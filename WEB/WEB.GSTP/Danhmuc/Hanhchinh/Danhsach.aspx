<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Danhsach.aspx.cs" Inherits="WEB.GSTP.Danhmuc.Hanhchinh.Danhsach" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hddPageSize" Value="70" runat="server" />
    <style type="text/css">
        .btnTimKiemCss {
            margin-left: 5px;
        }
                            ...
                            <table style="width: 100%; padding: 3px; border-spacing: 3px;">
                                ...
                                <tr>
                                    <td style="width: 120px;">
                                        <b>Mã</b><asp:Label runat="server" ID="nhap" Text="(*)" ForeColor="Red"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtMa" CssClass="user" runat="server" Width="200px" MaxLength="50"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <b>Tên đơn vị</b><asp:Label runat="server" ID="Label2" Text="(*)" ForeColor="Red"></asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList CssClass="chosen-select" ID="dropParent" runat="server" Width="200px" OnSelectedIndexChanged="dropParent_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <table style="width: 300px; margin-top: 10px; border-spacing: 5px;">
                                            <tr>
                                                <td style="width: 150px;">
                                                    <asp:TextBox runat="server" ID="txttimkiem" Width="100%" CssClass="user" placeholder="Mã, tên đơn vị"></asp:TextBox>
                                                </td>
                                                <td>
    ...
    <script type="text/javascript">
        function ValidateDataInput() {
            ...
            if (txtMaControl.value.trim() == "" || txtMaControl.value.trim() == null) {
                alert('Bạn hãy nhập mã đơn vị!');
                txtMaControl.focus();
                return false;
            } else if (txtMaControl.value.trim().length > 50) {
                alert('Mã đơn vị không được quá 50 ký tự. Hãy nhập lại!');
                txtMaControl.focus();
                return false;
            }
            ...
            if (txtTenControl.value.trim() == "" || txtTenControl.value.trim() == null) {
                alert('Bạn hãy nhập tên đơn vị!');
                txtTenControl.focus();
                return false;
            } else if (txtTenControl.value.trim().length > 250) {
                alert('Tên đơn vị không được quá 250 ký tự. Hãy nhập lại!');
                txtTenControl.focus();
                return false;
            }
            return true;
