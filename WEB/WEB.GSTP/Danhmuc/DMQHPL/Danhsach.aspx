<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Danhsach.aspx.cs" Inherits="WEB.GSTP.Danhmuc.DMQHPL.Danhsach" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hddPageSize" Value="50" runat="server" />
    <style type="text/css">
        .btnTimKiemCss {
            margin-left: 5px;
        }
        ...
        <div class="box_nd">
            <div class="truong">
                <table class="table1">
                    <tr>
                        <td >
                             <asp:DropDownList CssClass="chosen-select" ID="ddlLoaiAn" runat="server" Width="98%" OnSelectedIndexChanged="ddlLoaiAn_SelectedIndexChanged" AutoPostBack="true">
                                 <asp:ListItem Value="0" Text="Dân sự" Selected="True"></asp:ListItem>
                                 <asp:ListItem Value="1" Text="Hôn nhân & Gia đình"></asp:ListItem>
                                 <asp:ListItem Value="2" Text="Kinh doanh & Thương mại"></asp:ListItem>
                                 <asp:ListItem Value="3" Text="Lao động"></asp:ListItem>
                                 <asp:ListItem Value="4" Text="Hành chính"></asp:ListItem>
                                 <asp:ListItem Value="5" Text="Phá sản"></asp:ListItem>
                                 <asp:ListItem Value="15" Text="Ngành kinh tế"></asp:ListItem>
                             </asp:DropDownList>
                        </td>
                        <td></td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 70%; vertical-align: top; text-align: left">
                            <table style="width: 100%; padding: 3px; border-spacing: 3px;">
                                ...
                                <tr>
                                    <td style="width:90px;">
                                        <b>Tên quan hệ pháp luật</b><asp:Label runat="server" ID="Label2" Text="(*)" ForeColor="Red"></asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList CssClass="chosen-select" ID="dropParent" runat="server" Width="400px" OnSelectedIndexChanged="dropParent_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <b>QHPL Công bố BA/QĐ</b>
                                    </td>
                                    <td>
                                        <asp:DropDownList CssClass="chosen-select" ID="ddlQHPL_CONGBO" runat="server" Width="400px" AutoPostBack="true"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                        ...
                                        <table style="width: 300px; margin-top: 10px; border-spacing: 5px;">
                                            <tr>
                                                <td style="width: 150px;">
                                                    <asp:TextBox runat="server" ID="txttimkiem" Width="100%" CssClass="user" placeholder="Mã, tên"></asp:TextBox>
                                                </td>
                                                <td>
                                        ...
                                        <asp:Panel runat="server" ID="pndata">
                                            ...
                                            <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderStyle-Width="70px" ItemStyle-Width="70px">
                                                        <HeaderTemplate>
                                                            Thứ tự
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:DropDownList CssClass="user" ID="DropThuTuChildren" runat="server" Width="98%">
                                                            </asp:DropDownList>
                                                        </ItemTemplate>
    ...
    <script type="text/javascript">
        function ValidateDataInput() {
            ...
            if (txtTenControl.value.trim() == "" || txtTenControl.value.trim() == null) {
                alert('Bạn hãy nhập tên QHPL!');
                txtTenControl.focus();
                return false;
            } else if (txtTenControl.value.trim().length > 250) {
                alert('Tên QHPL không được quá 250 ký tự. Hãy nhập lại!');
                txtTenControl.focus();
                return false;
            }
            return true;
