<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Danhsach.aspx.cs" Inherits="WEB.GSTP.Danhmuc.VienKiemSat.Danhsach" %>
                    ...
                    <tr>
                        ...
                        <td style="width: 70%; vertical-align: top; text-align: left">
                            <table style="width: 100%; padding: 3px; border-spacing: 3px;">
                                ...
                                <tr>
                                    <td style="width: 120px;"><b>Mã viện kiểm sát</b><asp:Label runat="server" ID="nhap" Text="(*)" ForeColor="Red"></asp:Label></td>
                                    <td>
                                        <asp:TextBox ID="txtMa" CssClass="user" runat="server" Width="200px" MaxLength="50"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td><b>Tên viện kiểm sát</b><asp:Label runat="server" ID="Label2" Text="(*)" ForeColor="Red"></asp:Label></td>
                                    <td>
                                        <asp:TextBox ID="txtTen" CssClass="user" runat="server" Width="100%" MaxLength="250"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td><b>Viện kiểm sát cấp trên</b></td>
                                    <td>
                                ...
                                <tr>
                                    <td><b>Loại viện kiểm sát</b></td>
                                    <td>
                                        <asp:DropDownList CssClass="chosen-select" ID="dropLoaiVKS" runat="server" Width="390px"></asp:DropDownList></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><b>Tòa án tương ứng</b></td>
                                    <td>
                                        <asp:HiddenField ID="hddToaAnTuongUng" runat="server" />
                                        <asp:TextBox ID="txtToaAn" CssClass="user" runat="server" Width="100%" MaxLength="250"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div>
                                            <asp:HiddenField ID="hddVKSID" runat="server" Value="0" />
                                            <asp:Label runat="server" ID="lbthongbao" ForeColor="Red"></asp:Label>
                                        </div>
                                        <table style="width: 300px; margin-top: 10px; border-spacing: 5px;">
                                            <tr>
                                                <td style="width: 150px;">
                                                    <asp:TextBox runat="server" ID="txttimkiem" Width="100%" CssClass="user" placeholder="Mã, tên viện kiểm soát"></asp:TextBox>
                                                </td>
                                                <td>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            $(function () {
                ...
                var urldmToaAn = '<%=ResolveUrl("~/Ajax/SearchDanhmuc.aspx/GetDMToaAn") %>';
                $("[id$=txtToaAn]").autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            url: urldmToaAn, data: "{ 'q': '" + request.term + "'}", dataType: "json", type: "POST", contentType: "application/json; charset=utf-8",
                            success: function (data) { response($.map(data.d, function (item) { return { label: item.split('_')[1], val: item.split('_')[0] } })) }, error: function (response) { }, failure: function (response) { }
                        });
                    },
                    select: function (e, i) { $("[id$=hddToaAnTuongUng]").val(i.item.val); }, minLength: 1
                });
            });
