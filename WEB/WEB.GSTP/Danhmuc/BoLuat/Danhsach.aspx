<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true"
    CodeBehind="Danhsach.aspx.cs" Inherits="WEB.GSTP.Danhmuc.BoLuat.Danhsach" %>
    ...
    <div style="float: left; width: 97%; margin-left: 1.5%;">
        <div class="box">
            ...
            <div class="boder" style="float: left; width: 99%; margin-bottom: 10px;">
                <table class="table1">
                    <tr>
                        <td class="tdWidthTblToaAn"><b>Tên bộ luật</b>
                    ...
                    <tr>
                        <td class="tdWidthTblToaAn"><b>Ngày ban hành</b></td>
                        <td style="width: 150px;">
                            <asp:TextBox ID="txtNgayBanHanh" runat="server" CssClass="user" Width="100px" MaxLength="10"></asp:TextBox>
                            <cc1:CalendarExtender ID="txtNgayBanHanhh_CalendarExtender" runat="server"
                                TargetControlID="txtNgayBanHanh" Format="dd/MM/yyyy" Enabled="true" />
                            <cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server"
                                TargetControlID="txtNgayBanHanh" Mask="99/99/9999" MaskType="Date"
                                CultureName="vi-VN" ErrorTooltipEnabled="true" />
                            <cc1:MaskedEditValidator ID="MaskedEditValidator1" runat="server" ControlExtender="MaskedEditExtender1"
                                ControlToValidate="txtNgayBanHanh" InvalidValueMessage="dd/MM/yyyy"
                                Style="color: red; margin-left: 15px;"></cc1:MaskedEditValidator>
                        </td>

                        <td class="tdWidthTblToaAn" style="width: 80px; text-align: right;"><b>Loại án</b></td>
                        <td>
                            <asp:DropDownList ID="dropLoai" class="check" runat="server" CssClass="chosen-select" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdWidthTblToaAn"><b>Hiệu lực</b></td>
                        <td colspan="3">
                            <asp:RadioButtonList ID="rdHieuLuc" runat="server" RepeatDirection="Horizontal">
                    ...
                    <ItemTemplate>
                        <tr>
                           ...
                           <%-- <td align="center" style="width: 110px;">
                                <asp:LinkButton ID="lkToiDanh" runat="server" Text="Danh sách chương"
