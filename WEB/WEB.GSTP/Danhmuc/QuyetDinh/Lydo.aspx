<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Lydo.aspx.cs" Inherits="WEB.GSTP.Danhmuc.QuyetDinh.Lydo" %>
        ...
        <div class="box_nd" style="float: left; width: 99%;">
            <div class="truong" style="float: left; width: 99%;">
                <div class="class_nhomDM">
                    <span class="lbTitle_DonCap"><b>Chọn quyết định</b></span>
                    <asp:DropDownList CssClass="chosen-select" ID="DropQD" runat="server" Width="650px" AutoPostBack="True" OnSelectedIndexChanged="DropQD_SelectedIndexChanged">
                    </asp:DropDownList>
                </div>
                <asp:Panel ID="pnlDonCap" runat="server">
                    <div class="DataInfo">
                        <div class="lbTitle_DonCap">Mã lý do<asp:Label runat="server" ID="Label1" Text="(*)" ForeColor="Red"></asp:Label></div>
                        <div class="inputData_DonCap">
                            <asp:TextBox ID="txtMa" CssClass="user" runat="server" Width="180px" MaxLength="20"></asp:TextBox>
                        </div>
                        <div class="clear"></div>

                        <div class="lbTitle_DonCap">Tên lý do<asp:Label runat="server" ID="Label3" Text="(*)" ForeColor="Red"></asp:Label></div>
                        <div class="inputData_DonCap">
                            <asp:TextBox ID="txtTen" CssClass="user" Width="99%" runat="server" MaxLength="500"></asp:TextBox>
                        </div>
                        <div class="clear"></div>
    ...
    <script type="text/javascript">
        ...
        function KtratenDV() {
            ...
            if (txtTen.value.trim() == null || txtTen.value.trim() == "") {
                ...
                if (txtTen.value.lenght > 500) {
                    alert('Tên lý do không quá 500 ký tự!');
                    txtTen.focus();
                    return false;
                }
            }
