...
namespace WEB.GSTP
{
    public partial class ChangePass : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (OQUANTRI_MATKHAU != null)
                {
                    ...
                    txtLuuY.Text += "- Mật khẩu phải có tối thiểu "+ OQUANTRI_MATKHAU.DO_DAI_TOI_THIEU + " ký tự. Bao gồm ký tự số, chữ viết hoa, chữ viết thường, ít nhất 1 ký tự đặc biệt <b>!@#$%^&*,.</b></br>";
                    txtLuuY.Text += "- Mật khẩu <b>không được chứa tên tài khoản</b></br>";
        ...
        protected void cmdLogIn_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //{
            //    lttMsg.Text = "Mật khẩu phải tối thiểu 8 ký tự !";
            //    return;
            //}
            ...
            if (OQUANTRI_MATKHAU != null)
            {
                ...
                else if (OQUANTRI_MATKHAU.CO_KY_TU_DAC_BIET == 1 && !hasSymbols.IsMatch(txtPass.Text))
                {
