<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Chitiet_CongBoBA_QD.aspx.cs" Inherits="WEB.GSTP.GSTP.Chitiet_CongBoBA_QD" %>
        ...
        <div class="NoiDung">
            <table class="Table_Full_Width_No_Border_Spacing">
                <tr>
                    ...
                    <td style="vertical-align: top; height: 86px;">
                ...
                <tr runat="server" id="tr_vuan">
                    <td style="vertical-align: top;">
                        <div style="background-color: #f0a400; color: #fff; width: 610px; height: 28px; margin-left: 5px; border-radius: 5px; text-align: center; margin-bottom: 10px;">
                            <span style="font-size: 18px; font-weight: bold; margin-left: 10px; padding-top: 4px; float: left; text-transform: uppercase;">TÌNH HÌNH CÔNG BỐ BẢN ÁN, QUYẾT ĐỊNH CỦA CÁC THẨM PHÁN</span>
                        </div>
                        <span class="Title_Group_Box_GiaiDoan">Hình sự</span>
                        <table class="table2" style="width: 1216px; margin-left: 5px; margin-bottom: 15px;">
                            <tr class="header">
                                <td>Cấp Tòa án</td>
                                <td>Tổng số BA/QĐ đã xét xử</td>
                                <td>Tổng số BA/QĐ có kháng cáo, kháng nghị</td>
                                <td>Tổng số BA/QĐ đã công bố</td>
                                <td>Tổng số BA/QĐ công bố chậm</td>
                                <td>Tổng số BA/QĐ có đính chính</td>
                            </tr>
                            <asp:Repeater ID="rpt_HinhSu" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="Col_css_DS">
                                            <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("DAXETXU")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                        </td>
                                        <td class="Col_css_DS">
                                            <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("KCKN")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                        </td>
                                        <td class="Col_css_DS">
                                            <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("DACONGBO")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                        </td>
                                        <td class="Col_css_DS">
                                            <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("CONGBOCHAM")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                        </td>
                                        <td class="Col_css_DS">
                                            <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("DINHCHINH")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                        </table>
                        <span class="Title_Group_Box_GiaiDoan">Dân sự</span>
                        <table class="table2" style="width: 1216px; margin-left: 5px; margin-bottom: 15px;">
                            <tr class="header">
                                <td>Cấp Tòa án</td>
                                <td>Tổng số BA/QĐ đã xét xử</td>
                        ...
                        <span class="Title_Group_Box_GiaiDoan">Hôn nhân gia đình</span>
                        <table class="table2" style="width: 1216px; margin-left: 5px; margin-bottom: 15px;">
                            <tr class="header">
                                <td>Cấp Tòa án</td>
                                <td>Tổng số BA/QĐ đã xét xử</td>
                        ...
                        <span class="Title_Group_Box_GiaiDoan">Kinh doanh thương mại</span>
                        <table class="table2" style="width: 1216px; margin-left: 5px; margin-bottom: 15px;">
                            <tr class="header">
                                <td>Cấp Tòa án</td>
                                <td>Tổng số BA/QĐ đã xét xử</td>
                        ...
                        <span class="Title_Group_Box_GiaiDoan">Hành chính</span>
                        <table class="table2" style="width: 1216px; margin-left: 5px; margin-bottom: 15px;">
                            <tr class="header">
                                <td>Cấp Tòa án</td>
                                <td>Tổng số BA/QĐ đã xét xử</td>
                        ...
                        <span class="Title_Group_Box_GiaiDoan">Lao động</span>
                        <table class="table2" style="width: 1216px; margin-left: 5px; margin-bottom: 15px;">
                            <tr class="header">
                                <td>Cấp Tòa án</td>
                                <td>Tổng số BA/QĐ đã xét xử</td>
                ...
                <tr id="tr_congbo" runat="server">
                    <td style="vertical-align: top;">
                        <div style="background-color: #f0a400; color: #fff; width: 610px; height: 28px; margin-left: 5px; border-radius: 5px; text-align: center; margin-bottom: 10px;">
                            <span style="font-size: 18px; font-weight: bold; margin-left: 10px; padding-top: 4px; float: left; text-transform: uppercase;">TÌNH HÌNH CÔNG BỐ BẢN ÁN, QUYẾT ĐỊNH CỦA CÁC CẤP TÒA ÁN</span>
                        </div>
                        <table class="table2" style="width: 1216px; margin-left: 5px; margin-bottom: 15px;">
                            <tr class="header">
                                <td>Cấp Tòa án</td>
                                <td>Tổng số bản án/quyết định đã công bố</td>
                                <td>Tổng số bản án/quyết định công bố chậm</td>
                                <td>Tổng số bản án/quyết định có đính chính</td>
                                <td>Tổng số bản án/quyết định hạ xuống</td>
                                <td>Tổng số bản án/quyết định có áp dụng án lệ</td>
                            </tr>
                            <asp:Repeater ID="rpt_congbobobanan" runat="server" OnItemCommand="rpt_congbobobanan_ItemCommand"  OnItemDataBound ="rpt_congbobobanan_ItemDataBound">
                                <ItemTemplate>
                                    <tr>
                                        <td style="display: none;">
                                            <span style='<%#Eval("TYPE_NAME")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Eval("TYPE_ID") %></span>
                                        </td>
                                        <td style="text-align:center">
                                            <asp:LinkButton ID="LinkButton0" runat="server" Font-Bold="true" CommandArgument='<%# Eval("TYPE_ID")  %>' CommandName="1" Text='<%#Eval("TYPE_NAME") %>'></asp:LinkButton>
                                        </td>
                                        <td class="Col_css_DS">
                                            <span style='<%#Eval("TYPE_NAME")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("COLUMN_1")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                        </td>
                                        <td class="Col_css_DS">
                                            <span style='<%#Eval("TYPE_NAME")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("COLUMN_2")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                        </td>
                                        <td class="Col_css_DS">
                                            <span style='<%#Eval("TYPE_NAME")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("COLUMN_3")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                        </td>
                                        <td class="Col_css_DS">
                                            <span style='<%#Eval("TYPE_NAME")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("COLUMN_4")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                        </td>
                                        <td class="Col_css_DS">
                                            <span style='<%#Eval("TYPE_NAME")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("COLUMN_5")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
