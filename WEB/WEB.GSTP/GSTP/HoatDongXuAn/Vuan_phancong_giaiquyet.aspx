<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Vuan_phancong_giaiquyet.aspx.cs" Inherits="WEB.GSTP.GSTP.HoatDongXuAn.Vuan_phancong_giaiquyet" %>
        ...
        <div class="box_nd">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:DropDownList ID="ddlVaiTro" CssClass="chosen-select" runat="server" Width="321px">
                                    ...
                                    <asp:ListItem Value="VTTP_GIAIQUYETDON" Text="Thẩm phán giải quyết đơn"></asp:ListItem>
                                    <asp:ListItem Value="VTTP_GIAIQUYETSOTHAM" Text="Thẩm phán giải quyết sơ thẩm"></asp:ListItem>
                                    <asp:ListItem Value="VTTP_GIAIQUYETPHUCTHAM" Text="Thẩm phán giải quyết phúc thẩm"></asp:ListItem>
            ...
            <div class="truong">
                <table class="table1">
                    <tr>
                        <td>
                            <span style="font-weight: bold; text-transform: uppercase;">Danh sách vụ án được phân công giải quyết</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
