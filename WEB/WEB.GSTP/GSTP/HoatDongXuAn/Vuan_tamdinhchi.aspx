<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Vuan_tamdinhchi.aspx.cs" Inherits="WEB.GSTP.GSTP.HoatDongXuAn.Vuan_tamdinhchi" %>
        ...
        <div class="box_nd">
            ...
            <div class="truong">
                <table class="table1">
                    <tr>
                        <td>
                            <span style="font-weight: bold; text-transform: uppercase;">Danh sách vụ án tạm đình chỉ</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
