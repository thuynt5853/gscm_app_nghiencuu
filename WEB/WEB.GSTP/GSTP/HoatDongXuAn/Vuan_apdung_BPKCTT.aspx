<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Vuan_apdung_BPKCTT.aspx.cs" Inherits="WEB.GSTP.GSTP.HoatDongXuAn.Vuan_apdung_BPKCTT" %>
        ...
        <div class="box_nd">
            ...
            <div class="truong">
                <table class="table1">
                    <tr>
                        <td>
                            <span style="font-weight: bold; text-transform: uppercase;">Danh sách vụ án áp dụng biện pháp khẩn cấp tạm thời</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ...
                            <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn DataField="TenToaAn" HeaderText="Tòa xét xử" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="header_td" HeaderStyle-Width="200px"></asp:BoundColumn>
