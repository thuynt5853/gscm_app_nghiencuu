<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Vuan_tochuc_PTRKN.aspx.cs" Inherits="WEB.GSTP.GSTP.HoatDongXuAn.Vuan_tochuc_PTRKN" %>
        ...
        <div class="box_nd">
                    ...
                    <table class="table1">
                        ...
                        <tr>
                            ...
                            <td style="width: 162px;">
                                <asp:TextBox ID="txtSoQDBA" runat="server" CssClass="user" Width="125px" MaxLength="50"></asp:TextBox>
                            </td>
                            <td style="width: 80px;"><b>Ngày BA/QĐ</b></td>
                            <td>
                                <asp:TextBox ID="txtNgayQDBA" runat="server" CssClass="user" Width="94px" MaxLength="10"></asp:TextBox>
                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtNgayQDBA" Format="dd/MM/yyyy" Enabled="true" />
                                <cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server" TargetControlID="txtNgayQDBA" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" />
                            </td>
                        </tr>
                        <tr>
                            <td></td>
            ...
            <div class="truong">
                <table class="table1">
                    <tr>
                        <td>
                            <span style="font-weight: bold; text-transform: uppercase;">Danh sách vụ án tổ chức phiên tòa rút kinh nghiệm</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="Tên vụ án, vụ việc" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="header_td">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbtTenVuAn" runat="server" CausesValidation="false" Text='<%#Eval("TenVuAn") %>' CommandName="ChiTiet" CommandArgument='<%#Eval("VuAnID")+"#"+Eval("LOAIAN") %>'></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    ...
                                    <asp:BoundColumn DataField="LinhVuc" HeaderText="Lĩnh vực" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="header_td" HeaderStyle-Width="90px"></asp:BoundColumn>
    ...
    <script type="text/javascript">
        function validate() {
            ...
            if (txtNgayQDBA.value.trim().length > 0) {
                if (!IsTrueDate(txtNgayQDBA.value)) {
