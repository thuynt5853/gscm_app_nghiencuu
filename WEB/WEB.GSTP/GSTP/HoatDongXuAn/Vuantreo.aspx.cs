...
{
    public partial class Vuantreo : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            DataTable tbl = bl.DS_ANTREO_BYTP(ThamPhanID, TenVuAn, SoQDBA, NgayQDBA);
        ...
        {
            Session["GSTP_CALL_VUAN_INFO"] = e.CommandArgument.ToString();
