<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Thamtravien.aspx.cs" Inherits="WEB.GSTP.GSTP.NhanXet.Thamtravien" %>
            ...
            <div class="truong" style="width: 99%; float: left;">
                <div style="margin-left: 10px;">
                    ...
                    <div style="float: left; width: 100%; margin: 5px 0px">
                        <asp:TextBox ID="txtYKien" runat="server" TextMode="MultiLine" Height="350px" Width="99%" CssClass="yKien_css"></asp:TextBox>
                    </div>
