<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Chitiet_PhucTham.aspx.cs" Inherits="WEB.GSTP.GSTP.Chitiet_PhucTham" %>
                ...
                <tr>
                    <td id="td_NoiDung" runat="server" style="vertical-align: top;">
                        ...
                        <asp:Panel ID="panHS" runat="server">
                            <span class="Title_Group_Box_GiaiDoan">Hình sự phúc thẩm</span>
                            <table class="table2" style="width: 1216px; margin-left: 5px; margin-bottom: 15px;">
                                <tr class="header">
                                    ...
                                    <td colspan="8">GIẢI QUYẾT ÁN</td>
                                    <td colspan="5">ÁN HỦY, SỬA</td>
                                    <td colspan="2" rowspan="2">CÒN LẠI</td>
                                    <td colspan="2" rowspan="2">ÁN QUÁ HẠN LUẬT ĐỊNH CHƯA GIẢI QUYẾT</td>
                                </tr>
                                <tr class="header">
                                    <td colspan="2">Rút KC-KN</td>
                                    <td colspan="2">Xét xử</td>
                                    <td colspan="2">Tổng số GQ</td>
                                    <td colspan="2">Tỷ lệ GQ</td>
                                    <td>Sửa bản án, quyết định sơ thẩm</td>
                                    <td>Huỷ bản án sơ thẩm, tuyên bố bị cáo không có tội và đình chỉ vụ án</td>
                                    <td>Huỷ bản án sơ thẩm và đình chỉ vụ án</td>
                                    <td>Huỷ bản án, quyết định sơ thẩm để điều tra lại</td>
                                    <td>Huỷ bản án, quyết định sơ thẩm để xét xử sơ thẩm lại</td>
                                </tr>
                                <tr class="header">
                                    <td>Vụ</td>
                                    <td>Bị cáo</td>
                                ...
                                <asp:Repeater ID="rpt_HinhSu" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="Col_HS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_GQ_RUTKCKN_VU")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                            </td>
                                            <td class="Col_HS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_GQ_RUTKCKN_BICAO")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                            </td>
                                            <td class="Col_HS_css">
                                            ...
                                            <td class="Col_HS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_SUA_BA")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span><br />
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_SUA_BA_TYLE")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) + "%" %></span>
                                            </td>
                                            <td class="Col_HS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_HUY_BA_TUYENBO_DINHCHI")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span><br />
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_HUY_BA_TUYENBO_DINHCHI_TYLE")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) + "%" %></span>
                                            </td>
                                            <td class="Col_HS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_HUY_BA_DINHCHI")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span><br />
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_HUY_BA_DINHCHI_TYLE")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) + "%" %></span>
                                            </td>
                                            <td class="Col_HS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_HUY_BA_DIEUTRALAI")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span><br />
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_HUY_BA_DIEUTRALAI_TYLE")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) + "%" %></span>
                                            </td>
                                            <td class="Col_HS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_HUY_BA_XETXULAI")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span><br />
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_HUY_BA_XETXULAI_TYLE")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) + "%" %></span>
                                            </td>
                                            <td class="Col_HS_css">
                        ...
                        <asp:Panel ID="panDS" runat="server">
                            <span class="Title_Group_Box_GiaiDoan">Dân sự phúc thẩm</span>
                            <table class="table2" style="width: 1216px; margin-left: 5px; margin-bottom: 15px;">
                                <tr class="header">
                                    <td rowspan="3">Cấp Tòa án</td>
                                    <td rowspan="3">TỔNG THỤ LÝ
                                    <br />
                                        (vụ)</td>
                                    <td colspan="3">GIẢI QUYẾT ÁN</td>
                                    <td colspan="9">PHÂN TÍCH CÁC VỤ ÁN ĐÃ GIẢI QUYẾT</td>
                                    <td rowspan="3">CÒN LẠI</td>
                                    <td rowspan="3">ÁN QUÁ HẠN LUẬT ĐỊNH CHƯA GIẢI QUYẾT</td>
                                </tr>
                                <tr class="header">
                                    <td rowspan="2">TỔNG SỐ GQ</td>
                                    <td rowspan="2">TỶ LỆ GQ</td>
                                    <td rowspan="2">Số vụ án TA tổ chức phiên tòa rút kinh nghiệm</td>
                                    <td rowspan="2">Tạm đình chỉ</td>
                                    <td rowspan="2">Y án</td>
                                    <td colspan="3">Đình chỉ</td>
                                    <td colspan="2">Sửa án</td>
                                    <td colspan="2">Huỷ án</td>
                                </tr>
                                <tr class="header">
                                    <td>Rút kháng cáo</td>
                                    <td>Rút kháng nghị</td>
                                    <td>Lý do khác</td>
                                    <td>Do cấp ST sai</td>
                                    <td>Do có tình tiết mới</td>
                                    <td>Do cấp ST sai</td>
                                    <td>Do có tình tiết mới</td>
                                </tr>
                                <asp:Repeater ID="rpt_DanSu" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="Col_DS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_GQ_RUTKINHNGHIEM")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                            </td>
                                            <td class="Col_DS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_PHANTICH_TAMDINHCHI")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                            </td>
                                            <td class="Col_DS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_PHANTICH_ANLE")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                            </td>
                                            <td class="Col_DS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_PHANTICH_DC_RUTKHANGCAO")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                            </td>
                                            <td class="Col_DS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_PHANTICH_DC_RUTKHANGNGHI")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                            </td>
                                            <td class="Col_DS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_PHANTICH_DC_LYDOKHAC")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                            </td>
                                            <td class="Col_DS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_PHANTICH_SUA_CAPSOTHAMSAI")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                            </td>
                                            <td class="Col_DS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_PHANTICH_SUA_TINHTIETMOI")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                            </td>
                                            <td class="Col_DS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_PHANTICH_HUY_CAPSOTHAMSAI")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                            </td>
                                            <td class="Col_DS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_PHANTICH_HUY_TINHTIETMOI")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                            </td>
                                            <td class="Col_DS_css">
                                            ...
                                            <td class="Col_DS_css">
                                                <span style='<%#Eval("V_CAPTOA")+""=="Cộng"? "font-weight: bold; color: #db212d;": "" %>'><%#Convert.ToDecimal(Eval("V_QUAHAN_CHUAGQ")).ToString("#,0.##", new System.Globalization.CultureInfo("vi-VN")) %></span>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                        ...
                        <asp:Panel ID="panHN" runat="server">
                            <span class="Title_Group_Box_GiaiDoan">Hôn nhân gia đình phúc thẩm</span>
                            <table class="table2" style="width: 1216px; margin-left: 5px; margin-bottom: 15px;">
                                <tr class="header">
                                    <td rowspan="3">Cấp Tòa án</td>
                                    <td rowspan="3">TỔNG THỤ LÝ
                        ...
                        <asp:Panel ID="panKT" runat="server">
                            <span class="Title_Group_Box_GiaiDoan">Kinh doanh thương mại phúc thẩm</span>
                            <table class="table2" style="width: 1216px; margin-left: 5px; margin-bottom: 15px;">
                                <tr class="header">
                                    <td rowspan="3">Cấp Tòa án</td>
                                    <td rowspan="3">TỔNG THỤ LÝ
                        ...
                        <asp:Panel ID="panHC" runat="server">
                            <span class="Title_Group_Box_GiaiDoan">Hành chính phúc thẩm</span>
                            <table class="table2" style="width: 1216px; margin-left: 5px; margin-bottom: 15px;">
                                <tr class="header">
                                    <td rowspan="3">Cấp Tòa án</td>
                                    <td rowspan="3">TỔNG THỤ LÝ
                        ...
                        <asp:Panel ID="panLD" runat="server">
                            <span class="Title_Group_Box_GiaiDoan">Lao động phúc thẩm</span>
                            <table class="table2" style="width: 1216px; margin-left: 5px; margin-bottom: 15px;">
                                <tr class="header">
                                    <td rowspan="3">Cấp Tòa án</td>
                                    <td rowspan="3">TỔNG THỤ LÝ
