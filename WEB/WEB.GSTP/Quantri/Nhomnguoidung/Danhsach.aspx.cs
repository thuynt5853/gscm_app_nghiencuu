...
namespace WEB.GSTP.Quantri.Nhomnguoidung
{
    public partial class Danhsach : System.Web.UI.Page
    {
        ...
        {
            QT_NHOMNGUOIDUNG_BL oBL = new QT_NHOMNGUOIDUNG_BL();
            DataTable lst = oBL.QT_NHOMNGUOIDUNG_SEARCHBY(ddlDonvi.SelectedValue, txtTennhom.Text);
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Xoa":
                    ...
                    if(dt.QT_NGUOISUDUNG.Where(x=>x.NHOMNSDID==CID).ToList().Count>0)
                    {
