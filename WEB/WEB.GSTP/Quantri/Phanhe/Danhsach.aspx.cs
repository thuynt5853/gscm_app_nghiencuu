    ...
    public partial class Danhsach : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ddlHethong.DataSource = dt.QT_HETHONG.OrderBy(x => x.THUTU).ToList();
                    ddlHethong.DataTextField = "TEN";
                    ddlHethong.DataValueField = "ID";
                    ddlHethong.DataBind();
                    ddlHethongTK.DataSource = dt.QT_HETHONG.OrderBy(x => x.THUTU).ToList();
                    ddlHethongTK.DataTextField = "TEN";
                    ddlHethongTK.DataValueField = "ID";
                    ddlHethongTK.DataBind();
                    ddlHethongTK.Items.Insert(0, new ListItem("--Tất cả--", "0"));
                    List<QT_CHUONGTRINH> list = dt.QT_CHUONGTRINH.OrderBy(x => x.THUTU).ToList();
        ...
        private void objSubSite()
        {
            ...
            try
            {
                ...
                List<QT_CHUONGTRINH> lst;
                if (ddlHethongTK.SelectedIndex == 0)
                    lst = dt.QT_CHUONGTRINH.OrderBy(x => x.THUTU).ToList();
                else
                {
                    decimal HTID = Convert.ToDecimal(ddlHethongTK.SelectedValue);
                    lst = dt.QT_CHUONGTRINH.Where(x => x.HETHONGID == HTID).OrderBy(x => x.THUTU).ToList();
                }
                ...
                foreach (DataGridItem i in dgrDanhMucCT.Items)
                {
                    HiddenField hddHethongID = (HiddenField)i.FindControl("hddHethongID");
                    string strHTID = hddHethongID.Value + "";
                    if (strHTID != "")
                    {
                        decimal ID = Convert.ToDecimal(strHTID);
                        Literal lstChuongtrinh = (Literal)i.FindControl("lstChuongtrinh");
                        QT_HETHONG oT = dt.QT_HETHONG.Where(x => x.ID == ID).FirstOrDefault();
            ...
            if (!string.IsNullOrEmpty(hddchuongtrinhID.Value))
            {
                ...
                if (Int32.TryParse(hddchuongtrinhID.Value, out chuongtrinhid))
                {
                    if (chuongtrinhid != 0)
                    {
                        ...
                        QT_CHUONGTRINH otblCT = dt.QT_CHUONGTRINH.Where(x => x.ID == chuongtrinhid).FirstOrDefault();
                        ...
                        otblCT.HETHONGID = Convert.ToInt32(ddlHethong.SelectedItem.Value);
                        if (chkHieuluc.Checked == true)
                        { otblCT.HIEULUC = 1; }
                        else
                            otblCT.HIEULUC = 0;
                        if (chkNhomTDGS.Checked == true)
                            otblCT.ISLOAIAN = 1;
                        else
                            otblCT.ISLOAIAN = 0;
                        dt.SaveChanges();
        ...
        protected void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            if (hddchuongtrinhID.Value != "0")
            {
                ...
                QT_CHUONGTRINH otblCT = dt.QT_CHUONGTRINH.Where(x => x.ID == chuongtrinhid).FirstOrDefault();
                if (otblCT == null) return;
                List<QT_CHUONGTRINH> list = dt.QT_CHUONGTRINH.Where(x => x.MA == txtMaChuongTrinh.Text).ToList();
                List<QT_CHUONGTRINH> listten = dt.QT_CHUONGTRINH.Where(x => x.TEN == txtTenChuongTrinh.Text).ToList();
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        QT_CHUONGTRINH otblCT = new QT_CHUONGTRINH();
                        otblCT.MA = txtMaChuongTrinh.Text.ToUpper();
                        otblCT.TEN = txtTenChuongTrinh.Text;
                        ...
                        if (chkNhomTDGS.Checked == true)
                            ...
                            otblCT.ISLOAIAN = 0;
                        dt.QT_CHUONGTRINH.Add(otblCT);
                        dt.SaveChanges();
                        //Sau khi insert du lieu thì phải load lại dropthutu

                        List<QT_CHUONGTRINH> lstC = dt.QT_CHUONGTRINH.OrderBy(x => x.THUTU).ToList();
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(hddchuongtrinhID.Value))
                {
                    ...
                    if (Int32.TryParse(hddchuongtrinhID.Value, out chuongtrinhid))
                    {
                        if (chuongtrinhid != 0)
                        {
                            otblCT = dt.QT_CHUONGTRINH.Where(x => x.ID == chuongtrinhid).FirstOrDefault();
                            ...
                            if (otblCT.HETHONGID != null) ddlHethong.SelectedValue = otblCT.HETHONGID.ToString();
                            if (otblCT.HIEULUC == 1)
                            {
                            ...
                            if (otblCT.ISLOAIAN == 1)
                            {
                                chkNhomTDGS.Checked = true;
                            }
                            else
                                chkNhomTDGS.Checked = false;
                        }
        ...
        protected void dgrDanhMucCT_ItemCommand(object o, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "xoa":
                    ...
                    List<QT_MENU> list = dt.QT_MENU.Where(x => x.CHUONGTRINHID == chuongtrinhID).ToList();
                    if (list.Count > 0)
                    {
                    ...
                    {
                        QT_CHUONGTRINH otblCT = dt.QT_CHUONGTRINH.Where(x => x.ID == chuongtrinhID).FirstOrDefault();
                        dt.QT_CHUONGTRINH.Remove(otblCT);
