...
CodeBehind="DSCauHinh.aspx.cs" Inherits="WEB.GSTP.Quantri.Cauhinh.DSCauHinh" %>
    ...
    <div class="box">
        <div class="box_nd">
            <div class="truong">
                <table class="table1">
                    <tr>
                        <td style="width: 120px;"><b>Mã cấu hình<span class="must_input">(*)</span></b>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td><b>Tên cấu hình<span class="must_input">(*)</span></b></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtServerName" CssClass="user" runat="server" Width="98%" MaxLength="250"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td><b>Post</b></td>
                        <td>
                            <asp:TextBox ID="txtPost" CssClass="user" runat="server" Width="98%" MaxLength="250"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td><b>Email</b></td>
                        <td>
                            <asp:TextBox ID="txtEmail" CssClass="user" runat="server" Width="98%" MaxLength="250"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td><b>PassWord</b></td>
                        <td>
                            <asp:TextBox ID="txtPass" CssClass="user" runat="server" Width="98%" MaxLength="250" TextMode="Password"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td><b>Ghi chú</b></td>
                                        ...
                                        <table class="table2" style="width:100%;" border="1">
                                            <tr class="header">
                                                ...
                                                <td  style="width:120px">
                                                    <div style ="font-weight:bold; text-align:center;">Mã cấu hình</div>
                                                </td>
                                                <td  >
                                                    <div style ="font-weight:bold; text-align:center;">Tên cấu hình</div>
                                                </td>
