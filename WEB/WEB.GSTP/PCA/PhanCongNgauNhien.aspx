<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" 
    CodeBehind="PhanCongNgauNhien.aspx.cs" Inherits="WEB.GSTP.PCA.PhanCongNgauNhien" %>
        ...
        <div class="box_nd">
            <div class="truong">
                <table class="table1">
                                ...
                                <div class="boder" style="padding: 10px;">
                                    <table class="table1">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <div style="float: left; width: 140px; line-height: 20px;">Từ ngày (tạo vụ án)</div>
                                                ...
                                                <div style="float: left; width: 140px; line-height: 20px; margin-left: 30px;">Đến ngày (tạo vụ án)</div>
                                                <div style="float: left;">
                                                ...
                                                <div style="float: left; width: 105px; line-height: 20px; margin-left: 30px;">Giai đoạn</div>
                                                <div>
                    ...
                    <tr>
                        <td colspan="2" align="left" style="height: 300px;">
                            <div class="phantrang">
                                <div class="sobanghi">
                    ...
                    <tr>
                         <td colspan="2">
                             <div style="text-align: center;">
                                <span> <asp:Button ID="Button2" runat="server" CssClass="buttoninput" Text="Phân công án" OnClick="lbphancong_Click" /></span>
