<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" 
    CodeBehind="CauHinhToaAn.aspx.cs" Inherits="WEB.GSTP.PCA.CauHinhToaAn" %>
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="Lưu" ItemStyle-VerticalAlign="Middle" HeaderStyle-Font-Bold="true"
                                                ...
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkDon" runat="server" AutoPostBack="true" Checked='<%# GetNumber(Eval("PC_DON"))%>' ToolTip='<%#Eval("TEN")%>'  />
                                                </ItemTemplate>
                                         ...
                                         <asp:TemplateColumn HeaderText="Lưu" ItemStyle-VerticalAlign="Middle" HeaderStyle-Font-Bold="true"
                                                ...
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkAn" runat="server" AutoPostBack="true" Enabled="false" Checked="true" ToolTip='<%#Eval("TEN")%>'  />
                                                </ItemTemplate>
                                                <HeaderStyle Font-Bold="True" Width="50px"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                                            </asp:TemplateColumn> 
