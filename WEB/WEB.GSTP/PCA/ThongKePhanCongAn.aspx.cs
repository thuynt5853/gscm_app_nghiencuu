...
{
    public partial class ThongKePhanCongAn : System.Web.UI.Page
    {
        ...
        private void Load_Data()
        {
            ...
            //};
            //DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PCAConnection", "PCA_PKG.PRC_BC_KET_QUA_PCA", prm);
            DataTable tbl = pca.PCANN_DS_THONGKE(toa_an_id, tu_ngay, den_ngay, pageindex, page_size);
            if (tbl.Rows.Count > 0)
            {
