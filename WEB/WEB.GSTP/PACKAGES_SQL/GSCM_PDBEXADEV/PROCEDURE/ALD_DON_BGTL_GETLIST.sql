CREATE OR REPLACE PROCEDURE GSCM."ALD_DON_BGTL_GETLIST" 
(
  vDonID IN NUMBER,
...
BEGIN
  ...
  select b.ID,b.DONID,b.NGAYBANGIAO
    ...
    from ALD_DON_TAILIEU b
      ...
      left join (select a.ID,a.TENDUONGSU from ALD_DON_DUONGSU a) ds on ds.ID=b.NGUOIBANGIAO
      left join (select a.ID,a.HOTEN from ALD_DON_THAMGIATOTUNG a) tt on tt.ID=b.NGUOIBANGIAO        
  where b.DONID=vDonID
  order by b.NGAYBANGIAO desc;
END ALD_DON_BGTL_GETLIST;
