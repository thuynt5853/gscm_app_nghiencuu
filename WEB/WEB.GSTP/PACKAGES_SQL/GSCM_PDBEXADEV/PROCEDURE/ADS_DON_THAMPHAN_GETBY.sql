CREATE OR REPLACE PROCEDURE GSCM."ADS_DON_THAMPHAN_GETBY" 
( vDONID in number,
...
CheckBanAnST number;
BEGIN
   select count(ID) into CheckBanAnST from ADS_SOTHAM_BANAN where DonID = vDONID; 
    OPEN curReturn FOR  
      Select NVL(CheckBanAnST,0) CheckBanAnST, d.ID,d.NGAYPHANCONG,d.NGAYNHANPHANCONG,d.NGAYTHAMGIA,d.NGAYKETTHUC,d.NGUOITAO,d.NGAYTAO,c3.HOTEN as THUKY
         ,d.CANBOID,d.NGUOIPHANCONGID
         ,c1.HOTEN as TENTHAMPHAN
         ,c2.HOTEN as THAMPHANPHANCONG
         ,d.TOA_GIAIQUYET_ID
  From ADS_DON_THAMPHAN d 
