create or replace NONEDITIONABLE PROCEDURE "ADS_DON_ANPHI_GETBYDONID" 
(
   CurrDonID in int,   
   V_TINHTRANG in int,   
	 PageIndex	in	int,
...
--                , d.tenduongsu || '-' || di.TEN as duongsu
                ...
                , a.TOA_GIAIQUYET_ID
              from ADS_ANPHI a
--              left join ADS_DON_DUONGSU d on d.ID = a.DUONGSU_IDS   -- VNPT - Lê BÁ Thọ lấy ra đương sự thanh toán án phí 19/11/2025
