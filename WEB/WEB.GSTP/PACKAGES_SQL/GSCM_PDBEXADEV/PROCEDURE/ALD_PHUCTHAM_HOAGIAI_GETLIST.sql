CREATE OR REPLACE PROCEDURE GSCM."ALD_PHUCTHAM_HOAGIAI_GETLIST" 
( vDONID in number,
...
OPEN curReturn FOR  
  ...
  (CASE t.LOAITHONGBAO WHEN 1 THEN 'Thông báo hòa giải' WHen 2 then 'Thông báo hoãn hòa giải' END) as TENLOAITHONGBAO
       ,t.SO,t.NGAY,c.HOTEN
       ,t.NGAYTAO,t.NGUOITAO
       ,t.TOA_GIAIQUYET_ID  --hoangndh vnpt 09072025
  From ALD_PHUCTHAM_HOAGIAI t   
  inner join DM_CANBO c on c.ID=t.NGUOIKY
  Where t.DONID=vDONID
  ORder by t.NGAY desc;
END ALD_PHUCTHAM_HOAGIAI_GETLIST;