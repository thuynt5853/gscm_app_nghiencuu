--------------------------------------------------------
--  DDL for Package Body PKG_GDTTT_HCTP
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "GSCM"."PKG_GDTTT_HCTP" AS
  ...
  --vvTuNgay:=to_date(trim(vTuNgay)||' 00:00:00','dd/MM/yyyy HH24:MI:SS');vvDenNgay:=to_date(trim(vDenNgay)||' 00:00:00','dd/MM/yyyy HH24:MI:SS');
    ...
    LOOP
             ...
             SELECT COUNT(*) INTO v_Tongso From GDTTT_DON d
              ...
              And nvl(d.BAQD_LOAIAN,55)=item.BAQD_LOAIAN --AND pb.ISGIAIQUYETDON=0
...
--               Or  ( d.TL_NGAY>=vvTuNgay and d.TL_NGAY <= vvDenNgay )
              ...
              v_table.extend;
              v_table(v_table.count) := R_THONGKE_HCTP(
...
--               Or  ( d.TL_NGAY>=vvTuNgay and d.TL_NGAY <= vvDenNgay )
         ...
         SELECT COUNT(*) INTO v_Tongso From GDTTT_DON d
          ...
          -- Đơn thụ lý mới-Đơn đủ điều kiện chuyển Vụ GĐKT 1           
         SELECT COUNT(*) INTO v_Tongso From GDTTT_DON d
              Where d.TOAANID=vToaAnID 
              AND ( V_XEM_ALL=1 OR(V_XEM_ALL=0 AND d.nguoitao=VstrUsername) )
              And nvl(d.BAQD_LOAIAN,55)=item.BAQD_LOAIAN 
...
--                Or  ( d.TL_NGAY>=vvTuNgay and d.TL_NGAY <= vvDenNgay )
          ...
          -- Đơn trùng-Đơn đủ điều kiện chuyển Vụ GĐKT 2           
         SELECT COUNT(*) INTO v_Tongso From GDTTT_DON d
              Where d.TOAANID=vToaAnID 
              AND ( V_XEM_ALL=1 OR(V_XEM_ALL=0 AND d.nguoitao=VstrUsername) )
              And nvl(d.BAQD_LOAIAN,55)=item.BAQD_LOAIAN 
...
--               Or  ( d.TL_NGAY>=vvTuNgay and d.TL_NGAY <= vvDenNgay )
           ...
           -- Đơn thụ lý mới-Đơn đủ điều kiện chuyển Vụ GĐKT 2           
         SELECT COUNT(*) INTO v_Tongso From GDTTT_DON d
              Where d.TOAANID=vToaAnID 
              AND ( V_XEM_ALL=1 OR(V_XEM_ALL=0 AND d.nguoitao=VstrUsername) )
              And nvl(d.BAQD_LOAIAN,55)=item.BAQD_LOAIAN 
...
--                Or  ( d.TL_NGAY>=vvTuNgay and d.TL_NGAY <= vvDenNgay )
         ...
         -- Đơn trùng-Đơn đủ điều kiện chuyển Vụ GĐKT 3           
         SELECT COUNT(*) INTO v_Tongso From GDTTT_DON d
              Where d.TOAANID=vToaAnID 
              AND ( V_XEM_ALL=1 OR(V_XEM_ALL=0 AND d.nguoitao=VstrUsername) )
              And nvl(d.BAQD_LOAIAN,55)=item.BAQD_LOAIAN 
...
--              Or  ( d.TL_NGAY>=vvTuNgay and d.TL_NGAY <= vvDenNgay )
           ...
           -- Đơn thụ lý mới-Đơn đủ điều kiện chuyển Vụ GĐKT 3 ;CD_TA_DONVIID đơn vị nội bộ          
         SELECT COUNT(*) INTO v_Tongso From GDTTT_DON d
              Where d.TOAANID=vToaAnID 
              AND ( V_XEM_ALL=1 OR(V_XEM_ALL=0 AND d.nguoitao=VstrUsername) )
              And nvl(d.BAQD_LOAIAN,55)=item.BAQD_LOAIAN 
...
--              Or  ( d.TL_NGAY>=vvTuNgay and d.TL_NGAY <= vvDenNgay )
         ...
         -- Chuyển Vụ Tổ chức cán bộ   
         SELECT COUNT(*) INTO v_Tongso From GDTTT_DON d
              Where d.TOAANID=vToaAnID 
              AND ( V_XEM_ALL=1 OR(V_XEM_ALL=0 AND d.nguoitao=VstrUsername) )
              And nvl(d.BAQD_LOAIAN,55)=item.BAQD_LOAIAN
              AND d.CD_LOAI=0 and d.CD_TA_DONVIID=21
              AND( (d.NGAYTAO>=vvTuNgay AND d.NGAYTAO<=vvDenNgay)
--               Or  ( d.TL_NGAY>=vvTuNgay and d.TL_NGAY <= vvDenNgay )
              );
              -----
...
OPEN curReturn FOR 
           ...
           PP.COLUMN_18,PP.COLUMN_19,PP.COLUMN_20,PP.COLUMN_21,PP.COLUMN_22,PP.COLUMN_23,PP.COLUMN_24
           FROM 
           (
          ...
          --and PP.LoaiAn=0 lấy những loại án chưa xác định
           ...
           PP.COLUMN_5,PP.COLUMN_6,PP.COLUMN_7,PP.COLUMN_8,PP.COLUMN_9,PP.COLUMN_10,
           PP.COLUMN_11,PP.COLUMN_12,PP.COLUMN_13,PP.COLUMN_14,PP.COLUMN_15,PP.COLUMN_16,PP.COLUMN_17,
           PP.COLUMN_18,PP.COLUMN_19,PP.COLUMN_20,PP.COLUMN_21,PP.COLUMN_22,PP.COLUMN_23,PP.COLUMN_24 FROM 
           (
              SELECT NULL v_TT,PA.LoaiAn,PA.TenLoaiAn,SUM(PA.COLUMN_1)COLUMN_1,SUM(PA.COLUMN_2)COLUMN_2,SUM(PA.COLUMN_3)COLUMN_3,SUM(PA.COLUMN_4)COLUMN_4
              ,SUM(PA.COLUMN_5)COLUMN_5,SUM(PA.COLUMN_6)COLUMN_6,SUM(PA.COLUMN_7)COLUMN_7,SUM(PA.COLUMN_8)COLUMN_8,SUM(PA.COLUMN_9)COLUMN_9
              ,SUM(PA.COLUMN_10)COLUMN_10,SUM(PA.COLUMN_11)COLUMN_11,SUM(PA.COLUMN_12)COLUMN_12,SUM(PA.COLUMN_13)COLUMN_13,SUM(PA.COLUMN_14)COLUMN_14
...
(
 ...
 RETURN SYS_REFCURSOR
   IS 
    V_CURSOR sys_refcursor;
    V_EXPORT_TEXT CLOB; v_table T_THONGKE_HCTP;v_table_nsd T_NGUOIDUNG_HCTP;
       --------------
        ...
        COLUMN_19 number;COLUMN_20 number;COLUMN_21 number;COLUMN_22 number;COLUMN_23 number;COLUMN_24 number;
       ------------------------
  ...
  BEGIN	
    ...
    DBMS_LOB.CREATETEMPORARY(V_EXPORT_TEXT,true);
                ----------------------
                 v_table := T_THONGKE_HCTP();
                 PKG_GDTTT_HCTP.TK_HCTP_CREATE_DATA(VTOAANID,VstrUsername,VstrNhomID,VTUNGAY,VDENNGAY,V_CURSOR);
                -----------------------
               LOOP 
         ...
         DBMS_LOB.APPEND(V_EXPORT_TEXT,'
            ...
            <tr style="font-weight: bold;">
                ...
                <td rowspan="2" style="text-align: center; vertical-align: middle; border: 0.1pt solid #000000;">Đơn không thuộc thẩm quyền TATC</td>
                <td rowspan="2" style="text-align: center; vertical-align: middle; border: 0.1pt solid #000000;">Đơn chưa đủ điều kiện</td>
                <td colspan="2" style="text-align: center; vertical-align: middle; border: 0.1pt solid #000000; height: 40pt;">Đơn đủ điều kiện chuyển Vụ GĐKT 1</td>
                <td colspan="2" style="text-align: center; vertical-align: middle; border: 0.1pt solid #000000;">Đơn đủ điều kiện chuyển Vụ GĐKT 2</td>
                <td colspan="2" style="text-align: center; vertical-align: middle; border: 0.1pt solid #000000;">Đơn đủ điều kiện chuyển Vụ GĐKT 3</td>
                <td colspan="3" style="text-align: center; vertical-align: middle; border: 0.1pt solid #000000;">Đơn chuyển 03 Tòa cấp cao</td>
                <td rowspan="2" style="text-align: center; vertical-align: middle; border: 0.1pt solid #000000;">Chuyển Vụ Tổ chức cán bộ</td>
                <td rowspan="2" style="text-align: center; vertical-align: middle; border: 0.1pt solid #000000;">Chuyển Ban Thanh tra</td>
            ...
            <tr style="font-weight: bold;">
                ...
                <td style="text-align: center; vertical-align: middle; border: 0.1pt solid #000000; height: 70pt;">Đơn trùng</td>
                <td style="text-align: center; vertical-align: middle; border: 0.1pt solid #000000;">Đơn thụ lý mới</td>
                <td style="text-align: center; vertical-align: middle; border: 0.1pt solid #000000;">TAND CC tại Hà Nội</td>
                <td style="text-align: center; vertical-align: middle; border: 0.1pt solid #000000; height: 70pt;">TAND CC tại Đà Nẵng</td>
                <td style="text-align: center; vertical-align: middle; border: 0.1pt solid #000000;">TAND CC tại TP.Hồ Chí Minh</td>
            </tr>
