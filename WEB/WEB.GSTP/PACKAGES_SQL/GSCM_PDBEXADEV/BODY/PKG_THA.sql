CREATE OR REPLACE PACKAGE BODY GSCM.PKG_THA AS
...
BEGIN
  ...
  OPEN curReturn FOR  
     Select t.ID,t.BIANID,t.VUANID,t.TOAANID,t.MATHULY,decode(NVL(t.TRUONGHOPTHULY,0),0,'Thụ lý mới','Thụ lý mới do Ủy thác') TRUONGHOPTHULY,t.NGAYTHULY,t.SOTHULY,
                ...
                t.GHICHU,t.NGAYTAO,t.NGUOITAO,t.NGAYSUA,t.NGUOISUA,t.TT, t.TOA_GIAIQUYET_ID,
                t.QT_FILE_ID AS FILE_ID, -- vnpt hoangndh UPDATE 170925
                t.IS_KHONGTHA, 
				CASE 
				   WHEN NVL(t.IS_KHONGTHA, 0) = 1 
				   THEN 'Ngày thống kê: ' || TO_CHAR(t.NGAYTHONGKE, 'dd/MM/yyyy') 
				   ELSE '' 
				END AS NGAYTHONGKE,
				CASE 
				   WHEN NVL(t.IS_KHONGTHA, 0) = 1 
				   THEN u'L\00ed do: ' || t.LIDO_KHONGTHA 
				   ELSE u''
				END AS LIDO -- vnpt hoangndh 170925
    From THA_THULY t
