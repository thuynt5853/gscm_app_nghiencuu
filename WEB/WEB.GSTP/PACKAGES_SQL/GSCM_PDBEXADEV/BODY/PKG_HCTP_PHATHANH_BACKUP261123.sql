--------------------------------------------------------
--  DDL for Package Body PKG_HCTP_PHATHANH_BACKUP261123
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PKG_HCTP_PHATHANH_BACKUP261123" AS
...
(
  ...
  BEGIN
        if (v_ID >0) then
            ...
            values (TONGDAT_GDKT_SEQ.nextval,v_DON_ID,v_LOAIVANBAN,v_TENVANBAN,v_SOVB,v_NGAYVB,v_NGUOIKY,v_DONVIPHATHANH_ID,v_DONVIPHATHANH,v_TOAANID,v_NGAYTHUHOI,v_LYDOTHUHOI,v_NGAYTAO,v_NGUOITAO,v_NGAYSUA,v_NGUOISUA)
            RETURNING ID INTO vID;
        end if;
...
(
  ...
  BEGIN
    if (v_ID >0) then
            ...
            values (TONGDAT_GDKT_SEQ.nextval,v_TONGDAT_HCTP_ID,v_NOINHAN_ID,v_NOINHAN,v_DOITUONG,v_TUCACHTOTUNG,v_DIACHI,v_TRANGTHAI,v_LYDO,v_NGAYGUI,v_NGAYPHATHANH,v_NGAYNHAN,v_HINHTHUCGUI,v_PHATHANHLAI_ID,v_NGAYTAO,v_NGUOITAO)
            RETURNING ID INTO vID;
        end if;
...
END PKG_HCTP_PHATHANH_BACKUP261123;
