--------------------------------------------------------
--  DDL for Package Body PKG_TUPHAP_ANPHI
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "GSCM"."PKG_TUPHAP_ANPHI" AS
...
begin
 ...
 --------------
  FOR item_tp IN 
            (
                SELECT TD.URL_FILE,TD.ID TONGDATID,TD.NGAYTAO,THA.ID DONVITHA_ID,FL.TENFILE,'Dân sự' LOAIAN,TO_CHAR(DO.MAVUVIEC)MAVUVIEC,TD.BIEUMAUID,'2' AS MALOAIVUVIEC,TD.FILEID,TD.DONID,DU.ID DUONGSU_ID,AI.SOTHONGBAO||'/TB-TA' AS SOTHONGBAO,
                'Họ tên:<b> '||DU.TENDUONGSU||'</b><br/> Năm sinh: '||DU.NAMSINH||'<br/> CMTND/CCCD/HC: '||DECODE(DU.SO_CCCD,NULL,SOCMND,NULL,SO_HO_CHIEU,DU.SO_CCCD)||'<br/> Điên thoại: '||DU.DIENTHOAI||'<br/> Email: '||DU.EMAIL||'<br/>' TENDUONGSU,DU.NAMSINH,DU.GIOITINH,DU.SOCMND,DU.DIENTHOAI,DU.EMAIL,TN.MA_TEN DONVI,AI.TAMUNGANPHI,
                DECODE(tt.TRANGTHAITHANHTOAN,0,'Chưa nộp án phí',1,'Đã nộp án phí') STATUS,HC.MA_TEN,
                DECODE(DU.NDD_DIACHICHITIET,NULL,HC.MA_TEN,REPLACE(DU.NDD_DIACHICHITIET,',')||', '||HC.MA_TEN) AS DIACHI,
                ...
                TA.NOP_ISNGUYENDON,TA.NOP_GIOITINH,decode(TA.NOP_HOTEN,NULL,TT.HOTENNGUOINOPTIEN,TA.NOP_HOTEN)NOP_HOTEN,TA.NOP_NAMSINH,decode(tt.TT_TRUCTUYEN,1,tt.SOCMNDNGUOINOP,TA.NOP_CMND)NOP_CMND,TA.NOP_TEL,TA.NOP_EMAIL,decode(TA.NOP_DIACHI,NULL,TT.DIACHINGUOINOPTIEN,TA.NOP_DIACHI)NOP_DIACHI,TA.HOANTRAAP_ISNGUYENDON,DU.LOAIDUONGSU               
                              ...
                              from(SELECT SUBSTR(TT.NGAYNHANTONGDATS,0,instr(TT.NGAYNHANTONGDATS,',')-1)NGAYNHANTONGDAT
                                 ...
                                 ,TT.DUONGSUIDS,TT.tongdatid
                                  FROM (    select tongdatid,LISTAGG(DUONGSUID, ',')WITHIN GROUP (ORDER BY ID)DUONGSUIDS,
                                            ...
                                            from ADS_TONGDAT_DOITUONG where NGAYPHATHANH is not null
                                            group by tongdatid 
                                        )TT 
                                 )tts
    ...
    LOOP
        ...
        ,item_tp.ANPHI_FILE_NAME,item_tp.NGAYSUA,item_tp.NGUOISUA,item_tp.TUPHAP_ANPHI_ID,item_tp.TONGDATID,item_tp.URL_FILE);     
    END LOOP;
      -----------
     FOR item_tp IN 
            (
                SELECT TD.URL_FILE,TD.ID TONGDATID,TD.NGAYTAO,THA.ID DONVITHA_ID,FL.TENFILE,'Hôn nhân ' LOAIAN,DO.MAVUVIEC,TD.BIEUMAUID,'3' AS MALOAIVUVIEC,TD.FILEID,TD.DONID,0 DUONGSU_ID,AI.SOTHONGBAO||'/TB-TA' AS SOTHONGBAO,
                ...
                LEFT JOIN (SELECT LISTAGG('Họ tên:<b> '||HN.TENDUONGSU||'</b><br/> Năm sinh: '||HN.NAMSINH||'<br/> CMTND/CCCD/HC: '||DECODE(HN.SO_CCCD,NULL,SOCMND,NULL,SO_HO_CHIEU,HN.SO_CCCD)||'<br/> Điên thoại: '||HN.DIENTHOAI||'<br/> Email: '||HN.EMAIL||'<br/>', '')
                                   WITHIN GROUP (ORDER BY 'Họ tên:<b> '||HN.TENDUONGSU||'</b><br/> Năm sinh: '||HN.NAMSINH||'<br/> CMTND/CCCD/HC: '||DECODE(HN.SO_CCCD,NULL,SOCMND,NULL,SO_HO_CHIEU,HN.SO_CCCD)||'<br/> Điên thoại: '||HN.DIENTHOAI||'<br/> Email: '||HN.EMAIL||'<br/>') TENDUONGSU ,
                             DU.ANPHI_ID
    ...
    END LOOP;
     ...
     FOR item_tp IN 
            (
               SELECT TD.URL_FILE,TD.ID TONGDATID,TD.NGAYTAO,THA.ID DONVITHA_ID,FL.TENFILE,'Kinh tế' LOAIAN,DO.MAVUVIEC,DO.TENVUVIEC,TD.BIEUMAUID,'4' AS MALOAIVUVIEC,TD.FILEID,TD.DONID,DU.ID DUONGSU_ID,AI.SOTHONGBAO||'/TB-TA' AS SOTHONGBAO,
                'Họ tên:<b> '||DU.TENDUONGSU||'</b><br/> Năm sinh: '||DU.NAMSINH||'<br/> CMTND/CCCD/HC: '||DECODE(DU.SO_CCCD,NULL,SOCMND,NULL,SO_HO_CHIEU,DU.SO_CCCD)||'<br/> Điên thoại: '||DU.DIENTHOAI||'<br/> Email: '||DU.EMAIL||'<br/>' TENDUONGSU,DU.NAMSINH,DU.GIOITINH,DU.SOCMND,DU.DIENTHOAI,DU.EMAIL,TN.MA_TEN DONVI,AI.TAMUNGANPHI,
                DECODE(tt.TRANGTHAITHANHTOAN,0,'Chưa nộp án phí',1,'Đã nộp án phí') STATUS,HC.MA_TEN,
                DECODE(DU.NDD_DIACHICHITIET,NULL,HC.MA_TEN,REPLACE(DU.NDD_DIACHICHITIET,',')||', '||HC.MA_TEN) AS DIACHI,
                TA.HOANTRAAP_HOTEN,TA.HOANTRAAP_GIOITINH,TA.HOANTRAAP_NAMSINH,TA.HOANTRAAP_CMND,TA.HOANTRAAP_TEL,TA.HOANTRAAP_EMAIL,TA.HOANTRAAP_DIACHI,
                              ...
                              from(SELECT SUBSTR(TT.NGAYNHANTONGDATS,0,instr(TT.NGAYNHANTONGDATS,',')-1)NGAYNHANTONGDAT
                                 ...
                                 ,TT.DUONGSUIDS,TT.tongdatid
                                  FROM (    select tongdatid,LISTAGG(DUONGSUID, ',')WITHIN GROUP (ORDER BY ID)DUONGSUIDS,
                                            LISTAGG(NGAYNHANTONGDAT,',')WITHIN GROUP (ORDER BY ID)NGAYNHANTONGDATS,
                                            LISTAGG(NGAYPHATHANH,',')WITHIN GROUP (ORDER BY ID)NGAYPHATHANHS 
                                            from AKT_TONGDAT_DOITUONG where NGAYPHATHANH is not null
                                            group by tongdatid 
                                        )TT 
                                 )tts
                          )DT on DT.tongdatid=TD.ID --and instr(','||TT.DUONGSU_ID||',',','||DT.DUONGSUID||',')>0                      
    ...
    END LOOP;
     ...
     FOR item_tp IN 
            (
                SELECT TD.URL_FILE,TD.ID TONGDATID,TD.NGAYTAO,THA.ID DONVITHA_ID,FL.TENFILE,'Lao động' LOAIAN,DO.MAVUVIEC,TD.BIEUMAUID,'5' AS MALOAIVUVIEC,TD.FILEID,TD.DONID,DU.ID DUONGSU_ID,AI.SOTHONGBAO||'/TB-TA' AS SOTHONGBAO,
                'Họ tên:<b> '||DU.TENDUONGSU||'</b><br/> Năm sinh: '||DU.NAMSINH||'<br/> CMTND/CCCD/HC: '||DECODE(DU.SO_CCCD,NULL,SOCMND,NULL,SO_HO_CHIEU,DU.SO_CCCD)||'<br/> Điên thoại: '||DU.DIENTHOAI||'<br/> Email: '||DU.EMAIL||'<br/>'TENDUONGSU,DU.NAMSINH,DU.GIOITINH,DU.SOCMND,DU.DIENTHOAI,DU.EMAIL,TN.MA_TEN DONVI,AI.TAMUNGANPHI,
                DECODE(tt.TRANGTHAITHANHTOAN,0,'Chưa nộp án phí',1,'Đã nộp án phí') STATUS,HC.MA_TEN,
                DECODE(DU.NDD_DIACHICHITIET,NULL,HC.MA_TEN,REPLACE(DU.NDD_DIACHICHITIET,',')||', '||HC.MA_TEN) AS DIACHI,
                TA.HOANTRAAP_HOTEN,TA.HOANTRAAP_GIOITINH,TA.HOANTRAAP_NAMSINH,TA.HOANTRAAP_CMND,TA.HOANTRAAP_TEL,TA.HOANTRAAP_EMAIL,TA.HOANTRAAP_DIACHI,
                              ...
                              from(SELECT SUBSTR(TT.NGAYNHANTONGDATS,0,instr(TT.NGAYNHANTONGDATS,',')-1)NGAYNHANTONGDAT
                                 ...
                                 ,TT.DUONGSUIDS,TT.tongdatid
                                  FROM (    select tongdatid,LISTAGG(DUONGSUID, ',')WITHIN GROUP (ORDER BY ID)DUONGSUIDS,
                                            LISTAGG(NGAYNHANTONGDAT,',')WITHIN GROUP (ORDER BY ID)NGAYNHANTONGDATS,
                                            LISTAGG(NGAYPHATHANH,',')WITHIN GROUP (ORDER BY ID)NGAYPHATHANHS 
                                            from ALD_TONGDAT_DOITUONG where NGAYPHATHANH is not null
                                            group by tongdatid 
                                        )TT 
                                 )tts
                          )DT on DT.tongdatid=TD.ID --and instr(','||TT.DUONGSU_ID||',',','||DT.DUONGSUID||',')>0                     
    ...
    FOR item_tp IN 
            (
            SELECT TD.URL_FILE,TD.ID TONGDATID,TD.NGAYTAO,THA.ID DONVITHA_ID,FL.TENFILE,'Hành chính' LOAIAN,DO.MAVUVIEC,TD.BIEUMAUID,'6' AS MALOAIVUVIEC,TD.FILEID,TD.DONID,0 DUONGSU_ID,AI.SOTHONGBAO||'/TB-TA' AS SOTHONGBAO,
                AP.TENDUONGSU,null NAMSINH,null GIOITINH,null SOCMND,null DIENTHOAI,null EMAIL,TN.MA_TEN DONVI,AI.TAMUNGANPHI,
                DECODE(tt.TRANGTHAITHANHTOAN,0,'Chưa nộp án phí',1,'Đã nộp án phí') STATUS,null MA_TEN,
                null AS DIACHI,
                TA.HOANTRAAP_HOTEN,TA.HOANTRAAP_GIOITINH,TA.HOANTRAAP_NAMSINH,TA.HOANTRAAP_CMND,TA.HOANTRAAP_TEL,TA.HOANTRAAP_EMAIL,TA.HOANTRAAP_DIACHI,
                              ...
                              from(SELECT SUBSTR(TT.NGAYNHANTONGDATS,0,instr(TT.NGAYNHANTONGDATS,',')-1)NGAYNHANTONGDAT
                                 ...
                                 ,TT.DUONGSUIDS,TT.tongdatid
                                  FROM (    select tongdatid,LISTAGG(DUONGSUID, ',')WITHIN GROUP (ORDER BY ID)DUONGSUIDS,
                                            LISTAGG(NGAYNHANTONGDAT,',')WITHIN GROUP (ORDER BY ID)NGAYNHANTONGDATS,
                                            LISTAGG(NGAYPHATHANH,',')WITHIN GROUP (ORDER BY ID)NGAYPHATHANHS 
                                            from AHC_TONGDAT_DOITUONG where NGAYPHATHANH is not null
                                            group by tongdatid 
                                        )TT 
                                 )tts
                          )DT on DT.tongdatid=TD.ID --and instr(','||TT.DUONGSU_IDS||',',','||DT.DUONGSUID||',')>0                
    ...
    FOR item_tp IN 
            (
                SELECT TD.URL_FILE,TD.ID TONGDATID,TD.NGAYTAO,THA.ID DONVITHA_ID,FL.TENFILE,'Phá sản' LOAIAN,DO.MAVUVIEC,TD.BIEUMAUID,'7' AS MALOAIVUVIEC,TD.FILEID,TD.DONID,DU.ID DUONGSU_ID,AI.SOTHONGBAO||'/TB-TA' AS SOTHONGBAO,
                'Họ tên:<b> '||DU.TENDUONGSU||'</b><br/> Năm sinh: '||DU.NAMSINH||'<br/> CMTND/CCCD/HC: '||DECODE(DU.SO_CCCD,NULL,SOCMND,NULL,SO_HO_CHIEU,DU.SO_CCCD)||'<br/> Điên thoại: '||DU.DIENTHOAI||'<br/> Email: '||DU.EMAIL||'<br/>' TENDUONGSU,DU.NAMSINH,DU.GIOITINH,DU.SOCMND,DU.DIENTHOAI,DU.EMAIL,TN.MA_TEN DONVI,AI.TAMUNGANPHI,
                DECODE(tt.TRANGTHAITHANHTOAN,0,'Chưa nộp án phí',1,'Đã nộp án phí') STATUS,HC.MA_TEN,
                DECODE(DU.NDD_DIACHICHITIET,NULL,HC.MA_TEN,REPLACE(DU.NDD_DIACHICHITIET,',')||', '||HC.MA_TEN) AS DIACHI,
                TA.HOANTRAAP_HOTEN,TA.HOANTRAAP_GIOITINH,TA.HOANTRAAP_NAMSINH,TA.HOANTRAAP_CMND,TA.HOANTRAAP_TEL,TA.HOANTRAAP_EMAIL,TA.HOANTRAAP_DIACHI,
                              ...
                              from(SELECT SUBSTR(TT.NGAYNHANTONGDATS,0,instr(TT.NGAYNHANTONGDATS,',')-1)NGAYNHANTONGDAT
                                 ...
                                 ,TT.DUONGSUIDS,TT.tongdatid
                                  FROM (    select tongdatid,LISTAGG(DUONGSUID, ',')WITHIN GROUP (ORDER BY ID)DUONGSUIDS,
                                            LISTAGG(NGAYNHANTONGDAT,',')WITHIN GROUP (ORDER BY ID)NGAYNHANTONGDATS,
                                            LISTAGG(NGAYPHATHANH,',')WITHIN GROUP (ORDER BY ID)NGAYPHATHANHS 
                                            from APS_TONGDAT_DOITUONG where NGAYPHATHANH is not null
                                            group by tongdatid 
                                        )TT 
                                 )tts
                          )DT on DT.tongdatid=TD.ID --and instr(','||TT.DUONGSU_ID||',',','||DT.DUONGSUID||',')>0                  
 ...
 OPEN v_cursor FOR
 select DS.* from (
                SELECT TP.URL_FILE,TP.TONGDATID,TP.NGAYTAO,TP.DONVITHA_ID,TP.TENFILE,'<b>'||TP.LOAIAN||'</b>' LOAIAN,TP.MAVUVIEC,TP.BIEUMAUID,TP.MALOAIVUVIEC,TP.FILEID,COUNT(*) OVER()COUNTALL,ROW_NUMBER() OVER (ORDER BY TP.NGAYTAO DESC,TP.DONVI) STT,
...
begin
 ...
 --------------
  FOR item_tp IN 
            (
                SELECT  TD.URL_FILE,TD.ID TONGDATID,TD.NGAYTAO,THA.ID DONVITHA_ID,NULL TENFILE,'Dân sự' LOAIAN,TO_CHAR(DO.MAVUVIEC)MAVUVIEC,TD.BIEUMAUID,'2' AS MALOAIVUVIEC,TD.FILEID,TD.DONID,DU.ID DUONGSU_ID,AI.SOTHONGBAO||'/TB-TA' AS SOTHONGBAO,
               ...
               -- INNER JOIN ADS_TONGDAT_DOITUONG DO ON DO.DUONGSUID =DU.id
                INNER JOIN DM_TOAAN_THIHANHAN_MAP THM ON THM.TOAANID=TN.ID
                INNER JOIN DM_DONVITHIHANHAN THA ON THA.ARRTOAANID=THM.THIHANHANID
    ...
    END LOOP;
     ...
     FOR item_tp IN 
            (
                SELECT  TD.URL_FILE,TD.ID TONGDATID,TD.NGAYTAO,THA.ID DONVITHA_ID,NULL TENFILE,'Hôn nhân ' LOAIAN,DO.MAVUVIEC, TD.BIEUMAUID,'3' AS MALOAIVUVIEC,TD.FILEID,TD.DONID,0 DUONGSU_ID,AI.SOTHONGBAO||'/TB-TA' AS SOTHONGBAO,
    ...
    END LOOP;
     ...
     FOR item_tp IN 
            (
               SELECT  TD.URL_FILE,TD.ID TONGDATID,TD.NGAYTAO,THA.ID DONVITHA_ID,NULL TENFILE,'Kinh tế' LOAIAN,DO.MAVUVIEC,TD.BIEUMAUID,'4' AS MALOAIVUVIEC,TD.FILEID,TD.DONID,DU.ID DUONGSU_ID,AI.SOTHONGBAO||'/TB-TA' AS SOTHONGBAO,
                DO.TENVUVIEC TENDUONGSU,DU.NAMSINH,DU.GIOITINH,DU.SOCMND,DU.DIENTHOAI,DU.EMAIL,TN.MA_TEN DONVI,AI.TAMUNGANPHI,
                --DECODE(tt.TRANGTHAITHANHTOAN,0,'Chưa nộp án phí',1,'Đã nộp án phí') STATUS,
                DECODE(DO.MAGIAIDOAN,2,'Thông báo nộp tiền tạm ứng án phí',3,'Thông báo nộp tiền tạm ứng án phí phúc thẩm') STATUS,
                HC.MA_TEN,
...
--                LEFT JOIN AKT_FILE FL ON FL.DONID=TD.DONID AND FL.BIEUMAUID=67
    ...
    END LOOP;
     ...
     FOR item_tp IN 
            (
                SELECT  TD.URL_FILE,TD.ID TONGDATID,TD.NGAYTAO,THA.ID DONVITHA_ID,NULL TENFILE,'Lao động' LOAIAN,DO.MAVUVIEC,TD.BIEUMAUID,'5' AS MALOAIVUVIEC,TD.FILEID,TD.DONID,DU.ID DUONGSU_ID,AI.SOTHONGBAO||'/TB-TA' AS SOTHONGBAO,
                DO.TENVUVIEC TENDUONGSU,DU.NAMSINH,DU.GIOITINH,DU.SOCMND,DU.DIENTHOAI,DU.EMAIL,TN.MA_TEN DONVI,AI.TAMUNGANPHI,
                --DECODE(tt.TRANGTHAITHANHTOAN,0,'Chưa nộp án phí',1,'Đã nộp án phí') STATUS,
                DECODE(DO.MAGIAIDOAN,2,'Thông báo nộp tiền tạm ứng án phí',3,'Thông báo nộp tiền tạm ứng án phí phúc thẩm') STATUS,
                HC.MA_TEN,
...
--                LEFT JOIN ALD_FILE FL ON FL.DONID=TD.DONID AND FL.BIEUMAUID=67
    ...
    FOR item_tp IN 
            (
            SELECT  TD.URL_FILE,TD.ID TONGDATID,TD.NGAYTAO,THA.ID DONVITHA_ID,NULL TENFILE,'Hành chính' LOAIAN,DO.MAVUVIEC,TD.BIEUMAUID,'6' AS MALOAIVUVIEC,TD.FILEID,TD.DONID,0 DUONGSU_ID,AI.SOTHONGBAO||'/TB-TA' AS SOTHONGBAO,
                DO.TENVUVIEC TENDUONGSU,null NAMSINH,null GIOITINH,null SOCMND,null DIENTHOAI,null EMAIL,TN.MA_TEN DONVI,AI.TAMUNGANPHI,
                --DECODE(tt.TRANGTHAITHANHTOAN,0,'Chưa nộp án phí',1,'Đã nộp án phí') STATUS,
                DECODE(DO.MAGIAIDOAN,2,'Thông báo nộp tiền tạm ứng án phí',3,'Thông báo nộp tiền tạm ứng án phí phúc thẩm') STATUS,
                null MA_TEN,
    ...
    FOR item_tp IN 
            (
                SELECT  TD.URL_FILE,TD.ID TONGDATID,TD.NGAYTAO,THA.ID DONVITHA_ID,NULL TENFILE,'Phá sản' LOAIAN,DO.MAVUVIEC,DO.TENVUVIEC,TD.BIEUMAUID,'7' AS MALOAIVUVIEC,TD.FILEID,TD.DONID,DU.ID DUONGSU_ID,AI.SOTHONGBAO||'/TB-TA' AS SOTHONGBAO,
                DO.TENVUVIEC TENDUONGSU,DU.NAMSINH,DU.GIOITINH,DU.SOCMND,DU.DIENTHOAI,DU.EMAIL,TN.MA_TEN DONVI,AI.TAMUNGANPHI,
                --DECODE(tt.TRANGTHAITHANHTOAN,0,'Chưa nộp án phí',1,'Đã nộp án phí') STATUS,
                DECODE(DO.MAGIAIDOAN,2,'Thông báo nộp tiền tạm ứng án phí',3,'Thông báo nộp tiền tạm ứng án phí phúc thẩm') STATUS,
                HC.MA_TEN,
...
--                LEFT JOIN ALD_FILE FL ON FL.DONID=TD.DONID AND FL.BIEUMAUID=67
    ...
    FOR item_tp IN 
            (
                SELECT TD.URL_FILE,TD.ID TONGDATID,TD.NGAYTAO,THA.ID DONVITHA_ID,NULL TENFILE,'Phá sản' LOAIAN,DO.MAVUVIEC,TD.BIEUMAUID,'7' AS MALOAIVUVIEC,TD.FILEID,TD.DONID,DU.ID DUONGSU_ID,AI.SOTHONGBAO||'/TB-TA' AS SOTHONGBAO,
                'Họ tên:<b> '||DU.TENDUONGSU||'</b><br/> Năm sinh: '||DU.NAMSINH||'<br/> CCCD: '||DU.SOCMND||'<br/> Điên thoại: '||DU.DIENTHOAI||'<br/> Email: '||DU.EMAIL||'<br/>' TENDUONGSU,DU.NAMSINH,DU.GIOITINH,DU.SOCMND,DU.DIENTHOAI,DU.EMAIL,TN.MA_TEN DONVI,AI.TAMUNGANPHI,
                DECODE(tt.TRANGTHAITHANHTOAN,0,'Chưa nộp án phí',1,'Đã nộp án phí') STATUS,HC.MA_TEN,
                DECODE(DU.NDD_DIACHICHITIET,NULL,HC.MA_TEN,REPLACE(DU.NDD_DIACHICHITIET,',')||', '||HC.MA_TEN) AS DIACHI,
                TA.HOANTRAAP_HOTEN,TA.HOANTRAAP_GIOITINH,TA.HOANTRAAP_NAMSINH,TA.HOANTRAAP_CMND,TA.HOANTRAAP_TEL,TA.HOANTRAAP_EMAIL,TA.HOANTRAAP_DIACHI,
...
BEGIN
  ...
  FOR item_tp IN 
            (
                ...
                DECODE(tt.TRANGTHAITHANHTOAN,0,'Chưa nộp án phí',1,'Đã nộp án phí') STATUS,HC.MA_TEN,                
                DECODE(DU.TAMTRUCHITIET,NULL,DU.NDD_DIACHICHITIET,REPLACE(DU.TAMTRUCHITIET,',')||', '||HC.MA_TEN) AS DIACHI,
                TA.HOANTRAAP_HOTEN,TA.HOANTRAAP_GIOITINH,TA.HOANTRAAP_NAMSINH,TA.HOANTRAAP_CMND,TA.HOANTRAAP_TEL,TA.HOANTRAAP_EMAIL,TA.HOANTRAAP_DIACHI,
                TA.NGAYBIENLAI,TA.SOBIENLAI,TA.NGUOITHUTIEN,DX.NGAYGQ_YC,
                TA.NOP_ISNGUYENDON,TA.NOP_GIOITINH
                ,decode(TA.NOP_HOTEN,NULL,TT.HOTENNGUOINOPTIEN,TA.NOP_HOTEN)NOP_HOTEN,TA.NOP_NAMSINH
                ,decode(TA.NOP_CMND,NULL,tt.SOCMNDNGUOINOP,TA.NOP_CMND)NOP_CMND,TA.NOP_TEL,TA.NOP_EMAIL
                ,decode(TA.NOP_DIACHI,NULL,TT.DIACHINGUOINOPTIEN,TA.NOP_DIACHI)NOP_DIACHI
                ,TA.HOANTRAAP_ISNGUYENDON,DU.LOAIDUONGSU
                ,TL.SOTHULY,TA.ANPHIHOANTRA,TA.NGAYHOANTRA,TA.GHICHU_HOANTRA,THA1.TEN,TT.MA_THONGBAO,TT.TT_TRUCTUYEN
                ,FD.FILE_NAME ANPHI_FILE_NAME,TA.NOPCHO_DUONGSUID,TA.NHANCHO_DUONGSUID,AI.NGAYTHONGBAO
                ,DU.SO_CCCD,DU.SO_HO_CHIEU
                FROM ADS_TONGDAT TD 
                INNER JOIN ADS_DON DO ON TD.DONID=DO.ID     
                INNER JOIN DM_TOAAN TN ON TN.ID=DO.TOAANID
                INNER JOIN DM_BIEUMAU BM ON BM.ID=TD.BIEUMAUID
    ...
    LOOP
       ...
       ,item_tp.NOPCHO_DUONGSUID,item_tp.NHANCHO_DUONGSUID,item_tp.NGAYTHONGBAO,item_tp.SO_CCCD,item_tp.SO_HO_CHIEU,item_tp.SO_CCCD,item_tp.SO_HO_CHIEU); 
    END LOOP;
    -----------------------
                 ...
                 FOR item_tp IN 
                        (
                            SELECT TD.NGAYTAO,THA.ID DONVITHA_ID,NULL TENFILE,'Hôn nhân' LOAIAN,DO.MAVUVIEC,TD.BIEUMAUID,'3' AS MALOAIVUVIEC,TD.FILEID,TD.DONID,DU.ID DUONGSU_ID,AI.SOTHONGBAO||'/TB-TA' AS SOTHONGBAO,
                             DU.TENDUONGSU,DU.NAMSINH,DU.GIOITINH,DECODE(DU.SOCMND,NULL,TA.NOP_CMND,DU.SOCMND)SOCMND,DU.DIENTHOAI,DU.EMAIL,TN.MA_TEN DONVI,AI.TAMUNGANPHI,
                            DECODE(tt.TRANGTHAITHANHTOAN,0,'Chưa nộp án phí',1,'Đã nộp án phí') STATUS,HC.MA_TEN,
                            DECODE(DU.TAMTRUCHITIET,NULL,DU.NDD_DIACHICHITIET,REPLACE(DU.TAMTRUCHITIET,',')||', '||HC.MA_TEN) AS DIACHI,
                            TA.HOANTRAAP_HOTEN,TA.HOANTRAAP_GIOITINH,TA.HOANTRAAP_NAMSINH,TA.HOANTRAAP_CMND,TA.HOANTRAAP_TEL,TA.HOANTRAAP_EMAIL,TA.HOANTRAAP_DIACHI,
                            TA.NGAYBIENLAI,TA.SOBIENLAI,TA.NGUOITHUTIEN,DX.NGAYGQ_YC,
          ...
          ELSIF(V_COUNT_DSU>0)THEN  
                 FOR item_tp IN 
                        (
                            ...
                            AP.TENDUONGSU,NULL NAMSINH,NULL GIOITINH,TA.NOP_CMND SOCMND,NULL DIENTHOAI,NULL EMAIL,TN.MA_TEN DONVI,AI.TAMUNGANPHI,
    ...
    -----------------------
     FOR item_tp IN 
            (
                ...
                ,decode(TA.NOP_HOTEN,NULL,TT.HOTENNGUOINOPTIEN,TA.NOP_HOTEN)NOP_HOTEN,TA.NOP_NAMSINH
                ,decode(TA.NOP_CMND,NULL,tt.SOCMNDNGUOINOP,TA.NOP_CMND)NOP_CMND,TA.NOP_TEL,TA.NOP_EMAIL
                ,decode(TA.NOP_DIACHI,NULL,TT.DIACHINGUOINOPTIEN,TA.NOP_DIACHI)NOP_DIACHI,TA.HOANTRAAP_ISNGUYENDON,DU.LOAIDUONGSU
               ,TL.SOTHULY,TA.ANPHIHOANTRA,TA.NGAYHOANTRA,TA.GHICHU_HOANTRA,THA1.TEN,TT.MA_THONGBAO,TT.TT_TRUCTUYEN
               ,FD.FILE_NAME ANPHI_FILE_NAME,TA.NOPCHO_DUONGSUID,TA.NHANCHO_DUONGSUID,AI.NGAYTHONGBAO
               ,DU.SO_CCCD,DU.SO_HO_CHIEU
                FROM ALD_TONGDAT TD 
...
--                LEFT JOIN ALD_FILE FL ON FL.DONID=TD.DONID AND FL.BIEUMAUID=67
     ...
     IF(V_COUNT_DSU=0)THEN
                 FOR item_tp IN 
                        (
                            ...
                            TA.HOANTRAAP_HOTEN,TA.HOANTRAAP_GIOITINH,TA.HOANTRAAP_NAMSINH,TA.HOANTRAAP_CMND,TA.HOANTRAAP_TEL,TA.HOANTRAAP_EMAIL,TA.HOANTRAAP_DIACHI,
                            TA.NGAYBIENLAI,TA.SOBIENLAI,TA.NGUOITHUTIEN,DX.NGAYGQ_YC,
                            TA.NOP_ISNGUYENDON,TA.NOP_GIOITINH,decode(TA.NOP_HOTEN,NULL,TT.HOTENNGUOINOPTIEN,TA.NOP_HOTEN)NOP_HOTEN,TA.NOP_NAMSINH,decode(TA.NOP_CMND,NULL,tt.SOCMNDNGUOINOP,TA.NOP_CMND)NOP_CMND,TA.NOP_TEL,TA.NOP_EMAIL,decode(TA.NOP_DIACHI,NULL,TT.DIACHINGUOINOPTIEN,TA.NOP_DIACHI)NOP_DIACHI,TA.HOANTRAAP_ISNGUYENDON,DU.LOAIDUONGSU
                            ,TL.SOTHULY,TA.ANPHIHOANTRA,TA.NGAYHOANTRA,TA.GHICHU_HOANTRA,THA1.TEN,TT.MA_THONGBAO,TT.TT_TRUCTUYEN,AI.DUONGSU_IDS
                            ,FD.FILE_NAME ANPHI_FILE_NAME,TA.NOPCHO_DUONGSUID,TA.NHANCHO_DUONGSUID,AI.NGAYTHONGBAO
                            ,DU.SO_CCCD,DU.SO_HO_CHIEU
                            FROM AHC_TONGDAT TD 
          ...
          ELSIF(V_COUNT_DSU>0)THEN  
                 FOR item_tp IN 
                        (
                            ...
                            TA.HOANTRAAP_HOTEN,TA.HOANTRAAP_GIOITINH,TA.HOANTRAAP_NAMSINH,TA.HOANTRAAP_CMND,TA.HOANTRAAP_TEL,TA.HOANTRAAP_EMAIL,TA.HOANTRAAP_DIACHI,
                            TA.NGAYBIENLAI,TA.SOBIENLAI,TA.NGUOITHUTIEN,DX.NGAYGQ_YC,
                            TA.NOP_ISNGUYENDON,TA.NOP_GIOITINH,decode(TA.NOP_HOTEN,NULL,TT.HOTENNGUOINOPTIEN,TA.NOP_HOTEN)NOP_HOTEN,TA.NOP_NAMSINH
                            ,decode(TA.NOP_CMND,NULL,tt.SOCMNDNGUOINOP,TA.NOP_CMND)NOP_CMND,TA.NOP_TEL,TA.NOP_EMAIL
                            ,decode(TA.NOP_DIACHI,NULL,TT.DIACHINGUOINOPTIEN,TA.NOP_DIACHI)NOP_DIACHI,TA.HOANTRAAP_ISNGUYENDON,1 LOAIDUONGSU
                            ,TL.SOTHULY,TA.ANPHIHOANTRA,TA.NGAYHOANTRA,TA.GHICHU_HOANTRA,THA1.TEN,TT.MA_THONGBAO,TT.TT_TRUCTUYEN,AI.DUONGSU_IDS
                            ,FD.FILE_NAME ANPHI_FILE_NAME,TA.NOPCHO_DUONGSUID,TA.NHANCHO_DUONGSUID,AI.NGAYTHONGBAO
                            ,NULL SO_CCCD,NULL SO_HO_CHIEU
                            FROM AHC_TONGDAT TD 
    ...
    ----PS
     FOR item_tp IN 
            (
                ...
                TA.NGAYBIENLAI,TA.SOBIENLAI,TA.NGUOITHUTIEN,DX.NGAYGQ_YC,
                TA.NOP_ISNGUYENDON,TA.NOP_GIOITINH,decode(TA.NOP_HOTEN,NULL,TT.HOTENNGUOINOPTIEN,TA.NOP_HOTEN)NOP_HOTEN,TA.NOP_NAMSINH
                ,decode(TA.NOP_CMND,NULL,tt.SOCMNDNGUOINOP,TA.NOP_CMND)NOP_CMND,TA.NOP_TEL,TA.NOP_EMAIL,decode(TA.NOP_DIACHI,NULL,TT.DIACHINGUOINOPTIEN,TA.NOP_DIACHI)NOP_DIACHI,TA.HOANTRAAP_ISNGUYENDON,DU.LOAIDUONGSU
                ,TL.SOTHULY,TA.ANPHIHOANTRA,TA.NGAYHOANTRA,TA.GHICHU_HOANTRA,THA1.TEN,TT.MA_THONGBAO,TT.TT_TRUCTUYEN
                ,FD.FILE_NAME ANPHI_FILE_NAME,TA.NOPCHO_DUONGSUID,TA.NHANCHO_DUONGSUID,AI.NGAYTHONGBAO
                ,DU.SO_CCCD,DU.SO_HO_CHIEU
                FROM APS_TONGDAT TD 
    ...
    --------------------
         ...
         OPEN v_cursor FOR
                ...
                EXTRACT(DAY FROM TP.NGAYTHONGBAO)NGAY_THONGBAO,EXTRACT(MONTH FROM TP.NGAYTHONGBAO)THANG_THONGBAO,EXTRACT(YEAR FROM TP.NGAYTHONGBAO)NAM_THONGBAO,
                ...
                ,TP.NOPCHO_DUONGSUID,TP.NHANCHO_DUONGSUID,TP.NGAYTHONGBAO  
                ,TP.NOP_SO_CCCD,TP.NOP_SO_HO_CHIEU,TP.HOANTRAAP_SO_CCCD,TP.HOANTRAAP_SO_HO_CHIEU
               --  ,decode(CN.TRANG_THAI,0,'- Đang lưu',1,'- Đã gửi',2,'- Đã thu hồi',NULL)TRANG_THAI
                FROM TABLE(v_table) TP
                --LEFT JOIN TUPHAP_ANPHI_CN CN ON CN.TUPHAP_ANPHI_ID=tp.TUPHAP_ANPHI_ID
