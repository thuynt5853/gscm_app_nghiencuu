...
FUNCTION BAOCAO_XETXUTRUCTUYEN_CANBO
(
    VDONVIID  IN number,
...
BEGIN
     ...
     DBMS_LOB.APPEND(V_EXPORT_TEXT_HEAD1,'
      ...
      DBMS_LOB.APPEND(V_EXPORT_TEXT_HEAD2,'
       ...
       FOR v_DM_TOAAN In (  SELECT A.* FROM (
                            ...
                            FROM (SELECT DMTA.ID, DMTA.MA_TEN || ' \ ' || DMCANBO.HOTEN AS MA_TEN, DMTA.LOAITOA, DMTA.ARRSAPXEP
                                    ...
                                    FROM DM_TOAAN DMTA
                                        ...
                                        INNER JOIN DM_CANBO DMCANBO ON DMCANBO.TOAANID = DMTA.ID
                                        
                                        LEFT JOIN DM_TOAAN DMTACAPCHA ON DMTACAPCHA.ID = DMTA.CAPCHAID -- Lấy tên tỉnh cho cấp huyện  
                                        --Hình sự
                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM AHS_SOTHAM_QUYETDINH_VUAN QD
                                                   ...
                                                   GROUP BY QD.NGUOIKYID) AHS_ST_QD ON AHS_ST_QD.NGUOIKYID = DMCANBO.ID  

                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM AHS_PHUCTHAM_QUYETDINH_VUAN QD
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   WHERE QD.HINHTHUCXETXU IN (1,3) AND (EXISTS (SELECT 'X' FROM AHS_PHUCTHAM_BANAN BA WHERE QD.VUANID = BA.VUANID AND BA.NGAYMOPHIENTOA BETWEEN VV_TUNGAY AND VV_DENNGAY ) 
                                                                                     OR EXISTS (SELECT 'X' FROM AHS_PHUCTHAM_QUYETDINH_VUAN QD2 
                                                                                                INNER JOIN DM_QD_QUYETDINH DMQD2 ON DMQD2.ID = QD2.QUYETDINHID AND DMQD2.KET_THUC = 1
                                                                                                WHERE QD.VUANID = QD2.VUANID AND QD2.NGAYMOPT BETWEEN VV_TUNGAY AND VV_DENNGAY))
                                                   GROUP BY QD.NGUOIKYID) AHS_PT_QD ON AHS_PT_QD.NGUOIKYID = DMCANBO.ID


                                        --Dân sự
                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM ADS_SOTHAM_QUYETDINH QD 
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   ...
                                                   GROUP BY QD.NGUOIKYID) ADS_ST_QD ON ADS_ST_QD.NGUOIKYID = DMCANBO.ID                                    
                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM ADS_PHUCTHAM_QUYETDINH QD 
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   WHERE QD.HINHTHUCXETXU IN (1,3) AND (EXISTS (SELECT 'X' FROM ADS_PHUCTHAM_BANAN BA WHERE QD.DONID = BA.DONID AND BA.NGAYMOPHIENTOA BETWEEN VV_TUNGAY AND VV_DENNGAY ) 
                                                                                     OR EXISTS (SELECT 'X' FROM ADS_PHUCTHAM_QUYETDINH QD2
                                                                                                INNER JOIN DM_QD_QUYETDINH DMQD2 ON DMQD2.ID = QD2.QUYETDINHID AND DMQD2.KET_THUC = 1
                                                                                                WHERE QD.DONID = QD2.DONID AND QD2.NGAYMOPT BETWEEN VV_TUNGAY AND VV_DENNGAY))
                                                   GROUP BY QD.NGUOIKYID) ADS_PT_QD ON ADS_PT_QD.NGUOIKYID = DMCANBO.ID


                                        --Hành chính
                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM AHC_SOTHAM_QUYETDINH QD 
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   WHERE QD.HINHTHUCXETXU IN (1,3)  AND (EXISTS (SELECT 'X' FROM AHC_SOTHAM_BANAN BA WHERE QD.DONID = BA.DONID AND BA.NGAYMOPHIENTOA BETWEEN VV_TUNGAY AND VV_DENNGAY ) 
                                                                                     OR EXISTS (SELECT 'X' FROM AHC_SOTHAM_QUYETDINH QD2
                                                                                                INNER JOIN DM_QD_QUYETDINH DMQD2 ON DMQD2.ID = QD2.QUYETDINHID AND DMQD2.KET_THUC = 1
                                                                                                WHERE QD.DONID = QD2.DONID AND QD2.NGAYMOPT BETWEEN VV_TUNGAY AND VV_DENNGAY))
                                                   GROUP BY QD.NGUOIKYID) AHC_ST_QD ON AHC_ST_QD.NGUOIKYID = DMCANBO.ID      

                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM AHC_PHUCTHAM_QUYETDINH QD 
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   WHERE QD.HINHTHUCXETXU IN (1,3) AND (EXISTS (SELECT 'X' FROM AHC_PHUCTHAM_BANAN BA WHERE QD.DONID = BA.DONID AND BA.NGAYMOPHIENTOA BETWEEN VV_TUNGAY AND VV_DENNGAY ) 
                                                                                     OR EXISTS (SELECT 'X' FROM AHC_PHUCTHAM_QUYETDINH QD2
                                                                                                INNER JOIN DM_QD_QUYETDINH DMQD2 ON DMQD2.ID = QD2.QUYETDINHID AND DMQD2.KET_THUC = 1
                                                                                                WHERE QD.DONID = QD2.DONID AND QD2.NGAYMOPT BETWEEN VV_TUNGAY AND VV_DENNGAY))
                                                   GROUP BY QD.NGUOIKYID) AHC_PT_QD ON AHC_PT_QD.NGUOIKYID = DMCANBO.ID

                                        --Hôn nhân
                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM AHN_SOTHAM_QUYETDINH QD 
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   WHERE QD.HINHTHUCXETXU IN (1,3) AND (EXISTS (SELECT 'X' FROM AHN_SOTHAM_BANAN BA WHERE QD.DONID = BA.DONID AND BA.NGAYMOPHIENTOA BETWEEN VV_TUNGAY AND VV_DENNGAY ) 
                                                                                     OR EXISTS (SELECT 'X' FROM AHN_SOTHAM_QUYETDINH QD2
                                                                                                INNER JOIN DM_QD_QUYETDINH DMQD2 ON DMQD2.ID = QD2.QUYETDINHID AND DMQD2.KET_THUC = 1
                                                                                                WHERE QD.DONID = QD2.DONID AND QD2.NGAYMOPT BETWEEN VV_TUNGAY AND VV_DENNGAY))
                                                   GROUP BY QD.NGUOIKYID) AHN_ST_QD ON AHN_ST_QD.NGUOIKYID = DMCANBO.ID

                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM AHN_PHUCTHAM_QUYETDINH QD 
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   WHERE QD.HINHTHUCXETXU IN (1,3) AND (EXISTS (SELECT 'X' FROM AHN_PHUCTHAM_BANAN BA WHERE QD.DONID = BA.DONID AND BA.NGAYMOPHIENTOA BETWEEN VV_TUNGAY AND VV_DENNGAY ) 
                                                                                     OR EXISTS (SELECT 'X' FROM AHN_PHUCTHAM_QUYETDINH QD2
                                                                                                INNER JOIN DM_QD_QUYETDINH DMQD2 ON DMQD2.ID = QD2.QUYETDINHID AND DMQD2.KET_THUC = 1
                                                                                                WHERE QD.DONID = QD2.DONID AND QD2.NGAYMOPT BETWEEN VV_TUNGAY AND VV_DENNGAY))
                                                   GROUP BY QD.NGUOIKYID) AHN_PT_QD ON AHN_PT_QD.NGUOIKYID = DMCANBO.ID

                                        --Lao động
                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM ALD_SOTHAM_QUYETDINH QD 
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   WHERE QD.HINHTHUCXETXU IN (1,3) AND (EXISTS (SELECT 'X' FROM ALD_SOTHAM_BANAN BA WHERE QD.DONID = BA.DONID AND BA.NGAYMOPHIENTOA BETWEEN VV_TUNGAY AND VV_DENNGAY ) 
                                                                                     OR EXISTS (SELECT 'X' FROM ALD_SOTHAM_QUYETDINH QD2
                                                                                                INNER JOIN DM_QD_QUYETDINH DMQD2 ON DMQD2.ID = QD2.QUYETDINHID AND DMQD2.KET_THUC = 1
                                                                                                WHERE QD.DONID = QD2.DONID AND QD2.NGAYMOPT BETWEEN VV_TUNGAY AND VV_DENNGAY))
                                                   GROUP BY QD.NGUOIKYID) ALD_ST_QD ON ALD_ST_QD.NGUOIKYID = DMCANBO.ID

                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM ALD_PHUCTHAM_QUYETDINH QD 
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   WHERE QD.HINHTHUCXETXU IN (1,3) AND (EXISTS (SELECT 'X' FROM ALD_PHUCTHAM_BANAN BA WHERE QD.DONID = BA.DONID AND BA.NGAYMOPHIENTOA BETWEEN VV_TUNGAY AND VV_DENNGAY ) 
                                                                                     OR EXISTS (SELECT 'X' FROM ALD_PHUCTHAM_QUYETDINH QD2
                                                                                                INNER JOIN DM_QD_QUYETDINH DMQD2 ON DMQD2.ID = QD2.QUYETDINHID AND DMQD2.KET_THUC = 1
                                                                                                WHERE QD.DONID = QD2.DONID AND QD2.NGAYMOPT BETWEEN VV_TUNGAY AND VV_DENNGAY))
                                                   GROUP BY QD.NGUOIKYID) ALD_PT_QD ON ALD_PT_QD.NGUOIKYID = DMCANBO.ID
                                        --Kinh tế
                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM AKT_SOTHAM_QUYETDINH QD 
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   WHERE QD.HINHTHUCXETXU IN (1,3) AND (EXISTS (SELECT 'X' FROM AKT_SOTHAM_BANAN BA WHERE QD.DONID = BA.DONID AND BA.NGAYMOPHIENTOA BETWEEN VV_TUNGAY AND VV_DENNGAY ) 
                                                                                     OR EXISTS (SELECT 'X' FROM AKT_SOTHAM_QUYETDINH QD2
                                                                                                INNER JOIN DM_QD_QUYETDINH DMQD2 ON DMQD2.ID = QD2.QUYETDINHID AND DMQD2.KET_THUC = 1
                                                                                                WHERE QD.DONID = QD2.DONID AND QD2.NGAYMOPT BETWEEN VV_TUNGAY AND VV_DENNGAY))
                                                   GROUP BY QD.NGUOIKYID) AKT_ST_QD ON AKT_ST_QD.NGUOIKYID = DMCANBO.ID

                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM AKT_PHUCTHAM_QUYETDINH QD 
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   WHERE QD.HINHTHUCXETXU IN (1,3) AND (EXISTS (SELECT 'X' FROM AKT_PHUCTHAM_BANAN BA WHERE QD.DONID = BA.DONID AND BA.NGAYMOPHIENTOA BETWEEN VV_TUNGAY AND VV_DENNGAY ) 
                                                                                     OR EXISTS (SELECT 'X' FROM AKT_PHUCTHAM_QUYETDINH QD2
                                                                                                INNER JOIN DM_QD_QUYETDINH DMQD2 ON DMQD2.ID = QD2.QUYETDINHID AND DMQD2.KET_THUC = 1
                                                                                                WHERE QD.DONID = QD2.DONID AND QD2.NGAYMOPT BETWEEN VV_TUNGAY AND VV_DENNGAY))
                                                   GROUP BY QD.NGUOIKYID) AKT_PT_QD ON AKT_PT_QD.NGUOIKYID = DMCANBO.ID  
                                        --Án khác  
                                        --Phá sản
                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM APS_SOTHAM_QUYETDINH QD 
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   WHERE QD.HINHTHUCXETXU IN (1,3) AND (EXISTS (SELECT 'X' FROM APS_SOTHAM_BANAN BA WHERE QD.DONID = BA.DONID AND BA.NGAYMOPHIENTOA BETWEEN VV_TUNGAY AND VV_DENNGAY ) 
                                                                                     OR EXISTS (SELECT 'X' FROM APS_SOTHAM_QUYETDINH QD2
                                                                                                INNER JOIN DM_QD_QUYETDINH DMQD2 ON DMQD2.ID = QD2.QUYETDINHID AND DMQD2.KET_THUC = 1
                                                                                                WHERE QD.DONID = QD2.DONID AND QD2.NGAYMOPT BETWEEN VV_TUNGAY AND VV_DENNGAY))
                                                  GROUP BY QD.NGUOIKYID) APS_ST_QD ON APS_ST_QD.NGUOIKYID = DMCANBO.ID
                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM APS_PHUCTHAM_QUYETDINH QD 
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   WHERE QD.HINHTHUCXETXU IN (1,3) AND (EXISTS (SELECT 'X' FROM APS_PHUCTHAM_BANAN BA WHERE QD.DONID = BA.DONID AND BA.NGAYMOPHIENTOA BETWEEN VV_TUNGAY AND VV_DENNGAY ) 
                                                                                     OR EXISTS (SELECT 'X' FROM APS_PHUCTHAM_QUYETDINH QD2
                                                                                                INNER JOIN DM_QD_QUYETDINH DMQD2 ON DMQD2.ID = QD2.QUYETDINHID AND DMQD2.KET_THUC = 1
                                                                                                WHERE QD.DONID = QD2.DONID AND QD2.NGAYMOPT BETWEEN VV_TUNGAY AND VV_DENNGAY))
                                                   GROUP BY QD.NGUOIKYID) APS_PT_QD ON APS_PT_QD.NGUOIKYID = DMCANBO.ID

                                        -- Xử lý hành chính                                           
                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM XLHC_SOTHAM_QUYETDINH QD 
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   WHERE QD.HINHTHUCXETXU IN (1,3) AND (EXISTS (SELECT 'X' FROM XLHC_SOTHAM_BANAN BA WHERE QD.DONID = BA.DONID AND BA.NGAYMOPHIENTOA BETWEEN VV_TUNGAY AND VV_DENNGAY ) 
                                                                                     OR EXISTS (SELECT 'X' FROM XLHC_SOTHAM_QUYETDINH QD2
                                                                                                INNER JOIN DM_QD_QUYETDINH DMQD2 ON DMQD2.ID = QD2.QUYETDINHID AND DMQD2.KET_THUC = 1
                                                                                                WHERE QD.DONID = QD2.DONID AND QD2.NGAYMOPT BETWEEN VV_TUNGAY AND VV_DENNGAY))
                                                   GROUP BY QD.NGUOIKYID) XLHC_ST_QD ON XLHC_ST_QD.NGUOIKYID = DMCANBO.ID

                                        LEFT JOIN (SELECT QD.NGUOIKYID, COUNT('X') AS SL FROM XLHC_PHUCTHAM_QUYETDINH QD 
                                                       INNER JOIN DM_QD_QUYETDINH DMQD ON DMQD.ID = QD.QUYETDINHID AND (DMQD.TEN LIKE '%Quyết định mở phiên họp%' OR DMQD.LOAIID = 5)
                                                   WHERE QD.HINHTHUCXETXU IN (1,3) AND (EXISTS (SELECT 'X' FROM XLHC_PHUCTHAM_BANAN BA WHERE QD.DONID = BA.DONID AND BA.NGAYMOPHIENTOA BETWEEN VV_TUNGAY AND VV_DENNGAY ) 
                                                                                     OR EXISTS (SELECT 'X' FROM XLHC_PHUCTHAM_QUYETDINH QD2
                                                                                                INNER JOIN DM_QD_QUYETDINH DMQD2 ON DMQD2.ID = QD2.QUYETDINHID AND DMQD2.KET_THUC = 1
                                                                                                WHERE QD.DONID = QD2.DONID AND QD2.NGAYMOPT BETWEEN VV_TUNGAY AND VV_DENNGAY))
                                                   GROUP BY QD.NGUOIKYID) XLHC_PT_QD ON XLHC_PT_QD.NGUOIKYID = DMCANBO.ID


                                        LEFT JOIN (SELECT CHUTOAID, COUNT('X') AS SL FROM APS_CAPNHAT_HTXX WHERE MAGIAIDOAN = 2 AND TRANGTHAI = 1 AND NGAYXETXU BETWEEN VV_TUNGAY AND VV_DENNGAY GROUP BY CHUTOAID) STPS_BOSUNG ON STPS_BOSUNG.CHUTOAID = DMCANBO.ID
                                        LEFT JOIN (SELECT CHUTOAID, COUNT('X') AS SL FROM APS_CAPNHAT_HTXX WHERE MAGIAIDOAN = 3 AND TRANGTHAI = 1 AND NGAYXETXU BETWEEN VV_TUNGAY AND VV_DENNGAY GROUP BY CHUTOAID) PTPS_BOSUNG ON PTPS_BOSUNG.CHUTOAID = DMCANBO.ID
                                        LEFT JOIN (SELECT CHUTOAID, COUNT('X') AS SL FROM XLHC_CAPNHAT_HTXX WHERE MAGIAIDOAN = 2 AND TRANGTHAI = 1 AND NGAYXETXU BETWEEN VV_TUNGAY AND VV_DENNGAY GROUP BY CHUTOAID) STXLHC_BOSUNG ON STXLHC_BOSUNG.CHUTOAID = DMCANBO.ID
                                        LEFT JOIN (SELECT CHUTOAID, COUNT('X') AS SL FROM XLHC_CAPNHAT_HTXX WHERE MAGIAIDOAN = 3 AND TRANGTHAI = 1 AND NGAYXETXU BETWEEN VV_TUNGAY AND VV_DENNGAY GROUP BY CHUTOAID) PTXLHC_BOSUNG ON PTXLHC_BOSUNG.CHUTOAID = DMCANBO.ID
       ...
       FOR v_DM_TOAAN In (SELECT A.* FROM (
                            SELECT ROW_NUMBER() OVER (ORDER BY 'X' ASC) AS STT, JJ.MA_TEN,
                                    JJ.STHS, JJ.PTHS, JJ.STHC, JJ.PTHC, JJ.STDS, JJ.PTDS,
                                    JJ.STHN, JJ.PTHN, JJ.STLD, JJ.PTLD, JJ.STKT, JJ.PTKT,
                                    JJ.STPS + jj.STPS_BOSUNG, JJ.PTPS + jj.PTPS_BOSUNG, JJ.STXLHC + jj.STXLHC_BOSUNG, JJ.PTXLHC + jj.PTXLHC_BOSUNG, 
                                    JJ.STPS + JJ.PTPS + JJ.STXLHC + JJ.PTXLHC  + jj.STPS_BOSUNG + jj.PTPS_BOSUNG + jj.STXLHC_BOSUNG + jj.PTXLHC_BOSUNG AS ANKHAC,
                            ...
                            FROM (SELECT DMTA.ID, DMTA.MA_TEN || ' \ ' || DMCANBO.HOTEN AS MA_TEN
                                ...
                                --WHERE (JJ.STPS + JJ.PTPS + JJ.STXLHC + JJ.PTXLHC  + jj.STPS_BOSUNG + jj.PTPS_BOSUNG + jj.STXLHC_BOSUNG + jj.PTXLHC_BOSUNG) > 0
            ...
            LOOP
                ...
                <tr style="text-align: center; vertical-align: middle; height:50px">
                    ...
                    IF(VDONVIID IN (1,4,5,6)) 
                        THEN DBMS_LOB.APPEND(V_EXPORT_TEXT,'<td style="border: 0.1pt solid #000000; text-align: left;" colspan="2"><b>'||v_DM_TOAAN.MA_TEN||'</b></td>');
...
END BAOCAO_XETXUTRUCTUYEN_CANBO;
...
FUNCTION BAOCAO_XETXUTRUCTUYEN_TINHHUYEN
(
    VDONVIID  IN number,
    V_TUNGAY IN VARCHAR2,
    V_DENNGAY IN VARCHAR2,
...
END BAOCAO_XETXUTRUCTUYEN_TINHHUYEN;
