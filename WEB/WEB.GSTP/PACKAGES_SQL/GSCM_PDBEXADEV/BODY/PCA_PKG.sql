...
PROCEDURE PRC_DONGBO_PCA(
  ...
  BEGIN
    ...
    (ID, DONID, CANBOID, MAVAITRO, NGAYPHANCONG, NGUOIPHANCONGID, NGAYTAO, NGUOITAO, ID_PHAN_CONG_AN, TOA_GIAIQUYET_ID) -- UPDATE toa_giaiquyet_id
    ...
    (ID, DONID, CANBOID, MAVAITRO, NGAYPHANCONG, NGUOIPHANCONGID, NGAYTAO, NGUOITAO, ID_PHAN_CONG_AN, TOA_GIAIQUYET_ID)
    ...
    q.ID_TOA_AN
      ...
      (ID, DONID, CANBOID, MAVAITRO, NGAYPHANCONG, NGUOIPHANCONGID, NGAYTAO, NGUOITAO, ID_PHAN_CONG_AN, TOA_GIAIQUYET_ID)
      (SELECT AHN_DON_THAMPHAN_SEQ.NEXTVAL, p.id_vu_an, p.id_tham_phan_ct, p.vai_tro, to_date(p.ngay_phan_cong,'YYYY/MM/DD'), q.id_nguoi_phan_cong, Sysdate, q.nguoi_phan_cong, p.id_phan_cong_an, q.ID_TOA_AN 
       FROM pca_qlpc_phan_cong_an q
       INNER JOIN pca_qlxx_phan_cong_an p ON q.id_pc = p.id_ql_pca
       WHERE q.id_pc = p_ql_pca AND p.loai_an = 'HN');

      INSERT INTO AHS_THAMPHANGIAIQUYET 
      (ID, VUANID, CANBOID, MAVAITRO, NGAYPHANCONG, NGUOIPHANCONGID, NGAYTAO, NGUOITAO, ID_PHAN_CONG_AN, TOA_GIAIQUYET_ID) -- UPDATE toa_gq_id
      ...
      (ID, DONID, CANBOID, MAVAITRO, NGAYPHANCONG, NGUOIPHANCONGID, NGAYTAO, NGUOITAO, ID_PHAN_CONG_AN,TOA_GIAIQUYET_ID) -- UPDATE toa_gq_id
      ...
      (ID, DONID, CANBOID, MAVAITRO, NGAYPHANCONG, NGUOIPHANCONGID, NGAYTAO, NGUOITAO, ID_PHAN_CONG_AN, TOA_GIAIQUYET_ID)
      (SELECT ALD_DON_THAMPHAN_SEQ.NEXTVAL, p.id_vu_an, p.id_tham_phan_ct, p.vai_tro, to_date(p.ngay_phan_cong,'YYYY/MM/DD'), q.id_nguoi_phan_cong, Sysdate, q.nguoi_phan_cong, p.id_phan_cong_an, q.ID_TOA_AN
       FROM pca_qlpc_phan_cong_an q
       INNER JOIN pca_qlxx_phan_cong_an p ON q.id_pc = p.id_ql_pca
