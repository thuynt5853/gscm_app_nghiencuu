--------------------------------------------------------
--  DDL for Package Body PKG_ADS_STPT_DS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "GSCM"."PKG_ADS_STPT_DS" AS
            ...
            AND ( (v_TINHTRANG_THULY IS NULL 
                    AND(   (GD.MAGIAIDOAN = 2 AND (V_NGAYTHULY_TU IS NULL OR  A.NGAYNHANDON >=VV_NGAYTHULY_TU)  AND (V_NGAYTHULY_DEN IS NULL OR A.NGAYNHANDON <=VV_NGAYTHULY_DEN) )
                        OR EXISTS ( SELECT 'X' FROM ADS_CHUYEN_NHAN_AN CNA 
                                    WHERE GD.MAGIAIDOAN = 3 AND (V_NGAYTHULY_TU IS NULL OR  CNA.NGAYNHAN >=VV_NGAYTHULY_TU) 
       ...
       AND (v_THOIHAN_GQ IS NULL
           ...
           --Tình trạng GQ;
            ...
            AND (
                    (
                        ...
                        AND (
                            (
                                ...
                                AND (
                                    V_TUNGAY IS NULL
                                    OR A.NGAYNHANDON >= VV_TUNGAY
                                    )
                                AND (
                                    V_DENNGAY IS NULL
                                    OR A.NGAYNHANDON <= VV_DENNGAY
                                    )
                                )
                            OR EXISTS (
                                SELECT 'X'
                                ...
                                WHERE GD.MAGIAIDOAN = 3
                                    AND (
                                        V_NGAYTHULY_TU IS NULL
                                        OR CNA.NGAYNHAN >= VV_NGAYTHULY_TU
                                        )
                                    AND (
                                        V_NGAYTHULY_DEN IS NULL
                                        OR CNA.NGAYNHAN <= VV_NGAYTHULY_DEN
                                        )
                                )
                            )
                        )
                    OR (
                        v_TINHTRANG_GIAIQUYET = 1 --Chưa giải quyết xong
                        AND --SƠ THẨM
                        ((
                            (
                                EXISTS (
                                ...
                                AND (
                                    ...
                                    EXISTS (
                                        ...
                                        WHERE STTL.DONID = A.ID
                                            AND (
                                                V_TUNGAY IS NULL
                                                OR STTL.NGAYTHULY >= VV_TUNGAY
                                                )
                                            AND (
                                                V_DENNGAY IS NULL
                                                OR STTL.NGAYTHULY <= VV_DENNGAY
                                                )
                                        ) -- =2)
                                    --=3
                                    OR EXISTS (
                                        ...
                                        WHERE PC.DONID = A.ID
                                            AND PC.MAVAITRO = 'VTTP_GIAIQUYETSOTHAM'
                                            AND GD.MAGIAIDOAN = 2 --sơ thẩm
                                            AND (
                                                V_TUNGAY IS NULL
                                    ...
                                    OR EXISTS (
                                        SELECT 'X'
                                        FROM ADS_SOTHAM_QUYETDINH QSV --SO THAM
                                        LEFT JOIN DM_QD_QUYETDINH QD ON QD.ID = QSV.QUYETDINHID
                                        LEFT JOIN DM_QD_LOAI QDL ON QDL.ID = QD.LOAIID
                        ...
                        OR (
                            ...
                            AND (
                                ...
                                OR EXISTS (
                                    SELECT 'X'
                                    FROM ADS_PHUCTHAM_QUYETDINH PTQDVA -- PHUC THAM
                                    LEFT JOIN DM_QD_QUYETDINH QD ON QD.ID = PTQDVA.QUYETDINHID
                                    LEFT JOIN DM_QD_LOAI QDL ON QDL.ID = QD.LOAIID
                                    LEFT JOIN ADS_PHUCTHAM_BANAN BA ON PTQDVA.DONID = BA.DONID
                                    WHERE GD.MAGIAIDOAN = 3
                                        AND QDL.MA = 'DVARXX' --QDL.MA = 'DVARXX' == Đưa vụ án ra xét xử
                                        AND (
                                            V_TUNGAY IS NULL
                    ...
                    OR (
                        v_TINHTRANG_GIAIQUYET = 2 --chưa phân công Thẩm phán
                        AND (
                            EXISTS (
                                SELECT 'X'
                                FROM ADS_SOTHAM_THULY STTL
                        ...
                        AND (
                            NOT EXISTS (
                                ...
                                WHERE PC.DONID = A.ID
                                    AND (
                                        (
                                            PC.MAVAITRO = 'VTTP_GIAIQUYETSOTHAM'
                                            AND GD.MAGIAIDOAN = 2
                                            ) --sơ thẩm
                                        OR (
                    ...
                    OR (
                        v_TINHTRANG_GIAIQUYET = 3 --đã phân công Thẩm phán
                        AND EXISTS (
                            SELECT 'x'
                            FROM ADS_DON_THAMPHAN PC
                            WHERE PC.DONID = A.ID
                    ...
                    OR (
                        v_TINHTRANG_GIAIQUYET = 4 --đã lên lịch xét xử
                        AND (
                            EXISTS (
                                SELECT 'X'
                                FROM ADS_SOTHAM_QUYETDINH QSV
                    ...
                    OR (
                        v_TINHTRANG_GIAIQUYET = 5 --Đang hoãn  
                        AND (
                            EXISTS (
                                -- hoãn sơ thẩm
                                SELECT 'X'
                    ...
                    OR (
                        v_TINHTRANG_GIAIQUYET = 6 --Đang tạm đình chỉ 
                    ...
                    ------------------------------
                    OR (
                        v_TINHTRANG_GIAIQUYET = 7 --Đã giải quyết xong
                        AND (
                            EXISTS (
                                SELECT 'X'
                                FROM ADS_SOTHAM_BANAN BA
                                WHERE BA.SOBANAN IS NOT NULL
                                    AND (
                                        V_TUNGAY IS NULL
                                        OR BA.NGAYTUYENAN >= VV_TUNGAY
                                        )
                                    AND (
                                        V_DENNGAY IS NULL
                                        OR BA.NGAYTUYENAN <= VV_DENNGAY
                                        )
                                    AND BA.DONID = a.id
                                    AND GD.MAGIAIDOAN = 2
                                )
                            ...
                            OR EXISTS (
                                ...
                                WHERE PTBA.SOBANAN IS NOT NULL
                                    AND (
                                        V_TUNGAY IS NULL
                                        OR PTBA.NGAYTUYENAN >= VV_TUNGAY
                                        )
                                    AND (
                                        V_DENNGAY IS NULL
                                        OR PTBA.NGAYTUYENAN <= VV_DENNGAY
                                        )
                                    AND PTBA.DONID = a.id
                                    AND GD.MAGIAIDOAN = 3
                                )
                    ...
                    OR (
                        v_TINHTRANG_GIAIQUYET = 8 --Đã xét xử
                        AND (
                            EXISTS (
                                SELECT 'X'
                                FROM ADS_SOTHAM_BANAN BA
                    ...
                    OR (
                        v_TINHTRANG_GIAIQUYET = 9 --Đình chỉ
                        AND (
                            EXISTS (
                                SELECT 'X'
                                FROM ADS_SOTHAM_QUYETDINH QSV
                    ...
                    OR (
                        v_TINHTRANG_GIAIQUYET = 10 --Công nhận thỏa thuận của đương sự
                        AND (
                            EXISTS (
                                SELECT 'X'
                                FROM ADS_SOTHAM_QUYETDINH QSV
                    ...
                    OR (
                        v_TINHTRANG_GIAIQUYET = 11 --QĐ chuyển vụ án
                        AND (
                            EXISTS (
                                SELECT 'X'
                                FROM ADS_SOTHAM_QUYETDINH QSV
                            ...
                            OR EXISTS (
                                ...
                                WHERE CA.VUANID = a.ID
                                    ...
                                    AND (
                                        V_TUNGAY IS NULL
                                        OR CA.NGAYGIAO >= VV_TUNGAY
                                        )
                                    AND (
                                        V_DENNGAY IS NULL
                                        OR CA.NGAYGIAO <= VV_DENNGAY
                                        )
                                    AND GD.MAGIAIDOAN = 2
                                )
                            OR EXISTS (
