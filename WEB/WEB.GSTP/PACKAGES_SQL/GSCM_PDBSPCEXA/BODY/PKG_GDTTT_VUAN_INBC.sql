...
--                                                               (v.gqd_loaiketqua is not null and (v.GQD_NGAYPHATHANHCV>vvGQD_DenNgay OR v.GDQ_NGAY>vvGQD_DenNgay))
                   ...
                   -- AND v.TrangThaiID  not in (13,14,15,16,18)      
                   )
                ...
                or (
                            (vKetquathuly = 1 
                            AND (vNgayThulyTu is null or (VA.GQD_NGACVS is null or VA.GQD_NGACVS >=vvvNgayThulyTu)  ) AND (vvngaythulyden is null or(VA.GQD_NGACVS is null or VA.GQD_NGACVS <=vvngaythulyden))
                ...
                AND (vKetquathuly!=4 OR (vKetquathuly=4 AND v.NGAYTAO<vvGQD_DenNgay AND v.ISVIENTRUONGKN is null)   )
...
--            -- Trạng thái thụ lý 
         ...
         and ( (isBuocTT = 0)
             ...
             and ( vKetquathuly = 3 
                ...
                or (
                            (vKetquathuly = 1 
                            AND (tt_tungay is null or (VA.GQD_NGACVS is null or VA.GQD_NGACVS >=tt_tungay)  ) AND (vvngaythulyden is null or(VA.GQD_NGACVS is null or VA.GQD_NGACVS <=vvngaythulyden))
                                              AND  (vvngaythulyden is null or( v.NGAYTAO<=vvngaythulyden)) 
                                              AND v.GQD_LOAIKETQUA=1 
                                              AND NVL(isvientruongkn,0) !=1
                                        )
