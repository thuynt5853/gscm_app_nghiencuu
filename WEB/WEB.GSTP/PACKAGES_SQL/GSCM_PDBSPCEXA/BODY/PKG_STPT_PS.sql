...
BEGIN
SELECT COUNT(*) INTO V_COUNTS FROM APS_SOTHAM_THULY TL  WHERE TL.DONID = vDONID AND TL.NGAYTHULY < TO_DATE('26/APR/2022','dd/mon/yyyy');
IF(V_COUNTS>=1)THEN
    OPEN curReturn FOR  
    ...
    And d.ISDON=1 AND d.TUCACHTOTUNG_MA='NGUYENDON' AND ((x.SOBIENLAI is not null AND x.NGAYTHONGBAO >= TO_DATE('26/APR/2022','dd/mon/yyyy')) 
        OR x.NGAYTHONGBAO < TO_DATE('26/APR/2022','dd/mon/yyyy') OR x.NGAYTHONGBAO is null)  
