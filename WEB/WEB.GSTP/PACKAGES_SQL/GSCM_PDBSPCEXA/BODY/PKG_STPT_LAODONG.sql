--------------------------------------------------------
--  DDL for Package Body PKG_STPT_LAODONG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "GSCM"."PKG_STPT_LAODONG" AS
...
BEGIN
SELECT COUNT(*) INTO V_COUNTS FROM ALD_SOTHAM_THULY TL  WHERE TL.DONID = vDONID AND TL.NGAYTHULY < TO_DATE('01/MAY/2022','dd/mon/yyyy');
IF(V_COUNTS>=1)THEN
    OPEN curReturn FOR  
