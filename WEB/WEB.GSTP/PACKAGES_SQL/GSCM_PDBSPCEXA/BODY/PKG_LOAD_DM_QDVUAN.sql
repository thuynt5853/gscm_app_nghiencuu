--------------------------------------------------------
--  DDL for Package Body PKG_LOAD_DM_QDVUAN
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "GSCM"."PKG_LOAD_DM_QDVUAN" AS
...
OPEN curReturn FOR    
    ...
    WHERE ISDANSU = 1 AND ISSOTHAM = 1 AND KET_THUC != 1
...
OPEN curReturn FOR    
    SELECT TEN,ID
    FROM DM_QD_QUYETDINH
    WHERE ISHANHCHINH = 1 AND ISSOTHAM = 1 AND KET_THUC != 1 
            AND TEN like '%Quyết định%' -- Load tất cả quyết định
            AND TEN not like '%Quyết định đình chỉ%' -- Trừ quyết định đình chỉ (vì có Đình chỉ BPXLHC và VDS)
            AND LOAIID != 23   -- Công nhận thuận tình ly hôn và sự thỏa thuận của các đương sự
            AND LOAIID != 10   -- Công nhận thỏa thuận của các đương sự
...
OPEN curReturn FOR    
    SELECT TEN,ID
    FROM DM_QD_QUYETDINH
    WHERE ISHNGD = 1 AND ISSOTHAM = 1 AND KET_THUC != 1 
            AND TEN like '%Quyết định%' -- Load tất cả quyết định
            AND TEN not like '%Quyết định đình chỉ%' -- Trừ quyết định đình chỉ (vì có Đình chỉ BPXLHC và VDS)
            AND LOAIID != 23   -- Công nhận thuận tình ly hôn và sự thỏa thuận của các đương sự
            AND LOAIID != 10   -- Công nhận thỏa thuận của các đương sự
...
OPEN curReturn FOR    
    SELECT TEN,ID
    FROM DM_QD_QUYETDINH
    WHERE  ISHINHSU = 1 AND ISSOTHAM = 1 AND KET_THUC != 1 
            AND TEN like '%Quyết định%' -- Load tất cả quyết định
            AND TEN not like '%Quyết định đình chỉ%' -- Trừ quyết định đình chỉ (vì có Đình chỉ BPXLHC và VDS)
...
OPEN curReturn FOR    
    SELECT TEN,ID
    FROM DM_QD_QUYETDINH
    WHERE ISKDTM = 1 AND ISSOTHAM = 1 AND KET_THUC != 1 
            AND TEN like '%Quyết định%' -- Load tất cả quyết định
            AND TEN not like '%Quyết định đình chỉ%' -- Trừ quyết định đình chỉ (vì có Đình chỉ BPXLHC và VDS)
            AND LOAIID != 23   -- Công nhận thuận tình ly hôn và sự thỏa thuận của các đương sự
            AND LOAIID != 10   -- Công nhận thỏa thuận của các đương sự
...
OPEN curReturn FOR    
    SELECT TEN,ID
    FROM DM_QD_QUYETDINH
    WHERE   ISLAODONG = 1 AND ISSOTHAM = 1 AND KET_THUC != 1 
            AND TEN like '%Quyết định%' -- Load tất cả quyết định
            AND TEN not like '%Quyết định đình chỉ%' -- Trừ quyết định đình chỉ (vì có Đình chỉ BPXLHC và VDS)
            AND LOAIID != 23   -- Công nhận thuận tình ly hôn và sự thỏa thuận của các đương sự
            AND LOAIID != 10   -- Công nhận thỏa thuận của các đương sự
...
OPEN curReturn FOR    
    SELECT TEN,ID
    FROM DM_QD_QUYETDINH 
    WHERE ISPHASAN = 1 AND ISSOTHAM = 1 AND KET_THUC != 1 
            AND TEN like '%Quyết định%' -- Load tất cả quyết định
            AND TEN not like '%Quyết định đình chỉ%' -- Trừ quyết định đình chỉ (vì có Đình chỉ BPXLHC và VDS) 
            AND LOAIID != 23   -- Công nhận thuận tình ly hôn và sự thỏa thuận của các đương sự
            AND LOAIID != 10   -- Công nhận thỏa thuận của các đương sự
...
OPEN curReturn FOR    
    SELECT TEN,ID
    FROM DM_QD_QUYETDINH
    WHERE ISDANSU = 1 AND ISPHUCTHAM = 1 AND KET_THUC != 1
...
OPEN curReturn FOR    
    SELECT TEN,ID
    FROM DM_QD_QUYETDINH
    WHERE ISHANHCHINH = 1 AND ISPHUCTHAM = 1  AND KET_THUC != 1
        AND TEN NOT LIKE '%Quyết định phúc thẩm giải quyết việc dân sự%'
    ORDER BY TEN;
...
OPEN curReturn FOR    
    SELECT TEN,ID
    FROM DM_QD_QUYETDINH
    WHERE ISHNGD = 1 AND ISPHUCTHAM = 1  AND KET_THUC != 1
        AND TEN NOT LIKE '%Quyết định phúc thẩm giải quyết việc dân sự%'
    ORDER BY TEN;
...
OPEN curReturn FOR  
    SELECT TEN,ID
    FROM DM_QD_QUYETDINH
    WHERE  ISHINHSU = 1 AND ISPHUCTHAM = 1  AND KET_THUC != 1
        AND TEN NOT LIKE '%Quyết định phúc thẩm giải quyết việc dân sự%'
...
OPEN curReturn FOR    
    SELECT TEN,ID
    FROM DM_QD_QUYETDINH
    WHERE ISKDTM = 1 AND ISPHUCTHAM = 1  AND KET_THUC != 1
        AND TEN NOT LIKE '%Quyết định phúc thẩm giải quyết việc dân sự%'
    ORDER BY TEN;
...
OPEN curReturn FOR    
    SELECT TEN,ID
    FROM DM_QD_QUYETDINH
    WHERE   ISLAODONG = 1 AND ISPHUCTHAM = 1  AND KET_THUC != 1
        AND TEN NOT LIKE '%Quyết định phúc thẩm giải quyết việc dân sự%'
    ORDER BY TEN;
...
OPEN curReturn FOR    
    SELECT TEN,ID
    FROM DM_QD_QUYETDINH 
    WHERE ISPHASAN = 1 AND ISPHUCTHAM = 1  AND KET_THUC != 1
        AND TEN NOT LIKE '%Quyết định phúc thẩm giải quyết việc dân sự%'
    ORDER BY TEN;
    ...
    IF(VLOAIAN = '1') THEN -- Hình sự
         OPEN curReturn FOR  
            Select q.ID,q.SOQUYETDINH,q.NGAYQD,q.CHUCVU
                ...
                q.HIEULUCTU,q.HIEULUCDEN,ld.TEN as LyDo,q.TENFILE
    ...
    IF(VLOAIAN = '1') THEN -- Hình sự
        OPEN curReturn FOR  
          Select q.ID,q.SOQUYETDINH,q.NGAYQD,q.CHUCVU
              ,d.TEN as TenQD
              ,c.HOTEN as NguoiKy
               ,q.NGAYTAO,q.NGUOITAO,bc.HOTEN,q.TENFILE,q.HINHPHAT_VUAN_KHAC
