...
namespace WEB.GSTP.QTCucTHA.Cauhinh
{
    public partial class CauHinhMatKhau : System.Web.UI.Page
    {
        ...
        {
            var OQuanTri = DataExtensions.FindById<QUANTRI_MATKHAU_ANPHI>(1);
            ...
            DataExtensions.Update<QUANTRI_MATKHAU_ANPHI>(OQuanTri);
        ...
        {
            QUANTRI_MATKHAU_ANPHI OQuanTri = DataExtensions.FindById<QUANTRI_MATKHAU_ANPHI>(1);
