...
namespace WEB.GSTP.QTCucTHA.User
{
    public partial class Danhsach : System.Web.UI.Page
    {
        ...
        private void Load_Data()
        {
            ...
            DataTable oDT = oBL.QT_NGUOIDUNG_SEARCH_THADS(Convert.ToDecimal(ddlDonvi.SelectedValue), txtDonvi.Text, Convert.ToDecimal(ddlLoaiNhom.SelectedValue), txtUserName.Text, txtHoten.Text);
            if (oDT.Rows.Count > 0)
            {
