...
namespace WEB.GSTP.QLAN.APS.TaoHS
{
    public partial class TaoHosoDS : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                DonID = (string.IsNullOrEmpty(Session[ENUM_LOAIAN.AN_PHASAN] + "")) ? 0 : Convert.ToDecimal(Session[ENUM_LOAIAN.AN_PHASAN] + "");
                ...
                APS_PHUCTHAM_THULY oTLPT = dt.APS_PHUCTHAM_THULY.Where(x => x.DONID == DonID).FirstOrDefault() ?? new APS_PHUCTHAM_THULY();
                if (oTLPT.ID > 0){
        ...
        private void LoadInfo(decimal ID)
        {
            ...
            APS_SOTHAM_BANAN oBA = dt.APS_SOTHAM_BANAN.Where(x => x.DONID == oT.ID).FirstOrDefault() ?? new APS_SOTHAM_BANAN();
            if (oBA.ID > 0)
            {
            ...
            {
                APS_SOTHAM_QUYETDINH oQD = dt.APS_SOTHAM_QUYETDINH.Where(x => x.DONID == oT.ID).FirstOrDefault() ?? new APS_SOTHAM_QUYETDINH();
                if (oQD.ID > 0)
                {
            ...
            APS_CHUYEN_NHAN_AN oCN = dt.APS_CHUYEN_NHAN_AN.Where(x => x.VUANID == oT.ID).FirstOrDefault<APS_CHUYEN_NHAN_AN>();
            if (oCN != null)
            {
            ...
            List<APS_DON_DUONGSU> lstNguyendon = dt.APS_DON_DUONGSU.Where(x => x.DONID == oT.ID && x.ISDAIDIEN == 1 && x.TUCACHTOTUNG_MA == ENUM_DANSU_TUCACHTOTUNG.NGUYENDON).ToList();
            ...
            List<APS_DON_DUONGSU> lstBidon = dt.APS_DON_DUONGSU.Where(x => x.DONID == oT.ID && x.ISDAIDIEN == 1 && x.TUCACHTOTUNG_MA == ENUM_DANSU_TUCACHTOTUNG.BIDON).ToList();
        ...
        public void SaveDuongSu_VUVIEC()
        {
            ...
            if (hddID.Value == "" || hddID.Value == "0")
            {
                ...
                if (ddlThuly.SelectedIndex == 0)
                    GD.GAIDOAN_INSERT_UPDATE("7", oT.ID, 2, Convert.ToDecimal(ddlToaxxST.SelectedValue), 0, 0, 0, 0);
        ...
        void UpdateBanAn(decimal VuAnId)
        {
            ...
            DateTime date_temp;
            APS_SOTHAM_BANAN obj = new APS_SOTHAM_BANAN();
            if (VuAnId > 0)
            {
                obj = dt.APS_SOTHAM_BANAN.Where(x => x.DONID == VuAnId).SingleOrDefault<APS_SOTHAM_BANAN>();
                if (obj != null)
                    IsUpdate = true;
                else
                    obj = new APS_SOTHAM_BANAN();
            }
            else
                obj = new APS_SOTHAM_BANAN();
        ...
        {
            Boolean IsUpdate = false;
            APS_SOTHAM_QUYETDINH oND = new APS_SOTHAM_QUYETDINH();
            if (VuAnId > 0)
            {
                oND = dt.APS_SOTHAM_QUYETDINH.Where(x => x.DONID == VuAnId).SingleOrDefault<APS_SOTHAM_QUYETDINH>();
                if (oND != null)
                    IsUpdate = true;
                else
        ...
        void Chuyenan_Nhanan(decimal VuAnID)
        {
            ...
            if (VuAnID > 0)
            {
                oND = dt.APS_CHUYEN_NHAN_AN.Where(x => x.VUANID == VuAnID).SingleOrDefault<APS_CHUYEN_NHAN_AN>();
                if (oND != null)
                    IsUpdate = true;
                else
                    oND = new APS_CHUYEN_NHAN_AN();
            }
            else
                oND = new APS_CHUYEN_NHAN_AN();
            ...
            APS_SOTHAM_KHANGCAO oKC = dt.APS_SOTHAM_KHANGCAO.Where(x => x.DONID == VuAnID).FirstOrDefault<APS_SOTHAM_KHANGCAO>();
            APS_SOTHAM_KHANGNGHI oKN = dt.APS_SOTHAM_KHANGNGHI.Where(x => x.DONID == VuAnID).FirstOrDefault<APS_SOTHAM_KHANGNGHI>();
            ...
            APS_DON oVuAn = dt.APS_DON.Where(x => x.ID == VuAnID).FirstOrDefault();
            ...
            if (ddlThuly.SelectedIndex == 1)
                GD.GAIDOAN_INSERT_UPDATE_XXLAI_PHUCTHAM("7", VuAnID, 3, Convert.ToDecimal(ddlToaxxST.SelectedValue), Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0);
            else
                GD.GAIDOAN_INSERT_UPDATE("7", VuAnID, 3, 0, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0);
        }
        ...
        protected void cmdUpdateKCKN_Click(object sender, EventArgs e)
        {
            ...
            APS_DON oDon = dt.APS_DON.Where(x => x.ID == vDonID).FirstOrDefault();
            if (rdbPanelKC.SelectedValue == KHANGCAO.ToString() && rdbPanelKN.SelectedValue == KHANGCAO.ToString())// Kháng cáo
            {
                ...
                APS_SOTHAM_KHANGCAO oND;
                if (hddKCID.Value == "" || hddKCID.Value == "0")
                {
                    oND = new APS_SOTHAM_KHANGCAO();
                ...
                else
                {
                    ...
                    oND = dt.APS_SOTHAM_KHANGCAO.Where(x => x.ID == ID).FirstOrDefault();
                }
                oND.DONID = vDonID;
                ...
                if (hddKCID.Value == "" || hddKCID.Value == "0")
                {
                    oND.NGAYTAO = DateTime.Now;
                    oND.NGUOITAO = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                    dt.APS_SOTHAM_KHANGCAO.Add(oND);
                }
                else
                {
                    oND.NGAYSUA = DateTime.Now;
            ...
            else if (rdbPanelKC.SelectedValue == KHANGNGHI.ToString() && rdbPanelKN.SelectedValue == KHANGNGHI.ToString())// Kháng nghị
            {
                ...
                APS_SOTHAM_KHANGNGHI oND;
                if (hddKNID.Value == "" || hddKNID.Value == "0")
                    oND = new APS_SOTHAM_KHANGNGHI();
                else
                {
                    ID = Convert.ToDecimal(hddKNID.Value);
                    oND = dt.APS_SOTHAM_KHANGNGHI.Where(x => x.ID == ID).FirstOrDefault();
                }
                oND.DONID = vDonID;
                ...
                if (hddKNID.Value == "" || hddKNID.Value == "0")
                {
                    oND.NGAYTAO = DateTime.Now;
                    oND.NGUOITAO = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                    dt.APS_SOTHAM_KHANGNGHI.Add(oND);
                }
                else
                {
                    oND.NGAYSUA = DateTime.Now;
            ...
            ResetControlsKCKN();
            LoadGridKCKN();
            lstMsgT.Text = lstMsgB.Text = "Hoàn thành Lưu đề nghị Kháng Nghị!";
        ...
        protected void cmdXoaHoSo_Click(object sender, EventArgs e)
        {
            ...
            APS_PHUCTHAM_THULY oTLPT = dt.APS_PHUCTHAM_THULY.Where(x => x.DONID == ID).FirstOrDefault() ?? new APS_PHUCTHAM_THULY();
            if (oTLPT.ID == 0)
            {
                APS_DON oVa = dt.APS_DON.Where(x => x.ID == ID).First();
                if (oVa != null)
                {
        ...
        public void XoaHoSo(decimal ID)
        {
            ...
            if (oBLDS.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oT.ID), 7, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Tạo hồ sơ KC/KN án Phá sản", "Xóa", json) == false)
            {
                return;
            }//Ket thuc

            //Tất cả Hồ sơ theo DonID 
            APS_DON_BL oBL = new APS_DON_BL();
            if (oBL.DELETE_ALLDATA_BY_VUANID(ID + "") == true)
            {
                //Xóa thông tin Giai đoan
                GIAI_DOAN_BL GD = new GIAI_DOAN_BL();
                GD.GIAIDOAN_DELETES("7", ID,2);
            }
           
        }
        public void xoAPS(decimal id)
        {
            APS_DON_DUONGSU oT = dt.APS_DON_DUONGSU.Where(x => x.ID == id).FirstOrDefault();
            //Luu thông tin đương sự trước khi xóa
            string strUserName = Session[ENUM_SESSION.SESSION_USERNAME] + "";
            var json = new JavaScriptSerializer().Serialize(oT);
            ADS_DON_BL oBLDS = new ADS_DON_BL();
            if (oBLDS.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oT.ID), 7, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Xoa Duong su trong Tạo hồ sơ KC/KN Phá sản", "Xóa", json) == false)
            {
                return;
            }//Ket thuc 

            //Xoa Duong su
            dt.APS_DON_DUONGSU.Remove(oT);
            dt.SaveChanges();
        }
        ...
        void Load_ListBiCan( decimal vDonid)
        {
            ...
            //Load đương sự
            ddlNguoikhangcao.DataSource = oDSBL.APS_SOTHAM_DUONGSU_GETBY(vDonid, 1);
        ...
        void Load_ListNguoiThamGiaToTung(decimal vDonid)
        {
            ...
            string hoten = "";
            List<APS_DON_THAMGIATOTUNG> lst = dt.APS_DON_THAMGIATOTUNG.Where(x => x.DONID == vDonid).ToList();
            if (lst != null && lst.Count > 0)
            {

                foreach (APS_DON_THAMGIATOTUNG item in lst)
                {
        ...
        {
            String temp = "";
            List<APS_SOTHAM_BANAN> lst = dt.APS_SOTHAM_BANAN.Where(x => x.DONID == DonID).OrderByDescending(y => y.NGAYTUYENAN).ToList();
            if (lst != null && lst.Count > 0)
            {
                foreach (APS_SOTHAM_BANAN item in lst)
                {
        ...
        {
            String temp = "";
            APS_SOTHAM_BL objBL = new APS_SOTHAM_BL();
            DataTable tblQD = objBL.APS_SOTHAM_QUYETDINH_GETLIST(DonID);
        ...
        private void LoadQD_BA_InfoKhangCao(decimal vDonid)
        {
            ...
            if (rdbLoaiKC.SelectedValue == "0")
            {
                ...
                APS_SOTHAM_BANAN oT = dt.APS_SOTHAM_BANAN.Where(x => x.ID == ID).FirstOrDefault();
                if (oT != null)
                {
            ...
            {
                decimal ID = Convert.ToDecimal(ddlSOQDBA_KC.SelectedValue);
                APS_SOTHAM_QUYETDINH oT = dt.APS_SOTHAM_QUYETDINH.Where(x => x.ID == ID).FirstOrDefault();
                if (oT != null)
                {
        ...
        public void LoadGridKCKN()
        {
            ...
            decimal ID = (string.IsNullOrEmpty(Session[ENUM_LOAIAN.AN_PHASAN] + "")) ? 0 : Convert.ToDecimal(Session[ENUM_LOAIAN.AN_PHASAN] + "");
            DataTable oDT = oBL.APS_SOTHAM_KCaoKNghi_GETLIST(ID);
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                //APS_SOTHAM_KHANGCAO oKC = dt.APS_SOTHAM_KHANGCAO.Where(x => x.DONID == DONID).FirstOrDefault();
        ...
        public void LoadEdit(decimal ID, decimal IsKhangCao)
        {
            ...
            if (IsKhangCao == KHANGCAO)// Kháng cáo
            {
                ...
                APS_SOTHAM_KHANGCAO oND = dt.APS_SOTHAM_KHANGCAO.Where(x => x.ID == ID).FirstOrDefault();
                if (oND != null)
                {
            ...
            else // Kháng nghị
            {
                ...
                APS_SOTHAM_KHANGNGHI oND = dt.APS_SOTHAM_KHANGNGHI.Where(x => x.ID == ID).FirstOrDefault();
                if (oND != null)
                {
                    hddID.Value = oND.DONID.ToString();
        ...
        public void xoa(decimal ID, decimal IsKhangCao)
        {
            if (IsKhangCao == KHANGCAO)// Kháng cáo
            {
                ...
                if (oND != null)
                {
                    dt.APS_SOTHAM_KHANGCAO.Remove(oND);
                }
            }
            else // Kháng nghị
            {
                ...
                if (oND != null)
                {
                    dt.APS_SOTHAM_KHANGNGHI.Remove(oND);
                }
            }
            dt.SaveChanges();
        ...
        protected void rdbDonVi_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                decimal vdonid = Convert.ToDecimal(hddID.Value);
                APS_DON oD = dt.APS_DON.Where(x => x.ID == vdonid).FirstOrDefault();
                decimal ToaAnID = 0;
                if (oD != null)
        ...
        {
            if (isKhangCao == KHANGCAO)// đề nghị
            {
                ...
                {
                    lbthongbao.Text = "Ngày đề nghị chưa nhập hoặc không theo định dạng (dd/MM/yyyy)!";
                ...
                {
                    lbthongbao.Text = "Chưa chọn người đề nghị. Hãy chọn lại!";
                    ddlNguoikhangcao.Focus();
                    return false;
                }
                if (rdbLoaiKC.SelectedValue == "")
                {
                    lbthongbao.Text = "Bạn chưa chọn loại đề nghị. Hãy chọn lại!";
                    return false;
                }
                ...
                {
                    lbthongbao.Text = "Bạn chưa chọn loại đề nghị quá hạn. Hãy chọn lại!";
                    return false;
                }
               

                //Kiểm tra ngày đề nghị
                ...
                {
                    lbthongbao.Text = "Ngày đề nghị không được lớn hơn ngày hiện tại !";
                    txtNgaykhangcao.Focus();
                    return false;
                }
                ...
                if (rdbLoaiKC.SelectedValue == "0")//Bản án
                {
                    ...
                    {
                        lbthongbao.Text = "Ngày đề nghị không được trước ngày bản án !";
                        txtNgaykhangcao.Focus();
                        return false;
                    }
                }
                else//Quyết định
                {
                    if (dNgayKC < dNgayQDBA)
                    {
                        lbthongbao.Text = "Ngày đề nghị không được trước ngày quyết định !";
                        txtNgaykhangcao.Focus();
                        return false;
                    }
                }
        ...
        protected void lkThemDuongSuKhac_Click(object sender, EventArgs e)
        {
            ...
            string StrMsg = "PopupReport('/QLAN/APS/TaoHS/Popup/pDuongsu.aspx?hsID=" + DonID.ToString() + "&bID=0','Thêm người tham gia tố tụng',950,450);";
        ...
        protected void lkThemNguoiTGTT_Click(object sender, EventArgs e)
        {
            ...
            string StrMsg = "PopupReport('/QLAN/APS/TaoHS/Popup/pNguoiThamgiaTT.aspx?hsID=" + DonID.ToString() + "&bID=0','Thêm người tham gia tố tụng',950,450);";
            System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), StrMsg, true);
        }
