<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true"
    CodeBehind="TaoHosoPS.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.TaoHS.TaoHosoDS" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/QLAN/APS/TaoHS/Popup/pDuongSuKhac.ascx" TagPrefix="uc1" TagName="DsDuongSu" %>
<%@ Register Src="~/QLAN/APS/TaoHS/Popup/uDSNguoiThamGiaToTung.ascx" TagPrefix="uc1" TagName="uDSNguoiThamGiaToTung" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="box">
        <div class="box_nd">
            <div class="truong">
                ...
                <div class="boxchung">
                    <h4 class="tleboxchung">Thông tin Hồ sơ đề nghị/ Kháng nghị</h4>
                        ...
                        <table style="border-width: 0;border-collapse: collapse;border-spacing: 0; margin: 0px;padding: 0px;
                           ...
                           <table>
                                <tr style="height:30px">
                                    ...
                                    <asp:DropDownList ID="ddlQuanhephapluat" CssClass="chosen-select" runat="server" Width="260px" AutoPostBack="True" OnSelectedIndexChanged="ddlQuanhephapluat_SelectedIndexChanged"></asp:DropDownList></td>
                                    <td>QHPL dùng cho thống kê<span class="batbuoc">(*)</span></td>
                                    <td colspan="3">
                                        <asp:DropDownList ID="ddlQHPLTK" CssClass="chosen-select" runat="server" Width="260px"></asp:DropDownList>
                                    </td>
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>Loại đề nghị<span class="batbuoc">(*)</span></td>
                                <td>
    ...
    <script type="text/javascript">
        ...
        function validate_khangcao() {
            ...
            msg = 'Bạn chưa chọn loại đề nghị. Hãy kiểm tra lại!';
            ...
            msg = 'Mục "đề nghị quá hạn" chưa được chọn. Hãy kiểm tra lại!';
