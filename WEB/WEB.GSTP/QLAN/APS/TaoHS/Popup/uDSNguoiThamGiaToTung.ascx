<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uDSNguoiThamGiaToTung.ascx.cs" Inherits="WEB.GSTP.QLAN.APS.TaoHS.Popup.uDSNguoiThamGiaToTung" %>
...
<script>
    function popup_form_edit(curr_id) {
        var link = "";
        if (curr_id > 0)
            link = "/QLAN/APS/TaoHS/Popup/pNguoiThamGiaTT.aspx?hsID=<%=Donid%>&uID=" + curr_id;
        else
            link = "/QLAN/APS/TaoHS/Popup/pNguoiThamGiaTT.aspx?hsID=<%=Donid%>";
        var width = 950;
        var height = 350;
