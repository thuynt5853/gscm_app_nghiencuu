<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pDuongsu.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.TaoHS.Popup.pDuongsu" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/QLAN/APS/TaoHS/Popup/pDuongSuKhac.ascx" TagPrefix="uc1" TagName="pDuongSuKhac" %>
                        ...
                        <div class="boxchung">
                            ...
                            <div class="boder" style="padding: 10px;">
                                ...
                                <table class="table1">
                                    ...
                                    <tr><td colspan="4" ><uc1:pDuongSuKhac runat="server" ID="pDuongSuKhac" /></td></tr>
                                </table>
                            </div>
                        </div>
                    </div>
