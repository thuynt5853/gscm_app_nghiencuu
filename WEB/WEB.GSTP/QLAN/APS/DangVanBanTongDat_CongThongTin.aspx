<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="DangVanBanTongDat_CongThongTin.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.DangVanBanTongDat_CongThongTin" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlLoai" CssClass="chosen-select" runat="server" Width="408px">
                                    ...
                                    <asp:ListItem Text="Thông báo phá sản" Value="5"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
