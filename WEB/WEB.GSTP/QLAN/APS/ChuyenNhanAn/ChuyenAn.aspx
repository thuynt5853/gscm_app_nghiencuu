<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="ChuyenAn.aspx.cs"
    Inherits="WEB.GSTP.QLAN.APS.ChuyenNhanAn.ChuyenAn" %>
                    ...
                    <table class="table1">
                                             ...
                                             <tr>
                                                ...
                                                <td colspan="3">
                                                    <asp:RadioButtonList ID="rdbLoai" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="rdbTrangthai_SelectedIndexChanged">
                                                        <asp:ListItem Value="1" Text="Chuyển án"  Selected="True"></asp:ListItem>
                                                        <asp:ListItem Value="0" Text="Chuyển đơn"></asp:ListItem>
                                                    </asp:RadioButtonList>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width: 90px;">Tên vụ việc</td>
                                                <td>
                        ...
                        <tr>
                             <td align="center">
                                ...
                                <asp:Button ID="cmdNhandon" runat="server" CssClass="buttoninput" Text="Chuyển đơn" OnClick="cmdNhanan_Click" />
                                <asp:Button ID="cmdHuyChuyendon" runat="server" CssClass="buttoninput" Text="Hủy chuyển đơn" OnClientClick="return confirm('Bạn thực sự muốn hủy chuyển đơn này? ');" OnClick="cmdHuyChuyen_Click" />
                                <% } else { %>
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4" PageSize="10" AllowPaging="True" GridLines="None" PagerStyle-Mode="NumericPages" CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-Width="30px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkChon" AutoPostBack="true" ToolTip='<%#Eval("V_CHUYENNHANID")%>' OnCheckedChanged="chkChon_CheckedChanged" runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-Width="85px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lbtHuyChuyen" runat="server" ForeColor="#0e7eee" CausesValidation="false" Text="Hủy chuyển án"
                                                    CommandName="HuyChuyen" CommandArgument='<%#Eval("V_CHUYENNHANID") %>'
