...
namespace WEB.GSTP.QLAN.APS.SoTham
{
    public partial class TrungCauGD : System.Web.UI.Page
    {
        ...
        APS_TRUNGCAU_GIAMDINH obj = new APS_TRUNGCAU_GIAMDINH();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                APS_TRUNGCAU_GIAMDINH oT = dt.APS_TRUNGCAU_GIAMDINH.Where(x => x.VUANID == VuAnID && x.MAGIAIDOAN == MaGiaiDoan).SingleOrDefault();
                if (oT != null)
                {
                    LoadInfo();
                }
        ...
        protected void cmdUpdateBottom_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                obj = dt.APS_TRUNGCAU_GIAMDINH.Where(x => x.VUANID == mavuan && x.MAGIAIDOAN == MaGiaidoan).SingleOrDefault();
            }
            catch (Exception ex)
            {
            ...
            {
                obj = new APS_TRUNGCAU_GIAMDINH();
                save_trungcau_giamdinh();
                obj.NGAYTAO = DateTime.Now;
                obj.NGUOITAO = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                dt.APS_TRUNGCAU_GIAMDINH.Add(obj);
                dt.SaveChanges();
            }
