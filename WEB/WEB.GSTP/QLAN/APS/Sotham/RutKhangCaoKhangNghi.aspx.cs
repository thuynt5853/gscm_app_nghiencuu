...
namespace WEB.GSTP.QLAN.APS.Sotham
{
    public partial class RutKhangCaoKhangNghi : System.Web.UI.Page
    {
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.APS_ST_KCKN_TINHTRANG_GETLIST(ID);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataGridItem item in dgList.Items)
                {
                    ...
                    {
                        APS_SOTHAM_KHANGCAO kc = dt.APS_SOTHAM_KHANGCAO.Where(x => x.ID == KCKNID).FirstOrDefault();
                        if (kc != null)
                        {
                    ...
                    {
                        APS_SOTHAM_KHANGNGHI kn = dt.APS_SOTHAM_KHANGNGHI.Where(x => x.ID == KCKNID).FirstOrDefault();
                        if (kn != null)
                        {
                    ...
                    if (NgayRut < dayKCKN)
                    {
                        ...
                        lbthongbao.Text = "Ngày rút phải lớn hơn ngày khiếu nại/kháng nghị " + dayKCKNstr + ". Hãy nhập lại!";
                        txtNgayRut.Focus();
                        txtNgayRut.ForeColor = Color.Red;
                        return;
                    }
                    ...
                    {
                        APS_SOTHAM_RUTKCKN oND = dt.APS_SOTHAM_RUTKCKN.Where(x => x.DONID == DonID
                                                                               && x.ISKCKN == isKhangCao
                                                                               && x.IDKCKN == KCKNID).FirstOrDefault();
                        APS_SOTHAM_KHANGCAO kc = dt.APS_SOTHAM_KHANGCAO.Where(x => x.DONID == DonID
                                                                                && x.ID == KCKNID).FirstOrDefault();
                        APS_SOTHAM_KHANGNGHI kn = dt.APS_SOTHAM_KHANGNGHI.Where(x => x.DONID == DonID
                                                                                && x.ID == KCKNID).FirstOrDefault();
                        if (oND == null)
                        {
                            isNew = true;
                            oND = new APS_SOTHAM_RUTKCKN();
        ...
        void XoaKhangCao_KN(decimal curr_id)
        {
            if (curr_id > 0)
            {
                APS_SOTHAM_RUTKCKN oT = dt.APS_SOTHAM_RUTKCKN.Where(x => x.ID == curr_id).FirstOrDefault();
                APS_SOTHAM_KHANGCAO kc = dt.APS_SOTHAM_KHANGCAO.Where(x => x.ID == oT.IDKCKN).FirstOrDefault();
                APS_SOTHAM_KHANGNGHI kn = dt.APS_SOTHAM_KHANGNGHI.Where(x => x.ID == oT.IDKCKN).FirstOrDefault();
                if (oT != null)
                {
                    if (kc != null)
                    {
                    ...
                    dt.APS_SOTHAM_RUTKCKN.Remove(oT);
                    dt.SaveChanges();
                }
            }
