...
namespace WEB.GSTP.QLAN.APS.Sotham
{
    public partial class NguoiTienhanhTT : System.Web.UI.Page
    {
        ...
        private void CheckQuyen(decimal ID)
        {
            ...
            APS_DON_THAMPHAN obj = dt.APS_DON_THAMPHAN.Where(x => x.DONID == ID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETSOTHAM).OrderByDescending(x => x.NGAYNHANPHANCONG).FirstOrDefault();
            if (obj != null)
            {
            ...
            List<APS_DON_THAMPHAN> lst = dt.APS_DON_THAMPHAN.Where(x => x.DONID == ID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETSOTHAM).ToList<APS_DON_THAMPHAN>();
            ...
            APS_SOTHAM_BANAN oBA = dt.APS_SOTHAM_BANAN.Where(x => x.DONID == ID).FirstOrDefault();
            if (oBA != null)
            {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                APS_SOTHAM_HDXX obj = dt.APS_SOTHAM_HDXX.Where(x => x.ID == ID).FirstOrDefault();
                if (obj != null)
                {

                    APS_CHUYEN_NHAN_AN chuyenan = dt.APS_CHUYEN_NHAN_AN.Where(x => x.VUANID == DONID).OrderByDescending(x => x.ID).FirstOrDefault();
                    if (chuyenan != null)
                    {
                        if (obj.NGAYTAO <= chuyenan.NGAYTAO)
                        {
                            List<APS_SOTHAM_QUYETDINH> qd = dt.APS_SOTHAM_QUYETDINH.Where(x => x.DONID == DONID).ToList();
                        ...
                        {
                            List<APS_SOTHAM_QUYETDINH> qd = dt.APS_SOTHAM_QUYETDINH.Where(x => x.DONID == DONID && x.NGAYTAO > chuyenan.NGAYTAO).ToList();
                            if ((qd != null && qd.Count > 0))
                            {
                                lblSua.Visible = false;
                                lbtXoa.Visible = false;
                ...
                //APS_SOTHAM_QUYETDINH qd = dt.APS_SOTHAM_QUYETDINH.Where(x => x.DONID == DONID).FirstOrDefault();
                //if (qd != null)
                //{
                //    lblSua.Visible = false;
                //    lbtXoa.Visible = false;
        ...
        private void LoadCombobox()
        {
            ...
            ddlTucachTGTT.Items.Add(new ListItem("Thẩm phán thành viên", ENUM_NGUOITIENHANHTOTUNG.THAMPHANHDXX));
            ...
            if (loaiQD != null)
            {
                APS_SOTHAM_QUYETDINH qd = dt.APS_SOTHAM_QUYETDINH.Where(x => x.DONID == DonID && x.LOAIQDID == loaiQD.ID).FirstOrDefault<APS_SOTHAM_QUYETDINH>();
                if (qd != null)
                {
                    APS_DON_THAMPHAN tpgq = dt.APS_DON_THAMPHAN.Where(x => x.DONID == DonID && x.MAVAITRO == "VTTP_GIAIQUYETSOTHAM").OrderByDescending(x => x.NGAYTAO).FirstOrDefault<APS_DON_THAMPHAN>();
                    if (tpgq != null)
                    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<APS_DON_THAMPHAN> countTPGQ = dt.APS_DON_THAMPHAN.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETSOTHAM).ToList();
                List<APS_SOTHAM_HDXX> countChuToa = dt.APS_SOTHAM_HDXX.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).ToList();
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    if (tucach == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN)
                    {
                        ...
                        oND = dt.APS_SOTHAM_HDXX.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).FirstOrDefault<APS_SOTHAM_HDXX>();
                    ...
                    oND = new APS_SOTHAM_HDXX();
                }
                else
                {
                    decimal ID = Convert.ToDecimal(hddid.Value);
                    oND = dt.APS_SOTHAM_HDXX.Where(x => x.ID == ID).FirstOrDefault();
                }
                oND.DONID = DONID;
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    ADS_SOTHAM_HDXX CheckCanBo = dt.ADS_SOTHAM_HDXX.Where(x => x.DONID == DONID && x.CANBOID == oND.CANBOID).FirstOrDefault();
        ...
        public void LoadGrid()
        {
            ...
            string current_id = Session[ENUM_LOAIAN.AN_PHASAN] + "";
            decimal ID = Convert.ToDecimal(current_id);
            DataTable oDT = oBL.APS_SOTHAM_HDXX_GETLIST(ID);
        ...
        {
            APS_SOTHAM_HDXX oND = dt.APS_SOTHAM_HDXX.Where(x => x.ID == id).FirstOrDefault();
            dt.APS_SOTHAM_HDXX.Remove(oND);
            dt.SaveChanges();
            dgList.CurrentPageIndex = 0;
            LoadGrid();
            ResetControls();
