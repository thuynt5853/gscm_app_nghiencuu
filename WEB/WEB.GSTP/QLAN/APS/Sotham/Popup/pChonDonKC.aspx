<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="pChonDonKC.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.Sotham.Popup.pChonDonKC" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="boxchung">
                    <h4 class="tleboxchung">Chọn đơn đề nghị</h4>
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                                <td class="KCHNCol1">Tên người đề nghị</td>
                                <td class="KCHNCol2">
                                            ...
                                            <HeaderTemplate>
                                                <table class="table2" width="100%" border="1">
                                                    <tr class="header">
                                                        ...
                                                        <td width="80px">
                                                            <div align="center"><strong>Loại đề nghị</strong></div>
                                                        </td>
                                                        <td width="80px">
                                                            <div align="center"><strong>Ngày đề nghị</strong></div>
                                                        </td>
                                                        <td width="80px">
                                                            <div align="center"><strong>Ngày viết đơn</strong></div>
                                                        </td>
                                                        <td width="200px">
                                                            <div align="center"><strong>Nội dung đề nghị</strong></div>
                                                        </td>
                                                        <td width="42px">
