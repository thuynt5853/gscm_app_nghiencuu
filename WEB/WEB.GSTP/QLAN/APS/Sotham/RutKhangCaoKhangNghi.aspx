<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="RutKhangCaoKhangNghi.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.Sotham.RutKhangCaoKhangNghi" %>
    ...
    <div class="box">
        <div class="box_nd" style="width: 99%;">
            <div class="truong">
                <table class="table1">
                    <tr>
                        <td><b>DANH SÁCH ĐỀ NGHỊ, KHÁNG NGHỊ</b></td>
                    </tr>
                    <tr>
                        <td>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-Width="50px" HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                    <div class="tooltip">
                                                        ...
                                                        <span class="tooltiptext  tooltip-bottom">Xóa đề nghị</span>
                                                    </div>
                                            </ItemTemplate>
