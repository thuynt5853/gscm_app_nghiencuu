<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Sauxetxu.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.Sauxetxu" %>
                                    ...
                                    <div class="boder" style="padding: 10px;">
                                        <table class="table1">
                                            ...
                                            <tr>
                                                <td>Số QĐ/BA</td>
                                                <td>
                                                    <asp:TextBox ID="txtSoQDBA" CssClass="user" runat="server" Width="242px" MaxLength="50"></asp:TextBox></td>
                                                <td>Tên đương sự</td>
                                                <td>
                                                    <asp:TextBox ID="txtTenDuongSu" CssClass="user" runat="server" Width="242px" MaxLength="250"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td>Ngày QĐ/BA từ</td>
                                                <td>
                            ...
                            <td>
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4" PageSize="10" AllowPaging="True" GridLines="None" PagerStyle-Mode="NumericPages" CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="GiaiDoan" HeaderText="Giai đoạn" HeaderStyle-Width="135px" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
    ...
    <script type="text/javascript">
        ...
        function validateUpdate() {
            ...
            if (lengthNgayRutKN == 0) {
                alert('Bạn phải nhập ngày họp theo định dạng (dd/MM/yyyy).');
                txtNgayRutKN.focus();
                return false;
            }
            if (lengthNgayRutKN > 0) {
