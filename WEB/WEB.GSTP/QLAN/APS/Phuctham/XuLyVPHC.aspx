<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="XuLyVPHC.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.Phuctham.XuLyVPHC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="text-align: center; margin: 5px; width: 95%; padding-top: 25px;">
        <h3>Xử lý vi phạm hành chính trong quá trình giải quyết vụ việc phá sản</h3>
    </div>
    <div class="box">
        <div class="box_nd">
            <div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="height: 20px; padding-bottom: 10px;">
                                    <asp:TextBox ID="txtSoTien" runat="server" Width="100px" CssClass="user align_right" onkeyup="javascript:this.value=Comma(this.value);" onkeypress="return isNumber(event)"></asp:TextBox>
                                    <b>VND</b>
                                </div>
                            </td>
                            <td></td>
        ...
        <div class="box_nd">
            ...
            <div class="boxchung">
                <h4 class="tleboxchung">Hình phạt bổ sung</h4>
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
            ...
            <div class="boxchung">
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            <td style="width: 180px">
                                <h4>Áp dụng biện pháp khắc phục hẩu quả</h4>
                            </td>
                            <td>
                                <asp:TextBox ID="txtKhacPhuc" runat="server" Width="100px" CssClass="user align_right" onkeypress="return isNumber(event)"></asp:TextBox>
                            </td>
