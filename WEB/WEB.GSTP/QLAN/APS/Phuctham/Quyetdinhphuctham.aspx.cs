...
namespace WEB.GSTP.QLAN.APS.Phuctham
{
    public partial class Quyetdinhphuctham : System.Web.UI.Page
    {
        ...
        public void LoadGrid()
        {
            ...
            DM_QUYETDINH_VUAN oBL = new DM_QUYETDINH_VUAN();
            DataTable oDT = oBL.DGLIST_QUYETDINH_PT(ENUM_LOAIVUVIEC_NUMBER.AN_PHASAN, ID);
            if (oDT != null)
            {
        ...
        public void xoa(decimal id)
        {
            ...
            if (oBL.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oND.DONID), 7, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Quyết định Phúc thẩm án Phá sản", "Xóa", json) == false)
            {
