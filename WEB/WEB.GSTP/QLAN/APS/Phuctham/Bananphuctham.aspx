<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Bananphuctham.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.Phuctham.Bananphuctham" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="boxchung">
        <h4 class="tleboxchung">QUYẾT ĐỊNH/BẢN ÁN TUYÊN BỐ PHÁ SẢN</h4>
        <div class="boder" style="padding: 10px;">
            <table class="table1">
                ...
                <tr>
                    <td style="width: 135px;">Số quyết định<span class="batbuoc">(*)</span></td>
                    <td style="width: 198px;">
                        <asp:TextBox ID="txtSobanan" CssClass="user" runat="server" Width="90px" MaxLength="250"></asp:TextBox>
                    </td>
                    <td style="width: 128px;">Ngày mở phiên họp<span class="batbuoc">(*)</span></td>
                    <td>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:DropDownList ID="ddlKetQuaPhucTham" CssClass="chosen-select" runat="server" Width="438px" AutoPostBack="true" OnSelectedIndexChanged="ddlKetQuaPhucTham_SelectedIndexChanged"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td>Kết quả phúc thẩm<span class="batbuoc">(*)</span></td>
                    <td colspan="3">
                        <asp:DropDownList ID="ddlLyDoBanAn" CssClass="chosen-select" runat="server" Width="438px"></asp:DropDownList>
                    </td>
                </tr>
                    ...
                    <td colspan="4">
                        ...
                        <div class="boxchung">
                            ...
                            <div class="boder" style="padding: 10px;">
                                <table class="table1">
                                    <tr>
                                        <td style="width: 324px;">VKS có kháng nghị nhưng không được chấp nhận</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>VKS rút kháng nghị nhưng đương sự không rút đơn đề nghị</td>
                                        <td>
                ...
                <tr>
                    <td colspan="4" style="text-align: center;">
                        <asp:Button ID="cmdUpdate" runat="server" CssClass="buttoninput" Text="Lưu thông tin quyết định" OnClientClick="return ValidInputData();" OnClick="cmdUpdate_Click" />
                        <asp:Button ID="cmdHuyBanAn" runat="server" CssClass="buttoninput"
                            Text="Xóa quyết định" OnClick="cmdHuyBanAn_Click"
