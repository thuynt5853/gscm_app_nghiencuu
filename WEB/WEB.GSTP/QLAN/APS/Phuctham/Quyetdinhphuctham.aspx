<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Quyetdinhphuctham.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.Phuctham.Quyetdinhphuctham" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <table class="table1">
                        ...
                        <asp:Panel ID="pnLyDo" runat="server">
                            <tr>
                                <td>Lý do</td>
                                <td colspan="3">
                                    <asp:DropDownList ID="ddlLydo" CssClass="chosen-select" runat="server" Width="650px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </asp:Panel>
    ...
    <script type="text/javascript">
        function ValidInputData() {
            ...
            if (lengthSoQD > 20) {
                alert('Số quyết định không quá 20 ký tự!');
                txtSoQD.focus();
                return false;
            }--%>
