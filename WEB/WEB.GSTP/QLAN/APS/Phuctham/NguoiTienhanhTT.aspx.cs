    ...
    public partial class NguoiTienhanhTT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    DataTable oDT = oBL.DGLIST_BAQD_QUYETDINH_KETTHUC_PT(ENUM_LOAIVUVIEC_NUMBER.AN_PHASAN, DONID);
                    if (oDT.Rows.Count > 0)
                    {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                APS_PHUCTHAM_QUYETDINH qd = dt.APS_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DONID).FirstOrDefault();
                if (qd != null)
                {
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.APS_PHUCTHAM_HDXX_GETLIST(ID);
        ...
        public void xoa(decimal id)
        {
            ...
            APS_PHUCTHAM_QUYETDINH APS_PHUCTHAM_QUYETDINH = dt.APS_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DONID).FirstOrDefault<APS_PHUCTHAM_QUYETDINH>();
        ...
        public void loadedit(decimal ID)
        {
            ...
            if (tucach == ENUM_CHUCDANH.CHUCDANH_HTND || tucach == ENUM_NGUOITIENHANHTOTUNG.THUKY || tucach == ENUM_NGUOITIENHANHTOTUNG.THUKYDUKHUYET)
            {
                if (ddlHTND_Thuky.Items.FindByValue(oND.CANBOID + "") != null)
                    ddlHTND_Thuky.SelectedValue = oND.CANBOID + "";
                if (ddlHTND_NguoiPC.Items.FindByValue(oND.NGUOIPHANCONGID + "") != null)
                    ddlHTND_NguoiPC.SelectedValue = oND.NGUOIPHANCONGID + "";

                //if (oND.DUKHUYET != null) rdbDuKhuyet.SelectedValue = oND.DUKHUYET.ToString();
            ...
            {
                if (ddlKSV_Nguoi.Items.FindByValue(oND.CANBOID + "") != null)
                    ddlKSV_Nguoi.SelectedValue = oND.CANBOID + "";
                pnThamphan.Visible = false;
