<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="NguoiThamgiaTT.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.Phuctham.NguoiThamgiaTT" %>
                    ...
                    <asp:Panel ID="pnNew" runat="server">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>Nơi tạm trú</td>
                                <td>
                                    <asp:TextBox ID="txtND_TTChitiet" CssClass="user" runat="server" Width="100%" MaxLength="250"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>Giới tính</td>
                                <td colspan="3">
                                    ...
                                    <span class="namsinh">Năm sinh</span>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <span class="namsinh">Email</span>
                                    <asp:TextBox ID="txtEmail" CssClass="user floatF" runat="server" Width="150px"></asp:TextBox>
                                </td>
                            </tr>
