        ...
        private void ChuyenDonSangToaAnMoi(APS_DON oDon, decimal DonXyLyID, APS_DON_XULY obj, decimal ToaAnCuEdit)
        {
            if (DonXyLyID == 0)
            {
                ...
                foreach (var item in lstoDS)
                {
                    ...
                    oDS.NGANHKINHTEID = item.NGANHKINHTEID;
                    oDS.DIACHICOQUAN = item.DIACHICOQUAN;
                    oDS.ID_DUONGSU_TACC = item.ID_DUONGSU_TACC;
                    oDS.ISDONCHITIET = item.ISDONCHITIET;
                    oDS.ISDAIDIEN_DONCHITIET = item.ISDAIDIEN_DONCHITIET;
                    oDS.SO_CCCD = item.SO_CCCD;
                    oDS.SO_HO_CHIEU = item.SO_HO_CHIEU;
