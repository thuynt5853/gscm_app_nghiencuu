...
namespace WEB.GSTP.QLAN.APS.XuLyDon.Popup
{
    public partial class pBoSungTaiLieu : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    DataTable obj = aDXL.APS_GETALL_DON_YCBS(Convert.ToDecimal(DONID), xuLyID, 1, 20);
                    ...
                    APS_DON_XULY donXL = dt.APS_DON_XULY.Where(x => x.ID == xuLyID).FirstOrDefault();
        ...
        private bool CheckValid(decimal DONID)
        {
            ...
            // APS_TONGDAT oTD = dt.APS_TONGDAT.Where(x => x.DONID == DONID).FirstOrDefault();
            // if (oTD != null)
            // {
        ...
        protected void cmdCapNhat_Click(object sender, EventArgs e)
        {
            ...
            decimal xuLyID = (String.IsNullOrEmpty(Request["ID"] + "")) ? 0 : Convert.ToDecimal(Request["ID"] + "");
            APS_DON_XULY oXuLy = dt.APS_DON_XULY.Where(x => x.ID == xuLyID).FirstOrDefault();
            string bienphap = dropBienPhapGQ.SelectedValue;
            APS_DON oDon = dt.APS_DON.Where(x => x.ID == DONID).FirstOrDefault();
            ...
            DataTable checkGQ = oBLYC.CHECK_NGAYGQ_DON_YCBS(obj.ID, xuLyID, 7, txtNgayGQ.Text);
            ...
            switch (bienphap)
            {
                ...
                default://Thụ lý
                    ...
                    rFileID = UploadFileID(oDon, FileID, "05-vDS", "", "");
                    if (rFileID > 0) obj.FILEID = rFileID;
            ...
            APS_DON_XULY objXuLy = dt.APS_DON_XULY.Where(x => x.ID == obj.DON_XULY_YCBS_ID).FirstOrDefault();
            ...
            DataTable oDT = oBLYC.APS_GETALL_DON_YCBS(DONID, objXuLy.ID, 1, 1);
            ...
            DataTable objYCBS = oBLYC.APS_GETALL_DON_YCBS(Convert.ToDecimal(DONID), obj.DON_XULY_YCBS_ID.Value, 1, 20);
            ...
            else
            {
                ...
                if (oDonNew != null)
                {
                    if (oDonNew.TOAANID.Value != obj.CDTN_TOAANID)
                    {
                        ...
                        GIAI_DOAN_BL GD = new GIAI_DOAN_BL();
                        GD.GAIDOAN_UPDATE("7", oDonNew.ID, 2, Convert.ToDecimal(oDonNew.TOAANID), 0, 0, 0, 0);
                    }
                }
        ...
        protected void Reset()
        {
            ...
            DataTable donYCBS = oBLYC1.APS_GETALL_DON_YCBS(Convert.ToDecimal(DONID), xuLyID, 1, 20);
        ...
        protected void dgDS_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Xoa":
                    ...
                    DataTable obj = oBLDel.APS_GETALL_DON_YCBS(Convert.ToDecimal(DONID), ID_DON_YCBS, 1, 20);
                    if (e.Item.ItemIndex == 0 && obj.Rows.Count > 0)
                    {
                        APS_DON_XULY objXuLy = dt.APS_DON_XULY.Where(x => x.ID == ID_DON_YCBS).FirstOrDefault();
                    ...
                    {
                        APS_DON_XULY objXuLy = dt.APS_DON_XULY.Where(x => x.ID == ID_DON_YCBS).FirstOrDefault();
                        dt.APS_DON_XULY.Remove(objXuLy);
                        dt.SaveChanges();
                    }
        ...
        private void validateEnableButton(decimal DONID, decimal DON_YCBSID)
        {
            decimal xuLyID = (String.IsNullOrEmpty(Request["ID"] + "")) ? 0 : Convert.ToDecimal(Request["ID"] + "");
            ADS_DON_XULY_BL aDXL = new ADS_DON_XULY_BL();
            DataTable objYCBS = aDXL.APS_GETALL_DON_YCBS(Convert.ToDecimal(DONID), xuLyID, 1, 20);
        ...
        protected void dgDS_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                decimal ID_DON_YCBS = Convert.ToDecimal(Request.QueryString["ID"].ToString());
                APS_DON_XULY oXL = dt.APS_DON_XULY.Where(x => x.ID == ID_DON_YCBS).FirstOrDefault();
                ...
                if (e.Item.ItemIndex == 0)
                {
                    ...
                    DataTable anphiList = oBL.CHECK_APS_DON_DUONGSU_ANPHI_V2(DONID, DONCHITIETID, ISDONCHITIET);
                ...
                // DataTable obj = oB.APS_GETALL_DON_YCBS(Convert.ToDecimal(DONID), ID_DON_YCBS, 1, 20);
                ...
                string current_id = Session[ENUM_LOAIAN.AN_PHASAN] + "";
                decimal DONIDHandle = Convert.ToDecimal(current_id);

                APS_DON oT = dt.APS_DON.Where(x => x.ID == DONID).FirstOrDefault();
                APS_SOTHAM_THULY oTLST = dt.APS_SOTHAM_THULY.Where(x => x.DONID == DONIDHandle).FirstOrDefault();
                if (oT.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM || oTLST != null)
                {
                    cmdEdit.Visible = false;
                    cmdXoa.Visible = false;
        ...
        private void LoadDSTL()
        {
            ...
            DataTable oDT = oBL.APS_GETALL_DON_YCBS(DONID, ID_DON_YCBS, pageindex, page_size);
            dgDS.DataSource = oDT;
            dgDS.DataBind();
        }
    }
