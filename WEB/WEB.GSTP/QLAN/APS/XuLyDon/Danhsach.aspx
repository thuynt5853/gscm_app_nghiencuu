<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Danhsach.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.XuLyDon.Danhsach" %>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:TemplateColumn HeaderStyle-Width="105px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <br />
                                                                    <asp:LinkButton ID="lbtLichSuXuLy" runat="server" CausesValidation="false" Text="Lịch sử xử lý" ForeColor="#0e7eee" CommandName="BoSung"
