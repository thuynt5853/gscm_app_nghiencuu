<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Danhsach.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.AnPhi.Danhsach" %>
                                        ...
                                        <asp:DataGrid ID="rpt" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center">
                                                    <HeaderTemplate>
                                                        Người yêu cầu/ Đối tượng bị yêu cầu
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <%#Eval("DUONGSU") %>
                                                    </ItemTemplate>
