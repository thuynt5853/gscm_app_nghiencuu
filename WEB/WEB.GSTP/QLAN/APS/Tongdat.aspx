<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Tongdat.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.Tongdat" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn ItemStyle-Width="120px" HeaderStyle-Width="120px" HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <div style="float: left">
                                                    <asp:TextBox CssClass="floatleft cus_input" Width="75%" Height="21px" ID="txtNoiNhan" Visible="false" runat="server" />
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="110px">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:DropDownList Visible="false" Width="100%" Height="30px" CssClass="cus_input" runat="server" ID="ddlTCTT" OnSelectedIndexChanged="ddlTCTT_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                           <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="110px">
                                            <HeaderTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderStyle-Width="170px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        ...
                                        <asp:TemplateColumn HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left">
                                            ...
                                            <ItemTemplate>
                                                <div>
                                                    <i>Trạng thái:</i>   <b>
                                                        <asp:Label runat="server" ID="lbTrangThai"></asp:Label></b>
                                                </div>
                                                <div>
                                                    <i>Hình thức gửi:</i> <b>
                                                        <asp:Label runat="server" ID="lbtHinhthucgui"></asp:Label></b>
                                                </div>
