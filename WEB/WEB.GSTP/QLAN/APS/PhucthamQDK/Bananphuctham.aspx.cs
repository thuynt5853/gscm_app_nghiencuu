...
namespace WEB.GSTP.QLAN.APS.PhucthamQDK
{
    public partial class Bananphuctham : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    hddDonID.Value = Session[ENUM_LOAIAN.AN_PHASAN] + "";
        ...
        {
            decimal DONID = Convert.ToDecimal(hddDonID.Value);
            string Result = new APS_CHUYEN_NHAN_AN_BL().Check_ChuyenNhanAn(DONID, "Không được sửa đổi thông tin.", Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]));
            if (Result != "")
            {
            ...
            List<APS_KCKNQDK_PHUCTHAM_THULY> lstCount = DataExtensions.GetAllWithClause<APS_KCKNQDK_PHUCTHAM_THULY>("DONID = " + DONID);
            ...
            APS_KCKNQDK_PHUCTHAM_QUYETDINH qd64DS = DataExtensions.GetAllWithClause<APS_KCKNQDK_PHUCTHAM_QUYETDINH>($"DONID = {DONID} AND QUYETDINHID = 64").FirstOrDefault();
            if (qd64DS == null)
            {
            ...
            List<APS_KCKNQDK_PHUCTHAM_QUYETDINH> lstQD = DataExtensions.GetAllWithClause<APS_KCKNQDK_PHUCTHAM_QUYETDINH>("DONID = " + DONID + " AND (LOAIQDID IN (10,3) OR QUYETDINHID IN (213,145,146))");
            if (lstQD.Count >= 1)
            {
                pnQDVV.Visible = true;
            ...
            //                                                                ).FirstOrDefault();
            //APS_KCKNQDK_PHUCTHAM_QUYETDINH oQD = DataExtensions.GetAllWithClause<APS_KCKNQDK_PHUCTHAM_QUYETDINH>
        ...
        private void LoadFile()
        {
            ...
            List<APS_PHUCTHAM_BANAN_FILE> lst = dt.APS_PHUCTHAM_BANAN_FILE.Where(x => x.BANANID == DonID).ToList();
        ...
        private void LoadDropQuanhephapluat()
        {
            ...
            ddlQuanhephapluat.DataSource = oBL.DM_DATAITEM_GETBY2GROUPNAME(ENUM_DANHMUC.QUANHEPL_YEUCAUPS, ENUM_DANHMUC.QUANHEPL_YEUCAU);
        ...
        {
            decimal ID = Session[ENUM_LOAIAN.AN_PHASAN] + "" == "" ? 0 : Convert.ToDecimal(Session[ENUM_LOAIAN.AN_PHASAN]);
            //APS_PHUCTHAM_THULY oT = dt.APS_PHUCTHAM_THULY.Where(x => x.DONID == ID).FirstOrDefault();
            APS_KCKNQDK_PHUCTHAM_THULY oT = DataExtensions.GetAllWithClause<APS_KCKNQDK_PHUCTHAM_THULY>("DONID = " + ID).FirstOrDefault();
        ...
        private void txtQuanhephapluat_name(APS_PHUCTHAM_BANAN oT)
        {
            ...
            {
                APS_PHUCTHAM_BANAN oTT = dt.APS_PHUCTHAM_BANAN.Where(x => x.DONID == oT.DONID).FirstOrDefault();
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.APS_PHUCTHAMKCKNQDK_BANANQUYETDINH_GETLIST(ID);
        ...
        private void LoadQD()
        {
            ...
            DataTable oDT = oBL.APS_DM_QUYETDINH_VUAN_PTQDK();
        ...
        private void LoadNguoiKyInfo()
        {
            ...
            APS_KCKNQDK_PHUCTHAM_HDXX oND = DataExtensions.GetAllWithClause<APS_KCKNQDK_PHUCTHAM_HDXX>("DONID = " + DonID + " AND MAVAITRO ='" + ENUM_NGUOITIENHANHTOTUNG.THAMPHAN + "'").FirstOrDefault<APS_KCKNQDK_PHUCTHAM_HDXX>();
            if (oND != null)
            {
        ...
        {
            Decimal ID = Convert.ToDecimal(hddDonID.Value);
            //List<APS_PHUCTHAM_QUYETDINH> lstQD = dt.APS_PHUCTHAM_QUYETDINH.Where(x => x.DONID == ID && (x.LOAIQDID == 10 || x.QUYETDINHID == 423 || x.QUYETDINHID == 422 || x.LOAIQDID == 3 || x.LOAIQDID == 23)).ToList();
            List<APS_KCKNQDK_PHUCTHAM_QUYETDINH> lstQD = DataExtensions.GetAllWithClause<APS_KCKNQDK_PHUCTHAM_QUYETDINH>
        ...
        public void xoa(decimal id)
        {
            ...
            APS_KCKNQDK_PHUCTHAM_QUYETDINH oND = DataExtensions.FindById<APS_KCKNQDK_PHUCTHAM_QUYETDINH>(id);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                APS_KCKNQDK_PHUCTHAM_QUYETDINH oND;
                decimal STTQD = 0;
                if ((hddid.Value == "" || hddid.Value == "0"))
                {
                    oND = new APS_KCKNQDK_PHUCTHAM_QUYETDINH();
                ...
                else
                {
                    ...
                    oND = DataExtensions.FindById<APS_KCKNQDK_PHUCTHAM_QUYETDINH>(ID);
                    if (oND.TOAANID.ToString() != Session[ENUM_SESSION.SESSION_DONVIID].ToString())
                    {
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                case "Download":
                    var oND = DataExtensions.FindById<APS_KCKNQDK_PHUCTHAM_QUYETDINH>(ND_id);
                    if (oND.TENFILE != "")
                    {
                        var cacheKey = Guid.NewGuid().ToString("N");
        ...
        protected void set_valueLydo(APS_KCKNQDK_PHUCTHAM_QUYETDINH oND)
        {
        ...
        private void LoadDropKetQuaQuyetdinhPhuctham()
        {
            ...
            ddlKetquaQuyetdinh.DataSource = dt.DM_KETQUA_PHUCTHAM.Where(x => x.ISAPS == 1 && x.ISQUYETDINH == 1).OrderBy(y => y.THUTU).ToList();
