<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="DuongSu.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.Hoso.DuongSu" %>
                    ...
                    <table class="table1">
                        <tr>
                            ...
                            <td style="width: 260px;">
                                <asp:DropDownList ID="ddlTucachTotung" CssClass="chosen-select" runat="server" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlTucachTotung_SelectedIndexChanged"></asp:DropDownList>
                            </td>
                            <%--<td style="width: 110px;">Đương sự là<span class="batbuoc">(*)</span></td>--%>

                            <td>
                                <asp:Label ID="lbDuongSu" runat="server"></asp:Label></td>
                            <td>
                                <asp:DropDownList ID="ddlLoaiNguyendon" CssClass="chosen-select" runat="server" Width="250px">
                                </asp:DropDownList>
                            </td>

                        </tr>
                        <asp:Panel ID="pnLoaiHinhDoanhNghiep" runat="server">
                            <tr>
                                <td style="width: 145px;">Loại hình doanh nghiệp<span class="batbuoc">(*)</span></td>
                                <td style="width: 260px;">
                                    <asp:DropDownList ID="ddlLoaiHinh" CssClass="chosen-select" runat="server" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlLoaiHinh_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lbTenDuongSu" runat="server"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="txtTennguyendon" CssClass="user" runat="server" Width="242px"></asp:TextBox></td>
                            <asp:Panel ID="lbLoadDuongSu" runat="server" Visible="false">
                                <td>Đương sự là <span class="batbuoc">(*)</span></td>
                                <td>
                                    <asp:DropDownList ID="ddlDuongSu" CssClass="chosen-select" runat="server" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlDuongSu_SelectedIndexChanged">
                        ...
                        <asp:Panel ID="pnCuTru" runat="server">
                            <%--<tr>
                            ...
                            <asp:Panel runat="server" ID="pndata" Visible="false">
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="250px">
                                            <HeaderTemplate>
                                                Tên đương sự
                                            </HeaderTemplate>
                                            <ItemTemplate>
