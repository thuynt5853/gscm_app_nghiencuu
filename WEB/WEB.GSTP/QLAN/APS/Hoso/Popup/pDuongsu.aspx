<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pDuongsu.aspx.cs" Inherits="WEB.GSTP.QLAN.APS.Hoso.Popup.pDuongsu" %>
                            ...
                            <div class="boder" style="padding: 10px;">
                                <table class="table1">
                                    <tr>
                                        ...
                                        <%--<td style="width: 110px;">Đương sự là<span class="batbuoc">(*)</span></td>--%> 
                                         ...
                                         <td><asp:Label id="lbDuongSu"  runat="server"></asp:Label></td>
                                        <td>
                                ...
                                <td> 
                                    ...
                                    <tr>
                                      ...
                                      <td><asp:Label id="lbTenDuongSu"  runat="server"></asp:Label></td>
                                        <td >
