...
namespace WEB.GSTP.QLAN.APS.Hoso
{
    public partial class NguoiThamgiaTT : System.Web.UI.Page
    {
        ...
        private void LoadCombobox()
        {
            ...
            ddlTucachTGTT.DataSource = oBL.DM_DATAITEM_GETBYGROUPNAME(ENUM_DANHMUC.TUCACHTGTTPS);
        ...
        private void ResetControls()
        {
            ...
            if (ddlTucachTGTT.SelectedValue == "TGTTPS_02" || ddlTucachTGTT.SelectedValue == "TGTTPS_07" )
            {
        ...
        {
            if (ddlTucachTGTT.SelectedValue == "0" || string.IsNullOrEmpty(ddlTucachTGTT.SelectedValue))
            {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                APS_DON_THAMGIATOTUNG oND;
                if (hddid.Value == "" || hddid.Value == "0")
                    oND = new APS_DON_THAMGIATOTUNG();
                else
                {
                    decimal ID = Convert.ToDecimal(hddid.Value);
                    oND = dt.APS_DON_THAMGIATOTUNG.Where(x => x.ID == ID).FirstOrDefault();
                }
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    dt.APS_DON_THAMGIATOTUNG.Add(oND);
                    dt.SaveChanges();
                }
                else
                {
        ...
        public void LoadGrid()
        {
            ...
            string current_id = Session[ENUM_LOAIAN.AN_PHASAN] + "";
            decimal ID = Convert.ToDecimal(current_id);
            DataTable oDT = oBL.APS_DON_TGTT_GETLIST(ID);
        ...
        {
            APS_DON_THAMGIATOTUNG oND = dt.APS_DON_THAMGIATOTUNG.Where(x => x.ID == id).FirstOrDefault();
            dt.APS_DON_THAMGIATOTUNG.Remove(oND);
            dt.SaveChanges();
            dgList.CurrentPageIndex = 0;
            LoadGrid();
            ResetControls();
        ...
        protected void ddlTuCachTGTT_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlTucachTGTT.SelectedValue == "TGTTPS_01")
            {
                pnItemDs.Visible = true;
            }
            else
