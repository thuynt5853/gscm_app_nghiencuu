<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master"
    ...
    Inherits="WEB.GSTP.QLAN.NhanBanGiao" %>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList
                                                        ...
                                                        <asp:ListItem
                                                            Value="1"
                                                            Text="Chưa giải quyết xong"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <asp:Button
                                    ...
                                    CssClass="buttoninput"
                                    Text="Trả lại án"
                                    OnClientClick="return confirm('Bạn thực sự muốn trả lại các án này? ');"
                                        ...
                                        <asp:TemplateColumn
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton
                                                    ...
                                                    CommandName="TraLai"
                                                    CommandArgument='<%#Eval("MAPPINGID") %>'
                                                    OnClientClick="return confirm('Bạn thực sự muốn trả lại án này? ');"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                    </Columns>
