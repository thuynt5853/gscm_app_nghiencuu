<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="KhangCao.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.SoTham.KhangCao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="box_nd">
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            <td style="width: 130px;">Người kháng cáo<span class="batbuoc">(*)</span></td>
                            <td style="width: 305px;">
                                <asp:RadioButtonList ID="rdbNguoiKCLoai" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="1" Text="bị can" Selected="True"></asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNgayvietdon" runat="server" CssClass="user" Width="90px" MaxLength="10"></asp:TextBox>
                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtNgayvietdon" Format="dd/MM/yyyy" Enabled="true" />
                                <cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server" TargetControlID="txtNgayvietdon" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                            </td>
                            <td>Ngày kháng cáo<span class="batbuoc">(*)</span></td>
                            <td>
                                <asp:TextBox ID="txtNgaykhangcao" runat="server" CssClass="user" Width="90px" MaxLength="10"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>KC quá hạn</td>
                            <td>
                                <asp:RadioButtonList ID="rdbQuahan" runat="server" RepeatDirection="Horizontal">
                        ...
                        <tr>
                            <td>Ngày QĐ/BA</td>
                            <td>
                                <asp:TextBox ID="txtNgayQDBA" Enabled="false" runat="server" ReadOnly="true" CssClass="user" Width="90px" MaxLength="10"></asp:TextBox>
                            ...
                            <td>
                                <asp:TextBox ID="txtToaAnQD" ReadOnly="true" Enabled="false" runat="server" CssClass="user" Width="98%"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtNoidung" runat="server" CssClass="user" Width="100%" TextMode="MultiLine" Height="50px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>File đính kèm</td>
                            ...
                            <td colspan="2">
                                <asp:LinkButton ID="lbtDownload" Visible="false" runat="server" Text="Download file đính kèm" OnClick="lbtDownload_Click"></asp:LinkButton></td>
                        </tr>
                        <tr>
            ...
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            <td style="width: 115px;">Ngày giải quyết</td>
                            <td style="width: 305px;">
                            ...
                            <td style="width: 115px;">Thẩm phán</td>
                            <td>
                                <asp:DropDownList ID="ddlGQ_Thamphan" CssClass="chosen-select" runat="server" Width="450px"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>Chấp nhận</td>
                            <td>
                                <asp:RadioButtonList ID="rdbChapnhan" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="1" Text="Chấp nhận" Selected="True"></asp:ListItem>
                                    <asp:ListItem Value="0" Text="Không chấp nhận"></asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                            <td>Ghi chú</td>
                            <td>
                                <asp:TextBox ID="txtGQGhichu" runat="server" CssClass="user" Width="98%" MaxLength="250"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <table class="table1">
                    <tr>
                        <td colspan="2" style="text-align: center">
                            <asp:Button ID="cmdUpdate" runat="server" CssClass="buttoninput" Text="Lưu" OnClientClick="return ValidData();" OnClick="btnUpdate_Click" />
                            ...
                            <asp:Panel runat="server" ID="pndata" Visible="false">
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="NGAYKHANGCAO" HeaderText="Ngày kháng cáo" HeaderStyle-Width="75px" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundColumn>
                                        <asp:TemplateColumn HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>
                                                Loại kháng cáo
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <%#Eval("TENLOAIKHANGCAO") %>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>
                                        ...
                                        <asp:BoundColumn DataField="NGAYQDBA" HeaderText="Ngày QĐ/BA" HeaderStyle-Width="75px" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundColumn>
    ...
    <script type="text/javascript">
        function ValidData() {
            ...
            var txtNgayvietdon = document.getElementById('<%=txtNgayvietdon.ClientID%>');
            if (Common_CheckEmpty(txtNgayvietdon.value)) {
                if (!CheckDateTimeControl(txtNgayvietdon, 'Ngày viết đơn'))
                    return false;
            }
            ...
            if (counter == 0) {
                alert('Bạn chưa chọn yêu cầu kháng cáo. Hãy chọn lại!');
                return false;
            }
            ...
            if (Common_CheckEmpty(txtSobienlai.value)) {
                leng_string = txtSobienlai.value.trim().length;
                if (leng_string> 20) {
                    alert('Số biên lai không nhập quá 20 ký tự. Hãy kiểm tra lại!');
                    txtSobienlai.focus();
                    return false;
                }
            }
            ...
            if (Common_CheckEmpty(txtNgaygiaiquyet.value)) {
                if (!CheckDateTimeControl(txtNgaygiaiquyet, 'Ngày giải quyết'))
                    return false;
            }
            var txtGQGhichu = document.getElementById('<%=txtGQGhichu.ClientID%>');
            if (Common_CheckEmpty(txtGQGhichu.value)) {
                if (txtGQGhichu.value.trim().length > 250) {
                    alert('Ghi chú kết quả giải quyết kháng cáo của tòa Phúc thẩm không quá 250 ký tự. Hãy nhập lại!');
                    txtGQGhichu.focus();
                    return false;
                }
            }
