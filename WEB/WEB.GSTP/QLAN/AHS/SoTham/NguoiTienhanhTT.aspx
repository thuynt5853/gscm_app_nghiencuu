<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="NguoiTienhanhTT.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.SoTham.NguoiTienhanhTT" %>
            ...
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        ...
                        <tr>
                            <td style="width: 145px;">Số quyết định<span class="batbuoc">(*)</span></td>
                            <td style="width: 265px;">
                                <asp:TextBox ID="txtSoQD" runat="server" CssClass="user" Width="242" MaxLength="50"></asp:TextBox>
                            </td>
                            <td style="width: 140px;">Ngày quyết định<span class="batbuoc">(*)</span></td>
                            <td>
                                <asp:TextBox ID="txtNgayQD" runat="server" CssClass="user" Width="242px" MaxLength="10" AutoPostBack="true"
                                    OnTextChanged="txtNgayQD_TextChanged"></asp:TextBox>
                                <cc1:CalendarExtender ID="CalendarExtender_txtNgayQD" runat="server" TargetControlID="txtNgayQD" Format="dd/MM/yyyy" Enabled="true" />
                                <cc1:MaskedEditExtender ID="MaskedEditExtender_txtNgayQD" runat="server" TargetControlID="txtNgayQD" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                            </td>
                        </tr>
                        ...
                        <asp:Panel ID="pnPhancong" runat="server">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtNgayphancong" runat="server" CssClass="user" 
    ...
    <script type="text/javascript">
        function ValidInputData() {
            ...
            if (!CheckDateTimeControl(txtNgayQD, 'Ngày quyết định'))
                return false;
            if (hddNgayThuLy.value.length > 0) {
                if (!SoSanh2Date(txtNgayQD, 'Ngày quyết định', hddNgayThuLy.value, 'Ngày thụ lý sơ thẩm'))
                    return false;
            }
            ...
            //if (!SoSanh2Date_NhoHon(txtNgayphancong, 'Ngày phân công', NgayHoSo, 'Ngày thụ lý sơ thẩm'))
            //    return false;
          ...
          <%--  var txtNhanphancong = document.getElementById('<%=txtNhanphancong.ClientID%>');
            if (!CheckDateTimeControl(txtNhanphancong, 'Ngày nhận phân công'))
                return false;
            if (!SoSanh2Date(txtNhanphancong, 'Ngày nhận phân công', NgayHoSo, 'Ngày thụ lý sơ thẩm'))
                return false;
            ...
            if (Common_CheckEmpty(txtNgayketthuc.value)) {
                if (!CheckDateTimeControl(txtNgayketthuc, 'Ngày kết thúc'))
                    return false;
                if (!SoSanh2Date(txtNgayketthuc, 'Ngày kết thúc', NgayHoSo, 'Ngày thụ lý sơ thẩm'))
                    return false;
            }--%>
            return true;
        }
