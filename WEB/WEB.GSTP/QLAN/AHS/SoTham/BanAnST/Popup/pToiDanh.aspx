<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pToiDanh.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.SoTham.BanAnST.Popup.pToiDanh" %>
                                        ...
                                        <ItemTemplate>
                                            <asp:Panel ID="pnRow" runat="server">
                                                <tr class="trclass">
                                                    ...
                                                    <td>
                                                        <div align="center">
                                                            <asp:CheckBox ID="checkkboxTDC" runat="server" Checked='<%# CheckToiDanh(Eval("ISMAIN")) %>' Enabled ="false"/></td>
                                                        </div>
                                                    <td>
                                                        <div align="center">
