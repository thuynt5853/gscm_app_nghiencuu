...
{
    public partial class pTongHopHinhPhat : System.Web.UI.Page
    {
        ...
        void LoadInfo()
        {
            ...
            AHS_SOTHAM_BANAN_DIEU_CHITIET_BL objHP = new AHS_SOTHAM_BANAN_DIEU_CHITIET_BL();
        ...
        protected void cmdUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                List<AHS_SOTHAM_BANAN_DIEU_CHITIET> lst = dt.AHS_SOTHAM_BANAN_DIEU_CHITIET.Where(x => x.BANANID == BanAnSoThamID
                                                                                                   && x.BICANID == BiCaoID
                                                                                                   && x.TOIDANHID == ToiDanhID).ToList();
                if (lst != null && lst.Count > 0)
                {
                    foreach (AHS_SOTHAM_BANAN_DIEU_CHITIET objCT in lst)
                    {
                        if (OldItem.Length > 1)
                            OldItem += "|";
            ...
            foreach (RepeaterItem item in rptHP.Items)
            {
                ...
                {
                    IsUpdate = false;
                    obj = dt.AHS_SOTHAM_BANAN_DIEU_CHITIET.Where(x => x.BANANID == BanAnSoThamID
                                                                   && x.BICANID == BiCaoID
                                                                   && x.HINHPHATID == HinhPhatID
                                                                   && x.TOIDANHID == ToiDanhID).Single<AHS_SOTHAM_BANAN_DIEU_CHITIET>();
                    if (obj != null)
                        IsUpdate = true;
                    else obj = new AHS_SOTHAM_BANAN_DIEU_CHITIET();
                }
