<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="KhangNghi.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.SoTham.KhangNghi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        ...
                        <tr>
                            ...
                            <td>Ngày QĐ/BA</td>
                            <td>
                                <asp:TextBox ID="txtNgayQDBA" runat="server" ReadOnly="true" Enabled="false" CssClass="user" Width="90px" MaxLength="10"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtToaAnQD" ReadOnly="true" Enabled="false" runat="server" CssClass="user" Width="99%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>Nội dung kháng nghị</td>
                            <td colspan="3">
                                <asp:TextBox ID="txtNoidung" runat="server" CssClass="user" Width="100%" TextMode="MultiLine" Height="50px" MaxLength="1000"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>File đính kèm</td>
    ...
    <script type="text/javascript">
        function ValidData() {
            ...
            if (lengthSoKN == 0) {
                alert('Bạn chưa nhập số kháng nghị!');
            ...
            var CHK = document.getElementById("<%=chkYeuCauKN.ClientID%>");
            ...
            if (counter == 0) {
                alert('Bạn chưa chọn yêu cầu kháng nghị. Hãy chọn lại!');
                return false;
            }
            return true;
        }
