<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="RutKhangCaoKhangNghi.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.SoTham.RutKhangCaoKhangNghi" %>
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-Width="110px" HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                <asp:DropDownList ID="ddlTinhTrang" CssClass="chosen-select"
                                                    runat="server" Width="110px"  AutoPostBack="true" 
