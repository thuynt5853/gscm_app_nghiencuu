<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Quyetdinhvuan.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.SoTham.Quyetdinhvuan" %>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:DropDownList ID="ddlQuyetdinh" CssClass="chosen-select" runat="server" Width="650px"
                                    AutoPostBack="True" OnSelectedIndexChanged="ddlQuyetdinh_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                        </tr>
                            <tr>
                            ...
                            <asp:Panel runat="server" ID="pndata" Visible="false">
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="HINHTHUCXETXU" HeaderText="Hình thức xét xử" HeaderStyle-Width="125px" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-Width="65px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="lbtXoa" runat="server" CausesValidation="false"
                                                    Text="Xóa" ForeColor="#0e7eee" ToolTip="Xóa"
                                                    CommandName="Xoa" CommandArgument='<%#Eval("ID") %>'
                                                    Visible='<%# (Convert.ToInt16(Eval("IsBanAnST")+"")>0) ? false:true %>'
