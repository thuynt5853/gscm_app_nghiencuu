<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="NguoiThamGiaToTung.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.Hoso.NguoiThamGiaToTung" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hddTuCach_13HS_ID" runat="server" Value="" />
    <div class="box">
        <div class="box_nd">
            <div class="boxchung">
                        ...
                        <asp:Panel ID="pnTreViThanhNien" runat="server" Visible="false">
                            <tr>
                                ...
                                <asp:Panel ID="pnTreVTNCo" runat="server" Enabled="false">
                                    <td>Phân loại độ tuổi<span class="batbuoc">(*)</span></td>
                                    <td>
                                        <asp:DropDownList ID="ddlPLTuoi"
                                            CssClass="chosen-select" runat="server" Width="214px">
                                            <asp:ListItem Value="0" Text="--- Chọn ---" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="7" Text="Dưới 13 tuổi"></asp:ListItem>
                                            <asp:ListItem Value="1" Text="Từ đủ 13 tuổi đến dưới 16 tuổi"></asp:ListItem>
                                        ...
                                        <asp:DropDownList ID="ddlPLTuoi_Tren18" Visible ="false"
                                            CssClass="chosen-select" runat="server" Width="214px">
                                            <asp:ListItem Value="0" Text="--- Chọn ---" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="5" Text="Từ đủ 18 đến dưới 30 tuổi"></asp:ListItem>
                                            <asp:ListItem Value="6" Text="Trên 30 tuổi"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </asp:Panel>
                            ...
                            <tr>
                                <td>Mối quan hệ thân thích với bị cáo <span class="batbuoc">(*)</span></td>
                                <td>
                                    <asp:RadioButtonList ID="rdQuanHeThanThich" runat="server"
                                        RepeatDirection="Horizontal">
                                        <asp:ListItem Value="0">Không</asp:ListItem>
                                        <asp:ListItem Value="1">Có</asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                                <td>Mối quan hệ quen biết với bị cáo <span class="batbuoc">(*)</span></td>
                                <td>
                                    <asp:RadioButtonList ID="rdQuanHeQuenBiet" runat="server"
                                        RepeatDirection="Horizontal">
                                        <asp:ListItem Value="0">Không</asp:ListItem>
                                        <asp:ListItem Value="1">Có</asp:ListItem>
                                    </asp:RadioButtonList>
                            ...
                            <tr>
                                <td>Hậu quả đối với người bị hại <span class="batbuoc">(*)</span></td>
                                <td>
                                    <asp:DropDownList ID="ddlHauQuaVoiBiHai" CssClass="chosen-select" AutoPostBack="true" OnSelectedIndexChanged="ddlHauQuaVoiBiHai_SelectedIndexChanged"
                                        runat="server" Width="250px">
                                        <asp:ListItem Value="0" Text="--- Chọn ---" Selected="True"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="Tử vong"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="Bị nhiễm HIV"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="Bị thương tích hoặc tổn hại sức khoẻ"></asp:ListItem>
                                        <asp:ListItem Value="4" Text="Bị rối loạn tâm thần"></asp:ListItem>
                                        <asp:ListItem Value="5" Text="Có thai"></asp:ListItem>
                                        <asp:ListItem Value="6" Text="Bỏ học"></asp:ListItem>
                                        <asp:ListItem Value="7" Text="Khác"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <asp:Panel ID="pnTyLeRoiLoanTT" runat="server" Visible="false">
                                    <td>Tỷ lệ rối loạn tâm thần <span class="batbuoc">(*)</span></td>
                                    <td>
                                        <asp:DropDownList ID="ddlTyLeRoiLoanTT" CssClass="chosen-select" 
                                            runat="server" Width="214px">
                                            <asp:ListItem Value="0" Text="--- Chọn ---" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="1" Text="Dưới 31%"></asp:ListItem>
                                            <asp:ListItem Value="2" Text="Từ 31% trở lên"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </asp:Panel>
                            </tr>
                         ...
                         <asp:Panel ID="pn_daidien" runat="server" Visible="false">
                            ...
                            <td colspan="2"></td>
                                ...
                                <asp:Panel ID="pn_daidiencho" runat="server">
                                     <tr >
                                    <td>Đại diện cho <span class="batbuoc">(*)</span></td>
                                    <td colspan="3">
                                        <%--multiple--%>
                                        <asp:DropDownList ID="ddl_BICAO_ID" multiple data-placeholder="--- Chọn ---" class="chosen-select"  Style="width: 572px;" runat="server">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                              </asp:Panel>  
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtDiaChiChitiet" CssClass="user"
                                    runat="server" MaxLength="250" Width="568px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td colspan="3">
                                <asp:Button ID="cmdUpdate" runat="server"
                                    CssClass="buttoninput" Text="Lưu"
                                    OnClientClick="return validate_form();" OnClick="btnUpdate_Click"/>
                                <asp:Button ID="cmdLammoi" runat="server"
                                    CssClass="buttoninput" Text="Thêm mới" OnClick="btnLammoi_Click" />
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            ...
                            <tr>
                                <td colspan="7">
                                    ...
                                    <div style="margin-top: 10px; float: right;" id="divPrintNoibo" runat="server">
                                        <asp:Button ID="btn_GXN_BC" runat="server" Width="225px" CssClass="buttonprint" OnClick="btn_GXN_BC_Click" Text="Giấy XN người bảo vệ bị cáo" />
                                        <asp:Button ID="btn_GXN_BH" runat="server" Width="275px" CssClass="buttonprint" OnClick="btn_GXN_BH_Click" Text="Giấy XN người bảo vệ tham gia tố tụng khác" />
                                    </div>
                                </td>
                            </tr>
                        </table>
                            ...
                            <asp:Panel runat="server" ID="pndata" Visible="false">
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="20%">
                                            <HeaderTemplate>
                                                Họ và tên
                                            </HeaderTemplate>
                                            <ItemTemplate>
    ...
    <script>
        ...
        function validate_form() {
            ...
            if (loaidoituong == "0" && value_change == "0") {
                alert('Mục "Giới tính" bắt buộc phải chọn. Hãy kiểm tra lại!');
                ddlGioitinh.focus();
                return false;
            }
            //-------------------------------
            ...
            if (loaidoituong == "0" && tucachtt == ConfigBiHaiID) {
                ...
                if (selected_value == "1") {
                    var ddlPLTuoi = document.getElementById('<%=ddlPLTuoi.ClientID%>');
                    value_change = ddlPLTuoi.options[ddlPLTuoi.selectedIndex].value;
                    if (value_change == "0") {
                        alert('Mục "Phân loại độ tuổi" bắt buộc phải chọn.Hãy kiểm tra lại!');
                        ddlPLTuoi.focus();
                        return false;
                    }
                }
                else if (selected_value == "0"){
                    var ddlPLTuoi_Tren18 = document.getElementById('<%=ddlPLTuoi_Tren18.ClientID%>');
                    value_change = ddlPLTuoi_Tren18.options[ddlPLTuoi_Tren18.selectedIndex].value;
                    if (value_change == "0") {
                        alert('Mục "Phân loại độ tuổi" bắt buộc phải chọn.Hãy kiểm tra lại!');
                        ddlPLTuoi_Tren18.focus();
                        return false;
                    }
                }
                var rdQuanHeThanThich = document.getElementById('<%=rdQuanHeThanThich.ClientID%>');
                msg = 'Mục "Mối quan hệ thân thích với bị cáo" bắt buộc phải chọn.';
                msg += 'Hãy kiểm tra lại!';

                if (!CheckChangeRadioButtonList(rdQuanHeThanThich, msg))
                    return false;

                var rdQuanHeQuenBiet = document.getElementById('<%=rdQuanHeQuenBiet.ClientID%>');
                msg = 'Mục "Mối quan hệ quen biết với bị cáo" bắt buộc phải chọn.';
                msg += 'Hãy kiểm tra lại!';

                if (!CheckChangeRadioButtonList(rdQuanHeQuenBiet, msg))
                    return false;
                var ddlHauQuaVoiBiHai = document.getElementById('<%=ddlHauQuaVoiBiHai.ClientID%>');
                value_change = ddlHauQuaVoiBiHai.options[ddlHauQuaVoiBiHai.selectedIndex].value;
                if (value_change == "0") {
                    alert('Mục "Hậu quả đối với người bị hại" bắt buộc phải chọn.Hãy kiểm tra lại!');
                    ddlHauQuaVoiBiHai.focus();
                    return false;
                }

                if (ddlHauQuaVoiBiHai.value == "4") {
                    var ddlTyLeRoiLoanTT = document.getElementById('<%=ddlTyLeRoiLoanTT.ClientID%>');
                    value_change = ddlTyLeRoiLoanTT.options[ddlTyLeRoiLoanTT.selectedIndex].value;
                    if (value_change == "0") {
                        alert('Mục "Tỷ lệ rối loạn tâm thần" bắt buộc phải chọn.Hãy kiểm tra lại!');
                        ddlTyLeRoiLoanTT.focus();
                        return false;
                    }
                }
            }
            ...
            //-------------------------------------
            if (loaidoituong == "0" && (tucachtt == "127" || tucachtt == "123" || tucachtt == "549" || tucachtt == "130" || tucachtt == "131")) {
                var ddlDaiDienCho = document.getElementById('<%=ddl_BICAO_ID.ClientID%>');
                var selected = Array.from(ddlDaiDienCho.selectedOptions).map(o => o.value);
                if (selected.length === 0) {
                    alert('Mục "Đại diện cho" bắt buộc phải chọn.');
                    return false;
                }
            }
