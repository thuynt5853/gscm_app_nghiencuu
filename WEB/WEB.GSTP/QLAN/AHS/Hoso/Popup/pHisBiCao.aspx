<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pHisBiCao.aspx.cs" Inherits="WEB.GSTP.QLAN.AHN.Hoso.Popup.pHisBiCao" %>
...
<head runat="server">
    <title>Lịch sử Cập nhật Thông tin Bị can</title>
                                  ...
                                  <asp:Panel runat="server" ID="pndata" Visible="true">
                                    ...
                                    >
                                      <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center">
                                          <HeaderTemplate> Tên bị can </HeaderTemplate>
                                          <ItemTemplate> <%#Eval("TEN_BICAN") %> </ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center">
                                          ...
                                          <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center">
                                          <HeaderTemplate> Tội danh chính </HeaderTemplate>
                                          <ItemTemplate> <%#Eval("TOIDANH") %> </ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn
                                       ...
                                       <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center">
                                          ...
                                          <ItemTemplate> <%#Eval("NGAYTAO") %> </ItemTemplate>
                                        </asp:TemplateColumn>
