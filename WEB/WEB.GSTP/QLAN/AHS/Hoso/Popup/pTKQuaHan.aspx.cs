...
namespace WEB.GSTP.QLAN.AHS.Hoso.Popup
{
    public partial class pTKQuaHan : System.Web.UI.Page
    {
        ...
        {
            var lstData = DataExtensions.GetAll<TK_QUAHAN>().Where(x => x.TRANGTHAI != 99 && x.LOAIAN == 1 && x.TOAANID == Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID] + ""));
        ...
        {
            string link = "/QLAN/AHS/Hoso/Popup/pThemTKQuaHan.aspx";
        ...
        {
            string link = "/QLAN/AHS/Hoso/Popup/pThemTKQuaHan.aspx?TKID=" + id;
