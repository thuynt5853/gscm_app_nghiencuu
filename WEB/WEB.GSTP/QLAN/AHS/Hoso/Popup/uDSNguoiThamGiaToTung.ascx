<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uDSNguoiThamGiaToTung.ascx.cs" Inherits="WEB.GSTP.QLAN.AHS.Hoso.Popup.uDSNguoiThamGiaToTung" %>
...
<script>
    function popup_form_edit(curr_id) {
        var link = "";
        if (curr_id > 0)
            link = "/QLAN/AHS/Hoso/Popup/pNguoiThamGiaTT.aspx?hsID=<%=VuAnID%>&uID=" + curr_id;
        else
            link = "/QLAN/AHS/Hoso/Popup/pNguoiThamGiaTT.aspx?hsID=<%=VuAnID%>";
        var width = 950;
        var height = 350;
