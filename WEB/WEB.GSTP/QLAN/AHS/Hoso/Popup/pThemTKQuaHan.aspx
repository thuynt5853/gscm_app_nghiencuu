...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pThemTKQuaHan.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.Hoso.Popup.pThemTKQuaHan" %>
                                    ...
                                    <td>
                                        <div class="box_nd">
                                            <div style="float: left; width: 1050px">
                                                ...
                                                <div style="float: left; width: 90px; text-align: right; margin-right: 10px;">Tội danh</div>
                                                <div style="float: left;">
                                                    <asp:TextBox ID="txt_ToiDanh" CssClass="user" runat="server" Width="240px"></asp:TextBox>
                                                </div>
                    ...
                    <div>
                        <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Justify" HeaderStyle-Width="150px">
                                    <HeaderTemplate>
                                        Người tạo
                                    </HeaderTemplate>
                                    <ItemTemplate>
                    ...
                    <div style="text-align: center">
                        <asp:DataGrid ID="dgListCon" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="MavuAn" Visible="false"></asp:BoundColumn>
                                <asp:BoundColumn DataField="TenVuAn" Visible="false"></asp:BoundColumn>
