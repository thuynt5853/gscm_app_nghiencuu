...
namespace WEB.GSTP.QLAN.AHS.Hoso.Popup
{
    public partial class pThemTKQuaHan : System.Web.UI.Page
    {
        ...
        private void Load_Data()
        {
            ...
            {
                DataTable oDT = oBL.GetAllPaging(Session["CAP_XET_XU"] + "", txtTenVuViec.Text.Trim(), txt_ToiDanh.Text.Trim(), "", txtBiCan.Text.Trim(), dropCapxx.SelectedValue, toaAnID.ToString(),
                                "1", txtSOTHULY_THONGBAO.Text.Trim(), "", SetNgayCuoi(), "1", "", "", "", "",
                                "", ddlThamphan.SelectedValue, "", "", "", "", 0,
                                0, "", 0, pageindex, page_size, 0, 0, 0);
