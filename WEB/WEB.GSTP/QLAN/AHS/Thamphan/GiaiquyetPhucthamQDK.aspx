<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="GiaiquyetPhucthamQDK.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.Thamphan.GiaiquyetPhucthamQDK" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hddNgayThuLy" runat="server" />
    <div class="box">
        <div class="box_nd">
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:DropDownList ID="dropThuLy" CssClass="chosen-select"
                                    runat="server" Width="628"
                                    AutoPostBack="true" OnSelectedIndexChanged="dropThuLy_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="width: 115px;">Thẩm phán<span class="batbuoc">(*)</span></td>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlVaitro" CssClass="chosen-select"
                                    runat="server" Width="250px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNgayphancong" runat="server" CssClass="user" Width="110px" 
                        ...
                        <tr>
                            ...
                            <td>Ngày kết thúc</td>
                            <td>
                                <asp:TextBox ID="txtNgayketthuc" runat="server"
