<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="GiaiquyetSotham.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.Thamphan.GiaiquyetSotham" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNgayphancong" runat="server" CssClass="user" Width="100px"
                                    AutoPostBack="true" OnTextChanged="txtNgayphancong_TextChanged"
                        ...
                        <tr>
                            <td class="table_edit_col1" style="width: 142px;">Thẩm phán<span class="batbuoc">(*)</span></td>
                            <td class="table_edit_col1">
                                <asp:DropDownList ID="ddlThamphan" AutoPostBack="true" OnSelectedIndexChanged="myListDropDown_Change" CssClass="chosen-select" runat="server" Width="250"></asp:DropDownList>
                            </td>
                            <td style="width: 110px;">Vai trò<span class="batbuoc">(*)</span></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNhanphancong" runat="server"
                                ...
                                <cc1:MaskedEditValidator ID="MaskedEditValidator2" runat="server"
                                    ControlExtender="MaskedEditExtender2" ControlToValidate="txtNhanphancong"
                                    InvalidValueMessage="dd/MM/yyyy" Style="color: red; margin-left: 15px;"></cc1:MaskedEditValidator>
                            </td>
                            <td>Ngày kết thúc</td>
                            <td>
                                <asp:TextBox ID="txtNgayketthuc" runat="server" CssClass="user"
                                    Width="100px" MaxLength="10" onkeypress="return isNumber(event)"></asp:TextBox>
                                ...
                                <cc1:MaskedEditValidator ID="MaskedEditValidator4" runat="server"
                                    ControlExtender="MaskedEditExtender4" ControlToValidate="txtNgayketthuc"
                                    InvalidValueMessage="dd/MM/yyyy" Style="color: red; margin-left: 15px;"></cc1:MaskedEditValidator>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center;" class="auto-style1">
                            ...
                            <asp:Button ID="cmdUpdate" runat="server" CssClass="buttoninput"
                                ...
                                OnClick="cmdUpdate_Click1" />
                            <asp:Button ID="cmdLammoi" runat="server" CssClass="buttoninput" Text="Thêm mới" OnClick="btnLammoi_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="65px">
                                            ...
                                            <ItemTemplate>
                                                <%#(String.IsNullOrEmpty(Eval("NGAYKETTHUC")+""))? "": Convert.ToDateTime(Eval("NGAYKETTHUC")).ToString("dd/MM/yyyy", new System.Globalization.CultureInfo("vi-VN")) %>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                <b>Số:</b> <%#Eval("SoThuLy") %>
                                                <br>
                                                <b>TH:</b> <%#Eval("TruongHopThuLy") %>
                                                <br>
                                                <b>Ngày:</b><%# string.Format("{0:dd/MM/yyyy}",Eval("NgayThuLy")) %>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
    ...
    <script type="text/javascript">       
        function validate() {
            var value_change = "";
            var dropThuLy = document.getElementById('<%=dropThuLy.ClientID%>');
            value_change = dropThuLy.options[dropThuLy.selectedIndex].value;
            if (value_change == "0") {
                alert('Chưa chọn mục "Thụ lý". Hãy kiểm tra lại!');
                dropThuLy.focus();
                return false;
            }
            ...
            if (!Common_CheckEmpty(txtSoQD.value)) {
                alert('Chưa nhập số quyết định. Hãy kiểm tra lại!');
                txtSoQD.focus();
                return false;
            }
            var lengthSoQD = txtSoQD.value.trim().length;
            if (lengthSoQD > 50) {
                alert('Số quyết định không quá 50 ký tự. Hãy kiểm tra lại!');
                txtSoQD.focus();
                return false;
            }
            ...
            if (!CheckDateTimeControl(txtNgayphancong, 'Ngày phân công'))
                return false;
            if (!SoSanh2Date(txtNgayphancong, 'Ngày phân công', txtNgayQD.value, 'Ngày quyết định'))
                return false;
            //------------------------------------
            ...
            if (value_change == "0") {
                alert('Chưa chọn mục "Thẩm phán". Hãy kiểm tra lại!');
                ddlThamphan.focus();
                return false;
            }
            //----------------------------
