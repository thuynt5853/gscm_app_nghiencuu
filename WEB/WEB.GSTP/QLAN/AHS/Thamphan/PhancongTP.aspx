<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="PhancongTP.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.Thamphan.PhancongTP" %>
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Justify">
                                            ...
                                            <ItemTemplate>
                                                <i style='margin-right: 3px;'>Tên vụ án:</i>  <b><%#Eval("TenVuAn")%></b>
                                                <br />
                                                <i style='margin-right: 3px;'>Mã vụ án:</i>  <b><%#Eval("MavuAn")%></b>
                                                <br />
                                        ...
                                        <asp:TemplateColumn HeaderStyle-Width="110px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                <div style="text-align: center;">
                                                    <asp:Label runat="server" ID="lbtthongbao_01" ForeColor="Red" Font-Size="13px"></asp:Label>
                                                </div>
                                                <div style="text-align: left;">
                                                    <asp:HiddenField ID="hdd_SOQD" runat="server" Value='<%#Eval("SOQD")%>' />
                                                    <asp:TextBox ID="txt_SoQD_DG" Text='<%#Eval("SOQD") %>' runat="server" Width="172px" placeholder="Số QĐ" CssClass="user"></asp:TextBox>
                                                </div>
                                                <div style="text-align: left; margin-top: 10px;">
                                                    <asp:HiddenField ID="hddNgayQD_DG" runat="server" Value='<%#Eval("NGAYQD")%>' />
                                                    <asp:TextBox ID="txtNgayQD_DG" Text='<%#Eval("NGAYQD") %>' runat="server" placeholder="Ngày QĐ ..../..../....." CssClass="user" Width="172px" MaxLength="10"></asp:TextBox>
                                                    <cc1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtNgayQD_DG" Format="dd/MM/yyyy" Enabled="true" />
                                                    <cc1:MaskedEditExtender ID="MaskedEditExtender3" runat="server" TargetControlID="txtNgayQD_DG" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                                    <cc1:MaskedEditValidator ID="MaskedEditValidator3" runat="server" ControlExtender="MaskedEditExtender3" ControlToValidate="txtNgayQD_DG" InvalidValueMessage="dd/MM/yyyy" Style="color: red;"></cc1:MaskedEditValidator>
                                                </div>
                                                <div style="text-align: left; margin-top: 10px;">
                                                    <asp:DropDownList ID="dropThuLy" CssClass="chosen-select" runat="server" Width="180"></asp:DropDownList>
                                                </div>
                                            </ItemTemplate>
