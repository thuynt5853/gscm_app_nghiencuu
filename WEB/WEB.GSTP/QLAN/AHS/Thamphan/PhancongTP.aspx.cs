...
namespace WEB.GSTP.QLAN.AHS.Thamphan
{
    public partial class PhancongTP : System.Web.UI.Page
    {
        ...
        {
            AHS_VUAN_BL OBJ_BL = new AHS_VUAN_BL();
            String V_THONGBAO = ""; Decimal V_DEMS = 0;
            foreach (DataGridItem Item in dgList.Items)
            {
                DropDownList dropThuLy = (DropDownList)Item.FindControl("dropThuLy");
                ...
                TextBox txt_SoQD_DG = (TextBox)Item.FindControl("txt_SoQD_DG");
                TextBox txtNgayQD_DG = (TextBox)Item.FindControl("txtNgayQD_DG");
                CheckBox chkChon = (CheckBox)Item.FindControl("chkChon");
                //------------
                Label lbtthongbao_01 = (Label)Item.FindControl("lbtthongbao_01");
                Label lbtthongbao_02 = (Label)Item.FindControl("lbtthongbao_02");
                Label lbtthongbao_03 = (Label)Item.FindControl("lbtthongbao_03");

                if (chkChon.Checked)
                {
                    if (txt_SoQD_DG.Text.Trim() == "")
                    {
                        lbtthongbao_01.Text = "Bạn chưa nhập số quyết định";
                    }
                    else if (txtNgayQD_DG.Text == "")
                    {
                        lbtthongbao_01.Text = "Bạn chưa nhập ngày QĐ";
                    }
                    else
                    {
                        lbtthongbao_01.Text = "";
                    ...
                    //---------
                    Decimal V_COUNTS = 0;
                    OBJ_BL.PHANCONGTP_INS_UP(rdbTrangthai.SelectedValue, Item.Cells[1].Text,Item.Cells[0].Text, txt_SoQD_DG.Text.Trim(), txtNgayQD_DG.Text,dropThuLy.SelectedValue, txtNgayPhanCongTP.Text, ddlThamphan_DG.SelectedValue,
                        ...
                        , Session[ENUM_SESSION.SESSION_DONVIID] + ""); // update toa_gq_id
            ...
            if(V_DEMS >= 1)
            {
                lbtthongbao.Text= "Bạn đã cập nhật thành công thông tin thẩm phán cho "+ V_DEMS + " vụ án.";
        ...
        protected void cmdPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable tbl = obj.GetAllPaging_PCTP_Print(Session["CAP_XET_XU"] + "", txtTenVuViec.Text.Trim(), txt_toidanh.Text.Trim(), txtMaVuViec.Text.Trim(), txtBiCan.Text.Trim(), dropCapxx.SelectedValue, DropToaAn.SelectedValue,
                                                "1", txtSOTHULY.Text.Trim(), txt_NGAYTHULY_TU.Text, txt_NGAYTHULY_DEN.Text, rdbTrangthai.SelectedValue, txtTuNgay.Text.Trim(), txtDenNgay.Text.Trim(), "", txtSoQD.Text.Trim(),
                                                txt_NgayQD.Text.Trim(), ddlThamphan.SelectedValue, ddlHTND_Thuky.SelectedValue, "", "", 0, 0);
                ...
                //-------------------Export---------------------------
                Response.Clear();
                Response.AddHeader("content-disposition", "attachment;filename=PCTP_HS.xls");
        ...
        protected void cmdPrint_Click_OLD(object sender, EventArgs e)
        {
            try
            {
                AHS_VUAN_BL obj = new AHS_VUAN_BL();
                ...
                //--------------------------
                Response.Clear();
                Response.AddHeader("content-disposition", "attachment;filename=PCTP_HS.doc");
                Response.Cache.SetCacheability(HttpCacheability.NoCache);
                ...
                Response.Write("@page Section1 {size:595.45pt 841.7pt; margin:0.2in 0.2in 0.5in 0.2in;mso-header: h1;mso-header-margin:.2in;mso-footer-margin:.3in;mso-paper-source:0;mso-footer: f1;}");
                ...
                Response.Write("@page Section2 {size:841.7pt 595.45pt;mso-page-orientation:landscape;margin:0.2in 0.6in 0.5in 1.0in;mso-header: h1;mso-header-margin:.2in;mso-footer-margin:.3in;mso-paper-source:0;mso-footer: f1;}");
        ...
        private void Load_Data()
        {
            ...
            int page_size = Convert.ToInt32(dropPageSize.SelectedValue),
                ...
                count_all = 0;
            DataTable tbl = obj.GetAllPaging_PCTP(Session["CAP_XET_XU"] + "", txtTenVuViec.Text.Trim(), txt_toidanh.Text.Trim(), txtMaVuViec.Text.Trim(), txtBiCan.Text.Trim(), dropCapxx.SelectedValue, DropToaAn.SelectedValue,
                                            "1", txtSOTHULY.Text.Trim(), txt_NGAYTHULY_TU.Text, txt_NGAYTHULY_DEN.Text,rdbTrangthai.SelectedValue, txtTuNgay.Text.Trim(), txtDenNgay.Text.Trim(),"", txtSoQD.Text.Trim(),
                                            txt_NgayQD.Text.Trim(), ddlThamphan.SelectedValue, ddlHTND_Thuky.SelectedValue,"", "", pageindex, page_size);
            if (tbl.Rows.Count > 0)
            {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (dropCapxx.SelectedValue == "2")
                {
                    ...
                    tbl = obj.GetByVuAnID(Convert.ToDecimal(strID));
                }
                ...
                DropDownList dropThuLy = (DropDownList)e.Item.FindControl("dropThuLy");
                if (tbl != null && tbl.Rows.Count > 0)
                {
                ...
                {
                    dropThuLy.Items.Add(new ListItem("---Chọn---", "0"));
                    lbtthongbao.Text = "Vụ việc chưa được thụ lý. Hãy kiểm tra lại !";
                }
                ...
                TextBox txt_SoQD_DG = (TextBox)e.Item.FindControl("txt_SoQD_DG");
                TextBox txtNgayQD_DG = (TextBox)e.Item.FindControl("txtNgayQD_DG");
                if (chk.Checked)
                {
                    txtNgayPhanCongTP.Enabled = true; txtNgayPhanCongLD.Enabled = true;
                    txtNgayQD_DG.Enabled = true; txt_SoQD_DG.Enabled = true;
                    dropThuLy.Enabled = true; ddlThamphan_DG.Enabled = true; ddlLDV.Enabled = true;
                    if (rdbTrangthai.SelectedValue == "2")
                    {
                        ...
                        txtNgayQD_DG.Text = DateTime.Now.ToString("dd/MM/yyyy", cul);
                    }
                }
                else
                {
                    txtNgayPhanCongTP.Enabled = false; txtNgayPhanCongLD.Enabled = false;
                    dropThuLy.Enabled = false; ddlThamphan_DG.Enabled = false; ddlLDV.Enabled = false;
                    txtNgayQD_DG.Enabled = false; txt_SoQD_DG.Enabled = false;
                    if (rdbTrangthai.SelectedValue == "3")
                    {
                        txtNgayPhanCongTP.Text = ""; txtNgayPhanCongLD.Text = ""; txtNgayQD_DG.Text = ""; txt_SoQD_DG.Text = "";
                    }
                }
                //--------------
                ddlThamphan_DG.SelectedValue=rv["THAMPHAN_ID"] + "";
                ddlLDV.SelectedValue= rv["LANHDAO_ID"] + "";
                dropThuLy.SelectedValue = rv["THULYID"] + "";
                txtNgayPhanCongTP.Text= rv["NGAYPHANCONGTP"] + "";
                txtNgayPhanCongLD.Text = rv["NGAYPHANCONGLD"] + "";
                txt_SoQD_DG.Text = rv["SOQD"] + "";
                txtNgayQD_DG.Text = rv["NGAYQD"] + "";
            }
        }
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Xoa":
                    ...
                    {
                        //Luu thong tin Hồ sơ án trước khi xoa Toan bo vu an
                        AHS_VUAN oND = dt.AHS_VUAN.Where(x => x.ID == IDVuAn).FirstOrDefault();
                        var json = new JavaScriptSerializer().Serialize(oND);
                        ADS_DON_BL oBLDS = new ADS_DON_BL();
                        if (oBLDS.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oND.ID), 1, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "PhancongTP.aspx", "Xóa", json) == false)
                        {
                            lbtthongbao.Text = "Xóa không thành công!";
                            return;
                        }//Ket thuc
                         //Xoa Toan bo vu an
        ...
        void XoaVuAn(Decimal VuAnID)
        {
            ...
            //Luu thong tin Hồ sơ án trước khi xoa Hồ sơ án
            string strUserName = Session[ENUM_SESSION.SESSION_USERNAME] + "";
            var json = new JavaScriptSerializer().Serialize(oT);
            ADS_DON_BL oBLDS = new ADS_DON_BL();
            if (oBLDS.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oT.ID), 1, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "PhancongTP.aspx", "Xóa", json) == false)
            {
                lbtthongbao.Text = "Xóa không thành công!";
                return;
            }//Ket thuc
        ...
        void SetPhanCongTP(CheckBox curr_chk, DataGrid grid)
        {
            foreach (DataGridItem Item in grid.Items)
            {
                ...
                Label lbtthongbao_03 = (Label)Item.FindControl("lbtthongbao_03");
                //-----------
                HiddenField hdd_SOQD = (HiddenField)Item.FindControl("hdd_SOQD");
                HiddenField hddNgayQD_DG = (HiddenField)Item.FindControl("hddNgayQD_DG");
                ...
                else
                {
                    ...
                    lbtthongbao_01.Text = ""; lbtthongbao_02.Text = ""; lbtthongbao_03.Text = "";
                    txtNgayPhanCongTP.Enabled = false; txtNgayPhanCongLD.Enabled = false;
                    dropThuLy.Enabled = false; ddlThamphan_DG.Enabled = false; ddlLDV.Enabled = false;
                    txtNgayQD_DG.Enabled = false; txt_SoQD_DG.Enabled = false;
                    if (rdbTrangthai.SelectedValue == "2")
                    {
                        ...
                        txtNgayQD_DG.Text = ""; txt_SoQD_DG.Text = "";
                        ddlThamphan_DG.SelectedValue = ""; ddlLDV.SelectedValue = "";
                    }
                    else if (rdbTrangthai.SelectedValue == "3")
                    {
                        txt_SoQD_DG.Text =hdd_SOQD.Value;
                        txtNgayQD_DG.Text=hddNgayQD_DG.Value;
