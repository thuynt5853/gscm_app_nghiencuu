<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pTongHopHinhPhat.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.PhucTham.BanAn.pTongHopHinhPhat" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Tổng hợp hình phạt</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="boxchung">
            <h4 class="tleboxchung">Tổng hợp hình phạt cho bị can</h4>
            <div class="boder" style="padding: 10px;">
                <table class="table1">
                    ...
                    <tr>
                        <td colspan="2"><b>Tổng hợp hình phạt</b></td>
                    </tr>
                    <tr>
                        <td colspan="2">
