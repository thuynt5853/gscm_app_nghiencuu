<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="pChonToiDanh.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.PhucTham.BanAn.pChonToiDanh" %>
        ...
        <div>
                    ...
                    <table class="table1">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <asp:TextBox ID="txtDiem" runat="server" CssClass="user" Width="60px" Height="31px"></asp:TextBox>
                                <b style="width: 50px;">Khoản</b>
                                <asp:TextBox ID="txtKhoan" runat="server" CssClass="user" Width="60px" Height="31px"></asp:TextBox>
                                <b style="width: 50px;">Điều</b>
                                <asp:TextBox ID="txtDieu" runat="server" CssClass="user" Width="60px" Height="31px"></asp:TextBox>
                        ...
                        <tr>
                            <td colspan="2">
                                <div style="float: left; width: 100%; text-align: left; font-style: italic;">
                                    ...
                                    2. Ấn chọn "Cập nhật" để gán điều luật áp dụng cho bị can
                                </div>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style=" text-align:center;">
                                                    <asp:Panel ID="pnChonHinhPhat" runat="server">
                                                        <a href="javascript:;" onclick="popupChonHinhPhat(<%#Eval("ID") %>)">Hình phạt</a>
                                                    </asp:Panel>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
            ...
            <script>
                function popupChonHinhPhat(ToiDanhID) {
                    var link = "pChonHinhPhat.aspx?aID=<%=BanAnID%>&bID=<%=BiCaoID%>&tID=" + ToiDanhID;
                    var width = 800;
                    var height = 550;
