<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="NguoiTienhanhTT.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.PhucTham.NguoiTienhanhTT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="box_nd">
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            <td style="width: 145px;">Vai trò tham gia tố tụng<span class="batbuoc">(*)</span></td>
                            <td style="width: 165px;">
                                <asp:DropDownList ID="ddlTucachTGTT" CssClass="chosen-select" 
                                    runat="server" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlTucachTGTT_SelectedIndexChanged">
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtSoQD" runat="server" Width="242px" CssClass="user"></asp:TextBox>
                            </td>
                        ...
                        <asp:Panel ID="pnThamphan" runat="server">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlNguoiphancong" CssClass="chosen-select" 
                                        runat="server" Width="250px"></asp:DropDownList></td>
                            </tr>
                        </asp:Panel>
                        <asp:Panel ID="pnHTND" runat="server" Visible="false">
                            <tr>
                                <td><asp:Label ID="lblHTND" runat="server"></asp:Label><span class="batbuoc">(*)</span></td>
                                <td>
                                    <asp:DropDownList ID="ddlHTND_Thuky" CssClass="chosen-select"
                                        runat="server" Width="250px"></asp:DropDownList></td>
                                <td>Người phân công</td>
                                <td>
                                    <asp:DropDownList ID="ddlHTND_NguoiPC" CssClass="chosen-select" 
                                        runat="server" Width="250px"></asp:DropDownList></td>
                            </tr>
                            
                        </asp:Panel>
                        <%--<asp:Panel ID="pnDuKhuyet" runat="server">
                            <tr>
                                <td>Dự khuyết</td>
                                <td>
                                    <asp:RadioButtonList ID="rdbDuKhuyet" runat="server" RepeatDirection="Horizontal">
                        ...
                        <asp:Panel ID="pnKSV" runat="server" Visible="false">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlKSV_Nguoi" CssClass="chosen-select"
                                        runat="server" Width="250px"></asp:DropDownList></td>
                                <td></td>
                                <td></td>
                            </tr>
                        ...
                        <asp:Panel ID="pnPhancong" runat="server">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtNgayphancong" runat="server" CssClass="user" Width="242px" MaxLength="10"></asp:TextBox>
                                ...
                                <td>
                                    <asp:TextBox ID="txtNhanphancong" runat="server" CssClass="user" Width="242px" MaxLength="10"></asp:TextBox>
                        ...
                        <tr>
                            <td>Ngày kết thúc</td>
                            <td colspan="3">
                                <asp:TextBox ID="txtNgayketthuc" runat="server" CssClass="user" Width="242px" MaxLength="10"></asp:TextBox>
                ...
                <table class="table1">
                    <tr>
                        <td colspan="2" style="text-align: center;">
                            <asp:Button ID="btnUpdate" runat="server" CssClass="buttoninput" OnClientClick="return ValidInputData();" Text="Lưu" OnClick="btnUpdate_Click" />
                            ...
                            <asp:Panel runat="server" ID="pndata" Visible="false">
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="25%">
                                            <HeaderTemplate>
                                              Họ và tên
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:BoundColumn DataField="SOQD" HeaderText="Số QĐ" HeaderStyle-Width="140px" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="NGAYQD" HeaderText="Ngày QĐ" HeaderStyle-Width="75px" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundColumn>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                <%#Eval("ChucVu_NguoiPC") +" "%> <%#Eval("NguoiPhanCong") %>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
    ...
    <script type="text/javascript">
        function ValidInputData() {
            ...
            if (LengthSoQD == 0) {
                alert('Bạn chưa nhập số quyết định. Hãy nhập lại!');
                txtSoQD.focus();
                return false;
            }
            if (LengthSoQD > 50) {
                alert('Số quyết định không nhập quá 50 ký tự. Hãy nhập lại!');
                txtSoQD.focus();
                return false;
            }
