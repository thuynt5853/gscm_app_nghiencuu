<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Capnhatkhangcaoquahan.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.PhucTham.Capnhatkhangcaoquahan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                        ...
                                        <table class="table1">
                                            <tr>
                                                ...
                                                <td style="width: 127px;">
                                                    <asp:TextBox ID="txtMaVuAn" CssClass="user" runat="server" Width="100px" MaxLength="50"></asp:TextBox></td>
                                                <td style="width: 60px;">Tên vụ án</td>
                                                <td>
                                                    <asp:TextBox ID="txtTenVuAn" CssClass="user" runat="server" Width="360px" MaxLength="250"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                            ...
                            <td>
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4" PageSize="10" AllowPaging="True" GridLines="None" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="MAVUAN" HeaderText="Mã vụ án" HeaderStyle-Width="130px" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="TENVUAN" HeaderText="Tên vụ án" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
    ...
    <asp:Panel ID="pnCapnhat" runat="server" Visible="false">
        ...
        <div class="box">
            <div class="box_nd">
                <div class="truong">
                    <div class="boxchung">
                        <h4 class="tleboxchung">Kết quả giải quyết kháng cáo quá hạn</h4>
                        <div class="boder" style="padding: 10px;">
                            <table class="table1">
                                <tr>
                                    <td colspan="6">
                                ...
                                <tr>
                                    <td style="width: 80px;">TP Chủ tọa<span class="batbuoc">(*)</span></td>
                                    <td>
                                        <asp:DropDownList ID="ddlGQ_Thamphan" CssClass="chosen-select" runat="server" Width="250px"
                                             AutoPostBack="True" OnSelectedIndexChanged="ddlGQ_Thamphan_SelectedIndexChanged"></asp:DropDownList>
                                    </td>
                                    <td style="width: 80px;">TP Thành viên 1<span class="batbuoc">(*)</span></td>
                                    <td>
                                        <asp:DropDownList ID="ddlGQ_Thamphan1" CssClass="chosen-select" runat="server" Width="250px"
                                             AutoPostBack="True" OnSelectedIndexChanged="ddlGQ_Thamphan1_SelectedIndexChanged"></asp:DropDownList>
                                    </td>
                                    <td style="width: 80px;">TP Thành viên 2<span class="batbuoc">(*)</span></td>
                                    <td>
                                        <asp:DropDownList ID="ddlGQ_Thamphan2" CssClass="chosen-select" runat="server" Width="250px"
                                             AutoPostBack="True" OnSelectedIndexChanged="ddlGQ_Thamphan2_SelectedIndexChanged"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Ghi chú</td>
    ...
    <script type="text/javascript">
        function validateSearch() {
            ...
            if (lengthTuNgay > 0 && lengthDenNgay > 0 && HieulucTuNgay > HieulucDenNgay) {
        ...
        function validateUpdate() {
            ...
            var ddlGQ_Thamphan1 = document.getElementById('<%=ddlGQ_Thamphan1.ClientID%>');
            var val = ddlGQ_Thamphan1.options[ddlGQ_Thamphan1.selectedIndex].value;
            if (val == 0) {
                alert('Bạn chưa chọn Thẩm phán thành viên HDXX. Hãy chọn lại!');
                ddlGQ_Thamphan1.focus();
                return false;
            }
            var ddlGQ_Thamphan2 = document.getElementById('<%=ddlGQ_Thamphan2.ClientID%>');
            var val = ddlGQ_Thamphan2.options[ddlGQ_Thamphan2.selectedIndex].value;
            if (val == 0) {
                alert('Bạn chưa chọn Thẩm phán thành viên HDXX. Hãy chọn lại!');
                ddlGQ_Thamphan2.focus();
                return false;
            }
