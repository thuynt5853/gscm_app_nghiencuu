    ...
    public partial class NguoiThamgiaTT : System.Web.UI.Page
    {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (oT.MAGIAIDOAN == ENUM_GIAIDOANVUAN.THULYGDT || oT.MAGIAIDOAN == ENUM_GIAIDOANVUAN.SOTHAM)
                {
                    ...
                    string toaGiaiQuyetID = oT.TOA_GIAIQUYET_ID.ToString();
                ...
                //{
                //    // check quyền để hiển thị nút xoá
                //    string toaGiaiQuyetID = oT.TOA_PHUCTHAM_GIAIQUYET_ID.ToString();
                //    if (string.IsNullOrEmpty(toaGiaiQuyetID))
                //    {
                //        toaGiaiQuyetID = oT.TOA_GIAIQUYET_ID.ToString();
                //    }
                //    string donviID = Session[ENUM_SESSION.SESSION_DONVIID]?.ToString();
                //    if (toaGiaiQuyetID != donviID)
                //    {
        ...
        void SaveData()
        {
                   ...
                   || ddlTuCachTGTT.SelectedValue == "549" || ddlTuCachTGTT.SelectedValue == "130" || ddlTuCachTGTT.SelectedValue == "131")
            {
                ...
                try{ oND.NGAY_DK = (String.IsNullOrEmpty(txt_NGAY_DK.Text.Trim())) ? (DateTime?)null : DateTime.Parse(this.txt_NGAY_DK.Text.Trim(), cul, DateTimeStyles.NoCurrentDateDefault); } catch (Exception){}
        ...
        public void LoadGrid()
        {
            ...
            DataTable tbl = objBL.AHS_NTGTT_GetByVuAnID_PT(VuAnID, "PHUCTHAM", pageindex, page_size);
            if (tbl != null && tbl.Rows.Count > 0)
            {
        ...
        public void GetBicao()
        {
            ...
            DataTable tbl = objBL.GetAllBiCan_bihai_PhucTham(VuAnID);
