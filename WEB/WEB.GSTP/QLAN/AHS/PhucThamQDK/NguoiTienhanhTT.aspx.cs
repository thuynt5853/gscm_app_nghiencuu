...
namespace WEB.GSTP.QLAN.AHS.PhucThamQDK
{
    public partial class NguoiTienhanhTT : System.Web.UI.Page
    {
        ...
        private void CheckQuyen()
        {
            ...
            //AHS_KCKNQDK_PHUCTHAM_BANAN ba = DataExtensions.GetAllWithClause < AHS_KCKNQDK_PHUCTHAM_BANAN>($"VUANID = {DONID}").FirstOrDefault();
            //if (ba != null)
            //{
            ...
            DataTable oDT = (new DM_QUYETDINH_VUAN_KETTHUC()).DGLIST_BAQD_QUYETDINH_KETTHUC_PT(ENUM_LOAIVUVIEC_NUMBER.AN_HINHSU, DONID);
            if (oDT.Rows.Count > 0)
            {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                AHS_KCKNQDK_PHUCTHAM_QUYETDINH_VUAN qdVA = DataExtensions.GetAllWithClause<AHS_KCKNQDK_PHUCTHAM_QUYETDINH_VUAN>($"VUANID = {DONID} AND TOA_GIAIQUYET_ID = {Donvi_ID}").FirstOrDefault();
                AHS_KCKNQDK_PHUCTHAM_QUYETDINH_BICAN qdBA = DataExtensions.GetAllWithClause<AHS_KCKNQDK_PHUCTHAM_QUYETDINH_BICAN>($"VUANID = {DONID} AND TOA_GIAIQUYET_ID = {Donvi_ID}").FirstOrDefault();
        ...
        private void LoadCombobox()
        {
            ...
            if (loaiQD != null)
            {
                AHS_KCKNQDK_PHUCTHAM_QUYETDINH_VUAN qd = DataExtensions.GetAllWithClause<AHS_KCKNQDK_PHUCTHAM_QUYETDINH_VUAN>($"VUANID = {VuAnID} AND LOAIQDID = {loaiQD.ID}").FirstOrDefault();
                if (qd != null)
                {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AHS_KCKNQDK_PHUCTHAM_HDXX oND;

                // Lấy count thụ lý và count chủ tọa để cho nhập thêm thẩm phán chủ tọa
                List<AHS_THAMPHANGIAIQUYET> countTPGQ = dt.AHS_THAMPHANGIAIQUYET.Where(x => x.VUANID == VuAnID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETPHUCTHAM && x.TOA_GIAIQUYET_ID == donviId).ToList();
                List<AHS_KCKNQDK_PHUCTHAM_HDXX> countChuToa = DataExtensions.GetAllWithClause<AHS_KCKNQDK_PHUCTHAM_HDXX>($"VUANID = {VuAnID} AND MAVAITRO = '{ENUM_NGUOITIENHANHTOTUNG.THAMPHAN}' AND TOA_GIAIQUYET_ID = '{donviId}'").ToList();
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    if (tucach == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN)
                    {
                        ...
                        oND = DataExtensions.GetAllWithClause<AHS_KCKNQDK_PHUCTHAM_HDXX>($"VUANID = {VuAnID} AND MAVAITRO = '{ENUM_NGUOITIENHANHTOTUNG.THAMPHAN}' AND TOA_GIAIQUYET_ID = '{donviId}'").FirstOrDefault();
                    ...
                    oND = new AHS_KCKNQDK_PHUCTHAM_HDXX();
                }
                else
                {
                    decimal ID = Convert.ToDecimal(hddid.Value);
                    oND = DataExtensions.FindById<AHS_KCKNQDK_PHUCTHAM_HDXX>(ID);
                }
                oND.VUANID = VuAnID;
                oND.MAVAITRO = tucach;
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    AHS_KCKNQDK_PHUCTHAM_HDXX CheckCanBo = DataExtensions.GetAllWithClause<AHS_KCKNQDK_PHUCTHAM_HDXX>($"VUANID = {VuAnID} AND  CANBOID = {oND.CANBOID}").FirstOrDefault();
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AHS_KCKNQDK_PHUCTHAM_HDXX_GETLIST(ID);
        ...
        {
            AHS_KCKNQDK_PHUCTHAM_HDXX oND = DataExtensions.FindById<AHS_KCKNQDK_PHUCTHAM_HDXX>(id);
