<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true"
    CodeBehind="ChuyenAn.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.ChuyenNhanAn.ChuyenAn" %>
                                        ...
                                        <table class="table1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <%--  <asp:TextBox ID="txtToaAnNhan" CssClass="user" runat="server" Width="242px" MaxLength="250"></asp:TextBox>--%>
    ...
    <script type="text/javascript">
       ...
       <%-- var urldmHanhchinh = '<%=ResolveUrl("~/Ajax/SearchDanhmuc.aspx/SearchTopToaAn") %>';
        ...
        function popup_chitiet(V_VUANID, V_MAVUAN) {
            ...
            var link = "/QLAN/AHS/ChuyenNhanAn/ChuyenAn_Chitiet.aspx?vuanid=" + V_VUANID + "&mavuan=" + V_MAVUAN;
            var width = 800;
            var height = 700;
