<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="NhanAn.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.ChuyenNhanAn.NhanAn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                    ...
                                    <div class="boder" style="padding: 10px;">
                                        <table class="table1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="float: left; width: 80px; text-align: right; margin-right: 10px;">Người kháng cáo</div>
                                                    <div style="float: left;">
                            ...
                            <td>
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4" PageSize="10" AllowPaging="True" GridLines="None"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="v_TENVUAN" HeaderText="Thông tin vụ việc" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="200px"></asp:BoundColumn>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="300px" ItemStyle-HorizontalAlign="Justify">
                                            <HeaderTemplate>
                                                Nội dung
                                            </HeaderTemplate>
                                            <ItemTemplate>
    ...
    <script type="text/javascript">
        ...
        function popup_chitiet(V_VUANID, V_MAVUAN) {

            var link = "/QLAN/AHS/ChuyenNhanAn/NhanAn_Chitiet.aspx?vuanid=" + V_VUANID + "&mavuan=" + V_MAVUAN;
            var width = 800;
            var height = 700;
            PopupReport(link, "Thông tin vụ việc", width, height);
        }
