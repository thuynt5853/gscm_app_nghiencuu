<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="pChonToiDanh.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.TaoHS.Popup.pChonToiDanh" %>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <div style="float: left; width: 100%; text-align: left; font-style: italic;">
                                            ...
                                            2. Ấn chọn "Lưu" để gán điều luật áp dụng cho bị cáo
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                            ...
                                            <div class="phantrang">
                                                <div class="sobanghi">
                                                    <asp:Button ID="cmdSave" runat="server" CssClass="buttoninput"
                                                        Text="Lưu quyết định cho bị cáo" OnClick="cmdSave_Click" />
