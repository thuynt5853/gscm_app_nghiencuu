<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uDSBiCao.ascx.cs" Inherits="WEB.GSTP.QLAN.AHS.TaoHS.Popup.uDSBiCao" %>
<asp:HiddenField ID="hddTotalPage" Value="1" runat="server" />
<asp:HiddenField ID="hddPageIndex" Value="1" runat="server" />

<%--<a href="javascript:;" onclick="popup_edit_bicao(0);" 
    style="float: right;" class="buttonpopup">Thêm bị cáo</a>--%>
...
<table class="table2" style="width: 100%" border="1">
    <tr class="header">
        ...
        <td width="25px">
            <div align="center"><strong>Bị cáo đầu vụ</strong></div>
        </td>
        <td style="width: 35%">
        ...
        <td width="25px">
            <div align="center"><strong>Ngày bị khởi tố</strong></div>
        </td>
        <td style="width: 15%">
    ...
    <asp:Repeater ID="rptBiCan" runat="server" OnItemCommand="rptBiCan_ItemCommand" OnItemDataBound="rptBiCan_ItemDataBound">
        <ItemTemplate>
            <tr>
                ...
                <td>                    
                    <div align="center">
                        <asp:Label ID ="lbNamSinh" runat="server" Text="" ></asp:Label>
                    </div>
                </td>
                <td></td> <%-- Ngày bị khởi tố %> 
                ...
                <td>
                    <div align="center">
                        ...
                        <asp:LinkButton ID="lbtXoa" runat="server" CausesValidation="false"
                            ...
                            ToolTip="Xóa" OnClientClick="return confirm('Bạn thực sự muốn xóa bản ghi này? ');">
                        </asp:LinkButton>
                    </div>
                </td>
            </tr>
...
<script>
    function popup_edit_bicao(BiCaoID) {
        ...
        var link = "";
        if (BiCaoID > 0)
            link = "/QLAN/AHS/TaoHS/popup/pBiCao.aspx?hsID=" + VuAnID + "&bID=" + BiCaoID;
        else
            link = "/QLAN/AHS/TaoHS/popup/pBiCao.aspx?hsID=" + VuAnID;
        var width = 950;
        var height = 650;
