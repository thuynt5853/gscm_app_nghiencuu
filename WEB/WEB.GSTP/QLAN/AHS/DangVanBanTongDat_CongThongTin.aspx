<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="DangVanBanTongDat_CongThongTin.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.DangVanBanTongDat_CongThongTin" %>
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1" style="width: 53%; margin: auto;">
                        ...
                        <tr>
                            <td><b>Tên vụ án</b></td>
                            <td>
                                <asp:TextBox ID="txtTenVuAn" CssClass="user" runat="server" Width="400px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td><b>Số BA/QĐ</b></td>
