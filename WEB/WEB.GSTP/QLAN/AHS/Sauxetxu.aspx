<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Sauxetxu.aspx.cs" Inherits="WEB.GSTP.QLAN.AHS.Sauxetxu" %>
                                    ...
                                    <div class="boder" style="padding: 10px;">
                                        <table class="table1">
                                            <tr>
                                                ...
                                                <td style="width: 92px;">Tên vụ án</td>
                                                <td>
                                                    <asp:TextBox ID="txtTenVuAn" CssClass="user" runat="server" Width="360px" MaxLength="250"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td>Số QĐ/BA</td>
                                                <td><asp:TextBox ID="txtSoQDBA" CssClass="user" runat="server" Width="100px" MaxLength="50"></asp:TextBox></td>
                                                <td>Tên bị can/bị cáo</td>
                                                <td><asp:TextBox ID="txtTenBiCanBiCao" CssClass="user" runat="server" Width="360px" MaxLength="250"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td>Ngày QĐ/BA từ</td>
                                                <td>
                    ...
                    <div class="boxchung">
                        ...
                        <div class="boder" style="padding: 10px;">
                            <table class="table1">
                                <tr>
                                    <td colspan="4">
                                         <b>DANH SÁCH CÁC VỤ ÁN ĐÃ CHỌN</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
