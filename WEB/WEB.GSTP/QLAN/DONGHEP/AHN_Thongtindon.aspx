<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AHN_Thongtindon.aspx.cs" Inherits="WEB.GSTP.QLAN.DONGHEP.AHN_Thongtindon" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/QLAN/AHN/Hoso/Popup/pDuongSuKhacChiTiet.ascx" TagPrefix="uc1" TagName="DsDuongSuChiTiet" %>
...
<body>
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlLoaiQuanhe" Visible="false" CssClass="chosen-select" runat="server" Width="250px">
                            ...
                            <tr runat="server" id="trLydoLyhon">
                                ...
                                <td>Số con từ 7 đến dưới 18 tuổi<span class="batbuoc">(*)</span></td>
                                <td>
                                    <asp:TextBox ID="txtSoconchuathanhnien" CssClass="user" onkeypress="return isNumber(event)" runat="server" Width="110px" MaxLength="2"></asp:TextBox></td>
                            </tr>
                            <tr>
                            ...
                            <asp:Panel ID="pnNDCanhan" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtND_TTChitiet" CssClass="user" runat="server" Width="255px" MaxLength="250"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>Nơi làm việc</td>
                                    <td colspan="3">
                                        <asp:TextBox ID="txtND_NoiLamViec" CssClass="user" runat="server" Width="602px" MaxLength="500"></asp:TextBox>
                                    </td>
                                </tr>
                            </asp:Panel>
                            <tr>
                                ...
                                <td>Điện thoại</td>
                                <td>
                                    <asp:TextBox ID="txtND_Dienthoai" runat="server" CssClass="user" Width="119px"></asp:TextBox>
                                    Fax
                                    <asp:TextBox ID="txtND_Fax" runat="server" CssClass="user" Width="110px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
                            ...
                            <asp:Panel ID="pnBD_Canhan" runat="server">
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       Năm sinh
                                        <asp:TextBox ID="txtBD_Namsinh" CssClass="user" runat="server" onkeypress="return isNumber(event)" Width="50px" MaxLength="4" AutoPostBack="true" OnTextChanged="txtBD_Namsinh_TextChanged"></asp:TextBox>
                                        Tuổi
                                        <asp:TextBox ID="txtBD_Tuoi" CssClass="user" onkeypress="return isNumber(event)" runat="server" Width="48px" MaxLength="2"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
 ...
 <tr>
                                    <td>Nơi làm việc</td>
                                    <td colspan="3">
                                         <asp:TextBox ID="txtBD_NoiLamViec" CssClass="user" runat="server" Width="596px" MaxLength="500"></asp:TextBox>
                                    </td>
                                </tr>
                            </asp:Panel>
                            <tr>
                                ...
                                <td>Điện thoại</td>
                                <td>
                                    <asp:TextBox ID="txtBD_Dienthoai" runat="server" CssClass="user" Width="119px"></asp:TextBox>
                                    Fax
