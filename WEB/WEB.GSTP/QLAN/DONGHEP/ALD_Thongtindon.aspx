<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ALD_Thongtindon.aspx.cs" Inherits="WEB.GSTP.QLAN.DONGHEP.ALD_Thongtindon" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/QLAN/ALD/Hoso/Popup/pDuongSuKhacChiTiet.ascx" TagPrefix="uc1" TagName="DsDuongSuChiTiet" %>
...
<body>
            ...
            <div class="truong">
                        ...
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="txtQuanhephapluat" CssClass="user" placeholder="" runat="server" Width="251px" MaxLength="500" TextMode="MultiLine"></asp:TextBox>
                ...
                <div class="boxchung">
                    <h4 class="tleboxchung">
                        <asp:Literal ID="lstTitleNguyendon" runat="server" Text="Thông tin nguyên đơn (đại diện)"></asp:Literal>
                    </h4>
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                            ...
                            <tr>
                                <td style="width: 115px;">Nguyên đơn là<span class="batbuoc">(*)</span></td>
                                <td style="width: 260px;">
                                ...
                                <td colspan="2">
                                    <asp:CheckBox ID="chkISBVQLNK" Visible="false" runat="server" Text="Khởi kiện bảo vệ quyền và lợi ích hợp pháp của người khác, lợi ích công cộng và nhà nước" />
                                     <asp:CheckBox ID="chkND_IsNguoitantat" runat="server" Text="<span style='position: absolute;'>Người lao động là người tàn tật</span>" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                               ...
                               <td style="width: 70px;">Quốc tịch<span class="batbuoc">(*)</span></td>
                                <td>
                                    <asp:DropDownList ID="ddlND_Quoctich" CssClass="chosen-select" runat="server" Width="255px" AutoPostBack="True" OnSelectedIndexChanged="ddlND_Quoctich_SelectedIndexChanged"></asp:DropDownList></td>
                            </tr>
                            <tr>
                                    <td></td>
                                    <td colspan="3">
                                ...
                                <%--    <td>Giới tính</td>
                                    <td>
                                        <asp:DropDownList ID="ddlND_Gioitinh" CssClass="chosen-select" runat="server" Width="250px">
                                          ...
                                          <td>
                                              <asp:RadioButtonList ID="ddlND_Gioitinh" AutoPostBack="true" Width="200px"
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtND_Namsinh" CssClass="user" onkeypress="return isNumber(event)" runat="server" Width="50px" MaxLength="4" AutoPostBack="true" OnTextChanged="txtND_Namsinh_TextChanged"></asp:TextBox>
                                        Tuổi
                                        <asp:TextBox ID="txtND_Tuoi" CssClass="user" onkeypress="return isNumber(event)" runat="server" Width="35px" MaxLength="2"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
 ...
 <tr>
                                    <td>Nơi làm việc</td>
                                    <td colspan="3">
                                         <asp:TextBox ID="txtND_NoiLamViec" CssClass="user" runat="server" Width="597px" MaxLength="603"></asp:TextBox>
                                    </td>
                                </tr>
                            </asp:Panel>
                            <tr>
                                ...
                                <td >Điện thoại</td>
                                <td>
                                    <asp:TextBox ID="txtND_Dienthoai" runat="server" CssClass="user" Width="112px"></asp:TextBox>
                                    Fax
                                    <asp:TextBox ID="txtND_Fax" runat="server" CssClass="user" Width="112px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="boxchung">
                    <h4 class="tleboxchung">
                        <asp:Literal ID="lstTitleBidon" runat="server" Text="Thông tin bị đơn (đại diện)"></asp:Literal></h4>
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                                <td style="width: 115px;">Danh sách đương sự<span class="batbuoc">(*)</span></td>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:CheckBox ID="chkBD_IsNguoitantat" runat="server" Text="<span style='position: absolute;'>Người lao động là người tàn tật</span>" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <asp:Panel ID="pnBD_Tochuc" runat="server" Visible="false">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtBD_NDD_Diachichitiet" CssClass="user" runat="server" Width="255px" MaxLength="250"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Người đại diện</td>
                            ...
                            <tr>
                                ...
                                <td>
                                  ...
                                  <td style="width: 70px;">Quốc tịch<span class="batbuoc">(*)</span></td>
                                <td>
                                    <asp:DropDownList ID="ddlBD_Quoctich" CssClass="chosen-select" runat="server" Width="252px" AutoPostBack="True" OnSelectedIndexChanged="ddlBD_Quoctich_SelectedIndexChanged"></asp:DropDownList></td>
                            </tr>
                            <tr>
                                    <td></td>
                                    <td colspan="3">
                                        <asp:CheckBox ID="chkBoxCMNDBD" AutoPostBack="true" runat="server" Text="Không có" OnCheckedChanged="chkBoxCMNDND_CheckedChanged" />
                                    </td>
                                </tr>
                            <asp:Panel ID="pnBD_Canhan" runat="server">
                                ...
                                <%--    <td>Giới tính</td>
                                    <td>
                                        <asp:DropDownList ID="ddlBD_Gioitinh" CssClass="chosen-select" runat="server" Width="250px">
                                          ...
                                          <td>Giới tính<span class="batbuoc">(*)</span></td>
                                  <td>
                                      <asp:RadioButtonList ID="ddlBD_Gioitinh" AutoPostBack="true" Width="200px"
                                          runat="server" RepeatDirection="Horizontal">
                                          <asp:ListItem Value="0" Text="Nữ"></asp:ListItem>
                                          <asp:ListItem Value="1" Text="Nam"></asp:ListItem>
                                      </asp:RadioButtonList>
                                    ...
                                    <td>
                                        ...
                                        Năm sinh
                                        <asp:TextBox ID="txtBD_Namsinh" CssClass="user" runat="server" onkeypress="return isNumber(event)" Width="60px" MaxLength="4" AutoPostBack="true" OnTextChanged="txtBD_Namsinh_TextChanged"></asp:TextBox>
                                        Tuổi
                                        <asp:TextBox ID="txtBD_Tuoi" CssClass="user" onkeypress="return isNumber(event)" runat="server" Width="40px" MaxLength="2"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                               ...
                               <%-- <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtBD_HKTT_Chitiet" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox>
                                    </td>
                                </tr>--%>
                                <tr>
                                    <td>Nơi cư trú</td>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtBD_Tamtru_Chitiet" CssClass="user" runat="server" Width="251px" MaxLength="250"></asp:TextBox>
                                    </td>
                                </tr>
 ...
 <tr>
                                    <td>Nơi làm việc</td>
                                    <td colspan="3">
                                         <asp:TextBox ID="txtBD_NoiLamViec" CssClass="user" runat="server" Width="597px" MaxLength="500"></asp:TextBox>
                                    </td>
                                </tr>
                            </asp:Panel>
                            <tr>
                                ...
                                <td>Điện thoại</td>
                                <td>
                                    <asp:TextBox ID="txtBD_Dienthoai" runat="server" CssClass="user" Width="112px"></asp:TextBox>
                                    Fax
                                    <asp:TextBox ID="txtBD_Fax" runat="server" CssClass="user" Width="112px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
