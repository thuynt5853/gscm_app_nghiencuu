<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="ADS_Thongtindon.aspx.cs" Inherits="WEB.GSTP.QLAN.DONGHEP.DONKHAC.ADS_Thongtindon" %>
                    ...
                    <%--<div class="boder" style="padding: 10px;">
                                <table class="table1">
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style2">Loại kháng cáo<span class="batbuoc">(*)</span></td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style2">Kháng cáo quá hạn<span class="batbuoc">(*)</span></td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style2">Tòa ra QĐ/BA</td>
                                        <td>
                                ...
                                <table class="table1">
                                    ...
                                    <asp:Panel ID="pnCaNhanDK" runat="server">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <asp:TextBox ID="txtDiaChiCT_DK" runat="server" CssClass="user" Height="25px" Width="670px" MaxLength="100"></asp:TextBox></td>
                                        </tr>
                                    </asp:Panel>
                                    <tr>
                                        <td>Email</td>
