...
{
    public partial class ALD_Thongtindon : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    {
                        current_id = Session[ENUM_LOAIAN.AN_LAODONG] + "";
                        ...
                        ALD_DON oT = dt.ALD_DON.Where(x => x.ID == IdDon).FirstOrDefault();
        ...
        private void LoadInfo(decimal ID)
        {
            ...
            DON_KHAC oD = dt.DON_KHAC.Where(x => x.ID == ID && x.LOAIANID == 5).FirstOrDefault();
            ALD_DON ALD = dt.ALD_DON.FirstOrDefault(s => s.ID == oD.DONID);
            txtMaVuViec.Text = ALD.MAVUVIEC;
            txtTenVuViec.Text = ALD.TENVUVIEC;
            ...
            ddlLoaiQuanhe.SelectedValue = ALD.LOAIQUANHE.ToString();
            ALD_DON ALDoD = dt.ALD_DON.Where(x => x.ID == oD.DONID).FirstOrDefault();
            txtQuanhephapluat_name(ALDoD);
            if (ALD.QHPLTKID != null)
                ddlQHPLTK.SelectedValue = ALD.QHPLTKID.ToString();
            ...
            if (oD.LOAIDON == 8)
            {
                if (oD.ISDUONGSU == 0)
                {
                    ALD_DON_THAMGIATOTUNG oTT = dt.ALD_DON_THAMGIATOTUNG.Where(x => x.ID == oD.DUONGSUID).FirstOrDefault();
                ...
                if (oD.ISDUONGSU == 1)
                {
                    ALD_DON_DUONGSU oDonDS = dt.ALD_DON_DUONGSU.Where(x => x.ID == oD.DUONGSUID).FirstOrDefault();
        ...
        private void LoadCombobox()
        {
            ...
            ALD_DON_DUONGSU_BL oBL_DS_TGTT = new ALD_DON_DUONGSU_BL();
            ddlNguoidungdon.DataSource = oBL_DS_TGTT.ALD_DON_DUONGSU_THAMGIATOTUNG(Convert.ToDecimal(donid));
            ...
            //Load đương sự
            ddlNguoiKC.DataSource = oBL_DS_TGTT.ALD_DON_DUONGSU_THAMGIATOTUNG(Convert.ToDecimal(donid));
        ...
        private bool SaveData()
        {
            try
            {
                ...
                if (loaiDon == "7")
                {
                    ...
                    {
                        oKC = dt.DON_KHAC.Where(x => x.ID == ID && x.LOAIANID == 5).FirstOrDefault();
                    }
                    ...
                    oKC.DONID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_LAODONG]);
                    oKC.LOAIANID = Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_LAODONG);
                    ...
                    ALD_DON oDS = dt.ALD_DON.Where(x => x.ID == oKC.DONID).FirstOrDefault();
                ...
                else if (loaiDon == "8")
                {
                    ...
                    {
                        oDK = dt.DON_KHAC.Where(x => x.ID == ID && x.LOAIANID == 5).FirstOrDefault();
                    }
                    DateTime dNgayNhanKC;
                    DateTime dNgayGhiTrenDon;
                    dNgayNhanKC = (String.IsNullOrEmpty(txtNgayNhan.Text.Trim())) ? DateTime.MinValue : DateTime.Parse(this.txtNgayNhan.Text.Trim(), cul, DateTimeStyles.NoCurrentDateDefault);
                    ...
                    oDK.DONID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_LAODONG]);
                    oDK.LOAIANID = Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_LAODONG);
                    ...
                    {
                        ALD_DON_DUONGSU ALD_DuongSu = null;

                        if (idDuongSuDK == 0)
                        {
                            ALD_DuongSu = new ALD_DON_DUONGSU();
                        }
                        else
                        {
                            ALD_DuongSu = dt.ALD_DON_DUONGSU.Where(x => x.ID == idDuongSuDK).FirstOrDefault();
                        }
                        decimal donid = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_LAODONG]);
                        ALD_DuongSu.DONID = donid;
                        ALD_DuongSu.TENDUONGSU = Cls_Comon.FormatTenRieng(txtHoTen_DK.Text);
                        if (ALD_DuongSu.ISDAIDIEN == 1)
                        {
                            ALD_DuongSu.ISDAIDIEN = 1;
                        }
                        else
                        {
                            ALD_DuongSu.ISDAIDIEN = 0;
                        }
                        ALD_DuongSu.TUCACHTOTUNG_MA = TCTT.MA;
                        ALD_DuongSu.LOAIDUONGSU = Convert.ToDecimal(ddlLoaidungdon.SelectedValue);
                        //if (chkISBVQLNK.Visible)
                        //    ALD_DuongSu.ISBVQLNGUOIKHAC = chkISBVQLNK.Checked ? 1 : 0;
                        //else
                        //    ALD_DuongSu.ISBVQLNGUOIKHAC = 0;
                        ALD_DuongSu.SOCMND = txtCMND_Dk.Text;
                        ALD_DuongSu.TAMTRUTINHID = Convert.ToDecimal(ddlTamtru_Tinh_DK.SelectedValue);
                        ALD_DuongSu.TAMTRUID = Convert.ToDecimal(ddlTamtru_Huyen_DK.SelectedValue);
                        ALD_DuongSu.TAMTRUCHITIET = txtDiaChiCT_DK.Text;
                        ...
                        ALD_DuongSu.NGAYSINH = dNDNgaysinh;
                        ALD_DuongSu.NAMSINH = txtNamsinh_DK.Text == "" ? 0 : Convert.ToDecimal(txtNamsinh_DK.Text);
                        ALD_DuongSu.GIOITINH = Convert.ToDecimal(ddlGioiTinh_DK.SelectedValue);
                        ALD_DuongSu.EMAIL = txtEmail_DK.Text;
                        ALD_DuongSu.DIENTHOAI = txtTel_DK.Text;
                        //if (pnNDTochuc.Visible)
                        //{
                        //    ALD_DuongSu.NDD_DIACHIID = Convert.ToDecimal(ddlNDD_Huyen_NguyenDon.SelectedValue);
                        //    ALD_DuongSu.NDD_DIACHICHITIET = txtND_NDD_Diachichitiet.Text;
                        //}
                        ALD_DuongSu.ISSOTHAM = 1;
                        ALD_DuongSu.ISDON = 1;
                        
                        if (idDuongSuDK != 0)
                        {
                            ALD_DuongSu.NGAYSUA = DateTime.Now;
                            ALD_DuongSu.NGUOISUA = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                            dt.SaveChanges();
                        }
                        else
                        {
                            ALD_DuongSu.NGAYTAO = DateTime.Now;
                            ALD_DuongSu.NGUOITAO = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                            
                            // quyennd
                            if (ALD_DuongSu.TOA_GIAIQUYET_ID == null)
                                ALD_DuongSu.TOA_GIAIQUYET_ID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                            
                            dt.ALD_DON_DUONGSU.Add(ALD_DuongSu);
                            dt.SaveChanges();
                        }
                        oDK.ISDUONGSU = 1;
                        oDK.DUONGSUID = ALD_DuongSu.ID;
                    }
                    if (TCTT != null && TCTT.GROUPID == 16)
                    {
                        ALD_DON_THAMGIATOTUNG ALD_TGTT = null;

                        if (idDuongSuDK == 0)
                        {
                            ALD_TGTT = new ALD_DON_THAMGIATOTUNG();
                        }
                        else
                        {
                            ALD_TGTT = dt.ALD_DON_THAMGIATOTUNG.Where(x => x.ID == idDuongSuDK).FirstOrDefault();
                        }
                        decimal donid = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_LAODONG]);
                        ALD_TGTT.DONID = donid;
                        ALD_TGTT.HOTEN = Cls_Comon.FormatTenRieng(txtHoTen_DK.Text);
                        //if (ALD_TGTT.ISDAIDIEN == 1)
                        //{
                        //    ALD_TGTT.ISDAIDIEN = 1;
                        //}
                        //else
                        //{
                        //    ALD_TGTT.ISDAIDIEN = 0;
                        //}
                        ALD_TGTT.TUCACHTGTTID = TCTT.MA;
                        //////ALD_TGTT. = Convert.ToDecimal(ddlLoaidungdon.SelectedValue);
                        //if (chkISBVQLNK.Visible)
                        //    ALD_TGTT.ISBVQLNGUOIKHAC = chkISBVQLNK.Checked ? 1 : 0;
                        //else
                        //    ALD_TGTT.ISBVQLNGUOIKHAC = 0;
                        ALD_TGTT.SOCMND = txtCMND_Dk.Text;
                        ALD_TGTT.TAMTRUTINHID = Convert.ToDecimal(ddlTamtru_Tinh_DK.SelectedValue);
                        ALD_TGTT.TAMTRUID = Convert.ToDecimal(ddlTamtru_Huyen_DK.SelectedValue);
                        ALD_TGTT.TAMTRUCHITIET = txtDiaChiCT_DK.Text;
                        DateTime dNDNgaysinh;
                        dNDNgaysinh = (String.IsNullOrEmpty(txtNgaysinh_DK.Text.Trim())) ? DateTime.MinValue : DateTime.Parse(this.txtNgaysinh_DK.Text.Trim(), cul, DateTimeStyles.NoCurrentDateDefault);
                        ALD_TGTT.NGAYSINH = dNDNgaysinh;
                        ALD_TGTT.NAMSINH = txtNamsinh_DK.Text == "" ? 0 : Convert.ToDecimal(txtNamsinh_DK.Text);
                        ALD_TGTT.GIOITINH = Convert.ToDecimal(ddlGioiTinh_DK.SelectedValue);
                        ALD_TGTT.EMAIL = txtEmail_DK.Text;
                        ALD_TGTT.DIENTHOAI = txtTel_DK.Text;
                        //if (pnNDTochuc.Visible)
                        //{
                        //    ALD_TGTT.NDD_DIACHIID = Convert.ToDecimal(ddlNDD_Huyen_NguyenDon.SelectedValue);
                        //    ALD_TGTT.NDD_DIACHICHITIET = txtND_NDD_Diachichitiet.Text;
                        //}
                        //ALD_TGTT.ISSOTHAM = 1;
                        //ALD_TGTT.ISDON = 1;
                        ...
                        if (idDuongSuDK != 0)
                        {
                            ALD_TGTT.NGAYSUA = DateTime.Now;
                            ALD_TGTT.NGUOISUA = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                            dt.SaveChanges();
                        }
                        else
                        {
                            ALD_TGTT.NGAYTAO = DateTime.Now;
                            ALD_TGTT.NGUOITAO = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                            
                            // quyennd
                            if (ALD_TGTT.TOA_GIAIQUYET_ID == null)
                                ALD_TGTT.TOA_GIAIQUYET_ID =  Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                            
                            dt.ALD_DON_THAMGIATOTUNG.Add(ALD_TGTT);
                            dt.SaveChanges();
                        }
                        oDK.ISDUONGSU = 0;
                        oDK.DUONGSUID = ALD_TGTT.ID;
                    }
                    ...
                    ALD_DON oDS = dt.ALD_DON.Where(x => x.ID == oDK.DONID).FirstOrDefault();
                    oDS.HINHTHUCNHANDON = Convert.ToDecimal(ddlHinhthucnhandon.SelectedValue);
                    dt.SaveChanges();
                }
                else
        ...
        protected void ddlNguoidungdon_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlNguoidungdon.SelectedValue == "0,0")
            {
                ...
                txtEmail_DK.Enabled = true;
                txtTel_DK.Enabled = true;
                chkBoxCMND_DK_CheckedChanged(sender, e);
            }
            else
            {
                if (isDuongSu == 1)
                {
                    ALD_DON_DUONGSU oDS = dt.ALD_DON_DUONGSU.Where(x => x.DONID == donid && x.ID == idDuongSu).FirstOrDefault();
                    ddlTuCachToTung_DK.Enabled = false;
                ...
                if (isDuongSu == 0)
                {
                    ALD_DON_THAMGIATOTUNG oDSTT = dt.ALD_DON_THAMGIATOTUNG.Where(x => x.DONID == donid && x.ID == idDuongSu).FirstOrDefault();
                    ddlTuCachToTung_DK.Enabled = false;
                    if (oDSTT.HOTEN != null)
                    {
                        txtHoTen_DK.Enabled = false;
            ...
            else
            {
                ...
                if (isDuongSu == 0)
                {
                    ALD_DON_THAMGIATOTUNG oTGTT = dt.ALD_DON_THAMGIATOTUNG.Where(x => x.DONID == donid && x.ID == idDuongSu).FirstOrDefault();
        ...
        {
            String temp = "";
            List<ALD_SOTHAM_BANAN> lst = dt.ALD_SOTHAM_BANAN.Where(x => x.DONID == DonID).OrderByDescending(y => y.NGAYTUYENAN).ToList();
            if (lst != null && lst.Count > 0)
            {
                foreach (ALD_SOTHAM_BANAN item in lst)
                {
        ...
        {
            String temp = "";
            ALD_SOTHAM_BL objBL = new ALD_SOTHAM_BL();
            DataTable tblQD = objBL.ALD_SOTHAM_QUYETDINH_GETLIST(DonID);
        ...
        private void LoadQD_BA_InfoKhangCao()
        {
            ...
            if (rdbLoaiKC.SelectedValue == "0")
            {
                ...
                ALD_SOTHAM_BANAN oT = dt.ALD_SOTHAM_BANAN.Where(x => x.ID == ID).FirstOrDefault();
                if (oT != null)
                {
            ...
            {
                decimal ID = Convert.ToDecimal(ddlQDBA.SelectedValue);
                ALD_SOTHAM_QUYETDINH oT = dt.ALD_SOTHAM_QUYETDINH.Where(x => x.ID == ID).FirstOrDefault();
                if (oT != null)
                {
            ...
            decimal DonIDID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_LAODONG] + "");
            ALD_DON oDon = dt.ALD_DON.Where(x => x.ID == DonIDID).FirstOrDefault();
            if (oDon != null)
            {
