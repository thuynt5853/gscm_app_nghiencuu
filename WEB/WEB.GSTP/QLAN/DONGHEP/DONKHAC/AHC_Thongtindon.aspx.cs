...
{
    public partial class AHC_Thongtindon : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        AHC_DON oT = dt.AHC_DON.Where(x => x.ID == IdDon).FirstOrDefault();
        ...
        private void LoadInfo(decimal ID)
        {
            ...
            DON_KHAC oD = dt.DON_KHAC.Where(x => x.ID == ID && x.LOAIANID == 6).FirstOrDefault();
            AHC_DON AHC = dt.AHC_DON.FirstOrDefault(s => s.ID == oD.DONID);
            txtMaVuViec.Text = AHC.MAVUVIEC;
            txtTenVuViec.Text = AHC.TENVUVIEC;
            ...
            ddlLoaiQuanhe.SelectedValue = AHC.LOAIQUANHE.ToString();
            AHC_DON AHCoD = dt.AHC_DON.Where(x => x.ID == oD.DONID).FirstOrDefault();
            txtQuanhephapluat_name(AHCoD);
            if (AHC.QHPLTKID != null)
                ddlQHPLTK.SelectedValue = AHC.QHPLTKID.ToString();
            ...
            if (oD.LOAIDON == 8)
            {
                if (oD.ISDUONGSU == 0)
                {
                    AHC_DON_THAMGIATOTUNG oTT = dt.AHC_DON_THAMGIATOTUNG.Where(x => x.ID == oD.DUONGSUID).FirstOrDefault();
                ...
                if (oD.ISDUONGSU == 1)
                {
                    AHC_DON_DUONGSU oDonDS = dt.AHC_DON_DUONGSU.Where(x => x.ID == oD.DUONGSUID).FirstOrDefault();
        ...
        private void LoadCombobox()
        {
            ...
            AHC_DON_DUONGSU_BL oBL_DS_TGTT = new AHC_DON_DUONGSU_BL();
            ddlNguoidungdon.DataSource = oBL_DS_TGTT.AHC_DON_DUONGSU_THAMGIATOTUNG(Convert.ToDecimal(donid));
            ...
            //Load đương sự
            ddlNguoiKC.DataSource = oBL_DS_TGTT.AHC_DON_DUONGSU_THAMGIATOTUNG(Convert.ToDecimal(donid));
        ...
        private bool SaveData()
        {
            try
            {
                ...
                if (loaiDon == "7")
                {
                    ...
                    {
                        oKC = dt.DON_KHAC.Where(x => x.ID == ID && x.LOAIANID == 6).FirstOrDefault();
                    }
                    ...
                    oKC.DONID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HANHCHINH]);
                    oKC.LOAIANID = Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HANHCHINH);
                    ...
                    AHC_DON oDS = dt.AHC_DON.Where(x => x.ID == oKC.DONID).FirstOrDefault();
                ...
                else if (loaiDon == "8")
                {
                    ...
                    {
                        oDK = dt.DON_KHAC.Where(x => x.ID == ID && x.LOAIANID == 6).FirstOrDefault();
                    }
                    DateTime dNgayNhanKC;
                    DateTime dNgayGhiTrenDon;
                    dNgayNhanKC = (String.IsNullOrEmpty(txtNgayNhan.Text.Trim())) ? DateTime.MinValue : DateTime.Parse(this.txtNgayNhan.Text.Trim(), cul, DateTimeStyles.NoCurrentDateDefault);
                    ...
                    oDK.DONID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HANHCHINH]);
                    oDK.LOAIANID = Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HANHCHINH);
                    ...
                    {
                        AHC_DON_DUONGSU AHC_DuongSu = null;

                        if (idDuongSuDK == 0)
                        {
                            AHC_DuongSu = new AHC_DON_DUONGSU();
                        }
                        else
                        {
                            AHC_DuongSu = dt.AHC_DON_DUONGSU.Where(x => x.ID == idDuongSuDK).FirstOrDefault();
                        }
                        decimal donid = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HANHCHINH]);
                        AHC_DuongSu.DONID = donid;
                        AHC_DuongSu.TENDUONGSU = Cls_Comon.FormatTenRieng(txtHoTen_DK.Text);
                        if (AHC_DuongSu.ISDAIDIEN == 1)
                        {
                            AHC_DuongSu.ISDAIDIEN = 1;
                        }
                        else
                        {
                            AHC_DuongSu.ISDAIDIEN = 0;
                        }
                        AHC_DuongSu.TUCACHTOTUNG_MA = TCTT.MA;
                        AHC_DuongSu.LOAIDUONGSU = Convert.ToDecimal(ddlLoaidungdon.SelectedValue);
                        //if (chkISBVQLNK.Visible)
                        //    AHC_DuongSu.ISBVQLNGUOIKHAC = chkISBVQLNK.Checked ? 1 : 0;
                        //else
                        //    AHC_DuongSu.ISBVQLNGUOIKHAC = 0;
                        AHC_DuongSu.SOCMND = txtCMND_Dk.Text;
                        AHC_DuongSu.TAMTRUTINHID = Convert.ToDecimal(ddlTamtru_Tinh_DK.SelectedValue);
                        AHC_DuongSu.TAMTRUID = Convert.ToDecimal(ddlTamtru_Huyen_DK.SelectedValue);
                        AHC_DuongSu.TAMTRUCHITIET = txtDiaChiCT_DK.Text;
                        ...
                        AHC_DuongSu.NGAYSINH = dNDNgaysinh;
                        AHC_DuongSu.NAMSINH = txtNamsinh_DK.Text == "" ? 0 : Convert.ToDecimal(txtNamsinh_DK.Text);
                        AHC_DuongSu.GIOITINH = Convert.ToDecimal(ddlGioiTinh_DK.SelectedValue);
                        AHC_DuongSu.EMAIL = txtEmail_DK.Text;
                        AHC_DuongSu.DIENTHOAI = txtTel_DK.Text;
                        //if (pnNDTochuc.Visible)
                        //{
                        //    AHC_DuongSu.NDD_DIACHIID = Convert.ToDecimal(ddlNDD_Huyen_NguyenDon.SelectedValue);
                        //    AHC_DuongSu.NDD_DIACHICHITIET = txtND_NDD_Diachichitiet.Text;
                        //}
                        AHC_DuongSu.ISSOTHAM = 1;
                        AHC_DuongSu.ISDON = 1;
                        if (idDuongSuDK != 0)
                        {
                            AHC_DuongSu.NGAYSUA = DateTime.Now;
                            AHC_DuongSu.NGUOISUA = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                            dt.SaveChanges();
                        }
                        else
                        {
                            AHC_DuongSu.NGAYTAO = DateTime.Now;
                            AHC_DuongSu.NGUOITAO = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                            dt.AHC_DON_DUONGSU.Add(AHC_DuongSu);
                            dt.SaveChanges();
                        }
                        oDK.ISDUONGSU = 1;
                        oDK.DUONGSUID = AHC_DuongSu.ID;
                    }
                    if (TCTT != null && TCTT.GROUPID == 16)
                    {
                        AHC_DON_THAMGIATOTUNG AHC_TGTT = null;

                        if (idDuongSuDK == 0)
                        {
                            AHC_TGTT = new AHC_DON_THAMGIATOTUNG();
                        }
                        else
                        {
                            AHC_TGTT = dt.AHC_DON_THAMGIATOTUNG.Where(x => x.ID == idDuongSuDK).FirstOrDefault();
                        }
                        decimal donid = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HANHCHINH]);
                        AHC_TGTT.DONID = donid;
                        AHC_TGTT.HOTEN = Cls_Comon.FormatTenRieng(txtHoTen_DK.Text);
                        //if (AHC_TGTT.ISDAIDIEN == 1)
                        //{
                        //    AHC_TGTT.ISDAIDIEN = 1;
                        //}
                        //else
                        //{
                        //    AHC_TGTT.ISDAIDIEN = 0;
                        //}
                        AHC_TGTT.TUCACHTGTTID = TCTT.MA;
                        //////AHC_TGTT. = Convert.ToDecimal(ddlLoaidungdon.SelectedValue);
                        //if (chkISBVQLNK.Visible)
                        //    AHC_TGTT.ISBVQLNGUOIKHAC = chkISBVQLNK.Checked ? 1 : 0;
                        //else
                        //    AHC_TGTT.ISBVQLNGUOIKHAC = 0;
                        AHC_TGTT.SOCMND = txtCMND_Dk.Text;
                        AHC_TGTT.TAMTRUTINHID = Convert.ToDecimal(ddlTamtru_Tinh_DK.SelectedValue);
                        AHC_TGTT.TAMTRUID = Convert.ToDecimal(ddlTamtru_Huyen_DK.SelectedValue);
                        AHC_TGTT.TAMTRUCHITIET = txtDiaChiCT_DK.Text;
                        DateTime dNDNgaysinh;
                        dNDNgaysinh = (String.IsNullOrEmpty(txtNgaysinh_DK.Text.Trim())) ? DateTime.MinValue : DateTime.Parse(this.txtNgaysinh_DK.Text.Trim(), cul, DateTimeStyles.NoCurrentDateDefault);
                        AHC_TGTT.NGAYSINH = dNDNgaysinh;
                        AHC_TGTT.NAMSINH = txtNamsinh_DK.Text == "" ? 0 : Convert.ToDecimal(txtNamsinh_DK.Text);
                        AHC_TGTT.GIOITINH = Convert.ToDecimal(ddlGioiTinh_DK.SelectedValue);
                        AHC_TGTT.EMAIL = txtEmail_DK.Text;
                        AHC_TGTT.DIENTHOAI = txtTel_DK.Text;
                        //if (pnNDTochuc.Visible)
                        //{
                        //    AHC_TGTT.NDD_DIACHIID = Convert.ToDecimal(ddlNDD_Huyen_NguyenDon.SelectedValue);
                        //    AHC_TGTT.NDD_DIACHICHITIET = txtND_NDD_Diachichitiet.Text;
                        //}
                        //AHC_TGTT.ISSOTHAM = 1;
                        //AHC_TGTT.ISDON = 1;
                        if (idDuongSuDK != 0)
                        {
                            AHC_TGTT.NGAYSUA = DateTime.Now;
                            AHC_TGTT.NGUOISUA = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                            dt.SaveChanges();
                        }
                        else
                        {
                            AHC_TGTT.NGAYTAO = DateTime.Now;
                            AHC_TGTT.NGUOITAO = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                            // update 130825
                            AHC_TGTT.TOA_GIAIQUYET_ID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                            dt.AHC_DON_THAMGIATOTUNG.Add(AHC_TGTT);
                            dt.SaveChanges();
                        }
                        oDK.ISDUONGSU = 0;
                        oDK.DUONGSUID = AHC_TGTT.ID;
                    }
                    ...
                    AHC_DON oDS = dt.AHC_DON.Where(x => x.ID == oDK.DONID).FirstOrDefault();
                    oDS.HINHTHUCNHANDON = Convert.ToDecimal(ddlHinhthucnhandon.SelectedValue);
                    dt.SaveChanges();
                }
                else
        ...
        protected void ddlNguoidungdon_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                if (isDuongSu == 1)
                {
                    AHC_DON_DUONGSU oDS = dt.AHC_DON_DUONGSU.Where(x => x.DONID == donid && x.ID == idDuongSu).FirstOrDefault();
                    ddlTuCachToTung_DK.Enabled = false;
                ...
                if (isDuongSu == 0)
                {
                    AHC_DON_THAMGIATOTUNG oDSTT = dt.AHC_DON_THAMGIATOTUNG.Where(x => x.DONID == donid && x.ID == idDuongSu).FirstOrDefault();
                    ddlTuCachToTung_DK.Enabled = false;
                    if (oDSTT.HOTEN != null)
                    {
                        txtHoTen_DK.Enabled = false;
            ...
            else
            {
                ...
                if (isDuongSu == 0)
                {
                    AHC_DON_THAMGIATOTUNG oTGTT = dt.AHC_DON_THAMGIATOTUNG.Where(x => x.DONID == donid && x.ID == idDuongSu).FirstOrDefault();
        ...
        private void LoadQD_BA_InfoKhangCao()
        {
            ...
            decimal DonIDID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HANHCHINH] + "");
            AHC_DON oDon = dt.AHC_DON.Where(x => x.ID == DonIDID).FirstOrDefault();
            if (oDon != null)
            {
