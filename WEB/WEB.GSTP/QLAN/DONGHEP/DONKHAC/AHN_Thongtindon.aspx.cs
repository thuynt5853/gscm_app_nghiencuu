...
namespace WEB.GSTP.QLAN.DONGHEP.DONKHAC
{
    public partial class AHN_Thongtindon : System.Web.UI.Page
    {
        ...
        private void LoadInfo(decimal ID)
        {
            ...
            DON_KHAC oD = dt.DON_KHAC.Where(x => x.ID == ID && x.LOAIANID == 3).FirstOrDefault();
            AHN_DON AHN = dt.AHN_DON.FirstOrDefault(s => s.ID == oD.DONID);
            txtMaVuViec.Text = AHN.MAVUVIEC;
            txtTenVuViec.Text = AHN.TENVUVIEC;
            ...
            ddlLoaiQuanhe.SelectedValue = AHN.LOAIQUANHE.ToString();
            AHN_DON AHNoD = dt.AHN_DON.Where(x => x.ID == oD.DONID).FirstOrDefault();
            txtQuanhephapluat_name(AHNoD);
            if (AHN.QHPLTKID != null)
                ddlQHPLTK.SelectedValue = AHN.QHPLTKID.ToString();
            ...
            if (oD.LOAIDON == 10)
            {
                ...
                if (oD.LOAIKCKN == 2)
                {
                    ...
                    if (oD.SOQDBA.ToString() != null) { ddlQDBA.SelectedValue = oD.SOQDBA.ToString(); }
                    DM_TOAAN oToaAn = dt.DM_TOAAN.Where(x => x.ID == oD.TOAANRAQDID).FirstOrDefault();
            ...
            if (oD.LOAIDON == 11)
            {
                if (oD.ISDUONGSU == 0)
                {
                    AHN_DON_THAMGIATOTUNG oTT = dt.AHN_DON_THAMGIATOTUNG.Where(x => x.ID == oD.DUONGSUID).FirstOrDefault();
                ...
                if (oD.ISDUONGSU == 1)
                {
                    AHN_DON_DUONGSU oDonDS = dt.AHN_DON_DUONGSU.Where(x => x.ID == oD.DUONGSUID).FirstOrDefault();
        ...
        private void LoadCombobox()
        {
            ...
            AHN_DON_DUONGSU_BL oBL_DS_TGTT = new AHN_DON_DUONGSU_BL();
            ddlNguoidungdon.DataSource = oBL_DS_TGTT.AHN_DON_DUONGSU_THAMGIATOTUNG(Convert.ToDecimal(donid));
            ...
            //Load đương sự
            ddlNguoiKC.DataSource = oBL_DS_TGTT.AHN_DON_DUONGSU_THAMGIATOTUNG(Convert.ToDecimal(donid));
        ...
        private bool SaveData()
        {
            try
            {
                ...
                if (loaiDon == "10")
                {
                    ...
                    {
                        oKC = dt.DON_KHAC.Where(x => x.ID == ID && x.LOAIANID == 3).FirstOrDefault();
                    }
                    ...
                    oKC.DONID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH]);
                    oKC.LOAIANID = Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH);
                    ...
                    AHN_DON oDS = dt.AHN_DON.Where(x => x.ID == oKC.DONID).FirstOrDefault();
                ...
                else if (loaiDon == "11")
                {
                    ...
                    {
                        oDK = dt.DON_KHAC.Where(x => x.ID == ID && x.LOAIANID == 3).FirstOrDefault();
                    }
                    DateTime dNgayNhanKC;
                    DateTime dNgayGhiTrenDon;
                    dNgayNhanKC = (String.IsNullOrEmpty(txtNgayNhan.Text.Trim())) ? DateTime.MinValue : DateTime.Parse(this.txtNgayNhan.Text.Trim(), cul, DateTimeStyles.NoCurrentDateDefault);
                    ...
                    oDK.DONID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH]);
                    oDK.LOAIANID = Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH);
                    ...
                    {
                        AHN_DON_DUONGSU AHN_DuongSu = null;

                        if (idDuongSuDK == 0)
                        {
                            AHN_DuongSu = new AHN_DON_DUONGSU();
                        }
                        else
                        {
                            AHN_DuongSu = dt.AHN_DON_DUONGSU.Where(x => x.ID == idDuongSuDK).FirstOrDefault();
                        }
                        decimal donid = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH]);
                        AHN_DuongSu.DONID = donid;
                        AHN_DuongSu.TENDUONGSU = Cls_Comon.FormatTenRieng(txtHoTen_DK.Text);
                        if (AHN_DuongSu.ISDAIDIEN == 1)
                        {
                            AHN_DuongSu.ISDAIDIEN = 1;
                        }
                        else
                        {
                            AHN_DuongSu.ISDAIDIEN = 0;
                        }
                        AHN_DuongSu.TUCACHTOTUNG_MA = TCTT.MA;
                        AHN_DuongSu.LOAIDUONGSU = Convert.ToDecimal(ddlLoaidungdon.SelectedValue);
                        //if (chkISBVQLNK.Visible)
                        //    AHN_DuongSu.ISBVQLNGUOIKHAC = chkISBVQLNK.Checked ? 1 : 0;
                        //else
                        //    AHN_DuongSu.ISBVQLNGUOIKHAC = 0;
                        AHN_DuongSu.SOCMND = txtCMND_Dk.Text;
                        AHN_DuongSu.TAMTRUTINHID = Convert.ToDecimal(ddlTamtru_Tinh_DK.SelectedValue);
                        AHN_DuongSu.TAMTRUID = Convert.ToDecimal(ddlTamtru_Huyen_DK.SelectedValue);
                        AHN_DuongSu.TAMTRUCHITIET = txtDiaChiCT_DK.Text;
                        ...
                        AHN_DuongSu.NGAYSINH = dNDNgaysinh;
                        AHN_DuongSu.NAMSINH = txtNamsinh_DK.Text == "" ? 0 : Convert.ToDecimal(txtNamsinh_DK.Text);
                        AHN_DuongSu.GIOITINH = Convert.ToDecimal(ddlGioiTinh_DK.SelectedValue);
                        AHN_DuongSu.EMAIL = txtEmail_DK.Text;
                        AHN_DuongSu.DIENTHOAI = txtTel_DK.Text;
                        //if (pnNDTochuc.Visible)
                        //{
                        //    AHN_DuongSu.NDD_DIACHIID = Convert.ToDecimal(ddlNDD_Huyen_NguyenDon.SelectedValue);
                        //    AHN_DuongSu.NDD_DIACHICHITIET = txtND_NDD_Diachichitiet.Text;
                        //}
                        AHN_DuongSu.ISSOTHAM = 1;
                        AHN_DuongSu.ISDON = 1;
                        if (idDuongSuDK != 0)
                        {
                            AHN_DuongSu.NGAYSUA = DateTime.Now;
                            AHN_DuongSu.NGUOISUA = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                            dt.SaveChanges();
                        }
                        else
                        {
                            AHN_DuongSu.NGAYTAO = DateTime.Now;
                            AHN_DuongSu.NGUOITAO = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                            AHN_DuongSu.TOA_GIAIQUYET_ID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);

                            dt.AHN_DON_DUONGSU.Add(AHN_DuongSu);
                            dt.SaveChanges();
                        }
                        oDK.ISDUONGSU = 1;
                        oDK.DUONGSUID = AHN_DuongSu.ID;
                    }
                    if (TCTT != null && TCTT.GROUPID == 16)
                    {
                        AHN_DON_THAMGIATOTUNG AHN_TGTT = null;

                        if (idDuongSuDK == 0)
                        {
                            AHN_TGTT = new AHN_DON_THAMGIATOTUNG();
                        }
                        else
                        {
                            AHN_TGTT = dt.AHN_DON_THAMGIATOTUNG.Where(x => x.ID == idDuongSuDK).FirstOrDefault();
                        }
                        decimal donid = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH]);
                        AHN_TGTT.DONID = donid;
                        AHN_TGTT.HOTEN = Cls_Comon.FormatTenRieng(txtHoTen_DK.Text);
                        //if (AHN_TGTT.ISDAIDIEN == 1)
                        //{
                        //    AHN_TGTT.ISDAIDIEN = 1;
                        //}
                        //else
                        //{
                        //    AHN_TGTT.ISDAIDIEN = 0;
                        //}
                        AHN_TGTT.TUCACHTGTTID = TCTT.MA;
                        //////AHN_TGTT. = Convert.ToDecimal(ddlLoaidungdon.SelectedValue);
                        //if (chkISBVQLNK.Visible)
                        //    AHN_TGTT.ISBVQLNGUOIKHAC = chkISBVQLNK.Checked ? 1 : 0;
                        //else
                        //    AHN_TGTT.ISBVQLNGUOIKHAC = 0;
                        AHN_TGTT.SOCMND = txtCMND_Dk.Text;
                        AHN_TGTT.TAMTRUTINHID = Convert.ToDecimal(ddlTamtru_Tinh_DK.SelectedValue);
                        AHN_TGTT.TAMTRUID = Convert.ToDecimal(ddlTamtru_Huyen_DK.SelectedValue);
                        AHN_TGTT.TAMTRUCHITIET = txtDiaChiCT_DK.Text;
                        DateTime dNDNgaysinh;
                        dNDNgaysinh = (String.IsNullOrEmpty(txtNgaysinh_DK.Text.Trim())) ? DateTime.MinValue : DateTime.Parse(this.txtNgaysinh_DK.Text.Trim(), cul, DateTimeStyles.NoCurrentDateDefault);
                        AHN_TGTT.NGAYSINH = dNDNgaysinh;
                        AHN_TGTT.NAMSINH = txtNamsinh_DK.Text == "" ? 0 : Convert.ToDecimal(txtNamsinh_DK.Text);
                        AHN_TGTT.GIOITINH = Convert.ToDecimal(ddlGioiTinh_DK.SelectedValue);
                        AHN_TGTT.EMAIL = txtEmail_DK.Text;
                        AHN_TGTT.DIENTHOAI = txtTel_DK.Text;
                        //if (pnNDTochuc.Visible)
                        //{
                        //    AHN_TGTT.NDD_DIACHIID = Convert.ToDecimal(ddlNDD_Huyen_NguyenDon.SelectedValue);
                        //    AHN_TGTT.NDD_DIACHICHITIET = txtND_NDD_Diachichitiet.Text;
                        //}
                        //AHN_TGTT.ISSOTHAM = 1;
                        //AHN_TGTT.ISDON = 1;
                        if (idDuongSuDK != 0)
                        {
                            AHN_TGTT.NGAYSUA = DateTime.Now;
                            AHN_TGTT.NGUOISUA = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                            dt.SaveChanges();
                        }
                        else
                        {
                            AHN_TGTT.NGAYTAO = DateTime.Now;
                            AHN_TGTT.NGUOITAO = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                            
                            if (AHN_TGTT.TOA_GIAIQUYET_ID == null)
                                AHN_TGTT.TOA_GIAIQUYET_ID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                            
                            dt.AHN_DON_THAMGIATOTUNG.Add(AHN_TGTT);
                            dt.SaveChanges();
                        }
                        oDK.ISDUONGSU = 0;
                        oDK.DUONGSUID = AHN_TGTT.ID;
                    }
                    ...
                    AHN_DON oDS = dt.AHN_DON.Where(x => x.ID == oDK.DONID).FirstOrDefault();
                    oDS.HINHTHUCNHANDON = Convert.ToDecimal(ddlHinhthucnhandon.SelectedValue);
                    dt.SaveChanges();
                }
                else
                {
                    ddlLoaidon.SelectedValue = "10";
                    pnKhangCao.Visible = true;
        ...
        protected void ddlNguoidungdon_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (isDuongSu == 0)
                {
                    AHN_DON_THAMGIATOTUNG oDSTT = dt.AHN_DON_THAMGIATOTUNG.Where(x => x.DONID == donid && x.ID == idDuongSu).FirstOrDefault();
                    ddlTuCachToTung_DK.Enabled = false;
                    if (oDSTT.HOTEN != null)
                    {
                        txtHoTen_DK.Enabled = false;
            ...
            else
            {
                ...
                if (isDuongSu == 0)
                {
                    AHN_DON_THAMGIATOTUNG oTGTT = dt.AHN_DON_THAMGIATOTUNG.Where(x => x.DONID == donid && x.ID == idDuongSu).FirstOrDefault();
        ...
        {
            String temp = "";
            List<AHN_SOTHAM_BANAN> lst = dt.AHN_SOTHAM_BANAN.Where(x => x.DONID == DonID).OrderByDescending(y => y.NGAYTUYENAN).ToList();
            if (lst != null && lst.Count > 0)
            {
                foreach (AHN_SOTHAM_BANAN item in lst)
                {
        ...
        {
            String temp = "";
            AHN_SOTHAM_BL objBL = new AHN_SOTHAM_BL();
            DataTable tblQD = objBL.AHN_SOTHAM_QUYETDINH_GETLIST(DonID);
