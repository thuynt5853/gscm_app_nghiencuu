<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AHC_Thongtindon.aspx.cs" Inherits="WEB.GSTP.QLAN.DONGHEP.AHC_Thongtindon" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/QLAN/AHC/Hoso/Popup/pDuongSuKhacChiTiet.ascx" TagPrefix="uc1" TagName="DsDuongSuChiTiet" %>
...
<head runat="server">
    ...
    <script src="../../../../UI/js/chosen.jquery.js"></script>
     <style>
        ...
        #chkBoxCMNDND, #chkBoxCMNDBD{
            height: 22px !important;
            position: absolute;
        }
        label[for=chkND_ONuocNgoai], label[for=chkBD_ONuocNgoai], label[for=chkBoxCMNDND], label[for=chkBoxCMNDBD] {
            margin-left: 25px
        }
         </style>
</head>
     ...
     <div class="box">
        <div class="box_nd">
            <div class="truong">
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlQuanhephapluat" Visible="false" CssClass="chosen-select" runat="server" Width="250px"></asp:DropDownList>
                            ...
                            <tr>
                                <td>QĐ bị kiện số</td>
                                <td>
                                    <asp:TextBox ID="txtQDSO" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox></td>
                                <td>Ngày QĐ</td>
                                <td>
                                    <asp:TextBox ID="txtQDNgay" runat="server" CssClass="user" Width="90px" MaxLength="10"></asp:TextBox>
                                    <cc1:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="txtQDNgay" Format="dd/MM/yyyy" Enabled="true" />
                                    <cc1:MaskedEditExtender ID="MaskedEditExtender5" runat="server" TargetControlID="txtQDNgay" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                </td>
                            </tr>
                            <tr>
                                <td>Loại QĐ</td>
                                <td>
                                    <asp:TextBox ID="txtQDTen" CssClass="user" runat="server" Width="250px"></asp:TextBox></td>
                                <td>Hành vi hành chính bị kiện</td>
                                <td>
                                    <asp:TextBox ID="txtQDHanhvi" CssClass="user" runat="server" Width="250px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td><asp:Label id="lbTenNguoiPhanTo"  runat="server"></asp:Label></td>
                                <td colspan="3">
                                    <asp:ListBox ID="txtNguoiNop"  CssClass="chosen-select"  runat="server" Width="250px" SelectionMode="Multiple" AutoPostBack="True"></asp:ListBox>
                                    <asp:ListBox ID="txtNguoiNopDocLap"  CssClass="chosen-select"  runat="server" Width="250px" SelectionMode="Multiple" AutoPostBack="True"></asp:ListBox>
                                </td>
                            </tr>
                            <tr>
                                <td><asp:Label id="lbNoidung"  runat="server"></asp:Label></td>
                                <td colspan="3">
                                    <asp:TextBox ID="txtNoidungkhoikien" CssClass="user" runat="server" Width="673px" TextMode="MultiLine"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td><asp:Label id="lbGhiChu"  runat="server"></asp:Label></td>
                                <td colspan="3">
                ...
                <asp:Panel id="pnTTDuongSu" runat="server">
                <div class="boxchung">
                    <h4 class="tleboxchung">
                        <asp:Literal ID="lstTitleNguyendon" runat="server" Text="Thông tin người khởi kiện (đại diện)"></asp:Literal>
                    </h4>
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                                <td style="width: 115px;">Danh sách đương sự<span class="batbuoc">(*)</span></td>
                                <td>
                                     <asp:DropDownList ID="ddlListDuongSu" CssClass="chosen-select" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlListDuongSu_SelectedIndexChanged" Width="250px">
                                    </asp:DropDownList>
                                <td colspan="2"></td>
                            </tr>
                            <tr>
                                <td style="width: 115px;">Người khởi kiện là<span class="batbuoc">(*)</span></td>
                                <td style="width: 260px;">
                                ...
                                <td style="width: 75px;">Tên người khởi kiện<span class="batbuoc">(*)</span>
                                <td>
                                    <asp:TextBox ID="txtTennguyendon" CssClass="user" runat="server" Width="250px"></asp:TextBox>
                                </td>
                            </tr>
                            <asp:Panel ID="pnNDTochuc" runat="server" Visible="false">
                                <tr>
                                    ...
                                    <td>Chi tiết</td>
                                    <td>
                                        <asp:TextBox ID="txtND_NDD_Diachichitiet" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Người đại diện</td>
                                    <td>
                                        <asp:TextBox ID="txtND_NDD_Ten" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox></td>
                                    <td>Chức vụ</td>
                                    <td>
                                        <asp:TextBox ID="txtND_NDD_Chucvu" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox></td>
                                </tr>
                            </asp:Panel>
                            <tr>
                                <td>Số CMND/ Thẻ căn cước/ Hộ chiếu<asp:Literal ID="ltCMNDND" runat="server"></asp:Literal></td>
                                <td>
                                    <asp:TextBox ID="txtND_CMND" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox></td>
                            ...
                            <asp:Panel ID="pnNDCanhan" runat="server">
                                <tr>
                                    ...
                                    <td>Ngày sinh</td>
                                    <td>
                                        <asp:TextBox ID="txtND_Ngaysinh" runat="server" CssClass="user" Width="109px" MaxLength="10" AutoPostBack="True" OnTextChanged="txtND_Ngaysinh_TextChanged"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txtND_Namsinh" CssClass="user" onkeypress="return isNumber(event)" runat="server" MaxLength="4" Style="text-align: right; width: 66px;" AutoPostBack="true" OnTextChanged="txtND_Namsinh_TextChanged"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                ...
                                <%--  <tr>
                                    ...
                                    <td >
                                      ...
                                      <td>Chi tiết</td>
                                    <td>
                                        <asp:TextBox ID="txtND_HKTT_Chitiet" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox>
                                    </td>
                                </tr>--%>
                                <tr>
                                    ...
                                    <td>Chi tiết</td>
                                    <td>
                                        <asp:TextBox ID="txtND_TTChitiet" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Nơi làm việc</td>
                                    <td>
                                        <asp:TextBox ID="txtND_NoiLamViec" CssClass="user" runat="server" Width="250px" MaxLength="500"></asp:TextBox>
                                    </td>
                                    <td>Chức vụ</td>
                                    <td>
                                        <asp:TextBox ID="txtND_ChucVu" CssClass="user" runat="server" Width="250px" MaxLength="500"></asp:TextBox>
                                    </td>
                                </tr>
                            </asp:Panel>
                            <tr>
                                <td>Email</td>
                                <td>
                                    <asp:TextBox ID="txtND_Email" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox></td>
                                <td>Điện thoại</td>
                                <td>
                                    <asp:TextBox ID="txtND_Dienthoai" runat="server" CssClass="user" Width="117px"></asp:TextBox>
                                    Fax
                                    <asp:TextBox ID="txtND_Fax" runat="server" CssClass="user" Width="106px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="boxchung">
                    <h4 class="tleboxchung">
                        <asp:Literal ID="lstTitleBidon" runat="server" Text="Thông tin người bị kiện (đại diện)"></asp:Literal></h4>
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                                <td style="width: 115px;">Danh sách đương sự<span class="batbuoc">(*)</span></td>
                                <td>
                                     <asp:DropDownList ID="DropDownListDuongSu" CssClass="chosen-select" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownListDuongSu_SelectedIndexChanged" Width="250px">
                                    </asp:DropDownList>
                                <td colspan="2"></td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 75px;">Tên người bị kiện<span class="batbuoc">(*)</span></td>
                                <td>
                                    <asp:TextBox ID="txtBD_Ten" CssClass="user" runat="server" Width="250px"></asp:TextBox></td>
                            </tr>
                            <asp:Panel ID="pnBD_Tochuc" runat="server" Visible="false">
                                <tr>
                                    ...
                                    <td>Chi tiết</td>
                                    <td>
                                        <asp:TextBox ID="txtBD_NDD_Diachichitiet" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Người đại diện</td>
                                    <td>
                                        <asp:TextBox ID="txtBD_NDD_ten" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox></td>
                                    <td>Chức vụ</td>
                                    <td>
                                        <asp:TextBox ID="txtBD_NDD_Chucvu" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox></td>
                                </tr>
                            </asp:Panel>
                            <tr>
                                <td>Số CMND/ Thẻ căn cước/ Hộ chiếu<asp:Literal ID="ltCMNDBD" runat="server"></asp:Literal></td>
                                <td>
                                    <asp:TextBox ID="txtBD_CMND" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox></td>
                                <td>Quốc tịch<span class="batbuoc">(*)</span></td>
                                <td>
                            ...
                            <asp:Panel ID="pnBD_Canhan" runat="server">
                                <tr>
                                    ...
                                    <td>Ngày sinh</td>
                                    <td>
                                        <asp:TextBox ID="txtBD_Ngaysinh" runat="server" CssClass="user" Width="110px" MaxLength="10" AutoPostBack="True" OnTextChanged="txtBD_Ngaysinh_TextChanged"></asp:TextBox>
                                        ...
                                        Năm sinh
                                        <asp:TextBox ID="txtBD_Namsinh" CssClass="user" runat="server" onkeypress="return isNumber(event)" Style="width: 83px; text-align: right;" MaxLength="4" AutoPostBack="true" OnTextChanged="txtBD_Namsinh_TextChanged"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td>Chi tiết</td>
                                    <td>
                                        <asp:TextBox ID="txtBD_Tamtru_Chitiet" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Nơi làm việc</td>
                                    <td colspan="3">
                                        <asp:TextBox ID="txtBD_NoiLamViec" CssClass="user" runat="server" Width="603px" MaxLength="500"></asp:TextBox>
                                    </td>
                                </tr>
                            </asp:Panel>
                            <tr>
                                <td>Email</td>
                                <td>
                                    <asp:TextBox ID="txtBD_Email" CssClass="user" runat="server" Width="250px" MaxLength="250"></asp:TextBox></td>
                                <td>Điện thoại</td>
                                <td>
                                    <asp:TextBox ID="txtBD_Dienthoai" runat="server" CssClass="user" Width="117px"></asp:TextBox>
                                    Fax
                                    <asp:TextBox ID="txtBD_Fax" runat="server" CssClass="user" Width="106px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <asp:Panel ID="pnDuongSuChiTiet" runat="server">
                    <div class="boxchung">
                        <h4 class="tleboxchung bg_title_group bg_yellow">Danh sách đương sự</h4>
                        <div class="boder" style="padding: 5px 10px;">
                            <asp:LinkButton ID="lkThemDuongSuKhac" runat="server"
                                OnClick="lkThemDuongSuKhac_Click" OnClientClick="return validate();"
                                CssClass="buttonpopup them_user">Thêm đương sự khác</asp:LinkButton>
                            <uc1:DsDuongSuChiTiet runat="server" ID="DsDuongSu" />
                        </div>
                    </div>
                    </asp:Panel>
        ...
        <asp:Button ID="cmdLoadDs" runat="server"
            Text="Load ds BI don khac" OnClick="cmdLoadDsKhac_Click" />
    </div>
        <script>
