...
namespace WEB.GSTP.QLAN.DONGHEP
{
    public partial class DonGhep : System.Web.UI.UserControl
    {
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "XuLyDon":
                    ...
                    break;
                case "Sua":
                    Cls_Comon.CallFunctionJS(this, this.GetType(), "popup_edit_DONGHEP_DKK(" + LOAIANID + "," + ND_id + " ," + LoaiDon + ")");
                    break;
                case "Xoa":
                    int count = 0;
                    int DuongSu = 0;
                        ...
                        if (LoaiDon != 7 && LoaiDon != 8)
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    dt.DON_DUONGSU_CHITIET.RemoveRange(lstDonChiTietDuongSu);
                                    dt.SaveChanges();
        ...
        protected void lbThemMoiDon_Click(object sender, EventArgs e)
        {
            ...
            string keyLoaiAnId = "DONGHEP.LOAIANID" + Session[ENUM_SESSION.SESSION_USERID].ToString();
            LOAIANID = Convert.ToDecimal(Session[keyLoaiAnId]);
            Cls_Comon.CallFunctionJS(this, this.GetType(), "popup_edit_DONGHEP_DKK(" + LOAIANID + ")");
        } 
            #region "Phân trang"
