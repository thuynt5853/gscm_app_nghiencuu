...
namespace WEB.GSTP.QLAN.DONGHEP
{
    public partial class ADS_Thongtindon : System.Web.UI.Page
    {
        ...
        {
            int DONID = Convert.ToInt32(Session[ENUM_LOAIAN.AN_DANSU]);
            txtNguoiNop.Items.Clear();
            txtNguoiNop.Items.Clear();
            List<ADS_DON_DUONGSU> listycPhanto = dt.ADS_DON_DUONGSU.Where(x => x.DONID == DONID && x.TUCACHTOTUNG_MA == "BIDON").OrderBy(x => x.TENDUONGSU).ToList<ADS_DON_DUONGSU>();
            List<ADS_DON_DUONGSU> listycDocLap = dt.ADS_DON_DUONGSU.Where(x => x.DONID == DONID && x.TUCACHTOTUNG_MA == "QUYENNVLQ").OrderBy(x => x.TENDUONGSU).ToList<ADS_DON_DUONGSU>();
        ...
        {
            DON_CHITIET oT = dt.DON_CHITIET.Where(x => x.ID == ID && x.LOAIANID == 2).FirstOrDefault();
            ADS_DON ads = dt.ADS_DON.FirstOrDefault(s => s.ID == oT.DONID);
            ...
            ADS_DON ADSoT = dt.ADS_DON.Where(x => x.ID == oT.DONID).FirstOrDefault();
            txtQuanhephapluat_name(ADSoT);
            ...
            if (loaiDon == "5")
            {
                ...
                lbNoidung.Text = "Nội dung yêu cầu";
                lbTenNguoiPhanTo.Text = "Người yêu cầu <span class='batbuoc'>(*)</span>";
            ...
            //List<DON_CHITIET_DUONGSU> lstNguyendon = dt.DON_CHITIET_DUONGSU.Where(x => x.DONID == oT.ID && x.LOAIANID == 2 && x.ISDAIDIEN == 1 && x.TUCACHTOTUNG_MA == ENUM_DANSU_TUCACHTOTUNG.NGUYENDON).ToList();
        ...
        private bool CheckValid()
        {
            ...
            if (ddlLoaidon.SelectedValue != "5" && ddlLoaidon.SelectedValue != "6")
            {
                ...
                if (pnNDCanhan.Visible)// cá nhân
                {
                    ...
                    //    {
                    //        lstMsgB.Text = "Bạn chưa chọn nơi sinh sống của nguyên đơn.";
        ...
        private bool SaveData()
        {
            try
            {
                ...
                {
                    oT = dt.DON_CHITIET.Where(x => x.ID == ID && x.LOAIANID == 2).FirstOrDefault();
                }
                oT.DONID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_DANSU]);
                oT.LOAIANID = Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_DANSU);
                ...
                ////            {
                ////                listNguoiNop = listNguoiNop + txtNguoiNop.Items[i].Value + ",";
                ////            }
                ////        }
                ////    }
                ////}
                ////else if (txtNguoiNopDocLap.Text != "")
                ////{
                ...
                ////    }
                ////}
                ////oT.NGUOINOP = listNguoiNop;

                ////string listTenNguoiNop = "";
                ////if (txtNguoiNop.Text != "")
                ////{
                ////    if (txtNguoiNop.Items.Count > 0)
                ////    {
                ...
                ////            if (txtNguoiNop.Items[i].Selected)
                ////            {
                ////                listTenNguoiNop = listTenNguoiNop + txtNguoiNop.Items[i].Text + ",";
                ////            }
                ////        }
                ////    }
                ////}
                ...
                ////    }
                ////}
                ////oT.TENNGUOINOP = listTenNguoiNop;
                ...
                if (ddlLoaidon.SelectedValue != "5" && ddlLoaidon.SelectedValue != "6")
                {
                    ...
                    {
                        oND = dt.ADS_DON_DUONGSU.Where(x => x.ID == idDuongSuND).FirstOrDefault();
                    }
                    ...
                    if (idDuongSuBD == 0)
                    {
                        oBD = new ADS_DON_DUONGSU();
                    }
                    else
                    {
                        oBD = dt.ADS_DON_DUONGSU.Where(x => x.ID == idDuongSuBD).FirstOrDefault();
                    }
                    oBD.DONID = donid;
                    ...
                    List<DON_DUONGSU_CHITIET> oListDs = dt.DON_DUONGSU_CHITIET.Where(x => x.DONCHITIETID == ID).ToList();
                    ADS_DON_DUONGSU oDuongSu_ND = null;
                    ADS_DON_DUONGSU oDuongSu_BD = null;
                    for (int i = 0; i < oListDs.Count; i++)
                    {
                        int IDduongSu = Convert.ToInt32(oListDs[i].DUONGSUID);
                        ADS_DON_DUONGSU Ods = dt.ADS_DON_DUONGSU.Where(x => x.ID == IDduongSu).FirstOrDefault();
                        if (Ods != null)
                        {
                            if (Ods.TUCACHTOTUNG_MA == "NGUYENDON" && Ods.ISDAIDIEN_DONCHITIET == 1)
                            {
                                oDuongSu_ND = dt.ADS_DON_DUONGSU.Where(x => x.ID == IDduongSu).FirstOrDefault();
                            }
                            if (Ods.TUCACHTOTUNG_MA == "BIDON" && Ods.ISDAIDIEN_DONCHITIET == 1)
                            {
                                oDuongSu_BD = dt.ADS_DON_DUONGSU.Where(x => x.ID == IDduongSu).FirstOrDefault();
                            }
                        }
        ...
        protected void lkThemDuongSuKhac_Click(object sender, EventArgs e)
        {
            if (SaveData())
            {
                ...
                {
                    string StrMsg = "PopupCenter('/QLAN/ADS/Hoso/Popup/pDuongsuChiTiet.aspx?hsID=" + DonID + "&bID=0','Thêm đương sự',950,450);";
        ...
        protected void txtNgayNhan_TextChanged(object sender, EventArgs e)
        {
            if (txtNgayNhan.Text != "" && Cls_Comon.IsValidDate(txtNgayNhan.Text))
            {
                ...
                //    if (Cls_Comon.IsValidDate(txtBD_Ngaysinh.Text))
                //    {
                //        DateTime NgaySinh = DateTime.Parse(txtBD_Ngaysinh.Text, cul, DateTimeStyles.NoCurrentDateDefault);
                //        txtBD_Tuoi.Text = TinhTuoi(NgaySinh, NgayNhan).ToString();
                //        txtBD_Namsinh.Text = NgaySinh.Year.ToString();
                //    }
                //}
            }
        }
        ...
        {
            decimal donidBD = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_DANSU]);
            int idDuongSuBD = Convert.ToInt32(DropDownListDuongSu.SelectedValue);
            ...
            {
                ADS_DON_DUONGSU oDS = dt.ADS_DON_DUONGSU.Where(x => x.DONID == donidBD && x.ID == idDuongSuBD).FirstOrDefault();
            ...
            else
            {
                ...
                ADS_DON_DUONGSU oDuongSuBD = dt.ADS_DON_DUONGSU.Where(x => x.DONID == donidBD && x.ID == idDuongSuBD).FirstOrDefault();
                if (oDuongSuBD.LOAIDUONGSU == 1)
                {
                    ddlLoaiBidon.SelectedValue = "1";
                    pnBD_Canhan.Visible = true;
                    pnBD_Tochuc.Visible = false;
                }
                else if (oDuongSuBD.LOAIDUONGSU == 2)
                {
                    ddlLoaiBidon.SelectedValue = "2";
                    pnBD_Canhan.Visible = false;
                    pnBD_Tochuc.Visible = true;
                }
                else if (oDuongSuBD.LOAIDUONGSU == 3)
                {
                    ddlLoaiBidon.SelectedValue = "3";
                    pnBD_Canhan.Visible = false;
                    pnBD_Tochuc.Visible = true;
                }
                txtBD_Ten.Text = oDuongSuBD.TENDUONGSU;
                if (oDuongSuBD.SOCMND == null)
                {
                    chkBoxCMNDBD.Checked = true;
                    txtBD_CMND.Text = "";
                }
                ...
                {
                    chkBoxCMNDBD.Checked = false;
                    txtBD_CMND.Text = oDuongSuBD.SOCMND;
                }

                ddlBD_Quoctich.SelectedValue = oDuongSuBD.QUOCTICHID.ToString();
                if (oDuongSuBD.GIOITINH == 1)
                {
                    ddlBD_Gioitinh.SelectedValue = "1";
                }
                else if (oDuongSuBD.GIOITINH == 0)
                {
                    ddlBD_Gioitinh.SelectedValue = "0";
                }
                if (oDuongSuBD.SINHSONG_NUOCNGOAI == 1)
                {
                ...
                {
                    txtBD_Namsinh.Text = oDuongSuBD.NAMSINH.ToString();
                    if (oDuongSuBD.NGAYSINH == null)
                    {
                        if (txtBD_Namsinh.Text.Length == 4)
                        {
                            string NgaySinhstr = "";
                    ...
                    {
                        if (oDuongSuBD.NGAYSINH != DateTime.MinValue)
                        {
                            txtBD_Ngaysinh.Text = ((DateTime)oDuongSuBD.NGAYSINH).ToString("dd/MM/yyyy", cul);
                        }
                        else
                        {
                            txtBD_Ngaysinh.Text = "";
                ...
                txtBD_Tamtru_Chitiet.Text = oDuongSuBD.TAMTRUCHITIET;
                txtBD_NoiLamViec.Text = oDuongSuBD.DIACHICOQUAN;
                txtBD_Email.Text = oDuongSuBD.EMAIL;
                txtBD_Dienthoai.Text = oDuongSuBD.DIENTHOAI;
                txtBD_Fax.Text = oDuongSuBD.FAX;
                if (oDuongSuBD.TAMTRUTINHID != null)
                {
                    ddlTamTru_Tinh_BiDon.SelectedValue = oDuongSuBD.TAMTRUTINHID.ToString();
                    LoadDropNoiSongHuyenBD();
                    try
                    {
                        if (oDuongSuBD.TAMTRUID != null) ddlTamTru_Huyen_BiDon.SelectedValue = oDuongSuBD.TAMTRUID.ToString();
                    }
                    catch (Exception ex) { }
                }
                txtBD_NDD_ten.Text = oDuongSuBD.NGUOIDAIDIEN;
                txtBD_NDD_Chucvu.Text = oDuongSuBD.CHUCVU;
                if (oDuongSuBD.NDD_DIACHIID != null)
                {
                    DM_HANHCHINH Huyen_NDD_BiDon = dt.DM_HANHCHINH.Where(x => x.ID == oDuongSuBD.NDD_DIACHIID).FirstOrDefault<DM_HANHCHINH>();
                    if (Huyen_NDD_BiDon != null)
                    {
                        ddlNDD_Tinh_BiDon.SelectedValue = Huyen_NDD_BiDon.CAPCHAID.ToString();
                        LoadDropNDD_Huyen_BiDon();
                ...
                txtBD_NDD_Diachichitiet.Text = oDuongSuBD.NDD_DIACHICHITIET;
            }
        }
        ...
        void LoaddsDuongSu()
        {
            ...
            decimal donid = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_DANSU]);
            ADS_DON_DUONGSU_BL ADS_BL = new ADS_DON_DUONGSU_BL();
            DataTable DuongSu = ADS_BL.ADS_DON_DUONGSU_Getall(DonCT, donid);
            ...
            DataTable DuongSuBD = ADS_BL.ADS_DON_DUONGSU_Getall_BiDon(DonCT, donid);
