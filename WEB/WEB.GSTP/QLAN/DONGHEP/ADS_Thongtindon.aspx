<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="ADS_Thongtindon.aspx.cs" Inherits="WEB.GSTP.QLAN.DONGHEP.ADS_Thongtindon" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/QLAN/ADS/Hoso/Popup/pDuongSuKhacChiTiet.ascx" TagPrefix="uc1" TagName="DsDuongSuChiTiet" %>
                        ...
                        <div class="boder" style="padding: 10px;">
                            <table class="table1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNgayNhan" runat="server" CssClass="user" Width="110px" MaxLength="10" AutoPostBack="true" OnTextChanged="txtNgayNhan_TextChanged"></asp:TextBox>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lbTenNguoiPhanTo" runat="server"></asp:Label></td>
                                    <td colspan="3">
                                ...
                                <table class="table1">
                                    ...
                                    <asp:Panel ID="pnNDCanhan" runat="server">
                                        <tr>
                                            ...
                                            <td>Ngày sinh</td>
                                            <td>
                                                <asp:TextBox ID="txtND_Ngaysinh" runat="server" CssClass="user" Width="85px" MaxLength="10" AutoPostBack="True" OnTextChanged="txtND_Ngaysinh_TextChanged"></asp:TextBox>
                                                ...
                                                <asp:TextBox ID="txtND_Namsinh" CssClass="user" onkeypress="return isNumber(event)" runat="server" Width="91px" MaxLength="4" AutoPostBack="true" OnTextChanged="txtND_Namsinh_TextChanged"></asp:TextBox>
                                                <%--    Tuổi
                                    ...
                                    <td>                                      
                                        ...
                                        <tr>
                                            <td>Nơi làm việc</td>
                                            <td colspan="3">
                                                <asp:TextBox ID="txtND_NoiLamViec" CssClass="user" runat="server" Width="597px" MaxLength="500"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </asp:Panel>
                                    <tr>
                                        ...
                                        <td>Điện thoại</td>
                                        <td>
                                            <asp:TextBox ID="txtND_Dienthoai" runat="server" onkeypress="return isNumber(event)" CssClass="user" Width="120px"></asp:TextBox>
                                            Fax
                            ...
                            <div class="boder" style="padding: 10px;">
                                <table class="table1">
                                    ...
                                    <asp:Panel ID="pnBD_Canhan" runat="server">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <td>Ngày sinh</td>
                                                <td>
                                                    <asp:TextBox ID="txtBD_Ngaysinh" runat="server" CssClass="user" Width="91px" MaxLength="10" AutoPostBack="True" OnTextChanged="txtBD_Ngaysinh_TextChanged"></asp:TextBox>
                                                    ...
                                                    Năm sinh
                                        <asp:TextBox ID="txtBD_Namsinh" CssClass="user" runat="server" onkeypress="return isNumber(event)" Width="100px" MaxLength="4" AutoPostBack="true" OnTextChanged="txtBD_Namsinh_TextChanged"></asp:TextBox>
                                                    <%--    Tuổi
                                    ...
                                    <tr>
                                        ...
                                        <td>Điện thoại</td>
                                        <td>
                                            <asp:TextBox ID="txtBD_Dienthoai" runat="server" onkeypress="return isNumber(event)" CssClass="user" Width="120px"></asp:TextBox>
                                            Fax
