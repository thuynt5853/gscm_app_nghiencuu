<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DonGhep.ascx.cs" Inherits="WEB.GSTP.QLAN.DONGHEP.DonGhep" %>
...
<script>
    function popup_edit_DONGHEP_DKK(LoaiAnId,DONGHEPID='',LOAIDON='') {
        ...
        if (LoaiAnId=='2') {
            //dân sự
            link = "/QLAN/DONGHEP/ADS_Thongtindon.aspx?DONGHEPID=" + DONGHEPID + "&LOAIDON=" +LOAIDON;
        }
        else if (LoaiAnId == '3') {
            //hôn nhân gia đình
            link = "/QLAN/DONGHEP/AHN_Thongtindon.aspx?DONGHEPID=" + DONGHEPID + "&LOAIDON=" + LOAIDON;
        }
        else if (LoaiAnId == '4') {
            //kinh doanh thương mại
            link = "/QLAN/DONGHEP/AKT_Thongtindon.aspx?DONGHEPID=" + DONGHEPID + "&LOAIDON=" + LOAIDON;
        }
        else if (LoaiAnId == '5') {
            //lạo động
            link = "/QLAN/DONGHEP/ALD_Thongtindon.aspx?DONGHEPID=" + DONGHEPID + "&LOAIDON=" + LOAIDON;
        }
        else if (LoaiAnId == '6') {
            //hành chính
            link = "/QLAN/DONGHEP/AHC_Thongtindon.aspx?DONGHEPID=" + DONGHEPID + "&LOAIDON=" + LOAIDON;
        }
        else if (LoaiAnId == '7') {
            //phá sản
            link = "/QLAN/DONGHEP/APS_Thongtindon.aspx?DONGHEPID=" + DONGHEPID + "&LOAIDON=" + LOAIDON;
        }
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4" PageSize="10" AllowPaging="True" GridLines="None" PagerStyle-Mode="NumericPages" CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                <%--<asp:LinkButton ID="lbtXuLyDon" runat="server" CausesValidation="false" Text="Xử lý đơn"
