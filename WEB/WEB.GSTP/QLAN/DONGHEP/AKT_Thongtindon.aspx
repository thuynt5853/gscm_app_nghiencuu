<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AKT_Thongtindon.aspx.cs" Inherits="WEB.GSTP.QLAN.DONGHEP.AKT_Thongtindon" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/QLAN/AKT/Hoso/Popup/pDuongSuKhacChiTiet.ascx" TagPrefix="uc1" TagName="DsDuongSuChiTiet" %>
...
<body>
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td> <asp:DropDownList ID="ddlLoaidon" CssClass="chosen-select" runat="server" Width="250px"  AutoPostBack="true" OnSelectedIndexChanged="ddlLoaidon_SelectedIndexChanged">
                        ...
                        <table class="table1">
                            ...
                            <asp:Panel ID="pnNDCanhan" runat="server">
                                <tr>
                                    ...
                                    <td>Ngày sinh</td>
                                    <td>
                                        <asp:TextBox ID="txtND_Ngaysinh" runat="server" CssClass="user" Width="97px" MaxLength="10" AutoPostBack="True" OnTextChanged="txtND_Ngaysinh_TextChanged"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txtND_Namsinh" CssClass="user" onkeypress="return isNumber(event)" runat="server" Width="78px" MaxLength="4" AutoPostBack="true" OnTextChanged="txtND_Namsinh_TextChanged"></asp:TextBox>
                                    </td>
                                </tr>
 ...
 <tr>
                                    <td>Nơi làm việc</td>
                                    <td colspan="3">
                                         <asp:TextBox ID="txtND_NoiLamViec" CssClass="user" runat="server" Width="598px" MaxLength="500"></asp:TextBox>
                                    </td>
                                </tr>
                            </asp:Panel>
                            <tr>
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                <td></td>
                                <td colspan="3">
                                    <asp:CheckBox ID="chkKhongCoNYC2" Text="<span style='position: absolute;'>Chưa xác định bị đơn</span>" Font-Bold="true" runat="server" AutoPostBack="True" OnCheckedChanged="chkKhongCoNYC2_CheckedChanged" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <asp:Panel ID="pnBD_Canhan" runat="server">
                                <tr>
                                    ...
                                    <td>Ngày sinh</td>
                                    <td>
                                        <asp:TextBox ID="txtBD_Ngaysinh" runat="server" CssClass="user" Width="112px" MaxLength="10" AutoPostBack="True" OnTextChanged="txtBD_Ngaysinh_TextChanged"></asp:TextBox>
                                       ...
                                       Năm sinh
                                        <asp:TextBox ID="txtBD_Namsinh" CssClass="user" runat="server" onkeypress="return isNumber(event)" Width="79px" MaxLength="4" AutoPostBack="true" OnTextChanged="txtBD_Namsinh_TextChanged"></asp:TextBox>
                                    </td>
                                </tr>
 ...
 <tr>
                                    <td>Nơi làm việc</td>
                                    <td colspan="3">
                                         <asp:TextBox ID="txtBD_NoiLamViec" CssClass="user" runat="server" Width="598px" MaxLength="500"></asp:TextBox>
                                    </td>
                                </tr>
                            </asp:Panel>
                            <tr>
                                ...
                                <td>Điện thoại</td>
                                <td>
                                    <asp:TextBox ID="txtBD_Dienthoai" runat="server" CssClass="user" Width="111px"></asp:TextBox>
                                    Fax
                                    <asp:TextBox ID="txtBD_Fax" runat="server" CssClass="user" Width="111px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
