<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Thongtindonghep.ascx.cs" Inherits="WEB.GSTP.QLAN.DONGHEP.Thongtindonghep" %>
                            ...
                            <td>
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4" PageSize="10" AllowPaging="True" GridLines="None" PagerStyle-Mode="NumericPages" CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center"  HeaderStyle-Width="200px" ItemStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>Nội dung khởi kiện</HeaderTemplate>
                                            <ItemTemplate>
