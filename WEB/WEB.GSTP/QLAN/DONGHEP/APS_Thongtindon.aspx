<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="APS_Thongtindon.aspx.cs" Inherits="WEB.GSTP.QLAN.DONGHEP.APS_Thongtindon" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<%@ Register Src="~/QLAN/APS/Hoso/Popup/pDuongSuKhacChiTiet.ascx" TagPrefix="uc1" TagName="DsDuongSuChiTiet" %>
...
<body>
                            ...
                            <asp:Panel ID="pnNDCanhan" runat="server">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtND_Namsinh" CssClass="user" onkeypress="return isNumber(event)" runat="server" Width="70px" MaxLength="4" AutoPostBack="true" OnTextChanged="txtND_Namsinh_TextChanged"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
 ...
 <tr>
                                    <td>Nơi làm việc</td>
                                    <td colspan="3">
                                         <asp:TextBox ID="txtND_NoiLamViec" CssClass="user" runat="server" Width="627px" MaxLength="500"></asp:TextBox>
                                    </td>
                                </tr>
                            </asp:Panel>
                            <tr>
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td style="width: 100px;"><asp:Label ID="lstNganhKT" runat="server" Text="Ngành kinh tế"></asp:Label></td>
                                <td> 
                            ...
                            <tr>
                                <td>
                                   Tên đối tượng bị yêu cầu<span class="batbuoc">(*)</span>
                                </td>
                                <td colspan="3">
                                    <asp:TextBox ID="txtBD_Ten" CssClass="user" runat="server" Width="250px"></asp:TextBox>
                                </td>
                            </tr>
