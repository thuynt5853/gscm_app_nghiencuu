...
{
    public partial class QuyetDinh_DS : System.Web.UI.Page
    {
        ...
        public void LoadGrid()
        {
            ...
            if (objBA != null)
                VuAnID = (decimal)objBA.VUANID;
            THA_CVDON_QD_BL objBL = new THA_CVDON_QD_BL();
        ...
        protected void rpt_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                case "sua":
                    Response.Redirect("/QLAN/THA/CongVanTHA/QuyetDinh.aspx?tID=" + ThuLyCV_ID);
                    break;
                case "Xoa":
