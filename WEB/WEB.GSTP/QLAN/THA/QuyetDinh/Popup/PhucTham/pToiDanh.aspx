<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pToiDanh.aspx.cs" Inherits="WEB.GSTP.QLAN.THA.QuyetDinh.Popup.PhucTham.pToiDanh" %>
            ...
            <ContentTemplate>
                                                        ...
                                                        <td>
                                                            <asp:Panel ID="pnZoneHinhPhat" runat="server" Enabled="false">
                                                                ...
                                                                <asp:CheckBox ID="chkAnTreo" runat="server" AutoPostBack="true"
                                                                    Text="Hưởng án treo" CssClass="margin_top" OnCheckedChanged="chkAnTreo_CheckedChanged"/><br />
                                                                ...
                                                                <asp:Panel ID="pnCoQuanGiamSat" runat="server" Visible="false">
                                                                    <div style="float: left; width: 95%">
		                                                            <span>Cơ quan Giám sát, giáo dục<span class="batbuoc">(*)</span></span>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:CheckBox ID="chkAnTreo" runat="server" Text="Hưởng án treo" CssClass="margin_top" AutoPostBack="true" OnCheckedChanged="chkAnTreo_CheckedChanged"/>
                                                            <asp:Panel ID="pnCoQuanGiamSat" runat="server" Visible="false">
                                                                    <div style="float: left; width: 95%">
		                                                            <span>Cơ quan Giám sát, giáo dục<span class="batbuoc">(*)</span></span>
		                                                            <asp:TextBox ID="txtCoQuanGiamSat" CssClass="user" runat="server" Width="200px"></asp:TextBox>
                ...
                <script>
                    ...
                    function popupChonToiDanh() {
                        ...
                        var link = "/QLAN/THA/QuyetDinh/Popup/PhucTham/pChonToiDanh.aspx?aID=<%=BiCanID%>";
                    ...
                    function ReloadParent() {
	                    window.opener.parent.Loadds_bicaoPT();
                    }
                </script>
