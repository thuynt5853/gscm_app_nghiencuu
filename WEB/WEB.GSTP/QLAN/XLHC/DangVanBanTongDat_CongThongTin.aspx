<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="DangVanBanTongDat_CongThongTin.aspx.cs" Inherits="WEB.GSTP.QLAN.XLHC.DangVanBanTongDat_CongThongTin" %>
    ...
    <div class="box">
        <div class="box_nd">
            <div class="boxchung">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlLoai" CssClass="chosen-select" runat="server" Width="408px">
                                    ...
                                    <asp:ListItem Text="Thông báo thụ lý dân sự" Value="0"></asp:ListItem>
                ...
                <div style="width: 100%; margin-top: 10px; margin-bottom: 10px; margin-left: 50px">
