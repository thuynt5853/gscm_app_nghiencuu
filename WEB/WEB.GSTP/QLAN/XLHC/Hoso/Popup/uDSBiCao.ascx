<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uDSBiCao.ascx.cs" Inherits="WEB.GSTP.QLAN.XLHC.Hoso.Popup.uDSBiCao" %>
...
<div class="boxchung">
    ...
    <div class="boder" style="padding: 20px 10px;">
        ...
        <%--<a href="javascript:;" onclick="popup_edit_duongsu(0);" style="float: right;" class="buttonpopup">Thêm đương sự khác</a>--%>
          ...
          <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderStyle-Width="80px" ItemStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            <a href="javascript:;" onclick='popup_edit_duongsu(<%# Eval("ID") %>);'>Sửa</a>
