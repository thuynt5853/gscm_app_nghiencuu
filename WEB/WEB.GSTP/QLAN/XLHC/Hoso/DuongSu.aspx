<%@ Page Title ="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="DuongSu.aspx.cs" Inherits="WEB.GSTP.QLAN.XLHC.Hoso.DuongSu" %>
                    ...
                    <table class="table1">
                        <tr>
                            ...
                            <td style="width: 260px;">
                                <asp:DropDownList ID="ddlLoaiNguyendon" CssClass="chosen-select" runat="server"
                                    Width="250px" AutoPostBack="True"
                                    OnSelectedIndexChanged="ddlLoaiNguyendon_SelectedIndexChanged">
                                    <asp:ListItem Value="1" Text="Người bị đề nghị"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="Cơ quan đề nghị"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <%--<td style="width: 102px;">Tư cách tố tụng<span class="batbuoc">(*)</span></td>
                            <td>
                        ...
                        <!-- ================= FORM CƠ QUAN ĐỀ NGHỊ ================= -->
                        <asp:Panel ID="pnNDTochuc" runat="server" Visible="false">
                            <tr>
                                <td>Địa chỉ<span class="batbuoc">(*)</span></td>
                                <td>
                                    <asp:DropDownList ID="ddl_NDD_Tinh" CssClass="chosen-select" runat="server" Width="123px"
                                        AutoPostBack="true" OnSelectedIndexChanged="ddl_NDD_Tinh_SelectedIndexChanged">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtND_NDD_Ten" CssClass="user" runat="server" Width="242px"></asp:TextBox>
                                </td>
                                <td>Chức vụ</td>
                                <td>
                                    <asp:TextBox ID="txtND_NDD_Chucvu" CssClass="user" runat="server" Width="242px" ></asp:TextBox>
                                </td>
                            </tr>
                              <tr>
                            <td>Thẻ căn cước<asp:Literal ID="ltCCCDND1" runat="server"></asp:Literal></td>
                            <td>
                                <asp:TextBox ID="txtND_CCCD1" CssClass="user" runat="server" Width="242px" MaxLength="250"></asp:TextBox></td>
                            <td>Quốc tịch<span class="batbuoc">(*)</span></td>
                            <td>
                                <asp:DropDownList ID="ddlCQ_Quoctich" CssClass="chosen-select" runat="server" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlND_Quoctich_SelectedIndexChanged"></asp:DropDownList></td>
                        </tr>

                            <tr>
                            <td>Số CMND <asp:Literal ID="ltCMNDND1" runat="server"></asp:Literal></td>
                            <td>
                                <asp:TextBox ID="txtND_CMND1" CssClass="user" runat="server" Width="242px" MaxLength="250"></asp:TextBox>
                            </td>
                            <td>Hộ chiếu<asp:Literal ID="ltHCND1" runat="server"></asp:Literal></td>
                            <td>
                                <asp:TextBox ID="txtND_HoChieu1" CssClass="user" runat="server" Width="242px" MaxLength="250"></asp:TextBox></td>
                        </tr>

                            <tr>
                                <td></td>
                                <td colspan="3">
                                    <asp:CheckBox ID="chkBoxCMNDND1" AutoPostBack="true" runat="server" Text="Không có"
                                        OnCheckedChanged="chkBoxCMNDND_CheckedChanged" />
                                </td>
                            </tr>
                        </asp:Panel>

                        <!-- ================= FORM NGƯỜI BỊ ĐỀ NGHỊ ================= -->
                        <asp:Panel ID="pnNDCanhan" runat="server">
                           <tr>
                            <td>Thẻ căn cước<asp:Literal ID="ltCCCDND" runat="server"></asp:Literal></td>
                            <td>
                                <asp:TextBox ID="txtND_CCCD" CssClass="user" runat="server" Width="242px" MaxLength="250"></asp:TextBox></td>
                            <td>Quốc tịch<span class="batbuoc">(*)</span></td>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtND_HoChieu" CssClass="user" runat="server" Width="242px" MaxLength="250"></asp:TextBox></td>
                        </tr>

                            <tr>
                                <td></td>
                                <td colspan="3">
                                    <asp:CheckBox ID="chkBoxCMNDND" AutoPostBack="true" runat="server" Text="Không có"
                                        OnCheckedChanged="chkBoxCMNDND_CheckedChanged" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>Ngày sinh</td>
                                <td>
                                    <asp:TextBox ID="txtND_Ngaysinh" runat="server" CssClass="user" Width="65px" MaxLength="10"
                                        AutoPostBack="True" OnTextChanged="txtND_Ngaysinh_TextChanged">
                                    </asp:TextBox>
                                    <cc1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtND_Ngaysinh"
                                        Format="dd/MM/yyyy" Enabled="true" />
                                    <cc1:MaskedEditExtender ID="MaskedEditExtender3" runat="server" TargetControlID="txtND_Ngaysinh"
                                        Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                    Năm sinh<span class="batbuoc">(*)</span>
                                    <asp:TextBox ID="txtND_Namsinh" CssClass="user" onkeypress="return isNumber(event)"
                                        runat="server" Width="35px" MaxLength="4">
                                    </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlNoiSongTinh" CssClass="chosen-select" runat="server" Width="123px"
                                        AutoPostBack="true" OnSelectedIndexChanged="ddlNoiSongTinh_SelectedIndexChanged">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                <td>Nơi làm việc</td>
                                <td colspan="3">
                                    <asp:TextBox ID="txtNoiLamViec" CssClass="user" runat="server" Width="618px" MaxLength="600"></asp:TextBox>
                                </td>
                            </tr>
                        </asp:Panel>
                        ...
                        <tr>
                            <td>Email</td>
                            <td>
                                <asp:TextBox ID="txtEmail" CssClass="user" runat="server" Width="242px" MaxLength="250"></asp:TextBox>
                            </td>
                            <td>Điện thoại</td>
                            <td>
                                <asp:TextBox ID="txtDienthoai" runat="server" CssClass="user" Width="103px"></asp:TextBox>
                                Fax
                    <asp:TextBox ID="txtFax" runat="server" CssClass="user" Width="106px"></asp:TextBox>
                            </td>
                        </tr>
                                       ...
                                       <%-- <asp:TemplateColumn HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        ...
                                        <asp:TemplateColumn HeaderStyle-Width="80px" ItemStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>
                                             ...
                                             <ItemTemplate>
                                                <asp:LinkButton ID="lblXem" runat="server" Text="Chi tiết" CausesValidation="false" CommandName="Xem" ForeColor="#0e7eee"
