<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Tailieu.aspx.cs" Inherits="WEB.GSTP.QLAN.XLHC.Hoso.Tailieu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="boder" style="padding: 10px; float: left; width: 97.5%;">
                    <table class="table1">
                        ...
                        <%-- <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="rdbTuCachToTung" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rdbTuCachToTung_SelectedIndexChanged">
                        ...
                        <tr>
                            <td>Nguồn bàn giao<span class="batbuoc">(*)</span></td>
                            <td>
                                <asp:RadioButtonList ID="idNguonBanGiao" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rdbNguonBanGiao_SelectedIndexChanged">
                                    <asp:ListItem Value="1" Text="Đơn vị đề nghị" Selected="True"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="Người bị đề nghị"></asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Textbox nhập tay -->
                                <asp:TextBox ID="txtNguoiBanGiao" runat="server" Visible="false" CssClass="user" Width="242px"></asp:TextBox>

                                <!-- Dropdown chọn từ DB -->
                                <asp:DropDownList ID="ddlNguoiBanGiao" CssClass="chosen-select" runat="server" Visible="false" Width="250px" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <asp:Button ID="cmdUpdate" runat="server" CssClass="buttoninput" Text="Lưu" OnClientClick="return ValidDataInput();" OnClick="btnUpdate_Click" />
                    ...
                    <asp:Panel runat="server" ID="pndata">
                        ...
                        <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="NGUOIBANGIAO_NEW" HeaderText="Người giao" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>                              
                                <asp:BoundColumn DataField="NGUONBANGIAO" HeaderText="Nguồn bàn giao" HeaderStyle-Width="135px" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
    ...
    <script type="text/javascript">
        function ValidDataInput() {
            ...
            var lengNgayBG = txtNgayBanGiao.value.trim().length;
            if (lengNgayBG == 0) {
                alert('Bạn chưa nhập ngày bàn giao.');
                txtNgayBanGiao.focus();
                return false;
            } else {
                var arr = txtNgayBanGiao.value.split('/');
                var NgayBanGiao = new Date(arr[2] + '-' + arr[1] + '-' + arr[0]);
                if (NgayBanGiao.toString() == "NaN" || NgayBanGiao.toString() == "Invalid Date") {
                    alert('Bạn phải nhập ngày bàn giao theo định dạng (dd/MM/yyyy).');
                    txtNgayBanGiao.focus();
                    return false;
                }
            }
            ...
            if (NgayBanGiao < NgayNhanDon) {
                alert('Ngày bàn giao không thể nhỏ hơn ngày nhận đơn: ' + hddNgayNhanDon.value);
                txtNgayBanGiao.focus();
                return false;
            }
            if (NgayBanGiao > Date.now()) {
                alert('Ngày bàn giao không thể lớn hơn ngày hiện tại');
                txtNgayBanGiao.focus();
                return false;
            }
            ...
            var txtNguonBanGiao = document.getElementById('<%=txtNguoiBanGiao.ClientID%>');
            var lengNguonBanGiao = txtNguonBanGiao.value.trim().length;
            if (val == 0) {
                alert('Bạn chưa nhập người bàn giao. Hãy nhập lại!');
                ddlNguoiBanGiao.focus();
                return false;
            }
            ...
            var lengTenTL = txtTenTL.value.trim().length;
            if (lengTenTL == 0) {
