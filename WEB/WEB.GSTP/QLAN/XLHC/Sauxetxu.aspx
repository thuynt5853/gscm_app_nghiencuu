<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Sauxetxu.aspx.cs" Inherits="WEB.GSTP.QLAN.XLHC.Sauxetxu" %>
                                    ...
                                    <div class="boder" style="padding: 10px;">
                                        <table class="table1">
                                            ...
                                            <tr>
                                                <td>Số QĐ/BA</td>
                                                <td>
                                                    <asp:TextBox ID="txtSoQDBA" CssClass="user" runat="server" Width="100px" MaxLength="50"></asp:TextBox></td>
                                                <td>Tên đương sự</td>
                                                <td>
                                                    <asp:TextBox ID="txtTenDuongSu" CssClass="user" runat="server" Width="360px" MaxLength="250"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td>Ngày QĐ/BA từ</td>
                                                <td>
