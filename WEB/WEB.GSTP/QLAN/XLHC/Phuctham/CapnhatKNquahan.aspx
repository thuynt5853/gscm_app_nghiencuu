<%@ Page Language="C#" MasterPageFile="~/MasterPages/GSTP_VBD.Master" AutoEventWireup="true" CodeBehind="CapnhatKNquahan.aspx.cs" Inherits="WEB.GSTP.QLAN.XLHC.Phuctham.CapnhatKNquahan" %>
                                            ...
                                            <div class="boder" style="padding: 10px;">
                                                <table class="table1">
                                                    ...
                                                    <tr>
                                                        <td>Số thụ lý</td>
                                                        <td>
                                                            <asp:TextBox ID="txtTimkiem_SoTL" CssClass="user" runat="server" Width="242px" MaxLength="50"></asp:TextBox>
                                                        </td>
                                        ...
                                        <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4" PageSize="10" AllowPaging="True" GridLines="None"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderStyle-Width="30px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chkChon" AutoPostBack="true" ToolTip='<%#Eval("KHANGNGHI_SOTHAM_ID")%>' OnCheckedChanged="chkChon_CheckedChanged" runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                ...
                                                <asp:BoundColumn DataField="NguoiKCCapKN" HeaderText="Người KN" HeaderStyle-Width="160px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundColumn>
                                                <asp:BoundColumn DataField="NGAYKN" HeaderText="Ngày KN" HeaderStyle-Width="101px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundColumn>
                                                ...
                                                <asp:TemplateColumn HeaderStyle-Width="90px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lbtGiaiquyet" runat="server" CausesValidation="false" Text="Giải quyết" ForeColor="#0e7eee" CommandName="Giaiquyet" CommandArgument='<%#Eval("ID") +";#"+ Eval("KHANGNGHI_SOTHAM_ID")%>'></asp:LinkButton>
                                                        <asp:LinkButton ID="lbtSua" runat="server" CausesValidation="false" Text="Sửa" ForeColor="#0e7eee" CommandName="Sua" CommandArgument='<%#Eval("ID") + ";#"+ Eval("KHANGNGHI_SOTHAM_ID")%>'></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                            </Columns>
            ...
            <ContentTemplate>
                ...
                <div class="box_nd" style="width: 900px;">
                    <div class="truong">
                        ...
                        <div>
                            ...
                            <div class="boder" style="padding: 10px;">
                                <table class="table1">
                                    ...
                                    <tr>
                                        <td style="width: 150px;">Quyết định: </td>
                                        <td>
                                            <span style="font-weight: bold; float: left; width: 100%; text-align: left;" id="lblQd" runat="server"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width: 150px;">Người KN: </td>
                                        <td>
                                            <span style="font-weight: bold; float: left; width: 100%; text-align: left;" id="lblNguoiKN" runat="server"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 150px;">Ngày KN: </td>
                                        <td>
                                            <span style="font-weight: bold; float: left; width: 100%; text-align: left;" id="lblNgayKhangcao" runat="server"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 150px;">Nội dung KN: </td>
                                        <td>
                                            <span style="font-weight: bold; float: left; width: 100%; text-align: left;" id="lblNoidungKN" runat="server"></span>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div>
                            <h4 class="tleboxchung"><b>THỤ LÝ XÉT KN QUÁ HẠN</b></h4>
                            <div>
                                <table>
                                    <tr>
                                        <td></td>
                        ...
                        <div>
                            <h4 class="tleboxchung"><b>KẾT QUẢ GIẢI QUYẾT KN QUÁ HẠN</b></h4>
                            <div>
                                <table>
                                    <tr>
                                        <td></td>
                            ...
                            <div class="boder" style="padding: 10px;">
                                <table class="table1">
                                    ...
                                    <tr>
                                        <td style="width: 101px;">Lý do KNQH</td>
                                        <td style="width: 250px;" >
        ...
        function validateSearch() {
            ...
            if (lengthTuNgay > 0) {
                ...
                if (TuNgay.toString() == "NaN" || TuNgay.toString() == "Invalid Date") {
                    alert('Bạn phải nhập KN từ ngày theo định dạng (dd/MM/yyyy).');
                    txtTuNgay.focus();
                    return false;
                }
            }
            ...
            if (lengthDenNgay > 0) {
                ...
                if (DenNgay.toString() == "NaN" || DenNgay.toString() == "Invalid Date") {
                    alert('Bạn phải nhập KN đến ngày theo định dạng (dd/MM/yyyy).');
                    txtDenNgay.focus();
                    return false;
                }
            }
            if (lengthTuNgay > 0 && lengthDenNgay > 0 && TuNgay > DenNgay) {
                alert('Ngày KN từ ngày phải nhỏ hơn đến ngày.');
                txtDenNgay.focus();
                return false;
            }
            return true;
