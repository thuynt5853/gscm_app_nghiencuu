...
namespace WEB.GSTP.QLAN.XLHC.PhucthamKCKN
{
    public partial class NguoiTienHanhTTKCKN : System.Web.UI.Page
    {
        ...
        void CheckQuyen(decimal DONID)
        {
            ...
            DataTable oDT = oBL.XLHC_KCKNQDK_PHUCTHAM_QUYETDINH_GETLIST(DONID);
        ...
        private void LoadCombobox()
        {
            ...
            if (loaiQD != null)
            {
                XLHC_KCKNQDK_PHUCTHAM_QUYETDINH qd = DataExtensions.GetAllWithClause<XLHC_KCKNQDK_PHUCTHAM_QUYETDINH>($"DONID = {DonID} AND LOAIQDID = {loaiQD.ID} ").FirstOrDefault();
                if (qd != null)
                {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                XLHC_KCKNQDK_PHUCTHAM_HDXX oND;
                ...
                //List<XLHC_KCKNQDK_PHUCTHAM_HDXX> countChuToa = DataExtensions.GetAllWithClause<XLHC_KCKNQDK_PHUCTHAM_HDXX>($"DONID = {DONID} AND MAVAITRO = '{ENUM_NGUOITIENHANHTOTUNG.THAMPHAN}'");
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    if (tucach == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN)
                    {
                        ...
                        oND = DataExtensions.GetAllWithClause<XLHC_KCKNQDK_PHUCTHAM_HDXX>($"DONID = {DONID} AND MAVAITRO = '{ENUM_NGUOITIENHANHTOTUNG.THAMPHAN}' AND TOA_GIAIQUYET_ID = {Donvi_id}").FirstOrDefault();
                        if (oND != null)
                        {
                    ...
                    oND = new XLHC_KCKNQDK_PHUCTHAM_HDXX();
                }
                else
                {
                    decimal ID = Convert.ToDecimal(hddid.Value);
                    oND = DataExtensions.GetAllWithClause<XLHC_KCKNQDK_PHUCTHAM_HDXX>($"DONID = {DONID} AND MAVAITRO = '{ENUM_NGUOITIENHANHTOTUNG.THAMPHAN}' AND ID != {ID} AND TOA_GIAIQUYET_ID = {Donvi_id}").FirstOrDefault();
                    if (oND != null)
                    {
                        lbthongbao.Text = "Vụ án đã có thẩm phán chủ tọa phiên tòa. Không được sửa!";
                        ddlThamphan.Focus();
                        return;
                    }
                    oND = DataExtensions.FindById<XLHC_KCKNQDK_PHUCTHAM_HDXX>(ID);
                }
                oND.DONID = DONID;
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    XLHC_KCKNQDK_PHUCTHAM_HDXX CheckCanBo = DataExtensions.GetAllWithClause<XLHC_KCKNQDK_PHUCTHAM_HDXX>($"DONID = {DONID} AND CANBOID = {oND.CANBOID} ").FirstOrDefault();
                    if (CheckCanBo != null)
                    {
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.XLHC_KCKNQDK_PHUCTHAM_HDXX_GETLIST(ID);
            if (oDT != null && oDT.Rows.Count > 0)
            {
        ...
        {
            XLHC_KCKNQDK_PHUCTHAM_HDXX oND = DataExtensions.FindById<XLHC_KCKNQDK_PHUCTHAM_HDXX>(id);
        ...
        public void loadedit(decimal ID, decimal DONID)
        {
            ...
            {
                //Cls_Comon.SetButton(cmdUpdate, false);
                //-- VNPT- Đinh Hoàng Sơn - chỉnh lấy số thụ lý cho PTQDK - 18-9-2025 08:00
