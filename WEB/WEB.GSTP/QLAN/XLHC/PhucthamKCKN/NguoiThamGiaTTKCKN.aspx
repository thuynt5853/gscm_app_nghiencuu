<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="NguoiThamGiaTTKCKN.aspx.cs" Inherits="WEB.GSTP.QLAN.XLHC.PhucthamKCKN.NguoiThamGiaTTKCKN" %>
                    ...
                    <asp:Panel ID="pnNew" runat="server">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>Năm sinh</td>
                                <td><asp:TextBox ID="txtND_Namsinh" CssClass="user floatF" onkeypress="return isNumber(event)" runat="server" Width="80px" MaxLength="4"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>Điện thoại</td>
                                <td>
