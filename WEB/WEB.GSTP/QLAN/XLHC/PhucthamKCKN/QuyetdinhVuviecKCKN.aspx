<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="QuyetdinhVuviecKCKN.aspx.cs" Inherits="WEB.GSTP.QLAN.XLHC.PhucthamKCKN.QuyetdinhVuviecKCKN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlHTXX" CssClass="chosen-select" runat="server" Width="250px" AutoPostBack="true">
                                        ...
                                        <asp:ListItem Text="Họp kín trực tuyến" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="Họp kín trực tiếp" Value="2"></asp:ListItem>
                                        <asp:ListItem Text="Họp công khai trực tuyến" Value="3"></asp:ListItem>
                                        <asp:ListItem Text="Họp công khai trực tiếp" Value="4"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                           </tr>
                        </asp:Panel>
                        ...
                        <asp:Panel ID="pnLyDo" runat="server">
                            <tr>
                                <td>Lý do</td>
                                <td colspan="3">
                                    <asp:DropDownList ID="ddlLydo" CssClass="chosen-select" runat="server" Width="654px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </asp:Panel>
                        <tr>
                            ...
                            <td class="QDVACol2">
                                <asp:TextBox ID="txtSoQD" runat="server" CssClass="user" Width="242px" MaxLength="250"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtHieulucTuNgay" runat="server" CssClass="user" Width="100px" MaxLength="10" AutoPostBack="True" OnTextChanged="txtHieulucTuNgay_TextChanged"></asp:TextBox>
                            ...
                            <%--<td style="width: 145px;">Thời hạn</td>
                            <td>
    ...
    <script type="text/javascript">
        function ValidInputData() {
            ...
            var lengthHieulucDenNgay = txtHieulucDenNgay.value.trim().length;
            if (lengthHieulucDenNgay == 0) {
                alert('Bạn phải nhập hiệu lực đến ngày theo định dạng (dd/MM/yyyy).');
                txtHieuLucDenNgay.focus();
                return false;
            }
            var HieulucDenNgay;
            if (lengthHieulucDenNgay > 0) {
                var arr = txtHieulucDenNgay.value.split('/');
                HieulucDenNgay = new Date(arr[2] + '-' + arr[1] + '-' + arr[0]);
                if (HieulucDenNgay.toString() == "NaN" || HieulucDenNgay.toString() == "Invalid Date") {
                    alert('Bạn phải nhập hiệu lực đến ngày theo định dạng (dd/MM/yyyy).');
                    txtHieulucDenNgay.focus();
                    return false;
                }
            }
            if (HieulucTuNgay > HieulucDenNgay) {
                alert('Hiệu lực từ ngày phải nhỏ hơn hiệu lực đến ngày.');
                txtHieuLucDenNgay.focus();
                return false;
            }
            return true;
