<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Giaiquyetdon.aspx.cs" Inherits="WEB.GSTP.QLAN.XLHC.Thamphan.Giaiquyetdon" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNgayphancong" runat="server"
                                    CssClass="user" Width="110px" MaxLength="10"
                                    AutoPostBack="True" OnTextChanged="txtNgayphancong_TextChanged"></asp:TextBox>
