<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="GiaiquyetSotham.aspx.cs" Inherits="WEB.GSTP.QLAN.XLHC.Thamphan.GiaiquyetSotham" %>
                ...
                <table class="table1">
                    <tr>
                        <td colspan="2" align="center">
                            <asp:Button ID="cmdUpdate" runat="server" CssClass="buttoninput" Text="Lưu" OnClientClick="return ValidData();" OnClick="cmdUpdate_Click" />
                    ...
                    <tr>
                        <td colspan="2">
                            <div>
                                ...
                                <asp:HiddenField ID="hddActionType" runat="server" Value="0" />
