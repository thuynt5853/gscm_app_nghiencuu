...
namespace WEB.GSTP.QLAN.XLHC.Thamphan
{
    public partial class Giaiquyetdon : System.Web.UI.Page
    {
        ...
        private void CheckQuyen(decimal ID)
        {
            ...
            List<XLHC_SOTHAM_THULY> lstTL = dt.XLHC_SOTHAM_THULY.Where(x => x.DONID == ID).ToList();
            if (lstTL.Count > 0)
            {
        ...
        private void LoadCombobox()
        {
            ...
            DataTable dtVaiTro = oBL.DM_DATAITEM_GETBYGROUPNAME(ENUM_DANHMUC.VAITROTHAMPHAN_BP_XLHC);
        ...
        public void LoadGrid()
        {
            ...
            string current_id = Session[ENUM_LOAIAN.BPXLHC] + "";
            decimal ID = Convert.ToDecimal(current_id);
            DataTable oDT = oBL.XLHC_DON_THAMPHAN_GETBY(ID, ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETDON);
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                var donXL = dt.XLHC_DON_XULY.FirstOrDefault(x => x.DONID == DONID);
        ...
        private void KiemTraDonXL()
        {
            string current_id = Session[ENUM_LOAIAN.BPXLHC] + "";
            decimal donID = Convert.ToDecimal(current_id);
            var donXL = dt.XLHC_DON_XULY.Where(x => x.DONID == donID).FirstOrDefault();
            if (donXL != null)
            {
                Cls_Comon.SetButton(cmdUpdate, false);
                Cls_Comon.SetButton(cmdLammoi, false);
