<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="ThuLy.aspx.cs" Inherits="WEB.GSTP.QLAN.XLHC.Sotham.ThuLy" %>
            ...
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        ...
                        <tr>
                            <td style="width: 125px;">Ngày thụ lý<span class="batbuoc">(*)</span></td>
                            ...
                            <td style="width: 162px;">Số thụ lý<span class="batbuoc">(*)</span></td>
                            <td>
                                <asp:TextBox ID="txtSoThuly" runat="server" CssClass="user" Width="242px" MaxLength="250"></asp:TextBox>
                            </td>
                        </tr>
                        <tr style="display: none;">
                            <td>Loại quan hệ</td>
                            <td>
                                <asp:DropDownList ID="ddlLoaiQuanhe" CssClass="chosen-select" runat="server" Width="300px" AutoPostBack="True" OnSelectedIndexChanged="ddlLoaiQuanhe_SelectedIndexChanged">
                            ...
                            <asp:Panel runat="server" ID="pndata" Visible="false">
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="NGAYTHONGBAO" HeaderText="Ngày thông báo" HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundColumn>
