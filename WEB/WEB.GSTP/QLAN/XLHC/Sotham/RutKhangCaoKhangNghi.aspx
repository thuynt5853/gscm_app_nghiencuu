<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="RutKhangCaoKhangNghi.aspx.cs" Inherits="WEB.GSTP.QLAN.XLHC.Sotham.RutKhangCaoKhangNghi" %>
    ...
    <div class="box">
        <div class="box_nd" style="width: 99%;">
            <div class="truong">
                <table class="table1">
                    <tr>
                        <td><b>DANH SÁCH KHIẾU NẠI, KIẾN NGHỊ, KHÁNG NGHỊ</b></td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Panel runat="server" ID="pndata" Visible="false">
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="KNKNKCID" Visible="false"></asp:BoundColumn>
                                        ...
                                        <asp:BoundColumn DataField="KNKNKCName" HeaderText="Khiếu nại, Kiến nghị, Kháng nghị" HeaderStyle-Width="66px" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="TEN" HeaderText="Người khiếu nại, CQ đề nghị, VKS cùng cấp" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="LOAI_QD" HeaderText="Loại" HeaderStyle-Width="118px" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="SO_QD" HeaderText="Số QĐ" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            ...
                                            <ItemTemplate>
                                             <%--   <asp:LinkButton ID="lblSua" runat="server" Text="Sửa" CausesValidation="false" CommandName="Sua" ForeColor="#0e7eee"
                                                ...
                                                <asp:LinkButton ID="lbtXoa" runat="server" CausesValidation="false" Text="Xóa" ForeColor="#0e7eee"
                                                    CommandName="Xoa" CommandArgument='<%#Eval("ID") %>' ToolTip="Xóa" OnClientClick="return confirm('Bạn chắc chắn muốn xóa bản ghi này? ');"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
