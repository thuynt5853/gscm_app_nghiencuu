<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="QuyetdinhVuviec.aspx.cs" Inherits="WEB.GSTP.QLAN.XLHC.Sotham.QuyetdinhVuviec" %>
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="QDVACol1">Ngày mở phiên họp</td>
                                <td class="QDVACol2">
                        ...
                        <asp:Panel ID="pnHinhThucXetXu" runat="server" Visible ="false">
                            <tr>
                                <td>Hình thức<span class="batbuoc">(*)</span></td>
                                <td>
