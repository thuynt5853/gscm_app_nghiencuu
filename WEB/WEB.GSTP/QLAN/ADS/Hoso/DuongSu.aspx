<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="DuongSu.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Hoso.DuongSu" %>
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        ...
                        <asp:Panel ID="pnNDCanhan" runat="server">
                            ...
                            <tr>
                                <td>Nơi cư trú
                                    <asp:Label ID="lblBatbuoc2" runat="server" ForeColor="Red" Text="(*)"></asp:Label></td>
                                <td>
                            ...
                            <tr>
                                <td>Nơi làm việc</td>
                                <td colspan="3">
                                    <asp:TextBox ID="txtNoiLamViec" CssClass="user" runat="server" Width="618px" MaxLength="500"></asp:TextBox>
                                </td>
                            </tr>
                        </asp:Panel>
                        <tr>
