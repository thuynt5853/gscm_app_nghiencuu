<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Thongtindon.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Hoso.Thongtindon" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/QLAN/ADS/Hoso/Popup/pDuongSuDonCha.ascx" TagPrefix="uc1" TagName="DsDuongSu" %>
            ...
            <div class="truong">
                ...
                <div class="boxchung">
                    <h4 class="tleboxchung">
                        <asp:Label ID="lbl_ttnguyendon" Text="Thông tin nguyên đơn (đại diện)" runat="server"></asp:Label></h4>
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                            ...
                            <%--<tr>
                                ...
                                <td style="width: 70px;">Quốc tịch<span class="batbuoc">(*)</span></td>
                                <td>
                                    <asp:DropDownList ID="DropDownList1" CssClass="chosen-select" runat="server" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlND_Quoctich_SelectedIndexChanged"></asp:DropDownList></td>
                            </tr>--%>
                            <tr>
                                <td>Thẻ căn cước
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtBD_Ten" CssClass="user" runat="server" Width="242px" ClientIDMode="Static"></asp:TextBox></td>
                                <td>Quốc tịch<span class="batbuoc">(*)</span></td>
                                <td>
                                    <asp:DropDownList ID="ddlBD_Quoctich" CssClass="chosen-select" runat="server" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlBD_Quoctich_SelectedIndexChanged" ClientIDMode="Static"></asp:DropDownList></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>Hộ chiếu
                                    <asp:Literal ID="ltHCBD" runat="server"></asp:Literal></td>
                                <td>
                            ...
                            <asp:Panel ID="pnBD_Canhan" runat="server">
                                <tr>
                                    ...
                                    <td>Ngày sinh</td>
                                    <td>
                                        <asp:TextBox ID="txtBD_Ngaysinh" ClientIDMode="Static" runat="server" CssClass="user" Width="65px" MaxLength="10"></asp:TextBox>
