<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Danhsach.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Hoso.Danhsach" %>
                                            ...
                                            <td>
                                                ...
                                                <asp:Panel ID="pnTTTK" runat="server" Visible="false">
                                                    ...
                                                    <div style="float: left; width: 1050px; margin-top: 6px;">
                                                        ...
                                                        <div style="float: left;">
                                                            <asp:DropDownList ID="ddlVaiTroThamPhan" CssClass="chosen-select" runat="server" AutoPostBack="true" Width="250px" OnSelectedIndexChanged="ddlVaiTroThamPhan_SelectedIndexChanged"></asp:DropDownList>
                                                        </div>
                                                    ...
                                                    <div style="float: left; width: 1050px; margin-top: 8px;">
                                                        ...
                                                        <div style="float: left; width: 1050px; margin-top: 8px;">
                                                            <asp:Panel ID="pnlHG" runat="server">
                                                                ...
                                                                <div style="float: left; width: 300px; text-align: right; margin-right: 10px;white-space: nowrap;">GQ KC/KN QĐ tạm đình chỉ và QĐ khác</div>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hddGiaiDoanVuViec" runat="server" Value='<%#Eval("MAGIAIDOAN")%>' />
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-Width="60px" HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="lbtXoa" runat="server" ForeColor="#0e7eee" CausesValidation="false" Text="Xóa"
                                                    ...
                                                    OnClientClick="return confirm('Bạn thực sự muốn xóa vụ việc này? ');">
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
