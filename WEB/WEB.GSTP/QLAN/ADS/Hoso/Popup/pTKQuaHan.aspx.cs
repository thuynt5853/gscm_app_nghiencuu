...
namespace WEB.GSTP.QLAN.ADS.Hoso.Popup
{
    public partial class pTKQuaHan : System.Web.UI.Page
    {
        ...
        {
            var lstData = DataExtensions.GetAll<TK_QUAHAN>().Where(x => x.TRANGTHAI != 99 && x.LOAIAN == 2 && x.TOAANID == Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID] + ""));
        ...
        {
            string link = "/QLAN/ADS/Hoso/Popup/pThemTKQuaHan.aspx";
        ...
        {
            string link = "/QLAN/ADS/Hoso/Popup/pThemTKQuaHan.aspx?TKID=" + id;
