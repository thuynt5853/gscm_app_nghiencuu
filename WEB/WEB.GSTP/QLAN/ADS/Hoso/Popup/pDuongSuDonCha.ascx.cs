...
namespace WEB.GSTP.QLAN.ADS.Hoso.Popup
{
    public partial class pDuongSuDonCha : System.Web.UI.UserControl
    {
        ...
        public void LoadGrid()
        {
            ...
            // GTEL-HUNGNQ 09-10-2025 them xac thực c06
            KHOBAQD_BL oBL = new KHOBAQD_BL();
            //END

            // GTEL-HUNGNQ 09-10-2025 comment hàm cũ
            //ADS_DON_DUONGSU_BL oBL = new ADS_DON_DUONGSU_BL();
            //END

            DataTable oDT = oBL.ADS_DON_DUONGSU_NOTDAIDIEN_DONCHA(DonID);
        ...
        protected void lkThemNguoiTGTT_Click(object sender, EventArgs e)
        {
            ...
            string StrMsg = "PopupCenter('/QLAN/ADS/Hoso/Popup/pDuongsuDonCha.aspx?hsID=" + DonID.ToString() + "&bID=0','Thêm đương sự',950,450);";
