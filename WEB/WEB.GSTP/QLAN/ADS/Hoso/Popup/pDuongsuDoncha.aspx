<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pDuongsuDoncha.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Hoso.Popup.pDuongsuDoncha" %>
                                ...
                                <table class="table1">
                                    ...
                                    <asp:Panel ID="pnNDCanhan" runat="server">
                                        <tr>
                                            ...
                                            <td>Ngày sinh</td>
                                            <td>
                                                <asp:TextBox ID="txtND_Ngaysinh" runat="server"  ClientIDMode="Static" CssClass="user" Width="65px" MaxLength="10" AutoPostBack="True" OnTextChanged="txtND_Ngaysinh_TextChanged"></asp:TextBox>
