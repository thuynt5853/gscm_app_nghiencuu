<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pDuongSuKhacChiTiet.ascx.cs" Inherits="WEB.GSTP.QLAN.ADS.Hoso.Popup.pDuongSuKhacChiTiet" %>
...
<script>
    function popup_edit_duongsu(DuongSuID) {
        ...
        var link = "";
        if (DuongSuID > 0)
            link = "/QLAN/ADS/Hoso/Popup/pDuongsuChiTiet.aspx?hsID=<%=DonID%>&bID=" + DuongSuID;
        else
            link = "/QLAN/ADS/Hoso/Popup/pDuongsuChiTiet.aspx?hsID=<%=DonID%>";
        var width = 950;
        var height = 400;
