    ...
    public partial class pDuongsu : System.Web.UI.Page
    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // GTEL-HUNGNQ 10-10-2025 Trạng thái Xac thuc Du lieu quoc gia của duong su
        ...
        protected void btnGet037_Click(object sender, EventArgs e)
        {
            ...
            if (quocTich == "2")
            {
                txtND_CMND.Enabled = txtTennguyendon.Enabled = txtND_Namsinh.Enabled = txtND_Ngaysinh.Enabled = true;
                string soDinhDanh = txtND_CMND.Text.Trim();
                ...
                else
                {
                    ...
                    if (DuongSuID > 0)
                    {
                        ...
                        if (ds != null)
                        {
                            if (ds.TENDUONGSU == txtTennguyendon.Text && ds.NAMSINH == dsNamSinh && ds.SO_CCCD == txtND_CMND.Text)
                            {
                                if (ds.SOCMND == null)
                                {
                    ...
                    txtND_CMND.Enabled = txtTennguyendon.Enabled = txtND_Namsinh.Enabled = txtND_Ngaysinh.Enabled = false;
                    ddlND_Quoctich.Enabled = false;
                    hdTrangThaiXacThuc.Value = "1";
                    chkKhongLamSach.Enabled = chkKhongLamSach.Enabled = false;
                    chkKhongLamSach.Checked = chkKhongLamSach.Checked = false;
