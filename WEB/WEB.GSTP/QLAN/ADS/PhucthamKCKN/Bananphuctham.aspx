<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Bananphuctham.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.PhucthamKCKN.Bananphuctham" %>
                            ...
                            <div class="boxchung">
                                ...
                                <div class="boder" style="padding: 10px;">
                                    <table class="table1">
                                        ...
                                        <tr>
                                            <td style="width: 140px;">Áp dụng án lệ?</td>
                                            ...
                                            <td style="width: 140px;">Có VKS tham gia?</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>VKS có kháng nghị nhưng không được chấp nhận</td>
                                            <td>
                                            ...
                                            <td>VKS rút kháng nghị nhưng đương sự không rút kháng cáo</td>
                                            <td>
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>Ngày mở phiên tòa <span class="batbuoc">(*)</span></td>
                                <td>
                                    <asp:TextBox ID="txtNgayMoPhienToaQD" runat="server" CssClass="user"
                                        AutoPostBack="true"
                                        Width="110px" MaxLength="10"></asp:TextBox>
                                    <cc1:CalendarExtender ID="CalendarExtender8" runat="server" TargetControlID="txtNgayMoPhienToaQD" Format="dd/MM/yyyy" Enabled="true" />
                                    <cc1:MaskedEditExtender ID="MaskedEditExtender8" runat="server" TargetControlID="txtNgayMoPhienToaQD" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                    <cc1:MaskedEditValidator ID="MaskedEditValidator2" runat="server" ControlExtender="MaskedEditExtender2" ControlToValidate="txtNgayMoPhienToaQD" InvalidValueMessage="dd/MM/yyyy" Style="color: red; margin-left: 15px;"></cc1:MaskedEditValidator>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <cc1:MaskedEditValidator ID="MaskedEditValidator1" runat="server" ControlExtender="MaskedEditExtender2" ControlToValidate="txtNgayQD" InvalidValueMessage="dd/MM/yyyy" Style="color: red; margin-left: 15px;"></cc1:MaskedEditValidator>
