<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuyetdinhphucthamKCKN.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.PhucthamKCKN.QuyetdinhphucthamKCKN" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="QuyetdinhphucthamKCKN.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.PhucthamKCKN.QuyetdinhphucthamKCKN" %>
            ...
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        ...
                        <tr>
                            <td class="QDVACol1">Ngày quyết định<span class="batbuoc">(*)</span></td>
                            <td class="QDVACol2">
                            ...
                            <td class="QDVACol2">Số Quyết định <span class="batbuoc">(*)</span> </td>
                            <td>
