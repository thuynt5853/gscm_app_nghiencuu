<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NguoiThamgiaTTKCKN.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.PhucthamKCKN.NguoiThamgiaTTKCKN" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="NguoiThamgiaTTKCKN.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.PhucthamKCKN.NguoiThamgiaTTKCKN" %>
                    ...
                    <asp:Panel ID="pnNew" runat="server">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>Email</td>
                                <td><asp:TextBox ID="txtEmail" CssClass="user floatF" runat="server" Width="47%"></asp:TextBox></td>
                            </tr>
