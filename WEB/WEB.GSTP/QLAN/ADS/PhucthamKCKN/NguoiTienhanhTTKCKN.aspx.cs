...
{
    public partial class NguoiTienhanhTTKCKN : System.Web.UI.Page
    {
        ...
        private void CheckQuyen(decimal DONID)
        {
            ...
            DataTable oDT = oBL.ADS_KCKNQDK_PHUCTHAM_QUYETDINH_GETLIST(DONID);
            ...
            //List<ADS_KCKNQDK_PHUCTHAM_THULY> lstCount = dt.ADS_KCKNQDK_PHUCTHAM_THULY.Where(x => x.DONID == DONID).ToList();
        ...
        private void LoadCombobox()
        {
            ...
            if (loaiQD != null)
            {
                //ADS_KCKNQDK_PHUCTHAM_QUYETDINH qd = dt.ADS_KCKNQDK_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DonID && x.LOAIQDID == loaiQD.ID).FirstOrDefault<ADS_KCKNQDK_PHUCTHAM_QUYETDINH>();
                ADS_KCKNQDK_PHUCTHAM_QUYETDINH qd = DataExtensions.GetAllWithClause<ADS_KCKNQDK_PHUCTHAM_QUYETDINH>($"DONID = {DonID} AND LOAIQDID = {loaiQD.ID} ").FirstOrDefault();
                if (qd != null)
                {
                    ADS_DON_THAMPHAN tpgq = dt.ADS_DON_THAMPHAN.Where(x => x.DONID == DonID && x.MAVAITRO == "VTTP_GIAIQUYETPHUCTHAM").OrderByDescending(x => x.NGAYTAO).FirstOrDefault<ADS_DON_THAMPHAN>();
                    if (tpgq != null)
                    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ADS_KCKNQDK_PHUCTHAM_HDXX oND;
               
                // Lấy count thụ lý và count chủ tọa để cho nhập thêm thẩm phán chủ tọa
                List<ADS_DON_THAMPHAN> countTPGQ = dt.ADS_DON_THAMPHAN.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETPHUCTHAM && x.TOA_GIAIQUYET_ID == Donvi_id).ToList();
                //List<ADS_KCKNQDK_PHUCTHAM_HDXX> countChuToa = dt.ADS_KCKNQDK_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).ToList();
                List<ADS_KCKNQDK_PHUCTHAM_HDXX> countChuToa = DataExtensions.GetAllWithClause<ADS_KCKNQDK_PHUCTHAM_HDXX>($"DONID = {DONID} AND MAVAITRO = '{ENUM_NGUOITIENHANHTOTUNG.THAMPHAN}' AND TOA_GIAIQUYET_ID = {Donvi_id}");
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    if (tucach == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN)
                    {
                        ...
                        //oND = dt.ADS_KCKNQDK_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).FirstOrDefault<ADS_KCKNQDK_PHUCTHAM_HDXX>();
                        oND = DataExtensions.GetAllWithClause<ADS_KCKNQDK_PHUCTHAM_HDXX>($"DONID = {DONID} AND MAVAITRO = '{ENUM_NGUOITIENHANHTOTUNG.THAMPHAN}' AND TOA_GIAIQUYET_ID = {Donvi_id}").FirstOrDefault();
                        if (oND != null && countTPGQ != null && countChuToa != null && countTPGQ.Count == countChuToa.Count)
                        {
                    ...
                    oND = new ADS_KCKNQDK_PHUCTHAM_HDXX();
                }
                else
                {
                    decimal ID = Convert.ToDecimal(hddid.Value);
                    //oND = dt.ADS_KCKNQDK_PHUCTHAM_HDXX.Where(x => x.ID == ID).FirstOrDefault();
                    oND = DataExtensions.FindById<ADS_KCKNQDK_PHUCTHAM_HDXX>(ID);
                }
                oND.DONID = DONID;
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    //ADS_KCKNQDK_PHUCTHAM_HDXX CheckCanBo = dt.ADS_KCKNQDK_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.CANBOID == oND.CANBOID).FirstOrDefault();
                    ADS_KCKNQDK_PHUCTHAM_HDXX CheckCanBo = DataExtensions.GetAllWithClause<ADS_KCKNQDK_PHUCTHAM_HDXX>($"DONID = {DONID} AND CANBOID = {oND.CANBOID} ").FirstOrDefault();
                    ...
                    //dt.ADS_KCKNQDK_PHUCTHAM_HDXX.Add(oND);
                }
                else
                {
        ...
        public void LoadGrid()
        {
            ...
            string current_id = Session[ENUM_LOAIAN.AN_DANSU] + "";
            decimal ID = Convert.ToDecimal(current_id);
            DataTable oDT = oBL.ADS_KCKNQDK_PHUCTHAM_HDXX_GETLIST(ID);
            if (oDT != null && oDT.Rows.Count > 0)
            {
        ...
        {
            //ADS_KCKNQDK_PHUCTHAM_HDXX oND = dt.ADS_KCKNQDK_PHUCTHAM_HDXX.Where(x => x.ID == id).FirstOrDefault();
            //dt.ADS_KCKNQDK_PHUCTHAM_HDXX.Remove(oND);
            //dt.SaveChanges();
            ADS_KCKNQDK_PHUCTHAM_HDXX oND = DataExtensions.FindById<ADS_KCKNQDK_PHUCTHAM_HDXX>(id);
