<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ThuLyKCKN.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Phuctham.ThuLyKCKN" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="ThuLyKCKN.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.PhucthamKCKN.ThuLyKCKN" %>
                    ...
                    <table class="table1">
                        <tr>
                            ...
                            <td style="width: 265px;">
                                <asp:DropDownList ID="ddlLoaiThuLy" Enabled = "false" CssClass="chosen-select" runat="server" Width="250px"></asp:DropDownList>
                            </td>
                        ...
                        <tr>
                            ...
                            <td >
                                ...
                                <%--<asp:RadioButtonList ID="quyetdinhId" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="quyetdinhId_SelectedIndexChanged">
                                    <asp:ListItem ID ="dinhchi" Value="0" Text="Tạm đình chỉ"></asp:ListItem>
                                    <asp:ListItem ID ="khac" Value="1" Text="Khác"></asp:ListItem>
                                </asp:RadioButtonList>--%>
                            </td>
                            <td></td>
                            <td>
                             <%--   <asp:DropDownList ID="ddlQuyetDinh" CssClass="chosen-select" runat="server" Width="200px" AutoPostBack="True" Visible="false">
                                </asp:DropDownList>--%>
                                <%--<asp:DropDownList ID="ddlQuyetDinh" CssClass="chosen-select" runat="server" Width="200px" OnSelectedIndexChanged="ddlQuyetDinh_SelectedIndexChanged"></asp:DropDownList>--%>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlQuanhephapluat" CssClass="chosen-select" runat="server" Width="250px"
                                ...
                                <asp:DropDownList ID="ddlLoaiQuanhe" Enabled ="false" Visible="false" CssClass="chosen-select" runat="server" Width="300px">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            ...
                            <td style="width: 125px;">Người ký<span class="batbuoc">(*)</span></td>
