<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NguoiTienhanhTTKCKN.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.PhucthamKCKN.NguoiTienhanhTTKCKN" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true"
    CodeBehind="NguoiTienhanhTTKCKN.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.PhucthamKCKN.NguoiTienhanhTTKCKN" %>
        ...
        <div class="box_nd">
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            <td style="width: 148px;">Vai trò tham gia tố tụng<span class="batbuoc">(*)</span></td>
                            ...
                            <asp:Panel runat="server" ID="pndata" Visible="false">
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="NGUOITAO" HeaderText="Người tạo" HeaderStyle-Width="140px" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
    ...
    <script type="text/javascript">
        function ValidInputData() {
            ...
            //--------------------------------
             ...
             var control_value = txtNgayphancong.value;
             ...
             vontrol_value = txtNhanphancong.value;
             if (Common_CheckEmpty(control_value) && control_value != Empty_date) {
            ...
            var txtNgayketthuc = document.getElementById('<%=txtNgayketthuc.ClientID%>');
               if (Common_CheckEmpty(txtNgayketthuc.value)) {
                   if (!CheckDateTimeControl_KoSoSanhNgayHienTai(txtNgayketthuc, 'Ngày kết thúc'))
                       return false;
