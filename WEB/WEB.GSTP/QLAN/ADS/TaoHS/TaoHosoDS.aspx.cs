...
namespace WEB.GSTP.QLAN.ADS.TaoHS
{
    public partial class TaoHosoDS : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                DonID = (string.IsNullOrEmpty(Session[ENUM_LOAIAN.AN_DANSU] + "")) ? 0 : Convert.ToDecimal(Session[ENUM_LOAIAN.AN_DANSU] + "");
                ...
                ADS_PHUCTHAM_THULY oTLPT = dt.ADS_PHUCTHAM_THULY.Where(x => x.DONID == DonID).FirstOrDefault() ?? new ADS_PHUCTHAM_THULY();
                if (oTLPT.ID > 0){
        ...
        private void LoadInfo(decimal ID)
        {
            ...
            ADS_SOTHAM_BANAN oBA = dt.ADS_SOTHAM_BANAN.Where(x => x.DONID == oT.ID).FirstOrDefault() ?? new ADS_SOTHAM_BANAN();
            if (oBA.ID > 0)
            {
            ...
            {
                ADS_SOTHAM_QUYETDINH oQD = dt.ADS_SOTHAM_QUYETDINH.Where(x => x.DONID == oT.ID).FirstOrDefault() ?? new ADS_SOTHAM_QUYETDINH();
                if (oQD.ID > 0)
                {
            ...
            ADS_CHUYEN_NHAN_AN oCN = dt.ADS_CHUYEN_NHAN_AN.Where(x => x.VUANID == oT.ID).FirstOrDefault<ADS_CHUYEN_NHAN_AN>();
            if (oCN != null)
            {
        ...
        private bool CheckValid()
        {
            ...
            {
                lstMsgT.Text = lstMsgB.Text = "Bạn chưa nhập tên nguyên đơn/người yêu cầu";
                txtTennguyendon.Focus();
                return false;
            }
            else if (txtTennguyendon.Text.Length > 250)
            {
                lstMsgT.Text = lstMsgB.Text = "Tên nguyên đơn/người yêu cầu không nhập quá 250 ký tự.";
                txtTennguyendon.Focus();
                return false;
            }
            if (pnNDCanhan.Visible)// cá nhân
            {
                if (txtND_Ngaysinh.Text != "")
                {
                    ...
                    {
                        lstMsgT.Text = lstMsgB.Text = "Bạn chưa nhập ngày sinh nguyên đơn/người yêu cầu theo định dạng dd/MM/yyyy. Hãy nhập lại.";
                    ...
                    {
                        lstMsgT.Text = lstMsgB.Text = "Ngày sinh nguyên/người yêu cầu đơn không được lớn hơn ngày hiện tại. Hãy nhập lại.";
                        txtND_Ngaysinh.Focus();
                        return false;
                    }
                ...
                {
                    lstMsgT.Text = lstMsgB.Text = "Bạn chưa nhập năm sinh nguyên đơn/người yêu cầu.";
                    txtND_Namsinh.Focus();
                    return false;
                }
                else
                {
                    ...
                    {
                        lstMsgT.Text = lstMsgB.Text = "Năm sinh của nguyên đơn/người yêu cầu phải là số gồm 04 chữ số. Hãy kiểm tra lại.";
                    ...
                    if (namsinh == 0)
                    {
                        lstMsgT.Text = lstMsgB.Text = "Năm sinh của nguyên/người yêu cầu đơn phải lớn hơn 0. Hãy kiểm tra lại.";
                        Cls_Comon.SetFocus(this, this.GetType(), txtND_Namsinh.ClientID);
                        return false;
                    }
                    ...
                    {
                        lstMsgT.Text = lstMsgB.Text = "Năm sinh của nguyên đơn/người yêu cầu không thể lớn hơn năm hiện tại. Hãy kiểm tra lại!";
                        Cls_Comon.SetFocus(this, this.GetType(), txtND_Namsinh.ClientID);
                        return false;
                    }
                }
                ...
                {
                    lstMsgT.Text = lstMsgB.Text = "Nơi làm việc của nguyên đơn/người yêu cầu không nhập quá 500 ký tự.";
            ...
            if (lengthEmail_ND > 0)
            {
                ...
                {
                    lstMsgT.Text = lstMsgB.Text = "Email của nguyên đơn/người yêu cầu không nhập quá 250 ký tự. Hãy nhập lại.";
                ...
                {
                    lstMsgT.Text = lstMsgB.Text = "Địa chỉ email của nguyên đơn/người yêu cầu chưa đúng.";
                    Cls_Comon.SetFocus(this, this.GetType(), txtND_Email.ClientID);
                    return false;
                }
            }
        ...
        private void LoadCombobox()
        {
            ...
            List<DM_QD_QUYETDINH> lst = dt.DM_QD_QUYETDINH.Where(x => x.LOAIID == LoaiQD && x.ISDANSU == 1 && x.ISSOTHAM == 1).OrderBy(y => y.TEN).ToList();
            ...
            ddlQuyetdinh.Items.Insert(1, new ListItem("93-DS. Quyết định giải quyết việc dân sự", "70"));
        ...
        public void SaveDuongSu_VUVIEC()
        {
            ...
            if (hddID.Value == "" || hddID.Value == "0")
            {
                ...
                string toaxxid = ddlToaxxST.SelectedValue;
                oT.MAVUVIEC = ENUM_LOAIVUVIEC.AN_DANSU + toaxxid + oT.TT.ToString();
                ...
                if (ddlThuly.SelectedIndex == 0)
                    GD.GAIDOAN_INSERT_UPDATE("2", oT.ID, 2, Convert.ToDecimal(ddlToaxxST.SelectedValue), 0, 0, 0, 0);
        ...
        void UpdateBanAn(decimal VuAnId)
        {
            ...
            DateTime date_temp;
            ADS_SOTHAM_BANAN obj = new ADS_SOTHAM_BANAN();
            if (VuAnId > 0)
            {
                obj = dt.ADS_SOTHAM_BANAN.Where(x => x.DONID == VuAnId).SingleOrDefault<ADS_SOTHAM_BANAN>();
                if (obj != null)
                    IsUpdate = true;
                else
                    obj = new ADS_SOTHAM_BANAN();
            }
            else
                obj = new ADS_SOTHAM_BANAN();
        ...
        {
            Boolean IsUpdate = false;
            ADS_SOTHAM_QUYETDINH oND = new ADS_SOTHAM_QUYETDINH();
            if (VuAnId > 0)
            {
                oND = dt.ADS_SOTHAM_QUYETDINH.Where(x => x.DONID == VuAnId).SingleOrDefault<ADS_SOTHAM_QUYETDINH>();
                if (oND != null)
                    IsUpdate = true;
                else
        ...
        void Chuyenan_Nhanan(decimal VuAnID)
        {
            ...
            if (VuAnID > 0)
            {
                oND = dt.ADS_CHUYEN_NHAN_AN.Where(x => x.VUANID == VuAnID).SingleOrDefault<ADS_CHUYEN_NHAN_AN>();
                if (oND != null)
                    IsUpdate = true;
                else
                    oND = new ADS_CHUYEN_NHAN_AN();
            }
            else
                oND = new ADS_CHUYEN_NHAN_AN();
            ...
            ADS_SOTHAM_KHANGCAO oKC = dt.ADS_SOTHAM_KHANGCAO.Where(x => x.DONID == VuAnID).FirstOrDefault<ADS_SOTHAM_KHANGCAO>();
            ADS_SOTHAM_KHANGNGHI oKN = dt.ADS_SOTHAM_KHANGNGHI.Where(x => x.DONID == VuAnID).FirstOrDefault<ADS_SOTHAM_KHANGNGHI>();
            ...
            ADS_DON oVuAn = dt.ADS_DON.Where(x => x.ID == VuAnID).FirstOrDefault();
            ...
            if (ddlThuly.SelectedIndex == 1)
                GD.GAIDOAN_INSERT_UPDATE_XXLAI_PHUCTHAM("2", VuAnID, 3, Convert.ToDecimal(ddlToaxxST.SelectedValue), Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0);
            else
                GD.GAIDOAN_INSERT_UPDATE("2", VuAnID, 3, 0, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0);
        }
        ...
        protected void cmdUpdateKCKN_Click(object sender, EventArgs e)
        {
            ...
            if (rdbPanelKC.SelectedValue == KHANGCAO.ToString() && rdbPanelKN.SelectedValue == KHANGCAO.ToString())// Kháng cáo
            {
                ...
                hddKCID.Value = "0";
                //-------------------------
                if (rdbMienAnphi.SelectedValue == "0")
                {
                    List<ADS_ANPHI> lstAP = dt.ADS_ANPHI.Where(x => x.DONID == vDonID && x.MAGIAIDOAN == 3).ToList();
                    ...
                    objAP.SOBIENLAI = txtSobienlai.Text;
                    ...
                    obj_anphi.DVCQG_THANH_TOAN_INSERT_ANPHI(3, DonID, 0, objAP.ID, "2",null);
                }
            }
        ...
        protected void cmdXoaHoSo_Click(object sender, EventArgs e)
        {
            ...
            ADS_PHUCTHAM_THULY oTLPT = dt.ADS_PHUCTHAM_THULY.Where(x => x.DONID == ID).FirstOrDefault() ?? new ADS_PHUCTHAM_THULY();
            if (oTLPT.ID == 0)
            {
                ADS_DON oVa = dt.ADS_DON.Where(x => x.ID == ID).First();
                if (oVa != null)
                {
        ...
        public void XoaHoSo(decimal ID)
        {
            ...
            //Luu thong tin ho so vu an khi xoa ho so
            ...
            if (oBL.HISTORY_ALLDATA_BY_VUANID(ID, 2, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Tạo hồ sơ KC/KN Dan su", "Xóa", json) == true)
            {
                if (oBL.DELETE_ALLDATA_BY_VUANID(ID + "") == true)
                {
                    //Xóa thông tin Giai đoan
                    GIAI_DOAN_BL GD = new GIAI_DOAN_BL();
                    GD.GIAIDOAN_DELETES("2", ID,2);
                }
            }
            //Ket thuc 
        }
        ...
        {
            ADS_DON_DUONGSU oT = dt.ADS_DON_DUONGSU.Where(x => x.ID == id).FirstOrDefault();

            //Luu thong tin Duong sư vu an khi xoa Duong su
            string strUserName = Session[ENUM_SESSION.SESSION_USERNAME] + "";
            var json = new JavaScriptSerializer().Serialize(oT);
            ADS_DON_BL oBL = new ADS_DON_BL();
            if (oBL.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oT.DONID), 2, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Xoa Đương sự trong Tạo hồ sơ KC/KN Dan su", "Xóa", json) == false)
                return;

            //Xoa duong su
            dt.ADS_DON_DUONGSU.Remove(oT);
            dt.SaveChanges();
        }
        ...
        {
            if (ddlQuyetdinh.SelectedValue == "70" || 
        ...
        void Load_ListBiCan( decimal vDonid)
        {
            ...
            //Load đương sự
            ddlNguoikhangcao.DataSource = oDSBL.ADS_SOTHAM_DUONGSU_GETBY(vDonid, 1);
        ...
        void Load_ListNguoiThamGiaToTung(decimal vDonid)
        {
            ...
            string hoten = "";
            List<ADS_DON_THAMGIATOTUNG> lst = dt.ADS_DON_THAMGIATOTUNG.Where(x => x.DONID == vDonid).ToList();
            if (lst != null && lst.Count > 0)
            {

                foreach (ADS_DON_THAMGIATOTUNG item in lst)
                {
        ...
        {
            String temp = "";
            List<ADS_SOTHAM_BANAN> lst = dt.ADS_SOTHAM_BANAN.Where(x => x.DONID == DonID).OrderByDescending(y => y.NGAYTUYENAN).ToList();
            if (lst != null && lst.Count > 0)
            {
                foreach (ADS_SOTHAM_BANAN item in lst)
                {
        ...
        {
            String temp = "";
            ADS_SOTHAM_BL objBL = new ADS_SOTHAM_BL();
            DataTable tblQD = objBL.ADS_SOTHAM_QUYETDINH_GETLIST(DonID);
        ...
        public void LoadGridKCKN()
        {
            ...
            decimal ID = (string.IsNullOrEmpty(Session[ENUM_LOAIAN.AN_DANSU] + "")) ? 0 : Convert.ToDecimal(Session[ENUM_LOAIAN.AN_DANSU] + "");
            DataTable oDT = oBL.ADS_SOTHAM_KCaoKNghi_GETLIST(ID);
        ...
        protected void rdbDonVi_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                decimal vdonid = Convert.ToDecimal(hddID.Value);
                ADS_DON oD = dt.ADS_DON.Where(x => x.ID == vdonid).FirstOrDefault();
                decimal ToaAnID = 0;
                if (oD != null)
        ...
        protected void lkThemDuongSuKhac_Click(object sender, EventArgs e)
        {
            ...
            string StrMsg = "PopupReport('/QLAN/ADS/TaoHS/Popup/pDuongsu.aspx?hsID=" + DonID.ToString() + "&bID=0','Thêm người tham gia tố tụng',950,450);";
        ...
        protected void lkThemNguoiTGTT_Click(object sender, EventArgs e)
        {
            ...
            string StrMsg = "PopupReport('/QLAN/ADS/TaoHS/Popup/pNguoiThamgiaTT.aspx?hsID=" + DonID.ToString() + "&bID=0','Thêm người tham gia tố tụng',950,450);";
            System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), StrMsg, true);
        }
