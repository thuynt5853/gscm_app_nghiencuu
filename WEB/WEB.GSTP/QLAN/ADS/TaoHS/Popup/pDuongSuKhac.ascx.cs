...
namespace WEB.GSTP.QLAN.ADS.TaoHS.Popup
{
    public partial class pDuongSuKhac : System.Web.UI.UserControl
    {
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.ADS_DON_DUONGSU_NOTDAIDIEN(vDonid);
        ...
        //    string StrMsg = "PopupReport('/QLAN/ADS/TaoHS/Popup/pDuongsu.aspx?hsID=" + DonID.ToString() + "&bID=0','Thêm đương sự',950,450);";
