<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true"
    CodeBehind="TaoHosoDS.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.TaoHS.TaoHosoDS" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/QLAN/ADS/TaoHS/Popup/pDuongSuKhac.ascx" TagPrefix="uc1" TagName="DsDuongSu" %>
<%@ Register Src="~/QLAN/ADS/TaoHS/Popup/uDSNguoiThamGiaToTung.ascx" TagPrefix="uc1" TagName="uDSNguoiThamGiaToTung" %>
        ...
        <div class="box_nd">
            <div class="truong">
                ...
                <div class="boxchung">
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table style="border-width: 0; border-collapse: collapse; border-spacing: 0; margin: 0px; padding: 0px; font-size: 12px; font-family: Arial;">
                        ...
                        <table>
                            <tr style="height: 30px">
                                ...
                                <td style="width: 145px;">
                                    <asp:DropDownList ID="ddlQuanhephapluat" CssClass="chosen-select" runat="server" Width="260px" AutoPostBack="True" OnSelectedIndexChanged="ddlQuanhephapluat_SelectedIndexChanged" Visible="false"></asp:DropDownList>
                                    <asp:TextBox ID="txtQuanhephapluat" CssClass="user" runat="server" Width="250px" MaxLength="500" placeholder="" TextMode="MultiLine"></asp:TextBox>
                                </td>
                                    ...
                                    <table class="table1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <cc1:MaskedEditExtender ID="MaskedEditExtender7" runat="server" TargetControlID="txtNgaynopanphi" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>
            ...
            <div align="center">
                ...
                <%-- Tạm thời ngắt nút xoá, vì Nếu phân quyền "XEM" thì vẫn có quyền xoá
                    ...
                    01/11/2024--%>
                <asp:Button ID="cmdXoaHoSo" runat="server" CssClass="buttoninput" Text="Xóa" Visible="false" 
                    OnClick="cmdXoaHoSo_Click" OnClientClick="return confirm('Bạn thực sự muốn xóa Hồ sơ này? ');" />
            </div>
