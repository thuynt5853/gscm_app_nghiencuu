<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pBoSungTaiLieu.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.XuLyDon.Popup.pBoSungTaiLieu" %>
                        ...
                        <table class="table1">
                            ...
                            <asp:Panel ID="pnYCBS" runat="server" Visible="false">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtYCBS" CssClass="user" runat="server" Width="615px" TextMode="MultiLine" Rows="2"></asp:TextBox></td>
                                </tr>
                            </asp:Panel>
                            <tr>
                                <td>
