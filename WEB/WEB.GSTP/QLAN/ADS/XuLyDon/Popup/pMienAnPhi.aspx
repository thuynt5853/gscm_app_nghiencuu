<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pMienAnPhi.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.XuLyDon.Popup.pMienAnPhi" %>
                                ...
                                <td colspan="4">
                                    <div style="text-align: center; margin-top: 5px;">
                                        <asp:Button ID="cmdCapNhatAP" runat="server"
                                            CssClass="buttoninput" Text="Lưu" OnClick="cmdCapNhatAP_Click"  OnV/>
