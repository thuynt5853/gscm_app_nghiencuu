<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="NguoiThamgiaTT.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Phuctham.NguoiThamgiaTT" %>
                    ...
                    <asp:Panel ID="pnNew" runat="server">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>Nơi tạm trú</td>
                                <td>
                                    <asp:TextBox ID="txtND_TTChitiet" CssClass="user" runat="server" Width="47%" MaxLength="250"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>Giới tính</td>
                                <td>
                                ...
                                <td>Năm sinh</td>
                                <td>
                                    <asp:TextBox ID="txtND_Namsinh" CssClass="user floatF" onkeypress="return isNumber(event)" runat="server" Width="80px" MaxLength="4"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>Điện thoại</td>
                                <td>
                                ...
                                <td>Email</td>
                                <td>
                                    <asp:TextBox ID="txtEmail" CssClass="user floatF" runat="server" Width="47%"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="4" style="text-align: center;">
                                    <asp:Button ID="cmdUpdate" runat="server" CssClass="buttoninput"
                                        OnClientClick="return ValidDataInput();" Text="Lưu" OnClick="btnUpdate_Click" />
