<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Capnhatkhangcaoquahan.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Phuctham.Capnhatkhangcaoquahan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlGQ_Thamphan" CssClass="chosen-select" runat="server" Width="220px"
                                            AutoPostBack="True" OnSelectedIndexChanged="ddlGQ_Thamphan_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlGQ_Thamphan1" CssClass="chosen-select" runat="server" Width="220px"
                                            AutoPostBack="True" OnSelectedIndexChanged="ddlGQ_Thamphan1_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="width: 80px;">TP Thành viên 1<span class="batbuoc">(*)</span></td>
                                    <td>
                                        <asp:DropDownList ID="ddlGQ_Thamphan2" CssClass="chosen-select" runat="server" Width="220px"
                                            AutoPostBack="True" OnSelectedIndexChanged="ddlGQ_Thamphan2_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
    ...
    <script type="text/javascript">
        ...
        function validateUpdate() {
            ...
            if (val == 0) {
                alert('Bạn chưa chọn Thẩm phán Chủ tọa. Hãy chọn lại!');
            ...
            if (val == 0) {
                alert('Bạn chưa chọn Thẩm phán thành viên HĐXX. Hãy chọn lại!');
