<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Quyetdinhphuctham.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Phuctham.Quyetdinhphuctham" %>
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        ...
                        <tr>
                            ...
                            <td class="QDVACol2">Số Quyết định<asp:Literal ID="ltSoQD" runat="server"></asp:Literal></td>
                            <td>
