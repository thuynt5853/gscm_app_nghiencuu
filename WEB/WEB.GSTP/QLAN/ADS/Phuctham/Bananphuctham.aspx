<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Bananphuctham.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Phuctham.Bananphuctham" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="boder" style="padding: 10px;">
                ...
                <table class="table1">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:DropDownList ID="ddlQuanhephapluat" CssClass="chosen-select" runat="server" Width="450px" AutoPostBack="True" OnSelectedIndexChanged="ddlQuanhephapluat_SelectedIndexChanged" Visible="false"></asp:DropDownList>
                            ...
                            <div class="boxchung">
                                ...
                                <div class="boder" style="padding: 10px;">
                                    <table class="table1">
                                        ...
                                        <tr>
                                            <td style="width: 140px;">Áp dụng án lệ?<span class="batbuoc">(*)</span></td>
                                        ...
                                        <tr>
                                            <td style="width: 125px;">Vụ án quá hạn luật định<span class="batbuoc">(*)</span></td>
                                            <td style="width: 195px;">
                                        ...
                                        <asp:Panel ID="pnNguyenNhanQuaHan" runat="server" Visible="false">
                                            <tr>
                                                <td>Nguyên nhân chủ quan<span class="batbuoc">(*)</td>
                                                <td>
                                                ...
                                                <td>Nguyên nhân khách quan<span class="batbuoc">(*)
                                                </td>
                                                <td>
            ...
            <div class="box_nd">
                <div class="boxchung">
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <asp:Panel ID="pnQDDinhChiPT" runat="server" Visible="true">
                                <tr>
                                    <td style="width: 125px;"></td>
                                    <td colspan="3">
                                        <asp:RadioButtonList ID="QDDinhChiPT" AutoPostBack="true"
                                            runat="server" RepeatDirection="Horizontal"
                                            OnSelectedIndexChanged="rdQDDinhChi_SelectedIndexChanged">
                                            <asp:ListItem Value="1">Thẩm phán</asp:ListItem>
                                            <asp:ListItem Value="2">Hội đồng xét xử</asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                            ...
                            <asp:Panel ID="QDDinhChi" runat="server" Visible="true">
                                <asp:Panel ID="pnNgayMoPhienToa" runat="server" Visible="false">
                                    <tr>
                                        ...
                                        <td class="QDVACol2">
                                            ...
                                            <cc1:calendarextender id="CalendarExtender4" runat="server" targetcontrolid="txtNgayMoPhienToa" format="dd/MM/yyyy" enabled="true" />
                                            <cc1:maskededitextender id="MaskedEditExtender4" runat="server" targetcontrolid="txtNgayMoPhienToa" mask="99/99/9999" masktype="Date" culturename="vi-VN" errortooltipenabled="true" />
                                        </td>
                                ...
                                <asp:Panel ID="pnCBQD" runat="server">
                                    <tr>
                ...
                <asp:Panel ID="pnChiTieuThongKe" runat="server">
                    <div class="boxchung">
                        ...
                        <div class="boder" style="padding: 10px;">
                            <table class="table1">
                                ...
                                <tr>
                                    <td>VKS có kháng nghị nhưng không được chấp nhận<span class="batbuoc">(*)</span></td>
                                    <td>
                                        <asp:RadioButtonList ID="rdVKSCoKNQD" runat="server" RepeatDirection="Horizontal">
                                            <asp:ListItem Value="0">Không</asp:ListItem>
                                            <asp:ListItem Value="1">Có</asp:ListItem>
                                        </asp:RadioButtonList></td>

                                    <td style="width: 135px;">VKS rút kháng nghị nhưng đương sự không rút kháng cáo<span class="batbuoc">(*)</span></td>
                                    <td>
                                        <asp:RadioButtonList ID="rdVKSRutKNQD" runat="server" RepeatDirection="Horizontal">
                                            <asp:ListItem Value="0">Không</asp:ListItem>
                                            <asp:ListItem Value="1">Có</asp:ListItem>
                                        </asp:RadioButtonList>
                       ...
                       <td style="width: 195px;">
                           <asp:RadioButtonList ID="rdVuAnQuaHanQD" AutoPostBack="true"
                               runat="server" RepeatDirection="Horizontal"
                               OnSelectedIndexChanged="rdVuAnQuaHan_SelectedIndexChanged">
                               <asp:ListItem Value="0">Không</asp:ListItem>
                               <asp:ListItem Value="1">Có</asp:ListItem>
                                    ...
                                    <asp:Panel ID="pnHoaGiaiThanh" runat="server">
                                        <td style="width: 140px;">Tòa án tổ chức Hòa giải thành?</td>
                                        <td>
                                ...
                                <%--   <asp:Panel ID="pnNguyenNhanQuaHanQD" runat="server" Visible="false">
                       <tr>
                           <td>Nguyên nhân chủ quan</td>
                           <td>
                               <asp:RadioButtonList ID="rdNNChuQuanQD" runat="server" RepeatDirection="Horizontal">
                                   <asp:ListItem Value="0">Không</asp:ListItem>
                                   <asp:ListItem Value="1">Có</asp:ListItem>
                               </asp:RadioButtonList>
                           </td>
                           ...
                           <td>
                               <asp:RadioButtonList ID="rdNNKhachQuanQD" runat="server" RepeatDirection="Horizontal">
                                   <asp:ListItem Value="0">Không</asp:ListItem>
                                   <asp:ListItem Value="1">Có</asp:ListItem>
                               </asp:RadioButtonList>
                           </td>
    ...
    <script type="text/javascript">
        ...
        if (!CheckChangeRadioButtonList(rdbVKSThamgiaQD, 'Chưa chọn "Có VKS tham gia?". Hãy chọn lại!'))
            return false;
        var rdVKSCoKNQD = document.getElementById('<%=rdVKSCoKNQD.ClientID%>');
        if (!CheckChangeRadioButtonList(rdVKSCoKNQD, 'Chưa chọn "VKS có kháng nghị nhưng không được chấp nhận". Hãy chọn lại!'))
            return false;
        var rdVKSRutKNQD = document.getElementById('<%=rdVKSRutKNQD.ClientID%>');
        if (!CheckChangeRadioButtonList(rdVKSRutKNQD, 'Chưa chọn "VKS rút kháng nghị nhưng đương sự không rút kháng cáo". Hãy chọn lại!'))
            return false;
        var rdqHoaGiaiThanhQD = document.getElementById('<%=rdqHoaGiaiThanhQD.ClientID%>');
            if (!CheckChangeRadioButtonList(rdqHoaGiaiThanhQD, 'Chưa chọn "Tòa án tổ chức Hòa giải thành?". Hãy chọn lại!'))
                return false;
        }
        ...
        if (val == 0) {
            alert('Bạn chưa chọn lý do bản án. Hãy chọn lại!');
            ddlLyDoBanAn.focus();
            return false;
        }
        ...
        val = ddlYeutonuocngoai.options[ddlYeutonuocngoai.selectedIndex].value;
        if (val == 0) {
            alert("Bạn chưa chọn Yếu tố nước ngoài. Hãy chọn lại!");
        ...
        if (!CheckChangeRadioButtonList(rdbVKSThamgia, "Chưa chọn có/không VKS tham gia!"))
            return false;

        //VKS có kháng nghị nhưng không được chấp nhận
        var rdVKSCoKN = document.getElementById('<%=rdVKSCoKN.ClientID%>');
        if (!CheckChangeRadioButtonList(rdVKSCoKN, "Chưa chọn có/không VKS có kháng nghị nhưng không được chấp nhận!"))
            return false;

        //VKS rút kháng nghị nhưng đương sự không rút kháng cáo
        var rdVKSRutKN = document.getElementById('<%=rdVKSRutKN.ClientID%>');
        if (!CheckChangeRadioButtonList(rdVKSRutKN, "Chưa chọn có/không VKS rút kháng nghị nhưng đường sự không rút kháng cáo!"))
            return false;

        //Vụ án quá hạn luật định
        var rdVuAnQuaHan = document.getElementById('<%=rdVuAnQuaHan.ClientID%>');
        if (!CheckChangeRadioButtonList(rdVuAnQuaHan, "Chưa chọn có/không vụ án quá hạn luật định!"))
            return false;
        var pnNguyenNhanQuaHan = document.getElementById('<%=pnNguyenNhanQuaHan.ClientID%>');
        if (!pnNguyenNhanQuaHan || pnNguyenNhanQuaHan.style.display === "none" || pnNguyenNhanQuaHan.offsetParent === null) {

        }
        else {
            var rdNNChuQuan = document.getElementById('<%=rdNNChuQuan.ClientID%>');
            if (!CheckChangeRadioButtonList(rdNNChuQuan, "Chưa chọn có/không nguyên nhân chủ quan!"))
                return false;
            var rdNNKhachQuan = document.getElementById('<%=rdNNKhachQuan.ClientID%>');
            if (!CheckChangeRadioButtonList(rdNNKhachQuan, "Chưa chọn có/không nguyên nhân khách quan!"))
                return false;
        }
        ...
        function CheckKyso() {
          <%--  var chkKySo = document.getElementById('<%=chkKySo.ClientID%>');
            if (chkKySo.checked) {
                ...
                document.getElementById("zonekythuong").style.display = "block";
            }--%>
        }
