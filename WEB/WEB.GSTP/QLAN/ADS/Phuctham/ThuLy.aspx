<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="ThuLy.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Phuctham.ThuLy" %>
                    ...
                    <table class="table1">
                        <tr>
                            ...
                            <td style="width: 265px;">
                                <asp:DropDownList ID="ddlLoaiThuLy" CssClass="chosen-select" runat="server" Width="250px"></asp:DropDownList>
                            </td>
