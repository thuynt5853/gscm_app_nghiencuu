    ...
    public partial class Bananphuctham : System.Web.UI.Page
    {
        ...
        bool CheckCongbo(decimal ID)
        {
            var list = DataExtensions.GetAllWithClause<BAQD_CONGBO>(
                $"VUVIECID = {ID} AND LOAIANID = {ENUM_LOAIVUVIEC_NUMBER.AN_DANSU} AND CAPXETXU = 3 AND TRANGTHAI IN (2,3)"
            );
        ...
        void CheckQuyen()
        {
            ...
            List<ADS_PHUCTHAM_QUYETDINH> lstQD = dt.ADS_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DONID && (x.LOAIQDID == 10 || x.QUYETDINHID == 423 || x.QUYETDINHID == 422 || x.LOAIQDID == 3 || x.QUYETDINHID == 212 || x.QUYETDINHID == 213 )).ToList();
            if (lstQD.Count >= 1)
            {
                pnQDVV.Visible = true;
            ...
            List<ADS_PHUCTHAM_HDXX> lstTPCT = dt.ADS_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).ToList();
            if (lstTPCT.Count == 0)
            {
                lstErr.Text = lbthongbaoQD.Text = "Chưa phân công thẩm phán giải quyết !";
                Cls_Comon.SetButton(cmdUpdate, false);
            ...
            ADS_CHUYEN_NHAN_AN oChuyenAn = dt.ADS_CHUYEN_NHAN_AN.Where(x => x.VUANID == DONID).OrderByDescending(x => x.NGAYTAO).FirstOrDefault();
            ...
            ADS_TONGDAT td = dt.ADS_TONGDAT.Where(x => x.DONID == DONID && (x.BIEUMAUID == 261)).FirstOrDefault();// vnpt -- xoá check biểu mẫu sơ thẩm đã tống đạt trên phúc thẩm
            if (td != null)
            {
            ...
            ADS_PHUCTHAM_QUYETDINH oQD = dt.ADS_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DONID && x.LOAIQDID == 5
            ...
            isExist = ads.IsExistKHOBADQ(1, DONID, 3, ENUM_LOAIVUVIEC_TEXT.AN_DANSU);
            if (isExist)
            {
                lstErr.Text = lbthongbaoQD.Text = "Vụ việc đã được đồng bộ. Phải thu hồi đồng bộ trước khi chỉnh sửa/xóa";
                Cls_Comon.SetButton(cmdUpdate, false);
        ...
        protected void cmdUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                decimal DONID = Convert.ToDecimal(hddDonID.Value);
                if (!CheckValid() || !CheckCongbo(DONID))
                    return;
                ...
                } else
                {
                    ...
                    ADS_TONGDAT oTD1 = dt.ADS_TONGDAT.Where(x => x.DONID == oND.DONID && x.MAPID == oND.ID && x.MAP_TABLE == ENUM_MAP_TABLE.ADS_PHUCTHAM_BANAN).FirstOrDefault();
                    if (oTD1 != null)
                    {
                ...
                //GTEL-HUNGQ 22-10-2025 Check neu da chia sẻ dữ liệu không được xóa
                KHOBAQD_BL ads = new KHOBAQD_BL();
                bool isExist = ads.IsExistKHOBADQ(0, DONID, 3, ENUM_LOAIVUVIEC_TEXT.AN_DANSU);
                if (isExist)
                {
                    lstErr.Text = lbthongbaoQD.Text = "Vụ việc đã được đồng bộ. Phải thu hồi đồng bộ trước khi chỉnh sửa/xóa";
                    return;
            ...
            try
            {
                if (AsyncFileUpLoad.HasFile && dgFile.Items.Count < 1)
                {
                    ...
                    if (extension == ".doc" || extension == ".docx" || extension == ".pdf")
                    {
                        ...
                        lbthongbao.Text = "chỉ lưu file .doc";
                }
                else 
                    lbthongbao.Text = "Chỉ được chọn 1 file.";
            }
        ...
        protected void cmdHuyBanAn_Click(object sender, EventArgs e)
        {
            ...
            {
                // khong duoc xoa khi da Tong dat - 27/11/2025 vnpt check
                ADS_TONGDAT oTD2 = dt.ADS_TONGDAT.Where(x => x.DONID == banan.DONID && x.MAPID == banan.ID && x.MAP_TABLE == ENUM_MAP_TABLE.ADS_PHUCTHAM_BANAN).FirstOrDefault();
                if (oTD2 != null)
                {
                ...
                {
                    lstErr.Text = "Xóa Bản án Phúc thẩm không thành công!";
                    return;
                }//Ket thuc 
            ...
            ADS_FILE file = dt.ADS_FILE.Where(x => x.DONID == DONID && x.BIEUMAUID == BieuMauID && x.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM).FirstOrDefault();
            if (file != null)
            {
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.DGLIST_BAQD_QUYETDINH_KETTHUC_PT(ENUM_LOAIVUVIEC_NUMBER.AN_DANSU, ID);
            if (oDT != null)
            {
        ...
        private void LoadQD()
        {
            ...
            DM_QUYETDINH_VUAN_KETTHUC oBL = new DM_QUYETDINH_VUAN_KETTHUC();
            DataTable oDT = oBL.DM_QUYETDINH_VUAN_PHUCTHAM_KETTHUC(ENUM_LOAIVUVIEC_NUMBER.AN_DANSU);
        ...
        private void ResetControls()
        {
            ...
            //rdVuAnQuaHanQD.ClearSelection();
            //rdNNChuQuanQD.ClearSelection();
            //rdNNKhachQuanQD.ClearSelection();
            pnChiTieuThongKe.Visible = false;
        ...
        protected void btnLammoi_Click(object sender, EventArgs e)
        {
            ...
            List<ADS_PHUCTHAM_QUYETDINH> lstQD = dt.ADS_PHUCTHAM_QUYETDINH.Where(x => x.DONID == ID && (x.LOAIQDID == 10 || x.QUYETDINHID == 423 || x.QUYETDINHID == 422 || x.LOAIQDID == 3)).ToList();
            if (lstQD.Count >= 1)
            {
                Cls_Comon.SetButton(btnUpdate, false);
            }
        ...
        {
            ADS_PHUCTHAM_QUYETDINH oND = dt.ADS_PHUCTHAM_QUYETDINH.Where(x => x.ID == id).FirstOrDefault();
            
            TK_PHUCTHAM_QUYETDINH TK = DataExtensions.GetAllWithClause<TK_PHUCTHAM_QUYETDINH>($"QUYETDINHID = {id} AND LOAIAN = {Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_DANSU)}").FirstOrDefault();
            if (TK != null)
            {
            ...
            if (oND != null)
            {
                decimal FileID = 0;
                if (oND.FILEID != null) 
                    FileID = (decimal)oND.FILEID;

                dt.ADS_PHUCTHAM_QUYETDINH.Remove(oND);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                decimal DONID = Convert.ToDecimal(hddDonID.Value);
                if (!CheckValidQDVV() || !CheckCongbo(DONID)) 
                    return;

                //GTEL-HUNGNQ 07-10-2025 Dữ liệu Bản án đã được chia sẻ không được xóa
                KHOBAQD_BL oDonBL = new KHOBAQD_BL();
                bool isExist = oDonBL.IsExistKHOBADQ(1, DONID, 3,ENUM_LOAIVUVIEC_TEXT.AN_DANSU);
                if (isExist)
                {
                    lbthongbaoQD.Text = "Vụ việc đã được đồng bộ. Phải thu hồi đồng bộ trước khi chỉnh sửa/xóa";
                    return;
                }
                //END
                ...
                ADS_PHUCTHAM_QUYETDINH oND;
                TK_PHUCTHAM_QUYETDINH TK = new TK_PHUCTHAM_QUYETDINH();
                decimal STTQD = 0;
                if ((hddid.Value == "" || hddid.Value == "0"))
                {
                    oND = new ADS_PHUCTHAM_QUYETDINH();
                    ADS_DON_BL oBL = new ADS_DON_BL();
                ...
                else
                {
                    ...
                    TK = DataExtensions.GetAllWithClause<TK_PHUCTHAM_QUYETDINH>($"QUYETDINHID= {ID} AND LOAIAN =  {Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_DANSU)} AND DONID = {DONID}").FirstOrDefault();
                    oND = dt.ADS_PHUCTHAM_QUYETDINH.Where(x => x.ID == ID).FirstOrDefault();
                    if (oND.TOAANID.ToString() != Session[ENUM_SESSION.SESSION_DONVIID].ToString())
                    {
                ...
                oND.DONID = DONID;
                oND.TOAANID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                oND.TOA_GIAIQUYET_ID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]); // 2025-07-29 Thêm thông tin toà giải quyết
                ...
                if (!ddlQuyetdinh.SelectedItem.Text.Contains("72-DS"))
                {
                    ...
                    if (ddlQuyetdinh.SelectedItem.Text.Contains("70-DS") || ddlQuyetdinh.SelectedItem.Text.Contains("69-DS"))
                    {
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    oND.NGUOITAO = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                    oND.TOA_GIAIQUYET_ID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                    dt.ADS_PHUCTHAM_QUYETDINH.Add(oND);
                    dt.SaveChanges();
        ...
        protected void AsyncFileUpLoad_UploadedCompleteQD(object sender, AjaxControlToolkit.AsyncFileUploadEventArgs e)
        {
            try
            {
                if (AsyncFileUpLoadQD.HasFile && dgFile.Items.Count < 1)
                {
                    ...
                    lbthongbaoQD.Text = "Chỉ được chọn 1 file.";
            }
        ...
        private decimal UploadFileID(ADS_DON oDon, decimal FileID, string strMaBieumau, decimal STT)
        {
            ...
            if (STT != 0) 
                objFile.STT = Convert.ToDecimal(STT);
            if (FileID == 0)
        ...
        public void loadedit(decimal ID)
        {
            ...
            if (TK.TK_ISVKSCOKN_KDCN != null)
                rdVKSCoKNQD.SelectedValue = TK.TK_ISVKSCOKN_KDCN.ToString();
            if (TK.TK_ISVKSRUTKN_DSKR != null)
                rdVKSRutKNQD.SelectedValue = TK.TK_ISVKSRUTKN_DSKR.ToString();
            if (TK.ISVKSTHAMGIA != null)
                rdbVKSThamgiaQD.SelectedValue = TK.ISVKSTHAMGIA.ToString();
            if (TK.ISHOAGIAITHANH != null)
                rdqHoaGiaiThanhQD.SelectedValue = TK.ISHOAGIAITHANH.ToString();
            if (TK.YEUTONUOCNGOAI != null)
                ddlYeutonuocngoaiQD.SelectedValue = TK.YEUTONUOCNGOAI.ToString();
            ...
            if (oND.NGAYMOPT != null)
                txtNgayMoPhienToaQD.Text = ((DateTime)oND.NGAYMOPT).ToString("dd/MM/yyyy", cul);

            if (oND.HIEULUCTU != null)
                txtHieuLucTuNgay.Text = ((DateTime)oND.HIEULUCTU).ToString("dd/MM/yyyy", cul);
            if (oND.HIEULUCDEN != null)
                txtHieuLucDenNgay.Text = ((DateTime)oND.HIEULUCDEN).ToString("dd/MM/yyyy", cul);
        ...
        private void SetEnable_data_QD(ADS_PHUCTHAM_QUYETDINH QD)
        {
            if (QD != null)
            {
                // khong duoc sửa khi da Tong dat nhưng cho phép nhập thêm những trường trống -27 / 11 / 2025 vnpt check
                ADS_TONGDAT oTD = dt.ADS_TONGDAT.Where(x => x.DONID == QD.DONID && x.MAPID == QD.ID && x.MAP_TABLE == ENUM_MAP_TABLE.ADS_PHUCTHAM_BANAN).FirstOrDefault();
                if (oTD != null)
                {
                    if (QD.QHPLTKID != null)
                    {
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                case "Download":
                    var oND = dt.ADS_PHUCTHAM_QUYETDINH.Where(x => x.DONID == ID).FirstOrDefault();
                    if (oND.TENFILE != "")
                    {
                        var cacheKey = Guid.NewGuid().ToString("N");
                ...
                case "Sua":
                    ...
                    hddFilePathQD.Value = "";
                    lbthongbaoQD.Text = "";
                    //ADS_PHUCTHAM_QUYETDINH oND3 = dt.ADS_PHUCTHAM_QUYETDINH.Where(x => x.ID == ND_id).FirstOrDefault();
                    // khong duoc xoa khi da Tong dat - 27/11/2025 vnpt check
                    //ADS_TONGDAT oTD2 = dt.ADS_TONGDAT.Where(x => x.DONID == oND3.DONID && x.MAPID == oND3.ID && x.MAP_TABLE == ENUM_MAP_TABLE.ADS_PHUCTHAM_QUYETDINH).FirstOrDefault();
                    //if (oTD2 != null)
                    //{
                ...
                case "Xoa":
                    ...
                    ADS_PHUCTHAM_QUYETDINH oND2 = dt.ADS_PHUCTHAM_QUYETDINH.Where(x => x.ID == ND_id).FirstOrDefault();
                    // khong duoc xoa khi da Tong dat - 27/11/2025 vnpt check
                    ADS_TONGDAT oTD1 = dt.ADS_TONGDAT.Where(x => x.DONID == oND2.DONID && x.MAPID == oND2.ID && x.MAP_TABLE == ENUM_MAP_TABLE.ADS_PHUCTHAM_QUYETDINH).FirstOrDefault();
                    if (oTD1 != null)
                    {
                        lbthongbaoQD.Text = "Bạn không thể xóa khi đã tống đạt!";
                        return;
                    }
                    //GTEL-HUNGNQ 07-10-2025 Dữ liệu Quyết định đã được chia sẻ không được xóa
                    KHOBAQD_BL oDonBL = new KHOBAQD_BL();
                    bool isExist = oDonBL.IsExistKHOBADQ(1, ID, 3,ENUM_LOAIVUVIEC_TEXT.AN_DANSU);
                    if (isExist)
                    {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                decimal DONID = Convert.ToDecimal(hddDonID.Value);
                ADS_PHUCTHAM_QUYETDINH oT = dt.ADS_PHUCTHAM_QUYETDINH.Where(x => x.ID == DONID).FirstOrDefault();
        ...
        protected void ddlQuyetdinh_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (btnUpdate.Enabled == true)
            {
                ...
                {
                    ADS_PHUCTHAM_QUYETDINH oQD = dt.ADS_PHUCTHAM_QUYETDINH.Where(x => x.DONID == IDD && x.LOAIQDID == 5 && x.QUYETDINHID != 147 && x.QUYETDINHID != 148 /*Quyết định chuyển vụ án giải quyết theo thủ tục rút gọn sang giải quyết theo thủ tục thông thường*/).FirstOrDefault();
                    if (oQD == null)
                    {
            ...
            pnVKSThamGia.Visible = !ddlQuyetdinh.SelectedItem.Text.Contains("69-DS");
        }
        ...
        private void LoadDropKetQuaQuyetdinhPhuctham()
        {
            ...
            {
                ddlKetquaQuyetdinh.Items.Clear();
                ddlKetquaQuyetdinh.DataSource = dt.DM_KETQUA_PHUCTHAM.Where(x => x.ISADS == 1 && x.ISBANAN == 1 && x.MA != "13" && x.MA != "14" && x.MA != "18").OrderBy(y => y.THUTU).ToList();
                ddlKetquaQuyetdinh.DataTextField = "TEN";
                ddlKetquaQuyetdinh.DataValueField = "ID";
                ddlKetquaQuyetdinh.DataBind();
                ddlKetquaQuyetdinh.Items.Insert(0, new ListItem("--- Chọn ---", "0"));
