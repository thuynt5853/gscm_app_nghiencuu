    ...
    public partial class Giaiquyetdon : System.Web.UI.Page
    {
        ...
        private void CheckQuyen(decimal DONID)
        {
            ...
            if (objCN != null)
            {
                ...
                if (oldDonXuLy == null)
                {
                    lbthongbao.Text = "Án được chuyển đến, không được sửa đổi!";
                    Cls_Comon.SetButton(cmdUpdate, false);
                    Cls_Comon.SetButton(cmdLammoi, false);
                    hddShowCommand.Value = "False";
                    return;
        ...
        private void LoadCombobox(decimal toaID)
        {
            ...
            DataTable oCBDT = oDMCBBL.DM_CANBO_GETBYDONVI_CHUCDANH(toaID, ENUM_CHUCDANH.CHUCDANH_THAMPHAN);
            ...
            ddlNguoiphancong.DataSource = oDMCBBL.DM_CANBO_GETBYDONVI_2CHUCVU(toaID, ENUM_CHUCVU.CHUCVU_CA, ENUM_CHUCVU.CHUCVU_PCA);
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.ADS_DON_THAMPHAN_GETBY(ID, ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETDON);
        ...
        public void xoa(decimal id)
        {
            ...
            ADS_DON_XULY xld = dt.ADS_DON_XULY.Where(x => x.DONID == oND.DONID).FirstOrDefault();
            ...
            if (oBL.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oND.DONID), 2, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Thẩm phán giải quyết đơn Dân sự", "Xóa", json) == false)
            {
                lbthongbao.Text = "Xóa không thành công!";
                return;
            }//Ket thuc
            //Xoa Tham phan giai quyet don
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ADS_DON_XULY oXL = dt.ADS_DON_XULY.Where(x => x.DONID == DONID || x.DON_XULYID == DONID).FirstOrDefault();
                if (oXL != null)
                {
                    lbtXoa.Visible = false;
                }
