<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Giaiquyetdon.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Thamphan.Giaiquyetdon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNgayphancong" runat="server" CssClass="user" Width="110px" MaxLength="10" AutoPostBack="True" OnTextChanged="txtNgayphancong_TextChanged"></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        function ValidData() {
            ...
            if ((Common_CheckEmpty(txtNhanphancong.value)) && (Common_CheckEmpty(txtNhanphancong.value))) {
                var ngayphancong = txtNgayphancong.value;
                if (!SoSanh2Date(txtNhanphancong, 'Ngày nhận phân công', ngayphancong, 'Ngày phân công'))
                    return false;
            }
            //------------------------------------
