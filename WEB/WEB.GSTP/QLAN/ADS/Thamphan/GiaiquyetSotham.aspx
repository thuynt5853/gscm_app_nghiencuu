<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="GiaiquyetSotham.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Thamphan.GiaiquyetSotham" %>
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNhanphancong" runat="server" CssClass="user" Width="110px" MaxLength="10" 
                                    AutoPostBack="true" OnTextChanged="txtNhanphancong_TextChanged"></asp:TextBox>
