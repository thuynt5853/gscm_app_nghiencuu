    ...
    public partial class GiaiquyetPhuctham : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataTable oDT = oBL.DGLIST_BAQD_QUYETDINH_KETTHUC_PT(ENUM_LOAIVUVIEC_NUMBER.AN_DANSU, DONID);
                if (oDT.Rows.Count > 0)
                {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ADS_PHUCTHAM_HDXX hdxx = dt.ADS_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).FirstOrDefault();
                ADS_PHUCTHAM_QUYETDINH qd = dt.ADS_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).FirstOrDefault();
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.ADS_DON_THAMPHAN_GETBY(ID, ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETPHUCTHAM);
        ...
        public void xoa(decimal id)
        {
            ...
            if (oND != null)
            {
                ...
                if (oBL.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oND.DONID), 2, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Phân công thẩm phán giải quyết Phúc thẩm Dân sự", "Xóa", json) == false)
                {
                ...
                ADS_PHUCTHAM_THAMGIATOTUNG ADS_PHUCTHAM_THAMGIATOTUNG = dt.ADS_PHUCTHAM_THAMGIATOTUNG.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).FirstOrDefault<ADS_PHUCTHAM_THAMGIATOTUNG>();
                if (ADS_PHUCTHAM_THAMGIATOTUNG != null)
                {
                    lbthongbao.Text = "Xóa không thành công! Do đang tồn tại người tham gia tố tụng.";
                    return;
                }
                ADS_PHUCTHAM_HDXX ADS_PHUCTHAM_HDXX = dt.ADS_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).FirstOrDefault<ADS_PHUCTHAM_HDXX>();
                if (ADS_PHUCTHAM_HDXX != null)
                {
                    lbthongbao.Text = "Xóa không thành công! Do đang tồn tại thông tin người tiến hành tố tụng.";
                    return;
                }
                ADS_PHUCTHAM_HOAGIAI ADS_PHUCTHAM_HOAGIAI = dt.ADS_PHUCTHAM_HOAGIAI.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).FirstOrDefault<ADS_PHUCTHAM_HOAGIAI>();
                if (ADS_PHUCTHAM_HOAGIAI != null)
                {
                    lbthongbao.Text = "Xóa không thành công! Do đang tồn tại thông tin hòa giải.";
                    return;
                }
                ADS_PHUCTHAM_QUYETDINH ADS_PHUCTHAM_QUYETDINH = dt.ADS_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).FirstOrDefault<ADS_PHUCTHAM_QUYETDINH>();
                ...
                //Xoa Phan cong Tham phan Phuc Tham
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            //ADS_PHUCTHAM_HDXX hdxx = dt.ADS_PHUCTHAM_HDXX.Where(x => x.DONID == DonID).FirstOrDefault();
            //ADS_PHUCTHAM_QUYETDINH qd = dt.ADS_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DonID).FirstOrDefault();
        ...
        private bool CheckQDofThamPhan(decimal DonID,decimal TPID)
        {
            ...
            ADS_PHUCTHAM_QUYETDINH obj_QD = dt.ADS_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DonID && x.NGUOIKYID == TPID).FirstOrDefault<ADS_PHUCTHAM_QUYETDINH>();
            if (obj_QD != null)
            {
