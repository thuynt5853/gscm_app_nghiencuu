<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="KhangCaoKhangNghi.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Sotham.KhangCaoKhangNghi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <table class="table1">
                    <tr>
                        <td colspan="2" style="text-align: center">
                            <asp:Button ID="btnUpdate" runat="server"  CssClass="buttoninput" Text="Lưu"
    ...
    <script type="text/javascript">
        ...
        function validate_khangcao() {
            ...
            msg = 'Mục "Miễn án phí" chưa được chọn. Hãy kiểm tra lại!';
        ...
        function popup_loaddonkc_bc(DonID, NGUOIKC) {
            var link = "/QLAN/ADS/Sotham/Popup/pChonDonKC.aspx?ID=" + DonID + "&KCID=" + NGUOIKC;
            var width = 800;
            var height = 900;
