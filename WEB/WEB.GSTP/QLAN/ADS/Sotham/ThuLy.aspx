<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="ThuLy.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Sotham.ThuLy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="box_nd">
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            ...
                            <td style="width: 265px;">
                                <asp:DropDownList ID="ddlLoaiThuLy" CssClass="chosen-select" runat="server" Width="250px">
                                    ...
                                    <%--  <asp:ListItem Value="2" Text="Thụ lý từ Tòa án khác chuyển đến"></asp:ListItem>--%>
                                    <asp:ListItem Value="3" Text="Thụ lý xét xử lại do PT hủy"></asp:ListItem>
                                    <asp:ListItem Value="4" Text="Thụ lý xét xử lại do GDT hủy"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        ...
                        <tr>
                            <td>Nguyên đơn đại diện<span class="batbuoc">(*)</span></td>
                            <td>
                                <asp:DropDownList ID="ddlNguyenDon" CssClass="chosen-select" runat="server" Width="250px"></asp:DropDownList>
                            </td>
                            <td>Bị đơn đại diện<span class="batbuoc">(*)</span></td>
                            <td>
                                <asp:DropDownList ID="ddlBiDon" CssClass="chosen-select" runat="server" Width="250px"></asp:DropDownList>
                            </td>
            ...
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            <td style="width: 125px;">Ngày thông báo<span class="batbuoc">(*)</span></td>
                            ...
                            <td style="width: 162px;">Số thông báo<span class="batbuoc">(*)</span></td>
                            <td>
    ...
    <div class="boxchung">
        <h4 class="tleboxchung">Cập nhật thông tin đương sự</h4>
        <div class="boder" style="padding: 10px;">
            <table class="table1">
                <tr>
                    <td>
                        <asp:DataGrid ID="dgDuongSu" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            PageSize="20" AllowPaging="false" GridLines="None" PagerStyle-Mode="NumericPages"
                            CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
                            ItemStyle-CssClass="chan" Width="100%" OnItemDataBound="dgList_ItemDataBoundDuongSu">
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderStyle-Width="90px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtNgaySinh" runat="server" Text='<%# GetTextDate(Eval("NGAYSINH"))%>' CssClass="user" Width="90px" MaxLength="10"></asp:TextBox>
                                        <cc1:CalendarExtender ID="Calendar1" runat="server" TargetControlID="txtNgaySinh" Format="dd/MM/yyyy" />
                                        <cc1:MaskedEditExtender ID="txtNgaySinh_MaskedEditExtender3" runat="server" TargetControlID="txtNgaySinh" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" />
                                        <asp:TextBox Visible="false" ID="txtND_Namsinh" CssClass="user" onkeypress="return isNumber(event)" runat="server" Width="35px" MaxLength="4" AutoPostBack="true"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lstMsgDuongSu" runat="server" ForeColor="Red"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="center">
                        <asp:Button ID="cmdDuongSu" runat="server" CssClass="buttoninput"
                            Text="Lưu" OnClick="cmdDuongSu_Click" />
                    </td>
                </tr>
            </table>
        </div>
