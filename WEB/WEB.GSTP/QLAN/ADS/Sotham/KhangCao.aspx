<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="KhangCao.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Sotham.KhangCao" %>
        ...
        <div class="box_nd">
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            <td style="width: 115px;">Hình thức nhận đơn<span class="batbuoc">(*)</span></td>
                            <td style="width: 305px;">
                                <asp:RadioButtonList ID="rdbHinhthucnhan" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="1" Text="Trực tiếp" Selected="True"></asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td>KC quá hạn<span class="batbuoc">(*)</span></td>
                            <td>
