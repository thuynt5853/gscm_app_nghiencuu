<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="QuyetdinhVuviec.aspx.cs" Inherits="WEB.GSTP.QLAN.ADS.Sotham.QuyetdinhVuviec" %>
                    ...
                    <table class="table1">
                        ...
                        <tr>
                          ...
                          <tr>
                              ...
                              <td>Giờ</td>
                              <td class="QDVACol1">
                                  <asp:TextBox ID="txtGio" runat="server" CssClass="user" TextMode="Time" Width="100px"/>
                                  <%--<cc1:maskededitextender id="MaskedEditExtenderTime" runat="server"
                                      targetcontrolid="txtGio"
                                      mask="99:99"
                                      masktype="Time"
                                      culturename="vi-VN"
                        ...
                        <asp:Panel ID="pnQHPL" Visible="false" runat="server">
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:DropDownList ID="ddlQHPLTK" CssClass="chosen-select" runat="server" Width="650px"></asp:DropDownList>
                                </td>
                            </tr>
                        </asp:Panel>
                        <tr>
                        ...
                        <asp:Panel ID="pnDuongSuYC" runat="server" Visible="true">
                            <tr>
                                <td>Người yêu cầu</td>
                                <td>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hdTenQD" runat="server" Value='<%# Eval("TenQD") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
