<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="QuyetDinh.aspx.cs" Inherits="WEB.GSTP.QLAN.HOAGIAI.QuyetDinh" %>
        ...
        <div class="box_nd">
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <asp:TextBox ID="txtQuyetDinhId" runat="server" Visible="false" />
                        <tr>
                            ...
                            <td class="Col2">
                                ...
                                <cc1:MaskedEditValidator ID="MaskedEditValidator1" runat="server" ControlExtender="MaskedEditExtender1" ControlToValidate="txtNgayHoaGiai" InvalidValueMessage="dd/MM/yyyy" Style="color: red; margin-left: 15px;"></cc1:MaskedEditValidator>
                            </td>
                        ...
                        <tr>
                            <td class="Col1">Kết quả quyết định công nhận <%=hoagiaitext%> thành<span class="batbuoc">(*)</span></td>
                            <td colspan="3">
                                <asp:DropDownList ID="dllKetQua" CssClass="chosen-select Drop3Col d-validator-required" runat="server" AutoPostBack="True" OnSelectedIndexChanged="dllKetQua_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="Col1">Tên quyết định<span class="batbuoc">(*)</span></td>
                            <td colspan="3">
                                <asp:DropDownList ID="dllTenQuyetDinh" CssClass="chosen-select Drop3Col d-validator-required" runat="server" AutoPostBack="False">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <asp:Panel ID="pnLyDoKhongCongNhan" runat="server" Visible="false">
                            <tr>
                                <td class="Col1">Lý do</td>
                                <td colspan="3">
                                    <asp:TextBox ID="txtLyDoKhongCongNhan" CssClass="user" runat="server" Width="660px" MaxLength="500" TextMode="MultiLine" Rows="2"></asp:TextBox>
                                </td>
                            </tr>
                        </asp:Panel>
                        <tr>
                            ...
                            <td class="Col3">Chức vụ</td>
                            <td>
                                <asp:TextBox ID="txtChuVu" CssClass="user" Enabled="false" runat="server" Width="242px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr id="radioKetQua" runat="server" visible="false">
                            <td class="Col1">Tình trạng hôn nhân<span class="batbuoc">(*)</span></td>
                            <td colspan="3">
                                <asp:RadioButtonList ID="rdKetQua" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="1">Cho ly hôn</asp:ListItem>
                                    <asp:ListItem Value="3">Không công nhận là vợ chồng</asp:ListItem>
                ...
                <table class="table1">
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <asp:Button ID="btnXoa" runat="server" CssClass="buttoninput" Text="Xoá" OnClick="btnXoa_Click" />
                        </td>
                    </tr>
                    <%--<tr>    
                        <td colspan="2">
                            ...
                            <asp:Panel runat="server" ID="pndata" Visible="true">
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="NGAYHOAGIAI" HeaderText="Ngày diễn ra phiên hoà giải" HeaderStyle-Width="170px" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundColumn>
                                        <asp:TemplateColumn HeaderStyle-Width="300px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>
                                                Kết quả quyết định công nhận <%=hoagiaitext%> thành
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <%#Eval("KETQUATXT") %>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:BoundColumn DataField="SOQUYETDINH" HeaderText="Số QĐ" HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="NGAYQUYETDINH" HeaderText="Ngày QĐ" HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="NGUOIKY_TEN" HeaderText="Người ký" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="TOAAN_TEN" HeaderText="Toà ra QĐ" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="NGUOITAO" HeaderText="Người tạo" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="NGAYTAO" HeaderText="Ngày tạo" HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundColumn>
    ...
    <script>
        ...
        function validate() {
            ...
            if (isPass == false)
                ...
                const rdKQVal = '<%= rdKetQua.ClientID %>';
                const container = document.getElementById(rdKQVal);
                const checkedRadio = container.querySelector('input[type="radio"]:checked');
                if (!checkedRadio) {
                    alert("Hãy chọn tình trạng hôn nhân");
                    return false;
                }
            }
