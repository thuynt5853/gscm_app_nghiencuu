<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Muontrahoso.aspx.cs" Inherits="WEB.GSTP.QLAN.QLHS.Muontrahoso" %>
                        ...
                        <div class="boder" style="padding: 10px;">
                            <table class="table1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlGQ_Thamphan" CssClass="chosen-select" runat="server" Width="220px"></asp:DropDownList>
                                    </td>
                                    <td style="width: 80px;">TP Thành viên 1<span class="batbuoc">(*)</span></td>
                                    <td>
                                        <asp:DropDownList ID="ddlGQ_Thamphan1" CssClass="chosen-select" runat="server" Width="220px"></asp:DropDownList>
                                    </td>
                                    <td style="width: 80px;">TP Thành viên 1<span class="batbuoc">(*)</span></td>
                                    <td>
                                        <asp:DropDownList ID="ddlGQ_Thamphan2" CssClass="chosen-select" runat="server" Width="220px"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
