...
namespace WEB.GSTP.QLAN.AHN.XuLyDon.Popup
{
    public partial class pBoSungTaiLieu : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string current_id = Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH] + "", bienphap = dropBienPhapGQ.SelectedValue;
                ...
                try
                {
                    ...
                    DataTable obj = aDXL.AHN_GETALL_DON_YCBS(Convert.ToDecimal(DONID), xuLyID, 1, 20);
                    ...
                    AHN_DON_XULY donXL = dt.AHN_DON_XULY.Where(x => x.ID == xuLyID).FirstOrDefault();
        ...
        protected void cmdCapNhat_Click(object sender, EventArgs e)
        {
            ...
            decimal xuLyID = (String.IsNullOrEmpty(Request["ID"] + "")) ? 0 : Convert.ToDecimal(Request["ID"] + "");
            AHN_DON_XULY oXuLy = dt.AHN_DON_XULY.Where(x => x.ID == xuLyID).FirstOrDefault();
            string bienphap = dropBienPhapGQ.SelectedValue;
            ...
            DataTable checkGQ = oBLYC.CHECK_NGAYGQ_DON_YCBS(obj.ID, xuLyID, 3, txtNgayGQ.Text);
            ...
            AHN_DON_XULY objXuLy = dt.AHN_DON_XULY.Where(x => x.ID == obj.DON_XULY_YCBS_ID).FirstOrDefault();
            ...
            DataTable oDT = oBLYC.AHN_GETALL_DON_YCBS(DONID, objXuLy.ID, 1, 1);
            ...
            DataTable objYCBS = oBLYC.AHN_GETALL_DON_YCBS(Convert.ToDecimal(DONID), obj.DON_XULY_YCBS_ID.Value, 1, 20);
        ...
        private void ChuyenDonSangToaAnMoi(AHN_DON oDon, decimal DonXyLyID, AHN_DON_XULY obj, decimal ToaAnCuEdit)
        {
            if (DonXyLyID == 0)
            {
                ...
                // an hn
                if (oDonMoi.TOA_GIAIQUYET_ID == null)
            ...
            else
            {
                ...
                if (oDonNew != null)
                {
                    if (oDonNew.TOAANID.Value != obj.CDTN_TOAANID)
                    {
                        ...
                        oDonNew.MAVUVIEC = ENUM_LOAIVUVIEC.AN_HONNHAN_GIADINH + oTA.MA + oDonNew.TT.ToString();
                        dt.SaveChanges();
        ...
        protected void Reset()
        {
            ...
            DataTable donYCBS = oBLYC1.AHN_GETALL_DON_YCBS(Convert.ToDecimal(DONID), xuLyID, 1, 20);
        ...
        protected void dgDS_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Xoa":
                    ...
                    AHN_DON_XULY_BL oBLDel = new AHN_DON_XULY_BL();
                    ...
                    DataTable obj = oBLDel.AHN_GETALL_DON_YCBS(Convert.ToDecimal(DONID), ID_DON_YCBS, 1, 20);
                    if (e.Item.ItemIndex == 0 && obj.Rows.Count > 0)
                    {
                        AHN_DON_XULY objXuLy = dt.AHN_DON_XULY.Where(x => x.ID == ID_DON_YCBS).FirstOrDefault();
                    ...
                    {
                        AHN_DON_XULY objXuLy = dt.AHN_DON_XULY.Where(x => x.ID == ID_DON_YCBS).FirstOrDefault();
                        dt.AHN_DON_XULY.Remove(objXuLy);
                        dt.SaveChanges();
                    }
        ...
        private void validateEnableButton(decimal DONID, decimal DON_YCBSID)
        {
            decimal xuLyID = (String.IsNullOrEmpty(Request["ID"] + "")) ? 0 : Convert.ToDecimal(Request["ID"] + "");
            ADS_DON_XULY_BL aDXL = new ADS_DON_XULY_BL();
            DataTable objYCBS = aDXL.AHN_GETALL_DON_YCBS(Convert.ToDecimal(DONID), xuLyID, 1, 20);
        ...
        protected void dgDS_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                decimal ID_DON_YCBS = Convert.ToDecimal(Request.QueryString["ID"].ToString());
                AHN_DON_XULY oXL = dt.AHN_DON_XULY.Where(x => x.ID == ID_DON_YCBS).FirstOrDefault();
                ...
                if (e.Item.ItemIndex == 0)
                {
                    ...
                    AHN_DON_XULY_BL oBL = new AHN_DON_XULY_BL();
                    DataTable anphiList = oBL.CHECK_AHN_DON_DUONGSU_ANPHI_V2(DONID, DONCHITIETID, ISDONCHITIET);
                ...
                AHN_DON_XULY_BL oB = new AHN_DON_XULY_BL();
                // DataTable obj = oB.AHN_GETALL_DON_YCBS(Convert.ToDecimal(DONID), ID_DON_YCBS, 1, 20);
                ...
                AHN_DON oT = dt.AHN_DON.Where(x => x.ID == DONID).FirstOrDefault();
                AHN_SOTHAM_THULY oTLST = dt.AHN_SOTHAM_THULY.Where(x => x.DONID == DONIDHandle).FirstOrDefault();
                if (oT.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM || oTLST != null)
                {
                    cmdEdit.Visible = false;
                    cmdXoa.Visible = false;
        ...
        private void LoadDSTL()
        {
            ...
            DataTable oDT = oBL.AHN_GETALL_DON_YCBS(DONID, ID_DON_YCBS, pageindex, page_size);
            dgDS.DataSource = oDT;
            dgDS.DataBind();
        }
    }
