...
namespace WEB.GSTP.QLAN.AHN.PhucthamQDK
{
    public partial class Bananphuctham : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    hddDonID.Value = Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH] + "";
        ...
        {
            decimal DONID = Convert.ToDecimal(hddDonID.Value);
            string Result = new AHN_CHUYEN_NHAN_AN_BL().Check_ChuyenNhanAn(DONID, "Không được sửa đổi thông tin.", Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]));
            if (Result != "")
            {
            ...
            List<AHN_KCKNQDK_PHUCTHAM_THULY> lstCount = DataExtensions.GetAllWithClause<AHN_KCKNQDK_PHUCTHAM_THULY>("DONID = " + DONID);
            ...
            List<AHN_KCKNQDK_PHUCTHAM_QUYETDINH> lstQD = DataExtensions.GetAllWithClause<AHN_KCKNQDK_PHUCTHAM_QUYETDINH>("DONID = " + DONID + " AND (LOAIQDID IN (10,3) OR QUYETDINHID IN (213,145,146))");
            if (lstQD.Count >= 1)
            {
                pnQDVV.Visible = true;
            ...
            AHN_TONGDAT td = dt.AHN_TONGDAT.Where(x => x.DONID == DONID && (x.BIEUMAUID == 230 || x.BIEUMAUID == 261)).FirstOrDefault();
            if (td != null)
            {
            ...
            //                                                                ).FirstOrDefault();
            //AHN_KCKNQDK_PHUCTHAM_QUYETDINH oQD = DataExtensions.GetAllWithClause<AHN_KCKNQDK_PHUCTHAM_QUYETDINH>
            ...
            //    return;
            //}
            AHN_KCKNQDK_PHUCTHAM_QUYETDINH qd64DS = DataExtensions.GetAllWithClause<AHN_KCKNQDK_PHUCTHAM_QUYETDINH>($"DONID = {DONID} AND QUYETDINHID = 64").FirstOrDefault();
            if (qd64DS == null)
            {
                lbthongbaoQD.Text = "Chưa nhập quyết định đưa vụ án ra xét xử.";
                Cls_Comon.SetButton(cmdUpdate, false);
        ...
        private string getQHPL_NAME_THULY()
        {
            ...
            AHN_KCKNQDK_PHUCTHAM_THULY oT = DataExtensions.GetAllWithClause<AHN_KCKNQDK_PHUCTHAM_THULY>("DONID = " + ID).FirstOrDefault();
        ...
        private void txtQuanhephapluat_name(AHN_KCKNQDK_PHUCTHAM_THULY oT)
        {
            if (oT.QUANHEPHAPLUAT_NAME != null)
            {
                txtQuanhephapluat.Text = oT.QUANHEPHAPLUAT_NAME;
        ...
        {
            AHN_KCKN_PHUCTHAM_BL oBL = new AHN_KCKN_PHUCTHAM_BL();
            decimal ID = Convert.ToDecimal(hddDonID.Value);
            DataTable oDT = oBL.AHN_PHUCTHAMKCKNQDK_BANANQUYETDINH_GETLIST(ID);
        ...
        private void LoadQD()
        {
            ...
            DataTable oDT = oBL.AHN_DM_QUYETDINH_VUAN_PTQDK();
        ...
        private void LoadNguoiKyInfo()
        {
            ...
            AHN_KCKNQDK_PHUCTHAM_HDXX oND = DataExtensions.GetAllWithClause<AHN_KCKNQDK_PHUCTHAM_HDXX>("DONID = " + DonID + " AND MAVAITRO ='" + ENUM_NGUOITIENHANHTOTUNG.THAMPHAN + "'").FirstOrDefault<AHN_KCKNQDK_PHUCTHAM_HDXX>();
            if (oND != null)
            {
        ...
        protected void btnLammoi_Click(object sender, EventArgs e)
        {
            ...
            List<AHN_KCKNQDK_PHUCTHAM_QUYETDINH> lstQD = DataExtensions.GetAllWithClause<AHN_KCKNQDK_PHUCTHAM_QUYETDINH>
        ...
        public void xoa(decimal id)
        {
            ...
            AHN_KCKNQDK_PHUCTHAM_QUYETDINH oND = DataExtensions.FindById<AHN_KCKNQDK_PHUCTHAM_QUYETDINH>(id);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AHN_KCKNQDK_PHUCTHAM_QUYETDINH oND;
                decimal STTQD = 0;
                if ((hddid.Value == "" || hddid.Value == "0"))
                {
                    oND = new AHN_KCKNQDK_PHUCTHAM_QUYETDINH();
                ...
                else
                {
                    ...
                    oND = DataExtensions.FindById<AHN_KCKNQDK_PHUCTHAM_QUYETDINH>(ID);
                    if (oND.TOAANID.ToString() != Session[ENUM_SESSION.SESSION_DONVIID].ToString())
                    {
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                case "Download":
                    var oND = DataExtensions.FindById<AHN_KCKNQDK_PHUCTHAM_QUYETDINH>(ND_id);
        ...
        protected void set_valueLydo(AHN_KCKNQDK_PHUCTHAM_QUYETDINH oND)
        {
