...
namespace WEB.GSTP.QLAN.AHN.PhucthamQDK
{
    public partial class Quyetdinhphuctham : System.Web.UI.Page
    {
        ...
        private void check_Quyen(decimal DONID)
        {
            ...
            DataTable oDT = oBL.AHN_PHUCTHAMKCKNQDK_BANANQUYETDINH_GETLIST(DONID);
            ...
            // List<AHN_KCKNQDK_PHUCTHAM_THULY> lstCount = dt.AHN_KCKNQDK_PHUCTHAM_THULY.Where(x => x.DONID == DONID).ToList();
        ...
        private void SetNewSoQD()
        {
            ...
            if (!String.IsNullOrEmpty(txtNgayQD.Text))
                ...
                ngayBD = DateTime.Now;
            txtSoQD.Text = oSTBL.GET_SQD_NEW(DonViID, "AHN_PT", ngayBD, LoaiQD).ToString();
        }
        ...
        private void LoadCombobox()
        {
            ...
            decimal DonID = Convert.ToDecimal(hddDonID.Value);
            AHN_KCKNQDK_PHUCTHAM_THULY tl = DataExtensions.GetAllByDonId<AHN_KCKNQDK_PHUCTHAM_THULY>(DonID).OrderByDescending(x => x.NGAYTHULY).FirstOrDefault();
            if (tl != null)
            {
        ...
        private void LoadQD()
        {
            ...
            DataTable oDT = oBL.AHN_DM_QUYETDINH_VUAN_PT();
        ...
        private void LoadNguoiKyInfo()
        {
            ...
            AHN_KCKNQDK_PHUCTHAM_HDXX oND = DataExtensions.GetAllWithClause<AHN_KCKNQDK_PHUCTHAM_HDXX>($"DONID ={DonID} AND MAVAITRO ='{ENUM_NGUOITIENHANHTOTUNG.THAMPHAN}'").OrderByDescending(x => x.ID).FirstOrDefault();
            //  AHN_PHUCTHAM_HDXX oND = dt.AHN_PHUCTHAM_HDXX.Where(x => x.DONID == DonID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).OrderByDescending(x => x.ID).FirstOrDefault<AHN_PHUCTHAM_HDXX>();
            if (oND != null)
            {
        ...
        private bool CheckValid()
        {
            ...
            if (!String.IsNullOrEmpty(txtNgayQD.Text) && !String.IsNullOrEmpty(txtSoQD.Text))
            {
                ...
                ADS_SOTHAM_BL oSTBL = new ADS_SOTHAM_BL();
                Decimal LoaiQD = Convert.ToDecimal(ddlQuyetdinh.SelectedValue);
                Decimal CheckID = oSTBL.CHECK_SQDTheoLoaiAn(DonViID, "AHN_PT", so, ngay, LoaiQD);
                if (CheckID > 0)
                {
                    Decimal CurrID = (string.IsNullOrEmpty(hddid.Value)) ? 0 : Convert.ToDecimal(hddid.Value);

                    String strMsg = "";
                    String STTNew = oSTBL.GET_SQD_NEW(DonViID, "AHN_PT", ngay, LoaiQD).ToString();
                    if (CheckID != CurrID)
                    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    // oND = dt.AHN_KCKNQDK_PHUCTHAM_QUYETDINH.Where(x => x.ID == ID).FirstOrDefault();
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    // dt.AHN_KCKNQDK_PHUCTHAM_QUYETDINH.Add(oND);
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AHN_KCKNQDK_PHUCTHAM_QUYETDINH_GETLIST(ID);
        ...
        public void xoa(decimal id)
        {
            ...
            // AHN_KCKNQDK_PHUCTHAM_QUYETDINH oND = dt.AHN_KCKNQDK_PHUCTHAM_QUYETDINH.Where(x => x.ID == id).FirstOrDefault();
            decimal FileID = 0;
            if (oND.FILEID != null) FileID = (decimal)oND.FILEID;
            ...
            if (oBL.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oND.DONID), Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH), Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Quyết định Phúc thẩm án Hôn nhân", "Xóa", json) == false)
            {
            ...
            // dt.AHN_KCKNQDK_PHUCTHAM_QUYETDINH.Remove(oND);
            dt.SaveChanges();
            if (FileID > 0)
            {
                try
        ...
        {
            decimal ID = Convert.ToDecimal(hddid.Value);
            AHN_KCKNQDK_PHUCTHAM_QUYETDINH oQD = DataExtensions.FindById<AHN_KCKNQDK_PHUCTHAM_QUYETDINH>(ID);
            // AHN_KCKNQDK_PHUCTHAM_QUYETDINH oQD = dt.AHN_KCKNQDK_PHUCTHAM_QUYETDINH.Where(x => x.ID == ID).FirstOrDefault();
        ...
        protected void ddlQuyetdinh_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (oT != null)
            {
                ...
                if (ID == 143 || ID == 144 || ID == 145 || ID == 146 || ID == 61)
                {
                    ...
                    ADS_SOTHAM_BL oSTBL = new ADS_SOTHAM_BL();
                    String STTNew = oSTBL.GET_SQD_NEW(DonViID, "AHN_PT", ngayQD, ID).ToString();
                    txtSoQD.Text = STTNew;
                }
            }
            LoadLydo();
