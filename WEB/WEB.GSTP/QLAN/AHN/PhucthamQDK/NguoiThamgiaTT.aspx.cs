...
namespace WEB.GSTP.QLAN.AHN.PhucthamQDK
{
    public partial class NguoiThamgiaTT : System.Web.UI.Page
    {
        ...
        private void check_Quyen(decimal DONID)
        {
            ...
            //DataTable NTH = oBL.AHN_KCKNQDK_PHUCTHAM_HDXX_GETLIST(DONID);
        ...
        private void LoadTGTTFromDonKK()
        {
            ...
            chkListTGTT.DataSource = oBL.AHN_DON_TGTT_GETLIST(DONID);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string current_id = Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH] + "";
                decimal DONID = Convert.ToDecimal(current_id);
                AHN_KCKNQDK_PHUCTHAM_THAMGIATOTUNG oND;
                if (hddid.Value == "" || hddid.Value == "0")
                    oND = new AHN_KCKNQDK_PHUCTHAM_THAMGIATOTUNG();
                else
                {
                    decimal ID = Convert.ToDecimal(hddid.Value);
                    //oND = dt.AHN_PHUCTHAM_THAMGIATOTUNG.Where(x => x.ID == ID).FirstOrDefault();
                    oND = DataExtensions.FindById<AHN_KCKNQDK_PHUCTHAM_THAMGIATOTUNG>(ID);
                }
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    //dt.AHN_PHUCTHAM_THAMGIATOTUNG.Add(oND);
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AHN_PHUCTHAM_KCKN_TGTT_GETLIST(ID);
        ...
        {
            //AHN_PHUCTHAM_THAMGIATOTUNG oND = dt.AHN_PHUCTHAM_THAMGIATOTUNG.Where(x => x.ID == id).FirstOrDefault();
            AHN_KCKNQDK_PHUCTHAM_THAMGIATOTUNG oND = DataExtensions.FindById<AHN_KCKNQDK_PHUCTHAM_THAMGIATOTUNG>(id);
            if (oND != null)
            {
                //dt.AHN_PHUCTHAM_THAMGIATOTUNG.Remove(oND);
        ...
        protected void cmdChonTGTT_Click(object sender, EventArgs e)
        {
            ...
            foreach (ListItem oItem in chkListTGTT.Items)
            {
                if (oItem.Selected)
                {
                    ...
                    if (dt.AHN_PHUCTHAM_THAMGIATOTUNG.Where(x => x.NTGTT_DONKK_ID == NID).ToList().Count == 0)
                    {
                        AHN_DON_THAMGIATOTUNG oD = dt.AHN_DON_THAMGIATOTUNG.Where(x => x.ID == NID).FirstOrDefault();
                        AHN_KCKNQDK_PHUCTHAM_THAMGIATOTUNG oS = new AHN_KCKNQDK_PHUCTHAM_THAMGIATOTUNG();
                        oS.DONID = oD.DONID;
                        oS.HOTEN = oD.HOTEN;
                        ...
                        //dt.AHN_PHUCTHAM_THAMGIATOTUNG.Add(oS);
        ...
        {
            //------------------
            AHN_NGUOITHAMGIATOTUNG_BL oBL = new AHN_NGUOITHAMGIATOTUNG_BL();
            decimal sodk_ = 0;
        ...
        protected void btn_GXN_NBC_Click(object sender, EventArgs e)
        {
            ...
            {
                //--------------
                AHN_NGUOITHAMGIATOTUNG_BL objBL = new AHN_NGUOITHAMGIATOTUNG_BL();
