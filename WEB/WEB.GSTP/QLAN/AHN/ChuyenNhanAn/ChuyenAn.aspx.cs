...
namespace WEB.GSTP.QLAN.AHN.ChuyenNhanAn
{
    public partial class ChuyenAn : System.Web.UI.Page
    {
        ...
        private void LoadGrid()
        {
            ...
            DataTable oDT = oBL.HN_CHUYENAN(vDonViID, txtTenToa.Text.Trim(), txtMaVuViec.Text.Trim(), txtTenVuViec.Text.Trim(), txtSoquyetdinh.Text.Trim(), txtSobanan.Text.Trim(), dFrom, dTo, txtTenduongsu.Text.Trim(), Convert.ToDecimal(rdbTrangthai.SelectedValue), Convert.ToDecimal(rdbLoai.SelectedValue));
        ...
        protected void cmdNhanan_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridItem Item in dgList.Items)
            {
                ...
                if (chkChon.Checked)
                {
                    ...
                    input.NgayGiao = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss");
                    ...
                    {
                        AHN_DON_XULY donXuLy = dt.AHN_DON_XULY.Where(x => x.DONID == IDVUAN).FirstOrDefault();
                    ...
                    else
                    {
                        ...
                        else if (hddLydo.Value == "05")
                        {
                            ...
                            AHN_DON oDon = dt.AHN_DON.Where(x => x.ID == IDVUAN).FirstOrDefault();
                            if (oDon.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM_QDK)
                            {
                                AHN_CHUYEN_NHAN_AN_BL chuyenNhanBL = new AHN_CHUYEN_NHAN_AN_BL();
        ...
        private string genNoiDung(decimal MaGiaiDoan, decimal ID, string strNoiDung, bool isAn = true)
        {
            if (isAn)
            {
                if (MaGiaiDoan == ENUM_GIAIDOANVUAN.SOTHAM || MaGiaiDoan == ENUM_GIAIDOANVUAN.HOSO)
                {
                    ...
                    List<AHN_SOTHAM_KHANGCAO> lstkc = dt.AHN_SOTHAM_KHANGCAO.Where(x => x.DONID == ID && (x.TINHTRANG_GIAIQUYET == 0 || x.TINHTRANG_GIAIQUYET == null)).OrderBy(y => y.ISQUAHAN).ToList();
                    List<AHN_SOTHAM_KHANGNGHI> lstkn = dt.AHN_SOTHAM_KHANGNGHI.Where(x => x.DONID == ID && (x.TINHTRANG_GIAIQUYET == 0 || x.TINHTRANG_GIAIQUYET == null)).ToList();
                    AHN_SOTHAM_KHANGCAO okc = lstkc.OrderByDescending(y => y.ISQUAHAN).FirstOrDefault();
                    ...
                    if (flag == false)
                    {
                        ...
                        if (oDMQD != null)
                        {
                            ...
                            AHN_SOTHAM_QUYETDINH oQD = dt.AHN_SOTHAM_QUYETDINH.Where(x => x.DONID == ID && x.LOAIQDID == oDMQD.ID && x.TOAANID == IDToa).OrderByDescending(y => y.NGAYQD).FirstOrDefault();
                            if (oQD != null)
                            {
                ...
                else if (MaGiaiDoan == ENUM_GIAIDOANVUAN.PHUCTHAM)
                {
                    ...
                    List<AHN_PHUCTHAM_BANAN> lstba = dt.AHN_PHUCTHAM_BANAN.Where(x => x.DONID == ID && (x.KETQUAPHUCTHAMID == 4 || x.KETQUAPHUCTHAMID == 22)).ToList();
                    List<AHN_PHUCTHAM_QUYETDINH> lstqd = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.DONID == ID && x.KETQUAID == 103).ToList();
                ...
                else if (MaGiaiDoan == ENUM_GIAIDOANVUAN.PHUCTHAM_QDK)
                {
                    ...
                    List<AHN_KCKNQDK_PHUCTHAM_QUYETDINH> lstqd = DataExtensions.GetAllWithClause<AHN_KCKNQDK_PHUCTHAM_QUYETDINH>($"DONID = {ID} AND KETQUAID IN (101,102,103)");
                    if (lstqd.Count > 0)
                    {
            ...
            {
                AHN_DON_XULY dxl = dt.AHN_DON_XULY.Where(x => x.DONID == ID).OrderByDescending(x => x.ID).FirstOrDefault();
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                try
                {
                    ...
                    AHN_DON oDon = dt.AHN_DON.Where(x => x.ID == ID).FirstOrDefault();
                    if (oDon != null)
                    {
                    ...
                    else
                    {
                        ...
                        if (MaGiaiDoan == ENUM_GIAIDOANVUAN.SOTHAM || MaGiaiDoan == ENUM_GIAIDOANVUAN.HOSO)
                        {
                            AHN_SOTHAM_THULY oTL = dt.AHN_SOTHAM_THULY.Where(x => x.DONID == ID).OrderByDescending(y => y.NGAYTHULY).Take(1).FirstOrDefault();
                            ...
                            if (rdbTrangthai.SelectedValue == "0")
                            {
                                ...
                                List<AHN_SOTHAM_KHANGCAO> lstkc = dt.AHN_SOTHAM_KHANGCAO.Where(x => x.DONID == ID && (x.TINHTRANG_GIAIQUYET == 0 || x.TINHTRANG_GIAIQUYET == null)).OrderBy(y => y.ISQUAHAN).ToList();
                                List<AHN_SOTHAM_KHANGNGHI> lstkn = dt.AHN_SOTHAM_KHANGNGHI.Where(x => x.DONID == ID && (x.TINHTRANG_GIAIQUYET == 0 || x.TINHTRANG_GIAIQUYET == null)).ToList();
                                AHN_SOTHAM_KHANGCAO okc = dt.AHN_SOTHAM_KHANGCAO.Where(x => x.DONID == ID).OrderByDescending(y => y.ISQUAHAN).FirstOrDefault();
                                if (lstkc.Count > 0 && lstkn.Count > 0)
                                {
                        ...
                        {
                            AHN_PHUCTHAM_THULY oTL = dt.AHN_PHUCTHAM_THULY.Where(x => x.DONID == ID).OrderByDescending(y => y.NGAYTHULY).Take(1).FirstOrDefault();
                            if (oTL != null) lstNgaythuly.Text = ((DateTime)oTL.NGAYTHULY).ToString("dd/MM/yyyy");
                            if (rdbTrangthai.SelectedValue == "0")
                            {
                                //DM_KETQUA_PHUCTHAM oKQPT = dt.DM_KETQUA_PHUCTHAM.Where(x => x.MA == "06").FirstOrDefault();
                                //List<AHN_PHUCTHAM_BANAN> lstba = dt.AHN_PHUCTHAM_BANAN.Where(x => x.DONID == ID && x.KETQUAPHUCTHAMID == oKQPT.ID).ToList();
                                //DM_KETQUA_PHUCTHAM oKQPT2 = dt.DM_KETQUA_PHUCTHAM.Where(x => x.MA == "04").FirstOrDefault();
                                //List<AHN_PHUCTHAM_BANAN> lstba2 = dt.AHN_PHUCTHAM_BANAN.Where(x => x.DONID == ID && x.KETQUAPHUCTHAMID == oKQPT2.ID).ToList();
                                //List<AHN_PHUCTHAM_QUYETDINH> lstQD = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.DONID == ID && x.KETQUAID == 103).ToList();
                        ...
                        {
                            AHN_KCKNQDK_PHUCTHAM_THULY oTL = DataExtensions.GetAllByDonId<AHN_KCKNQDK_PHUCTHAM_THULY>(ID).OrderByDescending(y => y.NGAYTHULY).Take(1).FirstOrDefault();
                            if (oTL != null) lstNgaythuly.Text = ((DateTime)oTL.NGAYTHULY).ToString("dd/MM/yyyy");
                            if (rdbTrangthai.SelectedValue == "0")
                            {
                            ...
                            else
                            {
                                ...
                                {
                                    AHN_DON_XULY dxl = dt.AHN_DON_XULY.Where(x => x.DONID == ID).FirstOrDefault();
                                    strNoiDung = dxl.LYDO;
                                }
                            }
                        }
        ...
        {
            AHN_CHUYEN_NHAN_AN_BL Bl = new AHN_CHUYEN_NHAN_AN_BL();
            ...
            //    {
            //        AHN_CHUYEN_NHAN_AN ObjChuyenNhan = dt.AHN_CHUYEN_NHAN_AN.Where(x => x.VUANID == DonID).FirstOrDefault();
            //        if (ObjChuyenNhan != null)
            //        {
            //            dt.AHN_CHUYEN_NHAN_AN.Remove(ObjChuyenNhan);
            //            dt.SaveChanges();
            //            dgList.CurrentPageIndex = 0;
            //            hddPageIndex.Value = "1";

            //            //10092021 insert quản lý hồ sơ trạng thái kháng nghị kháng cáo
            //            new QLHS_BL().DeleteHoSoLuTruCoChuyenAn(DonID, ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH);

            //            //manhnd 10/12/2021 cap nhat lai MAGIAIDON sau khi huy chuyen
            //            AHN_DON_GIAIDOAN oGD = dt.AHN_DON_GIAIDOAN.Where(x => x.DONID == DonID && x.TOAANID == ObjChuyenNhan.TOACHUYENID).FirstOrDefault();
            //            AHN_DON oDon = dt.AHN_DON.Where(X => X.ID == DonID).FirstOrDefault();
            ...
            for (int i = 0; i < lstChuyenAnID.Count; i++)
            {
                ...
                AHN_CHUYEN_NHAN_AN oChuyenAn = dt.AHN_CHUYEN_NHAN_AN.Where(x => x.ID == ChuyenAnId).FirstOrDefault();
                AHN_DON_XULY dxl = dt.AHN_DON_XULY.Where(x => x.DONID == oChuyenAn.VUANID).FirstOrDefault();
                if (oChuyenAn != null)
                {
                    ...
                    {
                        dt.AHN_CHUYEN_NHAN_AN.Remove(oChuyenAn);
                        dt.SaveChanges();
                        dgList.CurrentPageIndex = 0;
                        hddPageIndex.Value = "1";
                        //10092021 insert quản lý hồ sơ trạng thái kháng nghị kháng cáo
                        ...
                        //manhnd 10/12/2021 cap nhat lai MAGIAIDON sau khi huy chuyen
                        AHN_DON_GIAIDOAN oGD = dt.AHN_DON_GIAIDOAN.Where(x => x.DONID == DonID && x.TOAANID == oChuyenAn.TOACHUYENID).FirstOrDefault();

                        AHN_DON oDon = dt.AHN_DON.Where(X => X.ID == DonID).FirstOrDefault();
                        if (oGD == null)
                        {
                            oGD = dt.AHN_DON_GIAIDOAN.Where(x => x.DONID == DonID && x.TOAPHUCTHAMID == oChuyenAn.TOACHUYENID).FirstOrDefault();
                        }
                        oDon.MAGIAIDOAN = oGD.MAGIAIDOAN;
                        dt.SaveChanges();
                    }
                ...
                if (dxl != null && dxl.LOAIGIAIQUYET == 1)
                {
        ...
        protected void rptCapNhat_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (hddTHGN.Value == "05")
                {
                    ...
                    {
                        AHN_DON oDonST = dt.AHN_DON.Where(x => x.MAVUVIEC == mavuviec && x.TOAANID != toaanST).FirstOrDefault();
