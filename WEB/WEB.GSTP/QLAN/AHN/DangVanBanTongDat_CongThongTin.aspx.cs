...
namespace WEB.GSTP.QLAN.AHN
{
    public partial class DangVanBanTongDat_CongThongTin : System.Web.UI.Page
    {
        ...
        private const string CAPXX_ST = "1", CAPXX_PT = "2", CAPXX_GDT = "3", CAPXX_TT = "4", LINHVUC_HNGD = "35";
        ...
        private void LoadDanhSach()
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("AHN_TONGDAT_GetVB_CTTDT", prm);
        ...
        protected void BtnGuiCongThongTinDienTu_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string prm_key = "dGFuZHRjL3NlcnZpY2UvZ3NvbG90aW9uL2FucHg=",
                    prm_linhVuc = LINHVUC_HNGD, StrLinhVuc = "hôn nhân và gia đình", BMKhongThanhCong = "";
                ...
                foreach (DataGridItem item in dgListChuaDangTai.Items)
                {
                    ...
                    if (chkIsSend.Checked)
                    {
                        ...
                        AHN_TONGDAT tdat = dt.AHN_TONGDAT.Where(x => x.ID == TongDatID).FirstOrDefault();
                        if (tdat != null)
                        {
                            ...
                            if (bm != null)
                            {
                                ...
                                if (bm.GIAIDOAN == ENUM_GIAIDOANVUAN.SOTHAM.ToString())// sơ thẩm
                                {
                                    ...
                                    AHN_SOTHAM_THULY ThuLyST = dt.AHN_SOTHAM_THULY.Where(x => x.DONID == DONID).OrderByDescending(x => x.NGAYTHULY).FirstOrDefault();
                                    if (ThuLyST != null)
                                    {
                                ...
                                else if (bm.GIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM.ToString())
                                {
                                    ...
                                    AHN_PHUCTHAM_THULY ThuLyPT = dt.AHN_PHUCTHAM_THULY.Where(x => x.DONID == DONID).OrderByDescending(x => x.NGAYTHULY).FirstOrDefault();
                                    if (ThuLyPT != null)
                                    {
                                ...
                                AHN_DON_DUONGSU NguoiKhoiKien = dt.AHN_DON_DUONGSU.Where(x => x.DONID == DONID && x.TUCACHTOTUNG_MA == ENUM_DANSU_TUCACHTOTUNG.NGUYENDON).FirstOrDefault();
                                ...
                                AHN_DON_DUONGSU NguoiBiKien = dt.AHN_DON_DUONGSU.Where(x => x.DONID == DONID && x.TUCACHTOTUNG_MA == ENUM_DANSU_TUCACHTOTUNG.BIDON).FirstOrDefault();
                                if (NguoiBiKien != null)
                                {
