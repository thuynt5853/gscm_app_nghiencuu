    ...
    public partial class NguoiTienhanhTT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    decimal currentToaId = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                    ...
                    DataTable oDT = oBL.DGLIST_BAQD_QUYETDINH_KETTHUC_PT(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH, DONID);
                    if (oDT.Rows.Count > 0)
                    {
                        bool exists = false;
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                var donviToaID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                ...
                AHN_PHUCTHAM_QUYETDINH qd = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID  == donviToaID).FirstOrDefault();
                if (qd != null)
                {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AHN_PHUCTHAM_HDXX oND;

                // Lấy count thụ lý và count chủ tọa để cho nhập thêm thẩm phán chủ tọa
                List<AHN_DON_THAMPHAN> countTPGQ = dt.AHN_DON_THAMPHAN.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETPHUCTHAM).ToList();
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AHN_PHUCTHAM_HDXX_GETLIST(ID);
