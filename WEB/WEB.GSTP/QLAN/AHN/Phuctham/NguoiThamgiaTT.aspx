<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="NguoiThamgiaTT.aspx.cs" Inherits="WEB.GSTP.QLAN.AHN.Phuctham.NguoiThamgiaTT" %>
                        ...
                        <table class="table1">
                            <tr>
                                ...
                                <td style="width: 308px">
                                    <asp:TextBox ID="txtBD_CMND" CssClass="user" runat="server" Width="308px" MaxLength="250"></asp:TextBox>
                                </td>--%>
                            ...
                            <tr>
                                <td>Thẻ căn cước <span id="ltCCCDBD"></span></td>
                                <td style="width: 308px">
                                    <asp:TextBox ID="txtBD_CCCD" CssClass="user" runat="server" Width="308px" MaxLength="250"></asp:TextBox>
                                </td>
                                <td>Hộ chiếu <span id="ltHCBD"></span></td>
                                <td style="width: 308px">
                                    <asp:TextBox ID="txtBD_HoChieu" CssClass="user" runat="server" Width="308px" MaxLength="250"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
    ...
    <script type="text/javascript">
        ...
        function loadeventchange() {
            if ($('#<%=chkBoxCMNDBD.ClientID%>').is(':checked')) {
                ...
                ltCCCDBD.innerHTML = "<span style='color:red'>(*)</span>";
            }
        ...
        function setValidateCMND() {
            ...
            var ltCCCDBD = document.getElementById('ltCCCDBD');
            ltCMNDBD.innerHTML = "<span style='color:red'>(*)</span>";
            ltCCCDBD.innerHTML = "<span style='color:red'>(*)</span>";
            $('#pnRight').off('change');
        ...
        function ValidDataInput() {
            ...
            <%--if (!$('#<%=chkBoxCMNDBD.ClientID%>').is(':checked')) {
                ...
                var txtBD_CCCD = document.getElementById('<%=txtBD_CCCD.ClientID%>');
                var txtBD_HoChieu = document.getElementById('<%=txtBD_HoChieu.ClientID%>');
                if (txtBD_CMND.value.trim().length == 0 && txtBD_CCCD.value.trim().length == 0 && txtBD_HoChieu.value.trim().length == 0) {
                    alert('Bạn chưa nhập 1 trong 3 nội dung Số CMND/ Thẻ căn cước/ Hộ chiếu. Hãy chọn lại! Nếu không hãy tích chọn "Không có"');
                    txtBD_CMND.focus();
                    return false;
                }
            }--%>
