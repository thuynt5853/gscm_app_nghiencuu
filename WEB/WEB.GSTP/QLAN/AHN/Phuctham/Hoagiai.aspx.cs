    ...
    public partial class Hoagiai : System.Web.UI.Page
    {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    if (dgList.Items.Count > 0)
                    {
                        ...
                        DataTable oDT = oBL.AHN_PHUCTHAM_HOAGIAI_GETLIST(ID);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AHN_PHUCTHAM_HOAGIAI oND;
                if (hddid.Value == "" || hddid.Value == "0")
                    oND = new AHN_PHUCTHAM_HOAGIAI();
                else
                {
                    decimal ID = Convert.ToDecimal(hddid.Value);
                    oND = dt.AHN_PHUCTHAM_HOAGIAI.Where(x => x.ID == ID).FirstOrDefault();
                }
                oND.DONID = DONID;
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    dt.AHN_PHUCTHAM_HOAGIAI.Add(oND);
                }
                else
                {
        ...
        {
            AHN_PHUCTHAM_HOAGIAI oND = dt.AHN_PHUCTHAM_HOAGIAI.Where(x => x.ID == id).FirstOrDefault();
            //Anhpn 
            ...
            dt.AHN_PHUCTHAM_HOAGIAI.Remove(oND);
            dt.SaveChanges();
            hddPageIndex.Value = "1";
            dgList.CurrentPageIndex = 0;
            LoadGrid();
