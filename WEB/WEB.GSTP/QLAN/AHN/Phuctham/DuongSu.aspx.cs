...
namespace WEB.GSTP.QLAN.AHN.Phuctham
{
    public partial class DuongSu : System.Web.UI.Page
    {
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AHN_PHUCTHAM_DUONGSU_GETBY(ID, 0);
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Select"://Cap nhat thong tin Duong su  
                    ...
                    string StrMsg = "PopupCenter('/QLAN/AHN/Hoso/Popup/pDuongSuUpdate.aspx?dsID=" + DuongSuID.ToString() + "','Bổ sung thông tin đương sự',950,450);";
