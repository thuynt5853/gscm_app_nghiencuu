    ...
    public partial class Bananphuctham : System.Web.UI.Page
    {
        ...
        bool CheckCongbo(decimal ID)
        {
            var list = DataExtensions.GetAllWithClause<BAQD_CONGBO>(
                $"VUVIECID = {ID} AND LOAIANID = {ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH} AND CAPXETXU = 3 AND TRANGTHAI IN (2,3)"
            );
        ...
        void CheckQuyen()
        {
            ...
            List<AHN_PHUCTHAM_QUYETDINH> lstQD = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DONID && (x.LOAIQDID == 10 || x.QUYETDINHID == 423 || x.QUYETDINHID == 422 || x.LOAIQDID == 3 || x.LOAIQDID == 23 || x.QUYETDINHID == 212 || x.QUYETDINHID == 213)).ToList();
            if (lstQD.Count >= 1)
            {
                pnQDVV.Visible = true;
            ...
            List<AHN_PHUCTHAM_BANAN> lstBA = dt.AHN_PHUCTHAM_BANAN.Where(x => x.DONID == DONID).ToList();
            if (lstBA.Count >= 1)
            {
                pnBAPT.Visible = true;
            ...
            List<AHN_PHUCTHAM_THULY> lstCount = dt.AHN_PHUCTHAM_THULY.Where(x => x.DONID == DONID).ToList();
            ...
            List<AHN_DON_THAMPHAN> lstTP = dt.AHN_DON_THAMPHAN.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETPHUCTHAM).ToList();
            if (lstTP.Count == 0)
            {
            ...
            List<AHN_PHUCTHAM_HDXX> lstTPCT = dt.AHN_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).ToList();
            if (lstTPCT.Count == 0)
            {
                lstErr.Text = lbthongbaoQD.Text = "Chưa phân công thẩm phán giải quyết !";
                Cls_Comon.SetButton(cmdUpdate, false);
            ...
            AHN_CHUYEN_NHAN_AN oChuyenAn = dt.AHN_CHUYEN_NHAN_AN.Where(x => x.VUANID == DONID).OrderByDescending(x => x.NGAYTAO).FirstOrDefault();
            ...
            AHN_TONGDAT td = dt.AHN_TONGDAT.Where(x => x.DONID == DONID && ( x.BIEUMAUID == 261)).FirstOrDefault();// vnpt -- xoá check biểu mẫu sơ thẩm đã tống đạt trên phúc thẩm
            if (td != null)
            {
            ...
            AHN_PHUCTHAM_QUYETDINH oQD = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DONID && x.LOAIQDID == 5
        ...
        private void LoadFile()
        {
            ...
            List<AHN_PHUCTHAM_BANAN_FILE> lst = dt.AHN_PHUCTHAM_BANAN_FILE.Where(x => x.BANANID == DonID).ToList();
        ...
        {
            AHN_PHUCTHAM_BANAN oT = dt.AHN_PHUCTHAM_BANAN.Where(x => x.DONID == DonID).FirstOrDefault<AHN_PHUCTHAM_BANAN>();
            if (oT != null)
            {
                ...
                if (!string.IsNullOrEmpty(oT.TK_KETQUA_CHITIET + ""))
                {
                    rdKetqua_Chitiet.SelectedValue = oT.TK_KETQUA_CHITIET.ToString();
                }
            ...
            else
            {
                ...
                AHN_PHUCTHAM_THULY tl = dt.AHN_PHUCTHAM_THULY.Where(x => x.DONID == DonID).OrderByDescending(x => x.NGAYTHULY).FirstOrDefault();
                if (tl != null)
                {
                    if (tl.QHPLTKID != null)
        ...
        private bool CheckValid()
        {
            ...
            if (string.IsNullOrEmpty(rdKetqua_Chitiet.SelectedValue))
            {
                lstErr.Text = "Chưa chọn Thông tin chi tiết !";
                return false;
            }
            ...
            if (!String.IsNullOrEmpty(txtNgaytuyenan.Text))
            {
                ...
                Decimal CheckID = oSTBL.CheckSoBATheoLoaiAn(DonViID, "AHN_PT", so, ngayBA);
                if (CheckID > 0)
                {
                    Decimal CurrBanAnId = (string.IsNullOrEmpty(hddBanAnID.Value)) ? 0 : Convert.ToDecimal(hddBanAnID.Value);
                    String strMsg = "";
                    String STTNew = oSTBL.GETSoBANEWTheoLoaiAn(DonViID, "AHN_PT", ngayBA).ToString();
        ...
        private void LoadDropKetQuaPhucTham()
        {
            ...
            ddlKetQuaPhucTham.DataSource = dt.DM_KETQUA_PHUCTHAM.Where(x => x.ISAHN == 1 && x.ISBANAN == 1).OrderBy(y => y.THUTU).ToList();
        ...
        protected void cmdUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                bool isNew = false;
                AHN_PHUCTHAM_BANAN_FILE oTF = new AHN_PHUCTHAM_BANAN_FILE();
                AHN_PHUCTHAM_BANAN oND = dt.AHN_PHUCTHAM_BANAN.Where(x => x.DONID == DONID).FirstOrDefault<AHN_PHUCTHAM_BANAN>();
                if (oND == null)
                {
                    oND = new AHN_PHUCTHAM_BANAN(); isNew = true;
                ...
                } else
                {
                    ...
                    AHN_TONGDAT oTD2 = dt.AHN_TONGDAT.Where(x => x.DONID == oND.DONID && x.MAPID == oND.ID && x.MAP_TABLE == ENUM_MAP_TABLE.AHN_PHUCTHAM_BANAN).FirstOrDefault();
                    if (oTD2 != null)
                    {
                ...
                oND.TK_KETQUA_CHITIET = Convert.ToDecimal(rdKetqua_Chitiet.SelectedValue);
                try
                {
                    if (hddFilePath.Value != "")
                    {
                        ...
                        using (FileStream fs = File.OpenRead(strFilePath))
                        {
                            ...
                            dt.AHN_PHUCTHAM_BANAN_FILE.Add(oTF);
                            dt.SaveChanges();
                        }
                        #endregion
                 ...
                 * File bản án nếu đính kèm sẽ lưu vào bảng AHN_PHUCTHAM_BANAN_FILE
                ...
                rFileID = UploadFileID(oDon, FileID, "75-DS", STTQD);
                if (rFileID > 0)
                {
                    oND.FILEID = rFileID;
                }
        ...
        protected void dgFile_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Xoa":
                    ...
                    AHN_PHUCTHAM_BANAN_FILE oT = dt.AHN_PHUCTHAM_BANAN_FILE.Where(x => x.ID == ND_id).FirstOrDefault();
                    dt.AHN_PHUCTHAM_BANAN_FILE.Remove(oT);
                    dt.SaveChanges();
                    LoadFile();
                    break;
                case "Download":
                    AHN_PHUCTHAM_BANAN_FILE oND = dt.AHN_PHUCTHAM_BANAN_FILE.Where(x => x.ID == ND_id).FirstOrDefault();
                    if (oND.TENFILE != "")
                    {
        ...
        protected void cmdHuyBanAn_Click(object sender, EventArgs e)
        {
            ...
            AHN_PHUCTHAM_BANAN banan = dt.AHN_PHUCTHAM_BANAN.Where(x => x.DONID == DONID).FirstOrDefault();
            if (banan != null)
            {
                //Dữ liệu Bản án đã được chia sẻ không được xóa
                KHOBAQD_BL oDonBL = new KHOBAQD_BL();
                bool isExist = oDonBL.IsExistKHOBADQ(0, banan.DONID??0, 3,ENUM_LOAIVUVIEC_TEXT.AN_HONNHAN_GIADINH);
                if (isExist)
                {
                    lstErr.Text = "Vụ việc đã được chia sẻ dữ liệu. Không được xóa.";
                    return;
                }

                // khong duoc xoa khi da Tong dat - 27/11/2025 vnpt check
                AHN_TONGDAT oTD2 = dt.AHN_TONGDAT.Where(x => x.DONID == banan.DONID && x.MAPID == banan.ID && x.MAP_TABLE == ENUM_MAP_TABLE.AHN_PHUCTHAM_BANAN).FirstOrDefault();
                if (oTD2 != null)
                {
                ...
                if (oBL.HISTORY_ALLDATA_BY_VUANID(DONID, 3, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Bản án Phúc thẩm án Hôn nhân", "Xóa", json) == false)
                {
                    return;
                }//Ket thuc
                 //Xoa Bản án Phúc thẩm
                dt.AHN_PHUCTHAM_BANAN.Remove(banan);
                dt.AHN_PHUCTHAM_BANAN.Remove(banan);
            }
            // Xóa thông tin file đính kèm
            List<AHN_PHUCTHAM_BANAN_FILE> files = dt.AHN_PHUCTHAM_BANAN_FILE.Where(x => x.BANANID == DONID).ToList();
            if (files.Count > 0)
            {
                dt.AHN_PHUCTHAM_BANAN_FILE.RemoveRange(files);
            }
            // Xóa thông tin người tham gia tố tụng
            List<AHN_PHUCTHAM_BANAN_TGTT> tGTTs = dt.AHN_PHUCTHAM_BANAN_TGTT.Where(x => x.DONID == DONID).ToList();
            if (tGTTs.Count > 0)
            {
                dt.AHN_PHUCTHAM_BANAN_TGTT.RemoveRange(tGTTs);
            }
            ...
            AHN_FILE file = dt.AHN_FILE.Where(x => x.DONID == DONID && x.BIEUMAUID == BieuMauID && x.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM).FirstOrDefault();
            if (file != null)
            {
        ...
        private string getQHPL_NAME_THULY()
        {
            ...
            AHN_PHUCTHAM_THULY oT = dt.AHN_PHUCTHAM_THULY.Where(x => x.DONID == ID).FirstOrDefault();
        ...
        private void txtQuanhephapluat_name(AHN_PHUCTHAM_BANAN oT)
        {
            ...
            {
                AHN_PHUCTHAM_BANAN oTT = dt.AHN_PHUCTHAM_BANAN.Where(x => x.DONID == oT.DONID).FirstOrDefault();
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.DGLIST_BAQD_QUYETDINH_KETTHUC_PT(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH, ID);
            if (oDT != null)
            {
        ...
        {
            DM_QUYETDINH_VUAN_KETTHUC oBL = new DM_QUYETDINH_VUAN_KETTHUC();
            DataTable oDT = oBL.DM_QUYETDINH_VUAN_PHUCTHAM_KETTHUC(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH);
        ...
        private void LoadNguoiKyInfo()
        {
            ...
            AHN_PHUCTHAM_HDXX oND = dt.AHN_PHUCTHAM_HDXX.Where(x => x.DONID == DonID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).FirstOrDefault<AHN_PHUCTHAM_HDXX>();
            if (oND != null)
            {
            ...
            {
                AHN_DON_THAMPHAN oTP = dt.AHN_DON_THAMPHAN.Where(x => x.DONID == DonID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETPHUCTHAM).FirstOrDefault();
                if (oTP != null)
                {
        ...
        protected void btnLammoi_Click(object sender, EventArgs e)
        {
            ...
            List<AHN_PHUCTHAM_QUYETDINH> lstQD = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.DONID == ID && (x.LOAIQDID == 10 || x.QUYETDINHID == 423 || x.QUYETDINHID == 422 || x.LOAIQDID == 3 || x.LOAIQDID == 23)).ToList();
            if (lstQD.Count >= 1)
            {
                Cls_Comon.SetButton(btnUpdate, false);
            }
        ...
        {
            AHN_PHUCTHAM_QUYETDINH oND = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.ID == id).FirstOrDefault();
            ...
            //    return;
            //}
            TK_PHUCTHAM_QUYETDINH TK = DataExtensions.GetAllWithClause<TK_PHUCTHAM_QUYETDINH>($"QUYETDINHID = {id} AND LOAIAN = {Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH)}").FirstOrDefault();
            if (TK != null)
            {
            ...
            if (oND != null)
            {
                ...
                dt.AHN_PHUCTHAM_QUYETDINH.Remove(oND);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AHN_PHUCTHAM_QUYETDINH oND;
                TK_PHUCTHAM_QUYETDINH TK = new TK_PHUCTHAM_QUYETDINH();
                decimal STTQD = 0;
                if ((hddid.Value == "" || hddid.Value == "0"))
                {
                    oND = new AHN_PHUCTHAM_QUYETDINH();
                    AHN_DON_BL oBL = new AHN_DON_BL();
                ...
                else
                {
                    ...
                    TK = DataExtensions.GetAllWithClause<TK_PHUCTHAM_QUYETDINH>($"QUYETDINHID= {ID} AND LOAIAN =  {Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH)}").FirstOrDefault();
                    oND = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.ID == ID).FirstOrDefault();
                    if (oND.TOAANID.ToString() != Session[ENUM_SESSION.SESSION_DONVIID].ToString())
                    {
                ...
                if (!ddlQuyetdinh.SelectedItem.Text.Contains("72-DS"))
                {
                    ...
                    TK.TK_KETQUA_CHITIET = Convert.ToDecimal(rdKetqua_Chitiet_QD.SelectedValue);
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    oND.NGUOITAO = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                    oND.TOA_GIAIQUYET_ID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                    dt.AHN_PHUCTHAM_QUYETDINH.Add(oND);
                    dt.SaveChanges();
        ...
        public void loadedit(decimal ID)
        {
            ...
            if (oQD != null)
            {
                if (/*oQD.MA == "TDC" || */oND.LOAIQDID == 10 || oND.LOAIQDID == 11 || oND.LOAIQDID == 3 || oND.LOAIQDID == 23 || oND.QUYETDINHID == 213)
                {
            ...
            if (!ddlQuyetdinh.SelectedItem.Text.Contains("72-DS"))
            {
                ...
                if (!string.IsNullOrEmpty(TK.TK_KETQUA_CHITIET + ""))
                {
                    rdKetqua_Chitiet_QD.SelectedValue = TK.TK_KETQUA_CHITIET.ToString();
                }
        ...
        private void SetEnable_data_QD(AHN_PHUCTHAM_QUYETDINH QD)
        {
            if (QD != null)
            {
                // khong duoc sửa khi da Tong dat nhưng cho phép nhập thêm những trường trống -27 / 11 / 2025 vnpt check
                AHN_TONGDAT oTD = dt.AHN_TONGDAT.Where(x => x.DONID == QD.DONID && x.MAPID == QD.ID && x.MAP_TABLE == ENUM_MAP_TABLE.AHN_PHUCTHAM_BANAN).FirstOrDefault();
                if (oTD != null)
                {
                    if (QD.QHPLTKID != null)
                    {
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                case "Download":
                    var oND = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.DONID == ID).FirstOrDefault();
                    if (oND.TENFILE != "")
                    {
                        var cacheKey = Guid.NewGuid().ToString("N");
                    ...
                    break;
                case "Sua":
                    //AHN_PHUCTHAM_QUYETDINH oND2 = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.ID == ND_id).FirstOrDefault();
                    //if (oND2 != null)
                    //{
                    //    // khong duoc xoa khi da Tong dat - 27/11/2025 vnpt check
                    //    AHN_TONGDAT oTD2 = dt.AHN_TONGDAT.Where(x => x.DONID == oND2.DONID && x.MAPID == oND2.ID && x.MAP_TABLE == ENUM_MAP_TABLE.AHN_PHUCTHAM_QUYETDINH).FirstOrDefault();
                    //    if (oTD2 != null)
                    //    {
                ...
                case "Xoa":
                    ...
                    KHOBAQD_BL oDonBL = new KHOBAQD_BL();
                    bool isExist = oDonBL.IsExistKHOBADQ(1, ID, 3,ENUM_LOAIVUVIEC_TEXT.AN_HONNHAN_GIADINH);
                    if (isExist)
                    {
                        lbthongbao.Text = "Vụ việc đã được chia sẻ dữ liệu. Không được xóa.";
                        return;
                    }
                    AHN_PHUCTHAM_QUYETDINH oND3 = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.ID == ND_id).FirstOrDefault();
                    if (oND3 != null)
                    {
                        // khong duoc xoa khi da Tong dat - 27/11/2025 vnpt check
                        AHN_TONGDAT oTD2 = dt.AHN_TONGDAT.Where(x => x.DONID == oND3.DONID && x.MAPID == oND3.ID && x.MAP_TABLE == ENUM_MAP_TABLE.AHN_PHUCTHAM_QUYETDINH).FirstOrDefault();
                        if (oTD2 != null)
                        {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                decimal DONID = Convert.ToDecimal(hddDonID.Value);
                AHN_PHUCTHAM_QUYETDINH oT = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.ID == DONID).FirstOrDefault();
        ...
        protected void ddlQuyetdinh_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (btnUpdate.Enabled == true)
            {
                ...
                {
                    AHN_PHUCTHAM_QUYETDINH oQD = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.DONID == IDD && x.LOAIQDID == 5 && x.QUYETDINHID != 147 && x.QUYETDINHID != 148 /*Quyết định chuyển vụ án giải quyết theo thủ tục rút gọn sang giải quyết theo thủ tục thông thường*/).FirstOrDefault();
                    if (oQD == null)
                    {
        ...
        protected void set_valueLydo(AHN_PHUCTHAM_QUYETDINH oND)
        {
        ...
        private bool CheckValidQDVV()
        {
            ...
            if (string.IsNullOrEmpty(rdKetqua_Chitiet_QD.SelectedValue))
            {
                lbthongbaoQD.Text = "Chưa chọn Thông tin chi tiết !";
                return false;
            }
        ...
        private void LoadDropKetQuaQuyetdinhPhuctham()
        {
            if (ddlQuyetdinh.SelectedItem.Text.Contains("72-DS"))
            {
                ...
                ddlKetquaQuyetdinh.DataSource = dt.DM_KETQUA_PHUCTHAM.Where(x => x.ISAHN == 1 && x.ISQUYETDINH == 1).OrderBy(y => y.THUTU).ToList();
            ...
            {
                ddlKetquaQuyetdinh.Items.Clear();
                ddlKetquaQuyetdinh.DataSource = dt.DM_KETQUA_PHUCTHAM.Where(x => x.ISAHN == 1 && x.ISBANAN == 1 && x.MA != "13" && x.MA != "14" && x.MA != "18").OrderBy(y => y.THUTU).ToList();
                ddlKetquaQuyetdinh.DataTextField = "TEN";
                ddlKetquaQuyetdinh.DataValueField = "ID";
                ddlKetquaQuyetdinh.DataBind();
                ddlKetquaQuyetdinh.Items.Insert(0, new ListItem("--- Chọn ---", "0"));
