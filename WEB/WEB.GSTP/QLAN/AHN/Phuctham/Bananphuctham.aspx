<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Bananphuctham.aspx.cs" Inherits="WEB.GSTP.QLAN.AHN.Phuctham.Bananphuctham" %>
        ...
        <div class="boxchung">
            ...
            <div class="boder" style="padding: 10px;">
                ...
                <table class="table1">
                    ...
                    <tr>
                        <td>Thông tin chi tiết<span class="batbuoc">(*)</span></td>
                        <td colspan="3">
                            <%--                            <asp:DropDownList ID="DropDownList1" CssClass="chosen-select" runat="server" Width="450px"></asp:DropDownList>--%>
                            <asp:RadioButtonList ID="rdKetqua_Chitiet" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Value="1">Ly hôn</asp:ListItem>
                                <asp:ListItem Value="3">Không phải là vợ chồng</asp:ListItem>
                ...
                <div class="boxchung">
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <asp:Panel ID="pnQDDinhChiPT" runat="server" Visible="false">
                                <tr>
                            ...
                            <asp:Panel ID="QDDinhChi" runat="server" Visible="true">
                                ...
                                <asp:Panel ID="pntxtLydo" runat="server">
                                    <tr>
                                        <td id="lbtxtLydo" visible="false" runat="server"></td>
                                        <td>Lý do<span class="batbuoc">(*)</span></td>
                                        <td colspan="3">
                                ...
                                <asp:Panel ID="pnSoNgay" runat="server">
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Thông tin chi tiết<span class="batbuoc">(*)</span></td>
                                        <td colspan="3">
                                            <asp:RadioButtonList ID="rdKetqua_Chitiet_QD" runat="server" RepeatDirection="Horizontal">
                                                <asp:ListItem Value="1">Ly hôn</asp:ListItem>
                                                <asp:ListItem Value="3">Không phải là vợ chồng</asp:ListItem>
                                                <asp:ListItem Value="2">Khác</asp:ListItem>
                                            </asp:RadioButtonList>
                                ...
                                <asp:Panel ID="pnHieuLuc" runat="server">
                                    <tr>
                                ...
                                <asp:Panel ID="pnNKCV" runat="server">
                                    <tr>
                                        <td>Người ký</td>
                                        <td>
    ...
    <script type="text/javascript">
        ...
        function ValidInputData() {
          ...
          <%--  var txtNgayhieuluc = document.getElementById('<%=txtNgayhieuluc.ClientID%>');
            ...
            //Kết quả phúc thẩm quyết định và lý do quyết định
            var ddlKetquaQuyetdinh = document.getElementById('<%=ddlKetquaQuyetdinh.ClientID%>');
            val = ddlKetquaQuyetdinh.options[ddlKetquaQuyetdinh.selectedIndex].value;
            if (val == 0) {
                alert('Bạn chưa chọn kết quả phúc thẩm. Hãy chọn lại!');
                ddlKetquaQuyetdinh.focus();
                return false;
            }
            var ddlLydoQuyetdinh = document.getElementById('<%=ddlLydoQuyetdinh.ClientID%>');
            val = ddlLydoQuyetdinh.options[ddlLydoQuyetdinh.selectedIndex].value;
            if (val == 0) {
                alert('Bạn chưa chọn lý do phúc thẩm. Hãy chọn lại!');
            ...
            if (val == 0) {
                alert("Bạn chưa chọn Yếu tố nước ngoài. Hãy chọn lại!");
                ddlYeutonuocngoai.focus();Yếu tố nước ngoài
                return false;
            }
            //Có VKS tham gia
