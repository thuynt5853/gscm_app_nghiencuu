<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pNguoiThamGiaTT.aspx.cs" Inherits="WEB.GSTP.QLAN.AHN.TaoHS.Popup.pNguoiThamGiaTT" %>
            ...
            <div class="form_tt">
                ...
                <div class="boder" style="padding: 10px;">
                      ...
                      <table>
                        ...
                        <tr>
                            <td style="width:150px" class="AHN_ToTung_Col1">Họ tên người TGTT<span class="batbuoc">(*)</span></td>
                            <td class="AHN_ToTung_Col2">
                                <asp:TextBox ID="txtHoten" CssClass="user" runat="server" Width="270px"></asp:TextBox>
                            </td>
                            <td class="AHN_ToTung_Col3">Ngày tham gia</td>
                            <td>
