...
namespace WEB.GSTP.QLAN.AHN.TaoHS
{
    public partial class TaoHosoHN : System.Web.UI.Page
    {
        ...
        private void LoadInfo(decimal ID)
        {
            ...
            AHN_SOTHAM_BANAN oBA = dt.AHN_SOTHAM_BANAN.Where(x => x.DONID == oT.ID).FirstOrDefault() ?? new AHN_SOTHAM_BANAN();
            if (oBA.ID > 0)
            {
            ...
            {
                AHN_SOTHAM_QUYETDINH oQD = dt.AHN_SOTHAM_QUYETDINH.Where(x => x.DONID == oT.ID).FirstOrDefault() ?? new AHN_SOTHAM_QUYETDINH();
                if (oQD.ID > 0)
                {
            ...
            AHN_CHUYEN_NHAN_AN oCN = dt.AHN_CHUYEN_NHAN_AN.Where(x => x.VUANID == oT.ID).FirstOrDefault<AHN_CHUYEN_NHAN_AN>();
            if (oCN != null)
            {
        ...
        private void LoadCombobox()
        {
            ...
            List<DM_QD_QUYETDINH> lst = dt.DM_QD_QUYETDINH.Where(x => x.LOAIID == LoaiQD && x.ISHNGD == 1 && x.ISSOTHAM == 1).OrderBy(y => y.TEN).ToList();
        ...
        public void SaveDuongSu_VUVIEC()
        {
            ...
            if (hddID.Value == "" || hddID.Value == "0")
            {
                ...
                oT.MAVUVIEC = ENUM_LOAIVUVIEC.AN_HONNHAN_GIADINH + donvitao + oT.TT.ToString();
                ...
                if (ddlThuly.SelectedIndex == 0)
                    GD.GAIDOAN_INSERT_UPDATE("3", oT.ID, 2, Convert.ToDecimal(ddlToaxxST.SelectedValue), 0, 0, 0, 0);
        ...
        void UpdateBanAn(decimal VuAnId)
        {
            ...
            DateTime date_temp;
            AHN_SOTHAM_BANAN obj = new AHN_SOTHAM_BANAN();
            if (VuAnId > 0)
            {
                obj = dt.AHN_SOTHAM_BANAN.Where(x => x.DONID == VuAnId).SingleOrDefault<AHN_SOTHAM_BANAN>();
                if (obj != null)
                    IsUpdate = true;
                else
                    obj = new AHN_SOTHAM_BANAN();
            }
            else
                obj = new AHN_SOTHAM_BANAN();
        ...
        {
            Boolean IsUpdate = false;
            AHN_SOTHAM_QUYETDINH oND = new AHN_SOTHAM_QUYETDINH();
            if (VuAnId > 0)
            {
                oND = dt.AHN_SOTHAM_QUYETDINH.Where(x => x.DONID == VuAnId).SingleOrDefault<AHN_SOTHAM_QUYETDINH>();
                if (oND != null)
                    IsUpdate = true;
                else
        ...
        void Chuyenan_Nhanan(decimal VuAnID)
        {
            ...
            if (VuAnID > 0)
            {
                oND = dt.AHN_CHUYEN_NHAN_AN.Where(x => x.VUANID == VuAnID).SingleOrDefault<AHN_CHUYEN_NHAN_AN>();
                if (oND != null)
                    IsUpdate = true;
                else
                    oND = new AHN_CHUYEN_NHAN_AN();
            }
            else
                oND = new AHN_CHUYEN_NHAN_AN();
            ...
            AHN_SOTHAM_KHANGCAO oKC = dt.AHN_SOTHAM_KHANGCAO.Where(x => x.DONID == VuAnID).FirstOrDefault<AHN_SOTHAM_KHANGCAO>();
            AHN_SOTHAM_KHANGNGHI oKN = dt.AHN_SOTHAM_KHANGNGHI.Where(x => x.DONID == VuAnID).FirstOrDefault<AHN_SOTHAM_KHANGNGHI>();
            ...
            AHN_DON oVuAn = dt.AHN_DON.Where(x => x.ID == VuAnID).FirstOrDefault();
            ...
            if (ddlThuly.SelectedIndex == 1)
                GD.GAIDOAN_INSERT_UPDATE_XXLAI_PHUCTHAM("3", VuAnID, 3, Convert.ToDecimal(ddlToaxxST.SelectedValue), Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0);
            else
                GD.GAIDOAN_INSERT_UPDATE("3", VuAnID, 3, 0, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0);
        }
        ...
        protected void cmdXoaHoSo_Click(object sender, EventArgs e)
        {
            ...
            AHN_PHUCTHAM_THULY oTLPT = dt.AHN_PHUCTHAM_THULY.Where(x => x.DONID == ID).FirstOrDefault() ?? new AHN_PHUCTHAM_THULY();
            if (oTLPT.ID == 0)
            {
                AHN_DON oVa = dt.AHN_DON.Where(x => x.ID == ID).First();
                if (oVa != null)
                {
        ...
        {
            //Luu thong tin Giải quyết đơn trước khi xoa
            ...
            if (oBLDS.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oT.ID), 3, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Tạo hồ sơ KC/KN án Hôn nhân", "Xóa", json) == false)
            {
                return;
            }//Ket thuc
            ...
            if (oBL.DELETE_ALLDATA_BY_VUANID(ID + "") == true)
            {
                ...
                GIAI_DOAN_BL GD = new GIAI_DOAN_BL();
                GD.GIAIDOAN_DELETES("3", ID,2);
            }
        }
        public void xoaHN(decimal id)
        {
            AHN_DON_DUONGSU oT = dt.AHN_DON_DUONGSU.Where(x => x.ID == id).FirstOrDefault();
            //Luu thông tin đương sự trước khi xóa
            string strUserName = Session[ENUM_SESSION.SESSION_USERNAME] + "";
            var json = new JavaScriptSerializer().Serialize(oT);
            ADS_DON_BL oBLDS = new ADS_DON_BL();
            if (oBLDS.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oT.ID), 3, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Xoa Duong su trong Tạo hồ sơ KC/KN Hôn nhân", "Xóa", json) == false)
            {
                return;
            }//Ket thuc 

            //Xoa Duong su
            dt.AHN_DON_DUONGSU.Remove(oT);
            dt.SaveChanges();
        }
        ...
        void Load_ListBiCan( decimal vDonid)
        {
            ...
            //Load đương sự
            ddlNguoikhangcao.DataSource = oDSBL.AHN_SOTHAM_DUONGSU_GETBY(vDonid, 1);
        ...
        void Load_ListNguoiThamGiaToTung(decimal vDonid)
        {
            ...
            string hoten = "";
            List<AHN_DON_THAMGIATOTUNG> lst = dt.AHN_DON_THAMGIATOTUNG.Where(x => x.DONID == vDonid).ToList();
            if (lst != null && lst.Count > 0)
            {

                foreach (AHN_DON_THAMGIATOTUNG item in lst)
                {
                    DM_DATAITEM tc = dt.DM_DATAITEM.Where(x => x.MA == item.TUCACHTGTTID).First();
                    hoten = item.HOTEN + " -- " + tc.TEN;
                    ddlNguoikhangcao.Items.Add(new ListItem(hoten, sTGTT + item.ID.ToString()));
                }
        ...
        public void LoadGridKCKN()
        {
            ...
            decimal ID = (string.IsNullOrEmpty(Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH] + "")) ? 0 : Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH] + "");
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                //AHN_SOTHAM_KHANGCAO oKC = dt.AHN_SOTHAM_KHANGCAO.Where(x => x.DONID == DONID).FirstOrDefault();
        ...
        protected void rdbDonVi_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                decimal vdonid = Convert.ToDecimal(hddID.Value);
                AHN_DON oD = dt.AHN_DON.Where(x => x.ID == vdonid).FirstOrDefault();
                decimal ToaAnID = 0;
                if (oD != null)
        ...
        private bool CheckValid(decimal isKhangCao)
        {
            if (isKhangCao == KHANGCAO)// Kháng cáo
            {
                ...
                decimal DONID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH]);
                decimal DSID = Convert.ToDecimal(ddlNguoikhangcao.SelectedValue.Replace(sTGTT,""));
        ...
        protected void lkThemDuongSuKhac_Click(object sender, EventArgs e)
        {
            ...
            string StrMsg = "PopupReport('/QLAN/AHN/TaoHS/Popup/pDuongsu.aspx?hsID=" + DonID.ToString() + "&bID=0','Thêm người tham gia tố tụng',950,450);";
        ...
        protected void lkThemNguoiTGTT_Click(object sender, EventArgs e)
        {
            ...
            string StrMsg = "PopupReport('/QLAN/AHN/TaoHS/Popup/pNguoiThamgiaTT.aspx?hsID=" + DonID.ToString() + "&bID=0','Thêm người tham gia tố tụng',950,450);";
            System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), StrMsg, true);
        }
