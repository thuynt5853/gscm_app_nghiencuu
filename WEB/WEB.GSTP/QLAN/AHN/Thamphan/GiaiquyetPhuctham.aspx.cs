    ...
    public partial class GiaiquyetPhuctham : System.Web.UI.Page
    {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                var currentToaId = Convert.ToDecimal(donviID);
                AHN_DON oT = dt.AHN_DON.Where(x => x.ID == DONID).FirstOrDefault();
                ...
                AHN_PHUCTHAM_HDXX hdxx = dt.AHN_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == currentToaId).FirstOrDefault();
                AHN_PHUCTHAM_QUYETDINH qd = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == currentToaId).FirstOrDefault();
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AHN_DON_THAMPHAN_GETBY(ID, ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETPHUCTHAM);
        ...
        public void xoa(decimal id)
        {
            ...
            if (oBL.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oND.DONID), 3, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Thẩm phán giải quyết Phúc thẩm án Hôn nhân", "Xóa", json) == false)
            {
            ...
            AHN_PHUCTHAM_BANAN AHN_PHUCTHAM_BANAN = dt.AHN_PHUCTHAM_BANAN.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == currentToaId).FirstOrDefault<AHN_PHUCTHAM_BANAN>();
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            //AHN_PHUCTHAM_HDXX hdxx = dt.AHN_PHUCTHAM_HDXX.Where(x => x.DONID == DonID).FirstOrDefault();
            //AHN_PHUCTHAM_QUYETDINH qd = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DonID).FirstOrDefault();
        ...
        private bool CheckQDofThamPhan(decimal DonID,decimal TPID)
        {
            ...
            AHN_PHUCTHAM_QUYETDINH obj_QD = dt.AHN_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DonID && x.NGUOIKYID == TPID).FirstOrDefault<AHN_PHUCTHAM_QUYETDINH>();
            if (obj_QD != null)
            {
