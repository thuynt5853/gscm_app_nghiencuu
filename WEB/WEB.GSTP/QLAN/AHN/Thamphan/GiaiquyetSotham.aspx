<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="GiaiquyetSotham.aspx.cs" Inherits="WEB.GSTP.QLAN.AHN.Thamphan.GiaiquyetSotham" %>
                    ...
                    <table class="table1">
                        <tr>
                            ...
                            <td style="width: 260px;">
                                <asp:DropDownList ID="ddlThamphan"  AutoPostBack="true" OnSelectedIndexChanged="myListDropDown_Change"  CssClass="chosen-select" runat="server" Width="250px"></asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNgayphancong" runat="server"   CssClass="user" Width="110px" 
                                   AutoPostBack="true" MaxLength="10" OnTextChanged="txtNgayphancong_TextChanged"></asp:TextBox>
                            ...
                            <asp:Panel runat="server" ID="pndata" Visible="false">
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="NGAYPHANCONG" HeaderText="Ngày phân công" HeaderStyle-Width="127px" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="NGAYNHANPHANCONG" HeaderText="Ngày nhận phân công" HeaderStyle-Width="127px" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        ...
                                        </asp:TemplateColumn> <asp:TemplateColumn HeaderStyle-Width="80px" ItemStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>
                                                Thao tác
                                            </HeaderTemplate>
                                            <ItemTemplate>
