...
namespace WEB.GSTP.QLAN.AHN.Thamphan
{
    public partial class GiaiquyetPhucthamKCKNQDK : System.Web.UI.Page
    {
        ...
        void check_Quyen(decimal DONID)
        {
            ...
            DataTable oDT = oBL.AHN_PHUCTHAM_KCKN_TGTT_GETLIST(DONID);
            ...
            AHN_KCKN_PHUCTHAM_BL BL = new AHN_KCKN_PHUCTHAM_BL();
            DataTable DT = BL.AHN_KCKNQDK_PHUCTHAM_HDXX_GETLIST(DONID);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AHN_KCKNQDK_PHUCTHAM_HDXX oTHTT = DataExtensions.GetAllWithClause<AHN_KCKNQDK_PHUCTHAM_HDXX>($"DONID = {DONID} AND MAVAITRO = '{ENUM_NGUOITIENHANHTOTUNG.THAMPHAN}' AND TOA_GIAIQUYET_ID = {Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID])}").FirstOrDefault();
                if (oTHTT == null)
                {
                    oTHTT = new AHN_KCKNQDK_PHUCTHAM_HDXX();
                    oTHTT.DONID = DONID;
