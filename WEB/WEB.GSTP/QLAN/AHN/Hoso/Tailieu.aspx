...
AutoEventWireup="true" CodeBehind="Tailieu.aspx.cs"
Inherits="WEB.GSTP.QLAN.AHN.Hoso.Tailieu" %> <%@ Register
...
>
  ...
  <asp:HiddenField ID="hddTotalPageFile" Value="1" runat="server" />
  <asp:HiddenField ID="hddPageIndexFile" Value="1" runat="server" />
          ...
          <table class="table1">
            <tr>
              <td style="width: 130px">
                Ngày bàn giao<span class="batbuoc">(*)</span>
              </td>
              <td>
                <asp:TextBox
                  ID="txtNgayBanGiao"
                ...
                <cc1:CalendarExtender
                  ...
                  runat="server"
                  TargetControlID="txtNgayBanGiao"
                  Format="dd/MM/yyyy"
                  Enabled="true"
                />
            ...
            <tr>
              ...
              <td>
                <asp:RadioButtonList
                  ...
                  AutoPostBack="true"
                  OnSelectedIndexChanged="rdbTuCachToTung_SelectedIndexChanged"
                >
                  <asp:ListItem Value="0" Text="Người khởi kiện"></asp:ListItem>
                  <asp:ListItem
                    Value="1"
                    Text="Người được ủy quyền nguyên đơn"
                  ></asp:ListItem>
                </asp:RadioButtonList>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <asp:DropDownList
                  ...
                  Width="250px"
                  AutoPostBack="true"
                  OnSelectedIndexChanged="ddlNguoiBanGiao_SelectedIndexChanged"
                ></asp:DropDownList>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <asp:Button
                  ...
                  Text="Lưu"
                  OnClientClick="return ValidDataInput();"
          ...
          <asp:Panel runat="server" ID="pndata">
            ...
            >
              <Columns>
                ...
                ></asp:BoundColumn>
                <asp:BoundColumn
                  DataField="NGUOIBANGIAO"
                  HeaderText="Họ tên người giao"
                  HeaderStyle-HorizontalAlign="Center"
                ></asp:BoundColumn>
                <asp:BoundColumn
                  DataField="TenLoaiDoiTuong"
                  HeaderText="Tư cách tố tụng"
  ...
  <script type="text/javascript">
    function ValidDataInput() {
      var txtNgayBanGiao = document.getElementById(
        "<%=txtNgayBanGiao.ClientID%>"
      );
      if (!CheckDateTimeControl(txtNgayBanGiao, "Ngày bàn giao")) return false;
      var NgayBanGiao = txtNgayBanGiao.value;

      var hddNgayNhanDon = document.getElementById(
        "<%=hddNgayNhanDon.ClientID%>"
      );
      ...
      if (
        ...
        return false;
      //----------------------------
      var rdbTuCachToTung = document.getElementById(
        "<%=rdbTuCachToTung.ClientID%>"
      );
      var msg = "Bạn chưa chọn tư cách tố tụng. Hãy chọn lại!";
      if (!CheckChangeRadioButtonList(rdbTuCachToTung, msg)) return false;
      //----------------------------
      var ddlNguoiBanGiao = document.getElementById(
        "<%=ddlNguoiBanGiao.ClientID%>"
      );
      ...
      if (!Common_CheckEmpty(txtTenTL.value)) {
        alert("Bạn chưa nhập tên tài liệu. Hãy kiểm tra lại!");
        txtTenTL.focus();
        return false;
      }
