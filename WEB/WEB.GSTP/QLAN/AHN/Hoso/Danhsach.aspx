<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Danhsach.aspx.cs" Inherits="WEB.GSTP.QLAN.AHN.Hoso.Danhsach" %>
                                            ...
                                            <ItemTemplate>
                                                &nbsp;
                                                   <asp:Button ID="cmdChitiet" runat="server" Text="Chọn vụ việc"
                                                       ...
                                                       CommandName="Select" CommandArgument='<%#Eval("ID") %>' /></div>
                                                <div>&nbsp;</div>
