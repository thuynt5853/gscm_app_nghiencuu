<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Thongtindon.aspx.cs" Inherits="WEB.GSTP.QLAN.AHN.Hoso.Thongtindon" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/QLAN/AHN/Hoso/Popup/pDuongSuDonCha.ascx" TagPrefix="uc1" TagName="DsHNDuongSu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="box_nd">
            <div class="truong">
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTennguyendon" CssClass="user" runat="server" Width="242px"   ClientIDMode="Static"></asp:TextBox></td>
                            ...
                            <tr>
                                ...
                                <td>Ngày sinh <span class="batbuoc">(*)</span></td>
                                <td>
                                    <asp:TextBox ID="txtND_Ngaysinh" runat="server" CssClass="user" Width="65px" MaxLength="10" AutoPostBack="True" OnTextChanged="txtND_Ngaysinh_TextChanged" ClientIDMode="Static"></asp:TextBox>
                                    ...
                                    <asp:TextBox ID="txtND_Namsinh" CssClass="user" onkeypress="return isNumber(event)" runat="server" Width="35px" MaxLength="4"></asp:TextBox>
                                    Tuổi
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtND_CMND" CssClass="user" runat="server" Width="242px" MaxLength="250"  ClientIDMode="Static"></asp:TextBox>
                                </td>
                                 <td>Hộ chiếu
                            ...
                            <asp:Panel ID="pnNDCanhan" runat="server">
                                <tr>
                                    <td>Giới tính</td>
                                    <td colspan="3">
                                        <asp:DropDownList ID="ddlND_Gioitinh" CssClass="chosen-select" runat="server" Width="250px"  ClientIDMode="Static" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlTamTru_Tinh_NguyenDon" CssClass="chosen-select" runat="server" Width="123px" AutoPostBack="true" OnSelectedIndexChanged="ddlTamTru_Tinh_NguyenDon_SelectedIndexChanged" ClientIDMode="Static" ></asp:DropDownList>
                                        <asp:DropDownList ID="ddlTamTru_Huyen_NguyenDon" CssClass="chosen-select" runat="server" Width="123px" ClientIDMode="Static" ></asp:DropDownList>
                                    </td>
                                    <td>Chi tiết
                                    </td>
                                    <td>

                                        <asp:TextBox ID="txtND_TTChitiet" CssClass="user" runat="server" Width="242px" MaxLength="250"  ClientIDMode="Static"></asp:TextBox>
                                    </td>
                                </tr>
                ...
                <div class="boxchung">
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lbl_tenbidon" runat="server" Text="Tên bị đơn"   ClientIDMode="Static"></asp:Label><span class="batbuoc">(*)</span></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Ngày sinh <span class="batbuoc">(*)</span></td>
                                    <td>
                                        <asp:TextBox ID="txtBD_Ngaysinh" runat="server" CssClass="user" Width="65px" MaxLength="10" AutoPostBack="True" OnTextChanged="txtBD_Ngaysinh_TextChanged"  ClientIDMode="Static"></asp:TextBox>
                                        ...
                                        Năm sinh<span class="batbuoc">(*)</span>
                                        <asp:TextBox ID="txtBD_Namsinh" CssClass="user" runat="server" onkeypress="return isNumber(event)" Width="35px" MaxLength="4"></asp:TextBox>
                                        Tuổi
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtBD_CMND" CssClass="user" runat="server" Width="242px" MaxLength="250"   ClientIDMode="Static"></asp:TextBox>
                                </td>
                                <td>Hộ chiếu
                            ...
                            <asp:Panel ID="pnBD_Canhan" runat="server">
                                <tr>
                                    <td>Giới tính</td>
                                    <td colspan ="3">
                                        <asp:DropDownList ID="ddlBD_Gioitinh" CssClass="chosen-select" runat="server" Width="250px" ClientIDMode="Static">
                                             <asp:ListItem Value="0" Text="Chọn" Selected ="True"></asp:ListItem>
                                            <asp:ListItem Value="1" Text="Nam"></asp:ListItem>
                                            <asp:ListItem Value="2" Text="Nữ"></asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    <td>Nơi cư trú</td>
                                    <td>
                                        <asp:DropDownList ID="ddlTamTru_Tinh_BiDon" CssClass="chosen-select" runat="server" Width="123px" AutoPostBack="true" OnSelectedIndexChanged="ddlTamTru_Tinh_BiDon_SelectedIndexChanged" ClientIDMode="Static"></asp:DropDownList>
                                        <asp:DropDownList ID="ddlTamTru_Huyen_BiDon" CssClass="chosen-select" runat="server" Width="123px" ClientIDMode="Static"></asp:DropDownList>
                                    </td>
                                    <td>Chi tiết</td>
                                    <td>
                                        <asp:TextBox ID="txtBD_Tamtru_Chitiet" CssClass="user" runat="server" Width="242px" MaxLength="250"   ClientIDMode="Static"></asp:TextBox>
                                    </td>
                                </tr>
                ...
                <div style="margin: 5px; width: 99%;">
                    <uc1:DsHNDuongSu runat="server" ID="DsHNDuongSu1" />
                </div>
                <div style="margin: 5px; text-align: center; width: 95%; color: red;">
    ...
    <script type="text/javascript">
        function pageLoad(sender, args) {
            ...
            // Nếu HiddenField chứa huyện đã có giá trị từ popup, set dropdown Huyện tự động
            var hidHuyen = document.getElementById('hidTamTru_Huyen_NguyenDon');
            var ddlHuyen = document.getElementById('ddlTamTru_Huyen_NguyenDon');
            if (hidHuyen && ddlHuyen && hidHuyen.value) {
                ddlHuyen.value = hidHuyen.value;
                $(".chosen-select").trigger("chosen:updated");
            }
            var hidHuyenBD = document.getElementById('hidTamTru_Huyen_BiDon');
            var ddlHuyenBD = document.getElementById('ddlTamTru_Huyen_BiDon');
            if (hidHuyenBD && ddlHuyenBD && hidHuyenBD.value) {
                ddlHuyenBD.value = hidHuyenBD.value;
                $(".chosen-select").trigger("chosen:updated");
            }
        }
