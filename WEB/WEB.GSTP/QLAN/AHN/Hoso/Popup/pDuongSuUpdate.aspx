<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pDuongSuUpdate.aspx.cs" Inherits="WEB.GSTP.QLAN.AHN.Hoso.Popup.pDuongSuUpdate" %>
                                ...
                                <table class="table1">
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <asp:CheckBox ID="chkBoxCMNDND" Visible="false" AutoPostBack="true" runat="server" Text="Không có" OnCheckedChanged="chkBoxCMNDND_CheckedChanged" />
                                        </td>
                                        <td></td>
                                        <td>
                                            <asp:CheckBox ID="chkKhongLamSachND" AutoPostBack="true" runat="server" Text="Đương sự Không thể làm sạch được" />
                                        </td>
                                    </tr>
                                </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlND_Gioitinh" CssClass="chosen-select" runat="server" Width="250px">
                                                    <asp:ListItem Value="2" Text="Chọn" Selected ="True"></asp:ListItem>
