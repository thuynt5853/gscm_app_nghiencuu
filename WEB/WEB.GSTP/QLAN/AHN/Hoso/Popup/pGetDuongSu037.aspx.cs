                                    ...
                                    if (window.opener && !window.opener.closed) {{
                                        ...
                                        if (caller === 'DuongSu') {{
                                            ...
                                            if (window.opener.__doPostBack) {{
                                                window.opener.__doPostBack('ddlNoiSongTinh', '');
                                            }}
                                        }}
                                            ...
                                            if (window.opener.__doPostBack) {{
                                                window.opener.__doPostBack('ddlTamTru_Tinh_NguyenDon', '');
                                            }}
                                        }}
                                            ...
                                            if (window.opener.__doPostBack) {{
                                                window.opener.__doPostBack('ddlTamTru_Tinh_BiDon', '');
                                            }}
                                        }}
                                        else {{
