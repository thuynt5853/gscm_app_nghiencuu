...
namespace WEB.GSTP.QLAN.AHN.Hoso.Popup
{
    public partial class pDuongSuKhac : System.Web.UI.UserControl
    {
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Xoa":
                    ...
                    DON_DUONGSU_CHITIET ds = dt.DON_DUONGSU_CHITIET.Where(x => x.DUONGSUID == ND_id && x.LOAIAN == 3).FirstOrDefault();
                    if (ds == null)
                    {
                        xoa(ND_id);
                    }
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AHN_DON_DUONGSU_NOTDAIDIEN(DonID);
        ...
        protected void lkThemNguoiTGTT_Click(object sender, EventArgs e)
        {
            ...
            StrMsg = "PopupReport('/QLAN/AHN/Hoso/Popup/pDuongsu.aspx?hsID=" + DonID.ToString() + "&bID=0','Thêm đương sự',950,450);";
