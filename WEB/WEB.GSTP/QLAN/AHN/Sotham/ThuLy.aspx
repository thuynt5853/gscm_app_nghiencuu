<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="ThuLy.aspx.cs" Inherits="WEB.GSTP.QLAN.AHN.Sotham.ThuLy" %>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="lbtXoaSothulyKhongSuDungLai" runat="server" CausesValidation="false" Text="Xóa số thụ lý" ForeColor="#0e7eee"
                                                    CommandName="XoaSothulyKhongSuDungLai" CommandArgument='<%#Eval("ID") %>' ToolTip="Xóa" OnClientClick="return confirm('Số thụ lý này sẽ không được sử dụng lại, bạn chắc chắn muốn xóa bản ghi này? ');"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
