...
AutoEventWireup="true" CodeBehind="Hoagiai.aspx.cs"
Inherits="WEB.GSTP.QLAN.AHN.Sotham.Hoagiai" %> <%@ Register
            ...
            <tr>
              ...
              <td style="width: 300px">
                ...
                >
                  <asp:ListItem
                    Value="1"
                    Text="Thông báo hòa giải"
                  ></asp:ListItem>

                  <asp:ListItem
                    Value="2"
                    Text="Thông báo hoãn hòa giải"
                  ></asp:ListItem>
                </asp:DropDownList>
              </td>
                ...
                >
                  <Columns>
                    ...
                    <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center">
                      <HeaderTemplate> Loại thông báo </HeaderTemplate>
                      <ItemTemplate>
                    ...
                    >
                      ...
                      <ItemTemplate> <%#Eval("SO") %> </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:BoundColumn
                      DataField="NGAY"
                      HeaderText="Ngày thông báo"
