...
namespace WEB.GSTP.QLAN.AHN.Sotham
{
    public partial class BananSotham : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                DSID = (String.IsNullOrEmpty(Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH] + "")) ? 0 : Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH]);
                ...
                if (anKetThuc)
                {
                    lbthongbaoBA.Text = lbthongbaoQD.Text = "Vụ việc đã kết thúc tại tòa cũ, không thể chỉnh sửa tại tòa mới !";
                    DisableButtonsBanan();
        ...
        void SetNewSoQD()
        {
            ...
            AHN_SOTHAM_BL oSTBL = new AHN_SOTHAM_BL();
        ...
        bool CheckCongbo(decimal ID)
        {
            var list = DataExtensions.GetAllWithClause<BAQD_CONGBO>(
                $"VUVIECID = {ID} AND LOAIANID = {ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH} AND CAPXETXU = 2 AND TRANGTHAI IN (2,3)"
            );
            ...
            if (lstCongbo != null)
            {
                DisableButtonsBanan();
                DisableButtonsQuyetdinh();
                lbthongbaoBA.Text = lbthongbaoQD.Text = "Đã có thông tin về công bố!";
                return false;
            }
        ...
        private void CheckQuyen(decimal ID)
        {
            ...
            DataTable oDT = oBL.DGLIST_BAQD_QUYETDINH_KETTHUC_ST(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH, ID);
            if (oDT.Rows.Count > 0)
            {
                pnQDVV.Visible = true;
                ...
                lbthongbaoBA.Text = lbthongbaoQD.Text = "Vụ viêc đã có quyết định kết thúc!";
                DisableButtonsQuyetdinh();
            }
            else
            {
            ...
            if (lstCount.Count == 0)
            {
                lbthongbaoBA.Text = lbthongbaoQD.Text = "Chưa cập nhật thông tin thụ lý sơ thẩm !";
                DisableButtonsBanan();
                DisableButtonsQuyetdinh();
                return;
            }
            ...
            List<AHN_DON_THAMPHAN> lstTPGQ = dt.AHN_DON_THAMPHAN.Where(x => x.DONID == ID && x.MAVAITRO == "VTTP_GIAIQUYETSOTHAM").ToList();
            if (lstTPGQ.Count == 0)
            {
                lbthongbaoBA.Text = lbthongbaoQD.Text = "Chưa cập nhật thông tin hội đồng xét xử !";
                DisableButtonsBanan();
                DisableButtonsQuyetdinh();
                return;
            }
            ...
            List<AHN_SOTHAM_HDXX> lstTPCT = dt.AHN_SOTHAM_HDXX.Where(x => x.DONID == ID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).ToList();
            if (lstTPCT.Count == 0)
            {
                lbthongbaoBA.Text = lbthongbaoQD.Text = "Chưa cập nhật thông tin hội đồng xét xử !";
                DisableButtonsBanan();
            ...
            //kiem tra neu Duong su chua duoc xác thuc thì không cho lưu
            //List<AHN_DON_DUONGSU> lstDS = dt.AHN_DON_DUONGSU.Where(x => x.DONID == ID && x.XACTHUC_DLDCQG == 0 && x.QUOCTICHID == 2).ToList();
            //if (lstDS.Count > 0)
            //{
            //    lbthongbaoBA.Text = lbthongbaoQD.Text = "Bạn cần xác thực thông tin Đương sự!";
            //    DisableButtonsBanan();
            //    DisableButtonsQuyetdinh();

            //    Cls_Comon.SetButton(cmdHuyBanAn, true);
            //    Cls_Comon.SetButton(cmdXoaAnphi, true);
            //    Cls_Comon.SetButton(cmdXoaTGTT, true);
            //    return;
            //}
        ...
        private bool CheckQuyenSua(decimal ID)
        {
            ...
            AHN_SOTHAM_BANAN ba = dt.AHN_SOTHAM_BANAN.Where(x => x.DONID == ID).FirstOrDefault();
            if (ba != null)
            {
                lbthongbaoQD.Text = lbthongbaoQD.Text = "Vụ việc đã có bản án. Không được sửa đổi.";
                DisableButtonsQuyetdinh();
            }
            else
            {
            ...
            if (oT != null)
            {
                ...
                {
                    lbthongbaoBA.Text = lbthongbaoQD.Text = "Vụ việc đã được chuyển lên tòa cấp trên, không được sửa đổi !";
                    DisableButtonsBanan();
                    DisableButtonsQuyetdinh();
                    return false;
                }
            ...
            List<AHN_SOTHAM_QUYETDINH> qdKetThuc = dt.AHN_SOTHAM_QUYETDINH.Where(x => x.DONID == ID && dmQDIds.Contains(x.QUYETDINHID.Value)).ToList();
            if (ba != null && qdKetThuc != null)
            {
                AHN_SOTHAM_KHANGCAO kc2 = dt.AHN_SOTHAM_KHANGCAO.Where(x => x.DONID == ID).FirstOrDefault();
                if (kc2 != null)
                {

                    lbthongbaoBA.Text = lbthongbaoQD.Text = "Vụ việc đã có kháng cáo. Không được sửa đổi.";
                    DisableButtonsBanan();
                    DisableButtonsQuyetdinh();
                    return false;
                }

                AHN_SOTHAM_KHANGNGHI kn2 = dt.AHN_SOTHAM_KHANGNGHI.Where(x => x.DONID == ID).FirstOrDefault();
                if (kn2 != null)
                {
                    lbthongbaoBA.Text = lbthongbaoQD.Text = "Vụ việc đã có kháng nghị. Không được sửa đổi.";
                    DisableButtonsBanan();
                    DisableButtonsQuyetdinh();
                    return false;
                }
            ...
            if (Result != "")
            {
                lbthongbaoBA.Text = lbthongbaoQD.Text = Result;
                DisableButtonsBanan();
                DisableButtonsQuyetdinh();
                return false;
            }
            #region hieu nếu có tống đạt thì ko được xóa bản án sơ thẩm
            AHN_TONGDAT td = dt.AHN_TONGDAT.Where(x => x.DONID == ID && (x.BIEUMAUID == 230 || x.BIEUMAUID == 261)).FirstOrDefault();
            if (td != null)
            {
                lbthongbaoBA.Text = lbthongbaoQD.Text = "Vụ việc đã tống đạt không được xóa";
                DisableButtonsBanan();
                DisableButtonsQuyetdinh();
                return false;
            }
            ...
            if (ba != null)
            {
                ...
                bool isExist = oDonBL.IsExistKHOBADQ(0, ba.DONID ?? 0, 2, ENUM_LOAIVUVIEC_TEXT.AN_HONNHAN_GIADINH);
                if (isExist)
                {
                    lbthongbaoBA.Text = lbthongbaoQD.Text = "Vụ việc đã được chia sẻ dữ liệu. Không được xóa.";
                    DisableButtonsBanan();
                    DisableButtonsQuyetdinh();
                    return false;
                }
        ...
        {
            decimal ID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH] + "" == "" ? "0" : Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH] + "");
            DM_QUYETDINH_VUAN_KETTHUC oBL = new DM_QUYETDINH_VUAN_KETTHUC();
            DataTable oDT = oBL.DGLIST_BAQD_QUYETDINH_KETTHUC_ST(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH, ID);
        ...
        protected void lbtDownload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AHN_FILE oND = dt.AHN_FILE.Where(x => x.DONID == DONID).FirstOrDefault();
                if (oND.TENFILE != "")
                {
            ...
            catch (Exception ex) { lbthongbaoBA.Text = ex.Message; return; }
        }
        ...
        private void LoadQD()
        {
            ...
            DM_QUYETDINH_VUAN_KETTHUC oBL = new DM_QUYETDINH_VUAN_KETTHUC();
            DataTable oDT = oBL.DM_QUYETDINH_VUAN_SOTHAM_KETTHUC(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH);
        ...
        private void LoadNguoiKyInfo()
        {
            ...
            AHN_SOTHAM_HDXX oND = dt.AHN_SOTHAM_HDXX.Where(x => x.DONID == DonID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).OrderByDescending(x => x.NGAYPHANCONG).FirstOrDefault<AHN_SOTHAM_HDXX>();
            if (oND != null)
            {
            ...
            {
                AHN_DON_THAMPHAN oTP = dt.AHN_DON_THAMPHAN.Where(x => x.DONID == DonID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETSOTHAM).OrderByDescending(x => x.NGAYPHANCONG).FirstOrDefault();
                if (oTP != null)
                {
        ...
        {
            txtTomtatnoidungQuyetdinh.Text = "";
            ddlLoaiQD.SelectedIndex = 0;
            ddlLoaiQD_SelectedIndexChanged(new object(), new EventArgs());
            ddlQuyetdinh.SelectedIndex = 0;
            ddlCBBA_AnleQD.SelectedValue = "0";
            rdVKSThamgia_QD.ClearSelection();
            txtSoQDTraiPLBiHuy_QD.Text = "";

            LoadDuongSuYC();
            txtNgayQD.Text = DateTime.Now.ToString("dd/MM/yyyy");
            txtSoQD.Text = txtHieuLucDenNgay.Text = hddFilePath.Value = lbthongbaoBA.Text = "";
            //hddDonID.Value = "0";
            rblHoagiadoantu.ClearSelection();
        }
        protected void btnLammoi_Click(object sender, EventArgs e)
        {
            Decimal ID = Convert.ToDecimal(hddDonID.Value);
            List<AHN_SOTHAM_QUYETDINH> lstQD = dt.AHN_SOTHAM_QUYETDINH.Where(x => x.DONID == ID && (x.LOAIQDID == 10 || x.QUYETDINHID == 423 || x.QUYETDINHID == 422 || x.QUYETDINHID == 70 || x.QUYETDINHID == 425 || x.LOAIQDID == 3 || x.LOAIQDID == 23)).ToList();
            if (lstQD.Count >= 1)
            {
        ...
        public void xoa(decimal id)
        {
            ...
            if (oND.NOIDUNG == null && oND.QT_FILE_ID != null)
            {
                ...
                {
                    qtFileDelete.DESCRIPTION = "Tài khoản " + Session[ENUM_SESSION.SESSION_USERNAME] + " đã xóa file tại form BanAnSoTham " + ENUM_LOAIAN.AN_HONNHAN_GIADINH + ".";
                    QT_FILE_BL fileH = new QT_FILE_BL();
                    fileH.DeleteFileLogic(qtFileDelete);
                }
            }
            TK_SOTHAM_QUYETDINH TK = DataExtensions.GetAllWithClause<TK_SOTHAM_QUYETDINH>($"QUYETDINHID = {id} AND LOAIAN =  {Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH)}").FirstOrDefault();
            if (TK != null)
            {
            ...
            var list = DataExtensions.GetAllWithClause<BAQD_CONGBO>($"  VUVIECID = {oND.DONID.Value} " +
                                                                    $"  AND LOAIANID = {Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH)} " +
                                                                    $"  AND CAPXETXU = {2} ");
            ...
            //{
            //    lbthongbaoBA.Text = "Quyết định đang chọn thuộc thẩm quyền của tòa án khác, không được phép xóa !";
            //    return;
            //}
            //if (oND != null)
            ...
            if (CheckQuyenSua(Convert.ToDecimal(oND.DONID + "")) == true)
            {
                if (oND != null)
                {
                    ...
                    LoadGrid();
                    ResetControl_Quyetdinh();
                    lbthongbaoBA.Text = "Xóa thành công!";
        ...
        protected void btnUpdate_Quyetdinh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    TK = DataExtensions.GetAllWithClause<TK_SOTHAM_QUYETDINH>($"QUYETDINHID= {ID} AND LOAIAN =  {Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH)}").FirstOrDefault();

                    oND = dt.AHN_SOTHAM_QUYETDINH.Where(x => x.ID == ID).FirstOrDefault();
                    if (oND.TOAANID.ToString() != Session[ENUM_SESSION.SESSION_DONVIID].ToString())
                    {
                        lbthongbaoBA.Text = "Quyết định đang chọn thuộc thẩm quyền của tòa án khác, không được phép thay đổi !";
                        return;
                    }
                    if (oND.FILEID != null) FileID = (decimal)oND.FILEID;
                }
                try
                {
                    if (hddFilePathQD.Value != "")
                    {
                        ...
                        QT_FILE qtFile = fileHelper.InsertFile_Minio_Banan(strFilePath, Convert.ToInt32(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH), "BANANSOTHAM");
                        if (qtFile == null)
                        {
                            lbthongbaoBA.Text = "Lỗi khi lưu file!";
                            return;
                        }
                        #region Lưu file
                        //byte[] buff = null;
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Lỗi: Lưu file không thành công!')", true);
                }
                ...
                if (!ddlQuyetdinh.SelectedItem.Text.Contains("19-VDS") && ddlQuyetdinh.SelectedValue != "4")
                {
                    ...
                    TK.DONID = DONID;
                    TK.LOAIAN = Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH);
                    TK.ISVKSTHAMGIA = rdVKSThamgia_QD.SelectedValue == "" ? 0 : Convert.ToDecimal(rdVKSThamgia_QD.SelectedValue);
                    ...
                    if (ddlQuyetdinh.SelectedItem.Text.Contains("38-DS") || ddlQuyetdinh.SelectedItem.Text.Contains("39-DS") || ddlQuyetdinh.SelectedItem.Text.Contains("45-DS") || ddlQuyetdinh.SelectedItem.Text.Contains("46-DS") || ddlQuyetdinh.SelectedItem.Text.Contains("40-DS"))
                    {
                        TK.TONGSOCONDUOI18TUOI = (String.IsNullOrEmpty(txtTongsoconduoi18tuoi_QD.Text + "")) ? 0 : Convert.ToDecimal(txtTongsoconduoi18tuoi_QD.Text);
                        TK.SOCONDUOI18LANU = (String.IsNullOrEmpty(txtSoconduoi18tuoi_QD.Text + "")) ? 0 : Convert.ToDecimal(txtSoconduoi18tuoi_QD.Text);
                        TK.SOCONDUOI7TUOI = (String.IsNullOrEmpty(txtSoconduoi7tuoi_QD.Text + "")) ? 0 : Convert.ToDecimal(txtSoconduoi7tuoi_QD.Text);
                        ...
                        if (ddlQuyetdinh.SelectedItem.Text.Contains("40-DS"))
                        {
                            TK.ISVKSTHAMGIA = rdVKSThamgia_QD.SelectedValue == "" ? 0 : Convert.ToDecimal(rdVKSThamgia_QD.SelectedValue);
                            TK.ISHOAGIAITHANH = rdqHoaGiaiThanhQD.SelectedValue == "" ? 0 : Convert.ToDecimal(rdqHoaGiaiThanhQD.SelectedValue);
                        }
                    }
                    if (chkKhongchapnhan_QD.Checked)
                    {
                        TK.TK_ISKHONGCHAPNHAN = 1;
                        if (rdLydokhongchapnhan_QD.SelectedValue == "0") TK.TK_ISCHAPNHANDON = 1;
                        if (rdLydokhongchapnhan_QD.SelectedValue == "1") TK.TK_ISKHONGCONGNHANVC = 1;
                        if (rdLydokhongchapnhan_QD.SelectedValue == "2") TK.TK_ISKHONGCHAPNHAN_KQKHAC = 1;
                    }
                    else
                    {
                        TK.TK_ISKHONGCHAPNHAN = 0;
                        TK.TK_ISCHAPNHANDON = 0;
                        TK.TK_ISKHONGCONGNHANVC = 0;
                        TK.TK_ISKHONGCHAPNHAN_KQKHAC = 0;
                    }
                    if (chkChapnhan_QD.Checked)
                    {
                        TK.TK_ISCHAPNHAN = 1;
                        if (rdLydoChapnhan_QD.SelectedValue == "1") TK.TK_CHOLYHON = 1; else TK.TK_CHOLYHON = 0; /*if (chkCholyhon_QD.Checked) TK.TK_CHOLYHON = 1;*/
                        if (rdLydoChapnhan_QD.SelectedValue == "2") TK.TK_ISCHAPNHAN_KQKHAC = 1; else TK.TK_ISCHAPNHAN_KQKHAC = 0;
                    }
                    else
                    {
                        TK.TK_ISCHAPNHAN = 0;
                ...
                if (oQDT.ISCONGBO == 1 && oND.HIEULUCTU != null)
                {
                    ...
                    temp_congbo.LOAIANID = Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH);
                ...
                ResetControl_Quyetdinh();
                LoadGrid();
                lbthongbaoBA.Text = lbthongbaoQD.Text = "Lưu thành công!";
            }
            catch (Exception ex)
            {
                lbthongbaoBA.Text = lbthongbaoQD.Text = "Lỗi: " + ex.Message;
            }
        }
        ...
        protected void AsyncFileUpLoad_UploadedCompleteQD(object sender, AjaxControlToolkit.AsyncFileUploadEventArgs e)
        {
            ...
            lbthongbaoQD.Text = "Đang tải file...";
            try
            {
            ...
            lbthongbaoQD.Text = "File đã tải thành công";
        }
        private decimal UploadFileID(AHN_DON oDon, decimal FileID, string strMaBieumau, decimal STT)
        {
            ...
            if (hddFilePath.Value != "")
            {
                ...
                catch (Exception ex) { lbthongbaoBA.Text = ex.Message; }
            }
        ...
        private decimal UploadFileIDQD(AHN_DON oDon, decimal FileID, string strMaBieumau, decimal STT)
        {
            AHN_DON_BL oBL = new AHN_DON_BL();
            decimal IDFIle = 0;
            decimal IDBM = 0;
        ...
        private void TamNgungDONKK_USER_DKNHANVB(decimal DONID, string TenQuyetDinh)
        {
            ...
            DONKK_USER_DKNHANVB obj = dkk.DONKK_USER_DKNHANVB.FirstOrDefault(s => s.MAVUVIEC == oDon.MAVUVIEC && s.VUVIECID == oDon.ID && s.MALOAIVUVIEC == ENUM_LOAIAN.AN_HONNHAN_GIADINH && s.TRANGTHAI == 1);
            if (obj != null)
            {
        ...
        {
            var oNDs = dt.AHN_SOTHAM_QUYETDINH.Where(x => x.ID == ID).ToArray();
            if (oNDs != null && oNDs.Length > 0)
            {
                AHN_SOTHAM_QUYETDINH oND = oNDs.FirstOrDefault();
                ...
                try
                {
                    ...
                    if (oQD != null)
                    {
                        if (/*oQD.MA == "TDC" || */oND.LOAIQDID == 10 || oND.LOAIQDID == 11 || oND.LOAIQDID == 3 || oND.LOAIQDID == 23)
                        {
                            //ddlQuyetdinh.Enabled = true;
                            pnCBQD.Visible = true;
                            Cls_Comon.SetButton(btnUpdate, true);
                    ...
                    if (TK != null)
                    {
                        ...
                        if (TK.ISVKSTHAMGIA != null) rdVKSThamgia_QD.SelectedValue = TK.ISVKSTHAMGIA.ToString();
                        ...
                        txtSoconduoi7tuoi_QD.Text = TK.SOCONDUOI7TUOI + "";
                        txtSoconduoi18tuoi_QD.Text = TK.SOCONDUOI18LANU + "";
                        txtTongsoconduoi18tuoi_QD.Text = TK.TONGSOCONDUOI18TUOI + "";

                        chkKhongchapnhan_QD.Checked = (TK.TK_ISKHONGCHAPNHAN + "") == "1" ? true : false;
                        if (chkKhongchapnhan_QD.Checked)
                        {
                            if ((TK.TK_ISCHAPNHANDON + "") == "1") rdLydokhongchapnhan_QD.SelectedValue = "0";
                            if ((TK.TK_ISKHONGCONGNHANVC + "") == "1") rdLydokhongchapnhan_QD.SelectedValue = "1";
                            if ((TK.TK_ISKHONGCHAPNHAN_KQKHAC + "") == "1") rdLydokhongchapnhan_QD.SelectedValue = "2";

                            rdLydokhongchapnhan_QD.Visible = true;
                            div_LyDo_QD.Visible = true;
                        }

                        chkChapnhan_QD.Checked = (TK.TK_ISCHAPNHAN + "") == "1" ? true : false;
                        ...
                        if (chkChapnhan_QD.Checked)
                        {
                            ...
                            if ((TK.TK_CHOLYHON + "") == "1")
                            {
                                rdLydoChapnhan_QD.SelectedValue = "1";
                            }

                            if ((TK.TK_ISCHAPNHAN_KQKHAC + "") == "1")
                            {
                                rdLydoChapnhan_QD.SelectedValue = "2";
                            }
                    ...
                    if (pnDuongSuYC.Visible)
                    {
                        if (oND.NGUOIYEUCAUID != null) ddlNguoiYC.SelectedValue = oND.NGUOIYEUCAUID.ToString();
                        ddlNguoiYC_SelectedIndexChanged(new object(), new EventArgs());
                        if (oND.NGUOIBIYEUCAUID != null) ddlNguoiBiYC.SelectedValue = oND.NGUOIBIYEUCAUID.ToString();
                        txtNoiDungYC.Text = oND.GHICHU;
                    }

                    if (oND.HOAGIAIDOANTU != null)
                    {
                        pnHoagiadoantu.Visible = true;
                        rblHoagiadoantu.SelectedValue = oND.HOAGIAIDOANTU.ToString();
                    }
                ...
                {
                    lbthongbaoBA.Text = lbthongbaoQD.Text = ex.Message;
                    return;
                }
            }
            else
            {
                lbthongbaoBA.Text = lbthongbaoQD.Text = "Lỗi tại loadedit: AHN_SOTHAM_QUYETDINH oND null khi tìm theo ID= " + ID + "!";
                return;
            }
        }
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                case "Download":
                    var oND = dt.AHN_SOTHAM_QUYETDINH.Where(x => x.DONID == ID && x.FILEID == ND_id).FirstOrDefault();
                    if (oND.NOIDUNGFILE != null && oND.NOIDUNGFILE.Length != 0 && oND.QT_FILE_ID == null)
                    {
                        var cacheKey = Guid.NewGuid().ToString("N");
                    ...
                    else
                    {
                        ...
                        string _pathStore = QT_FILE_BL.ToPathFolderStore(qT_FILE.DATE_CREATED.Value, Convert.ToInt32(ENUM_LOAIVUVIEC_NUMBER.AN_HONNHAN_GIADINH)) + "\\BANANSOTHAM";
                ...
                case "Xoa":
                    ...
                    //{
                    //    lbthongbaoBA.Text = "Bạn không có quyền xóa!";
                    //    return;
                    //}                                        
                    ...
                    KHOBAQD_BL oDonBL = new KHOBAQD_BL();
                    bool isExist = oDonBL.IsExistKHOBADQ(1, ID, 2, ENUM_LOAIVUVIEC_TEXT.AN_HONNHAN_GIADINH);
                    if (isExist)
                    {
                        lbthongbaoBA.Text = lbthongbaoQD.Text = "Vụ việc đã được chia sẻ dữ liệu. Không được xóa.";
                        return;
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                decimal DONID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH] + "" == "" ? "0" : Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH] + "");
                ...
                AHN_SOTHAM_KHANGCAO oTKC = dt.AHN_SOTHAM_KHANGCAO.Where(x => x.DONID == DONID).FirstOrDefault();
                AHN_SOTHAM_KHANGNGHI oTKN = dt.AHN_SOTHAM_KHANGNGHI.Where(x => x.DONID == DONID).FirstOrDefault();
        ...
        protected void ddlQuyetdinh_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (btnUpdate.Enabled == true)
            {
                ...
                //--Kiểm tra đã phân công thẩm phán chưa
                AHN_DON_THAMPHAN oTP = dt.AHN_DON_THAMPHAN.Where(x => x.DONID == IDD && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETSOTHAM).FirstOrDefault();
                if (oTP == null)
                {
                    ...
                    oT.TEN.Contains("Quyết định công nhận thuận tình ly hôn và sự thỏa thuận của các đương sự")  /*Thuận tình ly hôn*/)
                {
                    lbthongbaoQD.Text = "";
                    Cls_Comon.SetButton(btnUpdate, true);
                }
                else
                {
                    ...
                    AHN_SOTHAM_QUYETDINH QDST = dt.AHN_SOTHAM_QUYETDINH.Where(x => x.DONID == IDD && x.LOAIQDID == 5 && x.QUYETDINHID != 147 && x.QUYETDINHID != 148 /*Quyết định chuyển vụ án giải quyết theo thủ tục rút gọn sang giải quyết theo thủ tục thông thường*/).OrderByDescending(x => x.NGAYQD).FirstOrDefault();
                    if (QDST == null)
                    {
            ...
            if (oT != null)
            {
                ...
                if (oQD != null)
                {
                    ...
                    if (oQD.MA == "GQDS" || oQD.MA == "CNTT")
                    {
                        pnCBQD.Visible = false;
                        pnChiTieuThongKe.Visible = true;
                        DuTuoiViThanhNien.Visible = false;
            ...
            if (ddlQuyetdinh.SelectedItem.Text.Contains("45-DS") || ddlQuyetdinh.SelectedItem.Text.Contains("46-DS"))
            {
                pnChiTieuThongKe.Visible = true;
                pnHoaGiaiThanh.Visible = true;
                DuTuoiViThanhNien.Visible = true;
                if (ddlQuyetdinh.SelectedItem.Text.Contains("45-DS"))
                {
                    pnVKSThamgia.Visible = false;
                }
            }
            if (ddlQuyetdinh.SelectedItem.Text.Contains("40-DS") || ddlQuyetdinh.SelectedItem.Text.Contains("39-DS") || ddlQuyetdinh.SelectedItem.Text.Contains("38-DS"))
            {
                pnChiTieuThongKe.Visible = true;
                pnHoaGiaiThanh.Visible = true;
                DuTuoiViThanhNien.Visible = true;
                if (ddlQuyetdinh.SelectedItem.Text.Contains("38-DS"))
                {
                    pnVKSThamgia.Visible = false;
                }
            }

            if (ddlQuyetdinh.SelectedItem.Text.Contains("Quyết định công nhận sự thoả thuận của các đương sự"))
            {
                pnHoagiadoantu.Visible = true;
            }
            else
            {
                pnHoagiadoantu.Visible = false;
            }
        ...
        private void LoadAnPhi()
        {
            ...
            dgAnPhi.DataSource = oBL.AHN_SOTHAM_BANAN_ANPHI_GET(DONID);
            dgAnPhi.DataBind();
        ...
        private void LoadTGTT()
        {
            decimal DONID = Convert.ToDecimal(hddDonID.Value);
            AHN_SOTHAM_BL oBL = new AHN_SOTHAM_BL();
            DataTable dtTGTT = oBL.AHN_SOTHAM_BANAN_TGTT_GET(DONID);
        ...
        {
            List<DM_BOLUAT> lst = dt.DM_BOLUAT.Where(x => x.LOAI == ENUM_LOAIVUVIEC.AN_HONNHAN_GIADINH && x.HIEULUC == 1).OrderByDescending(y => y.NGAYBANHANH).ToList();
            if (lst != null && lst.Count > 0)
            {
        ...
        {
            decimal DONID = Convert.ToDecimal(hddDonID.Value), ma_gd = 0;
            dgFile.DataSource = dt.AHN_SOTHAM_BANAN_FILE.Where(x => x.DONID == DONID).ToList();
            dgFile.DataBind();
            AHN_DON oT = dt.AHN_DON.Where(x => x.ID == DONID).FirstOrDefault();
            if (oT != null)
            {
                ma_gd = (decimal)oT.MAGIAIDOAN;
            }
        ...
        private void LoadDieuLuat()
        {
            decimal DONID = Convert.ToDecimal(hddDonID.Value);
            AHN_SOTHAM_BL oBL = new AHN_SOTHAM_BL();
            dgDieuLuat.DataSource = oBL.AHN_SOTHAM_BANAN_DIEULUAT_GET(DONID);
            dgDieuLuat.DataBind();
        }
        private void LoadBanAnInfo(decimal DonID)
        {
            List<AHN_SOTHAM_BANAN> lst = dt.AHN_SOTHAM_BANAN.Where(x => x.DONID == DonID).ToList();
            if (lst.Count > 0)
            {
                ...
                if (oT.ISVKSTHAMGIA != null)
                    rdVKSThamgia.SelectedValue = oT.ISVKSTHAMGIA.ToString();

                txtSoconduoi7tuoi.Text = oT.TK_SOCONDUOI7TUOI == null ? "" : oT.TK_SOCONDUOI7TUOI.ToString();
                txtSoconduoi18tuoi.Text = oT.TK_SOCONDUOI18LANU == null ? "" : oT.TK_SOCONDUOI18LANU.ToString();
                txtTongsoconduoi18tuoi.Text = oT.TK_TONGSOCONDUOI18TUOI == null ? "" : oT.TK_TONGSOCONDUOI18TUOI.ToString();
                ddlYeutonuocngoai.SelectedValue = oT.YEUTONUOCNGOAI.ToString();

                if ((oT.TK_APDUNGANLE == null || oT.TK_APDUNGANLE == 1) && oT.SOANLE == null)
                {
                ...
                chkKhongchapnhan.Checked = (oT.TK_ISKHONGCHAPNHAN + "") == "1" ? true : false;
                if (chkKhongchapnhan.Checked)
                {
                    if ((oT.TK_ISCHAPNHANDON + "") == "1") rdLydokhongchapnhan.SelectedValue = "0";
                    if ((oT.TK_ISKHONGCONGNHANVC + "") == "1") rdLydokhongchapnhan.SelectedValue = "1";
                    if ((oT.TK_ISKHONGCHAPNHAN_KQKHAC + "") == "1") rdLydokhongchapnhan.SelectedValue = "2";

                    rdLydokhongchapnhan.Visible = true;
                    div_LyDo.Visible = true;
                }

                chkChapnhan.Checked = (oT.TK_ISCHAPNHAN + "") == "1" ? true : false;
                if (chkChapnhan.Checked)
                {
                    rdLydoChapnhan.Visible = true;

                    if ((oT.TK_CHOLYHON + "") == "1")
                    {
                        rdLydoChapnhan.SelectedValue = "1";
                    }

                    if ((oT.TK_ISCHAPNHAN_KQKHAC + "") == "1")
                    {
                        rdLydoChapnhan.SelectedValue = "2";
                    }
            ...
            else
            {
                ...
                if (don != null)
                {
                    if (don.LOAIQUANHE != null)
                        ddlLoaiQuanhe.SelectedValue = don.LOAIQUANHE.ToString();
                    if (don.YEUTONUOCNGOAI != null)
                        ddlYeutonuocngoai.SelectedValue = don.YEUTONUOCNGOAI.ToString();
                }
        ...
        private bool CheckValidQDVV(decimal IDQD)
        {
            ...
            {
                lbthongbaoBA.Text = "Bạn chưa chọn tên quyết định. Hãy chọn lại!";
                ddlQuyetdinh.Focus();
                return false;
            }
            ...
            if (pnCBQD.Visible)
            {
                ...
                {
                    lbthongbaoBA.Text = "Bạn chưa chọn có công bố quyết định. Hãy chọn lại!";
                    rdCongBoQD.Focus();
                    return false;
                }
            }
            ...
            {
                lbthongbaoBA.Text = "Bạn chưa chọn quan hệ pháp luật. Hãy chọn lại!";
                ddlQHPLQDVV.Focus();
                return false;
            }
            ...
            if (pnChiTieuThongKe.Visible)
            {
                if (chkKhongchapnhan_QD.Checked == false && chkChapnhan_QD.Checked == false)
                {
                    lbthongbaoQD.Text = "Bạn chưa chọn \"Chấp nhận hoặc Không chấp nhận yêu cầu của đương sự ?\"";
                    return false;
                }
                if (chkKhongchapnhan_QD.Checked == true)
                {
                    if (string.IsNullOrEmpty(rdLydokhongchapnhan_QD.SelectedValue))
                    {
                        lbthongbaoQD.Text = "Bạn chưa chọn \"Lý do không chấp nhận ?\"";
                        return false;
                    }

                }

                if (chkChapnhan_QD.Checked == true)
                {
                    if (string.IsNullOrEmpty(rdLydoChapnhan_QD.SelectedValue))
                    {
                        lbthongbaoQD.Text = "Bạn chưa chọn \"Lý do chấp nhận ?\"";
                        return false;
                    }
                }
            ...
            //AHN_SOTHAM_QUYETDINH oND = dt.AHN_SOTHAM_QUYETDINH.Where(x => x.ID == ID).FirstOrDefault();
            //// khong duoc xoa khi da Tong dat - 28/11/2025 vnpt check
            //if (oND != null)
            //{
        ...
        private bool CheckValid()
        {
            ...
            {
                lbthongbaoBA.Text = "Quan hệ pháp luật nhập quá dài.";
                txtQuanhephapluat.Focus();
                return false;
            }
            if (txtQuanhephapluat.Text == null || txtQuanhephapluat.Text == "")
            {
                lbthongbaoBA.Text = "Chưa nhập quan hệ pháp luật.";
                txtQuanhephapluat.Focus();
                return false;
            }
            if (txtNguoiKy.Text == null || txtNguoiKy.Text == "")
            {
                lbthongbaoBA.Text = "Chưa nhập người ký.";
                txtNguoiKy.Focus();
                return false;
            }
            if (ddlQHPLTK.SelectedValue == "0")
            {
                lbthongbaoBA.Text = "Chưa chọn quan hệ pháp luật dùng cho thống kê!";
                return false;
            }
            ...
            {
                lbthongbaoBA.Text = "Quan hệ pháp luật dùng cho thống kê chỉ được chọn mã con, bạn hãy chọn lại !";
                return false;
            }
            if (txtSobanan.Text == "")
            {
                lbthongbaoBA.Text = "Chưa nhập số bản án";
                txtSobanan.Focus();
                return false;
            }
            if (Cls_Comon.IsValidDate(txtNgaymophientoa.Text) == false)
            {
                lbthongbaoBA.Text = "Chưa nhập ngày mở phiên tòa hoặc không hợp lệ !";
            ...
            {
                lbthongbaoBA.Text = "Ngày mở phiên tòa không được lớn hơn ngày hiện tại !";
                txtNgaymophientoa.Focus();
                return false;
            }
            ...
            {
                lbthongbaoBA.Text = "Ngày mở phiên tòa không được nhỏ hơn ngày thụ lý " + hddNgayThuLy.Value;
                txtNgaymophientoa.Focus();
                return false;
            }
            if (Cls_Comon.IsValidDate(txtNgaytuyenan.Text) == false)
            {
                lbthongbaoBA.Text = "Chưa nhập ngày tuyên án hoặc không hợp lệ !";
                return false;
            }
            ...
            {
                lbthongbaoBA.Text = "Ngày tuyên án không được lớn hơn ngày hiện tại !";
                txtNgaytuyenan.Focus();
                return false;
            }
            if (dNgayTA < dNgayMoPhienToa)
            {
                lbthongbaoBA.Text = "Ngày tuyên án phải lớn hơn ngày mở phiên tòa !";
                txtNgaytuyenan.Focus();
                return false;
            }
            if (txtNgayhieuluc.Text.Trim() != "")
            {
                ...
                {
                    lbthongbaoBA.Text = "Chưa nhập ngày hiệu lực hoặc không hợp lệ !";
                    return false;
                }
                ...
                {
                    lbthongbaoBA.Text = "Ngày hiệu lực phải lớn hơn ngày tuyên án !";
            ...
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('" + " Chưa chọn số án lệ áp dụng. Hãy kiểm tra lại. " + "')", true);
                lbthongbaoBA.Text = "Lỗi: Dữ liệu thống kê lưu không thành công!";
                return false;
            }

            //if (rdCongboBA.SelectedValue == "")
            //{
            //    lbthongbaoBA.Text = "Bạn chưa chọn \"Có công bố bản án ?\"";
            //    return false;
            //}
            if (rdVKSThamgia.SelectedValue == "")
            {
                lbthongbaoBA.Text = "Bạn chưa chọn \"Có VKS tham gia ?\"";
                return false;
            }
            if (chkKhongchapnhan.Checked == false && chkChapnhan.Checked == false)
            {
                lbthongbaoBA.Text = "Bạn chưa chọn \"Chấp nhận hoặc Không chấp nhận yêu cầu của đương sự ?\"";
                return false;
            }

            if (chkKhongchapnhan.Checked == true)
            {
                if (string.IsNullOrEmpty(rdLydokhongchapnhan.SelectedValue))
                {
                    lbthongbaoBA.Text = "Bạn chưa chọn \"Lý do không chấp nhận ?\"";
                    return false;
                }

            }
            if (chkChapnhan.Checked == true)
            {
                if (string.IsNullOrEmpty(rdLydoChapnhan.SelectedValue))
                {
                    lbthongbaoBA.Text = "Bạn chưa chọn \"Lý do chấp nhận ?\"";
                    return false;
                }
            }
            ...
            {
                lbthongbaoBA.Text = "Bạn chưa chọn \"Vụ án quá hạn luật định ?\"";
                return false;
            }
            if (rdVuAnQuaHan.SelectedValue == "1")
            {
                ...
                {
                    lbthongbaoBA.Text = "Bạn chưa chọn \"Nguyên nhân chủ quan ?\"";
                    return false;
                }
                if (rdNNKhachQuan.SelectedValue == "")
                {
                    lbthongbaoBA.Text = "Bạn chưa chọn \"Nguyên nhân khách quan ?\"";
                    return false;
                }
            }
            ...
            //List<AHN_DON_DUONGSU> lstDS = dt.AHN_DON_DUONGSU.Where(x => x.DONID == vDonID && x.XACTHUC_DLDCQG == 0 && x.QUOCTICHID == 2).ToList();
            //if (lstDS.Count > 0)
            //{
            //    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Bạn cần xác thực thông tin Đương sự!');", true);
            //    return false;
            //}
            ...
            if (!String.IsNullOrEmpty(txtNgaytuyenan.Text))
            {
                ...
                Decimal DonViID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                ADS_SOTHAM_BL oSTBL = new ADS_SOTHAM_BL();
                Decimal CheckID = oSTBL.CheckSoBATheoLoaiAn(DonViID, "AHN", so, ngayBA);
                if (CheckID > 0)
                {
                    Decimal CurrBanAnId = (string.IsNullOrEmpty(hddBanAnID.Value)) ? 0 : Convert.ToDecimal(hddBanAnID.Value);

                    String strMsg = "";
                    String STTNew = oSTBL.GETSoBANEWTheoLoaiAn(DonViID, "AHN", ngayBA).ToString();
        ...
        private void LoadCombobox()
        {
            ...
            ddlQHPLQDVV.DataSource = dt.DM_QHPL_TK.Where(x => x.STYLES == ENUM_QHPLTK.HONNHAN_GIADINH && x.ENABLE == 1).OrderBy(y => y.ARRTHUTU).ToList();
            ...
            AHN_SOTHAM_HDXX oHD = dt.AHN_SOTHAM_HDXX.Where(x => x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN && x.DONID == DONID).OrderByDescending(x => x.NGAYPHANCONG).FirstOrDefault();
            if (oHD != null)
            {
        ...
        protected void cmdUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AHN_SOTHAM_BANAN_FILE oTF = new AHN_SOTHAM_BANAN_FILE();
                List<AHN_SOTHAM_BANAN> lst = dt.AHN_SOTHAM_BANAN.Where(x => x.DONID == DONID).ToList();
                AHN_SOTHAM_BANAN oND;
                if (lst.Count == 0)
                {
                    List<AHN_DON_DUONGSU> lstDS = dt.AHN_DON_DUONGSU.Where(x => x.DONID == DONID && x.XACTHUC_DLDCQG == 0 && x.QUOCTICHID == 2).ToList();
                    if (lstDS.Count > 0)
                    {
                        lbthongbaoBA.Text = lbthongbaoQD.Text = "Bạn cần xác thực thông tin Đương sự!";
                        DisableButtonsBanan();
                    ...
                    oND = new AHN_SOTHAM_BANAN();
                }
                else
                {
                    oND = lst[0];
                    // khong duoc xoa khi da Tong dat - 27/11/2025 vnpt check
                    AHN_TONGDAT oTD2 = dt.AHN_TONGDAT.Where(x => x.DONID == oND.DONID && x.MAPID == oND.ID && x.MAP_TABLE == ENUM_MAP_TABLE.AHN_SOTHAM_BANAN).FirstOrDefault();
                    if (oTD2 != null)
                    {
                ...
                oND.ISVKSTHAMGIA = rdVKSThamgia.SelectedValue == "" ? 0 : Convert.ToDecimal(rdVKSThamgia.SelectedValue);
                oND.TK_APDUNGANLE = ddlCBBA_Anle.SelectedValue == "0" ? 0 : 1;
                ...
                oND.TK_TONGSOCONDUOI18TUOI = (String.IsNullOrEmpty(txtTongsoconduoi18tuoi.Text + "")) ? 0 : Convert.ToDecimal(txtTongsoconduoi18tuoi.Text);
                oND.TK_SOCONDUOI18LANU = (String.IsNullOrEmpty(txtSoconduoi18tuoi.Text + "")) ? 0 : Convert.ToDecimal(txtSoconduoi18tuoi.Text);
                oND.TK_SOCONDUOI7TUOI = (String.IsNullOrEmpty(txtSoconduoi7tuoi.Text + "")) ? 0 : Convert.ToDecimal(txtSoconduoi7tuoi.Text);
                try
                {
                    if (hddFilePath.Value != "")
                    {
                        ...
                        dt.AHN_SOTHAM_BANAN_FILE.Add(oTF);
                        dt.SaveChanges();
                        //}
                        #endregion
                        //File.Delete(strFilePath);
                ...
                if (chkKhongchapnhan.Checked)
                {
                    oND.TK_ISKHONGCHAPNHAN = 1;
                    if (rdLydokhongchapnhan.SelectedValue == "0") oND.TK_ISCHAPNHANDON = 1;
                    if (rdLydokhongchapnhan.SelectedValue == "1") oND.TK_ISKHONGCONGNHANVC = 1;
                    if (rdLydokhongchapnhan.SelectedValue == "2") oND.TK_ISKHONGCHAPNHAN_KQKHAC = 1;
                }
                else
                {
                    oND.TK_ISKHONGCHAPNHAN = 0;
                    oND.TK_ISCHAPNHANDON = 0;
                    oND.TK_ISKHONGCONGNHANVC = 0;
                    oND.TK_ISKHONGCHAPNHAN_KQKHAC = 0;
                }
                if (chkChapnhan.Checked)
                {
                    oND.TK_ISCHAPNHAN = 1;
                    if (rdLydoChapnhan.SelectedValue == "1") oND.TK_CHOLYHON = 1; else oND.TK_CHOLYHON = 0; /*if (chkCholyhon.Checked) oND.TK_CHOLYHON = 1;*/
                    if (rdLydoChapnhan.SelectedValue == "2") oND.TK_ISCHAPNHAN_KQKHAC = 1; else oND.TK_ISCHAPNHAN_KQKHAC = 0;
                }
                else
                {
                    oND.TK_ISCHAPNHAN = 0;
                ...
                ResetControl_Banan();
                LoadBanAnInfo(DONID);
                lbthongbaoBA.Text = "Lưu thành công!";
                Page.Response.Redirect(Page.Request.Url.ToString(), true);
            }
            catch (Exception ex)
            {
                lbthongbaoBA.Text = "Lỗi: " + ex.Message;
            }
        }
        ...
        {
            AHN_DON oDon = dt.AHN_DON.FirstOrDefault(s => s.ID == DONID);
            DONKK_USER_DKNHANVB obj = dkk.DONKK_USER_DKNHANVB.FirstOrDefault(s => s.MAVUVIEC == oDon.MAVUVIEC && s.VUVIECID == oDon.ID && s.MALOAIVUVIEC == ENUM_LOAIAN.AN_HONNHAN_GIADINH && s.TRANGTHAI == 3);
            if (obj != null)
            {
        ...
        protected void AsyncFileUpLoad_UploadedComplete(object sender, AjaxControlToolkit.AsyncFileUploadEventArgs e)
        {
            try
            {
                if (AsyncFileUpLoad.HasFile && dgFile.Items.Count < 1)
                {
                    ...
                    else lbthongbaoBA.Text = "chỉ lưu file .doc";
                }
                else lbthongbaoBA.Text = "Chỉ được chọn 1 file.";
            }
            catch (Exception ex) { lbthongbaoBA.Text = "Lỗi: " + ex.Message; }
        }
        ...
        protected void dgFile_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Xoa":
                    ...
                    AHN_SOTHAM_BANAN_FILE oT = dt.AHN_SOTHAM_BANAN_FILE.Where(x => x.ID == ND_id).FirstOrDefault();
                    if (oT.NOIDUNG == null)
                    {
                    ...
                    AHN_FILE oDsF = dt.AHN_FILE.Where(x => x.DONID == oT.DONID && x.TENFILE == oT.TENFILE).FirstOrDefault();
                    if (oDsF != null)
                    {
                        dt.AHN_FILE.Remove(oDsF);
                        dt.SaveChanges();
                    }
                    dt.AHN_SOTHAM_BANAN_FILE.Remove(oT);
                    dt.SaveChanges();
                    LoadFile();
                    break;
                case "Download":
                    AHN_SOTHAM_BANAN_FILE oND = dt.AHN_SOTHAM_BANAN_FILE.Where(x => x.ID == ND_id).FirstOrDefault();
                    if (oND.NOIDUNG != null && oND.QT_FILE_ID == null)
                    {
                        var cacheKey = Guid.NewGuid().ToString("N");
        ...
        protected void cmdLuatUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dt.AHN_SOTHAM_BANAN_DIEULUAT.Where(x => x.DONID == DONID && x.DIEULUATID == DIEUID).ToList().Count > 0)
                {
                    lstMsgDieuluat.Text = "Đã tồn tại điều luật này trong danh sách !";
                    return;
                }

                AHN_SOTHAM_BANAN_DIEULUAT oT = new AHN_SOTHAM_BANAN_DIEULUAT();
                oT.DONID = DONID;
                ...
                dt.AHN_SOTHAM_BANAN_DIEULUAT.Add(oT);
                dt.SaveChanges();
                LoadDieuLuat();
        ...
        protected void dgDieuLuat_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Xoa":
                    ...
                    AHN_SOTHAM_BANAN_DIEULUAT oT = dt.AHN_SOTHAM_BANAN_DIEULUAT.Where(x => x.ID == ND_id).FirstOrDefault();
                    dt.AHN_SOTHAM_BANAN_DIEULUAT.Remove(oT);
                    dt.SaveChanges();
                    LoadDieuLuat();
                    break;
            }
        ...
        protected void cmdAnphi_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataGridItem oItem in dgAnPhi.Items)
                {
                    ...
                    TextBox txtNgaynhanbanan = (TextBox)oItem.FindControl("txtNgaynhanbanan");
                    List<AHN_SOTHAM_BANAN_ANPHI> lst = dt.AHN_SOTHAM_BANAN_ANPHI.Where(x => x.DONID == DONID && x.DUONGSU == DSID).ToList();
                    if (lst.Count == 0)
                    {
                        AHN_SOTHAM_BANAN_ANPHI oT = new AHN_SOTHAM_BANAN_ANPHI();
                        oT.DONID = DONID;
                        oT.DUONGSU = DSID;
                        ...
                        oT.NGUOITAO = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                        oT.TOA_GIAIQUYET_ID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                        dt.AHN_SOTHAM_BANAN_ANPHI.Add(oT);
                        dt.SaveChanges();
                    }
                    else
                    {
                        AHN_SOTHAM_BANAN_ANPHI oT = lst[0];
                        oT.DONID = DONID;
                        oT.DUONGSU = DSID;
                        oT.MIENANPHI = chkMien.Checked == true ? 1 : 0;
                        oT.ANPHI = txtAnphi.Text == "" ? 0 : Convert.ToDecimal(txtAnphi.Text.Replace(".", ""));
            ...
            try
            {
                if (dgTGTT.Items.Count > 0)
                {
                    foreach (DataGridItem oItem in dgTGTT.Items)
                    {
                        ...
                        {
                            DateTime NgayNhanBA;
                            if (DateTime.TryParse(txtNgayTGTT.Text, cul, DateTimeStyles.NoCurrentDateDefault, out NgayNhanBA))
                            {
                                if (DateTime.Compare(NgayNhanBA, DateTime.Now) > 0)
                                {
                ...
                foreach (DataGridItem oItem in dgTGTT.Items)
                {
                    ...
                    TextBox txtNgayTGTT = (TextBox)oItem.FindControl("txtNgayTGTT");
                    List<AHN_SOTHAM_BANAN_TGTT> lst = dt.AHN_SOTHAM_BANAN_TGTT.Where(x => x.DONID == DONID && x.THAMGIATOTUNGID == DSID).ToList();
                    if (lst.Count == 0)
                    {
                        AHN_SOTHAM_BANAN_TGTT oT = new AHN_SOTHAM_BANAN_TGTT();
                        oT.DONID = DONID;
                        ...
                        oT.TOA_GIAIQUYET_ID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                        dt.AHN_SOTHAM_BANAN_TGTT.Add(oT);
                        dt.SaveChanges();
                    }
                    else
                    {
                        AHN_SOTHAM_BANAN_TGTT oT = lst[0];
                        oT.DONID = DONID;
                        oT.THAMGIATOTUNGID = DSID;
                        oT.ISTHAMGIA = chkThamgiaTGTT.Checked == true ? 1 : 0;
                        oT.NGAYNHANBANAN = (String.IsNullOrEmpty(txtNgayTGTT.Text.Trim())) ? (DateTime?)null : DateTime.Parse(txtNgayTGTT.Text.Trim(), cul, DateTimeStyles.NoCurrentDateDefault);
        ...
        protected void chkKhongchapnhan_CheckedChanged(object sender, EventArgs e)
        {
            if (chkKhongchapnhan.Checked)
            {
                rdLydokhongchapnhan.Visible = true;
                div_LyDo.Visible = true;
                chkChapnhan.Checked = false;
                rdLydoChapnhan.Visible = false; /*chkCholyhon.Visible = false;*/
            }
            else
            {
                rdLydokhongchapnhan.Visible = false;
                div_LyDo.Visible = false;
            }
            ...
            if (chkKhongchapnhan_QD.Checked)
            {
                rdLydokhongchapnhan_QD.Visible = true;
                div_LyDo_QD.Visible = true;
                chkChapnhan_QD.Checked = false;
                rdLydoChapnhan_QD.Visible = false; /*chkCholyhon_QD.Visible = false;*/
            }
            else
            {
                rdLydokhongchapnhan_QD.Visible = false;
                div_LyDo_QD.Visible = false;
            }
        }
        protected void chkChapnhan_CheckedChanged(object sender, EventArgs e)
        {
            if (chkChapnhan.Checked)
            {
                ///Bản án
                div_LyDo.Visible = false;
                chkKhongchapnhan.Checked = false;
                rdLydoChapnhan.Visible = true; /*chkCholyhon.Visible = true;*/
                rdLydokhongchapnhan.Visible = false;
            ...
            if (chkChapnhan_QD.Checked)
            {
                //Quyết định
                div_LyDo_QD.Visible = false;
                chkKhongchapnhan_QD.Checked = false;
                rdLydoChapnhan_QD.Visible = true; /*chkCholyhon_QD.Visible = true;*/
                rdLydokhongchapnhan_QD.Visible = false;
            }
            else
            {
                rdLydoChapnhan_QD.Visible = false; /*chkCholyhon_QD.Visible = false;*/
                //chkCholyhon_QD.Checked = false;
                rdLydoChapnhan_QD.ClearSelection();
            }
        }
        ...
        protected void cmdHuyBanAn_Click(object sender, EventArgs e)
        {
            ...
            List<AHN_SOTHAM_BANAN> banans = dt.AHN_SOTHAM_BANAN.Where(x => x.DONID == DonID).ToList();
            if (banans.Count > 0)
            {
                ...
                if (oBL.HISTORY_ALLDATA_BY_VUANID(DonID, 3, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Bản án Sơ thẩm án Hôn nhân", "Xóa", json) == false)
                {
                    lbthongbaoBA.Text = "Xóa không thành công!";
                    return;
                }//Ket thuc
                 //Xoa Bản án Sơ thẩm
                dt.AHN_SOTHAM_BANAN.RemoveRange(banans);
            }
            // Xóa thông tin file đính kèm
            List<AHN_SOTHAM_BANAN_FILE> files = dt.AHN_SOTHAM_BANAN_FILE.Where(x => x.DONID == DonID).ToList();
            if (files.Count > 0)
            {
                ...
                dt.AHN_SOTHAM_BANAN_FILE.RemoveRange(files);
            }
            // Xóa điều luật áp dụng, tội danh
            List<AHN_SOTHAM_BANAN_DIEULUAT> dieuLuats = dt.AHN_SOTHAM_BANAN_DIEULUAT.Where(x => x.DONID == DonID).ToList();
            if (dieuLuats.Count > 0)
            {
                dt.AHN_SOTHAM_BANAN_DIEULUAT.RemoveRange(dieuLuats);
            }
            // Xóa thông tin án phí
            List<AHN_SOTHAM_BANAN_ANPHI> anPhis = dt.AHN_SOTHAM_BANAN_ANPHI.Where(x => x.DONID == DonID).ToList();
            if (anPhis.Count > 0)
            {
                dt.AHN_SOTHAM_BANAN_ANPHI.RemoveRange(anPhis);
            }
            // Xóa thông tin người tham gia tố tụng
            List<AHN_SOTHAM_BANAN_TGTT> tGTTs = dt.AHN_SOTHAM_BANAN_TGTT.Where(x => x.DONID == DonID).ToList();
            if (tGTTs.Count > 0)
            {
                dt.AHN_SOTHAM_BANAN_TGTT.RemoveRange(tGTTs);
            }
            ...
            AHN_FILE file = dt.AHN_FILE.Where(x => x.DONID == DonID && x.BIEUMAUID == BieuMauID && x.MAGIAIDOAN == ENUM_GIAIDOANVUAN.SOTHAM).FirstOrDefault();
            if (file != null)
            {
                dt.AHN_FILE.Remove(file);
            }
            ...
            dt.SaveChanges();
            ResetControl_Banan();
            lbthongbaoBA.Text = "Xóa bản án thành công!";
            Page.Response.Redirect(Page.Request.Url.ToString(), true);
        }
        ...
        private void ResetControl_Banan()
        {
            ...
            rdVKSThamgia.ClearSelection();
            chkKhongchapnhan.Checked = false;
            rdLydokhongchapnhan.ClearSelection();
            chkChapnhan.Checked = false;
            //chkCholyhon.Checked = false;
            rdLydoChapnhan.ClearSelection();
        ...
        private void UploadFileID(AHN_DON oDon, string strMaBieumau, AHN_SOTHAM_BANAN_FILE fileDinhKem)
        {
            AHN_DON_BL oBL = new AHN_DON_BL();
            decimal IDBM = 0;
            string strTenBM = "";
            ...
            AHN_FILE objFile = dt.AHN_FILE.Where(x => x.DONID == oDon.ID && x.TOAANID == oDon.TOAANID && x.MAGIAIDOAN == oDon.MAGIAIDOAN && x.BIEUMAUID == IDBM).FirstOrDefault();
            if (objFile == null)
            {
                isNew = true;
                objFile = new AHN_FILE();
            }
            objFile.DONID = oDon.ID;
            objFile.TOAANID = oDon.TOAANID;
            objFile.MAGIAIDOAN = oDon.MAGIAIDOAN;
        ...
        {
            decimal ID = Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH] + "" == "" ? 0 : Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH]);
            AHN_SOTHAM_THULY oT = dt.AHN_SOTHAM_THULY.Where(x => x.DONID == ID).FirstOrDefault();
        ...
        {
            decimal vDonID = Convert.ToDecimal(hddDonID.Value);
            AHN_SOTHAM_BANAN ba = dt.AHN_SOTHAM_BANAN.Where(x => x.DONID == vDonID).FirstOrDefault();
            if (ba != null)
            {
                txtQuanhephapluat.Enabled = false;
                txtSobanan.Enabled = false;
                ...
                rdVKSThamgia.Enabled = false;
                if (ba.TK_ISKHONGCHAPNHAN == 1)
                {
                    chkKhongchapnhan.Enabled = false;
                    rdLydokhongchapnhan.Enabled = false;
                    rdLydokhongchapnhan.Enabled = false;
                    chkChapnhan.Enabled = false;
                    rdLydoChapnhan.Enabled = false;

                }

                if (ba.TK_ISCHAPNHAN == 1)
                {
                    chkChapnhan.Enabled = false;
                    rdLydoChapnhan.Visible = true;
                    rdLydoChapnhan.Enabled = false;
                ...
                if (ba.TK_SOCONDUOI7TUOI != null)
                    txtSoconduoi7tuoi.Enabled = false;
                else
                    txtSoconduoi7tuoi.Enabled = true;

                if (ba.TK_SOCONDUOI18LANU != null)
                    txtSoconduoi18tuoi.Enabled = false;
                else
                    txtSoconduoi18tuoi.Enabled = true;

                if (ba.TK_TONGSOCONDUOI18TUOI != null)
                    txtTongsoconduoi18tuoi.Enabled = false;
                else
                    txtTongsoconduoi18tuoi.Enabled = true;
        ...
        private void SetEnable_data_QD(AHN_SOTHAM_QUYETDINH QD)
        {
            if (QD != null)
            {
                txtQuanhephapluat.Enabled = false;
                ...
                AHN_TONGDAT oTD = dt.AHN_TONGDAT.Where(x => x.DONID == QD.DONID && x.MAPID == QD.ID && x.MAP_TABLE == ENUM_MAP_TABLE.AHN_SOTHAM_QUYETDINH).FirstOrDefault();
                if (oTD != null)
                {
