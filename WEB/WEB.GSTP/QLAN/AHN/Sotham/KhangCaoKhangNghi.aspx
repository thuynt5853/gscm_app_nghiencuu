...
AutoEventWireup="true" CodeBehind="KhangCaoKhangNghi.aspx.cs"
Inherits="WEB.GSTP.QLAN.AHN.Sotham.KhangCaoKhangNghi" %> <%@ Register
...
>
        ...
        <div class="boxchung">
          ...
          <div class="boder" style="padding: 10px">
            <table class="table1">
              <tr>
                <td colspan="4">
                  <asp:RadioButtonList
                    ...
                    Font-Bold="true"
                    AutoPostBack="true"
                    OnSelectedIndexChanged="rdbPanelKC_SelectedIndexChanged"
                  >
                    <asp:ListItem
                      Value="1"
                      Text="Kháng cáo"
              ...
              <tr>
                ...
                <td class="KCHNCol2">
                  ...
                  <cc1:CalendarExtender
                    ...
                    runat="server"
                    TargetControlID="txtNgayvietdonKC"
                    Format="dd/MM/yyyy"
                    Enabled="true"
                  />
                ...
                <td colspan="3">
                  <asp:TextBox
                    ID="txtNgaykhangcao"
                    AutoPostBack="true"
                    OnTextChanged="txtNgaykhangcao_TextChanged"
                    runat="server"
                    CssClass="user"
                    Width="90px"
                    MaxLength="10"
                  ...
                  <cc1:CalendarExtender
                    ...
                    runat="server"
                    TargetControlID="txtNgaykhangcao"
                    Format="dd/MM/yyyy"
                    Enabled="true"
                  />
                  <cc1:MaskedEditExtender
              ...
              <tr>
                <td class="KCHNCol1">
                  Tên người kháng cáo<span class="batbuoc">(*)</span>
                </td>
                <td class="KCHNCol2">
                  <asp:DropDownList
                    ID="ddlNguoikhangcao"
                    ...
                    Width="98%"
                    AutoPostBack="True"
                    OnSelectedIndexChanged="ddlNguoikhangcao_SelectedIndexChanged"
                  ></asp:DropDownList>
                </td>
                <td class="KCHNCol3">
                  Loại kháng cáo<span class="batbuoc">(*)</span>
                </td>
                <td>
                  <asp:RadioButtonList
                    ID="rdbLoaiKC"
                    ...
                    RepeatDirection="Horizontal"
                    AutoPostBack="True"
                    OnSelectedIndexChanged="rdbLoaiKC_SelectedIndexChanged"
                  >
              ...
              <tr>
                ...
                <td>
                  <asp:DropDownList
                    ...
                    Width="98%"
                    AutoPostBack="True"
                    OnSelectedIndexChanged="ddlSOQDBA_KC_SelectedIndexChanged"
                  ></asp:DropDownList>
                </td>
              ...
              <tr>
                ...
                <td>
                  ...
                  <cc1:CalendarExtender
                    ...
                    runat="server"
                    TargetControlID="txtNgayQDBA_KC"
                    Format="dd/MM/yyyy"
                    Enabled="true"
                  />
                  <cc1:MaskedEditExtender
              ...
              <tr>
                ...
                <td>
                  ...
                  <cc1:AsyncFileUpload
                    ID="AsyncFileUpLoadKhangCao"
                    runat="server"
                    CompleteBackColor="Lime"
                    UploaderStyle="Modern"
                    OnUploadedComplete="AsyncFileUpLoadKhangCao_UploadedComplete"
                    ErrorBackColor="Red"
                    ThrobberID="Throbber"
                ...
                <td>
                  <asp:LinkButton
                    ID="lbtDownloadKhangCao"
                    Visible="false"
                    runat="server"
                    Text="Tải file đính kèm"
                    OnClick="lbtDownloadKhangCao_Click"
                  ></asp:LinkButton>
                </td>
                <td>
                  <asp:LinkButton
                    ID="lbtDownloadKhangCao_DonKhangCao"
                    Visible="false"
                    runat="server"
                    Text="Tải file đính kèm"
                    OnClick="lbtDownloadKhangCao_DonKhangCao_Click"
                  ></asp:LinkButton>
                </td>
              </tr>
            </table>
                ...
                <table class="table1">
                  <tr>
                    <td style="width: 115px">
                      Miễn án phí<span class="batbuoc">(*)</span>
                    </td>
                    <td style="width: 305px">
                      <asp:RadioButtonList
                        ...
                        RepeatDirection="Horizontal"
                        AutoPostBack="true"
                        OnSelectedIndexChanged="rdbMienAnphi_SelectedIndexChanged"
                      >
                        <asp:ListItem Value="0" Text="Không"></asp:ListItem>
                        <asp:ListItem Value="1" Text="Có"></asp:ListItem>
                      </asp:RadioButtonList>
            ...
            <table class="table1">
              <tr>
                <td colspan="4">
                  <asp:RadioButtonList
                    ...
                    Font-Bold="true"
                    AutoPostBack="true"
                    OnSelectedIndexChanged="rdbPanelKN_SelectedIndexChanged"
                  >
                    <asp:ListItem
                      Value="1"
                      Text="Kháng cáo"
              ...
              <tr>
                <td style="width: 135px">
                  Người Kháng nghị<span class="batbuoc">(*)</span>
                </td>
                <td style="width: 250px">
                  <asp:RadioButtonList
                    ...
                    RepeatDirection="Horizontal"
                    AutoPostBack="True"
                    OnSelectedIndexChanged="rdbDonVi_SelectedIndexChanged"
                  >
                ...
                <td style="width: 115px">
                  Cấp kháng nghị<span class="batbuoc">(*)</span>
                </td>
                <td>
                  <asp:RadioButtonList
                    ID="rdbCapkhangnghi"
                    ...
                    RepeatDirection="Horizontal"
                    AutoPostBack="True"
                    OnSelectedIndexChanged="rdbCapkhangnghi_SelectedIndexChanged"
                  >
              ...
              <tr>
                ...
                <td>
                  ...
                  <cc1:CalendarExtender
                    ...
                    runat="server"
                    TargetControlID="txtNgaykhangnghi"
                    Format="dd/MM/yyyy"
                    Enabled="true"
                  />
                  <cc1:MaskedEditExtender
              ...
              <tr>
                ...
                <td>
                  <asp:RadioButtonList
                    ...
                    RepeatDirection="Horizontal"
                    AutoPostBack="True"
                    OnSelectedIndexChanged="rdbLoaiKN_SelectedIndexChanged"
                  >
                    <asp:ListItem Value="0" Text="Bản án"></asp:ListItem>
                    <asp:ListItem
                      Value="1"
              ...
              <tr>
                ...
                <td>
                  <asp:DropDownList
                    ID="ddlSOQDBAKhangNghi"
                    CssClass="chosen-select"
                    runat="server"
                    Width="250px"
                    AutoPostBack="True"
                    OnSelectedIndexChanged="ddlSOQDBAKhangNghi_SelectedIndexChanged"
                  ></asp:DropDownList>
                </td>
                <td>Ngày QĐ/BA</td>
                <td>
                  ...
                  <cc1:CalendarExtender
                    ...
                    runat="server"
                    TargetControlID="txtNgayQDBA_KN"
                    Format="dd/MM/yyyy"
                    Enabled="true"
                  />
              ...
              <tr>
                ...
                <td>
                  ...
                  <cc1:AsyncFileUpload
                    ID="AsyncFileUpLoadKhangNghi"
                    runat="server"
                    CompleteBackColor="Lime"
                    UploaderStyle="Modern"
                    OnUploadedComplete="AsyncFileUpLoadKhangNghi_UploadedComplete"
                    ErrorBackColor="Red"
                    ThrobberID="Throbber"
                    UploadingBackColor="#66CCFF"
                  />
                ...
                <td>
                  <asp:LinkButton
                    ID="lbtDownloadKhangNghi"
                    Visible="false"
                    runat="server"
                    Text="Tải file đính kèm"
                    OnClick="lbtDownloadKhangNghi_Click"
                  ></asp:LinkButton>
                </td>
                <td>
                  <asp:LinkButton
                    ID="lbtDownloadKhangNghi_DonKhangCao"
                    Visible="false"
                    runat="server"
                    Text="Tải file đính kèm"
                    OnClick="lbtDownloadKhangNghi_DonKhangCao_Click"
                  ></asp:LinkButton>
                </td>
              </tr>
            </table>
      ...
      <div class="truong">
              ...
              <asp:Panel runat="server" ID="pndata" Visible="false">
                ...
                >
                  <Columns>
                    ...
                    <asp:BoundColumn
                      DataField="KCKNName"
                      HeaderText="Kháng cáo, Kháng nghị"
                      HeaderStyle-Width="66px"
                      HeaderStyle-HorizontalAlign="Center"
                    ></asp:BoundColumn>
                    <asp:BoundColumn
                      DataField="HTNhanDonDonViKN"
                      HeaderText="Hình thức nhận đơn KC, Đơn vị kháng nghị"
                      HeaderStyle-Width="96px"
                      HeaderStyle-HorizontalAlign="Center"
                    ></asp:BoundColumn>
                    <asp:BoundColumn
                      DataField="NguoiKCCapKN"
                      HeaderText="Người kháng cáo, Cấp kháng nghị"
                      HeaderStyle-HorizontalAlign="Center"
                    ></asp:BoundColumn>
                    <asp:BoundColumn
                      DataField="LoaiKCKN"
                    ...
                    <asp:BoundColumn
                      DataField="NgayKCKN"
                      HeaderText="Ngày kháng cáo, kháng nghị"
                    ...
                    <asp:BoundColumn
                      DataField="NGAYQDBA"
                      HeaderText="Ngày QĐ/BA"
                      HeaderStyle-Width="65px"
                      HeaderStyle-HorizontalAlign="Center"
                      DataFormatString="{0:dd/MM/yyyy}"
                    ></asp:BoundColumn>
                    <asp:BoundColumn
                      DataField="TINHTRANG_GIAIQUYET"
                      HeaderText="Tình trạng giải quyết"
                      HeaderStyle-HorizontalAlign="Center"
                    ></asp:BoundColumn>
                    <%--
                    <asp:BoundColumn
                    ...
                    >
                      ...
                      <ItemTemplate>
                        <asp:LinkButton
                          ...
                          CommandArgument='<%#Eval("ID") +";#"+ Eval("IsKhangCao")%>'
        ...
        <div style="display: none">
          <asp:Button
            ID="cmdLoadDonKhac"
            runat="server"
            Text="Load ds BI don khac"
            OnClick="cmdLoadDonKhac_Click"
          />
        </div>
      </div>
    </div>
  ...
  <script type="text/javascript">
    function ValidData() {
      ...
      if (selected_value == 1) {
        if (!validate_khangcao()) return false;
      } else if (selected_value == 2) {
        if (!validate_khangnghi()) return false;
      }
      return true;
    }
    function validate_khangcao() {
      var rdbHinhThucNhanDon = document.getElementById(
        "<%=rdbHinhThucNhanDon.ClientID%>"
      );
      var msg = "Bạn chưa chọn hình thức nhận đơn. Hãy chọn lại!";
      if (!CheckChangeRadioButtonList(rdbHinhThucNhanDon, msg)) return false;

      //-----------------------------------------
      var KC_txtNgaykhangcao = document.getElementById(
        "<%=txtNgaykhangcao.ClientID%>"
      );
      if (!Common_CheckEmpty(KC_txtNgaykhangcao.value)) {
        alert("Bạn chưa nhập ngày kháng cáo.");
        KC_txtNgaykhangcao.focus();
        return false;
      }
      if (!Common_IsTrueDate(KC_txtNgaykhangcao.value)) return false;

      //-----------------------------
      var KC_ddlNguoikhangcao = document.getElementById(
        "<%=ddlNguoikhangcao.ClientID%>"
      );
      var val =
        KC_ddlNguoikhangcao.options[KC_ddlNguoikhangcao.selectedIndex].value;
      if (val == 0) {
        alert("Bạn chưa chọn người kháng cáo. Hãy chọn lại!");
      ...
      if (Common_CheckEmpty(txtNgaynopanphi.value)) {
        if (!Common_IsTrueDate(txtNgaynopanphi.value)) return false;
      }
      return true;
    }
    function validate_khangnghi() {
      var txtSokhangnghi = document.getElementById(
        "<%=txtSokhangnghi.ClientID%>"
      );
      ...
      if (txtSokhangnghi.value.trim().length > 20) {
        alert("Số kháng nghị không quá 20 ký tự. Hãy nhập lại!");
        txtSokhangnghi.focus();
        return false;
      }
      //----------------------------
      var txtNgaykhangnghi = document.getElementById(
        "<%=txtNgaykhangnghi.ClientID%>"
      );
      if (!Common_CheckEmpty(txtNgaykhangnghi.value)) {
        alert("Bạn chưa nhập ngày kháng nghij.");
        txtNgaykhangnghi.focus();
        return false;
      }
      if (!Common_IsTrueDate(txtNgaykhangnghi.value)) return false;
      //----------------------------
      var rdbCapkhangnghi = document.getElementById(
        "<%=rdbCapkhangnghi.ClientID%>"
      );
      msg = "Bạn chưa chọn cấp kháng nghị. Hãy chọn lại!";
      if (!CheckChangeRadioButtonList(rdbCapkhangnghi, msg)) return false;
      //----------------------------
      var rdbLoaiKN = document.getElementById("<%=rdbLoaiKN.ClientID%>");
      msg = "Bạn chưa chọn loại kháng nghị. Hãy chọn lại!";
      if (!CheckChangeRadioButtonList(rdbLoaiKN, msg)) return false;
      //----------------------------
      var ddlSOQDBAKhangNghi = document.getElementById(
        "<%=ddlSOQDBAKhangNghi.ClientID%>"
      );
      var val =
        ddlSOQDBAKhangNghi.options[ddlSOQDBAKhangNghi.selectedIndex].value;
      if (val == 0) {
        alert("Bạn chưa chọn số QĐ/BA. Hãy chọn lại!");
    ...
    function popup_loaddonkc_bc(DonID, NGUOIKC) {
      var link =
        "/QLAN/AHN/Sotham/Popup/pChonDonKC.aspx?ID=" +
        DonID +
        "&KCID=" +
        NGUOIKC;
      var width = 800;
