...
AutoEventWireup="true" CodeBehind="RutKhangCaoKhangNghi.aspx.cs"
Inherits="WEB.GSTP.QLAN.AHN.Sotham.RutKhangCaoKhangNghi" %> <%@ Register
  ...
  <div class="box">
    <div class="box_nd" style="width: 99%">
      <div class="truong">
        <table class="table1">
          <tr>
            <td><b>DANH SÁCH KHÁNG CÁO, KHÁNG NGHỊ</b></td>
          </tr>
          <tr>
            <td>
                    ...
                    >
                      ...
                      <ItemTemplate>
                        ...
                        <cc1:CalendarExtender
                          ID="txtNgayRut_CalendarExtender3"
                          runat="server"
                          TargetControlID="txtNgayRut"
                          Format="dd/MM/yyyy"
                          Enabled="true"
                        />

                        <cc1:MaskedEditExtender
                          ID="txtNgayRut_MaskedEditExtender2"
                          runat="server"
                          TargetControlID="txtNgayRut"
                          Mask="99/99/9999"
                          MaskType="Date"
