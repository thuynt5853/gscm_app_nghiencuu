...
AutoEventWireup="true" CodeBehind="QuyetdinhVuviec.aspx.cs"
Inherits="WEB.GSTP.QLAN.AHN.Sotham.QuyetdinhVuviec" %> <%@ Register
      ...
      <div class="boxchung">
        ...
        <div class="boder" style="padding: 10px">
          <table class="table1">
            <tr style="display: none">
              ...
              <td colspan="3">
                <asp:DropDownList
                  ...
                  Width="650px"
                  AutoPostBack="True"
                  OnSelectedIndexChanged="ddlLoaiQD_SelectedIndexChanged"
                >
                </asp:DropDownList>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="3">
                <asp:DropDownList
                  ...
                  Width="650px"
                  AutoPostBack="True"
                  OnSelectedIndexChanged="ddlQuyetdinh_SelectedIndexChanged"
                >
                </asp:DropDownList>
              </td>
            </tr>
            <tr>
              <td class="QDVACol1">
                Ngày mở phiên tòa<asp:Label
                  runat="server"
                  Visible="false"
                  ID="LabeltxtNgayMoPhienToa"
                  ForeColor="Red"
                  Text="(*)"
                ></asp:Label>
              </td>
              <td class="QDVACol2">
                ...
                <cc1:CalendarExtender
                  ...
                  runat="server"
                  TargetControlID="txtNgayMoPhienToa"
                  Format="dd/MM/yyyy"
                  Enabled="true"
                />
              ...
              <tr>
                ...
                <td>
                  ...
                  >
                    ...
                    <asp:ListItem
                      Text="Xử/Họp kín trực tuyến"
                      Value="1"
                    ></asp:ListItem>
                    <asp:ListItem
                      Text="Xử/Họp kín trực tiếp"
                      Value="2"
                    ></asp:ListItem>
                    <asp:ListItem
                      Text="Xử/Họp công khai trực tuyến"
                      Value="3"
                    ></asp:ListItem>
                    <asp:ListItem
                      Text="Xử/Họp công khai trực tiếp"
                      Value="4"
                    ></asp:ListItem>
                  </asp:DropDownList>
                </td>
              ...
              <tr>
                ...
                <td colspan="3">
                  <asp:DropDownList
                    ...
                    Width="650px"
                    AutoPostBack="true"
                    OnSelectedIndexChanged="ddlLydo_SelectedIndexChanged"
                  ></asp:DropDownList>
                </td>
              </tr>
            </asp:Panel>
            ...
            <tr>
              ...
              <td>
                ...
                <asp:Panel ID="ltDuongsuL" Visible="false" runat="server">
                                <td class="QDVACol3">Đương sự <span style="color:red;">(*)</span></td>
                                <td>
                                    <asp:ListBox ID="lbxDuongSu" CssClass="chosen-select" runat="server" Width="230px" SelectionMode="Multiple" AutoPostBack="True"></asp:ListBox>
                                </td>
                </asp:Panel>
            </tr>
            ...
            <asp:Panel ID="pnHieulucngay" runat="server" Visible="true">
                <tr>
              ...
              <td>
                ...
                <cc1:CalendarExtender
                  ...
                  runat="server"
                  TargetControlID="txtHieuLucTuNgay"
                  Format="dd/MM/yyyy"
                  Enabled="true"
                />
                <cc1:MaskedEditExtender
              ...
              <td>
                ...
                <cc1:CalendarExtender
                  ...
                  runat="server"
                  TargetControlID="txtHieuLucDenNgay"
                  Format="dd/MM/yyyy"
                  Enabled="true"
                />
                <cc1:MaskedEditExtender
                ...
                <td colspan="3">
                  <div runat="server" id="trThemFile" visible="false">
                    ...
                    <asp:CheckBox
                      ...
                      runat="server"
                      onclick="CheckKyso();"
                      Text="Sử dụng ký số file đính kèm"
                    />
                    <br />
