...
namespace WEB.GSTP.QLAN.AHN.Sotham.Popup
{
    public partial class pChonDonKC : System.Web.UI.Page
    {
        ...
        void LoadDrop()
        {
            ...
            ddlNguoikhangcao.Items.Clear();
            //Load đương sự
            ddlNguoikhangcao.DataSource = oDSBL.AHN_DUONGSU_KHANGCAO(DonID);
        ...
        public void LoadGrid()
        {
            ...
            DataTable tbl = objBL.GetDonGhepDonKC_DUONGSUID(Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), DonID, DuongSuID, 3, pageindex, pagesize);
