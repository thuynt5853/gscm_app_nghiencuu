<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="pChonToiDanh.aspx.cs" Inherits="WEB.GSTP.QLAN.C06.pChonToiDanh" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div>
                    ...
                    <div class="boxchung">
                        <h4 class="tleboxchung">Xem thông tin tội danh</h4>
                        <div class="boder" style="padding: 10px; margin-right: 10px">
                            <table class="table1">
                                <tr>
                                    <td style="width: 60px;"><b>Bị can</b></td>
                                    <td style="width: 250px">
                                        <asp:DropDownList ID="dropBiCao"
                                            runat="server" CssClass="chosen-select" Width="250px" Height="25px"
                                            ...
                                            <div class="phantrang">
                                                <div class="sobanghi">
                                                   <%-- <asp:Button ID="cmdSave" runat="server" CssClass="buttoninput"
                                                        Text="Lưu quyết định cho bị can" OnClick="cmdSave_Click" />--%>
