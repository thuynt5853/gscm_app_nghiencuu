...
{
    public partial class Capnhatkhangcaoquahan_AKT : System.Web.UI.Page
    {
        ...
        private void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AKT_PT_KCQUAHAN(LOAIAN, vDonViID, txtMaVuViec.Text, txtTenVuViec.Text, txtTimkiem_SoBAQD.Text, txtTimkiem_NgayBAQD.Text, txtTimkiem_NguoiKC.Text, txtTuNgay.Text, txtDenNgay.Text,
        ...
        protected void loadInfo(decimal DONID)
        {
            try
            {
                ...
                AKT_DON don = dt.AKT_DON.Where(x => x.ID == DONID).FirstOrDefault<AKT_DON>();
                AKT_SOTHAM_KHANGCAO khangcao = dt.AKT_SOTHAM_KHANGCAO.Where(x => x.ID == SOTHAM_KHANGCAO_ID).FirstOrDefault<AKT_SOTHAM_KHANGCAO>();
                AKT_DON_DUONGSU duongsu = dt.AKT_DON_DUONGSU.Where(x => x.ID == khangcao.DUONGSUID && x.DONID == don.ID).FirstOrDefault<AKT_DON_DUONGSU>();
                DM_DATAITEM tucachtotung;
                if (duongsu == null)
                {
                    AKT_DON_THAMGIATOTUNG tgtt = dt.AKT_DON_THAMGIATOTUNG.Where(x => x.ID == khangcao.DUONGSUID && x.DONID == don.ID).FirstOrDefault<AKT_DON_THAMGIATOTUNG>();
                ...
                {
                    AKT_SOTHAM_BANAN banansotham = dt.AKT_SOTHAM_BANAN.Where(x => x.ID == khangcao.SOQDBA).FirstOrDefault<AKT_SOTHAM_BANAN>();
                ...
                {
                    AKT_SOTHAM_QUYETDINH quyetdinhsotham = dt.AKT_SOTHAM_QUYETDINH.Where(x => x.ID == khangcao.SOQDBA).FirstOrDefault<AKT_SOTHAM_QUYETDINH>();
        ...
        protected void cmdSuggestSoThuly_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    AKT_SOTHAM_KHANGCAO oKhangcao = dt.AKT_SOTHAM_KHANGCAO.Where(x => x.ID == SOTHAM_KHANGCAO_ID).FirstOrDefault<AKT_SOTHAM_KHANGCAO>();
        ...
        protected void cmdCapnhatThuly_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AKT_SOTHAM_KHANGCAO oKhangcao = dt.AKT_SOTHAM_KHANGCAO.Where(x => x.ID == oThuly.KHANGCAOID).FirstOrDefault<AKT_SOTHAM_KHANGCAO>();
        ...
        protected void cmdCapnhatKetqua_old()
        {
            ...
            AKT_SOTHAM_KHANGCAO oT = dt.AKT_SOTHAM_KHANGCAO.Where(x => x.DONID == VuViecID && x.GQ_TOAANID == DonViID).FirstOrDefault();
            if (oT != null)
            {
        ...
        protected void cmdXoaKetqua_old()
        {
            ...
            AKT_SOTHAM_KHANGCAO oND = dt.AKT_SOTHAM_KHANGCAO.Where(x => x.ID == KHANGCAOID).FirstOrDefault();
            if (oND != null)
            {
                oND.GQ_NGAY = null;
        ...
        protected void cmdInDanhsach_Click(object sender, EventArgs e)
        {
            ...
            tbl = oBL.AKT_PT_KCQUAHAN(LOAIAN, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), txtMaVuViec.Text, txtTenVuViec.Text, txtTimkiem_SoBAQD.Text, txtTimkiem_NgayBAQD.Text, txtTimkiem_NguoiKC.Text, txtTuNgay.Text, txtDenNgay.Text,
                                                txtTimkiem_SoTL.Text, txtTimkiem_TuNgayTL.Text, txtTimkiem_DenNgayTL.Text, Convert.ToDecimal(ddlTimkiem_Trangthai.SelectedValue + ""), txtTrangthai_tungay.Text, txtTrangthai_denngay.Text, Convert.ToDecimal(ddlTimkiem_Thamphan.SelectedValue + ""), Convert.ToDecimal(ddlTimkiem_Thuky.SelectedValue + ""),
                                                CHECKEDLIST, 0, 0);
        ...
        protected void cmdInQuyetDinh_Chapnhan()
        {
            try
            {
                ...
                STPT_KHANGCAOQUAHAN oBL = new STPT_KHANGCAOQUAHAN();
                DataTable tbl = oBL.AKT_PT_KCQUAHAN_PRINT(Convert.ToDecimal(hddThulyid.Value), LOAIAN, Convert.ToDecimal(hddVuViecID.Value), CurrDonViID, Convert.ToDecimal(hddKhangcaoID.Value));
