<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP_VBD.Master" AutoEventWireup="true" CodeBehind="Capnhatkhangcaoquahan_AHS.aspx.cs" Inherits="WEB.GSTP.QLAN.KHANGCAOQUAHAN.Capnhatkhangcaoquahan_AHS" %>
                                                ...
                                                <table class="table1">
                                                    <tr>
                                                        ...
                                                        <td style="width: 260px;">
                                                            <asp:TextBox ID="txtMaVuAn" CssClass="user" runat="server" Width="242px" MaxLength="50"></asp:TextBox></td>
                                                        <td style="width: 62px;">Tên vụ án</td>
                                                        <td>
                                                            <asp:TextBox ID="txtTenVuAn" CssClass="user" runat="server" Width="242px" MaxLength="250"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Số BA/QĐ</td>
                                                        <td>
