...
{
    public partial class Capnhatkhangcaoquahan_AHC : System.Web.UI.Page
    {
        ...
        private void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AHC_PT_KCQUAHAN(LOAIAN, vDonViID, txtMaVuViec.Text, txtTenVuViec.Text, txtTimkiem_SoBAQD.Text, txtTimkiem_NgayBAQD.Text, txtTimkiem_NguoiKC.Text, txtTuNgay.Text, txtDenNgay.Text,
        ...
        protected void loadDDLThuly()
        {
            ...
            if (tbl != null)
            {
                ...
                {
                    if (",488,485,36,474,2338,2319,2318,48836,1417,507,383,486,487,474,473,384,490,491,492,".Contains("," + T["CHUCDANHID"].ToString() + ","))
                    {
        ...
        protected void loadInfo(decimal DONID)
        {
            try
            {
                ...
                AHC_SOTHAM_KHANGCAO khangcao = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.ID == SOTHAM_KHANGCAO_ID).FirstOrDefault<AHC_SOTHAM_KHANGCAO>();
                AHC_DON_DUONGSU duongsu = dt.AHC_DON_DUONGSU.Where(x => x.ID == khangcao.DUONGSUID && x.DONID == don.ID).FirstOrDefault<AHC_DON_DUONGSU>();
                DM_DATAITEM tucachtotung;
                if (duongsu == null)
                {
                    AHC_DON_THAMGIATOTUNG tgtt = dt.AHC_DON_THAMGIATOTUNG.Where(x => x.ID == khangcao.DUONGSUID && x.DONID == don.ID).FirstOrDefault<AHC_DON_THAMGIATOTUNG>();
                ...
                {
                    AHC_SOTHAM_BANAN banansotham = dt.AHC_SOTHAM_BANAN.Where(x => x.ID == khangcao.SOQDBA).FirstOrDefault<AHC_SOTHAM_BANAN>();
                ...
                {
                    AHC_SOTHAM_QUYETDINH quyetdinhsotham = dt.AHC_SOTHAM_QUYETDINH.Where(x => x.ID == khangcao.SOQDBA).FirstOrDefault<AHC_SOTHAM_QUYETDINH>();
        ...
        protected void cmdSuggestSoThuly_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    AHC_SOTHAM_KHANGCAO oKhangcao = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.ID == SOTHAM_KHANGCAO_ID).FirstOrDefault<AHC_SOTHAM_KHANGCAO>();
        ...
        protected void cmdCapnhatThuly_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AHC_SOTHAM_KHANGCAO oKhangcao = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.ID == oThuly.KHANGCAOID).FirstOrDefault<AHC_SOTHAM_KHANGCAO>();
        ...
        protected void cmdCapnhatKetqua_old()
        {
            ...
            AHC_SOTHAM_KHANGCAO oT = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.DONID == VuViecID && x.GQ_TOAANID == DonViID).FirstOrDefault();
            if (oT != null)
            {
        ...
        protected void cmdXoaKetqua_old()
        {
            ...
            AHC_SOTHAM_KHANGCAO oND = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.ID == KHANGCAOID).FirstOrDefault();
            if (oND != null)
            {
                oND.GQ_NGAY = null;
        ...
        protected void cmdInDanhsach_Click(object sender, EventArgs e)
        {
            ...
            tbl = oBL.AHC_PT_KCQUAHAN(LOAIAN, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), txtMaVuViec.Text, txtTenVuViec.Text, txtTimkiem_SoBAQD.Text, txtTimkiem_NgayBAQD.Text, txtTimkiem_NguoiKC.Text, txtTuNgay.Text, txtDenNgay.Text,
                                                txtTimkiem_SoTL.Text, txtTimkiem_TuNgayTL.Text, txtTimkiem_DenNgayTL.Text, Convert.ToDecimal(ddlTimkiem_Trangthai.SelectedValue + ""), txtTrangthai_tungay.Text, txtTrangthai_denngay.Text, Convert.ToDecimal(ddlTimkiem_Thamphan.SelectedValue + ""), Convert.ToDecimal(ddlTimkiem_Thuky.SelectedValue + ""),
                                                CHECKEDLIST, 0, 0);
        ...
        protected void cmdInQuyetDinh_Chapnhan()
        {
            try
            {
                ...
                STPT_KHANGCAOQUAHAN oBL = new STPT_KHANGCAOQUAHAN();
                DataTable tbl = oBL.AHC_PT_KCQUAHAN_PRINT(Convert.ToDecimal(hddThulyid.Value), LOAIAN, Convert.ToDecimal(hddVuViecID.Value), CurrDonViID, Convert.ToDecimal(hddKhangcaoID.Value));

                string fileName, saveAs, fileNameSave = "";

                fileName = TemplateWordSTPT + "rpt29HC.doc";
                saveAs = TemplateWordSTPT + "rpt29HC" + Session[ENUM_SESSION.SESSION_USERID] + ".doc";
        ...
        protected void cmdInQuyetDinh_KhongChapnhan()
        {
            try
            {
                ...
                fileName = TemplateWordSTPT + "rpt30HC.doc";
                saveAs = TemplateWordSTPT + "rpt30HC" + Session[ENUM_SESSION.SESSION_USERID] + ".doc";
