...
{
    public partial class Capnhatkhangcaoquahan_ADS : System.Web.UI.Page
    {
        ...
        protected void loadInfo(decimal DONID)
        {
            try
            {
                ...
                ADS_DON don = dt.ADS_DON.Where(x => x.ID == DONID).FirstOrDefault<ADS_DON>();
                ADS_SOTHAM_KHANGCAO khangcao = dt.ADS_SOTHAM_KHANGCAO.Where(x => x.ID == SOTHAM_KHANGCAO_ID).FirstOrDefault<ADS_SOTHAM_KHANGCAO>();

                ADS_DON_DUONGSU duongsu = dt.ADS_DON_DUONGSU.Where(x => x.ID == khangcao.DUONGSUID && x.DONID == don.ID).FirstOrDefault<ADS_DON_DUONGSU>();
                DM_DATAITEM tucachtotung;
                if (duongsu == null)
                {
                    ADS_DON_THAMGIATOTUNG tgtt = dt.ADS_DON_THAMGIATOTUNG.Where(x => x.ID == khangcao.DUONGSUID && x.DONID == don.ID).FirstOrDefault<ADS_DON_THAMGIATOTUNG>();
                ...
                {
                    ADS_SOTHAM_BANAN banansotham = dt.ADS_SOTHAM_BANAN.Where(x => x.ID == khangcao.SOQDBA).FirstOrDefault<ADS_SOTHAM_BANAN>();
                ...
                {
                    ADS_SOTHAM_QUYETDINH quyetdinhsotham = dt.ADS_SOTHAM_QUYETDINH.Where(x => x.ID == khangcao.SOQDBA).FirstOrDefault<ADS_SOTHAM_QUYETDINH>();
        ...
        protected void cmdCapnhatThuly_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ADS_SOTHAM_KHANGCAO oKhangcao = dt.ADS_SOTHAM_KHANGCAO.Where(x => x.ID == oThuly.KHANGCAOID).FirstOrDefault<ADS_SOTHAM_KHANGCAO>();
        ...
        protected void cmdXoaKetqua_old()
        {
            ...
            ADS_SOTHAM_KHANGCAO oND = dt.ADS_SOTHAM_KHANGCAO.Where(x => x.ID == KHANGCAOID).FirstOrDefault();
            if (oND != null)
            {
                oND.GQ_NGAY = null;
