...
{
    public partial class Capnhatkhangcaoquahan_ALD : System.Web.UI.Page
    {
        ...
        private void LoadGrid()
        {
            ...
            DataTable oDT = oBL.ALD_PT_KCQUAHAN(LOAIAN, vDonViID, txtMaVuViec.Text, txtTenVuViec.Text, txtTimkiem_SoBAQD.Text, txtTimkiem_NgayBAQD.Text, txtTimkiem_NguoiKC.Text, txtTuNgay.Text, txtDenNgay.Text,
        ...
        protected void loadInfo(decimal DONID)
        {
            try
            {
                ...
                ALD_DON don = dt.ALD_DON.Where(x => x.ID == DONID).FirstOrDefault<ALD_DON>();
                ALD_SOTHAM_KHANGCAO khangcao = dt.ALD_SOTHAM_KHANGCAO.Where(x => x.ID == SOTHAM_KHANGCAO_ID).FirstOrDefault<ALD_SOTHAM_KHANGCAO>();
                ALD_DON_DUONGSU duongsu = dt.ALD_DON_DUONGSU.Where(x => x.ID == khangcao.DUONGSUID && x.DONID == don.ID).FirstOrDefault<ALD_DON_DUONGSU>();
                DM_DATAITEM tucachtotung;
                if (duongsu == null)
                {
                    ALD_DON_THAMGIATOTUNG tgtt = dt.ALD_DON_THAMGIATOTUNG.Where(x => x.ID == khangcao.DUONGSUID && x.DONID == don.ID).FirstOrDefault<ALD_DON_THAMGIATOTUNG>();
                ...
                {
                    ALD_SOTHAM_BANAN banansotham = dt.ALD_SOTHAM_BANAN.Where(x => x.ID == khangcao.SOQDBA).FirstOrDefault<ALD_SOTHAM_BANAN>();
                ...
                {
                    ALD_SOTHAM_QUYETDINH quyetdinhsotham = dt.ALD_SOTHAM_QUYETDINH.Where(x => x.ID == khangcao.SOQDBA).FirstOrDefault<ALD_SOTHAM_QUYETDINH>();
        ...
        protected void cmdSuggestSoThuly_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ALD_SOTHAM_KHANGCAO oKhangcao = dt.ALD_SOTHAM_KHANGCAO.Where(x => x.ID == SOTHAM_KHANGCAO_ID).FirstOrDefault<ALD_SOTHAM_KHANGCAO>();
        ...
        protected void cmdCapnhatThuly_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ALD_SOTHAM_KHANGCAO oKhangcao = dt.ALD_SOTHAM_KHANGCAO.Where(x => x.ID == oThuly.KHANGCAOID).FirstOrDefault<ALD_SOTHAM_KHANGCAO>();
        ...
        protected void cmdCapnhatKetqua_old()
        {
            ...
            ALD_SOTHAM_KHANGCAO oT = dt.ALD_SOTHAM_KHANGCAO.Where(x => x.DONID == VuViecID && x.GQ_TOAANID == DonViID).FirstOrDefault();
            if (oT != null)
            {
        ...
        protected void cmdXoaKetqua_old()
        {
            ...
            ALD_SOTHAM_KHANGCAO oND = dt.ALD_SOTHAM_KHANGCAO.Where(x => x.ID == KHANGCAOID).FirstOrDefault();
            if (oND != null)
            {
                oND.GQ_NGAY = null;
        ...
        protected void cmdInDanhsach_Click(object sender, EventArgs e)
        {
            ...
            tbl = oBL.ALD_PT_KCQUAHAN(LOAIAN, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), txtMaVuViec.Text, txtTenVuViec.Text, txtTimkiem_SoBAQD.Text, txtTimkiem_NgayBAQD.Text, txtTimkiem_NguoiKC.Text, txtTuNgay.Text, txtDenNgay.Text,
                                                txtTimkiem_SoTL.Text, txtTimkiem_TuNgayTL.Text, txtTimkiem_DenNgayTL.Text, Convert.ToDecimal(ddlTimkiem_Trangthai.SelectedValue + ""), txtTrangthai_tungay.Text, txtTrangthai_denngay.Text, Convert.ToDecimal(ddlTimkiem_Thamphan.SelectedValue + ""), Convert.ToDecimal(ddlTimkiem_Thuky.SelectedValue + ""),
                                                CHECKEDLIST, 0, 0);
        ...
        protected void cmdInQuyetDinh_Chapnhan()
        {
            try
            {
                ...
                STPT_KHANGCAOQUAHAN oBL = new STPT_KHANGCAOQUAHAN();
                DataTable tbl = oBL.ALD_PT_KCQUAHAN_PRINT(Convert.ToDecimal(hddThulyid.Value), LOAIAN, Convert.ToDecimal(hddVuViecID.Value), CurrDonViID, Convert.ToDecimal(hddKhangcaoID.Value));
