...
{
    public partial class Capnhatkhangcaoquahan_AHS : System.Web.UI.Page
    {
        ...
        private void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AHS_PT_KCQUAHAN(LOAIAN, vDonViID, txtMaVuAn.Text, txtTenVuAn.Text, txtTimkiem_SoBAQD.Text, txtTimkiem_NgayBAQD.Text, txtTimkiem_NguoiKC.Text, txtTuNgay.Text, txtDenNgay.Text,
        ...
        protected void loadInfo(decimal DONID)
        {
            try
            {
                ...
                AHS_VUAN don = dt.AHS_VUAN.Where(x => x.ID == DONID).FirstOrDefault<AHS_VUAN>();
                AHS_SOTHAM_KHANGCAO khangcao = dt.AHS_SOTHAM_KHANGCAO.Where(x => x.ID == SOTHAM_KHANGCAO_ID).FirstOrDefault<AHS_SOTHAM_KHANGCAO>();



                if (khangcao.NGUOIKCLOAI == 0)
                {
                    AHS_BICANBICAO bicanbicao = dt.AHS_BICANBICAO.Where(x => x.ID == khangcao.NGUOIKCID).FirstOrDefault<AHS_BICANBICAO>();
                    lblNguoiKhangcao.InnerText = bicanbicao.HOTEN + " - " + "Bị cáo ";
                }
                else if (khangcao.NGUOIKCLOAI == 1)
                {
                    AHS_NGUOITHAMGIATOTUNG tgtt = dt.AHS_NGUOITHAMGIATOTUNG.Where(x => x.ID == khangcao.NGUOIKCID).FirstOrDefault<AHS_NGUOITHAMGIATOTUNG>();
                    AHS_NGUOITHAMGIATOTUNG_TUCACH tucach = dt.AHS_NGUOITHAMGIATOTUNG_TUCACH.Where(x => x.NGUOIID == tgtt.ID).FirstOrDefault<AHS_NGUOITHAMGIATOTUNG_TUCACH>();

                    DM_DATAITEM tucachtotung = dt.DM_DATAITEM.Where(x => x.ID == tucach.TUCACHID).FirstOrDefault<DM_DATAITEM>();
                ...
                {
                    AHS_SOTHAM_BANAN banansotham = dt.AHS_SOTHAM_BANAN.Where(x => x.ID == khangcao.SOQDBA).FirstOrDefault<AHS_SOTHAM_BANAN>();
                    lblBaqd.InnerText = "Số " + banansotham.SOBANAN + " ngày " + (string.IsNullOrEmpty(banansotham.NGAYBANAN + "") ? "" : ((DateTime)banansotham.NGAYBANAN).ToString("dd/MM/yyyy", cul));
                }
                else if (khangcao.LOAIKHANGCAO == 1) // quyết định
                {
                    AHS_SOTHAM_QUYETDINH_VUAN quyetdinhsotham = dt.AHS_SOTHAM_QUYETDINH_VUAN.Where(x => x.ID == khangcao.SOQDBA).FirstOrDefault<AHS_SOTHAM_QUYETDINH_VUAN>();
                    lblBaqd.InnerText = "Số " + quyetdinhsotham.SOQUYETDINH + " ngày " + (string.IsNullOrEmpty(quyetdinhsotham.NGAYQD + "") ? "" : ((DateTime)quyetdinhsotham.NGAYQD).ToString("dd/MM/yyyy", cul));
                }
                else if (khangcao.LOAIKHANGCAO == 2) // quyết định
                {
                    AHS_SOTHAM_QUYETDINH_VUAN quyetdinhsotham = dt.AHS_SOTHAM_QUYETDINH_VUAN.Where(x => x.ID == khangcao.SOQDBA).FirstOrDefault<AHS_SOTHAM_QUYETDINH_VUAN>();
                    lblBaqd.InnerText = "Số " + quyetdinhsotham.SOQUYETDINH + " ngày " + (string.IsNullOrEmpty(quyetdinhsotham.NGAYQD + "") ? "" : ((DateTime)quyetdinhsotham.NGAYQD).ToString("dd/MM/yyyy", cul));
                }
                else if (khangcao.LOAIKHANGCAO == 3) // quyết định
                {
                    AHS_SOTHAM_QUYETDINH_BICAN quyetdinhsotham = dt.AHS_SOTHAM_QUYETDINH_BICAN.Where(x => x.ID == khangcao.SOQDBA).FirstOrDefault<AHS_SOTHAM_QUYETDINH_BICAN>();
                    lblBaqd.InnerText = "Số " + quyetdinhsotham.SOQUYETDINH + " ngày " + (string.IsNullOrEmpty(quyetdinhsotham.NGAYQD + "") ? "" : ((DateTime)quyetdinhsotham.NGAYQD).ToString("dd/MM/yyyy", cul));
                }

                lblTenVuAn.InnerText = don.TENVUAN;
        ...
        protected void cmdSuggestSoThuly_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    AHS_SOTHAM_KHANGCAO oKhangcao = dt.AHS_SOTHAM_KHANGCAO.Where(x => x.ID == SOTHAM_KHANGCAO_ID).FirstOrDefault<AHS_SOTHAM_KHANGCAO>();
        ...
        protected void cmdCapnhatThuly_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AHS_SOTHAM_KHANGCAO oKhangcao = dt.AHS_SOTHAM_KHANGCAO.Where(x => x.ID == oThuly.KHANGCAOID).FirstOrDefault<AHS_SOTHAM_KHANGCAO>();
        ...
        protected void cmdCapnhatKetqua_old()
        {
            ...
            AHS_SOTHAM_KHANGCAO oT = dt.AHS_SOTHAM_KHANGCAO.Where(x => x.VUANID == VuViecID && x.GQ_TOAANID == DonViID).FirstOrDefault();
            if (oT != null)
            {
        ...
        protected void cmdXoaKetqua_old()
        {
            ...
            AHS_SOTHAM_KHANGCAO oND = dt.AHS_SOTHAM_KHANGCAO.Where(x => x.ID == KHANGCAOID).FirstOrDefault();
            if (oND != null)
            {
                oND.GQ_NGAY = null;
        ...
        protected void cmdInDanhsach_Click(object sender, EventArgs e)
        {
            ...
            tbl = oBL.AHS_PT_KCQUAHAN(LOAIAN, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), txtMaVuAn.Text, txtTenVuAn.Text, txtTimkiem_SoBAQD.Text, txtTimkiem_NgayBAQD.Text, txtTimkiem_NguoiKC.Text, txtTuNgay.Text, txtDenNgay.Text,
                                                txtTimkiem_SoTL.Text, txtTimkiem_TuNgayTL.Text, txtTimkiem_DenNgayTL.Text, Convert.ToDecimal(ddlTimkiem_Trangthai.SelectedValue + ""), txtTrangthai_tungay.Text, txtTrangthai_denngay.Text, Convert.ToDecimal(ddlTimkiem_Thamphan.SelectedValue + ""), Convert.ToDecimal(ddlTimkiem_Thuky.SelectedValue + ""),
                                                CHECKEDLIST, 0, 0);
        ...
        protected void cmdInQuyetDinh_Chapnhan()
        {
            try
            {
                ...
                STPT_KHANGCAOQUAHAN oBL = new STPT_KHANGCAOQUAHAN();
                DataTable tbl = oBL.AHS_PT_KCQUAHAN_PRINT(Convert.ToDecimal(hddThulyid.Value), LOAIAN, Convert.ToDecimal(hddVuViecID.Value), CurrDonViID, Convert.ToDecimal(hddKhangcaoID.Value));

                string fileName, saveAs, fileNameSave = "";

                fileName = TemplateWordSTPT + "rpt47HS_CN.doc";
                saveAs = TemplateWordSTPT + "rpt47HS_CN" + Session[ENUM_SESSION.SESSION_USERID] + ".doc";

                fileNameSave = "rptQD_CN_KCQH_" + tbl.Rows[0]["ITEM_HOTENNGUOIKC"].ToString().Replace(" ", "_") + ".doc";
                ...
                baoCao.MailMerge.Execute(new[] { "TCTTNGUOIBK" }, new[] { tbl.Rows[0]["ITEM_TCTTNGUOIBK"] });
                baoCao.MailMerge.Execute(new[] { "HOTENNGUOIBK" }, new[] { tbl.Rows[0]["ITEM_HOTENNGUOIBK"] });
                ...
                baoCao.MailMerge.Execute(new[] { "SOTHULYST" }, new[] { tbl.Rows[0]["ITEM_SOTHULYST"] });
                baoCao.MailMerge.Execute(new[] { "NGAYTHULYST" }, new[] { tbl.Rows[0]["ITEM_NGAYTHULYST"] });
        ...
        protected void cmdInQuyetDinh_KhongChapnhan()
        {
            try
            {
                ...
                fileName = TemplateWordSTPT + "rpt47HS_KCN.doc";
                saveAs = TemplateWordSTPT + "rpt47HS_KCN" + Session[ENUM_SESSION.SESSION_USERID] + ".doc";
        ...
        protected void cmdInQuyetDinh_Dinhchi()
        {
            try
            {
                ...
                string Ngaythuly = txtNgaythuly.Text.Substring(Math.Max(0, txtNgaythuly.Text.Length - 4));  //Convert.ToDateTime(txtNgaythuly.Text).Year.ToString();
                baoCao.MailMerge.Execute(new[] { "SOTHULYKCQH" }, new[] { txtSothuly.Text + "/" + Ngaythuly });
