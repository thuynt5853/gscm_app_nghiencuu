<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP_VBD.Master" AutoEventWireup="true" CodeBehind="Capnhatkhangcaoquahan_APS.aspx.cs" Inherits="WEB.GSTP.QLAN.KHANGCAOQUAHAN.Capnhatkhangcaoquahan_APS" %>
...
<%--                                        <asp:Button ID="cmdGiaiQuyet" runat="server" CssClass="buttoninput" Text="Giải quyết" OnClick="cmdGiaiQuyet_Click" />--%>
                                    ...
                                    <td>
                                        ...
                                        <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4" PageSize="10" AllowPaging="True" GridLines="None" PagerStyle-Mode="NumericPages" CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="TenToaAn" HeaderText="Tòa án xét xử ST" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                ...
                                                <asp:BoundColumn DataField="SONGAYTHULYXETKCQH" HeaderText="Thụ lý xét KCQH" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
    ...
    <asp:Panel ID="pnCapnhat" runat="server" align="center" CssClass="modalPopup" Style="display: none">
                        ...
                        <div>
                            ...
                            <div class="boder" style="padding: 10px;">
                                <table class="table1">
                                    ...
                                    <tr>
                                        <td style="width: 101px;"><asp:Label runat="server" ID="lbCanboHDXX" Text="Tên thẩm phán"></asp:Label><span class="batbuoc">(*)</span></td>
                                        <td>
                                            <div style="width: 250px;">
