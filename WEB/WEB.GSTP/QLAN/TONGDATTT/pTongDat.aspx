<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pTongDat.aspx.cs" Inherits="WEB.GSTP.QLAN.TONGDATTT.pTongDat" %>
...
<head runat="server">
    <title>Cập nhật Tống đạt Văn thư</title>
            ...
            <ContentTemplate>
                ...
                <div class="box">
                    <div class="box_nd">
                            ...
                            <div class="boder" style="padding: 10px;">
                                <table class="table1">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div style="width: 380px; float: left;">
                                                <asp:DropDownList ID="ddlBieumau" CssClass="chosen-select" runat="server" Width="661px" AutoPostBack="True">
                                                </asp:DropDownList>
                                    ...
                                    <tr id="trFile" runat="server">
                                        ...
                                        <td colspan="3">
                                            <%--<asp:Button ID="cmdKySo" runat="server" CssClass="buttoninput" Text="Kyso" OnClick="btnKySo_Click" />--%>
                                            <div runat="server" id="trThemFile" visible="false">
                                                ...
                                                <asp:HiddenField ID="hddKysoID" runat="server" />
                                                <asp:HiddenField ID="hddKysoValues" runat="server" />

                                                <div id="zonekyso" runat="server" style="margin-bottom: 5px; margin-top: 10px; float: left;">
                                                    
                                                    <button type="button" class="buttonkyso" id="TruongPhongKyNhay"  runat="server"  onclick="exc_sign_file1();">Chọn file đính kèm và ký số</button>
                                                ...
                                                <div id="zonekythuong" runat="server" style="display: none; float: left; margin-top: 10px; width: 80%;">
                                            ...
                                            <asp:DataGrid ID="dgTructiep" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="50px">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:CheckBox ID="chkIsSend" runat="server" Checked='<%#GetNumber(Eval("DAGUI"))%>' AutoPostBack="true" ToolTip='<%#Eval("ID")%>' OnCheckedChanged="chkIsSend_CheckChange" />
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtNgaygui" Visible='<%# GetNumber(Eval("TRANGTHAI"))%>' runat="server" Text='<%# GetTextDate(Eval("NGAYGUI"))%>' CssClass="user" Width="90px" MaxLength="10"></asp:TextBox>
                                                    ...
                                                    <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label id="lblHinhthucgui" type="text" runat="server"/>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                </Columns>
                                            ...
                                            <asp:DataGrid ID="dgTructuyen" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="70px">
                                                        ...
                                                        <ItemTemplate>
                                                            <%#(Eval("NGAYGUI")+"")==""?"Chưa gửi":"Đã gửi"%>
                                                        </ItemTemplate>
                                                        <%--<ItemTemplate>
                                                            <asp:CheckBox ID="chkIsSendTT" runat="server" Checked='<%#GetNumber(Eval("DAGUI"))%>' AutoPostBack="true" ToolTip='<%#Eval("ID")%>' OnCheckedChanged="chkIsSendTT_CheckChange" />
                                                        </ItemTemplate>--%>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px">
                                                        <HeaderTemplate>
                                                    ...
                                                    <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px">
                                                        ...
                                                        <ItemTemplate>
                                                            <%--<asp:TextBox ID="txtNgayNhan" Visible='<%# GetNumber(Eval("TRANGTHAI"))%>' runat="server" Text='<%# GetTextDate(Eval("NGAYNHANTONGDAT"))%>' CssClass="user" Width="90px" MaxLength="10"></asp:TextBox>--%>
                                                            <%# GetTextDate(Eval("NGAYNHANTONGDAT"))%>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center">
                                                        <HeaderTemplate>
                        ...
                        <div class="boxchung">
                            <h4 class="tleboxchung">Các văn bản tống đạt</h4>
                            <div class="boder" style="padding: 10px;">
                                <table class="table1">
                                    <tr>
                                        <td>
                ...
                <script type="text/javascript">       
                    ...
                    function exc_sign_file1() {
                        ...
                        var key = document.getElementById('<%=hddKysoID.ClientID%>');
                        var vhddKysoValues = document.getElementById('<%=hddKysoValues.ClientID%>');
                        var data = vhddKysoValues.Value;

                        var prms = {};
                        var scv = [{ "Key": key.Value, "Value": data }];   
                    ...
                    // function exc_sign_file_data(vkey,vValues) {
                    //    //su ky so tu databse
                    //    var prms = {};
                    //    var scv = [{ "Key": vkey, "Value": vValues }];                        
                    //    prms["SessionId"] = "";
                    //    prms["FileName"] = "";
                    //    prms["MetaData"] = scv;
                    //    var json_prms = JSON.stringify(prms);
