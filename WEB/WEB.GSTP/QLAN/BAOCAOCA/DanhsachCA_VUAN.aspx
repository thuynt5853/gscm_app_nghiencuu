    ...
    AutoEventWireup="true" CodeBehind="DanhsachCA_VUAN.aspx.cs" Inherits="WEB.GSTP.QLAN.BAOCAOCA.DanhsachCA_VUAN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="box">
        <div>
            <asp:LinkButton class="tab" ID="tabtatc" OnClick="TabClick" CommandArgument="0" runat="server" data-view="ViewTATC" TabIndex="0">Tòa án nhân dân tối cao</asp:LinkButton>
            <asp:LinkButton class="tab" ID="tabtptatc" OnClick="TabClick" CommandArgument="1" runat="server" data-view="ViewTPTATC" TabIndex="1">Thẩm phán TANDTC</asp:LinkButton>
            <asp:LinkButton class="tab" ID="tabstpt" OnClick="TabClick" CommandArgument="2" runat="server"  data-view="ViewTAND" TabIndex="2">Các Tòa án nhân dân</asp:LinkButton>
        </div>
        <div class="box_nd">
            <div class="truong">
                <table class="table1">
                                        ...
                                        <asp:Panel ID="pnTTTK" runat="server" Visible="false">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:CheckBox ID="chk_conlai" runat="server" Text="Tính cả số cũ còn lại" Visible="false"/>
                                                    <style>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <asp:DataGrid ID="dgListDon" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                PageSize="20" AllowPaging="true" GridLines="None" PagerStyle-Mode="NumericPages"
                                CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
                                ItemStyle-CssClass="chan" Width="100%" EnableViewState="true"
                                OnItemCommand="dgList_ItemCommand" OnItemDataBound="dgListDon_ItemDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderTemplate>Người khởi kiện</HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Literal ID="txtNKK" runat="server"></asp:Literal>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>

                                    <asp:TemplateColumn HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderTemplate>Người bị kiện</HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Literal ID="txtNBK" runat="server"></asp:Literal>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            <a href="javascript:;" class="link_view" onclick='ViewVuAn(
                                                <%# String.IsNullOrEmpty(Eval("ID").ToString()) ? "0" : Eval("ID").ToString() %>, 
                                                <%#Eval("DONID")%>, 
                                                <%#Eval("LoaiAn") %>)'>
                                                Thông tin vụ án
                                            </a>
                            ...
                            <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderTemplate>
                                            Thẩm tra viên<br />
                                            Lãnh đạo<br />
                                            Thẩm phán
    ...
    <script type="text/javascript">
        ...
        function ViewVuAn(vuan_id, don_id, loaian) {
            //  alert(vuan_id);
            var pageURL = '';
            if (loaian != 1)
                pageURL = '/QLAN/BAOCAOCA/Popup/ThongTinVA.aspx?vid=' + vuan_id + '&&did=' + don_id;
            else
                pageURL = '/QLAN/BAOCAOCA/Popup/ThongTinVAHS.aspx?vid=' + vuan_id + '&&did=' + don_id;
