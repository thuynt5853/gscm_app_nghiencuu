<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChiTietDonKhac.aspx.cs" Inherits="WEB.GSTP.QLAN.DONCHOXULY.Popup.ChiTietDonKhac" %>
                ...
                <div>
                    ...
                    <div class="boxchung">
                        ...
                        <div class="boder" style="padding: 10px; margin-right: 10px">
                            <table class="table1">
                                <tr>
                                    <td style="width: 100px;">Người đứng đơn là:</td>
                                    <td>
                        ...
                        <div class="boder" style="padding: 10px; margin-right: 10px">
                            <table class="table1">
                                <tr>
                                    ...
                                    <td style="width: 100px;">Giai đoạn:</td>
                                    <td>
                                        <asp:DropDownList ID="ddlGiaiDoan" runat="server" CssClass="user"
                                            Width="278px" Height="25px" Enabled="false"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
