...
{
    public partial class rptThongkeThulyVaGQD : DevExpress.XtraReports.UI.XtraReport
    {
        public rptThongkeThulyVaGQD()
        {
            InitializeComponent();
        }
        ...
        {
            xrTableCell25.Text = Parameters["TenPhongban"].Value + "";
        }
