<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="ThongKeChiTieu.aspx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.VuAn.BaoCao.Thongke.ThongKeChiTieu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="padding: 15px;">
        <table class="table1">
            ...
            <tr>
                <td style="width: 55px;"><b>Lãnh đạo</b></td>
                <td style="width: 265px;">
