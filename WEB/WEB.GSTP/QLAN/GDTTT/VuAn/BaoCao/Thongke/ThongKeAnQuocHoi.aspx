<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="ThongKeAnQuocHoi.aspx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.VuAn.BaoCao.Thongke.ThongKeAnQuocHoi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="padding: 15px;">
        <table class="table1">
            ...
            <tr>
                <td style="width: 100px;">Giải quyết từ ngày</td>
            ...
            <tr>
                ...
                <td>Thẩm tra viên</td>
                <td>
                    <asp:DropDownList ID="ddlThamtravien"
            ...
            <tr>
                ...
                <td>Loại công văn</td>
                <td>
                    <asp:DropDownList ID="ddlCongVan" CssClass="chosen-select" runat="server" Width="250px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlKetquaThuLy" CssClass="chosen-select"
                        ...
                        <asp:ListItem Value="3" Text="--Tất cả--" Selected="True"></asp:ListItem>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtCoQuanChuyenDon" runat="server"
                        CssClass="user" Width="601px" MaxLength="250"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="DonGDTCol1">Tiêu đề báo cáo</td>
                <td colspan="3">
                    <asp:TextBox ID="txtTieuDeBC" runat="server"
                        CssClass="user" Width="601px" MaxLength="250" Text="Danh sách các vụ án quốc hội"></asp:TextBox></td>
            </tr>
            <tr>
                <td></td>
                <td colspan="3">
