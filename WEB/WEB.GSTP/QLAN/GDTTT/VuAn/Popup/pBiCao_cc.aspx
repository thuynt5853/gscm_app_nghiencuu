<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pBiCao_cc.aspx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.VuAn.Popup.pBiCao_cc" %>
    ...
    <form id="form1" runat="server">
                    ...
                    <tr>
                        <td>
                            ...
                            <div style="float: left; width: 819px; margin-top: 10px;">
                                <div style="float: left; width: 100px; text-align: right; margin-top: 4px;">Đối tượng phạm tội</div>
                                <div style="float: left; margin-left: 7px;">
                                 ...
                                 <div style="float: left; width: 100px; text-align: right; margin-top: 4px;">Bị cáo đầu vụ</div>
                                <div style="float: left; margin-left: 7px;">
                            ...
                            <div style="float: left; width: 819px; margin-top: 10px;">
                                <div style="float: left; width: 100px; text-align: right; margin-top: 4px;">
                                ...
                                <div style="float: left; width: 65px; text-align: right; margin-top: 4px;">Năm sinh</div>
                                <div style="float: left; margin-left: 7px;">
                            ...
                            <div style="float: left; width: 819px; margin-top: 10px;">
                             ...
                             <div style="float: left; width: 819px; margin-top: 10px;">
                                <div style="float: left; width: 100px; text-align: right; margin-top: 4px;">CMND/Thẻ căn cước/Hộ chiếu</div>
                                <div style="float: left; margin-left: 7px;">
                                    <asp:TextBox ID="txtCMND" CssClass="user"
                                                runat="server" Width="242px" MaxLength="250"></asp:TextBox>
                                </div>
                                <div style="float: left; width: 65px; text-align: right; margin-top: 4px;">Giới tính</div>
                                <div style="float: left; margin-left: 7px;">
                            ...
                            <div style="float: left; width: 819px; margin-top: 10px;">
                                <div style="float: left; width: 100px; text-align: right; margin-top: 4px;">Quốc tịch</div>
                                <div style="float: left; margin-left: 7px;">
                                    <asp:DropDownList ID="dropQuocTich" CssClass="chosen-select"
                                                runat="server" Width="250px" AutoPostBack="True">
                                            </asp:DropDownList>
                                </div>
                                <div style="float: left; width: 65px; text-align: right; margin-top: 4px;">Trẻ vị thành niên</div>
                                <div style="float: left; margin-left: 7px;">
                            ...
                            <div style="float: left; width: 819px; margin-top: 10px;">
                                 ...
                                 <div style="float: left; width: 100px; text-align: right; margin-top: 4px;">Tái phạm, tái phạm nguy hiểm</div>
                                 <div style="float: left; margin-left: 7px;">
                            ...
                            <div style="float: left; width: 400px; margin-top: 10px; margin-left: 106px;">
                                <asp:Button ID="cmdSaveDSHinhSu" runat="server" CssClass="buttoninput" Text="Lưu" OnClick="cmdSaveDSHinhSu_Click" OnClientClick="return validate();" />
        ...
        <script>
            ...
            function validate_infor() {
                var txtBC_HoTen = document.getElementById('<%=txtBC_HoTen.ClientID%>');
                if (!Common_CheckTextBox(txtBC_HoTen, ' Họ tên Bị cáo'))
                    return false;
                //-----------------------------
                return true;
            }
