<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DSDonQuocHoi.aspx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.VuAn.Popup.DSDonQuocHoi" %>
...
<head runat="server">
    <title>Danh sách công văn 8.1</title>
                  ...
                  <table class="table1">
                        <tr>
                            <td style="width:100px;">
                                <asp:Label ID="lblTitleBC" runat="server" Text="Nguyên đơn/ Người khởi kiện"></asp:Label>
                            </td>
                            <td >
                      ...
                      <tr>
                            <td><asp:Label ID="lblTitleBCDV" runat="server" Text="Bị đơn/ Người  bị kiện"></asp:Label>
                            </td>
                            <td >
                       ...
                       <tr>
                            <td><asp:Label ID="lblTitleTD" runat="server" Text="Quan hệ pháp luật"></asp:Label>
                            </td>
                            <td >
                        ...
                        <td colspan="2">
                              <asp:DataGrid ID="dgDon" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <Columns>
                                   ...
                                   <asp:BoundColumn DataField="CV_TENDONVI" HeaderText="Cơ quan chuyển đơn"  ></asp:BoundColumn>
                                    <asp:BoundColumn DataField="CV_SO" HeaderText="CV/PC số" HeaderStyle-Width="100px" ></asp:BoundColumn>
                                    <asp:BoundColumn DataField="CV_NGAY" HeaderText="CV/PC ngày" HeaderStyle-Width="70px" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundColumn>                              
