<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pDsDon.aspx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.VuAn.Popup.pDsDon" %>
                        ...
                        <td>
                              <asp:DataGrid ID="dgDon" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateColumn HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" Visible ="false">
                                        <HeaderTemplate>Thao tác</HeaderTemplate>
                                        <ItemTemplate>
                                               <asp:LinkButton ID="cmdEdit" runat="server" Font-Bold="true" ForeColor="#0e7eee" OnClientClick="return confirm('Bạn chắc chắn muốn trả lại đơn này');"
                                                    CommandName="Tralai" CommandArgument='<%#Eval("ID") %>'>Trả lại</asp:LinkButton>
