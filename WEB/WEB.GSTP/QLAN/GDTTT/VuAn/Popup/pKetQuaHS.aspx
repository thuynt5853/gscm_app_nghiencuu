<%@ Page Language="C#" AutoEventWireup="true"
    CodeBehind="pKetQuaHS.aspx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.VuAn.Popup.pKetQuaHS" %>
                            ...
                            <table class="table1" style="width: 95%; margin: 0 auto;">
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:RadioButtonList ID="rdbLoai" runat="server"
                                            ...
                                            <asp:ListItem Value="4" Text="VKS đang giải quyết"></asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                                </tr>
                                <asp:Panel ID="pnDon" runat="server">
                                    <tr>
                                        <td>Chọn đơn</td>
                                        <td colspan="3">
                                            <asp:DropDownList ID="dropDon" CssClass="chosen-select"
                                ...
                                <asp:Panel ID="pnQDKN" Visible="false" runat="server">
                                    ...
                                    <tr>
                                        ...
                                        <td runat="server" id="txtKN_NguoiKy_td">
                                            <asp:TextBox ID="txtKN_NguoiKy" runat="server" CssClass="user" Width="262px" MaxLength="240"></asp:TextBox>
                                        </td>
                                        <td runat="server" id="dropKN_NguoiKy_td" colspan="3">
                                            <asp:DropDownList ID="dropKN_NguoiKy" CssClass="chosen-select"
                                                runat="server" OnSelectedIndexChanged="dropKN_NguoiKy_SelectedIndexChanged" Width="223px">
                                            </asp:DropDownList>
                                        </td>
                                        <tr>
                                ...
                                <asp:Panel ID="pnXepDon" runat="server" Visible="false">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtNguoiDuyetXepDon" runat="server" CssClass="user" Width="232px" MaxLength="240"></asp:TextBox>
                                        </td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtTB_Ngay" runat="server"
                                                onkeypress="return isNumber(event)"
                                                AutoPostBack="true"
                                                CssClass="user" Width="232px" MaxLength="10" OnTextChanged="txtTB_Ngay_TextChanged"></asp:TextBox>
                                        ...
                                        <td colspan="4">
                                            <asp:Repeater ID="rpt" runat="server">
                                                <HeaderTemplate>
                                                    <table class="table2" width="100%" border="1">
                                                        <tr class="header">
                                                            <td colspan="8"><strong>THÔNG BÁO </strong>
                                                            </td>
                                                        </tr>
                                                        <tr class="header">
                                                            <td width="40px">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtNgay" runat="server" onkeypress="return isNumber(event)"
                                                                Text='<%#Eval("NGAY") %>' CssClass="user" Width="70px" MaxLength="10"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <asp:Button ID="cmdUpdateThongBaoAnQH" runat="server" CssClass="buttoninput"
                                                Text="Lưu" OnClick="cmdUpdateThongBaoAnQH_Click" /></td>
                                    </tr>
                                </asp:Panel>
