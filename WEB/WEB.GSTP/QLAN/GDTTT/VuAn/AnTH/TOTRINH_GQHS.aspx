<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TOTRINH_GQHS.aspx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.VuAn.AnTH.TOTRINH_GQHS" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Quản lý tờ trình Xin ân giảm</title>
...
<body>
                        ...
                        <div class="boder" style="padding: 10px;">
                            <table class="table1" style="width: 100%; margin: 0 auto;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNgayTT" runat="server" CssClass="user"
                                            AutoPostBack="true"
                                            Width="242px" MaxLength="10" OnTextChanged="txtNgayTT_TextChanged"></asp:TextBox>
                                        <cc1:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txtNgayTT" Format="dd/MM/yyyy" Enabled="true" />
                                        <cc1:MaskedEditExtender ID="MaskedEditExtender2" runat="server" TargetControlID="txtNgayTT" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtDeXuatTTV" runat="server"
                                            CssClass="user" Width="602px"></asp:TextBox></td>
                                </tr>
                                <asp:Panel ID="pnNoiDungToTrinh" runat="server">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" style="position: relative;">
                                            ...
                                            <asp:RadioButtonList ID="rdLoaiYKien" RepeatDirection="Horizontal" runat="server">
                                                ...
                                                <asp:ListItem Value="3" Text="Bác đơn"></asp:ListItem>
                                                <asp:ListItem Value="4" Text="Xin ân giảm"></asp:ListItem>
                                            </asp:RadioButtonList>
                                    ...
                                    <tr>
                                        <td colspan="4" align="center">
                                            <div>
                                                <asp:HiddenField ID="TT_ID" runat="server" Value="0" />
                        ...
                        <asp:Repeater ID="rpt" runat="server" OnItemCommand="rpt_ItemCommand" OnItemDataBound="rpt_ItemDataBound">
                            <HeaderTemplate>
                                <table class="table2" width="100%" border="1">
                                    <tr class="header">
                                        <td width="80px">
                                            <div align="center"><strong>Số TT/Ngày</strong></div>
                                        </td>
                                        <td width="80px">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <%--<asp:Literal ID="lttSoTotrinh" runat="server"></asp:Literal>--%>
                                    
                                    <td style="text-align:center"><%#  Eval("SOTT") %> - <%# string.Format("{0:dd/MM/yyyy}",Eval("NGAYTT"))  %> </td>
                                    <td style="text-align:center"><%# string.Format("{0:dd/MM/yyyy}",Eval("NGAYTRINH")) %></td>
                                    <td style="text-align:center"><%# Eval("TENTINHTRANG") %></td>
                                    <td style="text-align:center"><%# Eval("TENLANHDAO") %></td>
                                    <td style="text-align:center"><%# Eval("NGAYDUKIENBC", "{0:dd/MM/yyyy}") %></td>
                                    <td style="text-align:center"><%# Eval("NGAYTRATT", "{0:dd/MM/yyyy}") %></td>
                                    <td style="text-align:center">
                                        
                                        <b><%# Eval("TENYKIEN") %> </b>
                                        <br />
                                        <%# Eval("TENCAPTRINHTIEP") %> 
    ...
    <script>
        function validate() {
            ...
            var txtNgaylap = document.getElementById('<%=txtNgayTT.ClientID%>');
