<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master"
    AutoEventWireup="true" CodeBehind="DanhsachAnTh.aspx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.VuAn.AnTH.DanhsachAnTh" %>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="cmdSoDonTrung" runat="server" ForeColor="#0e7eee" Font-Bold="true"
                                                CommandArgument='<%#Eval("vuanid") +"#"+ Eval("ds_id") %>' CommandName="SoDonTrung"
                                    ...
                                    <asp:TemplateColumn HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <a href="javascript:;" class="link_view" onclick='ViewVuAn(<%#Eval("ID") %>, <%#Eval("VUANID") %>)'>1. Xem Thông tin</a>
                                            <br />
                                            
                                            <a href="javascript:;" class="link_view" onclick='Totrinh_TH(<%#Eval("ID") %>, <%#Eval("VUANID") %>)'>2. Tờ Trình</a>
                                               <%--<asp:LinkButton ID="lbltotrinh" runat="server" Text="Tờ Trình" Font-Bold="true" ForeColor="#0e7eee" CausesValidation="false"
                                                    CommandName="TOTRINH_GQHS" CommandArgument='<%#Eval("ID")%>'></asp:LinkButton>--%>
                                             <br />
                                               <asp:LinkButton ID="lblKQGQHS" runat="server" Text="3. Kết quả GQHS" Font-Bold="true" ForeColor="#0e7eee" CausesValidation="false"
                                                     CommandName="KQGQHS" CommandArgument='<%#Eval("ID")%>'></asp:LinkButton>
                                            <br /> 
                                            <%#Eval("username") %>
                                            <br />
                                            <i><%#Eval("NGAYTAO") %></i>
