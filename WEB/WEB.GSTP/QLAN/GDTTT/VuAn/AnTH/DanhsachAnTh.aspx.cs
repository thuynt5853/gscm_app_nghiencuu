...
{
    public partial class DanhsachAnTh : System.Web.UI.Page
    {
        ...
        private DataTable getDS(int page_size, int pageindex)
        {
            ...
            DataTable tbl = null;
            tbl = oBL.HOSO_TUHINH_SEARCH(Session["V_COLUME"] + "", Session["V_ASC_DESC"] + "", V_ID, vToaAnID, 
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "KQGQHS":
                    Response.Redirect("CapnhatGQHS.aspx?ID=" + e.CommandArgument);
                    break;
                case "TOTRINH_GQHS":
                  
                    string StrTotrinh = "PopupReport('/QLAN/GDTTT/VuAn/AnTH/TOTRINH_GQHS.aspx?VID=" + e.CommandArgument + "','Quản lý tờ trình Hồ sơ Tử hình',1000,700);";
                    System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), StrTotrinh, true);
                    break;
                case "SoDonTrung":
                    //string StrMsgArr = "PopupReport('/QLAN/GDTTT/VuAn/AnTH/pDsDonAnGiam.aspx?type=dt&vID=" + e.CommandArgument + "','Danh sách đơn trùng HCTP nhận',1000,500);";
                    ...
                    if (arr1.Length > 0)
                    {
                        ...
                        decimal v_vuanid = String.IsNullOrEmpty(arr1[0] + "") ? 0 : Convert.ToDecimal(arr1[0] + "");
                        string StrMsgArr = "PopupReport('/QLAN/GDTTT/VuAn/AnTH/pDsDonAnGiam.aspx?type=dt&vid=" + v_vuanid + "&dsID=" + duongsu_id + "','Danh sách đơn trùng HCTP nhận',1000,500);";
                        System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), StrMsgArr, true);
                    }
                    break;
            }
