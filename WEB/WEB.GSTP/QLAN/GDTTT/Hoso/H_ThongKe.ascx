<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="H_ThongKe.ascx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.Hoso.H_ThongKe" %>
        ...
        <asp:Panel ID="pn_HCTP" runat="server" Visible="false">
            <table class="table2" style="width: 100%;" border="1">
                ...
                <asp:Repeater ID="rptHCTP" runat="server" OnItemCommand="rptHCTP_ItemCommand" OnItemDataBound="rptHCTP_ItemDataBound">
                    <HeaderTemplate>
                        <tr class="header2">
                            <td colspan="3">Tổng số đơn đã nhận</td>
                            ...
                            <td style="width: 45px;" rowspan="2">Đơn không thuộc thẩm quyền TATC</td>
                            <td style="width: 45px;" rowspan="2">Đơn chưa đủ điều kiện</td>
                            <td colspan="2">Đơn đủ điều kiện chuyển Vụ GĐKT 1</td>
                            <td colspan="2">Đơn đủ điều kiện chuyển Vụ GĐKT 2</td>
                            <td colspan="2">Đơn đủ điều kiện chuyển Vụ GĐKT 3</td>
                            <td colspan="3">Đơn chuyển 03 Tòa cấp cao</td>
                            <td style="width: 45px;" rowspan="2">Chuyển Vụ Tổ chức cán bộ</td>
                            <td style="width: 45px;" rowspan="2">Chuyển Ban Thanh tra</td>
                            ...
                            <td style="width: 45px;" rowspan="2">Đơn còn lại chưa xử lý</td>
                        </tr>
                        <tr class="header2">
                            <td style="width: 45px; height: 80px;">Văn thư đến</td>
                            <td style="width: 45px;">Ban thanh tra</td>
                            <td style="width: 45px;">Tổng</td>
                            ...
                            <td style="width: 45px;">Đơn trùng</td>
                            <td style="width: 45px;">Đơn thụ lý mới</td>
                            <td style="width: 45px;">TAND CC tại Hà Nội</td>
                            <td style="width: 45px;">TAND CC tại Đà Nẵng</td>
                            <td style="width: 45px;">TAND CC tại TP.Hồ Chí Minh</td>
                            <!------------------------------------>
                        </tr>
                        ...
                        <tr class="row_center">
                            ...
                            <td class="row_center">
                                <asp:LinkButton ID="LinkButton11" runat="server" ForeColor="#0E7EEE"
                                    Font-Bold="true" CommandArgument='<%# Eval("LoaiAn")  %>'
                                    CommandName="COLUMN_11" Text='<%# (Eval("COLUMN_11")+"")=="0"?"":Eval("COLUMN_11")  %>'></asp:LinkButton></td>
                            <td class="row_center">
                                <asp:LinkButton ID="LinkButton12" runat="server" ForeColor="#0E7EEE"
                                    Font-Bold="true" CommandArgument='<%# Eval("LoaiAn")  %>'
                                    CommandName="COLUMN_12" Text='<%# (Eval("COLUMN_12")+"")=="0"?"":Eval("COLUMN_12")  %>'></asp:LinkButton></td>
                            <td class="row_center">
                                <asp:LinkButton ID="LinkButton13" runat="server" ForeColor="#0E7EEE"
                                    Font-Bold="true" CommandArgument='<%# Eval("LoaiAn")  %>'
                                    CommandName="COLUMN_13" Text='<%# (Eval("COLUMN_13")+"")=="0"?"":Eval("COLUMN_13")  %>'></asp:LinkButton></td>
                            <td class="row_center">
                            ...
                            <td class="row_center">
                                <asp:LinkButton ID="LinkButton15" runat="server" ForeColor="#0E7EEE"
                                    Font-Bold="true" CommandArgument='<%# Eval("LoaiAn")  %>'
                                    CommandName="COLUMN_15" Text='<%# (Eval("COLUMN_15")+"")=="0"?"":Eval("COLUMN_15")  %>'></asp:LinkButton></td>
                            <td class="row_center">
