<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP_VBD.Master" AutoEventWireup="true" CodeBehind="Thongtindon.aspx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.Hoso.Thongtindon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="Ajax_Manager_Updata">
        <ContentTemplate>
            <%-- xoa thu ly--%>
            <asp:HiddenField ID="hddIDCC" runat="server" Value="0" />
            ...
            <div class="box">
                <div class="box_nd">
                    <div class="truong">
                                ...
                                <div class="boder" style="padding: 10px;">
                                    <table class="table1">
                                            ...
                                            <asp:Panel ID="pn_LOAI_GDTTT" runat="server">
                                                ...
                                                <td colspan="2">
                                                    <asp:DropDownList ID="ddl_LOAI_GDTTT" Width="250px" CssClass="chosen-select" runat="server">
                                                        ...
                                                        <asp:ListItem Value="1" Text="Giám đốc thẩm" Selected="True"></asp:ListItem>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:RadioButtonList ID="rdbBAQD" runat="server" Width="300px" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rdbBAQD_SelectedIndexChanged">
                                                    <asp:ListItem Value="0" Text="Bản án/ Quyết định" Selected="True"></asp:ListItem>
                                            ...
                                            <td colspan="2">
                                                <asp:CheckBox ID="chkKN_TBTLD" runat="server" Text="Thông báo trả lời đơn" AutoPostBack="True" OnCheckedChanged="chkKN_TBTLD_CheckedChanged" />
                                                <asp:CheckBox ID="chkIsNotGDT" runat="server" Text="Không có nội dung GDT,TT" AutoPostBack="True" OnCheckedChanged="chkIsNotGDT_CheckedChanged" />
                                            </td>
                                        </tr>
                                        ...
                                        <asp:Panel ID="pnSoBA" runat="server">
                                            ...
                                            <tr>
                                                <td class="DonGDTCol1"></td>
                                                <td class="DonGDTCol2"></td>
                                                <td class="DonGDTCol3"></td>
                                                <td></td>
                                            </tr>
                                        </asp:Panel>

                                        <asp:Panel ID="pnToaanXX" runat="server">
                                            <tr>
                                        ...
                                        <asp:Panel ID="pnPhucTham" runat="server">
                                            ...
                                            <tr>
                                                <td style="width: 120px;">Số BA/QĐ Phúc thẩm</td>
                                                <td style="width: 255px;">
                                                    <asp:TextBox ID="txtSoBA_PT" CssClass="user" runat="server" Width="242px"></asp:TextBox></td>
                                                <td style="width: 95px;">Ngày BA/QĐ Phúc thẩm</td>
                                                <td>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                            ...
                                                            <ItemTemplate>
																...
																<asp:DropDownList ID="ddlToaAn" CssClass="chosen-select" AutoPostBack="true" OnSelectedIndexChanged="ddlToaAn_SelectedIndexChanged" runat="server" Width="320px"></asp:DropDownList>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                        ...
                                        <asp:Panel ID="pnKiemtraTrung" runat="server" Visible="false">
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    ...
                                                    <asp:HiddenField ID="hddDontrungID_Chon" runat="server" Value="0" />
                                                    <asp:HiddenField ID="hddDontrungID_Huy" runat="server" Value="0" />
                                                    ...
                                                    <div style="margin: 5px; text-align: left; width: 95%; color: #ee0d0d; font-style: italic;">
                                                        <asp:Label ID="lstMsg_dontrung" Font-Size="16px" runat="server"></asp:Label>
                                                    </div>
                                                </td>
                                            </tr>
                                                    ...
                                                    <asp:DataGrid ID="dgListTrung" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="90px">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Button ID="cmdChitiet" ToolTip='<%#Eval("ID") %>' runat="server" Text="Chọn đơn" CssClass="buttonchitiet" CausesValidation="false" CommandName="Select" CommandArgument='<%#Eval("ID") +";"+Eval("VUAN_ID")+";"+Eval("LOAIAN")%>' />
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                            </asp:TemplateColumn>
                                                            ...
                                                            <asp:BoundColumn DataField="SOHIEUDON" Visible="false"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="DONGKHIEUNAI" HeaderText="Người gửi đơn" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="125px"></asp:BoundColumn>
                                                            ...
                                                            <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Top">
                                                                ...
                                                                <ItemTemplate>
                                                                    <b>BA/QĐ:</b> Số <%#Eval("SOBAQD") %>;&nbsp;Ngày: <%# GetDate(Eval("NGAYBAQD")) %>;&nbsp;<%#Eval("TOAXETXU") %>
                                                                    <div style='color: #0e7eee; font-weight: bold;'>
                                ...
                                <div class="boder" style="padding: 10px;">
                                    ...
                                    <cc1:MaskedEditExtender ID="MaskedEditExtender3" runat="server" TargetControlID="txtNgaynhandon" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />--%>
                                        ...
                                        <asp:Panel ID="pnTTDon" runat="server">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label runat="server" ID="lbl_nguoi_gui"> Người đứng đơn</asp:Label><span class="batbuoc">*</span></td>
                                                <td>
                                        ...
                                        <asp:Panel ID="pnCongvan" runat="server" Visible="false">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="4">
                                                    ...
                                                    &nbsp;&nbsp;<asp:CheckBox ID="chkTraigiam" runat="server" Text="Đơn vị là trại giam ?" AutoPostBack="true" OnCheckedChanged="chkTraigiam_CheckedChanged" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                        ...
                        <div>
                            <%--thêm đơn kèm the0--%>
                            <asp:Panel ID="pnDonTrung" runat="server">
                                <div class="boxchung">
                                    <h4 class="tleboxchung">Thêm đơn thụ lý kèm</h4>
                                    <div class="boder" style="padding: 10px;">
                                        <table class="table1">
                                            <tr>
                                                <td class="DonGDTCol1">Số đơn kèm theo</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:DataGrid ID="dgListDontrung" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                        PageSize="10" AllowPaging="false" GridLines="None" PagerStyle-Mode="NumericPages"
                                                        CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
                                                        ItemStyle-CssClass="chan" OnItemDataBound="dgListDontrung_ItemDataBound">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateColumn HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkIsCV" runat="server" AutoPostBack="true" Checked='<%# GetNumber(Eval("HINHTHUCDON"))%>'
                                                                        ToolTip='<%#Eval("TT")%>' OnCheckedChanged="chkDontrung_IsCV_CheckedChanged" />
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            ...
                                                            <asp:TemplateColumn HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkIsTrongnganh" Visible="false" runat="server" AutoPostBack="true" Checked='<%# GetNumber(Eval("LOAIDONVI"))%>'
                                                                        ToolTip='<%#Eval("TT")%>' OnCheckedChanged="chkDontrung_IsTrongnganh_CheckedChanged" />
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            <asp:TemplateColumn HeaderStyle-Width="250px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                                <HeaderTemplate>Đơn vị gửi, Người ký, Chức vụ</HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:Panel ID="pnlDontrung" Visible="false" runat="server">

                                                                        <asp:TextBox ID="txtDontrung_Donvi" Visible="false" runat="server" CssClass="user" Width="200px" MaxLength="250" placeholder="Đơn vị gửi"></asp:TextBox>
                                                                        <asp:DropDownList ID="ddlDontrung_Donvi" Visible="false" CssClass="chosen-select" runat="server" Width="200px"></asp:DropDownList>
                                                                        <asp:TextBox ID="txtDontrung_Nguoiky" runat="server" CssClass="user" Width="100px" MaxLength="250" placeholder="Người ký"></asp:TextBox>
                                                                        <asp:TextBox ID="txtDontrung_Chucvu" runat="server" CssClass="user" Width="100px" MaxLength="250" placeholder="Chức vụ"></asp:TextBox>
                        ...
                        <div class="boxchung">
                                ...
                                <table class="table1">
                                    <tr>
                                        ...
                                        <td style="width: 100px;">
                                            <asp:Label ID="lblNgayXuLy" runat="server" Text="Ngày xử lý đơn" Visible="false"></asp:Label></td>
                                        <td>
                                            <asp:TextBox ID="txtNgayXuLy" Style="text-align: right;" Visible="false" Enabled="false" runat="server" CssClass="user" Width="100px" MaxLength="50"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <asp:Panel ID="pnNoibo" runat="server">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:DropDownList ID="dropTPTC" CssClass="chosen-select"
                                                    runat="server" Width="230px">
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblLoaiAn" runat="server" Text="Loại án *"></asp:Label></td>
                                            <td colspan="3">
                                        ...
                                        <tr runat="server" id="trTrangthaidon">
                                            ...
                                            <td style="width: 200px;">
                                                <asp:Button ID="cmdXoaTL" runat="server" Text="Xóa thụ lý" OnClick="cmdXoaTL_Click" CssClass="buttoninput" Height="25px" Visible="true" />
                                                <asp:Button ID="cmdXuLyLai" runat="server" Text="Xử lý lại" OnClientClick="return confirm('Bạn chắc chắn muốn xóa số thụ lý?');" Visible="true" OnClick="cmdXuLyLai_Click" CssClass="buttoninput" Height="25px" />
                                            </td>
                                        </tr>
                            ...
                            <div class="boder">
                                ...
                                <asp:RadioButtonList ID="rdbThamquyen" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rdbTq_SelectedIndexChanged">
                                                    <asp:ListItem Value="0" Text="Đơn thuộc thẩm quyền thẩm phán tối cao&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" Selected="True"></asp:ListItem>
                                                    <asp:ListItem Value="1" Text="Đơn thuộc thẩm quyền thẩm phán bậc 3"></asp:ListItem>
                                                </asp:RadioButtonList></div>
                                <div style="color: red;text-align: center;">    
                                <asp:Label ID="lblThamquyen" runat="server" Text="Dựa trên thông tin đơn, đây là đơn dành cho thẩm phán tối cao" ForeColor="Red" Visible="false"></asp:Label>
                                <br />
                                <asp:Label ID="lblalert" runat="server"></asp:Label>  
                                    <%--danh sach tham phan bac 3 kem so don--%>
                                    <asp:DataGrid ID="List_thamphan" Visible ="false" runat="server" AutoGenerateColumns="False" CellPadding="4" Width="635px"
                                        PageSize="10" AllowPaging="false" GridLines="None" PagerStyle-Mode="NumericPages"
                                        CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
                                        ItemStyle-CssClass="chan" ForeColor="#333333" HeaderStyle-BackColor="Red"
                                        HeaderStyle-ForeColor="#FFFFFF" ItemStyle-ForeColor="#333333" AlternatingItemStyle-ForeColor="#333333"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderStyle-Width="200px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                <HeaderTemplate>Họ tên Thẩm phán</HeaderTemplate>
                                               <ItemTemplate>
                                                   <asp:Label 
                                                        ID="lblTen" 
                                                        runat="server" 
                                                        Text='<%# Eval("HOTEN_CHUCVU") %>' 
                                                        CssClass="user" 
                                                        style="display: inline-block; word-wrap: break-word;">
                                                    </asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateColumn HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                <HeaderTemplate>Tổng Vụ án được phân công</HeaderTemplate>
                                                 <ItemTemplate>
                                                     <asp:Label 
                                                          ID="lblTongAn" 
                                                          runat="server" 
                                ...
                                <asp:Panel runat="server" ID="BC_NKN_DS" Visible="false">
                                    <div style="margin-left: 30px;">
                                        <table class="table1" style="width: 70%;">
                                            ...
                                            <tr>
                                                <td>
                                                    <div style="float: left; width: 116px; margin-top: 4px;">Quan hệ pháp luật<span class="batbuoc">*</span></div>
                                                    <div style="float: left;">
                                                        <asp:TextBox ID="txt_QHPL" CssClass="user" runat="server" Width="741px"></asp:TextBox>
                                                    </div>
                                                </td>
                                            </tr>
                                            <!----------------------------->
                                            ...
                                            <tr>
                                                <td>
                                                    <div style="float: left; margin-left: 0px; margin-top: 0px; margin-top: 0px; width: 500px;">
                                                        <div style="margin: 5px; margin-left: 0px; text-align: left; width: 95%; color: red;">
                                                            <asp:Label ID="lstMsgBB" Font-Size="17px" runat="server"></asp:Label>
                                                        </div>
                                                        <div runat="server" id="div1" style="margin: 5px; margin-left: 0px; text-align: left; width: 95%">
                                                            <asp:Button ID="cmdUpdate_NDBD" runat="server" CssClass="buttoninput" Text="Lưu"
                                                                OnClick="cmdUpdate_NDBD_Click" />
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <%--//------------------------%>
                        <asp:Panel ID="pnDS_Thulylai_theo_don" runat="server" Visible="false">
                            <div class="boxchung">
                                <h4 class="tleboxchung">Thụ lý lại theo đơn</h4>
                                <div class="boder" style="padding: 10px;">
                                    <table class="table1">
                                        <tr>
                                            <td>
                                                <asp:HiddenField ID="hddTotalPageTLL" Value="1" runat="server" />
                                                <asp:HiddenField ID="hddPageIndexTLL" Value="1" runat="server" />
                                                <div class="phantrang">
                                                    <div class="sobanghi" style="display: none;">
                                                        <asp:Literal ID="lstSobanghiTTLL" runat="server"></asp:Literal>
                                                    </div>
                                                    <div class="sotrang">
                                                        <asp:LinkButton ID="lbTBackTLL" runat="server" CausesValidation="false" CssClass="back" Visible="false"
                                                            OnClick="lbTBackTLL_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbTFirstTLL" runat="server" CausesValidation="false" CssClass="active" Visible="true"
                                                            Text="1" OnClick="lbTFirstTLL_Click"></asp:LinkButton>
                                                        <asp:Label ID="lbTStep1TLL" runat="server" Text="..." Visible="false"></asp:Label>
                                                        <asp:LinkButton ID="lbTStep2TLL" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="2" OnClick="lbTStepTLL_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbTStep3TLL" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="3" OnClick="lbTStepTLL_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbTStep4TLL" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="4" OnClick="lbTStepTLL_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbTStep5TLL" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="5" OnClick="lbTStepTLL_Click"></asp:LinkButton>
                                                        <asp:Label ID="lbTStep6TLL" runat="server" Text="..." Visible="false"></asp:Label>
                                                        <asp:LinkButton ID="lbTLastTLL" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="100" OnClick="lbTLastTLL_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbTNextTLL" runat="server" CausesValidation="false" CssClass="next" Visible="false"
                                                            OnClick="lbTNextTLL_Click"></asp:LinkButton>
                                                    </div>
                                                </div>
                                                <asp:DataGrid ID="dgDSDonTLL" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    PageSize="5" AllowPaging="true" GridLines="None" PagerStyle-Mode="NumericPages"
                                                    CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
                                                    ItemStyle-CssClass="chan" OnItemCommand="dgDSDonTLL_ItemCommand" OnItemDataBound="dgDSDonTLL_ItemDataBound">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderStyle-Width="40px" HeaderStyle-HorizontalAlign="Center" Visible="false">
                                                        ...
                                                        <asp:TemplateColumn HeaderStyle-Width="40px" HeaderStyle-HorizontalAlign="Center">
                                                            ...
                                                            <ItemTemplate>
                                                                <div class="tooltip">
                                                                    ...
                                                                    <span class="tooltiptext  tooltip-bottom">Hủy trùng <%#Eval("ID") %></span>
                                                                </div>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                ...
                                                <div class="phantrang" style="display: none;">
                                                    <div class="sobanghi" style="display: none;">
                                                        <asp:Literal ID="lstSobanghiBTLL" runat="server"></asp:Literal>
                                                    </div>
                                                    <div class="sotrang">
                                                        <asp:LinkButton ID="lbBBackTLL" runat="server" CausesValidation="false" CssClass="back" Visible="false"
                                                            OnClick="lbTBackTLL_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbBFirstTLL" runat="server" CausesValidation="false" CssClass="active" Visible="false"
                                                            Text="1" OnClick="lbTFirstTLL_Click"></asp:LinkButton>
                                                        <asp:Label ID="lbBStep1TLL" runat="server" Text="..." Visible="false"></asp:Label>
                                                        <asp:LinkButton ID="lbBStep2TLL" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="2" OnClick="lbTStepTLL_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbBStep3TLL" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="3" OnClick="lbTStepTLL_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbBStep4TLL" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="4" OnClick="lbTStepTLL_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbBStep5TLL" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="5" OnClick="lbTStepTLL_Click"></asp:LinkButton>
                                                        <asp:Label ID="lbBStep6TLL" runat="server" Text="..." Visible="false"></asp:Label>
                                                        <asp:LinkButton ID="lbBLastTLL" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="100" OnClick="lbTLastTLL_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbBNextTLL" runat="server" CausesValidation="false" CssClass="next" Visible="false"
                                                            OnClick="lbTNextTLL_Click"></asp:LinkButton>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        <asp:Panel ID="pnDSTrung" runat="server" Visible="false">
                            <div class="boxchung">
                                <h4 class="tleboxchung">Đơn chưa đủ điều kiện bổ sung</h4>
                                <div class="boder" style="padding: 10px;">
                                    <table class="table1">
                                        <tr>
                                            <td>
                                                ...
                                                <asp:DataGrid ID="dgDSDonTrung" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderStyle-Width="350px" HeaderStyle-HorizontalAlign="Left">
                                                            <HeaderTemplate>Nơi chuyển đến</HeaderTemplate>
                                                            <ItemTemplate>
                                                                <b style="color: #0e7eee;"><%#Eval("TRANGTHAICHUYEN") %>:</b></i>  <b><%#Eval("NOICHUYEN") %></b> <i>(Số <%#Eval("CD_SOCV") %> - <%# GetDate(Eval("CD_NGAYCV")) %>)</i>
                                                                <br />
                        ...
                        <asp:Panel ID="pnDS_DonKemTheo" runat="server" Visible="false">
                            <div class="boxchung">
                                <h4 class="tleboxchung">Danh sách đơn kèm theo</h4>
                                <div class="boder" style="padding: 10px;">
                                    <table class="table1">
                                        <tr>
                                            <td>
                                                <asp:HiddenField ID="hddTotalPageDKT" Value="1" runat="server" />
                                                <asp:HiddenField ID="hddPageIndexDKT" Value="1" runat="server" />
                                                <div class="phantrang">
                                                    <div class="sobanghi" style="display: none;">
                                                        <asp:Literal ID="lstSobanghiDKT" runat="server"></asp:Literal>
                                                    </div>
                                                    <div class="sotrang">
                                                        <asp:LinkButton ID="lbTBackDKT" runat="server" CausesValidation="false" CssClass="back" Visible="false"
                                                            OnClick="lbTBackDKT_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbTFirstDKT" runat="server" CausesValidation="false" CssClass="active" Visible="true"
                                                            Text="1" OnClick="lbTFirstDKT_Click"></asp:LinkButton>
                                                        <asp:Label ID="lbTStep1DKT" runat="server" Text="..." Visible="false"></asp:Label>
                                                        <asp:LinkButton ID="lbTStep2DKT" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="2" OnClick="lbTStepDKT_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbTStep3DKT" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="3" OnClick="lbTStepDKT_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbTStep4DKT" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="4" OnClick="lbTStepDKT_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbTStep5DKT" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="5" OnClick="lbTStepDKT_Click"></asp:LinkButton>
                                                        <asp:Label ID="lbTStep6DKT" runat="server" Text="..." Visible="false"></asp:Label>
                                                        <asp:LinkButton ID="lbTLastDKT" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="100" OnClick="lbTLastDKT_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbTNextDKT" runat="server" CausesValidation="false" CssClass="next" Visible="false"
                                                            OnClick="lbTNextDKT_Click"></asp:LinkButton>
                                                    </div>
                                                </div>
                                                <asp:DataGrid ID="dgDSDonKemTheo" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    PageSize="5" AllowPaging="true" GridLines="None" PagerStyle-Mode="NumericPages"
                                                    CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
                                                    ItemStyle-CssClass="chan" OnItemCommand="dgDSDonKemTheo_ItemCommand" OnItemDataBound="dgDSDonKemTheo_ItemDataBound">
                                                    <Columns>
                                                        <asp:TemplateColumn HeaderStyle-Width="15px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                            <HeaderTemplate>TT</HeaderTemplate>
                                                            <ItemTemplate><%# Container.ItemIndex + 1 %></ItemTemplate>
                                                        ...
                                                        <asp:TemplateColumn HeaderStyle-Width="40px" HeaderStyle-HorizontalAlign="Center">
                                                            ...
                                                            <ItemTemplate>
                                                                <div class="tooltip">
                                                                    <asp:ImageButton ID="cmdXoa" runat="server" ToolTip="Xóa đơn kèm theo " CssClass="grid_button"
                                                                        CommandName="Xoa" CommandArgument='<%#Eval("ID") %>'
                                                                        ImageUrl="~/UI/img/delete.png" Width="17px"
                                                                        OnClientClick="return confirm('Bạn thực sự muốn hủy trùng đơn? ');" />
                                                                    <span class="tooltiptext  tooltip-bottom">Xóa đơn kèm theo <%#Eval("ID") %></span>
                                                                </div>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                ...
                                                <div class="phantrang" style="display: none;">
                                                    <div class="sobanghi" style="display: none;">
                                                        <asp:Literal ID="lstSobanghiBDKT" runat="server"></asp:Literal>
                                                    </div>
                                                    <div class="sotrang">
                                                        <asp:LinkButton ID="lbBBackDKT" runat="server" CausesValidation="false" CssClass="back" Visible="false"
                                                            OnClick="lbTBackDKT_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbBFirstDKT" runat="server" CausesValidation="false" CssClass="active" Visible="false"
                                                            Text="1" OnClick="lbTFirstDKT_Click"></asp:LinkButton>
                                                        <asp:Label ID="lbBStep1DKT" runat="server" Text="..." Visible="false"></asp:Label>
                                                        <asp:LinkButton ID="lbBStep2DKT" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="2" OnClick="lbTStepDKT_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbBStep3DKT" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="3" OnClick="lbTStepDKT_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbBStep4DKT" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="4" OnClick="lbTStepDKT_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbBStep5DKT" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="5" OnClick="lbTStepDKT_Click"></asp:LinkButton>
                                                        <asp:Label ID="lbBStep6DKT" runat="server" Text="..." Visible="false"></asp:Label>
                                                        <asp:LinkButton ID="lbBLastDKT" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                                            Text="100" OnClick="lbTLastDKT_Click"></asp:LinkButton>
                                                        <asp:LinkButton ID="lbBNextDKT" runat="server" CausesValidation="false" CssClass="next" Visible="false"
                                                            OnClick="lbTNextDKT_Click"></asp:LinkButton>
                                                    </div>
                                                </div>
                                            </td>
    ...
    <cc1:ModalPopupExtender ID="MP_Add" BehaviorID="mpe_xtl" runat="server" Y="1030" X="250"
        PopupControlID="P_XTL" TargetControlID="id_Judge_add" PopupDragHandleControlID="id_header" BackgroundCssClass="modalBackground"
        CancelControlID="cmd_close_window">
    </cc1:ModalPopupExtender>
    <asp:Panel ID="P_XTL" runat="server" CssClass="modalPopup" Style="display: none;">
                ...
                <div class="header" style="">
                    <div class="head_windowList">
                        <div class="HeadResend">
                            <asp:Label ID="txt_head_judge" runat="server" Text="Xóa Sổ thụ lý"></asp:Label>
                        </div>
                ...
                <div class="body" style="overflow-y: scroll;">
                    ...
                    <div style="float: left; width: 860px; margin-top: 10px; margin-left: 7px;">
                        ...
                        <div style="float: left; width: 100%; position: relative; margin-bottom: 10px;">
                            <h4 class="tleboxchung"><b>Nhập lý do Xóa Thụ lý</b></h4>
                            <div class="boder" style="float: left; padding: 2%; width: 100%;">
                                <div style="width: 810px; float: left; margin-top: 5px;">

                                    <div style="float: left; width: 600px; margin-left: 7px;">
                                        <asp:TextBox ID="txt_XOATHULY" runat="server"
                                            CssClass="user" Width="500px" MaxLength="350" Text=""></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="width: 810px; float: left; margin-top: 10px; margin-bottom: 10px; text-align: left;">
                            <div style="float: left;">
                                ...
                                <div style="float: left; margin-left: 20px;">
                                    <asp:Button ID="cmd_Up_XoaThuLy" runat="server" CssClass="buttoninput" Text="Lưu" OnClick="btnUp_XoaThuLy_Click" />
                                </div>
                                <div style="float: left; margin-left: 7px;">
    ...
    <script type="text/javascript">
        function validate() {
            ...
            val = vHinhthucdon;
            var ddlTrangthaidon = document.getElementById('<%=ddlTrangthaidon.ClientID%>');
            var vTrangthaidon = ddlTrangthaidon.options[ddlTrangthaidon.selectedIndex].value;
            ...
            if (vHinhthucdon != 8) {
                ...
                val = ddl_LOAI_GDTTT.options[ddl_LOAI_GDTTT.selectedIndex].value;
                var ddlLoaiAn = document.getElementById('<%=ddlLoaiAn.ClientID%>');
                var vddlLoaiAn = ddlLoaiAn.options[ddlLoaiAn.selectedIndex].value;

                var chkIsTuHinh = document.getElementById('<%=chkIsTuHinh.ClientID%>');
                var chkKeuOan = document.getElementById('<%=chkKeuOan.ClientID%>');
                var chkIsAnGiam = document.getElementById('<%=chkIsAnGiam.ClientID%>');


                if (vddlLoaiAn == '01') {

                    if (chkIsAnGiam.checked == true) {
                        if (chkKeuOan.checked == true) {
                            if (val == 0) {
                                alert('Bạn chưa chọn Thủ tục giải quyết');
                                return false;
                            }
                        }
            ...
            if (val == 31 || val == 3 || val == 6 || val == 9 || val == 10) {//Đơn + Công văn hoac  KNTP + Công Văn hoac Cong van hoac Cong van kem Ho so
                ...
                if (chkIsTrongNganh.checked) {
                    ...
                    var ddlCV_Donvi = document.getElementById('<%=ddlCV_Donvi.ClientID%>');
                    val = ddlCV_Donvi.options[ddlCV_Donvi.selectedIndex].value;
                ...
                var chkTraigiamChecked = document.getElementById('<%=chkTraigiam.ClientID%>');
                if (chkTraigiamChecked.checked) {
            ...
            if (val == 1 || val == 8 || val == 3 || val == 10) {
                ...
                //19/11/2024 Duy bao cu dong lại như này
