<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="Thongtindon_cc.aspx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.Hoso.Popup.Thongtindon_cc" %>
...
<head runat="server">
    <title>Thông tin chi tiết  đơn</title>
...
<body>
    ...
    <form id="form1" runat="server" style="padding: 30px !important">
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlHinhthucdon" Width="250px" CssClass="chosen-select" runat="server" Enabled="false" AutoPostBack="True" OnSelectedIndexChanged="ddlHinhthucdon_SelectedIndexChanged">
                                ...
                                <asp:Panel ID="pn_LOAI_GDTTT" runat="server" Enabled="false">
                                    <td>Thủ tục giải quyết</td>
                                    <td colspan="2">
                                        <asp:DropDownList ID="ddl_LOAI_GDTTT" Width="250px" CssClass="chosen-select" runat="server" Enabled="false">
                                ...
                                <asp:Panel ID="pn_Loai_KNTP" runat="server" Enabled="false" Visible="false">
                                    <td>Loại đơn</td>
                                    <td colspan="2">
                                        <asp:RadioButtonList ID="rdbLoaiKNTC_cc" runat="server" Enabled="false" Font-Bold="true" RepeatDirection="Horizontal">
                            ...
                            <tr>
                                <td>Loại QĐ/BA</td>
                                <td>
                                    <asp:RadioButtonList ID="rdbBAQD" runat="server" Enabled="false" Width="300px" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rdbBAQD_SelectedIndexChanged">
                                    ...
                                    <asp:TextBox ID="txtMaDon" Visible="false" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="50"></asp:TextBox>
                                </td>
                                <td colspan="2">
                                    <asp:CheckBox ID="chkKN_TBTLD" runat="server" Enabled="false" Text="Thông báo trả lời đơn" AutoPostBack="True" OnCheckedChanged="chkKN_TBTLD_CheckedChanged" Visible="false" />
                                    <asp:CheckBox ID="chkIsNotGDT" runat="server" Enabled="false" Text="Không có nội dung GDT,TT" AutoPostBack="True" OnCheckedChanged="chkIsNotGDT_CheckedChanged" Visible="false" />
                                </td>
                            </tr>
                            <asp:Panel ID="pnSoKhangNghi" runat="server" Enabled="false" Visible="false">
                                <tr>
                                    <td class="DonGDTCol1">Số quyết định <span runat="server" id="spSOKN" class="batbuoc">*</span></td>
                                    <td class="DonGDTCol2">
                                        <asp:TextBox ID="txtSoQDKN" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="50"></asp:TextBox>
                                    </td>
                                    <td class="DonGDTCol3">Ngày quyết định<span runat="server" id="spNGKN" class="batbuoc">*</span></td>
                                    <td>
                                        <asp:TextBox ID="txtNgayKhangNghi" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="10"></asp:TextBox>
                                        <cc1:CalendarExtender ID="CalendarExtender5" runat="server" Enabled="false" TargetControlID="txtNgayKhangNghi" Format="dd/MM/yyyy" />
                                        <cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server" Enabled="false" TargetControlID="txtNgayKhangNghi" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>Người kháng nghị
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlNguoiKhangNghi" CssClass="chosen-select" runat="server" Enabled="false" Width="250px">
                                        </asp:DropDownList>
                                    </td>
                                    <td></td>
                                    <td></td>
                            ...
                            <asp:Panel ID="pnSoBA" runat="server" Enabled="false">
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl_so_ba_qd" runat="server" Enabled="false"></asp:Label><span runat="server" id="spSOBA" class="batbuoc">*</span></td>
                                    <td>
                                        <asp:TextBox ID="txtSoQDBA" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="50"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:Label runat="server" Enabled="false" ID="lbl_ngay_ba_qd"></asp:Label><span runat="server"  id="spNGBA" class="batbuoc">*</span></td>
                                    <td>
                                        <asp:TextBox ID="txtNgayBA" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="10"></asp:TextBox>
                                        <cc1:CalendarExtender ID="CalendarExtender6" runat="server" Enabled="false" TargetControlID="txtNgayBA" Format="dd/MM/yyyy" />
                                        <cc1:MaskedEditExtender ID="MaskedEditExtender6" runat="server" Enabled="false" TargetControlID="txtNgayBA" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="DonGDTCol2">
                                        <asp:DropDownList ID="ddlToaXetXu" CssClass="chosen-select" runat="server" Enabled="false" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlToaXetXu_SelectedIndexChanged"></asp:DropDownList>
                                    </td>
                                    <td class="DonGDTCol3">Cấp xét xử</td>
                                    <td>
                                        <asp:DropDownList ID="ddlCapXetXu" CssClass="chosen-select" runat="server" Enabled="false" Width="250px"
                                ...
                                <tr runat="server" id="trTenToaXX" visible="false">
                                    ...
                                    <td colspan="3">
                                        <asp:Label ID="lblTentoaXX" ForeColor="Red" runat="server" Enabled="false"></asp:Label>
                                    </td>
                                </tr>
                            </asp:Panel>
                            <!---------------An PT----------------------------->
                            <asp:Panel ID="pnPhucTham" runat="server" Enabled="false">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 255px;">
                                        <asp:TextBox ID="txtSoBA_PT" CssClass="user" runat="server" Enabled="false" Width="242px"></asp:TextBox></td>
                                    <td style="width: 95px;">Ngày BA Phúc thẩm</td>
                                    <td>
                                        <asp:TextBox ID="txtNgayBA_PT" CssClass="user" runat="server" Enabled="false" Width="242px"></asp:TextBox>
                                        <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Enabled="false" TargetControlID="txtNgayBA_PT" Format="dd/MM/yyyy"/>
                                        <cc1:MaskedEditExtender ID="MaskedEditExtender3" runat="server" Enabled="false" TargetControlID="txtNgayBA_PT"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="dropToaAnPT" CssClass="chosen-select"
                                            ...
                                            runat="server" Enabled="false" Width="250px">
                                        </asp:DropDownList>
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                            ...
                            <!-----------An ST--------------------------------->
                            <asp:Panel ID="pnAnST" runat="server" Enabled="false">
                                <tr>
                                    <td colspan="4" style="border-bottom: 1.5px dotted #808080;"></td>
                                </tr>
                                <tr>
                                    <td>Số BA Sơ thẩm</td>
                                    <td>
                                        <asp:TextBox ID="txtSoBA_ST" CssClass="user" runat="server" Enabled="false" Width="242px"></asp:TextBox></td>
                                    <td>Ngày BA Sơ thẩm</td>
                                    <td>
                                        <asp:TextBox ID="txtNgayBA_ST" CssClass="user" runat="server" Enabled="false" Width="242px"></asp:TextBox>
                                        <cc1:CalendarExtender ID="CalendarExtender9" runat="server" Enabled="false" TargetControlID="txtNgayBA_ST" Format="dd/MM/yyyy" />
                                        <cc1:MaskedEditExtender ID="MaskedEditExtender9" runat="server" Enabled="false" TargetControlID="txtNgayBA_ST"
                                            Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <tr runat="server" id="trThongbaoTLD" visible="false">
                                <td>
                                    <asp:DropDownList ID="ddlSoTBTLD" CssClass="chosen-select" runat="server" Enabled="false" Width="115px" AutoPostBack="True" OnSelectedIndexChanged="ddlSoTBTLD_SelectedIndexChanged"></asp:DropDownList>
                                </td>
                                <td colspan="3">
                                    <asp:DataGrid ID="dgTBTLD" runat="server" Enabled="false" AutoGenerateColumns="False" CellPadding="4" Width="630px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderStyle-Width="110px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtSo" runat="server" Enabled="false" Text='<%# Eval("SO")%>' CssClass="user" Width="110px" MaxLength="250"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            <asp:TemplateColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="80px">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtNgay" runat="server" Enabled="false" Text='<%# GetDate(Eval("NGAY"))%>' CssClass="user" Width="110px" MaxLength="10"></asp:TextBox>
                                                    <cc1:CalendarExtender ID="txtNgay_CalendarExtender" runat="server" Enabled="false" TargetControlID="txtNgay" Format="dd/MM/yyyy" />
                                                    <cc1:MaskedEditExtender ID="txtNgay_MaskedEditExtender3" runat="server" Enabled="false" TargetControlID="txtNgay" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="True" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="₫" CultureDateFormat="DMY" CultureDatePlaceholder="/" CultureDecimalPlaceholder="," CultureThousandsPlaceholder="." CultureTimePlaceholder=":" />
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            <asp:TemplateColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:DropDownList ID="ddlToaAn" CssClass="chosen-select" runat="server" Enabled="false" Width="320px"></asp:DropDownList>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                            ...
                            <asp:Panel ID="pnKiemtraTrung" runat="server" Enabled="false" Visible="false">
                                <tr>
                                    <td>Trùng với đơn</td>
                                    <td colspan="3">
                                        <asp:HiddenField ID="hddDontrungID" runat="server"  Value="0" />
                                        <asp:TextBox ID="txtTenDonTrung" placeholder="Nhập thêm tên người gửi để kiểm tra trùng" CssClass="user" Width="538px" runat="server" Enabled="false"></asp:TextBox>
                                        <asp:Button ID="cmdCheckTrungDon" runat="server" Enabled="false" Text="Kiểm tra" OnClick="cmdCheckTrungDon_Click" CssClass="buttoninput" Height="25px" />
                                        <asp:Button ID="cmdHuyTrungDon" runat="server" Enabled="false" Text="Hủy trùng" Visible="false" OnClick="cmdHuyTrungDon_Click" CssClass="buttoninput" Height="25px" />
                                    </td>
                                </tr>
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlHinhthucdon_kntc" Width="250px" CssClass="chosen-select" runat="server" Enabled="false" AutoPostBack="True" OnSelectedIndexChanged="ddlHinhthucdon_kntc_SelectedIndexChanged">
                                        <asp:ListItem Value="5" Text="Văn bản hành chính,Tài liệu chung"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="Đơn đề nghị GĐT,TT"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="Đơn đề nghị GĐT,TT kèm theo CV chuyển đơn"></asp:ListItem>
                                        <asp:ListItem Value="4" Text="Hồ sơ Kháng nghị GĐT,TT"></asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td class="DonGDTCol2">
                                    <asp:RadioButtonList ID="rdbLoaiKNTC" runat="server" Enabled="false" Font-Bold="true" RepeatDirection="Horizontal">
                                        <asp:ListItem Value="1" Text="Đơn khiếu nại" Selected="True"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="Đơn tố cáo"></asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:TextBox ID="txtDoituongbiKN" CssClass="user" runat="server" Enabled="false" Width="625px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Phân loại KN,TC
                                ...
                                <td colspan="3">
                                    <asp:CheckBoxList ID="chkPhanloai" runat="server" Enabled="false" RepeatColumns="3" RepeatDirection="Horizontal"></asp:CheckBoxList>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <asp:Panel ID="PN_HOSO_KN" runat="server" Enabled="false" Visible="false">
                <div class="boxchung">
                                    ...
                                    <div style="float: left; width: 810px; margin-top: 10px; margin-left: 5px;">
                                        <div style="width: 810px; float: left; margin-top: 7px;">
                                            ...
                                            <div style="float: left; width: 200px; margin-left: 7px;">
                                                <asp:TextBox ID="txtSOKN" runat="server" Enabled="false"
                                            ...
                                            <div style="float: left; width: 200px; margin-left: 7px;">
                                                <asp:TextBox ID="txt_NGAYQDKN" CssClass="user" runat="server" Enabled="false" Width="200px"></asp:TextBox>
                                                <cc1:CalendarExtender ID="CalendarExtender10" runat="server" Enabled="false" TargetControlID="txt_NGAYQDKN" Format="dd/MM/yyyy"/>
                                                <cc1:MaskedEditExtender ID="MaskedEditExtender10" runat="server" Enabled="false" TargetControlID="txt_NGAYQDKN" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                            </div>
                                        </div>
                                        <div style="width: 810px; float: left; margin-top: 7px;">
                                            ...
                                            <div style="float: left; width: 209px; margin-left: 7px;">
                                                <asp:DropDownList ID="drop_DONVICHUYEN_HSKN" CssClass="chosen-select"
                                                    runat="server" Enabled="false" Width="209px">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div style="width: 810px; float: left; margin-top: 7px;">
                                            ...
                                            <div style="float: left; width: 200px; margin-left: 7px;">
                                                <asp:TextBox ID="txtNgaynhandon_kn" CssClass="user" runat="server" Enabled="false" Width="200px"></asp:TextBox>
                                                <cc1:CalendarExtender ID="CalendarExtender11" runat="server" Enabled="false" TargetControlID="txtNgaynhandon_kn" Format="dd/MM/yyyy"/>
                                                <cc1:MaskedEditExtender ID="MaskedEditExtender11" runat="server" Enabled="false" TargetControlID="txtNgaynhandon_kn" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                            </div>
                                            <div style="float: left; width: 190px; text-align: right;">Ý kiến chỉ đạo ?</div>
                                            <div style="float: left; width: 200px; margin-left: 7px;">
                                                <asp:DropDownList ID="ddlCAChidao_kn" CssClass="chosen-select" runat="server" Enabled="false" Width="210px" AutoPostBack="true" OnSelectedIndexChanged="ddlCAChidao_kn_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div runat="server" Enabled="false" id="trChidao_kn" style="width: 810px; float: left; margin-top: 5px;">
                                            <div style="float: left; width: 120px; text-align: right;">
                                                Nội dung chỉ đạo
                                                <br />
                                                <asp:LinkButton ID="lbtGYChidao_kn" runat="server" Enabled="false" Text="[ Copy ]" ForeColor="Blue" OnClick="lbtGYChidao_kn_Click"></asp:LinkButton>

                                            </div>
                                            <div style="float: left; width: 597px; margin-left: 7px;">
                                                <asp:TextBox ID="txtCA_Noidung_kn" CssClass="user" TextMode="MultiLine" Rows="4" runat="server" Enabled="false" Width="597px"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div style="width: 810px; float: left; margin-top: 7px;">
                                            <div style="float: left; width: 120px; text-align: right;">Tổng số bút lục</div>
                                            <div style="float: left; width: 200px; margin-left: 7px;">
                                                <asp:TextBox ID="txtTongButLucKN" runat="server" Enabled="false"
                                                    CssClass="user" Width="200px" Text=""></asp:TextBox>
                                            </div>
                                            <div style="float: left; width: 190px; text-align: right;">Số thứ tự nhận HS</div>
                                            <div style="float: left; width: 200px; margin-left: 7px;">
                                                <asp:TextBox ID="txtSoTTNhanHSKN" runat="server" Enabled="false"
                                                    CssClass="user" Width="200px" Text=""></asp:TextBox>
                                            </div>
                                        </div>
                                        <div style="width: 810px; float: left; margin-top: 7px;">
                                            ...
                                            <div style="float: left; width: 200px; margin-left: 7px;">
                                                <asp:TextBox ID="txtTuSoKN" runat="server" Enabled="false"
                                                    CssClass="user" Width="200px" Text=""></asp:TextBox>
                                            </div>
                                            <div style="float: left; width: 190px; text-align: right;">Đến số</div>
                                            <div style="float: left; width: 200px; margin-left: 7px;">
                                                <asp:TextBox ID="txtDenSoKN" runat="server" Enabled="false"
                                                    CssClass="user" Width="200px" Text=""></asp:TextBox>
                                            </div>
                                        </div>
                                        <div style="width: 810px; float: left; margin-top: 5px;">
                                            ...
                                            <div style="float: left; width: 597px; margin-left: 7px;">
                                                <asp:TextBox ID="txtNoiDungKN" runat="server" Enabled="false"
                                        ...
                                        <div style="width: 810px; float: left; margin-top: 5px;">
                                            ...
                                            <div style="float: left; width: 597px; margin-left: 7px;">
                                                <asp:TextBox ID="txt_GHICHU_HS" runat="server" Enabled="false"
                                                    CssClass="user" Width="597px" Text="" Rows="2" TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
            ...
            <asp:Panel ID="PN_VBHC_TL" runat="server" Enabled="false" Visible="true">
                <div class="boxchung">
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                                ...
                                <td class="DonGDTCol2">
                                    <asp:TextBox ID="txtSohieudon_VB" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="50"></asp:TextBox>
                                </td>
                                <td>
                                    <div style="float: left; width: 120px; text-align: right; margin-top: 5px;">Ngày trên văn bản<span class="batbuoc">*</span></div>
                                    <div style="float: left; margin-left: 7px;">
                                        <asp:TextBox ID="txtVB_Ngay" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="10"></asp:TextBox>
                                        <cc1:CalendarExtender ID="CalendarExtender14" runat="server" Enabled="false" TargetControlID="txtVB_Ngay" Format="dd/MM/yyyy" />
                                        <cc1:MaskedEditExtender ID="MaskedEditExtender14" runat="server" Enabled="false" TargetControlID="txtVB_Ngay" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>Ngày nhận VB</td>
                                <td>
                                    <asp:TextBox ID="txtNgaynhandon_VB" runat="server" Enabled="false" CssClass="user"
                                        Width="242px"></asp:TextBox>
                                    <cc1:CalendarExtender ID="CalendarExtender12" runat="server" Enabled="false" TargetControlID="txtNgaynhandon_VB"
                                        Format="dd/MM/yyyy"/>
                                    <cc1:MaskedEditExtender ID="MaskedEditExtender12" runat="server" Enabled="false" TargetControlID="txtNgaynhandon_VB"
                                        Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                </td>
                            </tr>
                            <tr>
                                <td>Người gửi là</td>
                                <td>
                                    <asp:DropDownList ID="ddlDungdonla_VB" Width="250px" CssClass="chosen-select" runat="server" Enabled="false">
                            ...
                            <tr>
                                <td>
                                    <asp:Label runat="server" Enabled="false" ID="Label1"> Người gửi<span class="batbuoc">*</span></asp:Label></td>
                                <td>
                                    <asp:TextBox ID="txtNguoigui_VB" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="250"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label runat="server" Enabled="false" ID="lbl_diachi_gui_vb">Địa chỉ gửi</asp:Label></td>
                                <td>
                                    <asp:DropDownList ID="ddl_DIACHI_GUI_BT_ID" CssClass="chosen-select" runat="server" Enabled="false" Width="250px"></asp:DropDownList>
                                </td>
                                <td>
                                    <div style="float: left; width: 120px; text-align: right; margin-top: 5px;">Chi tiết</div>
                                    <div style="float: left; margin-left: 7px;">
                                        <asp:TextBox ID="txtDiachi_VB" CssClass="user" runat="server" Enabled="false" Width="242px" MaxLength="250"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="lblTitleNoidung_VB" runat="server" Enabled="false" Text="Nội dung VB"></asp:Label>
                                </td>
                                <td colspan="4">
                                    <asp:TextBox ID="txtNoidung_VB" CssClass="user" runat="server" Enabled="false" TextMode="MultiLine" Width="88%" Rows="3"></asp:TextBox>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="4">
                                    <asp:TextBox ID="txtGhichu_VB" autocomplete="off" CssClass="user" runat="server" Enabled="false" TextMode="MultiLine" Width="88%" Rows="2" MaxLength="2000"></asp:TextBox>
                                </td>
                                <td></td>
                            </tr>
                            <tr runat="server" id="trKQGQ_VB">
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlTraloi_VB" CssClass="chosen-select" runat="server" Enabled="false" Width="250px" AutoPostBack="true" OnSelectedIndexChanged="ddlTraloi_VB_SelectedIndexChanged">
                            ...
                            <asp:Panel ID="pnCV_traloi_VB" runat="server" Enabled="false" Visible="false">
                                <tr>
                                    <td>Nội dung kết quả giải quyết</td>
                                    <td colspan="4">
                                        <asp:TextBox ID="txtCV_Traloi_Noidung_VB" CssClass="user" TextMode="MultiLine" Rows="2" runat="server" Enabled="false" Width="88%"></asp:TextBox>
                                    </td>
                                    <td></td>
                                </tr>
                            </asp:Panel>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlCAChidao_VB" CssClass="chosen-select" runat="server" Enabled="false" Width="250px" AutoPostBack="true" OnSelectedIndexChanged="ddlCAChidao_VB_SelectedIndexChanged">
                                    </asp:DropDownList></td>
                                <td></td>
                                <td></td>
                                <td></td>
                            ...
                            <tr id="trChidao_VB" runat="server" visible="false">
                                ...
                                <td colspan="4">
                                    <asp:TextBox ID="txtCA_Noidung_VB" CssClass="user" TextMode="MultiLine" Rows="4" runat="server" Enabled="false" Width="88%"></asp:TextBox>
                                </td>
                                <td></td>
                            </tr>
                        </table>
            ...
            <asp:Panel ID="PN_DON_CV" runat="server" Enabled="false" Visible="true">
                <div class="boxchung">
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                                ...
                                <td class="DonGDTCol2">
                                    <asp:TextBox ID="txtSohieudon" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="50"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <%--  <asp:TextBox ID="txtNgaynhandon" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="10"></asp:TextBox>
                                <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Enabled="false" TargetControlID="txtNgaynhandon" Format="dd/MM/yyyy" Enabled="true" />
                                <cc1:MaskedEditExtender ID="MaskedEditExtender3" runat="server" Enabled="false" TargetControlID="txtNgaynhandon" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />--%>
                                    <asp:TextBox ID="txtNgaynhandon" runat="server" Enabled="false" CssClass="user"
                                        Width="242px"></asp:TextBox>
                                    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Enabled="false" TargetControlID="txtNgaynhandon"
                                        Format="dd/MM/yyyy" />
                                    <cc1:MaskedEditExtender ID="MaskedEditExtender2" runat="server" Enabled="false" TargetControlID="txtNgaynhandon"
                                        Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />

                                </td>
                                <td>
                                    <asp:Label ID="lblTitleNgaytrendon" runat="server" Enabled="false" Text="Ngày ghi trên đơn *"></asp:Label></td>
                                <td colspan="3">
                                    <asp:TextBox ID="txtNgayghidon" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="10"></asp:TextBox>
                                    <cc1:CalendarExtender ID="CalendarExtender3" runat="server" Enabled="false" TargetControlID="txtNgayghidon" Format="dd/MM/yyyy"/>
                                    <cc1:MaskedEditExtender ID="MaskedEditExtender4" runat="server" Enabled="false" TargetControlID="txtNgayghidon" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                </td>

                            </tr>
                            <asp:Panel ID="pnTTDon" runat="server" Enabled="false">
                                <tr>
                                    <td>Đứng đơn là</td>
                                    <td>
                                        <asp:DropDownList ID="ddlDungdonla" Width="250px" CssClass="chosen-select" runat="server" Enabled="false" AutoPostBack="true" OnSelectedIndexChanged="ddlDungdonla_SelectedIndexChanged">
                                            <asp:ListItem Value="1" Text="Cá nhân" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="2" Text="Các ông, bà"></asp:ListItem>
                                            <asp:ListItem Value="3" Text="Cơ quan, tổ chức"></asp:ListItem>
                                        </asp:DropDownList>
                                    ...
                                    <td>
                                        <asp:Label ID="lblTucach" runat="server" Enabled="false" Text="Tư cách tố tụng"></asp:Label>
                                    </td>
                                    <td colspan="3">
                                        <asp:DropDownList ID="ddlTucachTT" CssClass="chosen-select" runat="server" Enabled="false" Width="250px">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label runat="server" Enabled="false" ID="lbl_nguoi_gui"> Người gửi</asp:Label><span class="batbuoc">*</span></td>
                                    <td>
                                        <asp:TextBox ID="txtNguoigui" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="250"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:Label runat="server" Enabled="false" ID="lbl_Gioitinh"> Giới tính</asp:Label>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlGioitinh" CssClass="chosen-select" runat="server" Enabled="false" Width="250px">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label runat="server" Enabled="false" ID="lbl_diachi_gui">Địa chỉ gửi</asp:Label><span class="batbuoc">*</span></td>
                                    <td>
                                        <asp:HiddenField ID="hddNGDCID" runat="server" Value="0" />
                                        <a alt="Nhập tên huyện để chọn" class="tooltipleft">
                                            <asp:TextBox ID="txtNGHuyen" CssClass="user" runat="server" Enabled="false" Width="242px" MaxLength="250"></asp:TextBox>
                                        </a>
                                    </td>
                                    <td>Chi tiết
                                    </td>
                                    <td colspan="2">
                                        <asp:TextBox ID="txtDiachi" CssClass="user" runat="server" Enabled="false" Width="242px" MaxLength="250"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>Số điện thoại</td>
                                    <td>
                                        <asp:TextBox ID="txtSoDienThoai" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="50"></asp:TextBox></td>

                                    <td>Số CMND</td>
                                    <td>
                                        <asp:TextBox ID="txtSoCMND" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="15"></asp:TextBox></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        <asp:CheckBox ID="chkGDTIsKNTC" runat="server" Enabled="false" Text="Có nội dung tố cáo" /></td>
                                ...
                                <%--     <tr>
                                    ...
                                    <td>Số CMND</td>
                                    <td>
                                        <asp:TextBox ID="txtSoCMND" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="50"></asp:TextBox></td>
                                    <td></td>
                                    <td></td>
                                </tr>--%>
                            </asp:Panel>
                            <tr>
                                <td>
                                    <asp:Label ID="lblTitleNoidung" runat="server" Enabled="false" Text="Nội dung đơn"></asp:Label>
                                    <br />
                                    <asp:LinkButton ID="lbtGYNoidung" runat="server" Enabled="false" Text="[ Copy ]" ForeColor="Blue" OnClick="lbtGYNoidung_Click"></asp:LinkButton>
                                </td>
                                <td colspan="4">
                                    <asp:TextBox ID="txtNoidung" CssClass="user" runat="server" Enabled="false" TextMode="MultiLine" Width="88%" Rows="3"></asp:TextBox>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>Ghi chú
                                    <br />
                                    <asp:LinkButton ID="lbtGYGhichu" runat="server" Enabled="false" Text="[ Copy ]" ForeColor="Blue" OnClick="lbtGYGhichu_Click"></asp:LinkButton>
                                </td>
                                <td colspan="4">
                                    <asp:TextBox ID="txtGhichu" autocomplete="off" CssClass="user" runat="server" Enabled="false" TextMode="MultiLine" Width="88%" Rows="2" MaxLength="2000"></asp:TextBox>
                                </td>
                                <td></td>
                            </tr>
                            <tr runat="server" id="trKQGQ">
                                ...
                                <td>Kết quả giải quyết ?</td>
                                <td>
                                    <asp:DropDownList ID="ddlTraloi" CssClass="chosen-select" runat="server" Enabled="false" Width="250px" AutoPostBack="true" OnSelectedIndexChanged="ddlTraloi_SelectedIndexChanged">
                                        <asp:ListItem Value="1" Text="Có"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="Không"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="Chưa xác định" Selected="True"></asp:ListItem>
                                    </asp:DropDownList></td>
                            ...
                            <asp:Panel ID="pnCV_traloi" runat="server" Enabled="false" Visible="false">
                                <tr>
                                    <td>Nội dung kết quả giải quyết</td>
                                    <td colspan="4">
                                        <asp:TextBox ID="txtCV_Traloi_Noidung" CssClass="user" TextMode="MultiLine" Rows="2" runat="server" Enabled="false" Width="88%"></asp:TextBox>
                                    </td>
                                    <td></td>
                                </tr>
                            </asp:Panel>
                            <tr>
                                <td>Ý kiến chỉ đạo ?</td>
                                <td>
                                    <asp:DropDownList ID="ddlCAChidao" CssClass="chosen-select" runat="server" Enabled="false" Width="250px" AutoPostBack="true" OnSelectedIndexChanged="ddlCAChidao_SelectedIndexChanged">
                                    </asp:DropDownList></td>
                                <td></td>
                                <td></td>
                                <td></td>
                            ...
                            <tr id="trChidao" runat="server" visible="false">
                                <td>Nội dung chỉ đạo
                                <br />
                                    <asp:LinkButton ID="lbtGYChidao" runat="server" Enabled="false" Text="[ Copy ]" ForeColor="Blue" OnClick="lbtGYChidao_Click"></asp:LinkButton>
                                </td>
                                <td colspan="4">
                                    <asp:TextBox ID="txtCA_Noidung" CssClass="user" TextMode="MultiLine" Rows="4" runat="server" Enabled="false" Width="88%"></asp:TextBox>
                                </td>
                                <td></td>
                            </tr>
                            <asp:Panel ID="pnCongvan" runat="server" Enabled="false" Visible="false">
                                ...
                                <tr>
                                    <td>Loại công văn</td>
                                    <td>
                                        <asp:DropDownList ID="ddlLoaiCongVan" Width="250px" CssClass="chosen-select" runat="server" Enabled="false" AutoPostBack="true" OnSelectedIndexChanged="ddlLoaiCongVan_SelectedIndexChanged"></asp:DropDownList>
                                    </td>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkIsTrongNganh" Checked="true" runat="server" Enabled="false" AutoPostBack="true" Text="Đơn vị gửi trong ngành" OnCheckedChanged="chkIsTrongNganh_CheckedChanged" />
                                        &nbsp;&nbsp;<asp:CheckBox ID="chkTraigiam" Visible="false" runat="server" Enabled="false" Text="Đơn vị là trại giam ?" AutoPostBack="true" OnCheckedChanged="chkTraigiam_CheckedChanged" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="lstNguoiguiTitle" runat="server" Enabled="false" Text="Người gửi/Đơn vị gửi"></asp:Label>
                                        <span class="batbuoc">(*)</span></td>
                                    <td>
                                        <asp:Panel ID="pnDonViGuiNgoaiNganh" Visible="false" runat="server" Enabled="false">
                                            <asp:TextBox ID="txtCV_DonViGuiNgoaiNganh" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="250"></asp:TextBox>
                                        </asp:Panel>
                                        <asp:Panel ID="pnDonViGuiTrongNganh" Visible="true" runat="server" Enabled="false">
                                            <asp:DropDownList ID="ddlCV_Donvi" CssClass="chosen-select" runat="server" Enabled="false" Width="250px"></asp:DropDownList>

                                        </asp:Panel>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblTraigiamhientai" runat="server" Enabled="false" Visible="false" Text="Trại giam hiện tại (nếu thay đổi)"></asp:Label>
                                    </td>
                                    <td colspan="6">
                                        <asp:TextBox ID="txtTraigiamhientai" CssClass="user" Visible="false" runat="server" Enabled="false" Width="242px" MaxLength="250"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a alt="Nhập tên huyện để chọn" class="tooltipleft">
                                            <asp:TextBox ID="txtCVDC" CssClass="user" runat="server" Enabled="false" Width="242px" MaxLength="250"></asp:TextBox>
                                        </a>
                                    </td>
                                    <td>Chi tiết
                                    </td>
                                    <td colspan="3">
                                        <asp:TextBox ID="txtCVDiachi" CssClass="user" runat="server" Enabled="false" Width="242px" MaxLength="250"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Số công văn</td>
                                    <td>
                                        <asp:TextBox ID="txtCV_So" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="250"></asp:TextBox></td>
                                    <td>Ngày công văn</td>
                                    <td>
                                        <asp:TextBox ID="txtCV_Ngay" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="10"></asp:TextBox>
                                        <cc1:CalendarExtender ID="CalendarExtender4" runat="server" Enabled="false" TargetControlID="txtCV_Ngay" Format="dd/MM/yyyy"/>
                                        <cc1:MaskedEditExtender ID="MaskedEditExtender5" runat="server" Enabled="false" TargetControlID="txtCV_Ngay" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>Người ký</td>
                                    <td>
                                        <asp:TextBox ID="txtCV_Nguoiky" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="250"></asp:TextBox>
                                    </td>
                                    <td>Chức vụ</td>
                                    <td colspan="3">
                                        <asp:TextBox ID="txtCV_Chucvu" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="250"></asp:TextBox>
                                    </td>
                                </tr>

                                <asp:Panel ID="pnCongVanNhacLai" runat="server" Enabled="false" Visible="false">
                                    <tr>
                                        <td>Nhắc lại công văn</td>
                                        <td colspan="4">
                                            <a alt="Nhập số công văn để chọn(nếu có) hoặc nhập thông tin công văn" class="tooltipright">
                                                <asp:TextBox ID="txtCongVan" CssClass="user" Width="88%" runat="server" Enabled="false"></asp:TextBox>
                                            </a>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <asp:DropDownList ID="ddlYeucauthongbao" CssClass="chosen-select" runat="server" Enabled="false" Width="250px">
                            ...
                            <tr runat="server" id="trDongkhieunai">
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlSonguoiKN" CssClass="chosen-select" runat="server" Enabled="false" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlSonguoiKN_SelectedIndexChanged"></asp:DropDownList>
                                </td>
                                <td colspan="4">
                                    <asp:CheckBox ID="chkIsCongVan" runat="server" Enabled="false" Text="Đơn có công văn ?" AutoPostBack="True" OnCheckedChanged="chkIsCongVan_CheckedChanged" />
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td colspan="5">
                                    <asp:DataGrid ID="dgNguoiKN" runat="server" Enabled="false" AutoGenerateColumns="False" CellPadding="4" Width="635px"
                                        PageSize="10" AllowPaging="false" GridLines="None" PagerStyle-Mode="NumericPages"
                                        CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderStyle-Width="140px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="ddlGioitinhDNK" CssClass="chosen-select" runat="server" Enabled="false" AutoPostBack="true" Width="120px" SelectedValue='<%# Bind("GIOITINH") %>'>
                                            ...
                                            <asp:TemplateColumn HeaderStyle-Width="250px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtHoten" runat="server" Enabled="false" Text='<%# Eval("HOTEN")%>' CssClass="user" Width="97.5%" MaxLength="250"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            <asp:TemplateColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                <HeaderTemplate>Địa chỉ người khiếu nại</HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtDiachi" runat="server" Enabled="false" Text='<%# Eval("DIACHI")%>' CssClass="user" Width="98%" MaxLength="250"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                        </Columns>
                                        <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" Visible="false"></PagerStyle>
            ...
            <asp:Panel ID="pnDonTrung" runat="server" Enabled="false" Visible="false">
                <div class="boxchung">
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlSoLuong" CssClass="chosen-select" runat="server" Enabled="false" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlSoLuong_SelectedIndexChanged"></asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <asp:DataGrid ID="dgList" runat="server" Enabled="false" AutoGenerateColumns="False" CellPadding="4"
                                        PageSize="10" AllowPaging="false" GridLines="None" PagerStyle-Mode="NumericPages"
                                        CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtSohieudon" runat="server" Enabled="false" Text='<%# Eval("SOHIEUDON")%>' CssClass="user" Width="60px" MaxLength="10"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            <asp:TemplateColumn HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <%--  <asp:TextBox ID="txtNgaynhandon" runat="server" Enabled="false" Text='<%# Eval("NGAYNHANDON")%>' CssClass="user" Width="75px" MaxLength="10"></asp:TextBox>
                                                    <cc1:CalendarExtender ID="txtNgaynhandon_CalendarExtender" runat="server" Enabled="false" TargetControlID="txtNgaynhandon" Format="dd/MM/yyyy" />
                                                    <cc1:MaskedEditExtender ID="txtNgaynhandon_MaskedEditExtender3" runat="server" Enabled="false" TargetControlID="txtNgaynhandon" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="True" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="₫" CultureDateFormat="DMY" CultureDatePlaceholder="/" CultureDecimalPlaceholder="," CultureThousandsPlaceholder="." CultureTimePlaceholder=":" />--%>
                                                    <asp:TextBox ID="txtNgaynhandon" runat="server" Enabled="false" CssClass="user"
                                                        Text='<%# Eval("NGAYNHANDON")%>' Width="75px"></asp:TextBox>
                                                    <cc1:CalendarExtender ID="txtNgaynhandon_CalendarExtender" runat="server" Enabled="false" TargetControlID="txtNgaynhandon"
                                                        Format="dd/MM/yyyy"/>
                                                    <cc1:MaskedEditExtender ID="txtNgaynhandon_MaskedEditExtender3" runat="server" Enabled="false" TargetControlID="txtNgaynhandon"
                                                        Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                            ...
                                            <asp:TemplateColumn HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtNgayghitrendon" runat="server" Enabled="false" Text='<%# Eval("NGAYGHIDON")%>' CssClass="user" Width="75px" MaxLength="10"></asp:TextBox>
                                                    <cc1:CalendarExtender ID="txtNgayghitrendon_CalendarExtender" runat="server" Enabled="false" TargetControlID="txtNgayghitrendon" Format="dd/MM/yyyy" />
                                                    <cc1:MaskedEditExtender ID="txtNgayghitrendon_MaskedEditExtender3" runat="server" Enabled="false" TargetControlID="txtNgayghitrendon" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="True" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="₫" CultureDateFormat="DMY" CultureDatePlaceholder="/" CultureDecimalPlaceholder="," CultureThousandsPlaceholder="." CultureTimePlaceholder=":" />
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            <asp:TemplateColumn HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkIsCV" runat="server" Enabled="false" AutoPostBack="true" Checked='<%# GetNumber(Eval("HINHTHUCDON"))%>'
                                            ...
                                            <asp:TemplateColumn HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtSoCV" Visible="false" runat="server" Enabled="false" CssClass="user" Width="65px" MaxLength="50"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            <asp:TemplateColumn HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                <HeaderTemplate>Ngày CV</HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtNgayCV" Visible="false" runat="server" Enabled="false" Text='<%# Eval("NGAYGHIDON")%>' CssClass="user" Width="75px" MaxLength="10"></asp:TextBox>
                                                    <cc1:CalendarExtender ID="txtNgayCV_CalendarExtender" runat="server" Enabled="false" TargetControlID="txtNgayCV" Format="dd/MM/yyyy" />
                                                    <cc1:MaskedEditExtender ID="txtNgayCV_MaskedEditExtender3" runat="server" Enabled="false" TargetControlID="txtNgayCV" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="True" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="₫" CultureDateFormat="DMY" CultureDatePlaceholder="/" CultureDecimalPlaceholder="," CultureThousandsPlaceholder="." CultureTimePlaceholder=":" />
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            <asp:TemplateColumn HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                <HeaderTemplate>Trong ngành?</HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkIsTrongnganh" Visible="false" runat="server" Enabled="false" AutoPostBack="true" Checked='<%# GetNumber(Eval("LOAIDONVI"))%>'
                                            ...
                                            <asp:TemplateColumn HeaderStyle-Width="250px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtDonvi" Visible="false" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="250"></asp:TextBox>
                                                    <asp:DropDownList ID="ddlDonvi" Visible="false" CssClass="chosen-select" runat="server" Enabled="false" Width="250px"></asp:DropDownList>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                        </Columns>
                                        <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" Visible="false"></PagerStyle>
            ...
            <div class="boxchung">
                <h4 class="tleboxchung">
                    <asp:Label ID="TTChuyenDon" runat="server" Enabled="false" Text="Thông tin chuyển đơn"></asp:Label>
                </h4>
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            ...
                            <td colspan="3" style="width: 500px;">
                                <asp:RadioButtonList ID="rdbLoaichuyen" runat="server" Enabled="false" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="rdbLoaichuyen_SelectedIndexChanged">
                            ...
                            <td style="width: 100px;">
                                <asp:Label ID="lblNgayXuLy" runat="server" Enabled="false" Text="Ngày xử lý đơn"></asp:Label></td>
                            <td>
                        ...
                        <tr style="display: none;">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlPhanloai" CssClass="chosen-select" runat="server" Enabled="false" Width="250px" AutoPostBack="true" OnSelectedIndexChanged="ddlPhanloai_SelectedIndexChanged">
                        ...
                        <asp:Panel ID="pnNoibo_vb" runat="server" Enabled="false">
                            <tr>
                                <td colspan="6">
                                    <div style="float: left; margin-top: 15px;">
                                        <div style="width: 164px; float: left;">Đơn vị chuyển đến</div>
                                        <div style="float: left;">
                                            <asp:DropDownList ID="ddlChuyendenDV_VB" CssClass="chosen-select" runat="server" Enabled="false" Width="478px" AutoPostBack="True">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td colspan="6">
                                    <div style="float: left;">
                                        ...
                                        <div style="float: left">
                                            <asp:TextBox ID="txtNgayChuyen_VB" runat="server" Enabled="false" CssClass="user" Width="112px" MaxLength="10"></asp:TextBox>
                                            <cc1:CalendarExtender ID="CalendarExtender13" runat="server" Enabled="false" TargetControlID="txtNgayChuyen_VB" Format="dd/MM/yyyy"/>
                                            <cc1:MaskedEditExtender ID="MaskedEditExtender13" runat="server" Enabled="false" TargetControlID="txtNgayChuyen_VB" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                        </div>
                                    </div>
                                </td>
                            </tr>
                        </asp:Panel>
                        <asp:Panel ID="pnlLoaiAn" runat="server" Enabled="false">
                            <tr>
                                <td>
                                    <asp:Label ID="lblLoaiAn" runat="server" Enabled="false" Text="Loại án"></asp:Label><span class="batbuoc">*</span>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlLoaiAn" CssClass="chosen-select" runat="server" Enabled="false" Width="250px"
                        ...
                        <asp:Panel ID="pnNoibo" runat="server" Enabled="false">
                            <tr>
                                <td>Đơn vị chuyển đến<span class="batbuoc">*</span></td>
                                <td colspan="3">
                                    <asp:DropDownList ID="ddlChuyendenDV" CssClass="chosen-select" runat="server" Enabled="false" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlChuyendenDV_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr id="trTuHinh" runat="server">
                                ...
                                <td colspan="5" style="padding-top: 7px; padding-bottom: 7px;">
                                    <asp:CheckBox ID="chkIsTuHinh" runat="server" Enabled="false" Text="Án tử hình" AutoPostBack="True" OnCheckedChanged="chkIsTuHinh_CheckedChanged" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:CheckBox ID="chkIsAnGiam" Visible="false" runat="server" Enabled="false" Text="Xin ân giảm án tử hình" />
                                    &nbsp;
                                    <asp:CheckBox ID="chkKeuOan" Visible="false" runat="server" Enabled="false" Text="Kêu oan án tử hình" />
                                </td>
                            </tr>
                            <tr runat="server" id="trTrangthaidon">
                                <td class="DonGDTCol1">Trạng thái đơn</td>
                                <td class="DonGDTCol2">
                                    <asp:DropDownList ID="ddlTrangthaidon" CssClass="chosen-select" runat="server" Enabled="false" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlTrangthaidon_SelectedIndexChanged">
                                ...
                                <td class="DonGDTCol3">
                                    <asp:Label ID="lblLydoCDDK" runat="server" Enabled="false" Text="Thụ lý đơn"></asp:Label>
                                </td>
                                <td colspan="3">
                                    <asp:CheckBoxList ID="chkLydoCDDK" runat="server" Enabled="false" RepeatDirection="Horizontal" RepeatColumns="2" Visible="false" AutoPostBack="True" OnSelectedIndexChanged="chkLydoCDDK_SelectedIndexChanged">
                                    ...
                                    <asp:RadioButtonList ID="rdbThuLy" runat="server" Enabled="false" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rdbThuLy_SelectedIndexChanged">
                            ...
                            <tr runat="server" id="trLydokhac" visible="false">
                                <td colspan="6">
                                    <asp:TextBox ID="txtLydoCDDK_Khac" runat="server" Enabled="false" CssClass="user" TextMode="MultiLine" Width="88%" Rows="3" MaxLength="2000"></asp:TextBox>
                                </td>
                            </tr>
                            <asp:Panel ID="pnThuLy" Visible="true" runat="server" Enabled="false">
                                <tr>
                                    <td>
                                        <asp:Label ID="lblSoThuly" runat="server" Enabled="false" Text="Số thụ lý"></asp:Label>
                                        <span class="batbuoc">*</span></td>
                                    <td>
                                        <asp:TextBox ID="txtSoThuLy" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="50"></asp:TextBox>

                                    </td>
                                    <td>
                                        <asp:Label ID="lblNgaythuly" runat="server" Enabled="false" Text=" Ngày thụ lý đơn"></asp:Label>
                                        <span class="batbuoc">*</span></td>
                                    <td colspan="3">
                                        <asp:TextBox ID="txtNgaythuly" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="10"></asp:TextBox>
                                        <cc1:CalendarExtender ID="CalendarExtender8" runat="server" Enabled="false" TargetControlID="txtNgaythuly" Format="dd/MM/yyyy"/>
                                        <cc1:MaskedEditExtender ID="MaskedEditExtender8" runat="server" Enabled="false" TargetControlID="txtNgaythuly" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                                    </td>
                                </tr>
                                <tr style="display: none;">
                                    ...
                                    <td>Người thụ lý</td>
                                    <td>
                                        <asp:DropDownList ID="ddlNguoiThuly" CssClass="chosen-select" runat="server" Enabled="false" Width="250px">
                                        </asp:DropDownList></td>
                                    <td></td>
                                    <td colspan="3"></td>
                                </tr>
                            ...
                            <tr>
                                <td>Ghi chú</td>
                                <td colspan="5">
                                    <asp:TextBox ID="txt_GHICHU_TTCD" runat="server" Enabled="false" CssClass="user" Width="621px"></asp:TextBox></td>
                            </tr>
                        </asp:Panel>
                        <asp:Panel ID="pnToakhac" Visible="false" runat="server" Enabled="false">
                            <tr>
                                <td class="DonGDTCol1">Đơn vị chuyển đến<span class="batbuoc">*</span></td>
                                <td class="DonGDTCol2">
                                    <asp:DropDownList ID="ddlToaKhac" CssClass="chosen-select" runat="server" Enabled="false" Width="250px"></asp:DropDownList>

                                </td>
                                <td class="DonGDTCol3">Đơn gửi tới</td>
                                <td colspan="3">
                                    <asp:RadioButtonList ID="rdbDonguitoi" runat="server" Enabled="false" RepeatDirection="Horizontal">
                                        <asp:ListItem Value="0" Text="TA" Selected="True"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="CA"></asp:ListItem>
                                    </asp:RadioButtonList></td>
                            </tr>
                        </asp:Panel>
                        <asp:Panel ID="pnNgoaitoaan" Visible="false" runat="server" Enabled="false">
                            <tr>
                                <td class="DonGDTCol1">Đơn vị chuyển đến<span class="batbuoc">*</span></td>
                                <td colspan="5">
                                    <asp:TextBox ID="txtNgoaitoaan" CssClass="user" runat="server" Enabled="false" Width="625px"></asp:TextBox>
                                </td>
                            </tr>
                        </asp:Panel>
                        <asp:Panel ID="pnTralaidon" Visible="false" runat="server" Enabled="false">
                            <tr>
                                <td class="DonGDTCol1">Lý do trả lại</td>
                                <td class="DonGDTCol2">
                                    <asp:DropDownList ID="ddlLydotralai" CssClass="chosen-select" runat="server" Enabled="false" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlLydotralai_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                                <td class="DonGDTCol3">
                                    <asp:Label ID="lblLydokhac" runat="server" Enabled="false" Visible="false" Text="Lý do khác"></asp:Label>
                                </td>
                                <td colspan="3">
                                    <asp:TextBox ID="txtTralaikhac" Visible="false" CssClass="user" runat="server" Enabled="false" Width="242px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Yêu cầu</td>
                                <td colspan="5">
                                    <asp:TextBox ID="txtTralaiYeucau" runat="server" Enabled="false" CssClass="user" Width="625px"></asp:TextBox></td>
                            </tr>
                            <tr style="display: none;">
                                <td>Số phiếu trả lại</td>
                                <td>
                                    <asp:TextBox ID="txtTralaiSophieu" CssClass="user" runat="server" Enabled="false" Width="242px"></asp:TextBox></td>
                                <td>Ngày trả lại</td>
                                <td colspan="3">
                                    <asp:TextBox ID="txtTralaiNgay" runat="server" Enabled="false" CssClass="user" Width="242px" MaxLength="10"></asp:TextBox>
                                    <cc1:CalendarExtender ID="CalendarExtender7" runat="server" Enabled="false" TargetControlID="txtTralaiNgay" Format="dd/MM/yyyy"/>
                                    <cc1:MaskedEditExtender ID="MaskedEditExtender7" runat="server" Enabled="false" TargetControlID="txtTralaiNgay" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
            ...
            <div class="boxchung" runat="server" id="KN_BiCao">
                <h4 class="tleboxchung">
                    <asp:Label ID="lbl_KN_BC" runat="server" Enabled="false" Text="Bị cáo, Người khiếu nại"></asp:Label></h4>
                <div class="boder" style="padding: 10px;">
                    <asp:Panel runat="server" Enabled="false" ID="BC_NKN_HS" Visible="true">
                        <table class="table1">
                            <tr>
                                <td>
                                    <div style="float: left; width: 120px; text-align: right; margin-top: 3px;">Người khiếu nại</div>
                                    <div style="float: left; margin-left: 7px;">
                                        <asp:DropDownList ID="dropNguoiKhieuNai" runat="server" Enabled="false" CssClass="chosen-select" Width="250px"
                                            AutoPostBack="true" OnSelectedIndexChanged="dropNguoiKhieuNai_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </div>
                                    <div style="float: left; margin-left: 7px;">
                                        <%--<asp:LinkButton ID="lkThemNguoiKN" runat="server" Enabled="false" OnClick="lkThemNguoiKN_Click"
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div style="float: left; margin-left: 7px;">
                                        <asp:DropDownList ID="dropBiCao" runat="server" Enabled="false" Width="250px" CssClass="chosen-select"
                                            OnSelectedIndexChanged="dropBiCao_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </div>
                                    <div style="float: left; margin-left: 7px;">
                                        <%--<asp:LinkButton ID="lkThem_BC" runat="server" Enabled="false" OnClick="lkThemBiCao_Click"
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div style="float: left; margin-left: 7px;">
                                        <asp:TextBox ID="txtNguoiKN_NoiDung" CssClass="user" runat="server" Enabled="false" Width="606px"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <%--<div style="float: left; margin-left: 125px; margin-top: 11px;">
                                        <div style="float: left">
                                            <asp:Button ID="cmdSaveDSHinhSu" runat="server" Enabled="false" CssClass="buttoninput" Text="Lưu" OnClick="cmdSaveDSHinhSu_Click" />
                                        </div>
                                        <div style="float: left; margin-left: 7px;">
                                            <asp:Button ID="cmdRefresh" runat="server" Enabled="false" CssClass="buttoninput" Text="Làm mới"
                                                OnClick="cmdRefresh_Click" />
                                        </div>
                                        <div style="display: none;">
                                            <asp:Button ID="cmd_load_dstd_cc" runat="server" Enabled="false" CssClass="buttoninput" Text="Làm mới"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div id="td_sua_div" runat="server" align="center" style="width: 69px;">
                                                            ...
                                                            <div style="display: none;">
                                                                <%--<asp:LinkButton ID="lkSua" runat="server" Enabled="false"
                                                                    Text="Sửa" ForeColor="#0e7eee"
                    ...
                    <asp:Panel runat="server" ID="BC_NKN_DS" Visible="false">
                        <table class="table1" style="width: 70%;">
                            <tr>
                                <td>
                                    <div style="margin: 5px; width: 95%; color: red;">
                                        <asp:Label ID="lttMsg" runat="server" Enabled="false"></asp:Label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    ...
                                    <div style="float: left;">
                                        <asp:TextBox ID="txt_QHPL" CssClass="user" runat="server" Enabled="false" Width="616px"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                            <!----------------------------->
                            <asp:Panel ID="pnNguyenDon" runat="server" Enabled="false">
                                <tr>
                                ...
                                <tr>
                                    <td colspan="4"><b style="margin-right: 10px;">Nguyên đơn/ Người khởi kiện</b>
                                        ...
                                        <asp:CheckBox ID="chkND" runat="server" Enabled="false" Text="Có địa chỉ"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtTen" Width="96%" CssClass="user"
                                                            placeholder="Họ tên(*)"
                                                            runat="server" Enabled="false" Text='<%#Eval("TenDuongSu") %>'></asp:TextBox></td>

                                                    <asp:Panel ID="pn_diachi" runat="server" Enabled="false">
                                                        <td width="250px">
                                                            <asp:HiddenField ID="hddHuyenID" runat="server" Value='<%# Eval("HUYENID") %>' />
                                                            <asp:DropDownList ID="ddlTinhHuyen" CssClass="chosen-select" runat="server" Enabled="false" Width="250px"></asp:DropDownList>
                                                        </td>
                                                        <td width="190px">
                                                            <asp:TextBox ID="txtDiachi" Width="96%"
                                                                placeholder="Địa chỉ chi tiết"
                                                                CssClass="user" runat="server" Enabled="false"
                                                                Text='<%# Eval("DiaChi") %>'></asp:TextBox></td>
                                                    </asp:Panel>
                                                    <td width="30px">
                                                        <div align="center">
                                                            <asp:LinkButton ID="lkXoa" Visible='<%#(Convert.ToInt16(Eval("IsDelete")+"")==0)? false:true %>' runat="server" Enabled="false"
                            ...
                            <!----------------------------->
                            <asp:Panel ID="pnBiDon" runat="server" Enabled="false">
                                <tr>
                                    <td colspan="4" style="height: 5px;"></td>
                                </tr>
                                <tr>
                         ...
                         <%--               <asp:LinkButton ID="lkThemBD" runat="server" CssClass="buttonpopup them_user clear_bottom" ToolTip="Thêm bị đơn/ Người bị kiện"
                                        ...
                                        <asp:CheckBox ID="chkBD" runat="server" Enabled="false" Text="Có địa chỉ"
                            ...
                            <!----------------------------->
                            <asp:Panel ID="pnDsKhac" runat="server" Enabled="false">
                                <tr>
                                    <td colspan="4" style="height: 5px;"></td>
                                </tr>
                                <tr>
                                    <td colspan="4"><b style="margin-right: 10px;">Người có QL&NVLQ</b>
                                        ...
                                        <asp:CheckBox ID="chkDSKhac" runat="server" Enabled="false" Text="Có địa chỉ"
            ...
            <asp:Panel ID="pnBoSung" runat="server" Enabled="false">
                <div class="boxchung">
                    <h4 class="tleboxchung">Quá trình bổ sung tài liệu</h4>
                    <div class="boder" style="padding: 10px;">
                        <asp:DataGrid ID="dgDS" runat="server" Enabled="false" AutoGenerateColumns="False" CellPadding="4"
                            PageSize="10" AllowPaging="false" GridLines="None" PagerStyle-Mode="NumericPages"
                            CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
