...
namespace WEB.GSTP.QLAN.GDTTT.Hoso.Popup
{
    public partial class pBiCao : System.Web.UI.Page
    {
        ...
        void Update_DuongSu_AnHS()
        {
            ...
            GDTTT_DON_DUONGSU_CC obj = dt.GDTTT_DON_DUONGSU_CC.Where(x => x.ID == DuongSuID && x.DONID == don_id).Single<GDTTT_DON_DUONGSU_CC>();
            ...
            {//update lại các bị báo ->không phải là đầu vụ
                List<GDTTT_DON_DUONGSU_CC> lst = dt.GDTTT_DON_DUONGSU_CC.Where(x => x.DONID == don_id).OrderBy(y => y.DONID).ToList();
                foreach (GDTTT_DON_DUONGSU_CC its in lst)
                {
                    its.HS_BICANDAUVU = 0;
                    dt.SaveChanges();
                }
        ...
        protected void ThemBiCao()
        {
            ...
            //{
            //    GDTTT_DON_DUONGSU_TOIDANH_CC obj_TD = new GDTTT_DON_DUONGSU_TOIDANH_CC();
            ...
            //    dt.GDTTT_DON_DUONGSU_TOIDANH_CC.Add(obj_TD);
            //    dt.SaveChanges();
            //}
        }
        ...
        public void LoadDanhSachBiCao()
        {
            ...
            DataTable tbl = objBL.AnHS_GetAllDuongSu_CC(don_id, "", 2);
        ...
        void LoadThongTinBC_AHS(Decimal DuongSuID)
        {
            ...
            GDTTT_DON_DUONGSU_CC obj = dt.GDTTT_DON_DUONGSU_CC.Where(x => x.ID == DuongSuID).Single();
            if (obj != null)
            {
