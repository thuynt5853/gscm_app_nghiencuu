...
{
    public partial class Suadanhsach : System.Web.UI.Page
    {
        ...
        private DataTable getDS()
        {
            ...
            DenNgay = (Session[SS_TK.NGAYNHANDEN] + "") == "" ? (DateTime?)null : DateTime.Parse((Session[SS_TK.NGAYNHANDEN] + " 23:59:59"), cul, DateTimeStyles.NoCurrentDateDefault);
            ...
            vNgayNhapDen = (Session[SS_TK.NGAYNHAPDEN] + "") == "" ? (DateTime?)null : DateTime.Parse((Session[SS_TK.NGAYNHAPDEN] + " 23:59:59"), cul, DateTimeStyles.NoCurrentDateDefault);
        ...
        private void SaveData()
        {
            foreach (DataGridItem item in dgList.Items)
            {
                ...
                //TextBox txtSoThuLy = (TextBox)item.FindControl("txtSoThuLy");
                //TextBox txtNgaythuly = (TextBox)item.FindControl("txtNgaythuly");
                ...
                DropDownList ddlToaBAQD = (DropDownList)item.FindControl("ddlToaXX");
                ...
                //DateTime dNgaythuly = (String.IsNullOrEmpty(txtNgaythuly.Text.Trim())) ? DateTime.MinValue : DateTime.Parse(txtNgaythuly.Text.Trim(), cul, DateTimeStyles.NoCurrentDateDefault);
                ...
                obj.NGAYNHANDON = dNgayNhan != DateTime.MinValue ? dNgayNhan : (DateTime?)null;
                //obj.TL_SO = txtSoThuLy.Text;
                //obj.TL_NGAY = dNgaythuly != DateTime.MinValue ? dNgaythuly : (DateTime?)null;
                ...
                if (obj.BAQD_CAPXETXU == 2)
                {
                    ...
                    obj.BAQD_TOAANID_ST = Convert.ToDecimal(ddlToaBAQD.SelectedValue);
                }
                else if (obj.BAQD_CAPXETXU == 3)
                {
                    ...
                    obj.BAQD_TOAANID_PT = Convert.ToDecimal(ddlToaBAQD.SelectedValue);
                }
                else
                {
                    obj.BAQD_SO = txtSoBAQD.Text;
                    obj.BAQD_NGAYBA = dNgayBAQD != DateTime.MinValue ? dNgayBAQD : (DateTime?)null;
                    obj.BAQD_TOAANID = Convert.ToDecimal(ddlToaBAQD.SelectedValue);
                }
