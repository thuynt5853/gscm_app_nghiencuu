<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="pSuaCongvan.aspx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.Hoso.Popup.pSuaCongvan" %>
                                                 ...
                                                 <div class="phantrang">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:Button ID="cmdXoaCV" runat="server" CssClass="btnBuoc  bg_do" Text="Xóa" OnClick="cmdXoaCV_Click" 
                                                            OnClientClick="return confirm('Bạn thực sự muốn xóa Số Văn bản khỏi đơn này? ');"  />
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
