<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuaToaKhac.aspx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.Hoso.Popup.SuaToaKhac" %>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderStyle-Width="290px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HiddenField ID="hddNoiChuyenID" runat="server" Value='<%# Eval("CD_TK_DONVIID")%>' />
                                                        <asp:DropDownList ID="ddlNoiChuyen" CssClass="chosen-select" runat="server" Width="285px"></asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
