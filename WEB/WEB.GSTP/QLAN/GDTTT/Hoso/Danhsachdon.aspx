<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Danhsachdon.aspx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.Hoso.Danhsachdon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hdd_TONG_SODON_VEW" Value="0" runat="server" />


    <%--Đơn cấp cao--%>
    <asp:HiddenField ID="hddTotalPageCC" Value="1" runat="server" />
    <asp:HiddenField ID="hddPageIndexCC" Value="1" runat="server" />
    <asp:HiddenField ID="hddCountCVCC" Value="0" runat="server" />
    <asp:HiddenField ID="lstDataUSCC" Value="" runat="server" />
    <style type="text/css">
        .DonGDTCol1 {
            width: 100px;
        }
    ...
    <div id="divBackground" style="position: absolute; top: 0px; left: 0px; background-color: black; z-index: 100; opacity: 0.8; filter: alpha(opacity=60); -moz-opacity: 0.8; overflow: hidden; display: none">
        <asp:HiddenField ID="Hi_Errors" runat="server" Value="no_error" />
    </div>
    <div class="box">
        <div class="box_nd">
            <div class="truong">
                <table class="table1">
                    <tr>
                        <td colspan="2">
                                ...
                                <div class="boder" style="padding: 10px;">
                                    <table class="table1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:CheckBox ID="chkDanhSachCC" runat="server" Text="Đơn đã giải quyết xong từ tòa Cấp cao" AutoPostBack="True" /></td>
                                        </tr>
                                        <asp:Panel ID="pnTTTK" runat="server" Visible="false">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlPhanloaiDdon" CssClass="chosen-select" runat="server" Width="230px" AutoPostBack="True" Enabled="false" OnSelectedIndexChanged="ddlTrangthaichuyen_SelectedIndexChanged">
                                                        <%--<asp:ListItem Value="0" Text="--- Tất cả ---" Selected="True"></asp:ListItem>--%>
                                            ...
                                            <tr>
                                                ...
                                                <td id="txtNgayCV" runat="server">Ngày</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlThuLy" CssClass="chosen-select" runat="server" Width="108px" AutoPostBack="True" OnSelectedIndexChanged="ddlThuLy_SelectedIndexChanged">
                                                        ...
                                                        <asp:ListItem Value="6" Text="--TL mới"></asp:ListItem>
                                                        ...
                                                        <%-- <asp:ListItem Value="3" Text="Thụ lý lại"></asp:ListItem>--TLM trùng--%>
                            ...
                            <asp:Panel ID="pn_vanthu" runat="server" Visible="true">
                                <div class="boxchung">
                                        ...
                                        <asp:Panel ID="pn_VT_VBD" runat="server" Visible="false">
                                            <div style="float: left; width: 900px">
                                                ...
                                                <div style="float: left; width: 178px; margin-left: 7px;">
                                                    <asp:DropDownList ID="Drop_NOI_NHAN_SEARCH" CssClass="chosen-select" runat="server" Width="178px"></asp:DropDownList>
                                                </div>
                                                <div style="float: left; width: 100px; text-align: right;">Trạng thái</div>
                                                <div style="float: left; width: 178px; margin-left: 5px;">
                                                    <asp:DropDownList ID="Drop_TRANGTHAICHUYEN" CssClass="chosen-select" runat="server" Width="178px">
                            ...
                            <div style="float: left; width: 100%; margin-top: 15px;">
                                ...
                                <div style="float: right; margin-right: 7px; margin-top: 5px;">
                                    <asp:LinkButton ID="lb_tongsodon" runat="server" CausesValidation="false" CssClass="back tongdon"
                                        OnClick="lb_tongsodon_Click">Tổng đơn</asp:LinkButton>
                                    <style>
                                        .tongdon {
                                            background: unset;
                                        }
                                            ...
                                            <tr>
                                                <td colspan="8">
                                                    <div style="margin-top: 10px; float: left;" id="divPrintNoibo" runat="server" visible="false">
                                                        ...
                                                        <asp:Button ID="btnNBPhieuchuyen_TL_Lai" runat="server" Width="170px" CssClass="buttonprint" Text="TBPC trùng TP" OnClick="btnNBPhieuchuyen_TL_Lai_Click" />
                                                ...
                                                <td align="right" style="vertical-align: top;">
                                                    <asp:Button ID="btnChuyendon" runat="server" CssClass="buttoninput" Text="Chuyển đơn" OnClientClick="return confirm('Bạn chắc chắn muốn chuyển đơn?');" OnClick="btnChuyendon_Click" Width="119px" />
                    ...
                    <tr>
                        <td colspan="2">
                            <div runat="server" id="divToiCao" visible="true">
                                <div class="phantrang">
                                    <div class="sobanghi">
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="30%">
                                            ...
                                            &nbsp;
                                            <i>Ngày nhận</i>: <%# Eval("NGAYNHANDON") %>
                                                    <br />
                                                ...
                                                <%--<div style="float: left;">--%>
                                                    ...
                                                    <asp:LinkButton ID="cmdThuLyLai" runat="server" Font-Bold="true" ForeColor="#0e7eee" CommandArgument='<%#Eval("ID") %>' CommandName="ThuLyLai" Text="Thụ lý lại"></asp:LinkButton>
                                                </div>--%>
                                                    <%--      <div style="display: none;">
                                                    SQL_01:<%#Eval("SQL_01") %><br />
                                                    SQL_02:<%#Eval("SQL_02") %><br />
                                                    SQL_03:<%#Eval("SQL_03") %>
                                                </div>--%>
                                                </asp:Panel>
                                                <%------------------------------------------------%>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Top">
                                            ...
                                            <ItemTemplate>
                                                <asp:Panel ID="pn_TTD" runat="server" Visible="false">
                                                    ...
                                                    <i><%# Convert.ToInt32(Eval("BAQD_CAPXETXU"))==3 ? (String.IsNullOrEmpty(Eval("Infor_ST")+"")? "": Eval("Infor_ST") + "<br/>"):""%></i>
                                                    <%#Eval("THAMPHAN_SONGAY")%>
                                                    <%#Eval("THAMPHANTC_TEN") %>
                                                    <div style='display: <%#Eval("IS_SHOW_TP")%>'>
                                                        <%#(Eval("TRANGTHAICHUYENTP_TC")+"") =="1" ? "<b><i><span style='color:#0e7eee'>Đã chuyển:</span> Thẩm phán tối cao</i></b>" : Eval("TRANGTHAICHUYEN_TP")%>
                                                    </div>
                                                    <i><b style="color: #0e7eee;"><%#Eval("TRANGTHAICHUYEN")%>:</b></i>
                                                    <b><%#Eval("NOICHUYEN")%></b>
                                                    <i>(Số <%#Eval("SVB_SOCV") %> - <%# GetDate(Eval("SVB_NGAYCV")) %>)</i>
                                                    <div style='display: <%#Eval("IS_SHOW_TP")%>'>
                                                        <%#Eval("NGAYCHUYEN")%>
                                                    </div>
                                                    <div style='display: <%#Eval("IS_SHOW_DC")%>'>
                                                        <%#Eval("NGAYCHUYEN")%>
                                                    </div>
                                                ...
                                                <asp:Panel ID="pn_TTGQ" runat="server" Visible="false">
                                                    <div style='width: 100%; display: <%#Eval("IsShowNB") %>'>
                                                        <div style='width: 100%; display: <%#Eval("IsShowDDK") %>'>
                                                            ...
                                                            <div style='width: 100%; display: <%#Eval("IsShowTLMOI_TRUNG_TP") %>'>
                                                                <b>Thụ lý mới trùng TP</b><br />
                                                                <i>Số: </i><%#Eval("TL_SO") %> - <%# GetDate(Eval("TL_NGAY")) %>
                                                            </div>
                                                            ...
                                                            <div style='width: 100%; display: <%#Eval("IsGXNDV") %>'>
                                                                <i>GXNDV Số: </i><%#Eval("GXNSODV") %> - <%# GetDate(Eval("GXNNGAYDV")) %>
                                                            </div>
                                                        </div>
                                                        <div style='width: 100%; display: <%#Eval("IsShowCDDK") %>'>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <div class="tooltip">
                                                    <asp:ImageButton ID="cmdXoa" runat="server" ToolTip="Xóa" CssClass="grid_button"
                                                        CommandName="Xoa" CommandArgument='<%#Eval("ID") +";"+Eval("TONG_SODON") %>'
                                                    ...
                                                    <br />
                                                    <asp:LinkButton ID="cmdLichsu" runat="server" ForeColor="#0e7eee" CommandArgument='<%#Eval("ID")%>' CommandName="don_chuadu_dk" Text="Chi tiết"></asp:LinkButton>
                                                    <br />
                                        ...
                                        <asp:BoundColumn DataField="TRANGTHAICHUYEN" Visible="false"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="TRANGTHAICHUYEN_TP" Visible="false"></asp:BoundColumn>
                                    </Columns>
                            ...
                            <%--Danh sách đơn của toàn Cấp Cao--%>
                            <div runat="server" id="divCapCao" visible="false">
                                <div class="phantrang">

                                    <div class="sotrang">
                                        <asp:Literal ID="lstSobanghiTCC" runat="server"></asp:Literal>
                                        &nbsp;&nbsp;
                                    <asp:LinkButton ID="lbTBackCC" runat="server" CausesValidation="false" CssClass="back" Visible="false"
                                        OnClick="lbTBackCC_Click">
                                    </asp:LinkButton>
                                        <asp:LinkButton ID="lbTFirstCC" runat="server" CausesValidation="false" CssClass="active" Visible="false"
                                            Text="1" OnClick="lbTFirstCC_Click">
                                        </asp:LinkButton>
                                        <asp:Label ID="lbTStep1CC" runat="server" Text="..." Visible="false"></asp:Label>
                                        <asp:LinkButton ID="lbTStep2CC" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                            Text="2" OnClick="lbTStepCC_Click">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="lbTStep3CC" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                            Text="3" OnClick="lbTStepCC_Click">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="lbTStep4CC" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                            Text="4" OnClick="lbTStepCC_Click">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="lbTStep5CC" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                            Text="5" OnClick="lbTStepCC_Click">
                                        </asp:LinkButton>
                                        <asp:Label ID="lbTStep6CC" runat="server" Text="..." Visible="false"></asp:Label>
                                        <asp:LinkButton ID="lbTLastCC" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                            Text="100" OnClick="lbTLastCC_Click">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="lbTNextCC" runat="server" CausesValidation="false" CssClass="next" Visible="false"
                                            OnClick="lbTNext_Click">
                                        </asp:LinkButton>
                                        <asp:DropDownList ID="ddlPageCountCC" Visible="false" runat="server" Width="55px" CssClass="so" AutoPostBack="True" OnSelectedIndexChanged="ddlPageCountCC_SelectedIndexChanged">
                                            <asp:ListItem Value="10" Text="10"></asp:ListItem>
                                            <asp:ListItem Value="20" Text="20"></asp:ListItem>
                                            <asp:ListItem Value="30" Text="30" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="50" Text="50"></asp:ListItem>
                                ...
                                <asp:DataGrid ID="dgListCC" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    PageSize="10" AllowPaging="true" GridLines="None" PagerStyle-Mode="NumericPages"
                                    CssClass="table2" HeaderStyle-CssClass="header" AlternatingItemStyle-CssClass="le"
                                    ItemStyle-CssClass="chan"
                                    OnItemCommand="dgListCC_ItemCommand" OnItemDataBound="dgListCC_ItemDataBound">
                                    <Columns>
                                        <asp:BoundColumn DataField="ID" Visible="false"></asp:BoundColumn>

                                        <asp:TemplateColumn HeaderStyle-Width="20px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"></asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderStyle-Width="20px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>TT</HeaderTemplate>
                                            <ItemTemplate><%#Eval("STT")%></ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="30%">
                                            <HeaderTemplate>Thông tin người gửi/đơn vị gửi</HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:Panel ID="pn_TTNGDVGCC" runat="server" Visible="false">
                                                    <%#Eval("DONVITIEPNHAN") %>
                                                    <%#Eval("DONGKHIEUNAI_CC") %><b style="color: #db212d"><%#Eval("THOIHIEU") %></b>
                                                ...
                                                <%------------------------------------------------%>
                                                <asp:Panel ID="pn_TTNGDVG_VTCC" runat="server" Visible="false">
                                                    <%#Eval("DONVITIEPNHAN") %>
                                                    <%#Eval("NGUOI_GUI_BT") %></b><br />
                                                    <i>Địa chỉ</i>:<b> <%#Eval("DIACHI_GUI_BT") %></b><br />
                                                    <i>Số điện thoại</i>:<b> <%#Eval("NGUOIGUI_DIENTHOAI") %></b><br />
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Top">
                                            <HeaderTemplate>Thông tin đơn</HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:Panel ID="pn_TTD_HCTPCC" runat="server" Visible="true">
                                                ...
                                                <asp:Panel ID="pn_TTDCC" runat="server" Visible="false">
                                                    ...
                                                    <i>Ghi chú: </i><%#Eval("GHICHU") %>
                                                    <br />
                                                    <i>Đơn thuộc: </i><%#Eval("MA_TEN_TOA_CAP_CAO") %>
                                                    ...
                                                    <asp:Panel ID="pnDSYCBSCC" runat="server" Visible="false">
                                                        <div style='display: <%# Eval("IsShowDDK") %>'>
                                                            <i><%#Eval("YCBS") %></i>
                                                            <asp:ImageButton ID="cmdDsYCBS" runat="server" ToolTip="DS yêu cầu bổ sung" CssClass="grid_button"
                                                                CommandName="DSYCBS" CommandArgument='<%#Eval("ID") %>'
                                                ...
                                                <asp:Panel ID="pn_TTD_VTCC" runat="server" Visible="false">
                                                    <div style='width: 100%;'>
                                                        <%#Eval("THONGTIN_VBD") %>
                                                    </div>
                                                </asp:Panel>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-Width="110px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>Thông tin giải quyết</HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:Panel ID="pn_TTGQCC" runat="server" Visible="false">
                                                    <div style='width: 100%; display: <%#Eval("IsShowNB") %>'>
                                                        <div style='width: 100%; display: <%#Eval("IsShowDDK") %>'>
                                                            <div style='width: 100%; display: <%#Eval("IsShowTLMOI") %>'>
                                                                <b><%#Eval("lb_thuly") %></b><br />
                                                ...
                                                <asp:Panel ID="pn_TTGQ_VTCC" runat="server" Visible="false">
                                                    <div style='width: 100%;'>
                                                        <b>Chưa xử lý</b>
                                                    </div>
                                                </asp:Panel>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>Thao tác</HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:Panel ID="pn_THAOTACCC" runat="server" Visible="false">
                                                    <br />
                                                    <asp:LinkButton ID="cmdXuLy" runat="server" ForeColor="#0e7eee" CommandArgument='<%#Eval("ID")%>' CommandName="ChiTiet" Text="Chi tiết"></asp:LinkButton>
                                ...
                                <div class="phantrang">
                                    ...
                                    <div class="sotrang">
                                        <asp:Literal ID="lstSobanghiBCC" runat="server"></asp:Literal>
                                        &nbsp;&nbsp;
                                    <asp:LinkButton ID="lbBBackCC" runat="server" CausesValidation="false" CssClass="back" Visible="false"
                                        OnClick="lbTBackCC_Click">
                                    </asp:LinkButton>
                                        <asp:LinkButton ID="lbBFirstCC" runat="server" CausesValidation="false" CssClass="active" Visible="false"
                                            Text="1" OnClick="lbTFirstCC_Click">
                                        </asp:LinkButton>
                                        <asp:Label ID="lbBStep1CC" runat="server" Text="..." Visible="false"></asp:Label>
                                        <asp:LinkButton ID="lbBStep2CC" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                            Text="2" OnClick="lbTStepCC_Click">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="lbBStep3CC" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                            Text="3" OnClick="lbTStepCC_Click">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="lbBStep4CC" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                            Text="4" OnClick="lbTStepCC_Click">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="lbBStep5CC" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                            Text="5" OnClick="lbTStepCC_Click">
                                        </asp:LinkButton>
                                        <asp:Label ID="lbBStep6CC" runat="server" Text="..." Visible="false"></asp:Label>
                                        <asp:LinkButton ID="lbBLastCC" runat="server" CausesValidation="false" CssClass="so" Visible="false"
                                            Text="100" OnClick="lbTLastCC_Click">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="lbBNextCC" runat="server" CausesValidation="false" CssClass="next" Visible="false"
                                            OnClick="lbTNext_Click">
                                        </asp:LinkButton>
                                        <asp:DropDownList ID="ddlPageCount2CC" Visible="false" runat="server" Width="55px" CssClass="so" AutoPostBack="True" OnSelectedIndexChanged="ddlPageCount2CC_SelectedIndexChanged">
                                            <asp:ListItem Value="10" Text="10"></asp:ListItem>
                                            <asp:ListItem Value="20" Text="20"></asp:ListItem>
                                            <asp:ListItem Value="30" Text="30" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="50" Text="50"></asp:ListItem>
    ...
    <script type="text/javascript">
        ...
        function ddlMultiSelect_fu_setvalue() {
           ...
           <%-- var str_error = document.getElementById('<%= Hi_Errors.ClientID %>').value;
            Console.log("Hi_Errors: " + str_error);--%>
        }
