<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" 
    CodeBehind="DanhsachVAKN.aspx.cs" Inherits="WEB.GSTP.QLAN.GDTTT.Hoso.DanhsachVAKN" %>
            ...
            <div class="truong">
                <table class="table1">
                                    ...
                                    <table class="table1">
                                        ...
                                        <asp:Panel ID="pnTTTK" runat="server" Visible="false">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlLOAICVPC" runat="server" Width="80px" AutoPostBack="true" OnSelectedIndexChanged="ddlLOAICVPC_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>Trạng thái chuyển/nhận</td>
                                                <td>
                                                    <asp:DropDownList ID="dropTrangThaiNhan" CssClass="chosen-select" runat="server" Width="230px"
                                                        AutoPostBack="true" OnSelectedIndexChanged="dropTrangThaiNhan_SelectedIndexChanged">
                                                        <asp:ListItem Value="0" Text="Tất cả"></asp:ListItem>
                                                        <asp:ListItem Value="1" Text="Chưa nhận"></asp:ListItem>
                                                        <asp:ListItem Value="2" Text="Đã nhận"></asp:ListItem>
                                                        <asp:ListItem Value="3" Text="Chưa chuyển TP"></asp:ListItem>
                                                        <asp:ListItem Value="4" Text="Đã chuyển TP"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                                <td id="labelTrangThaiPC" runat="server" >Trạng thái phân công</td>
                                                <td>
                                                    <asp:DropDownList ID="dropTrangThaiPC" CssClass="chosen-select" runat="server" Width="160px"
                                                         AutoPostBack="true" OnSelectedIndexChanged="dropTrangThaiPC_SelectedIndexChanged" >
                                                        <asp:ListItem Value="0" Text="Tất cả"></asp:ListItem>
                                                        <asp:ListItem Value="1" Text="Chưa phân công TPTC"></asp:ListItem>
                                                        <asp:ListItem Value="2" Text="Đã phân công TPTC"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                        </asp:Panel>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="boxchung">
                                <h4 class="tleboxchung">Nhận vụ án, Thêm văn bản, Chuyển thẩm phán
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <div style="float: right">
                                                        <asp:Button ID="btnLuuVBchuyen" runat="server" CssClass="buttoninput" Text="Lưu Số Văn bản" OnClick="btnLuuVB_Click" Width="130px" />
                                                        <asp:Button ID="btnQuanlyVB" runat="server" CssClass="buttoninput" Text="Quản lý Sổ VB" OnClick="btnQuanlyVB_Click" Width="130px" />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="8">
                                                    <asp:Button ID="btnNBInTotrinh" runat="server" Width="170px" CssClass="buttonprint" Text="Tờ trình phân công" OnClick="btnNBInTotrinh_Click" Visible="false" />
                                                    <asp:Button ID="btnNBPhieuchuyen" runat="server" Width="170px" CssClass="buttonprint" Text="Thông báo phân công TP" OnClick="btnNBPhieuchuyen_Click" Visible="false" />
                                                    <asp:Button ID="btnNBInDSVAKN" runat="server" Width="200px" CssClass="buttonprint" Text="In danh sách vụ án kháng nghị" OnClick="cmdPrint_Click" Visible="false" />
                                                </td>
                                                <td align="right" style="vertical-align: top;">
                                                    <asp:Button ID="btnNhanVuAn" runat="server" CssClass="buttoninput" Text="Nhận vụ án" OnClick="btnNhan_Click" Width="130px"
                                                        OnClientClick="return confirm('Bạn chắc chắn muốn nhận vụ án?');" />

                                                    <asp:Button ID="btnChuyenTP" runat="server" CssClass="buttoninput" Text="Chuyển thẩm phán" OnClientClick="return confirm('Bạn chắc chắn muốn chuyển thẩm phán?');" OnClick="btnChuyenTP_Click" Width="130px" />
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Justify" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%# String.IsNullOrEmpty(Eval("thamphan_ten")+"")? "":("TPTC:<b style='margin-left:3px;'>"+Eval("thamphan_ten")+"</b><br/>")%>  
                                    ...
                                    <asp:TemplateColumn HeaderStyle-Width="250px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderTemplate>Thông tin chuyển thẩm phán</HeaderTemplate>
                                        <ItemTemplate>
                                            <span style="color:#0e7eee"> <%#Eval("trang_thai_chuyen_tp")%>: </span> Thẩm phán <b><%#Eval("thamphan_ten")%></b>
                                            <br />
                                            (<%#Eval("SOVB")%>/TTr-TANDTC-VP - <%#Eval("NGAYVB")%><b>;</b> <%#Eval("SO_TB")%>/TB-TANDTC-VP</b> - <%#Eval("NGAY_TB")%>)
                                            <br />
                                            Ngày chuyển: <%#Eval("NGAYCHUYENTP")%>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn HeaderStyle-Width="200px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <br />
                                            Số CV chuyển: <%#Eval("SoCV")%>
                                            <br />
                                            Ngày CV chuyển: <%#Eval("NgayCV")%>
                                            <br />
                                            <br />
                                    ...
                                    <asp:TemplateColumn HeaderStyle-Width="90px" HeaderStyle-HorizontalAlign="Center" Visible="false">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Justify" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%# String.IsNullOrEmpty(Eval("TENLANHDAO")+"")? "":( Eval("MaChucVuLD") + ":<b style='margin-left:3px;'>"+Eval("TENLANHDAO")+"</b><br />")%>
                                            <%# String.IsNullOrEmpty(Eval("TENTHAMPHAN")+"")? "":("TP:<b style='margin-left:3px;'>"+Eval("TENTHAMPHAN")+"</b><br/>")%>
                                            <%# String.IsNullOrEmpty(Eval("thamphan_ten")+"")? "":("TPTC:<b style='margin-left:3px;'>"+Eval("thamphan_ten")+"</b>")%>  
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <%--<asp:TemplateColumn ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
