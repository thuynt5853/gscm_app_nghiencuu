...
{
    public partial class rptTradonTinh : DevExpress.XtraReports.UI.XtraReport
    {
        public string strTenTinh { get; set; } // GTEL-DUCH 20-09-2025 thêm prop để xử lý Xuống dòng tên Tòa án Header
        public rptTradonTinh()
        {
            InitializeComponent();
        }
        ...
        private void xrLabel4_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            {
                strNoinhan += "\n- Chánh án " + strTAND_NHAN + " (để báo cáo);"; //Cap nhat 13/09 cho tinh
