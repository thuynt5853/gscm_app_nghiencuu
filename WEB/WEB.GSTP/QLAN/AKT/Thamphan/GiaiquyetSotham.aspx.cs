...
namespace WEB.GSTP.QLAN.AKT.Thamphan
{
    public partial class GiaiquyetSotham : System.Web.UI.Page
    {
        ...
        private void CheckQuyen(decimal DONID)
        {
            ...
            List<AKT_SOTHAM_THULY> lstCount = dt.AKT_SOTHAM_THULY.Where(x => x.DONID == DONID).ToList();
            if (lstCount.Count == 0)
            {
            ...
            AKT_SOTHAM_BANAN oBA = dt.AKT_SOTHAM_BANAN.Where(x => x.DONID == DONID).FirstOrDefault();
            if (oBA != null)
            {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                AKT_DON_THAMPHAN obj = dt.AKT_DON_THAMPHAN.Where(x => x.ID == ID).FirstOrDefault();
                if (obj != null)
                {
                    ...
                    if (chuyenan != null)
                    {
                        ...
                        {
                            List<AKT_SOTHAM_HDXX> NTHTT = dt.AKT_SOTHAM_HDXX.Where(x => x.DONID == DONID).ToList();
                        ...
                        {
                            List<AKT_SOTHAM_HDXX> NTHTT = dt.AKT_SOTHAM_HDXX.Where(x => x.DONID == DONID && x.NGAYTAO > chuyenan.NGAYTAO).ToList();
                    ...
                    else
                    {
                        ...
                        List<AKT_SOTHAM_HDXX> NTHTT = dt.AKT_SOTHAM_HDXX.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).ToList();
                        List<AKT_SOTHAM_QUYETDINH> qd = dt.AKT_SOTHAM_QUYETDINH.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).ToList();
                        if ((NTHTT != null && NTHTT.Count > 0) || (qd != null && qd.Count > 0))
                        {
                            lblSua.Visible = false;
                            lbtXoa.Visible = false;
                ...
                //AKT_SOTHAM_HDXX hdxx = dt.AKT_SOTHAM_HDXX.Where(x => x.DONID == DONID).FirstOrDefault();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AKT_SOTHAM_HDXX oTHTT = dt.AKT_SOTHAM_HDXX.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).FirstOrDefault<AKT_SOTHAM_HDXX>();
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AKT_DON_THAMPHAN_GETBY(ID, ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETSOTHAM);
        ...
        public void xoa(decimal id)
        {
            ...
            if (oBL.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oND.DONID), 4, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Thẩm phán Sơ thẩm án Kinh tế", "Xóa", json) == false)
            {
        ...
        private bool CheckQDofThamPhan(decimal DonID, decimal TPID)
        {
            ...
            AKT_SOTHAM_QUYETDINH obj_QD = dt.AKT_SOTHAM_QUYETDINH.Where(x => x.DONID == DonID && x.NGUOIKYID == TPID).FirstOrDefault<AKT_SOTHAM_QUYETDINH>();
            if (obj_QD != null)
            {
