...
namespace WEB.GSTP.QLAN.AKT.XuLyDon.Popup
{
    public partial class pTraLaiDon : System.Web.UI.Page
    {
        ...
        protected void cmdCapNhat_Click(object sender, EventArgs e)
        {
            ...
            DataTable checkGQ = oBLYC.CHECK_NGAYGQ_DON_YCBS(obj.ID, xuLyID, int.Parse(ENUM_LOAIVUVIEC_NUMBER.AN_KINHDOANH_THUONGMAI), txtNgayGQ.Text);
            ...
            obj.LOAIAN = int.Parse(ENUM_LOAIVUVIEC_NUMBER.AN_KINHDOANH_THUONGMAI);
            ...
            DataTable oDT = oBLYC.ADS_GETALL_DON_YCBS(DONID, objXuLy.ID, 1, 1);
        ...
        protected void dgDS_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                // DataTable obj = oBL.AKT_GETALL_DON_YCBS(Convert.ToDecimal(DONID), ID_DON_YCBS, 1, 20);
