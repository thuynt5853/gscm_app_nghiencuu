<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Tongdat.aspx.cs" Inherits="WEB.GSTP.QLAN.AKT.Tongdat" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="110px">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:DropDownList Visible="false" Width="100%" Height="30px" CssClass="cus_input" runat="server" ID="ddlTCTT"  Enabled ="false" OnSelectedIndexChanged="ddlTCTT_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="110px">
                                            <HeaderTemplate>
                                        ...
                                        <asp:TemplateColumn  HeaderStyle-HorizontalAlign="Center" Visible="false" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="40px">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <div style="display:flex;margin-top:5px">
                                                    ...
                                                    <span><asp:TextBox ID="txtCoquan"  TextMode="multiline"  runat="server" Text='' CssClass="user" Width="140px"></asp:TextBox></span>
                                                </div>
                                                <div style="display:flex">
                                                    <span style="width:60px"><asp:Label id="lblNoidung" Text="Nội dung" runat="server" /></span>
                                                    <span><asp:TextBox id="txtNoidung" TextMode="multiline" CssClass="user" Width="140px" Columns="50" Rows="1" runat="server" /></span>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        ...
                                        <asp:TemplateColumn Visible="true" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="120px">
                                            <HeaderTemplate>
