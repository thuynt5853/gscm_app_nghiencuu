<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Tailieu.aspx.cs" Inherits="WEB.GSTP.QLAN.AKT.Hoso.Tailieu" %>
                    ...
                    <asp:Panel runat="server" ID="pndata">
                        ...
                        <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="NGUOIBANGIAO" HeaderText="Họ tên người giao" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
