<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pDuongsu.aspx.cs" Inherits="WEB.GSTP.QLAN.AKT.Hoso.Popup.pDuongsu" %>
                            ...
                            <div class="boder" style="padding: 10px;">
                                <table class="table1">
                                    ...
                                    <asp:Panel ID="pnNDCanhan" runat="server">
                                        ...
                                        <%-- <tr>
                                    <td>Thường trú<asp:Label ID="lblBatbuoc1" runat="server" ForeColor="Red" Text="(*)"></asp:Label>
                                    </td>
                                    <td >
