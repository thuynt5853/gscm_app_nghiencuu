...
namespace WEB.GSTP.QLAN.AKT.Hoso.Popup
{
    public partial class pTKQuaHan : System.Web.UI.Page
    {
        ...
        {
            var lstData = DataExtensions.GetAll<TK_QUAHAN>().Where(x => x.TRANGTHAI != 99 && x.LOAIAN == 4 && x.TOAANID == Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID] + ""));
        ...
        {
            string link = "/QLAN/AKT/Hoso/Popup/pThemTKQuaHan.aspx";
        ...
        {
            string link = "/QLAN/AKT/Hoso/Popup/pThemTKQuaHan.aspx?TKID=" + id;
