...
namespace WEB.GSTP.QLAN.AKT.Hoso.Popup
{
    public partial class pDuongSuDonCha : System.Web.UI.UserControl
    {
        ...
        public void LoadGrid()
        {
            ...
            // GTEL-HUNGNQ 09-10-2025 them xac thực c06 và comment hàm cũ
            KHOBAQD_BL oBL = new KHOBAQD_BL();
            //AKT_DON_DUONGSU_BL oBL = new AKT_DON_DUONGSU_BL();
            //END

            DataTable oDT = oBL.AKT_DON_DUONGSU_NOTDAIDIEN_DONCHA(DonID);
        ...
        protected void lkThemNguoiTGTT_Click(object sender, EventArgs e)
        {
            ...
            string StrMsg = "PopupCenter('/QLAN/AKT/Hoso/Popup/pDuongsuDonCha.aspx?hsID=" + DonID.ToString() + "&bID=0','Thêm đương sự',950,450);";
