<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="DuongSu.aspx.cs" Inherits="WEB.GSTP.QLAN.AKT.Hoso.DuongSu" %>
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            ...
                            <td style="width: 75px;">Tư cách tố tụng<span class="batbuoc">(*)</span></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td colspan="2">
                                <asp:CheckBox ID="chkISDNNN" Visible="false" runat="server" Text="Doanh nghiệp nhà nước" />
                            </td>
                        </tr>
