    ...
    public partial class KhangCaoKhangNghi : System.Web.UI.Page
    {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Decimal READONLY = Convert.ToDecimal(dv["READONLY"]);
                if (READONLY == 1)
                {
                ...
                if (IsKhangCao == 1)
                {
                    AKT_SOTHAM_KHANGCAO oKC = dt.AKT_SOTHAM_KHANGCAO.Where(x => x.ID == idKCKN).FirstOrDefault();
                    if (oKC != null)
                    {
                        ...
                        string Result = new AKT_CHUYEN_NHAN_AN_BL().Check_ChuyenNhanAn(DONID, StrMsg, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]));
                        if (Result == "")
                        {
                ...
                {
                    AKT_SOTHAM_KHANGNGHI oKN = dt.AKT_SOTHAM_KHANGNGHI.Where(x => x.ID == idKCKN).FirstOrDefault();
                    if (oKN != null)
                    {
                ...
                //AKT_SOTHAM_KHANGCAO oKC = dt.AKT_SOTHAM_KHANGCAO.Where(x => x.DONID == DONID && x.ID == idKC).FirstOrDefault();
                //if (oKC != null)
                //{
                ...
                //    AKT_CHUYEN_NHAN_AN cn = dt.AKT_CHUYEN_NHAN_AN.Where(x => x.VUANID == DONID).FirstOrDefault();
                //    if (cn != null)
                //    {
        ...
        private void LoadComboboxKhangCao()
        {
            ...
            ddlNguoikhangcao.DataSource = oDSBL.AKT_DUONGSU_KHANGCAO(DonID);
        ...
        void LoadDrop_ST_BanAn(DropDownList drop, Decimal DonID)
        {
            ...
            DataTable oDT = oBL.DANHSACH_KHANGCAO_BANAN(ENUM_LOAIVUVIEC_NUMBER.AN_KINHDOANH_THUONGMAI, DonID);
            if (oDT != null)
            {
                drop.DataSource = oDT;
        ...
        void LoadDrop_ST_QuyetDinh(DropDownList drop, Decimal DonID, Decimal loaiKC)
        {
            ...
            {
                PAGE_KHANGCAO_ST oBL = new PAGE_KHANGCAO_ST();
                DataTable oDT = oBL.DANHSACH_KHANGCAO_QUYETDINH(ENUM_LOAIVUVIEC_NUMBER.AN_KINHDOANH_THUONGMAI, DonID);
                if (oDT != null)
                {
                    drop.DataSource = oDT;
                    drop.DataTextField = "TEN";
            ...
            {
                PAGE_KHANGCAO_ST oBL = new PAGE_KHANGCAO_ST();
                DataTable oDT = oBL.DANHSACH_KHANGCAO_QUYETDINH_KHAC(ENUM_LOAIVUVIEC_NUMBER.AN_KINHDOANH_THUONGMAI, DonID);
                if (oDT != null)
                {
                    drop.DataSource = oDT;
                    drop.DataTextField = "TEN";
            ...
            try
            {
                ...
                switch (e.CommandName)
                {
                    case "Download":
                        ...
                        if (IsKhangCao == 1)
                        {
                            AKT_SOTHAM_KHANGCAO oKN = dt.AKT_SOTHAM_KHANGCAO.Where(x => x.ID == ID).FirstOrDefault();
                            TENFILE = oKN.TENFILE;
                    ...
                    case "Xoa":
                        ...
                        AKT_SOTHAM_KHANGCAO oKC = dt.AKT_SOTHAM_KHANGCAO.Where(x => x.DONID == DonID && x.ID == ID).FirstOrDefault();
                        if (Result != "")
                        {
                            if (oKC.ISQUAHAN == 1)
                            {
            ...
            try
            {
                ...
                if (IsKhangCao == KHANGCAO)// Kháng cáo
                {
                    ...
                    if (oND != null)
                    {
                        ...
                        AKT_ANPHI oAP = dt.AKT_ANPHI.Where(x => x.DONID == oND.DONID && x.DUONGSU_ID == oND.DUONGSUID && x.MAGIAIDOAN == 3).FirstOrDefault();
                        if (oAP != null)
                        {
        ...
        public void xoa(decimal ID, decimal IsKhangCao)
        {
            if (IsKhangCao == KHANGCAO)// Kháng cáo
            {
                ...
                AKT_ANPHI objAP = dt.AKT_ANPHI.Where(x => x.DONID == DonID && x.DUONGSU_ID == oND.DUONGSUID && x.MAGIAIDOAN == 3).FirstOrDefault();
                if (objAP != null)
                {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                decimal ID = 0, IsKhangCao = 0, DonID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_KINHDOANH_THUONGMAI] + "");
                AKT_DON oDon = dt.AKT_DON.Where(x => x.ID == DonID).FirstOrDefault();
                if (rdbPanelKC.SelectedValue == KHANGCAO.ToString() && rdbPanelKN.SelectedValue == KHANGCAO.ToString())// Kháng cáo
                {
                    ...
                    {
                        AKT_ANPHI lstAPnew = new AKT_ANPHI();
        ...
        protected void rdbPanelKC_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else // Kháng nghị
            {
                ...
                DON_KHAC oD = dt.DON_KHAC.Where(x => x.DONID == DonID && x.LOAIANID == 4 && x.LOAIKCKN == 2).FirstOrDefault();
        ...
        protected void cmdLoadDonKhac_Click(object sender, EventArgs e)
        {
            ...
            DON_KHAC oD = dt.DON_KHAC.Where(x => x.ID == ID && x.LOAIANID == 4 && x.LOAIKCKN == 1).FirstOrDefault();
            if (oD != null)
            {
                pnKhangCao.Visible = true;
                pnKhangNghi.Visible = false;
        ...
        void CheckNgayKCQuaHan()
        {
            ...
            if (banan_qd_id > 0)
            {
                if (loai_ba_qd == 0)
                {
                    ...
                    AKT_SOTHAM_BANAN obj = dt.AKT_SOTHAM_BANAN.Where(x => x.ID == banan_qd_id).FirstOrDefault();
                    if (obj != null)
                ...
                else
                {
                    ...
                    AKT_SOTHAM_QUYETDINH obj = dt.AKT_SOTHAM_QUYETDINH.Where(x => x.ID == banan_qd_id).FirstOrDefault();
                    if (obj != null)
                    {
