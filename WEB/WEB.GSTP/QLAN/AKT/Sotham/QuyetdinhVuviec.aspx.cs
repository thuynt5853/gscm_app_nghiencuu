    ...
    public partial class QuyetdinhVuviec : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    GetTrangThaiBanDauDONKK_USER_DKNHANVB(Convert.ToDecimal(current_id));
                    LoadCombobox();
                    LoadNguoiKyInfo();
        ...
        private void CheckQuyen(decimal ID)
        {
            ...
            else
            {
                ...
                List<AKT_DON_THAMPHAN> lstTP = dt.AKT_DON_THAMPHAN.Where(x => x.DONID == ID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETSOTHAM).ToList();
                if (lstTP.Count == 0)
                {
                ...
                AKT_SOTHAM_BANAN banAn = dt.AKT_SOTHAM_BANAN.Where(x => x.DONID == ID).FirstOrDefault();
                if (banAn != null)
                {
                ...
                AKT_SOTHAM_QUYETDINH qdKetThuc = dt.AKT_SOTHAM_QUYETDINH.Where(x => x.DONID == ID && dmQDIds.Contains(x.QUYETDINHID.Value)).FirstOrDefault();
                if (qdKetThuc != null)
                {
                ...
                {
                    AKT_SOTHAM_KHANGCAO kc2 = dt.AKT_SOTHAM_KHANGCAO.Where(x => x.DONID == ID && x.TINHTRANG_GIAIQUYET != 2).FirstOrDefault();
                    if (kc2 != null)
                    {
                        lbthongbao.Text = "Vụ việc đã có kháng cáo. Không được sửa đổi.";
                        Cls_Comon.SetButton(cmdUpdate, false);
                ...
                {
                    AKT_SOTHAM_KHANGNGHI kn2 = dt.AKT_SOTHAM_KHANGNGHI.Where(x => x.DONID == ID && x.TINHTRANG_GIAIQUYET != 3).FirstOrDefault();
                    if (kn2 != null)
                    {
                        lbthongbao.Text = "Vụ việc đã có kháng nghị. Không được sửa đổi.";
                        Cls_Comon.SetButton(cmdUpdate, false);
                ...
                //    int countItem = dt.AKT_DON_THAMPHAN.Count(s => s.THUKYID == CurrentUserId && s.DONID == ID && s.MAVAITRO == "VTTP_GIAIQUYETSOTHAM");
                //    if (countItem > 0)
                //    {
                //        //được gán 
                //    }
        ...
        void SetNewSoQD()
        {
            ...
            if (!String.IsNullOrEmpty(txtNgayQD.Text))
                ...
                ngayBD = DateTime.Now;
            txtSoQD.Text = oSTBL.GET_SQD_NEW(DonViID, "AKT", ngayBD, LoaiQD).ToString();
        }
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (don.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM || don.MAGIAIDOAN == ENUM_GIAIDOANVUAN.THULYGDT)
                {
                    ...
                    AKT_DON_GIAIDOAN checkGD = dt.AKT_DON_GIAIDOAN.Where(x => x.DONID == DONID && x.MAGIAIDOAN == 3).FirstOrDefault();
                    //
                    if (checkGD != null)
                    {
                ...
                AKT_SOTHAM_KHANGCAO kc = dt.AKT_SOTHAM_KHANGCAO.Where(x => (x.LOAIKHANGCAO == 2 || x.LOAIKHANGCAO == 1) && x.SOQDBA == QDID).FirstOrDefault();

                AKT_SOTHAM_KHANGNGHI kn = dt.AKT_SOTHAM_KHANGNGHI.Where(x => (x.LOAIKN == 2 || x.LOAIKN == 1) && x.BANANID == QDID).FirstOrDefault();
                if (kc != null || kn != null)
                {
                    lblSua.Text = "Chi tiết";
                    lbtXoa.Visible = false;
        ...
        private void LoadDuongSuYC()
        {
            ...
            DataTable tb = oBL.AKT_THULY_NGUYENDON(DonID);
        ...
        private void LoadQD()
        {
            ...
            DataTable oDT = oBL.AKT_DM_QUYETDINH_VUAN();
        ...
        private void LoadNguoiKyInfo()
        {
            ...
            AKT_SOTHAM_HDXX oND = dt.AKT_SOTHAM_HDXX.Where(x => x.DONID == DonID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).OrderByDescending(x => x.ID).FirstOrDefault<AKT_SOTHAM_HDXX>();
            if (oND != null)
            {
            ...
            {
                AKT_DON_THAMPHAN oTP = dt.AKT_DON_THAMPHAN.Where(x => x.DONID == DonID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETSOTHAM).FirstOrDefault();
                if (oTP != null)
                {
        ...
        private bool CheckValid()
        {
            ...
            //---------29/11/2025---- Lê Bá Thọ vnpt - quyết định triệu tập đương sự
        ...
        private void GetTrangThaiBanDauDONKK_USER_DKNHANVB(decimal DONID)
        {
            ...
            DONKK_USER_DKNHANVB obj = dkkt.DONKK_USER_DKNHANVB.FirstOrDefault(s => s.MAVUVIEC == oDon.MAVUVIEC && s.VUVIECID == oDon.ID && s.MALOAIVUVIEC == ENUM_LOAIAN.AN_KINHDOANH_THUONGMAI && s.TRANGTHAI == 1);
            if (obj != null)
            {
        ...
        {
            AKT_DON oDon = dt.AKT_DON.FirstOrDefault(s => s.ID == DONID);
            DONKK_USER_DKNHANVB obj = dkkt.DONKK_USER_DKNHANVB.FirstOrDefault(s => s.MAVUVIEC == oDon.MAVUVIEC && s.VUVIECID == oDon.ID && s.MALOAIVUVIEC == ENUM_LOAIAN.AN_KINHDOANH_THUONGMAI && s.TRANGTHAI ==3);
            if (obj != null)
            {
        ...
        public void LoadGrid()
        {
            ...
            string current_id = Session[ENUM_LOAIAN.AN_KINHDOANH_THUONGMAI] + "";
            decimal ID = Convert.ToDecimal(current_id);
            DataTable oDT = oBL.AKT_SOTHAM_QUYETDINH_KHONGKETTHUC_GETLIST(ID);
        ...
        public void xoa(decimal id)
        {
            ...
            if (oBL.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oND.DONID), 4, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Quyết định Sơ thẩm án Kinh tế", "Xóa", json) == false)
            {
        ...
        public void loadedit(decimal ID)
        {
            ...
            {
                AKT_FILE objFile = dt.AKT_FILE.Where(x => x.ID == oND.FILEID).FirstOrDefault();
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                case "Download":
                    var oND = dt.AKT_FILE.Where(x => x.ID == ND_id).FirstOrDefault();
                    if (oND.TENFILE != "")
                    {
        ...
        {
            decimal ID = Convert.ToDecimal(hddid.Value);
            AKT_SOTHAM_QUYETDINH oQD = dt.AKT_SOTHAM_QUYETDINH.Where(x => x.ID == ID).FirstOrDefault();
        ...
        protected void ddlQuyetdinh_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (oT != null)
            {
                ...
                //Load số quyêt định với các loại QD KDTM sau
        ...
        void LoadDropDuongSu()
        {
            ...
            string current_id = Session[ENUM_LOAIAN.AN_KINHDOANH_THUONGMAI] + "";
            decimal ID = Convert.ToDecimal(current_id);
            DataTable obj = oBL.AKT_SOTHAM_DUONGSU_GETBY(ID, 0);
            lbxDuongSu.Items.Clear();
            if (obj != null)
            {
        ...
        protected void LoadDuongSuBiYC()
        {
            ...
            decimal DonID = Session[ENUM_LOAIAN.AN_KINHDOANH_THUONGMAI] + "" == "" ? 0 : Convert.ToDecimal(Session[ENUM_LOAIAN.AN_KINHDOANH_THUONGMAI]);
            //Lấy tất cả bị đơn
            List<AKT_DON_DUONGSU> lstDS = dt.AKT_DON_DUONGSU.Where(x => x.DONID == DonID && x.TUCACHTOTUNG_MA == "BIDON").OrderBy(x => x.TENDUONGSU).ToList<AKT_DON_DUONGSU>();
            ddlNguoiBiYC.DataSource = lstDS;
            ddlNguoiBiYC.DataTextField = "TENDUONGSU";
            ddlNguoiBiYC.DataValueField = "ID";
            ddlNguoiBiYC.DataBind();
