<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="QuyetdinhVuviec.aspx.cs" Inherits="WEB.GSTP.QLAN.AKT.Sotham.QuyetdinhVuviec" %>
                    ...
                    <table class="table1">
                        ...
                        <asp:Panel ID="Panel1" runat="server">
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:TextBox ID="TextBox1" CssClass="user" placeholder="" runat="server" Width="640px" MaxLength="500" TextMode="MultiLine"></asp:TextBox>
                                </td>
                            </tr>
                        </asp:Panel>
