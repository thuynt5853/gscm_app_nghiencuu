...
namespace WEB.GSTP.QLAN.AKT.Sotham
{
    public partial class RutKhangCaoKhangNghi : System.Web.UI.Page
    {
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AKT_ST_KCKN_TINHTRANG_GETLIST(ID);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataGridItem item in dgList.Items)
                {
                    ...
                    {
                        AKT_SOTHAM_KHANGCAO kc = dt.AKT_SOTHAM_KHANGCAO.Where(x => x.ID == KCKNID).FirstOrDefault();
                        if (kc != null)
                        {
                    ...
                    {
                        AKT_SOTHAM_KHANGNGHI kn = dt.AKT_SOTHAM_KHANGNGHI.Where(x => x.ID == KCKNID).FirstOrDefault();
                        if (kn != null)
                        {
                    ...
                    {
                        AKT_SOTHAM_RUTKCKN oND = dt.AKT_SOTHAM_RUTKCKN.Where(x => x.DONID == DonID
                                                                               && x.ISKCKN == isKhangCao
                                                                               && x.IDKCKN == KCKNID).FirstOrDefault();
                        AKT_SOTHAM_KHANGCAO kc = dt.AKT_SOTHAM_KHANGCAO.Where(x => x.DONID == DonID
                                                                                && x.ID == KCKNID).FirstOrDefault();
                        AKT_SOTHAM_KHANGNGHI kn = dt.AKT_SOTHAM_KHANGNGHI.Where(x => x.DONID == DonID
                                                                                && x.ID == KCKNID).FirstOrDefault();
                        if (oND == null)
                        {
                            isNew = true;
                            oND = new AKT_SOTHAM_RUTKCKN();
        ...
        void XoaKhangCao_KN(decimal curr_id)
        {
            if (curr_id > 0)
            {
                AKT_SOTHAM_RUTKCKN oT = dt.AKT_SOTHAM_RUTKCKN.Where(x => x.ID == curr_id).FirstOrDefault();
                AKT_SOTHAM_KHANGCAO kc = dt.AKT_SOTHAM_KHANGCAO.Where(x => x.ID == oT.IDKCKN).FirstOrDefault();
                AKT_SOTHAM_KHANGNGHI kn = dt.AKT_SOTHAM_KHANGNGHI.Where(x => x.ID == oT.IDKCKN).FirstOrDefault();
                if (oT != null)
                {
                    if (kc != null)
                    {
                    ...
                    dt.AKT_SOTHAM_RUTKCKN.Remove(oT);
                    dt.SaveChanges();
                }
            }
