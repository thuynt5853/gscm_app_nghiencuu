<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Danhsach.aspx.cs" Inherits="WEB.GSTP.QLAN.AKT.AnPhi.Danhsach" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="box">
        <div class="box_nd">
            ...
            <%--                         <asp:TextBox ID="txtGiaTriTranhChap" runat="server" Enabled="false" CssClass="user align_right" Width="150px" onkeypress="return isNumber(event)" onkeyup="javascript:this.value=Comma(this.value);"></asp:TextBox> --%>
            <%--                     </td> --%>
            <%-- --%>
            ...
            <%--                     <td>Án phí</td> --%>
            <%--                     <td> --%>
            <%--                         <asp:TextBox ID="txtAnPhi" runat="server" CssClass="user align_right" Width="150px" Enabled="false" onkeypress="return isNumber(event)" onkeyup="javascript:this.value=Comma(this.value);"></asp:TextBox> --%>
            <%--                     </td> --%>
            <%--                     <td>Tạm ứng án phí</td> --%>
            <%--                     <td> --%>
            <%--                         <asp:TextBox ID="txtTamUngAnPhi" runat="server" CssClass="user align_right" Enabled="false" Width="185px" onkeypress="return isNumber(event)" onkeyup="javascript:this.value=Comma(this.value);"></asp:TextBox> --%>
            <%--                     </td> --%>
            <%--                 </tr> --%>
            <%--                 <tr> --%>
            <%--                     <td>Hạn nộp</td> --%>
                    ...
                    <div id="zone_nopanphi">
                        <table class="table1">
                            <tr>
                                ...
                                <td style="width: 150px;">
                                    <asp:DropDownList ID="ddlDuongSu" CssClass="chosen-select" runat="server"
                                        Width="158px" AutoPostBack="True" OnSelectedIndexChanged="ddlDuongSu_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                                <td class="lable_td">Người nộp</td>
                                <td>
                                    <asp:TextBox ID="txtNguoiNop" runat="server" CssClass="user" Width="185px"></asp:TextBox>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 120px;">Ngày nộp biên lai<span class="must_input">(*)</span></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSoThongBao" runat="server" CssClass="user" Width="150px" MaxLength="10" Enabled="false"></asp:TextBox>
                                </td>
                                    ...
                                    <div>
                                        <asp:DataGrid ID="rpt" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left" HeaderStyle-Width="120px">
                                                ...
                                                <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left" HeaderStyle-Width="300px">
                                                    <HeaderTemplate>Thông tin biên lai trực tiếp (THA)</HeaderTemplate>
                                                    <ItemTemplate>
                                                       <div>
                                                            <i>Mã thông báo:</i>
                                                            ...
                                                            <br />
                                                              <i> Ngày nộp tạm ứng án phí:</i> <%# string.Format("{0:dd/MM/yyyy}",Eval("NGAYNOPANPHI")) %>
                                                        </div>
                                                        <div style="margin-top: 5px;">
                                                            <asp:ImageButton ID="lblDownloadAP_THA" ImageUrl="/UI/img/Manager/pdf_blues.png" runat="server" CausesValidation="false" CommandName="DownloadAP_THA"
                                                                CommandArgument='<%#Eval("ANPHI_ID") %>' ToolTip='<%#Eval("TENFILE")%>' />
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                ...
                                                <asp:TemplateColumn HeaderStyle-Width="105px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <ItemTemplate>
                                                        <div>
                                                            <asp:ImageButton ID="cmdENABLE" runat="server" CausesValidation="false" CommandArgument='<%#Eval("ID") %>'
                                                                CommandName="ENABLE" ImageUrl="/UI/img/Manager/lock.png" />
                                                        </div>
