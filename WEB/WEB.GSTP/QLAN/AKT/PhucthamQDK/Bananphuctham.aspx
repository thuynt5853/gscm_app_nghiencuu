<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Bananphuctham.aspx.cs" Inherits="WEB.GSTP.QLAN.AKT.PhucthamQDK.Bananphuctham" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnBAPT"  Visible="false" runat="server">
        <div class="boxchung">
            ...
            <div class="boder" style="padding: 10px;">
                ...
                <asp:HiddenField ID="hddShowDetail" runat="server" Value="True" />
    ...
    <asp:Panel ID="pnQDVV" runat="server" ChildrenAsTriggers="true" ClientIDMode="AutoID">
        <div class="box">
            <div class="box_nd">
                <div class="boxchung">
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                                <td colspan="4">
                                    <asp:RadioButtonList ID="rdbPanelQD" Visible="false" runat="server" RepeatDirection="Horizontal" Font-Bold="true" AutoPostBack="true" OnSelectedIndexChanged="rdbPanelQD_SelectedIndexChanged">
                                        <asp:ListItem Value="1" Text="Bản án"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="Quyết định" Selected="True"></asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <cc1:MaskedEditValidator ID="MaskedEditValidator1" runat="server" ControlExtender="MaskedEditExtender2" ControlToValidate="txtNgayMoPhienToaQD" InvalidValueMessage="dd/MM/yyyy" Style="color: red; margin-left: 15px;"></cc1:MaskedEditValidator>
                                </td>
                            ...
                            <asp:Panel ID="pnKetquaPhuctham" runat="server" >
                                <tr>
                                    <td>Kết quả phúc thẩm<span class="batbuoc">(*)</span></td>
                                    <td colspan="3">
