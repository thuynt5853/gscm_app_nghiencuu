    ...
    public partial class NguoiThamgiaTT : System.Web.UI.Page
    {
        ...
        public void GetDuongSu(string strlstId = "")
        {
            ...
            if (string.IsNullOrEmpty(strlstId))
            {
                ...
                var lstDuongSu = (from a in dt.AKT_DON_DUONGSU.Where(s => s.DONID == donId)
        ...
        private void check_Quyen(decimal DONID)
        {
            ...
            //DataTable NTH = oBL.AKT_KCKNQDK_PHUCTHAM_HDXX_GETLIST(DONID);
        ...
        private void LoadTGTTFromDonKK()
        {
            ...
            chkListTGTT.DataSource = oBL.AKT_DON_TGTT_GETLIST(DONID);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string current_id = Session[ENUM_LOAIAN.AN_KINHDOANH_THUONGMAI] + "";
                decimal DONID = Convert.ToDecimal(current_id);
                AKT_KCKNQDK_PHUCTHAM_THAMGIATOTUNG oND;
                if (hddid.Value == "" || hddid.Value == "0")
                    oND = new AKT_KCKNQDK_PHUCTHAM_THAMGIATOTUNG();
                else
                {
                    decimal ID = Convert.ToDecimal(hddid.Value);
                    //oND = dt.AKT_PHUCTHAM_THAMGIATOTUNG.Where(x => x.ID == ID).FirstOrDefault();
                    oND = DataExtensions.FindById<AKT_KCKNQDK_PHUCTHAM_THAMGIATOTUNG>(ID);
                }
                ...
                var data = (from s in dt.AKT_DON_DUONGSU
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    //dt.AKT_PHUCTHAM_THAMGIATOTUNG.Add(oND);
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AKT_PHUCTHAM_KCKN_TGTT_GETLIST(ID);
        ...
        {
            //AKT_PHUCTHAM_THAMGIATOTUNG oND = dt.AKT_PHUCTHAM_THAMGIATOTUNG.Where(x => x.ID == id).FirstOrDefault();
            AKT_KCKNQDK_PHUCTHAM_THAMGIATOTUNG oND = DataExtensions.FindById<AKT_KCKNQDK_PHUCTHAM_THAMGIATOTUNG>(id);
            if (oND != null)
            {
                //dt.AKT_PHUCTHAM_THAMGIATOTUNG.Remove(oND);
        ...
        protected void cmdChonTGTT_Click(object sender, EventArgs e)
        {
            ...
            foreach (ListItem oItem in chkListTGTT.Items)
            {
                if (oItem.Selected)
                {
                    ...
                    if (dt.AKT_PHUCTHAM_THAMGIATOTUNG.Where(x => x.NTGTT_DONKK_ID == NID).ToList().Count == 0)
                    {
                        AKT_DON_THAMGIATOTUNG oD = dt.AKT_DON_THAMGIATOTUNG.Where(x => x.ID == NID).FirstOrDefault();
                        AKT_KCKNQDK_PHUCTHAM_THAMGIATOTUNG oS = new AKT_KCKNQDK_PHUCTHAM_THAMGIATOTUNG();
                        oS.DONID = oD.DONID;
                        oS.HOTEN = oD.HOTEN;
                        ...
                        if (oS.TOA_GIAIQUYET_ID == null && oD.TOA_GIAIQUYET_ID != null)
                        {
                            oS.TOA_GIAIQUYET_ID = oD.TOA_GIAIQUYET_ID;
                        }
                        //dt.AKT_PHUCTHAM_THAMGIATOTUNG.Add(oS);
        ...
        {
            //------------------
            AKT_NGUOITHAMGIATOTUNG_BL oBL = new AKT_NGUOITHAMGIATOTUNG_BL();
            decimal sodk_ = 0;
        ...
        protected void btn_GXN_NBC_Click(object sender, EventArgs e)
        {
            ...
            {
                //--------------
                AKT_NGUOITHAMGIATOTUNG_BL objBL = new AKT_NGUOITHAMGIATOTUNG_BL();
