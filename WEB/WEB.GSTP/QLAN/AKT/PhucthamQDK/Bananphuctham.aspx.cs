...
namespace WEB.GSTP.QLAN.AKT.PhucthamQDK
{
    public partial class Bananphuctham : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    hddDonID.Value = Session[ENUM_LOAIAN.AN_KINHDOANH_THUONGMAI] + "";
        ...
        {
            decimal DONID = Convert.ToDecimal(hddDonID.Value);
            string Result = new AKT_CHUYEN_NHAN_AN_BL().Check_ChuyenNhanAn(DONID, "Không được sửa đổi thông tin.", Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]));
            if (Result != "")
            {
            ...
            List<AKT_KCKNQDK_PHUCTHAM_THULY> lstCount = DataExtensions.GetAllWithClause<AKT_KCKNQDK_PHUCTHAM_THULY>("DONID = " + DONID);
            ...
            #region Chỉ cho thêm 1 QĐ-bản án  - TAMNC
            string donviID = Session[ENUM_SESSION.SESSION_DONVIID]?.ToString();
            List<AKT_KCKNQDK_PHUCTHAM_QUYETDINH> lstQD = DataExtensions.GetAllWithClause<AKT_KCKNQDK_PHUCTHAM_QUYETDINH>("DONID = " + DONID + " AND TOA_GIAIQUYET_ID = " + donviID + " AND (LOAIQDID IN (10,3) OR QUYETDINHID IN (213,145,146))");
            if (lstQD.Count >= 1)
            {
                pnQDVV.Visible = true;
            ...
            #endregion Chỉ cho thêm 1 QĐ-bản án  - TAMNC

            #region hieu nếu có tống đạt thì ko được xóa bản án sơ thẩm

            AKT_TONGDAT td = dt.AKT_TONGDAT.Where(x => x.DONID == DONID && (x.BIEUMAUID == 230 || x.BIEUMAUID == 261)).FirstOrDefault();
            if (td != null)
            {
            ...
            //                                                                ).FirstOrDefault();
            //AKT_KCKNQDK_PHUCTHAM_QUYETDINH oQD = DataExtensions.GetAllWithClause<AKT_KCKNQDK_PHUCTHAM_QUYETDINH>
            //                        ($"DONID = {DONID} and LOAIQDID == 5 and QUYETDINHID not in (147, 148)").FirstOrDefault();
            //if (oQD == null)
            //{
            ...
            //    return;
            //}
            AKT_KCKNQDK_PHUCTHAM_QUYETDINH qd64DS = DataExtensions.GetAllWithClause<AKT_KCKNQDK_PHUCTHAM_QUYETDINH>($"DONID = {DONID} AND QUYETDINHID = 64").FirstOrDefault();
            if (qd64DS == null)
            {
                lbthongbaoQD.Text = "Chưa nhập quyết định đưa vụ án ra xét xử.";
                Cls_Comon.SetButton(btnUpdate, false);
        ...
        private void LoadFile()
        {
            ...
            List<AKT_PHUCTHAM_BANAN_FILE> lst = dt.AKT_PHUCTHAM_BANAN_FILE.Where(x => x.BANANID == DonID).ToList();
        ...
        private string getQHPL_NAME_THULY()
        {
            ...
            AKT_KCKNQDK_PHUCTHAM_THULY oT = DataExtensions.GetAllWithClause<AKT_KCKNQDK_PHUCTHAM_THULY>("DONID = " + ID).FirstOrDefault();
        ...
        private void txtQuanhephapluat_name(AKT_KCKNQDK_PHUCTHAM_THULY oT)
        {
            if (oT.QUANHEPHAPLUAT_NAME != null)
            {
                txtQuanhephapluat.Text = oT.QUANHEPHAPLUAT_NAME;
        ...
        {
            AKT_KCKN_PHUCTHAM_BL oBL = new AKT_KCKN_PHUCTHAM_BL();
            decimal ID = Convert.ToDecimal(hddDonID.Value);
            DataTable oDT = oBL.AKT_PHUCTHAMKCKNQDK_BANANQUYETDINH_GETLIST(ID);
        ...
        private void LoadQD()
        {
            ...
            DataTable oDT = oBL.ALD_DM_QUYETDINH_VUAN_PTQDK();
        ...
        private void LoadNguoiKyInfo()
        {
            ...
            AKT_KCKNQDK_PHUCTHAM_HDXX oND = DataExtensions.GetAllWithClause<AKT_KCKNQDK_PHUCTHAM_HDXX>("DONID = " + DonID + " AND MAVAITRO ='" + ENUM_NGUOITIENHANHTOTUNG.THAMPHAN + "'").FirstOrDefault<AKT_KCKNQDK_PHUCTHAM_HDXX>();
            if (oND != null)
            {
        ...
        {
            Decimal ID = Convert.ToDecimal(hddDonID.Value);
            //List<AKT_PHUCTHAM_QUYETDINH> lstQD = dt.AKT_PHUCTHAM_QUYETDINH.Where(x => x.DONID == ID && (x.LOAIQDID == 10 || x.QUYETDINHID == 423 || x.QUYETDINHID == 422 || x.LOAIQDID == 3 || x.LOAIQDID == 23)).ToList();
            List<AKT_KCKNQDK_PHUCTHAM_QUYETDINH> lstQD = DataExtensions.GetAllWithClause<AKT_KCKNQDK_PHUCTHAM_QUYETDINH>
                ($"DONID = {ID} and (LOAIQDID IN (10,3) OR  QUYETDINHID IN ( 423,422))").ToList();
            if (lstQD.Count >= 1)
            {
                Cls_Comon.SetButton(btnUpdate, false);
            }
        ...
        public void xoa(decimal id)
        {
            ...
            AKT_KCKNQDK_PHUCTHAM_QUYETDINH oND = DataExtensions.FindById<AKT_KCKNQDK_PHUCTHAM_QUYETDINH>(id);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AKT_KCKNQDK_PHUCTHAM_QUYETDINH oND;
                decimal STTQD = 0;
                if ((hddid.Value == "" || hddid.Value == "0"))
                {
                    oND = new AKT_KCKNQDK_PHUCTHAM_QUYETDINH();
                ...
                else
                {
                    ...
                    oND = DataExtensions.FindById<AKT_KCKNQDK_PHUCTHAM_QUYETDINH>(ID);
                    if (oND.TOAANID.ToString() != Session[ENUM_SESSION.SESSION_DONVIID].ToString())
                    {
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                case "Download":
                    AKT_KCKNQDK_PHUCTHAM_QUYETDINH oND = DataExtensions.FindById<AKT_KCKNQDK_PHUCTHAM_QUYETDINH>(ND_id);
                    if (oND.TENFILE != "")
                    {
                        var cacheKey = Guid.NewGuid().ToString("N");
        ...
        protected void set_valueLydo(AKT_KCKNQDK_PHUCTHAM_QUYETDINH oND)
        {
