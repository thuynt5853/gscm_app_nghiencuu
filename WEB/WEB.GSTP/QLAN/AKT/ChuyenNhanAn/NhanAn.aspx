<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="NhanAn.aspx.cs" Inherits="WEB.GSTP.QLAN.AKT.ChuyenNhanAn.NhanAn" %>
                                    ...
                                    <div class="boder" style="padding: 10px;">
                                        <table class="table1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="float: left; width: 85px; text-align: right; margin-right: 10px;">Người kháng cáo</div>
                                                    <div style="float: left;">
                            ...
                            <td align="center">
                               <%-- <asp:Button ID="cmdTimkiem" runat="server" CssClass="buttoninput" Text="Tìm kiếm" OnClick="cmdTimkiem_Click" />
                                ...
                                <asp:Button ID="cmdHuyNhan" runat="server" CssClass="buttoninput" Text="Hủy nhận án" OnClientClick="return confirm('Bạn thực sự muốn hủy nhận án này? ');" OnClick="cmdHuyNhan_Click" />--%>
                                  <asp:Button ID="Button1" runat="server" CssClass="buttoninput" Text="Tìm kiếm" OnClick="cmdTimkiem_Click" />
