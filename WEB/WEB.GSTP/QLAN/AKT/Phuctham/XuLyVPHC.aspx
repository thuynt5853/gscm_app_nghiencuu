<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="XuLyVPHC.aspx.cs" Inherits="WEB.GSTP.QLAN.AKT.Phuctham.XuLyVPHC" %>
            ...
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        ...
                        <tr>
                            <td>
                                <table style="width: 100%">
                                    <tr>
                                        <td style="width: 50px; border-right: 1px solid #cccccc;"><b>Phạt tiền</b>
                                        </td>
                                        <td>
                        ...
                        <tr>
                            <td>Tịch thu tang vật, Phương tiện
                            </td>
                            <td>
