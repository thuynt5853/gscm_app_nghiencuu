    ...
    public partial class DuongSu : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    bool daCoBanAn = dt.AKT_PHUCTHAM_BANAN.Any(x => x.DONID == DONID);
                    if (daCoBanAn)
                    {
        ...
        protected void cmdChonDuongSu_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridItem oItem in dgList.Items)
            {
                ...
                AKT_DON_DUONGSU oT = dt.AKT_DON_DUONGSU.Where(x => x.ID == DSID).FirstOrDefault();
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AKT_PHUCTHAM_DUONGSU_GETBY(ID, 0);
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Select"://Cap nhat thong tin Duong su  
                    ...
                    string StrMsg = "PopupCenter('/QLAN/AKT/Hoso/Popup/pDuongSuUpdate.aspx?dsID=" + DuongSuID.ToString() + "','Bổ sung thông tin đương sự',950,450);";
