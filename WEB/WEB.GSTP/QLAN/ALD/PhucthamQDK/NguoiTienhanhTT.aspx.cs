    ...
    public partial class NguoiTienhanhTT : System.Web.UI.Page
    {
        ...
        private void LoadCombobox()
        {
            ...
            if (loaiQD != null)
            {
                ...
                ALD_KCKNQDK_PHUCTHAM_QUYETDINH qd = DataExtensions.GetAllWithClause<ALD_KCKNQDK_PHUCTHAM_QUYETDINH>
                        ("DONID = " + DonID + " and LOAIQDID = " + loaiQD.ID).FirstOrDefault<ALD_KCKNQDK_PHUCTHAM_QUYETDINH>();
                if (qd != null)
                {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<ALD_KCKNQDK_PHUCTHAM_HDXX> countChuToa = DataExtensions.GetAllWithClause<ALD_KCKNQDK_PHUCTHAM_HDXX>($"DONID = {DONID} AND MAVAITRO = '{ENUM_NGUOITIENHANHTOTUNG.THAMPHAN}'");
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    if (tucach == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN)
                    {
                        ...
                        //oND = dt.ALD_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).FirstOrDefault<ALD_PHUCTHAM_HDXX>();
                        oND = DataExtensions.GetAllWithClause<ALD_KCKNQDK_PHUCTHAM_HDXX>($"DONID = {DONID} AND MAVAITRO = '{ENUM_NGUOITIENHANHTOTUNG.THAMPHAN}'").FirstOrDefault();
                    ...
                    oND = new ALD_KCKNQDK_PHUCTHAM_HDXX();
                }
                else
                {
                    decimal ID = Convert.ToDecimal(hddid.Value);
                    //oND = dt.ALD_PHUCTHAM_HDXX.Where(x => x.ID == ID).FirstOrDefault();
                    oND = DataExtensions.GetAllWithClause<ALD_KCKNQDK_PHUCTHAM_HDXX>("ID = " + ID).FirstOrDefault();
                }
                oND.DONID = DONID;
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    ALD_KCKNQDK_PHUCTHAM_HDXX CheckCanBo = DataExtensions.GetAllWithClause<ALD_KCKNQDK_PHUCTHAM_HDXX>
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.ALD_KCKNQDK_PHUCTHAM_HDXX_GETLIST(ID);
        ...
        public void xoa(decimal id)
        {
            ...
            ALD_KCKNQDK_PHUCTHAM_HDXX oND = DataExtensions.FindById<ALD_KCKNQDK_PHUCTHAM_HDXX>(id);
