<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true"
    CodeBehind="TaoHosoLD.aspx.cs" Inherits="WEB.GSTP.QLAN.ALD.TaoHS.TaoHosoLD" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/QLAN/ALD/TaoHS/Popup/pDuongSuKhac.ascx" TagPrefix="uc1" TagName="DsDuongSu" %>
<%@ Register Src="~/QLAN/ALD/TaoHS/Popup/uDSNguoiThamGiaToTung.ascx" TagPrefix="uc1" TagName="uDSNguoiThamGiaToTung" %>
