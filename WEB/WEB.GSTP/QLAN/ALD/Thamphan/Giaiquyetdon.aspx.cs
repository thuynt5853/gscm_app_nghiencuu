    ...
    public partial class Giaiquyetdon : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ALD_CHUYEN_NHAN_AN objCN = dt.ALD_CHUYEN_NHAN_AN.Where(x => x.MAP_VUANID_NEW == ID && x.TRUONGHOPGIAONHANID == 266).FirstOrDefault();
                if (objCN != null)
                {
        ...
        public void LoadGrid()
        {
            ...
            string current_id = Session[ENUM_LOAIAN.AN_LAODONG] + "";
            decimal ID = Convert.ToDecimal(current_id);
            DataTable oDT = oBL.ALD_DON_THAMPHAN_GETBY(ID, ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETDON);
        ...
        public void xoa(decimal id)
        {
            ...
            ALD_DON_XULY xld = dt.ALD_DON_XULY.Where(x => x.DONID == oND.DONID).FirstOrDefault();
            ...
            if (oBL.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oND.DONID), 5, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Thẩm phán giải quyết đơn án Lao động", "Xóa", json) == false)
            {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ALD_DON_XULY oXL = dt.ALD_DON_XULY.Where(x => x.DONID == DONID || x.DON_XULYID == DONID).FirstOrDefault();
                if (oXL != null)
                {
                    lbtXoa.Visible = false;
                }
