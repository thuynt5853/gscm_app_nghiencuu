...
namespace WEB.GSTP.QLAN.ALD.Thamphan
{
    public partial class GiaiquyetPhucthamKCKNQDK : System.Web.UI.Page
    {
        ...
        private void check_Quyen(decimal DONID)
        {
            ...
            DataTable oDT = oBL.ALD_PHUCTHAM_KCKN_TGTT_GETLIST(DONID);
            ...
            ALD_KCKN_PHUCTHAM_BL BL = new ALD_KCKN_PHUCTHAM_BL();
            DataTable DT = BL.ALD_KCKNQDK_PHUCTHAM_HDXX_GETLIST(DONID);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    oND = dt.ALD_DON_THAMPHAN.Where(x => x.DONID == DONID && x.CANBOID == CanBoID && x.MAVAITRO == MaVaiTro && x.TOA_GIAIQUYET_ID == currenttoaid).FirstOrDefault();
                    if (oND != null)
                    {
                ...
                ALD_KCKNQDK_PHUCTHAM_HDXX oTHTT = DataExtensions.GetAllWithClause<ALD_KCKNQDK_PHUCTHAM_HDXX>($"DONID = {DONID} AND MAVAITRO = '{ENUM_NGUOITIENHANHTOTUNG.THAMPHAN}'").FirstOrDefault();
                ...
                {
                    oTHTT = new ALD_KCKNQDK_PHUCTHAM_HDXX();
                    oTHTT.DONID = DONID;
        ...
        public void xoa(decimal id)
        {
            ...
            if (oBL.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oND.DONID), 3, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Thẩm phán giải quyết Phúc thẩm án Lao Động", "Xóa", json) == false)
            {
