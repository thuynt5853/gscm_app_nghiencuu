...
namespace WEB.GSTP.QLAN.ALD.Thamphan
{
    public partial class GiaiquyetSotham : System.Web.UI.Page
    {
        ...
        private void CheckQuyen(decimal DONID)
        {
            ...
            List<ALD_SOTHAM_THULY> lstCount = dt.ALD_SOTHAM_THULY.Where(x => x.DONID == DONID).ToList();
            if (lstCount.Count == 0)
            {
            ...
            ALD_SOTHAM_BANAN oBA = dt.ALD_SOTHAM_BANAN.Where(x => x.DONID == DONID).FirstOrDefault();
            if (oBA != null)
            {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ALD_DON_THAMPHAN obj = dt.ALD_DON_THAMPHAN.Where(x => x.ID == ID).FirstOrDefault();
                if (obj != null)
                {
                    ...
                    if (chuyenan != null)
                    {
                        ...
                        {
                            List<ALD_SOTHAM_HDXX> NTHTT = dt.ALD_SOTHAM_HDXX.Where(x => x.DONID == DONID).ToList();
                        ...
                        {
                            List<ALD_SOTHAM_HDXX> NTHTT = dt.ALD_SOTHAM_HDXX.Where(x => x.DONID == DONID && x.NGAYTAO > chuyenan.NGAYTAO).ToList();
                ...
                //ALD_SOTHAM_HDXX hdxx = dt.ALD_SOTHAM_HDXX.Where(x => x.DONID == DONID).FirstOrDefault();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ALD_SOTHAM_HDXX oTHTT = dt.ALD_SOTHAM_HDXX.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).FirstOrDefault<ALD_SOTHAM_HDXX>();
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.ALD_DON_THAMPHAN_GETBY(ID, ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETSOTHAM);
        ...
        public void xoa(decimal id)
        {
            ...
            if (oBL.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oND.DONID), 5, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Thẩm phán Sơ thẩm án Lao động", "Xóa", json) == false)
            {
        ...
        private bool CheckQDofThamPhan(decimal DonID, decimal TPID)
        {
            ...
            ALD_SOTHAM_QUYETDINH obj_QD = dt.ALD_SOTHAM_QUYETDINH.Where(x => x.DONID == DonID && x.NGUOIKYID == TPID).FirstOrDefault<ALD_SOTHAM_QUYETDINH>();
            if (obj_QD != null)
            {
