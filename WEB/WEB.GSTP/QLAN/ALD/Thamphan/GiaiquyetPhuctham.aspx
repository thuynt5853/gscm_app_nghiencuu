<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="GiaiquyetPhuctham.aspx.cs" Inherits="WEB.GSTP.QLAN.ALD.Thamphan.GiaiquyetPhuctham" %>
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNgayphancong" runat="server" AutoPostBack="True" OnTextChanged="txtNgayphancong_TextChanged"
                                    CssClass="user" Width="192px" MaxLength="10"></asp:TextBox>
                        ...
                        <tr>
                            <td>Ngày kết thúc</td>
                            <td>
                                <asp:TextBox ID="txtNgayketthuc" runat="server" CssClass="user" Width="192px" MaxLength="10"></asp:TextBox>
