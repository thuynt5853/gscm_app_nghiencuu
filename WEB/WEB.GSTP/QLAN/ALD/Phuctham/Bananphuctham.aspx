<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Bananphuctham.aspx.cs" Inherits="WEB.GSTP.QLAN.ALD.Phuctham.Bananphuctham" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <table class="table1">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <asp:DropDownList ID="ddlLoaiQuanhe" Visible="true" CssClass="chosen-select" runat="server" Width="300px">
                    ...
                    <tr>
                        ...
                        <td style="width: 120px;">Ngày mở phiên tòa<span class="batbuoc">(*)</span></td>
                        <td>
    ...
    <script type="text/javascript">
        ...
        function ValidInputData() {
            ...
            if (!CheckChangeRadioButtonList(rdVuAnQuaHan, 'Chưa chọn "Vụ án quá hạn luật định". Hãy chọn lại!'))
                return false;
            var rdNNChuQuan = document.getElementById('<%=rdNNChuQuan.ClientID%>');
            if (rdNNChuQuan !== null && !CheckChangeRadioButtonList(rdNNChuQuan, 'Chưa chọn "Nguyên nhân chủ quan". Hãy chọn lại!'))
                return false;
            var rdNNKhachQuan = document.getElementById('<%=rdNNKhachQuan.ClientID%>');
            if (rdNNKhachQuan !== null && !CheckChangeRadioButtonList(rdNNKhachQuan, 'Chưa chọn "Nguyên nhân khách quan". Hãy chọn lại!'))
                return false;
            //Quan hệ pháp luật
