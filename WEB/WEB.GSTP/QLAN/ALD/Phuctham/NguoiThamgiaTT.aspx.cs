    ...
    public partial class NguoiThamgiaTT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    ALD_DON oT = dt.ALD_DON.Where(x => x.ID == DONID && x.TOA_GIAIQUYET_ID == Donvi_ID && x.TOA_GIAIQUYET_ID == Donvi_ID).FirstOrDefault();
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ALD_DON oT = dt.ALD_DON.Where(x => x.ID == DONID && x.TOA_GIAIQUYET_ID == DonviID).FirstOrDefault();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string current_id = Session[ENUM_LOAIAN.AN_LAODONG] + "";
                decimal DONID = Convert.ToDecimal(current_id);
                ALD_PHUCTHAM_THAMGIATOTUNG oND;
                if (hddid.Value == "" || hddid.Value == "0")
                    oND = new ALD_PHUCTHAM_THAMGIATOTUNG();
                else
                {
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.ALD_PHUCTHAM_TGTT_GETLIST(ID);
        ...
        public void xoa(decimal id)
        {
            ...
            if (oND != null)
            {
                ...
                ALD_PHUCTHAM_HDXX ALD_PHUCTHAM_HDXX = dt.ALD_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == currenttoaid).FirstOrDefault<ALD_PHUCTHAM_HDXX>();
            ...
            foreach (ListItem oItem in chkListTGTT.Items)
            {
                if (oItem.Selected)
                {
                    ...
                    if (dt.ALD_PHUCTHAM_THAMGIATOTUNG.Where(x => x.NTGTT_DONKK_ID == NID).ToList().Count == 0)
                    {
                        ...
                        ALD_PHUCTHAM_THAMGIATOTUNG oS = new ALD_PHUCTHAM_THAMGIATOTUNG();
                        oS.DONID = oD.DONID;
                        oS.HOTEN = oD.HOTEN;
