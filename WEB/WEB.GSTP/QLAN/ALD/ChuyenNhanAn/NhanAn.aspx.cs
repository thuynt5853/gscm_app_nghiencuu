...
namespace WEB.GSTP.QLAN.ALD.ChuyenNhanAn
{
    public partial class NhanAn : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    #region Quét các vụ việc được chuyển từ Tòa án cấp cao và lưu vào ALD_DON và ALD_CHUYEN_NHAN_AN
                    ...
                    //string sql = "select * from HOSO where TOA_AN_XET_XU='" + ToaAnID.ToString() + "' and LOAI_AN='" + ENUM_LOAIAN.AN_LAODONG + "' and TRANG_THAI=1";
                    ...
                    //        #region Update Vụ việc ALD_DON
                    //        ALD_DON vDON = dt.ALD_DON.Where(x => x.MAVUVIEC == MaVuViec && ((x.MAGIAIDOAN == ENUM_GIAIDOANVUAN.SOTHAM && x.TOAANID == ToaAnID) || (x.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM && x.TOAPHUCTHAMID == ToaAnID))).FirstOrDefault();
                    //        if (vDON == null)
                    //        {
                    //            IsNew = true;
                    //            vDON = new ALD_DON();
                    ...
                    //        VuAnID = vDON.ID;
                    //        #endregion
                    //        #region Update Table ALD_CHUYEN_NHAN_AN
                    //        IsNew = false;
                    //        ALD_CHUYEN_NHAN_AN chuyen_nhan_an = dt.ALD_CHUYEN_NHAN_AN.Where(x => x.VUANID == VuAnID && x.TOACHUYENID == Toa_Chuyen_ID && x.TOANHANID == Toa_Nhan_ID).FirstOrDefault();
                    //        if (chuyen_nhan_an == null)
                    //        {
                    //            IsNew = true;
                    //            chuyen_nhan_an = new ALD_CHUYEN_NHAN_AN();
                    //        }
                    ...
                    //        if (IsNew)
                    //        {
                    //            dt.ALD_CHUYEN_NHAN_AN.Add(chuyen_nhan_an);
                    //        }
                    //        dt.SaveChanges();
                    //        #endregion
                    //    }
        ...
        private void LoadGrid()
        {
            ...
            DataTable oDT = oBL.LD_NHANAN(txt_NG_KC.Text.Trim(), txtSoQD.Text.Trim(), txt_NgayQD.Text.Trim(), vDonViID, txtMaVuViec.Text, txtTenVuViec.Text, txtTenToa.Text, Convert.ToDecimal(ddlTHGN.SelectedValue), dFrom, dTo, Convert.ToDecimal(rdbTrangthai.SelectedValue), Convert.ToDecimal(rdbLoai.SelectedValue));
        ...
        protected void cmdLuu_Click(object sender, EventArgs e)
        {
            ...
            foreach (RepeaterItem item in rptCapNhat.Items)
            {
                ...
                ALD_CHUYEN_NHAN_AN oT = dt.ALD_CHUYEN_NHAN_AN.Where(x => x.ID == ID).FirstOrDefault();
                if (oT != null)
                {
                    ...
                    if (oIT.MA == ENUM_TRUONGHOP_GIAONHAN.KHONGTHUOC_THAMQUYEN_XETXU)
                    {
                        ...
                        else
                        {
                            if (rdbLoai.SelectedValue == "0")
                            {
                                ...
                                GD.GAIDOAN_INSERT_UPDATE("5", oDonMoi.ID, 2, oDonMoi.TOAANID.Value, 0, 0, 0, 0);
                                ...
                                foreach (var it in lstTailieu)
                                {
                                    ...
                                    // quyennd
                                    if (objtl.TOA_GIAIQUYET_ID == null)
                            ...
                            else
                            {
                                ...
                                */
                                string UserName = Session[ENUM_SESSION.SESSION_USERNAME] + "", LoaiVuViec = ENUM_LOAIVUVIEC.AN_LAODONG, MaToaAn = Session[ENUM_SESSION.SESSION_MADONVI] + "";
                                ...
                                GIAI_DOAN_BL GD = new GIAI_DOAN_BL();
                                GD.GAIDOAN_INSERT_UPDATE("5", DonID_New, 2, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0, 0);
                            }
                        }
                    }
                    else if (oIT.MA == ENUM_TRUONGHOP_GIAONHAN.XETXULAI_CAPSOTHAM)
                    {
                        ...
                        {
                            ALD_CHUYEN_NHAN_AN_BL _caBL = new ALD_CHUYEN_NHAN_AN_BL();
                            decimal currentToaAnID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                            decimal donIdOld = _caBL.getDonIdOld(oDon.ID);
                            GIAI_DOAN_BL GD = new GIAI_DOAN_BL();
                            ALD_DON oDonOld = dt.ALD_DON.Where(x => x.ID == donIdOld).FirstOrDefault();
                            oDonOld.MAGIAIDOAN = ENUM_GIAIDOANVUAN.SOTHAM;
                            dt.SaveChanges();
                            GD.GAIDOAN_INSERT_UPDATE("5", donIdOld, ENUM_GIAIDOANVUAN.SOTHAM, currentToaAnID, 0, 0, 0, 0);
                            #region toancau - anhnt update lại kết quả kháng cáo/kháng nghị
                            List<ALD_SOTHAM_KHANGCAO> khangCaos = dt.ALD_SOTHAM_KHANGCAO.Where(x => x.DONID == donIdOld && (x.TINHTRANG_GIAIQUYET == null || x.TINHTRANG_GIAIQUYET == 0) && x.LOAIKHANGCAO == 2).ToList();
                            if (khangCaos != null && khangCaos.Count > 0)
                            {
                                foreach (ALD_SOTHAM_KHANGCAO kc in khangCaos)
                                {
                                    kc.TINHTRANG_GIAIQUYET = 1;
                                    dt.SaveChanges();
                                }
                            }
                            List<ALD_SOTHAM_KHANGNGHI> khangNghis = dt.ALD_SOTHAM_KHANGNGHI.Where(x => x.DONID == donIdOld && (x.TINHTRANG_GIAIQUYET == null || x.TINHTRANG_GIAIQUYET == 0) && x.LOAIKN == 2).ToList();
                            if (khangNghis != null && khangNghis.Count > 0)
                            {
                                foreach (ALD_SOTHAM_KHANGNGHI kn in khangNghis)
                                {
                        ...
                        else
                        {
                            ...
                            //GIAI_DOAN_BL GD = new GIAI_DOAN_BL();
                            //GD.GAIDOAN_INSERT_UPDATE("5", DonID, 2, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0, 0);
                            ALD_DON oDON_new = new ALD_DON();
                            ...
                            dt.ALD_DON.Add(oDON_new);
                            dt.SaveChanges();

                            GIAI_DOAN_BL GD = new GIAI_DOAN_BL();
                            GD.GAIDOAN_INSERT_UPDATE("5", oDON_new.ID, 2, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0, 0);
                            decimal DonChiTietID = 0;
                            var listDOnCT = new List<KeyValuePair<decimal, decimal>>();
                            ...
                            //Câp dương su vụ án
                            List<ALD_DON_DUONGSU> lst = dt.ALD_DON_DUONGSU.Where(x => x.DONID == DonID).ToList<ALD_DON_DUONGSU>();
                            foreach (ALD_DON_DUONGSU vDuongsu_old in lst)
                            {
                                ALD_DON_DUONGSU vDuongsu_new = new ALD_DON_DUONGSU();
                                ...
                                dt.ALD_DON_DUONGSU.Add(vDuongsu_new);
                                dt.SaveChanges();
                                ...
                                //Ban giao tai lieu
                                List<ALD_DON_TAILIEU> lstTaiLieu = dt.ALD_DON_TAILIEU.Where(x => x.DONID == DonID && x.NGUOIBANGIAO == vDuongsu_old.ID).ToList<ALD_DON_TAILIEU>();
                                foreach (ALD_DON_TAILIEU vdonFile_old in lstTaiLieu)
                                {
                                    ALD_DON_TAILIEU donFile_new = new ALD_DON_TAILIEU();
                                    ...
                                    dt.ALD_DON_TAILIEU.Add(donFile_new);
                                    dt.SaveChanges();
                                }

                            }
                            // Phan cong Tham phan
                            List<ALD_DON_THAMPHAN> lstThamPhan = dt.ALD_DON_THAMPHAN.Where(x => x.DONID == DonID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETDON).ToList<ALD_DON_THAMPHAN>();
                            foreach (ALD_DON_THAMPHAN vThamphan_old in lstThamPhan)
                            {
                                ALD_DON_THAMPHAN vThamphan_new = new ALD_DON_THAMPHAN();
                                ...
                                dt.ALD_DON_THAMPHAN.Add(vThamphan_new);
                                dt.SaveChanges();
                            }
                            //Xu ly don
                            List<ALD_DON_XULY> lstXulyDon = dt.ALD_DON_XULY.Where(x => x.DONID == DonID).ToList<ALD_DON_XULY>();
                            foreach (ALD_DON_XULY vXulyDon_old in lstXulyDon)
                            {
                                ALD_DON_XULY vXulyDon_new = new ALD_DON_XULY();
                                ...
                                dt.ALD_DON_XULY.Add(vXulyDon_new);
                                dt.SaveChanges();
                            }
                            //Tam ung an phi
                            List<ALD_ANPHI> lstAP = dt.ALD_ANPHI.Where(x => x.DONID == DonID && x.MAGIAIDOAN == 2).ToList();
                            foreach (ALD_ANPHI vAP_old in lstAP)
                            {
                                ALD_ANPHI vAP_new = new ALD_ANPHI();
                                ...
                                dt.ALD_ANPHI.Add(vAP_new);
                                dt.SaveChanges();

                                var CNA = new CHUYEN_NHAN_AN();
                                CNA.INSERT_ANPHI_DUONGSUID(5, DonID, oDON_new.ID);
                            }
                    ...
                    else
                    {
                        ...
                        //var soThamKhangCaos = dt.ALD_SOTHAM_KHANGCAO.Where(x => x.DONID == oDon.ID && x.LOAIKHANGCAO == 2 && (x.TINHTRANG_GIAIQUYET == null || x.TINHTRANG_GIAIQUYET == 0));
                        //var soThamKhangNghis = dt.ALD_SOTHAM_KHANGNGHI.Where(x => x.DONID == oDon.ID && x.LOAIKN == 2 && (x.TINHTRANG_GIAIQUYET == null || x.TINHTRANG_GIAIQUYET == 0));

                        //if ((soThamKhangCaos != null && soThamKhangCaos.Count() > 0) || (soThamKhangNghis != null && soThamKhangNghis.Count() > 0))
                        ALD_CHUYEN_NHAN_AN_BL _chuyenNhanAnBl = new ALD_CHUYEN_NHAN_AN_BL();
                        if (_chuyenNhanAnBl.CheckCoKcKnTamDinhChi(DonID))
                        {
                            ...
                            dt.ALD_DON.Add(oDON_new);
                            dt.SaveChanges();
                            GD.GAIDOAN_INSERT_UPDATE("5", oDON_new.ID, ENUM_GIAIDOANVUAN.PHUCTHAM_QDK, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0);
                        ...
                        else
                        {
                            ...
                            GD.GAIDOAN_INSERT_UPDATE("5", DonID, 3, 0, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0);
                        }
                    }
        ...
        private void UpdateNguyenDonBiDon(List<NGUOI_THAM_GIA_AK> List_NguyeDon_BiDon, decimal DonID)
        {
            if (List_NguyeDon_BiDon.Count > 0)
            {
                ...
                {
                    IsNew = false;
                    ALD_DON_DUONGSU DuongSu = dt.ALD_DON_DUONGSU.Where(x => x.DONID == DonID && x.ID_DUONGSU_TACC == item.Guid).FirstOrDefault();
                    if (DuongSu == null)
                    {
                        IsNew = true;
                        DuongSu = new ALD_DON_DUONGSU();
                    }
                    ...
                    if (IsNew)
                    {
                        dt.ALD_DON_DUONGSU.Add(DuongSu);
                    }
                    dt.SaveChanges();
                }
            }
        ...
        private void UpdateNguoiTGTT(List<NGUOI_THAM_GIA_CHUNG> ListNguoiTGTT, decimal DonID)
        {
            if (ListNguoiTGTT.Count > 0)
            {
                ...
                {
                    ALD_DON_THAMGIATOTUNG NguoiTGTT = dt.ALD_DON_THAMGIATOTUNG.Where(x => x.DONID == DonID && x.ID_DUONGSU_TACC == item.Guid).FirstOrDefault();
                    if (NguoiTGTT != null)
                    {
                        IsNew = true;
                        NguoiTGTT = new ALD_DON_THAMGIATOTUNG();
                    ...
                    if (IsNew)
                    {
                        dt.ALD_DON_THAMGIATOTUNG.Add(NguoiTGTT);
                    }
                    dt.SaveChanges();
                }
            }
        ...
        private void UpdateThuLy(THU_LY ThuLy, decimal ToaAnID, decimal DonID, string CapXetXu)
        {
            if (CapXetXu == "SOTHAM")
            {
                ...
                bool IsNew = false;
                ALD_SOTHAM_THULY STThuLy = dt.ALD_SOTHAM_THULY.Where(x => x.DONID == DonID && x.SOTHULY == ThuLy.SOTHULY.ToString()).FirstOrDefault();
                if (STThuLy != null)
                {
                    IsNew = true;
                    STThuLy = new ALD_SOTHAM_THULY();
                ...
                if (IsNew)
                {
                    dt.ALD_SOTHAM_THULY.Add(STThuLy);
                }
                dt.SaveChanges();
            }
            else
            {
                ...
                bool IsNew = false;
                ALD_PHUCTHAM_THULY PTThuLy = dt.ALD_PHUCTHAM_THULY.Where(x => x.DONID == DonID && x.SOTHULY == ThuLy.SOTHULY.ToString()).FirstOrDefault();
                if (PTThuLy != null)
                {
                    IsNew = true;
                    PTThuLy = new ALD_PHUCTHAM_THULY();
                ...
                if (IsNew)
                {
                    PTThuLy.TOA_GIAIQUYET_ID = ToaAnID;
                    dt.ALD_PHUCTHAM_THULY.Add(PTThuLy);
                }
                dt.SaveChanges();
            }
        }
        private void UpdateNguoiTHTT(List<NGUOI_TIEN_HANH_TO_TUNG> ListNguoiTHTT, decimal DonID, string CapXetXu)
        {
            if (ListNguoiTHTT.Count > 0)
            {
                ...
                foreach (NGUOI_TIEN_HANH_TO_TUNG item in ListNguoiTHTT)
                {
                    ...
                    if (CapXetXu == "SOTHAM")
                    {
                        ALD_SOTHAM_HDXX Hdxx = dt.ALD_SOTHAM_HDXX.Where(x => x.DONID == DonID && x.CANBOID == CanBoID).FirstOrDefault();
                        if (Hdxx == null)
                        {
                            IsNew = true;
                            Hdxx = new ALD_SOTHAM_HDXX();
                    ...
                    {
                        ALD_PHUCTHAM_HDXX Hdxx = dt.ALD_PHUCTHAM_HDXX.Where(x => x.DONID == DonID && x.CANBOID == CanBoID).FirstOrDefault();
                        if (Hdxx == null)
                        {
                            IsNew = true;
                            Hdxx = new ALD_PHUCTHAM_HDXX();
                            Hdxx.NGAYTAO = DateTime.Now;
                        }
                        else
                        {
        ...
        private void UpdateQDVuViec(List<QUYET_DINH> ListQD, decimal ToaAnID, decimal DonID, string CapXetXu)
        {
            if (ListQD.Count > 0)
            {
                ...
                foreach (QUYET_DINH item in ListQD)
                {
                    ...
                    if (CapXetXu == "SOTHAM")
                    {
                        ALD_SOTHAM_QUYETDINH QdVuAn = dt.ALD_SOTHAM_QUYETDINH.Where(x => x.DONID == DonID && x.TOAANID == ToaAnID).FirstOrDefault();
                        if (QdVuAn == null)
                        {
                            IsNew = false;
                            QdVuAn = new ALD_SOTHAM_QUYETDINH()
                            {
                        ...
                        if (IsNew)
                        {
                            dt.ALD_SOTHAM_QUYETDINH.Add(QdVuAn);
                        }
                        dt.SaveChanges();
                    }
                    // Phúc thẩm
                    ...
                    {
                        ALD_PHUCTHAM_QUYETDINH QdVuAn = dt.ALD_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DonID && x.TOAANID == ToaAnID).FirstOrDefault();
                        if (QdVuAn == null)
                        {
                            IsNew = false;
                            QdVuAn = new ALD_PHUCTHAM_QUYETDINH()
                            {
                                NGAYTAO = DateTime.Now
                            };
                        }
                        ...
                        if (IsNew)
                        {
                            dt.ALD_PHUCTHAM_QUYETDINH.Add(QdVuAn);
                        }
                        dt.SaveChanges();
                    }
                }
        ...
        private void UpdateBanAn(BAN_AN bAn, LICH_XET_XU LichXetXu, decimal ToaAnID, decimal DonID, string CapXetXu)
        {
            ...
            if (CapXetXu == "SOTHAM")
            {
                ALD_SOTHAM_BANAN STBanAn = dt.ALD_SOTHAM_BANAN.Where(x => x.DONID == DonID && x.TOAANID == ToaAnID).FirstOrDefault();
                if (STBanAn == null)
                {
                    IsNew = true;
                    STBanAn = new ALD_SOTHAM_BANAN();
                ...
                if (IsNew)
                {
                    dt.ALD_SOTHAM_BANAN.Add(STBanAn);
                }
                dt.SaveChanges();
            }
            // Phúc thẩm
            ...
            {
                ALD_PHUCTHAM_BANAN PTBanAn = dt.ALD_PHUCTHAM_BANAN.Where(x => x.DONID == DonID && x.TOAANID == ToaAnID).FirstOrDefault();
                if (PTBanAn == null)
                {
                    IsNew = true;
                    PTBanAn = new ALD_PHUCTHAM_BANAN();
                ...
                DM_KETQUA_PHUCTHAM KQPT = dt.DM_KETQUA_PHUCTHAM.Where(x => x.ISALD == 1 && x.MA == bAn.KETQUA).FirstOrDefault();
                if (KQPT != null)
                {
                ...
                if (IsNew)
                {
                    dt.ALD_PHUCTHAM_BANAN.Add(PTBanAn);
                }
                dt.SaveChanges();
            }
        }
        private void UpdateKhangCao(List<KHANG_CAO> ListKhangCao, decimal ToaAnID, decimal DonID)
        {
            if (ListKhangCao.Count > 0)
            {
                ...
                foreach (KHANG_CAO item in ListKhangCao)
                {
                    ...
                    decimal NguoiKCID = 0;
                    ALD_DON_DUONGSU DuongSu = dt.ALD_DON_DUONGSU.Where(x => x.DONID == DonID && x.ID_DUONGSU_TACC == Guid_NguoiKC).FirstOrDefault();
                    if (DuongSu != null)
                    {
                        NguoiKCID = DuongSu.ID;
                    }
                    ALD_SOTHAM_KHANGCAO kc = dt.ALD_SOTHAM_KHANGCAO.Where(x => x.DONID == DonID && x.DUONGSUID == NguoiKCID && x.TOAANRAQDID == ToaAnID).FirstOrDefault();
                    if (kc != null)
                    {
                        IsNew = true;
                        kc = new ALD_SOTHAM_KHANGCAO();
        ...
        private decimal Action_ChuyenAn_KhongThuoc_ThamQuyen(decimal DonID, string LoaiVuViec, decimal ToaNhanID, string MaToaNhan, string NguoiTao)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("ALD_CVA_KHONG_THAM_QUYEN", parameters);
            decimal Result = 0;
            if (tbl.Rows.Count > 0)
        ...
        {
            ALD_DON_BL Bl = new ALD_DON_BL();
            //for (int i = 0; i < lstDonID.Count; i++)
            //{
            //    var ChuyenNhanID = lstDonID[i];
            //    decimal DonID_New = 0;
            //    ALD_CHUYEN_NHAN_AN ObjChuyenAn = dt.ALD_CHUYEN_NHAN_AN.Where(x => x.ID == ChuyenNhanID).FirstOrDefault();
            //    if (ObjChuyenAn != null)
            //    {
            ...
            for (int i = 0; i < lstDonID.Count; i++)
            {
                var ChuyenNhanID = lstDonID[i];
                decimal DonID_New = 0;
                ALD_CHUYEN_NHAN_AN ObjNhanAn = dt.ALD_CHUYEN_NHAN_AN.Where(x => x.ID == ChuyenNhanID).FirstOrDefault();
                if (ObjNhanAn != null)
                {
                    int LoaiVuViec = Convert.ToInt32(ENUM_LOAIVUVIEC.AN_LAODONG);
                    if (ObjNhanAn.MAP_VUANID_NEW.GetValueOrDefault(0) > 0)
                    {
                        ...
                        if (rdbLoai.SelectedValue == "0")
                        {
                            ALD_DON_THAMPHAN thamPhan = dt.ALD_DON_THAMPHAN.Where(x => x.DONID == DonID_New && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETDON).FirstOrDefault();
                            if (thamPhan != null)
                            {
                                IsThuLy = true;
                        ...
                        if (!IsThuLy)
                        {
                            ...
                            ALD_DON oDonNew = dt.ALD_DON.Where(x => x.ID == DonID_New).FirstOrDefault();
                            var json = new JavaScriptSerializer().Serialize(oDonNew);
                            ADS_DON_BL oBL = new ADS_DON_BL();
                            if (oBL.HISTORY_ALLDATA_BY_VUANID(DonID_New, Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_LAODONG), Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Huỷ nhận án hành chính", "Xóa", json) == false)
                            {
                                break;
                            }
                            //Ket thuc 
                            ...
                            ALD_DON oVuan = dt.ALD_DON.Where(x => x.ID == ObjNhanAn.VUANID).FirstOrDefault();
                    ...
                    else
                    {
                        ...
                        if (oVuan.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM_QDK)
                        {
                            ...
                            ALD_CHUYEN_NHAN_AN chuyenAnSTlenPTTDC = dt.ALD_CHUYEN_NHAN_AN.Where(x => x.MAP_VUANID_NEW == oVuan.ID).FirstOrDefault();
                            List<ALD_SOTHAM_THULY> oThuLyST = dt.ALD_SOTHAM_THULY.Where(x => x.DONID == oldVuAnId && x.NGAYTAO >= chuyenAnSTlenPTTDC.NGAYTAO).ToList();
                            List<ALD_SOTHAM_HDXX> oSTNguoiTienHanhToTung = dt.ALD_SOTHAM_HDXX.Where(x => x.DONID == oldVuAnId && x.NGAYTAO >= chuyenAnSTlenPTTDC.NGAYTAO).ToList();
                            List<ALD_DON_THAMPHAN> oThamPhanST = dt.ALD_DON_THAMPHAN.Where(x => x.DONID == oldVuAnId && x.NGAYTAO >= chuyenAnSTlenPTTDC.NGAYTAO).ToList();
                            List<ALD_SOTHAM_BANAN> oBanAnST = dt.ALD_SOTHAM_BANAN.Where(x => x.DONID == oldVuAnId && x.NGAYTAO >= chuyenAnSTlenPTTDC.NGAYTAO).ToList();
                            List<ALD_SOTHAM_QUYETDINH> oQDST = dt.ALD_SOTHAM_QUYETDINH.Where(x => x.DONID == oldVuAnId && x.NGAYTAO >= chuyenAnSTlenPTTDC.NGAYTAO).ToList();
                            List<ALD_SOTHAM_KHANGCAO> oKCST = dt.ALD_SOTHAM_KHANGCAO.Where(x => x.DONID == oldVuAnId && x.NGAYTAO >= chuyenAnSTlenPTTDC.NGAYTAO).ToList();
                            List<ALD_SOTHAM_KHANGNGHI> oKNST = dt.ALD_SOTHAM_KHANGNGHI.Where(x => x.DONID == oldVuAnId && x.NGAYTAO >= chuyenAnSTlenPTTDC.NGAYTAO).ToList();
                            ...
                            {
                                ALD_DON oVuAnOld = dt.ALD_DON.Where(x => x.ID == oldVuAnId).FirstOrDefault();
                                ALD_CHUYEN_NHAN_AN ObjNhanAnLanCuoi = dt.ALD_CHUYEN_NHAN_AN.Where(x => x.VUANID == oldVuAnId && x.TOACHUYENID == oVuAnOld.TOAANID).OrderByDescending(x => x.ID).FirstOrDefault();
                                ALD_CHUYEN_NHAN_AN ObjNhanAnLanGanCuoi = dt.ALD_CHUYEN_NHAN_AN.Where(x => x.VUANID == oldVuAnId && x.TOACHUYENID == oVuAnOld.TOAANID && x.ID < ObjNhanAnLanCuoi.ID).OrderByDescending(x => x.ID).FirstOrDefault();
                                if (ObjNhanAnLanGanCuoi == null)
                                {
                                    #region toancau - anhnt update lại kết quả kháng cáo/kháng nghị
                                    List<ALD_SOTHAM_KHANGCAO> khangCaos = dt.ALD_SOTHAM_KHANGCAO.Where(x => x.DONID == oldVuAnId && x.TINHTRANG_GIAIQUYET == 1 && x.LOAIKHANGCAO == 2).ToList();
                                    if (khangCaos != null && khangCaos.Count > 0)
                                    {
                                        foreach (ALD_SOTHAM_KHANGCAO kc in khangCaos)
                                        {
                                    ...
                                    List<ALD_SOTHAM_KHANGNGHI> khangNghis = dt.ALD_SOTHAM_KHANGNGHI.Where(x => x.DONID == oldVuAnId && x.TINHTRANG_GIAIQUYET == 1 && x.LOAIKN == 2).ToList();
                                    if (khangNghis != null && khangNghis.Count > 0)
                                    {
                                        foreach (ALD_SOTHAM_KHANGNGHI kn in khangNghis)
                                        {
                                ...
                                {
                                    #region toancau - anhnt update lại kết quả kháng cáo/kháng nghị
                                    List<ALD_SOTHAM_KHANGCAO> khangCaos = dt.ALD_SOTHAM_KHANGCAO.Where(x => x.DONID == oldVuAnId && x.TINHTRANG_GIAIQUYET == 1 && x.LOAIKHANGCAO == 2 && x.NGAYTAO >= ObjNhanAnLanGanCuoi.NGAYTAO && x.NGAYTAO <= ObjNhanAnLanCuoi.NGAYTAO).ToList();
                                    if (khangCaos != null && khangCaos.Count > 0)
                                    {
                                        foreach (ALD_SOTHAM_KHANGCAO kc in khangCaos)
                                        {
                                    ...
                                    List<ALD_SOTHAM_KHANGNGHI> khangNghis = dt.ALD_SOTHAM_KHANGNGHI.Where(x => x.DONID == oldVuAnId && x.TINHTRANG_GIAIQUYET == 1 && x.LOAIKN == 2 && x.NGAYTAO >= ObjNhanAnLanGanCuoi.NGAYTAO && x.NGAYTAO <= ObjNhanAnLanCuoi.NGAYTAO).ToList();
                                    if (khangNghis != null && khangNghis.Count > 0)
                                    {
                                        foreach (ALD_SOTHAM_KHANGNGHI kn in khangNghis)
                                        {
