        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    oND = dt.ALD_DON_DUONGSU.Where(x => x.ID == ID && x.ISDONCHITIET == 1).FirstOrDefault();
                }
                ...
                if (chkBD_IsNguoitantat.Visible)
                    oND.ISNGUOITANTAT = chkBD_IsNguoitantat.Checked ? 1 : 0;
                else
                    oND.ISNGUOITANTAT = 0;
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    // quyennd
                    if (ObjDon_ChiTiet.TOA_GIAIQUYET_ID == null) 
                        ObjDon_ChiTiet.TOA_GIAIQUYET_ID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
