<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pDuongSuDonCha.ascx.cs" Inherits="WEB.GSTP.QLAN.ALD.Hoso.Popup.pDuongSuDonCha" %>
...
<script>
    function popup_edit_duongsu(DuongSuID) {
        ...
        var link = "";
        if (DuongSuID > 0)
            link = "Popup/pDuongsuDonCha.aspx?hsID=<%=DonID%>&bID=" + DuongSuID;
        else
            link = "Popup/pDuongsuDonCha.aspx?hsID=<%=DonID%>";
        var width = 950;
        var height = 400;
