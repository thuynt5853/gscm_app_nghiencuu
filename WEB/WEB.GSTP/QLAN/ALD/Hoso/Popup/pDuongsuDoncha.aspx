<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pDuongsuDoncha.aspx.cs" Inherits="WEB.GSTP.QLAN.ALD.Hoso.Popup.pDuongsuDoncha" %>
                        ...
                        <div class="boxchung">
                            ...
                            <div class="boder" style="padding: 10px;">
                                ...
                                <table class="table1">
                                    ...
                                    <tr>
                                        <%-- GTEL-HUNGNQ 10-10-2025 bỏ <span class="batbuoc">(*)</span> dùng code ẩn hiện --%>
                                    ...
                                    <tr>
                                        <td colspan="4" align="center">
                                            ...
                                            <input type="button" class="buttoninput" onclick="window.opener.location.reload(); window.close();" value="Đóng" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
