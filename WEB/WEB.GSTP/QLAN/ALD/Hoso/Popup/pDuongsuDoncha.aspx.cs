...
{
    public partial class pDuongsuDoncha : System.Web.UI.Page
    {
        ...
        protected void chkBoxCMNDND_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                ltCCCDND.Text = ltCMNDND.Text = "<span style='color:red'>(*)</span>";
            }
            else
            {
                ltCCCDND.Text = ltCMNDND.Text = "";
            }
        ...
        private bool CheckValid()
        {
            ...
            // GTEL-HUNGNQ 10-10-2025 check CCCD
            if (!chkBoxCMNDND.Checked)
            {
                ...
                if (!string.IsNullOrEmpty(txtND_CMND.Text) && txtND_CMND.Text.Length < 8)
                {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (chkBD_IsNguoitantat.Visible)
                    oND.ISNGUOITANTAT = chkBD_IsNguoitantat.Checked == true ? 1 : 0;
                else
                    oND.ISNGUOITANTAT = 0;
                oND.LOAIDUONGSU = Convert.ToDecimal(ddlLoaiNguyendon.SelectedValue);
                // VNPT - NGuyễn Đăng HUy Hoàng 11/11/2025 : 11:00:00
                // sửa trường lưu số cccd phục vụ tống đạt
                oND.SOCMND = txtND_CMND.Text;
                oND.SO_CCCD = txtND_CMND.Text;
        ...
        public void loadedit(decimal ID)
        {
            ...
            if (oND.ISNGUOITANTAT != null) chkBD_IsNguoitantat.Checked = oND.ISNGUOITANTAT == 1 ? true : false;
            ...
            if (quocTich == "2")
            {
                ...
                else
                {
                    ...
                    if (DuongSuID > 0)
                    {
                        ...
                        ALD_DON_DUONGSU ds = dt.ALD_DON_DUONGSU.Where(x => x.ID == DuongSuID).First();
                        if (ds != null)
                        {
