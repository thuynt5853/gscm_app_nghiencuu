                                ...
                                try {{
                                    if (window.opener && !window.opener.closed) {{
                                        ...
                                        function setRadio(id, val) {{
                                            var radios = window.opener.document.querySelectorAll('#' + id +' input[type=""radio""]');
                                            let value = val;//value you want to compare radio with
                                        ...
                                        if (caller === 'DuongSu') {{
                                            ...
                                            setRadio('ddlND_Gioitinh', '{gioiTinh}');
                                            ...
                                            setRadio('ddlBD_Gioitinh', '{gioiTinh}');
