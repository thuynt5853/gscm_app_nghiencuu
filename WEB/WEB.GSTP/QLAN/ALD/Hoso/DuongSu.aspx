<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="DuongSu.aspx.cs" Inherits="WEB.GSTP.QLAN.ALD.Hoso.DuongSu" %>
        ...
        <div class="box_nd">
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            <td style="width: 105px;">Tư cách tố tụng<span class="batbuoc">(*)</span></td>
                            <td style="width: 260px;">
                                <asp:DropDownList ID="ddlTucachTotung" CssClass="chosen-select" runat="server" Width="250px"></asp:DropDownList>
                            </td>
                            <td style="width: 90px;">Đương sự là<span class="batbuoc">(*)</span></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <asp:CheckBox ID="chkND_IsNguoitantat" runat="server" Text="Người lao động là người tàn tật" />
                        ...
                        <tr>
                            ...
                            <asp:Panel ID="pnNuocNgoai" runat="server">
                                <td colspan="2">
                        ...
                        <tr>
                            <td></td>
                            <td colspan="2">
                                <asp:CheckBox ID="chkKhongLamSach" AutoPostBack="true" runat="server" Text="Nguyên đơn Không thể làm sạch được"/> 
                            </td>
                        </tr>
                        <asp:Panel ID="pnNDCanhan" runat="server">
                            <tr>
                                ...
                                <td>
                                    <asp:RadioButtonList ID="ddlND_Gioitinh" ClientIDMode="Static" AutoPostBack="true" Width="200px"
                                ...
                                <td>Ngày sinh</td>
                                <td>
                                    <asp:TextBox ID="txtND_Ngaysinh" ClientIDMode="Static" runat="server" CssClass="user" Width="65px" MaxLength="10" AutoPostBack="True" OnTextChanged="txtND_Ngaysinh_TextChanged"></asp:TextBox>
                                    ...
                                    Tuổi <asp:TextBox ID="txtND_Tuoi" CssClass="user" onkeypress="return isNumber(event)" runat="server" Width="20px" MaxLength="2"></asp:TextBox>
