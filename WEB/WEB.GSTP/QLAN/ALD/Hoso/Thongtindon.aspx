<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Thongtindon.aspx.cs" Inherits="WEB.GSTP.QLAN.ALD.Hoso.Thongtindon" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/QLAN/ALD/Hoso/Popup/pDuongSuDonCha.ascx" TagPrefix="uc1" TagName="DsHNDuongSu" %>
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlCanbonhandon" CssClass="chosen-select" runat="server" Width="250px" OnSelectedIndexChanged="ddlCanbonhandon_SelectedIndexChanged">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="ddlOldCanbonhandon" CssClass="chosen-select" runat="server" Width="250px" Enabled="false"></asp:DropDownList>
                                </td>
                        ...
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:CheckBox ID="chkND_ONuocNgoai" AutoPostBack="true" runat="server" Text="Có yếu tố nước ngoài" OnCheckedChanged="chkBD_ONuocNgoai_CheckedChanged" />
                                </td>
                            </tr>
                            ...
                            <asp:Panel ID="pnNDCanhan" runat="server">
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadioButtonList ID="ddlND_Gioitinh" ClientIDMode="Static" Width="200px"
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:CheckBox ID="chkBD_IsNguoitantat" runat="server" Text="Người lao động là người tàn tật" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlBD_Quoctich" ClientIDMode="Static" CssClass="chosen-select" runat="server" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlBD_Quoctich_SelectedIndexChanged"></asp:DropDownList>
                            ...
                            <asp:Panel ID="pnBD_Canhan" runat="server">
                                <tr>
                                    ...
                                    <td>Giới tính<span class="batbuoc">(*)</span></td>
                                    <td>
                                        <asp:RadioButtonList ID="ddlBD_Gioitinh" ClientIDMode="Static" AutoPostBack="true" Width="200px"
                                            runat="server" RepeatDirection="Horizontal">
                                             <asp:ListItem Value="0" Text="Chọn" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="1" Text="Nam"></asp:ListItem>
                                            <asp:ListItem Value="2" Text="Nữ"></asp:ListItem>
                                    ...
                                    <td>Ngày sinh</td>
                                    <td>
                                        <asp:TextBox ID="txtBD_Ngaysinh" ClientIDMode="Static" runat="server" CssClass="user" Width="65px" MaxLength="10" AutoPostBack="True" OnTextChanged="txtBD_Ngaysinh_TextChanged"></asp:TextBox>
