<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="NguoiThamgiaTT.aspx.cs" Inherits="WEB.GSTP.QLAN.ALD.Hoso.NguoiThamgiaTT" %>
            ...
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    ...
                    <asp:Panel ID="pnItemDs" runat="server">
                        <table class="table1">
                            <tr>
                                <td style="width: 178px">Đại diện cho</td>
