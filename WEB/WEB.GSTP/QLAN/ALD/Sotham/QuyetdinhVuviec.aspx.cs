    ...
    public partial class QuyetdinhVuviec : System.Web.UI.Page
    {
        ...
        private void CheckQuyen(decimal ID)
        {
            ...
            else
            {
                ...
                ALD_SOTHAM_BANAN banAn = dt.ALD_SOTHAM_BANAN.Where(x => x.DONID == ID).FirstOrDefault();
                if (banAn != null)
                {
                ...
                ALD_SOTHAM_QUYETDINH qdKetThuc = dt.ALD_SOTHAM_QUYETDINH.Where(x => x.DONID == ID && dmQDIds.Contains(x.QUYETDINHID.Value)).FirstOrDefault();
                if (qdKetThuc != null)
                {
                ...
                {
                    ALD_SOTHAM_KHANGCAO kc2 = dt.ALD_SOTHAM_KHANGCAO.Where(x => x.DONID == ID  && x.TINHTRANG_GIAIQUYET != 2).FirstOrDefault();
                    if (kc2 != null)
                    {
                        lbthongbao.Text = "Vụ việc đã có kháng cáo. Không được sửa đổi.";
                        Cls_Comon.SetButton(cmdUpdate, false);
                ...
                {
                    ALD_SOTHAM_KHANGNGHI kn2 = dt.ALD_SOTHAM_KHANGNGHI.Where(x => x.DONID == ID && x.TINHTRANG_GIAIQUYET != 3).FirstOrDefault();
                    if (kn2 != null)
                    {
                        lbthongbao.Text = "Vụ việc đã có kháng nghị. Không được sửa đổi.";
                        Cls_Comon.SetButton(cmdUpdate, false);
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (don.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM || don.MAGIAIDOAN == ENUM_GIAIDOANVUAN.THULYGDT)
                {
                    ...
                    ALD_DON_GIAIDOAN checkGD = dt.ALD_DON_GIAIDOAN.Where(x => x.DONID == DONID && x.MAGIAIDOAN == 3).FirstOrDefault();
                    //
                    if (checkGD != null)
                    {
                ...
                ALD_SOTHAM_KHANGCAO kc = dt.ALD_SOTHAM_KHANGCAO.Where(x => (x.LOAIKHANGCAO == 2 || x.LOAIKHANGCAO == 1) && x.SOQDBA == QDID).FirstOrDefault();

                ALD_SOTHAM_KHANGNGHI kn = dt.ALD_SOTHAM_KHANGNGHI.Where(x => (x.LOAIKN == 2 || x.LOAIKN == 1) && x.BANANID == QDID).FirstOrDefault();
                if (kc != null || kn != null)
                {
                    lblSua.Text = "Chi tiết";
                    lbtXoa.Visible = false;
        ...
        private void LoadQD()
        {
            ...
            DataTable oDT = oBL.ALD_DM_QUYETDINH_VUAN();
        ...
        private void LoadNguoiKyInfo()
        {
            ...
            ALD_SOTHAM_HDXX oND = dt.ALD_SOTHAM_HDXX.Where(x => x.DONID == DonID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).OrderByDescending(x => x.ID).FirstOrDefault<ALD_SOTHAM_HDXX>();
            if (oND != null)
            {
            ...
            {
                ALD_DON_THAMPHAN oTP = dt.ALD_DON_THAMPHAN.Where(x => x.DONID == DonID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETSOTHAM).FirstOrDefault();
                if (oTP != null)
                {
        ...
        private void ResetControls()
        {
            ...
            //---------29/11/2025----  locbx - quyết định triệu tập đương sự
        ...
        private bool CheckValid()
        {
            ...
            //---------29/11/2025---- locbx vnpt - quyết định triệu tập đương sự
        ...
        void SetNewSoQD()
        {
            ...
            if (!String.IsNullOrEmpty(txtNgayQD.Text))
                ...
                ngayBD = DateTime.Now;
            txtSoQD.Text = oSTBL.GET_SQD_NEW(DonViID, "ALD", ngayBD, LoaiQD).ToString();
        }
        ...
        public void LoadGrid()
        {
            ...
            string current_id = Session[ENUM_LOAIAN.AN_LAODONG] + "";
            decimal ID = Convert.ToDecimal(current_id);
            DataTable oDT = oBL.ALD_SOTHAM_QUYETDINH_KHONGKETTHUC_GETLIST(ID);
        ...
        public void xoa(decimal id)
        {
            ...
            ALD_DON_BL oBL = new ALD_DON_BL();
            if (oBL.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oND.DONID), 5, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Quyết định Sơ thẩm án Lao động", "Xóa", json) == false)
            {
                lbthongbao.Text = "Xóa không thành công!";
                return;
            }//Ket thuc
             // khong duoc xoa khi da Tong dat - 29/11/2025 vnpt check
            ALD_TONGDAT oTD = dt.ALD_TONGDAT.Where(x => x.DONID == oND.DONID && x.MAPID == id && x.MAP_TABLE == ENUM_MAP_TABLE.ALD_SOTHAM_QUYETDINH).FirstOrDefault();
            if (oTD != null)
            {
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Xoa":
                    ...
                    if (tenQD.Value.Equals("53-DS. Quyết định sửa chữa, bổ sung bản án") || tenQD.Value.Contains("47-DS"))
                    {
        ...
        {
            decimal ID = Convert.ToDecimal(hddid.Value);
            ALD_SOTHAM_QUYETDINH oQD = dt.ALD_SOTHAM_QUYETDINH.Where(x => x.ID == ID).FirstOrDefault();
        ...
        protected void ddlQuyetdinh_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (oT != null)
            {
                ...
                //Load số quyêt định với các loại QD LD sau
        ...
        void LoadDropDuongSu()
        {
            ...
            string current_id = Session[ENUM_LOAIAN.AN_LAODONG] + "";
            decimal ID = Convert.ToDecimal(current_id);
            DataTable obj = oBL.ALD_DON_DSDUONGSU_GETBY(ID);
            lbxDuongSu.Items.Clear();
            if (obj != null)
            {
        ...
        protected void LoadDuongSuBiYC()
        {
            ...
            decimal DonID = Session[ENUM_LOAIAN.AN_LAODONG] + "" == "" ? 0 : Convert.ToDecimal(Session[ENUM_LOAIAN.AN_LAODONG]);
            //Lấy tất cả bị đơn
            List<ALD_DON_DUONGSU> lstDS = dt.ALD_DON_DUONGSU.Where(x => x.DONID == DonID && x.TUCACHTOTUNG_MA == "BIDON").OrderBy(x => x.TENDUONGSU).ToList<ALD_DON_DUONGSU>();
            ddlNguoiBiYC.DataSource = lstDS;
            ddlNguoiBiYC.DataTextField = "TENDUONGSU";
            ddlNguoiBiYC.DataValueField = "ID";
            ddlNguoiBiYC.DataBind();
