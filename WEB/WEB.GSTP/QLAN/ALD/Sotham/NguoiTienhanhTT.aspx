<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="NguoiTienhanhTT.aspx.cs" Inherits="WEB.GSTP.QLAN.ALD.Sotham.NguoiTienhanhTT" %>
        ...
        <div class="box_nd">
            <div class="boxchung">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            <td style="width: 147px;">Vai trò tham gia tố tụng<span class="batbuoc">(*)</span></td>
                        ...
                        <asp:Panel ID="pnPhancong" runat="server">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtNgayphancong" runat="server" CssClass="user" Width="100px" MaxLength="10"></asp:TextBox>
                                ...
                                <td>
                                    <asp:TextBox ID="txtNhanphancong" runat="server" CssClass="user" Width="100px" MaxLength="10"></asp:TextBox>
