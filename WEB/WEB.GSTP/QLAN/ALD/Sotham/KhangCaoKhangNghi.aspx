<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="KhangCaoKhangNghi.aspx.cs" Inherits="WEB.GSTP.QLAN.ALD.Sotham.KhangCaoKhangNghi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtAnphi" runat="server"
                                                ...
                                                CssClass="user" Width="100px" onkeyup="javascript:this.value=Comma(this.value);" onkeypress="return isNumber(event)"></asp:TextBox>
                                        </td>
                                        <td>Ngày nộp án phí</td>
                                        <td>
                                            <asp:TextBox ID="txtNgaynopanphi" runat="server" CssClass="user" Width="90px" MaxLength="10" onkeypress="return isNumber(event)"></asp:TextBox>
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtNgaykhangnghi" runat="server" CssClass="user" Width="90px" MaxLength="10" onkeypress="return isNumber(event)"></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        function popup_loaddonkc_bc(DonID, NGUOIKC) {
            var link = "/QLAN/ALD/Sotham/Popup/pChonDonKC.aspx?ID=" + DonID + "&KCID=" + NGUOIKC;
            var width = 800;
            var height = 900;
