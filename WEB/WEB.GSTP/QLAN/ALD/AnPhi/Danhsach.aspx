<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Danhsach.aspx.cs" Inherits="WEB.GSTP.QLAN.ALD.AnPhi.Danhsach" %>
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td style="width: 175px;">
                                    <asp:TextBox ID="txtGiaTriTranhChap" runat="server" Enabled="false"
                                        CssClass="user align_right" Width="150px" onkeypress="return isNumber(event)"
                                        onkeyup="javascript:this.value=Comma(this.value);"></asp:TextBox>
                                </td>
                                <td style="width: 120px;">Mức giảm án phí</td>
                                <td>
                                    <asp:TextBox ID="txtMucGiamAnPhi" runat="server" CssClass="user align_right" Width="185px"
                                        Enabled="false" onkeyup="javascript:this.value=Comma(this.value);"
                            ...
                            <tr>
                                <td>Án phí</td>
                                <td>
                                    <asp:TextBox ID="txtAnPhi" runat="server" CssClass="user align_right" Width="150px" Enabled="false"
                                        onkeyup="javascript:this.value=Comma(this.value);" onkeypress="return isNumber(event)"></asp:TextBox>
                                </td>
                                <td>Tạm ứng án phí</td>
                                <td>
                                    <asp:TextBox ID="txtTamUngAnPhi" runat="server" CssClass="user align_right" Enabled="false"
                                        onkeyup="javascript:this.value=Comma(this.value);" Width="185px" onkeypress="return isNumber(event)"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Hạn nộp</td>
