<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="DuongSu.aspx.cs" Inherits="WEB.GSTP.QLAN.AHC.Hoso.DuongSu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        <tr>
                            ...
                            <td style="width: 110px;">Tư cách tố tụng<span class="batbuoc">(*)</span></td>
                            <td>
                                <asp:DropDownList ID="ddlTucachTotung" CssClass="chosen-select" runat="server"
                                    Width="250px" AutoPostBack="true" OnSelectedIndexChanged="ddlTucachTotung_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtND_CMND" ClientIDMode="Static" CssClass="user" runat="server" Width="242px" MaxLength="250"></asp:TextBox></td>
                            <td>Hộ chiếu
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <asp:CheckBox ID="chkKhongLamSach" AutoPostBack="true" runat="server" Text="Không thể làm sạch được" />
                            </td>
                        </tr>
                        <asp:Panel ID="pnNDCanhan" runat="server">
                            <tr>
                                ...
                                <td>
                                    ...
                                    Năm sinh<asp:Literal ID="lttBBNamSinh" runat="server" Text="<span class='batbuoc'>(*)</span>" Visible="false"></asp:Literal>
                                    <%----%>
                            ...
                            <%-- <tr>
                                <td>Thường trú<asp:Label ID="lblBatbuoc1" runat="server" ForeColor="Red" Text="(*)"></asp:Label></td>
                                <td >
                                    <asp:DropDownList ID="ddlThuongTruTinh" CssClass="chosen-select" runat="server" Width="123px" AutoPostBack="true" OnSelectedIndexChanged="ddlThuongTruTinh_SelectedIndexChanged"></asp:DropDownList>
                                    <asp:DropDownList ID="ddlThuongTruHuyen" CssClass="chosen-select" runat="server" Width="123px"></asp:DropDownList>
                                </td>
                                <td>Chi tiết</td>
                                <td>
                            ...
                            <tr>
                                <td>Nơi cư trú<asp:Label ID="lblBatbuoc2" runat="server" ForeColor="Red" Text="(*)"></asp:Label></td>
                                <td>
                                    <asp:DropDownList ID="ddlNoiSongTinh" ClientIDMode="Static" CssClass="chosen-select" runat="server" Width="123px" AutoPostBack="true" OnSelectedIndexChanged="ddlNoiSongTinh_SelectedIndexChanged"></asp:DropDownList>
                                    <asp:DropDownList ID="ddlNoiSongHuyen" ClientIDMode="Static" CssClass="chosen-select" runat="server" Width="123px"></asp:DropDownList>
                                </td>
                                <td>Chi tiết</td>
                                <td>
                            ...
                            <tr>
                                <td>Nơi làm việc</td>
                                <td colspan="3">
                                    <asp:TextBox ID="txt_NoiLamViec" CssClass="user" runat="server" Width="590px" MaxLength="500"></asp:TextBox>
                                </td>
                            </tr>
                        </asp:Panel>
                        <tr>
                                ...
                                <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate><%#Eval("XACTHUC_DLDCQG_TEN") %> </ItemTemplate>
                                        </asp:TemplateColumn>
    ...
    <script type="text/javascript">
        function validate() {
            var tucachtt_nvlq = "QUYENNVLQ";
            var tucachtt_bidon = "BIDON";

            var ddlLoaiNguyendon = document.getElementById('<%=ddlLoaiNguyendon.ClientID%>');
                    var loai_nguyen_don = ddlLoaiNguyendon.options[ddlLoaiNguyendon.selectedIndex].value;
                    if (loai_nguyen_don == "1") {
                        //ca nhan
                    }


                    var ddlTucachTotung = document.getElementById('<%=ddlTucachTotung.ClientID%>');
                    var value_change = ddlTucachTotung.options[ddlTucachTotung.selectedIndex].value;

                    //---------------------------            
                    var txtTennguyendon = document.getElementById('<%=txtTennguyendon.ClientID%>');
                    if (!Common_CheckTextBox(txtTennguyendon, "Tên đương sự")) {
                        return false;
                    }
                    //---------------------------
                    var txtND_Namsinh = document.getElementById("<%= txtND_Namsinh.ClientID %>");
                    if (value_change != tucachtt_nvlq && value_change != tucachtt_bidon) {
                ...
                var namsinh = parseInt(txtND_Namsinh.value);
