<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pDuongsu.aspx.cs" Inherits="WEB.GSTP.QLAN.AHC.Hoso.Popup.pDuongsu" %>
                                    ...
                                    <asp:Panel ID="pnNDCanhan" runat="server">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                Năm sinh
                                        <asp:TextBox ID="txtND_Namsinh" CssClass="user" onkeypress="return isNumber(event)" runat="server" Style="width: 83px; text-align: right;" MaxLength="4"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td colspan="3">
                                                <asp:CheckBox ID="chkONuocNgoai" Text="Có yếu tố nước ngoài" 
                                                    AutoPostBack="true" runat="server" OnCheckedChanged="chkONuocNgoai_CheckedChanged" />
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Nơi làm việc</td>
                                            <td>
                                                <asp:TextBox ID="txt_NoiLamViec" CssClass="user" runat="server" Width="242px" MaxLength="500"></asp:TextBox>
                                            </td>
                                            <td>Chức vụ</td>
                                            <td>
                                                <asp:TextBox ID="txtND_ChucVu" CssClass="user" runat="server" Width="242px" MaxLength="250"></asp:TextBox></td>
                                        </tr>
                                    </asp:Panel>
                                    <tr>
                                        <td>Email</td>
