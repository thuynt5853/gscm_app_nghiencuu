...
namespace WEB.GSTP.QLAN.AHC.Hoso.Popup
{
    public partial class pDuongSuDonCha : System.Web.UI.UserControl
    {
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AHC_DON_DUONGSU_NOTDAIDIEN_DONCHA(DonID);
        ...
        protected void lkThemNguoiTGTT_Click(object sender, EventArgs e)
        {
            ...
            string StrMsg = "PopupCenter('/QLAN/AHC/Hoso/Popup/pDuongsuDonCha.aspx?hsID=" + DonID.ToString() + "&bID=0','Thêm đương sự',950,450);";
