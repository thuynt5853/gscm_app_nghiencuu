<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pGetDuongSu037.aspx.cs" Inherits="WEB.GSTP.QLAN.AHC.Hoso.Popup.pGetDuongSu037" %>


<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%-- GTEL-HUNGNQ 01-10-2025 form C06 cho AHC --%>
...
<body>
    <form id="form1" runat="server">
        <div style="width: 100%; margin: auto; padding: 20px;">
            ...
            <div class="form-group checkbox-large"><asp:CheckBox ID="chkDiaChiHuyen" runat="server" /><label>Huyện:</label><asp:Label ID="lblHuyen" runat="server" Text="" /></div>
            ...
            <div class="group-title">3. Quê quán</div>
            <div class="form-group checkbox-large"><asp:CheckBox ID="CheckBox1" runat="server" Enabled ="false" /><label>Tỉnh:</label><asp:Label ID="lblQueQuanTinh" runat="server" Text="" /></div>
            <div class="form-group checkbox-large"><asp:CheckBox ID="CheckBox2" runat="server" Enabled ="false" /><label>Huyện:</label><asp:Label ID="lblQueQuanXa" runat="server" Text="" /></div>
            <div class="form-group checkbox-large"><asp:CheckBox ID="CheckBox3" runat="server" Enabled ="false" /><label>Địa chỉ chi tiết:</label><asp:Label ID="lblQueQuanChiTiet" runat="server" Text="" /></div>
            
            <div class="group-title">4. Thường trú</div>
            <div class="form-group checkbox-large"><asp:CheckBox ID="CheckBox4" runat="server" Enabled ="false" /><label>Tỉnh:</label><asp:Label ID="lblThuongTruTinh" runat="server" Text="" /></div>
            <div class="form-group checkbox-large"><asp:CheckBox ID="CheckBox5" runat="server" Enabled ="false" /><label>Huyện:</label><asp:Label ID="lblThuongTruXa" runat="server" Text="" /></div>
            <div class="form-group checkbox-large"><asp:CheckBox ID="CheckBox6" runat="server" Enabled ="false" /><label>Địa chỉ chi tiết:</label><asp:Label ID="lblThuongTruChiTiet" runat="server" Text="" /></div>
