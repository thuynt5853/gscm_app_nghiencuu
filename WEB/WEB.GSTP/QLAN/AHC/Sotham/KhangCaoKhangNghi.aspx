<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="KhangCaoKhangNghi.aspx.cs" Inherits="WEB.GSTP.QLAN.AHC.Sotham.KhangCaoKhangNghi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtNgaykhangcao"
                                        AutoPostBack="true" OnTextChanged="txtNgaykhangcao_TextChanged"
                                        runat="server" CssClass="user" Width="90px" MaxLength="10"></asp:TextBox>
                        ...
                        <div class="boxchung">
                            ...
                            <div class="boder" style="padding: 10px;">
                                <table class="table1">
                                    <tr>
                                        <td style="width: 123px;">Miễn án phí<span class="batbuoc">(*)</span></td>
                                        ...
                                        <td class="KCHNCol3">Số biên lai</td>
                                        <td>
    ...
    <script type="text/javascript">
        ...
        function popup_loaddonkc_bc(DonID, NGUOIKC) {
            var link = "/QLAN/AHC/Sotham/Popup/pChonDonKC.aspx?ID=" + DonID + "&KCID=" + NGUOIKC;
            var width = 800;
            var height = 900;
