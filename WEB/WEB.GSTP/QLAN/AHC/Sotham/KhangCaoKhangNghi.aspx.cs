    ...
    public partial class KhangCaoKhangNghi : System.Web.UI.Page
    {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (IsKhangCao == 1)
                {
                    AHC_SOTHAM_KHANGCAO oKC = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.ID == idKCKN).FirstOrDefault();
                    if (oKC != null)
                    {
                        ...
                        string Result = new AHC_CHUYEN_NHAN_AN_BL().Check_ChuyenNhanAn(DONID, StrMsg, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]));
                        if (Result == "")
                        {
                ...
                {
                    AHC_SOTHAM_KHANGNGHI oKN = dt.AHC_SOTHAM_KHANGNGHI.Where(x => x.ID == idKCKN).FirstOrDefault();
                    if (oKN != null)
                    {
        ...
        private void LoadComboboxKhangCao()
        {
            ...
            ddlNguoikhangcao.DataSource = oDSBL.AHC_DUONGSU_KHANGCAO(DonID);
            ...
            string hoten = "";
            List<AHC_DON_THAMGIATOTUNG> lst = dt.AHC_DON_THAMGIATOTUNG.Where(x => x.DONID == DonID).ToList();
        ...
        void LoadDrop_ST_BanAn(DropDownList drop, Decimal DonID)
        {
            ...
            DataTable oDT = oBL.DANHSACH_KHANGCAO_BANAN(ENUM_LOAIVUVIEC_NUMBER.AN_HANHCHINH, DonID);
            if (oDT != null)
            {
                drop.DataSource = oDT;
        ...
        void LoadDrop_ST_QuyetDinh(DropDownList drop, Decimal DonID, Decimal loaiKC)
        {
            ...
            {
                PAGE_KHANGCAO_ST oBL = new PAGE_KHANGCAO_ST();
                DataTable oDT = oBL.DANHSACH_KHANGCAO_QUYETDINH(ENUM_LOAIVUVIEC_NUMBER.AN_HANHCHINH, DonID);
                if (oDT != null)
                {
                    drop.DataSource = oDT;
                    drop.DataTextField = "TEN";
            ...
            {
                PAGE_KHANGCAO_ST oBL = new PAGE_KHANGCAO_ST();
                DataTable oDT = oBL.DANHSACH_KHANGCAO_QUYETDINH_KHAC(ENUM_LOAIVUVIEC_NUMBER.AN_HANHCHINH, DonID);
                if (oDT != null)
                {
                    drop.DataSource = oDT;
                    drop.DataTextField = "TEN";
            ...
            try
            {
                ...
                switch (e.CommandName)
                {
                    case "Download":
                        ...
                        if (IsKhangCao == 1)
                        {
                            AHC_SOTHAM_KHANGCAO oKN = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.ID == ID).FirstOrDefault();
                            TENFILE = oKN.TENFILE;
                    ...
                    case "Xoa":
                        ...
                        AHC_SOTHAM_KHANGCAO oKC = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.DONID == DonID && x.ID == ID).FirstOrDefault();
                        if (Result != "")
                        {
                            if (oKC.ISQUAHAN == 1)
                            {
            ...
            try
            {
                ...
                if (IsKhangCao == KHANGCAO)// Kháng cáo
                {
                    ...
                    if (oND != null)
                    {
                        ...
                        AHC_ANPHI oAP = dt.AHC_ANPHI.Where(x => x.DONID == oND.DONID && x.DUONGSU_IDS == DuongSuID && x.MAGIAIDOAN == 3).FirstOrDefault();
                        if (oAP != null)
                        {
        ...
        public void xoa(decimal ID, decimal IsKhangCao)
        {
            if (IsKhangCao == KHANGCAO)// Kháng cáo
            {
                ...
                String DuongSuID = oND.DUONGSUID.ToString();
                AHC_ANPHI objAP = dt.AHC_ANPHI.Where(x => x.DONID == DonID && x.DUONGSU_IDS == DuongSuID && x.MAGIAIDOAN == 3).FirstOrDefault();
                if (objAP != null)
                {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                decimal ID = 0, IsKhangCao = 0, DonID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HANHCHINH] + "");
                AHC_DON oDon = dt.AHC_DON.Where(x => x.ID == DonID).FirstOrDefault();
                if (rdbPanelKC.SelectedValue == KHANGCAO.ToString() && rdbPanelKN.SelectedValue == KHANGCAO.ToString())// Kháng cáo
                {
                    ...
                    {
                        AHC_ANPHI lstAPnew = new AHC_ANPHI();
        ...
        protected void rdbPanelKC_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else // Kháng nghị
            {
                ...
                DON_KHAC oD = dt.DON_KHAC.Where(x => x.DONID == DonID && x.LOAIANID == 6 && x.LOAIKCKN == 2).FirstOrDefault();
        ...
        protected void cmdLoadDonKhac_Click(object sender, EventArgs e)
        {
            ...
            DON_KHAC oD = dt.DON_KHAC.Where(x => x.ID == ID && x.LOAIANID == 6 && x.LOAIKCKN == 1).FirstOrDefault();
            if (oD != null)
            {
                pnKhangCao.Visible = true;
                pnKhangNghi.Visible = false;
        ...
        void CheckNgayKCQuaHan()
        {
            ...
            if (banan_qd_id > 0)
            {
                if (loai_ba_qd == 0)
                {
                    ...
                    AHC_SOTHAM_BANAN obj = dt.AHC_SOTHAM_BANAN.Where(x => x.ID == banan_qd_id).FirstOrDefault();
                    if (obj != null)
                ...
                else
                {
                    ...
                    AHC_SOTHAM_QUYETDINH obj = dt.AHC_SOTHAM_QUYETDINH.Where(x => x.ID == banan_qd_id).FirstOrDefault();
                    if (obj != null)
                    {
