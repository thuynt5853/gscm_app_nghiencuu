<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Hoagiai.aspx.cs" Inherits="WEB.GSTP.QLAN.AHC.Sotham.Hoagiai" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="box">
        <div class="box_nd">
            <div class="boxchung">
                <h4 class="tleboxchung">Thông báo về việc tiếp cận công khai chứng cứ và đối thoại</h4>
                        ...
                        <tr>
                            ...
                            <td style="width: 300px;">
                                <asp:DropDownList ID="ddlLoaithongbao" CssClass="chosen-select" runat="server" Width="300px">
                                    <asp:ListItem Value="1" Text="Thông báo kiểm tra giao nộp chứng cứ và đối thoại"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="Thông báo hoãn kiểm tra giao nộp chứng cứ và đối thoại"></asp:ListItem>
                                </asp:DropDownList></td>
    ...
    <script type="text/javascript">
        function validate()
        {
            ...
            if (!CheckDateTimeControl_KoSoSanhNgayHienTai(txtNgaythongbao, 'Ngày thông báo'))
                return false;
