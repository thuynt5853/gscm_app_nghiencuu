...
namespace WEB.GSTP.QLAN.AHC.XuLyDon.Popup
{
    public partial class pBoSungTaiLieu : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    DataTable obj = aDXL.AHC_GETALL_DON_YCBS(Convert.ToDecimal(DONID), xuLyID, 1, 20);
                    ...
                    AHC_DON_XULY donXL = dt.AHC_DON_XULY.Where(x => x.ID == xuLyID).FirstOrDefault();
        ...
        protected void cmdCapNhat_Click(object sender, EventArgs e)
        {
            ...
            decimal xuLyID = (String.IsNullOrEmpty(Request["ID"] + "")) ? 0 : Convert.ToDecimal(Request["ID"] + "");
            AHC_DON_XULY oXuLy = dt.AHC_DON_XULY.Where(x => x.ID == xuLyID).FirstOrDefault();
            string bienphap = dropBienPhapGQ.SelectedValue;
            AHC_DON oDon = dt.AHC_DON.Where(x => x.ID == DONID).FirstOrDefault();
            ...
            DataTable checkGQ = oBLYC.CHECK_NGAYGQ_DON_YCBS(obj.ID, xuLyID, 6, txtNgayGQ.Text);
            ...
            switch (bienphap)
            {
                ...
                default://Thụ lý
                    ...
                    rFileID = UploadFileID(oDon, FileID, "04-HC", "", "");
                    if (rFileID > 0) obj.FILEID = rFileID;
            ...
            AHC_DON_XULY objXuLy = dt.AHC_DON_XULY.Where(x => x.ID == obj.DON_XULY_YCBS_ID).FirstOrDefault();
            ...
            DataTable oDT = oBLYC.AHC_GETALL_DON_YCBS(DONID, objXuLy.ID, 1, 1);
            ...
            DataTable objYCBS = oBLYC.AHC_GETALL_DON_YCBS(Convert.ToDecimal(DONID), obj.DON_XULY_YCBS_ID.Value, 1, 20);
            validateEnableButtonLuu(objYCBS);

            lbtthongbao.Text = "Lưu thành công!";
            //ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Lưu thành công!');OnClose();", true);
        }
            ...
            else
            {
                ...
                if (oDonNew != null)
                {
                    if (oDonNew.TOAANID.Value != obj.CDTN_TOAANID)
                    {
                        ...
                        GIAI_DOAN_BL GD = new GIAI_DOAN_BL();
                        GD.GAIDOAN_UPDATE("6", oDonNew.ID, 2, Convert.ToDecimal(oDonNew.TOAANID), 0, 0, 0, 0);
                    }
                }
        ...
        protected void Reset()
        {
            ...
            DataTable donYCBS = oBLYC1.AHC_GETALL_DON_YCBS(Convert.ToDecimal(DONID), xuLyID, 1, 20);
        ...
        protected void dgDS_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Xoa":
                    ...
                    AHC_DON_XULY_BL oBLDel = new AHC_DON_XULY_BL();
                    ...
                    DataTable obj = oBLDel.AHC_GETALL_DON_YCBS(Convert.ToDecimal(DONID), ID_DON_YCBS, 1, 20);
                    if (e.Item.ItemIndex == 0 && obj.Rows.Count > 0)
                    {
                        AHC_DON_XULY objXuLy = dt.AHC_DON_XULY.Where(x => x.ID == ID_DON_YCBS).FirstOrDefault();
                    ...
                    {
                        AHC_DON_XULY objXuLy = dt.AHC_DON_XULY.Where(x => x.ID == ID_DON_YCBS).FirstOrDefault();
                        dt.AHC_DON_XULY.Remove(objXuLy);
                        dt.SaveChanges();
                    }
        ...
        private void validateEnableButton(decimal DONID, decimal DON_YCBSID)
        {
            decimal xuLyID = (String.IsNullOrEmpty(Request["ID"] + "")) ? 0 : Convert.ToDecimal(Request["ID"] + "");
            ADS_DON_XULY_BL aDXL = new ADS_DON_XULY_BL();
            DataTable objYCBS = aDXL.AHC_GETALL_DON_YCBS(Convert.ToDecimal(DONID), xuLyID, 1, 20);
        ...
        protected void dgDS_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                decimal ID_DON_YCBS = Convert.ToDecimal(Request.QueryString["ID"].ToString());
                AHC_DON_XULY oXL = dt.AHC_DON_XULY.Where(x => x.ID == ID_DON_YCBS).FirstOrDefault();
                ...
                if (e.Item.ItemIndex == 0)
                {
                    ...
                    AHC_DON_XULY_BL oBL = new AHC_DON_XULY_BL();
                    DataTable anphiList = oBL.CHECK_AHC_DON_DUONGSU_ANPHI_V2(DONID, DONCHITIETID, ISDONCHITIET);
                ...
                AHC_DON_XULY_BL oB = new AHC_DON_XULY_BL();
                // DataTable obj = oB.AHC_GETALL_DON_YCBS(Convert.ToDecimal(DONID), ID_DON_YCBS, 1, 20);
                ...
                AHC_DON oT = dt.AHC_DON.Where(x => x.ID == DONID).FirstOrDefault();
                AHC_SOTHAM_THULY oTLST = dt.AHC_SOTHAM_THULY.Where(x => x.DONID == DONIDHandle).FirstOrDefault();
                if (oT.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM || oTLST != null)
                {
                    cmdEdit.Visible = false;
                    cmdXoa.Visible = false;
        ...
        private void LoadDSTL()
        {
            ...
            DataTable oDT = oBL.AHC_GETALL_DON_YCBS(DONID, ID_DON_YCBS, pageindex, page_size);
