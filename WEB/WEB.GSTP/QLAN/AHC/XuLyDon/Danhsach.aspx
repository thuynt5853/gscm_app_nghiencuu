<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Danhsach.aspx.cs" Inherits="WEB.GSTP.QLAN.AHC.XuLyDon.Danhsach" %>
                                                ...
                                                <div>
                                                    <asp:DataGrid ID="rpt" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center">
                                                                <HeaderTemplate>
                                                                    Ngày GQ/YC
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:BoundColumn DataField="NGUOITAO" Visible="false"></asp:BoundColumn>
                                                        </Columns>
                            ...
                            <asp:Panel ID="pnThuLy" runat="server" Visible="false">
                                <div class="boxchung">
                                    ...
                                    <div class="boder" style="padding: 10px;">
                                        <table class="table1">
                                            <tr>
                                                <td class="lable_td">Đương sự<span class="must_input">(*)</span></td>
                                                <td>
                                                    <asp:ListBox ID="lbxDuongSu" CssClass="chosen-select" runat="server" Width="250px" SelectionMode="Multiple" AutoPostBack="True"></asp:ListBox>
                                                </td>
                                                <td>Miễn án phí?</td>
                                                <td colspan="3">
                                            ...
                                            <tr>
                                                <td colspan="6">
                                                    <div style="text-align: center;">
                                                        ...
                                                        <asp:Button ID="cmdLoadAP" runat="server" Style="display: none;" disable="false"
                                                            OnClick="cmdLoadAP_Click" />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
