<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="GiaiquyetSotham.aspx.cs" Inherits="WEB.GSTP.QLAN.AHC.Thamphan.GiaiquyetSotham" %>
                    ...
                    <table class="table1">
                        <tr>
                            ...
                            <td style="width: 260px;">
                                <asp:DropDownList ID="ddlThamphan" CssClass="chosen-select" runat="server" AutoPostBack="true" OnSelectedIndexChanged="myListDropDown_Change" Width="250px"></asp:DropDownList>
                                </td>
