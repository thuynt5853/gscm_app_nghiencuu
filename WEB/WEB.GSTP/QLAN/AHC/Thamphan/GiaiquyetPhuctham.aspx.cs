    ...
    public partial class GiaiquyetPhuctham : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataTable oDT = oBL.DGLIST_BAQD_QUYETDINH_KETTHUC_PT(ENUM_LOAIVUVIEC_NUMBER.AN_HANHCHINH, DONID);
                if (oDT.Rows.Count > 0)
                {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                AHC_PHUCTHAM_HDXX hdxx = dt.AHC_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).FirstOrDefault();
                AHC_PHUCTHAM_QUYETDINH qd = dt.AHC_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).FirstOrDefault();
        ...
        public void xoa(decimal id)
        {
            ...
            AHC_PHUCTHAM_THAMGIATOTUNG AHC_PHUCTHAM_THAMGIATOTUNG = dt.AHC_PHUCTHAM_THAMGIATOTUNG.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).FirstOrDefault<AHC_PHUCTHAM_THAMGIATOTUNG>();
            if (AHC_PHUCTHAM_THAMGIATOTUNG != null)
            {
                lbthongbao.Text = "Xóa không thành công! Do đang tồn tại người tham gia tố tụng.";
                return;
            }
            AHC_PHUCTHAM_HDXX AHC_PHUCTHAM_HDXX = dt.AHC_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).FirstOrDefault<AHC_PHUCTHAM_HDXX>();
            if (AHC_PHUCTHAM_HDXX != null)
            {
                lbthongbao.Text = "Xóa không thành công! Do đang tồn tại thông tin người tiến hành tố tụng.";
                return;
            }
            AHC_PHUCTHAM_HOAGIAI AHC_PHUCTHAM_HOAGIAI = dt.AHC_PHUCTHAM_HOAGIAI.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).FirstOrDefault<AHC_PHUCTHAM_HOAGIAI>();
            if (AHC_PHUCTHAM_HOAGIAI != null)
            {
                lbthongbao.Text = "Xóa không thành công! Do đang tồn tại thông tin hòa giải.";
                return;
            }
            AHC_PHUCTHAM_QUYETDINH AHC_PHUCTHAM_QUYETDINH = dt.AHC_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).FirstOrDefault<AHC_PHUCTHAM_QUYETDINH>();
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            //AHC_PHUCTHAM_HDXX hdxx = dt.AHC_PHUCTHAM_HDXX.Where(x => x.DONID == DonID).FirstOrDefault();
            //AHC_PHUCTHAM_QUYETDINH qd = dt.AHC_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DonID).FirstOrDefault();
