    ...
    public partial class Giaiquyetdon : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                AHC_CHUYEN_NHAN_AN objCN = dt.AHC_CHUYEN_NHAN_AN.Where(x => x.MAP_VUANID_NEW == DONID && x.TRUONGHOPGIAONHANID == 266).FirstOrDefault();
                if (objCN != null)
                {
                    AHC_DON_XULY oldDonXuLy = dt.AHC_DON_XULY.Where(x => x.DONID == objCN.VUANID && x.LOAIGIAIQUYET == 1).FirstOrDefault();
                    if (oldDonXuLy == null)
                    {
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AHC_DON_THAMPHAN_GETBY(ID, ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETDON);
        ...
        public void xoa(decimal id)
        {
            ...
            AHC_DON_XULY xld = dt.AHC_DON_XULY.Where(x => x.DONID == oND.DONID).FirstOrDefault();
            ...
            if (oBL.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oND.DONID), 6, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Thẩm phán giải quyết đơn an Hanh chính", "Xóa", json) == false)
            {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                int CheckThuLy = (string.IsNullOrEmpty(rowView["CheckThuLy"] + "")) ? 0 : Convert.ToInt16(rowView["CheckThuLy"] + "");
                if (CheckThuLy > 0)
                    lbtXoa.Visible = false;
                ...
                AHC_DON_XULY oXL = dt.AHC_DON_XULY.Where(x => x.DONID == DONID || x.DON_XULYID == DONID).FirstOrDefault();
                if (oXL != null)
                {
                    lbtXoa.Visible = false;
                }
