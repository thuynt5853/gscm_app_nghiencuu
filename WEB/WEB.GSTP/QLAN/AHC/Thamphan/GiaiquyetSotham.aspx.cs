...
namespace WEB.GSTP.QLAN.AHC.Thamphan
{
    public partial class GiaiquyetSotham : System.Web.UI.Page
    {
        ...
        public CultureInfo cul = new CultureInfo("vi-VN");
        ...
        private void CheckQuyen(decimal DONID)
        {
            ...
            List<AHC_SOTHAM_THULY> lstCount = dt.AHC_SOTHAM_THULY.Where(x => x.DONID == DONID).ToList();
            if (lstCount.Count == 0)
            {
            ...
            AHC_SOTHAM_BANAN oBA = dt.AHC_SOTHAM_BANAN.Where(x => x.DONID == DONID).FirstOrDefault();
            if (oBA != null)
            {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                AHC_DON_THAMPHAN obj = dt.AHC_DON_THAMPHAN.Where(x => x.ID == ID).FirstOrDefault();
                if (obj != null)
                {
                    ...
                    if (chuyenan != null)
                    {
                        ...
                        {
                            List<AHC_SOTHAM_HDXX> NTHTT = dt.AHC_SOTHAM_HDXX.Where(x => x.DONID == DONID).ToList();
                        ...
                        {
                            List<AHC_SOTHAM_HDXX> NTHTT = dt.AHC_SOTHAM_HDXX.Where(x => x.DONID == DONID && x.NGAYTAO > chuyenan.NGAYTAO).ToList();
                    ...
                    else
                    {
                        ...
                        List<AHC_SOTHAM_HDXX> NTHTT = dt.AHC_SOTHAM_HDXX.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).ToList();
                        List<AHC_SOTHAM_QUYETDINH> qd = dt.AHC_SOTHAM_QUYETDINH.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == DonviID).ToList();
                        if ((NTHTT != null && NTHTT.Count > 0) || (qd != null && qd.Count > 0))
                        {
                            lblSua.Visible = false;
                            lbtXoa.Visible = false;
                ...
                //AHC_SOTHAM_HDXX hdxx = dt.AHC_SOTHAM_HDXX.Where(x => x.DONID == DONID).FirstOrDefault();
                //AHC_SOTHAM_QUYETDINH qd = dt.AHC_SOTHAM_QUYETDINH.Where(x => x.DONID == DONID).FirstOrDefault();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    oND = dt.AHC_DON_THAMPHAN.Where(x => x.DONID == DONID && x.CANBOID == CanBoID && x.MAVAITRO == MaVaiTro).FirstOrDefault();
                    if (oND != null)
                    {
                ...
                AHC_SOTHAM_HDXX oTHTT = dt.AHC_SOTHAM_HDXX.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).FirstOrDefault<AHC_SOTHAM_HDXX>();
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AHC_DON_THAMPHAN_GETBY(ID, ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETSOTHAM);
        ...
        public void xoa(decimal id)
        {
            ...
            if (oBL.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oND.DONID), 6, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Thẩm phán giải quyết Sơ thẩm an Hanh chính", "Xóa", json) == false)
            {
                lbthongbao.Text = "Xóa không thành công!";
                return;
            }//Ket thuc
            
            //Xoa tham phan giải quyết án So thẩm
        ...
        private bool CheckQDofThamPhan(decimal DonID, decimal TPID)
        {
            ...
            AHC_SOTHAM_QUYETDINH obj_QD = dt.AHC_SOTHAM_QUYETDINH.Where(x => x.DONID == DonID && x.NGUOIKYID == TPID).FirstOrDefault<AHC_SOTHAM_QUYETDINH>();
            if (obj_QD != null)
            {
