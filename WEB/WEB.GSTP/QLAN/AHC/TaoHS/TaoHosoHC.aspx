<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="TaoHosoHC.aspx.cs" Inherits="WEB.GSTP.QLAN.AHC.TaoHS.TaoHosoHC" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/QLAN/AHC/TaoHS/Popup/pDuongSuKhac.ascx" TagPrefix="uc1" TagName="DsDuongSu" %>
<%@ Register Src="~/QLAN/AHC/TaoHS/Popup/uDSNguoiThamGiaToTung.ascx" TagPrefix="uc1" TagName="uDSNguoiThamGiaToTung" %>
    ...
    <div class="box">
        <div class="box_nd">
            <div class="truong">
                                    ...
                                    <tr style="height:30px">
                                      ...
                                      <tr style="height:30px">
                                        ...
                                        <td style="width: 250px; padding-right:10px;" colspan="3">
                                            <asp:TextBox ID="txtTenVuViec" CssClass="user" placeholder="Người khởi kiện - Người bị kiện - Quan hệ pháp luật"
                ...
                <div class="boxchung">
                    <h4 class="tleboxchung">Thông tin người khởi kiện (đại diện)</h4>
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                                <td style="width: 115px;"><asp:Label ID="lbl_nguyendonla" Text="Người khởi kiện là" runat="server"></asp:Label> <span class="batbuoc">(*)</span></td>
                            ...
                            <tr>
                                <td><asp:Label ID="lbl_tennguyendon" runat="server" Text="Tên Người khởi kiện"></asp:Label> <span class="batbuoc">(*)</span></td>
                                <td>
                ...
                <div class="boxchung" runat="server" id="div_bidon">
                    <h4 class="tleboxchung">Thông tin người bị kiện (đại diện)</h4>
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                                ...
                                <td style="width: 70px;"><%--Mã người bị kiện--%></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>Tên người bị kiện<span class="batbuoc">(*)</span></td>
                                <td>
