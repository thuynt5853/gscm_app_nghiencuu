<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pNguoiThamGiaTT.aspx.cs" Inherits="WEB.GSTP.QLAN.AHC.TaoHS.Popup.pNguoiThamGiaTT" %>
            ...
            <div class="form_tt">
                ...
                <div class="boder" style="padding: 10px;">
                      ...
                      <table>
                        ...
                        <tr>
                            <td style="width:150px" class="AHC_ToTung_Col1">Họ tên người TGTT<span class="batbuoc">(*)</span></td>
                            <td class="AHC_ToTung_Col2">
                                <asp:TextBox ID="txtHoten" CssClass="user" runat="server" Width="270px"></asp:TextBox>
                            </td>
                            <td class="AHC_ToTung_Col3">Ngày tham gia</td>
                            <td>
                       ...
                       <%-- <tr>
                            <td style="width:150px">Đại diện cho</td>
                            <td  colspan="3">
                                <asp:TextBox ID="txtNDD_Hoten" CssClass="user" runat="server" Width="270px" MaxLength="250"></asp:TextBox></td>
                        ...
                        <tr><td colspan="4">
                            ...
                            <uc1:uDSNguoiThamGiaToTung runat="server" ID="uDSNguoiThamGiaToTung1" />
