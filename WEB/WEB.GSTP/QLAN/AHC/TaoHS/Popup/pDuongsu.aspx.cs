...
namespace WEB.GSTP.QLAN.AHC.TaoHS.Popup
{
    public partial class pDuongsu : System.Web.UI.Page
    {
        ...
        private bool CheckValid()
        {
            ...
            if (pnNDCanhan.Visible)// cá nhân
            {
                if (txtND_Ngaysinh.Text != "")
                {
                    ...
                    {
                        lbthongbao.Text = "Bạn chưa nhập ngày sinh người khởi kiện theo định dạng dd/MM/yyyy. Hãy nhập lại.";
                    ...
                    {
                        lbthongbao.Text = "Ngày sinh người khởi kiện không được lớn hơn ngày hiện tại. Hãy nhập lại.";
                        txtND_Ngaysinh.Focus();
                        return false;
                    }
                ...
                if (txtND_Namsinh.Text != "")
                {
                    ...
                    {
                        lbthongbao.Text = "Năm sinh của người khởi kiện phải là số gồm 04 chữ số. Hãy kiểm tra lại.";
                    ...
                    if (namsinh == 0)
                    {
                        lbthongbao.Text = "Năm sinh của người khởi kiện phải lớn hơn 0. Hãy kiểm tra lại.";
                        Cls_Comon.SetFocus(this, this.GetType(), txtND_Namsinh.ClientID);
                        return false;
                    }
                    ...
                    {
                        lbthongbao.Text = "Năm sinh của người khởi kiện không thể lớn hơn năm hiện tại. Hãy kiểm tra lại!";
                        Cls_Comon.SetFocus(this, this.GetType(), txtND_Namsinh.ClientID);
                        return false;
                    }
                }
        ...
        public void loadedit(decimal ID)
        {
            ...
            //{
            //    Cls_Comon.SetButton(cmdUpdate, false);
            //    lbthongbao.Text = "Bạn không được sửa người khởi kiện hoặc người bị kiện đại diện!";
            //    return;
            //}
            //else
            //{
