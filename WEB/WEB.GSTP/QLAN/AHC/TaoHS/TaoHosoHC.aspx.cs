...
namespace WEB.GSTP.QLAN.AHC.TaoHS
{
    public partial class TaoHosoHC : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                DonID = (string.IsNullOrEmpty(Session[ENUM_LOAIAN.AN_HANHCHINH] + "")) ? 0 : Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HANHCHINH] + "");
        ...
        private void LoadInfo(decimal ID)
        {
            ...
            AHC_SOTHAM_BANAN oBA = dt.AHC_SOTHAM_BANAN.Where(x => x.DONID == oT.ID).FirstOrDefault() ?? new AHC_SOTHAM_BANAN();
            if (oBA.ID > 0)
            {
            ...
            {
                AHC_SOTHAM_QUYETDINH oQD = dt.AHC_SOTHAM_QUYETDINH.Where(x => x.DONID == oT.ID).FirstOrDefault() ?? new AHC_SOTHAM_QUYETDINH();
                if (oQD.ID > 0)
                {
            ...
            AHC_CHUYEN_NHAN_AN oCN = dt.AHC_CHUYEN_NHAN_AN.Where(x => x.VUANID == oT.ID).FirstOrDefault< AHC_CHUYEN_NHAN_AN>();
            if (oCN != null)
            {
        ...
        private bool CheckValid()
        {
            ...
            {
                lstMsgT.Text = lstMsgB.Text = "Bạn chưa nhập tên người khởi kiện.";
                txtTennguyendon.Focus();
                return false;
            }
            else if (txtTennguyendon.Text.Length > 250)
            {
                lstMsgT.Text = lstMsgB.Text = "Tên người khởi kiện không nhập quá 250 ký tự.";
                txtTennguyendon.Focus();
                return false;
            }
            if (pnNDCanhan.Visible)// cá nhân
            {
                if (txtND_Ngaysinh.Text != "")
                {
                    ...
                    {
                        lstMsgT.Text = lstMsgB.Text = "Bạn chưa nhập ngày sinh người khởi kiện theo định dạng dd/MM/yyyy. Hãy nhập lại.";
                    ...
                    {
                        lstMsgT.Text = lstMsgB.Text = "Ngày sinh người khởi kiện không được lớn hơn ngày hiện tại. Hãy nhập lại.";
                        txtND_Ngaysinh.Focus();
                        return false;
                    }
                ...
                {
                    lstMsgT.Text = lstMsgB.Text = "Bạn chưa nhập năm sinh người khởi kiện.";
                    txtND_Namsinh.Focus();
                    return false;
                }
                else
                {
                    ...
                    {
                        lstMsgT.Text = lstMsgB.Text = "Năm sinh của người khởi kiện phải là số gồm 04 chữ số. Hãy kiểm tra lại.";
                    ...
                    if (namsinh == 0)
                    {
                        lstMsgT.Text = lstMsgB.Text = "Năm sinh của người khởi kiện phải lớn hơn 0. Hãy kiểm tra lại.";
                        Cls_Comon.SetFocus(this, this.GetType(), txtND_Namsinh.ClientID);
                        return false;
                    }
                    ...
                    {
                        lstMsgT.Text = lstMsgB.Text = "Năm sinh của người khởi kiện không thể lớn hơn năm hiện tại. Hãy kiểm tra lại!";
                        Cls_Comon.SetFocus(this, this.GetType(), txtND_Namsinh.ClientID);
                        return false;
                    }
                }
                ...
                {
                    lstMsgT.Text = lstMsgB.Text = "Nơi làm việc của người khởi kiện không nhập quá 500 ký tự.";
            ...
            if (lengthEmail_ND > 0)
            {
                ...
                {
                    lstMsgT.Text = lstMsgB.Text = "Email của người khởi kiện không nhập quá 250 ký tự. Hãy nhập lại.";
                ...
                {
                    lstMsgT.Text = lstMsgB.Text = "Địa chỉ email của người khởi kiện chưa đúng.";
                    Cls_Comon.SetFocus(this, this.GetType(), txtND_Email.ClientID);
                    return false;
                }
            }
            ...
            if (_option == 0)
            {
                if (txtBD_Ten.Text == "")
                {
                    lstMsgT.Text = lstMsgB.Text = "Bạn chưa nhập tên tên người bị kiện";
                    txtBD_Ten.Focus();
                    return false;
                }
                else if (txtBD_Ten.Text.Length > 250)
                {
                    lstMsgT.Text = lstMsgB.Text = "Tên người bị kiện không nhập quá 250 ký tự.";
                    txtBD_Ten.Focus();
                    return false;
                }
            }
            if (pnBD_Canhan.Visible)// Cá nhân
            {
                if (txtBD_Ngaysinh.Text != "")
                {
                    ...
                    {
                        lstMsgT.Text = lstMsgB.Text = "Bạn chưa nhập ngày sinh người bị kiện theo định dạng dd/MM/yyyy. Hãy nhập lại.";
                    ...
                    {
                        lstMsgT.Text = lstMsgB.Text = "Ngày sinh người bị kiện không được lớn hơn ngày hiện tại. Hãy nhập lại.";
                        txtBD_Ngaysinh.Focus();
                        return false;
                    }
                ...
                if (txtBD_Namsinh.Text != "")
                {
                    ...
                    {
                        lstMsgT.Text = lstMsgB.Text = "Năm sinh của người bị kiện phải là số gồm 04 chữ số. Hãy kiểm tra lại.";
                    ...
                    if (namsinh == 0)
                    {
                        lstMsgT.Text = lstMsgB.Text = "Năm sinh của người bị kiện phải lớn hơn 0. Hãy kiểm tra lại.";
                        Cls_Comon.SetFocus(this, this.GetType(), txtBD_Namsinh.ClientID);
                        return false;
                    }
                    ...
                    {
                        lstMsgT.Text = lstMsgB.Text = "Năm sinh của người bị kiện không thể lớn hơn năm hiện tại. Hãy kiểm tra lại!";
                        Cls_Comon.SetFocus(this, this.GetType(), txtBD_Namsinh.ClientID);
                        return false;
                    }
                }
                ...
                {
                    lstMsgT.Text = lstMsgB.Text = "Nơi làm việc của người bị kiện không nhập quá 500 ký tự.";
            ...
            if (lengthEmail_BD > 0)
            {
                ...
                {
                    lstMsgT.Text = lstMsgB.Text = "Email của người bị kiện không nhập quá 250 ký tự. Hãy nhập lại.";
                ...
                {
                    lstMsgT.Text = lstMsgB.Text = "Địa chỉ email của người bị kiện chưa đúng.";
                    Cls_Comon.SetFocus(this, this.GetType(), txtBD_Email.ClientID);
                    return false;
                }
            }
        ...
        private void LoadCombobox()
        {
            ...
            ddlToaxxST.DataSource = oT.DM_TOAAN_GETBY_PARENT_HC("3", Session[ENUM_SESSION.SESSION_DONVIID] + "", Session["CAP_XET_XU"] + "");
        ...
        public void SaveDuongSu_VUVIEC()
        {
            ...
            //if (ddlQuanhephapluat.SelectedValue != "")
            ...
            if (hddID.Value == "" || hddID.Value == "0")
            {
                ...
                oT.MAVUVIEC = ENUM_LOAIVUVIEC.AN_HANHCHINH + donvitao + oT.TT.ToString();
                ...
                if (ddlThuly.SelectedIndex == 0)
                    GD.GAIDOAN_INSERT_UPDATE("6", oT.ID, 2, Convert.ToDecimal(ddlToaxxST.SelectedValue), 0, 0, 0, 0);
        ...
        void UpdateBanAn(decimal VuAnId)
        {
            ...
            DateTime date_temp;
            AHC_SOTHAM_BANAN obj = new AHC_SOTHAM_BANAN();
            if (VuAnId > 0)
            {
                obj = dt.AHC_SOTHAM_BANAN.Where(x => x.DONID == VuAnId).SingleOrDefault<AHC_SOTHAM_BANAN>();
                if (obj != null)
                    IsUpdate = true;
                else
                    obj = new AHC_SOTHAM_BANAN();
            }
            else
                obj = new AHC_SOTHAM_BANAN();
        ...
        {
            Boolean IsUpdate = false;
            AHC_SOTHAM_QUYETDINH oND = new AHC_SOTHAM_QUYETDINH();
            if (VuAnId > 0)
            {
                oND = dt.AHC_SOTHAM_QUYETDINH.Where(x => x.DONID == VuAnId).SingleOrDefault<AHC_SOTHAM_QUYETDINH>();
                if (oND != null)
                    IsUpdate = true;
                else
        ...
        void Chuyenan_Nhanan(decimal VuAnID)
        {
            ...
            if (VuAnID > 0)
            {
                oND = dt.AHC_CHUYEN_NHAN_AN.Where(x => x.VUANID == VuAnID).SingleOrDefault<AHC_CHUYEN_NHAN_AN>();
                if (oND != null)
                    IsUpdate = true;
                else
                    oND = new AHC_CHUYEN_NHAN_AN();
            }
            else
                oND = new AHC_CHUYEN_NHAN_AN();
            ...
            AHC_SOTHAM_KHANGCAO oKC = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.DONID == VuAnID).FirstOrDefault<AHC_SOTHAM_KHANGCAO>();
            AHC_SOTHAM_KHANGNGHI oKN = dt.AHC_SOTHAM_KHANGNGHI.Where(x => x.DONID == VuAnID).FirstOrDefault<AHC_SOTHAM_KHANGNGHI>();
            ...
            AHC_DON oVuAn = dt.AHC_DON.Where(x => x.ID == VuAnID).FirstOrDefault();
            ...
            if (ddlThuly.SelectedIndex == 1)
                GD.GAIDOAN_INSERT_UPDATE_XXLAI_PHUCTHAM("6", VuAnID, 3, Convert.ToDecimal(ddlToaxxST.SelectedValue), Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0);
            else
                GD.GAIDOAN_INSERT_UPDATE("6", VuAnID, 3, 0, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0);
        }
        ...
        protected void cmdUpdateKCKN_Click(object sender, EventArgs e)
        {
            ...
            if (rdbPanelKC.SelectedValue == KHANGCAO.ToString() && rdbPanelKN.SelectedValue == KHANGCAO.ToString())// Kháng cáo
            {
                ...
                AHC_SOTHAM_KHANGCAO oND;
                if (hddKCID.Value == "" || hddKCID.Value == "0")
                {
                    oND = new AHC_SOTHAM_KHANGCAO();
                ...
                else
                {
                    ...
                    oND = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.ID == ID).FirstOrDefault();
                }
                oND.DONID = vDonID;
                ...
                if (hddKCID.Value == "" || hddKCID.Value == "0")
                {
                    oND.NGAYTAO = DateTime.Now;
                    oND.NGUOITAO = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                    dt.AHC_SOTHAM_KHANGCAO.Add(oND);
                }
                else
                {
                    oND.NGAYSUA = DateTime.Now;
            ...
            else if (rdbPanelKC.SelectedValue == KHANGNGHI.ToString() && rdbPanelKN.SelectedValue == KHANGNGHI.ToString())// Kháng nghị
            {
                ...
                AHC_SOTHAM_KHANGNGHI oND;
                if (hddKNID.Value == "" || hddKNID.Value == "0")
                    oND = new AHC_SOTHAM_KHANGNGHI();
                else
                {
                    ID = Convert.ToDecimal(hddKNID.Value);
                    oND = dt.AHC_SOTHAM_KHANGNGHI.Where(x => x.ID == ID).FirstOrDefault();
                }
                oND.DONID = vDonID;
                ...
                if (hddKNID.Value == "" || hddKNID.Value == "0")
                {
                    oND.NGAYTAO = DateTime.Now;
                    oND.NGUOITAO = Session[ENUM_SESSION.SESSION_USERNAME] + "";
                    dt.AHC_SOTHAM_KHANGNGHI.Add(oND);
                }
                else
                {
                    oND.NGAYSUA = DateTime.Now;
        ...
        protected void cmdXoaHoSo_Click(object sender, EventArgs e)
        {
            ...
            AHC_PHUCTHAM_THULY oTLPT = dt.AHC_PHUCTHAM_THULY.Where(x => x.DONID == ID).FirstOrDefault() ?? new AHC_PHUCTHAM_THULY();
            if (oTLPT.ID == 0)
            {
                AHC_DON oVa = dt.AHC_DON.Where(x => x.ID == ID).First();
                if (oVa != null)
                {
        ...
        {
            //Luu thong tin Ho so khi xoa Toàn bo ho so
            AHC_DON oT = dt.AHC_DON.Where(x => x.ID == ID).FirstOrDefault();
            ...
            if (oBLDS.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oT.ID), 6, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Tạo hồ sơ KC/KN Hanh chinh", "Xóa", json) == false)
            {
                return;
            }//Ket thuc 
            ...
            if (oBL.DELETE_ALLDATA_BY_VUANID(ID + "") == true)
            {
                ...
                GIAI_DOAN_BL GD = new GIAI_DOAN_BL();
                GD.GIAIDOAN_DELETES("6", ID,2);
            }
        }
        public void xoaDS(decimal id)
        {
            ...
            var json = new JavaScriptSerializer().Serialize(oT);
            ADS_DON_BL oBLDS = new ADS_DON_BL();
            if (oBLDS.HISTORY_ALLDATA_BY_VUANID(Convert.ToDecimal(oT.ID), 6, Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Xoa Duong su trong Tạo hồ sơ KC/KN Hanh chinh", "Xóa", json) == false)
            {
                return;
            }//Ket thuc 
        ...
        protected void qlhl_check_load()
        {
            if (ddlQHPLTK.SelectedValue != "0")
            {
                ...
                {
                    lbl_nguyendonla.Text = "Người khởi kiện là";
                    lbl_tennguyendon.Text = "Tên Người khởi kiện";
                    div_bidon.Style.Remove("Display");
                }
                else if (qhpltk.OPTIONS == 1)//yêu cầu
                {
                    div_bidon.Style.Add("Display", "none");
                    lbl_nguyendonla.Text = "Người yêu cầu";
        ...
        void Load_ListBiCan( decimal vDonid)
        {
            ...
            //Load đương sự
            ddlNguoikhangcao.DataSource = oDSBL.AHC_SOTHAM_DUONGSU_GETBY(vDonid, 1);
        ...
        void Load_ListNguoiThamGiaToTung(decimal vDonid)
        {
            ...
            string hoten = "";
            List<AHC_DON_THAMGIATOTUNG> lst = dt.AHC_DON_THAMGIATOTUNG.Where(x => x.DONID == vDonid).ToList();
            if (lst != null && lst.Count > 0)
            {

                foreach (AHC_DON_THAMGIATOTUNG item in lst)
                {
        ...
        {
            String temp = "";
            List<AHC_SOTHAM_BANAN> lst = dt.AHC_SOTHAM_BANAN.Where(x => x.DONID == DonID).OrderByDescending(y => y.NGAYTUYENAN).ToList();
            if (lst != null && lst.Count > 0)
            {
                foreach (AHC_SOTHAM_BANAN item in lst)
                {
        ...
        {
            String temp = "";
            AHC_SOTHAM_BL objBL = new AHC_SOTHAM_BL();
            DataTable tblQD = objBL.AHC_SOTHAM_QUYETDINH_GETLIST(DonID);
        ...
        private void LoadQD_BA_InfoKhangCao(decimal vDonid)
        {
            ...
            if (rdbLoaiKC.SelectedValue == "0")
            {
                ...
                AHC_SOTHAM_BANAN oT = dt.AHC_SOTHAM_BANAN.Where(x => x.ID == ID).FirstOrDefault();
                if (oT != null)
                {
            ...
            {
                decimal ID = Convert.ToDecimal(ddlSOQDBA_KC.SelectedValue);
                AHC_SOTHAM_QUYETDINH oT = dt.AHC_SOTHAM_QUYETDINH.Where(x => x.ID == ID).FirstOrDefault();
                if (oT != null)
                {
        ...
        public void LoadGridKCKN()
        {
            ...
            decimal ID = (string.IsNullOrEmpty(Session[ENUM_LOAIAN.AN_HANHCHINH] + "")) ? 0 : Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HANHCHINH] + "");
            DataTable oDT = oBL.AHC_SOTHAM_KCaoKNghi_GETLIST(ID);
        ...
        public void LoadEdit(decimal ID, decimal IsKhangCao)
        {
            ...
            if (IsKhangCao == KHANGCAO)// Kháng cáo
            {
                ...
                AHC_SOTHAM_KHANGCAO oND = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.ID == ID).FirstOrDefault();
                if (oND != null)
                {
            ...
            else // Kháng nghị
            {
                ...
                AHC_SOTHAM_KHANGNGHI oND = dt.AHC_SOTHAM_KHANGNGHI.Where(x => x.ID == ID).FirstOrDefault();
                if (oND != null)
                {
                    hddID.Value = oND.DONID.ToString();
        ...
        public void xoa(decimal ID, decimal IsKhangCao)
        {
            if (IsKhangCao == KHANGCAO)// Kháng cáo
            {
                ...
                if (oND != null)
                {
                    dt.AHC_SOTHAM_KHANGCAO.Remove(oND);
                }
            }
            else // Kháng nghị
            {
                ...
                if (oND != null)
                {
                    dt.AHC_SOTHAM_KHANGNGHI.Remove(oND);
                }
            }
            dt.SaveChanges();
        ...
        protected void rdbDonVi_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                decimal vdonid = Convert.ToDecimal(hddID.Value);
                AHC_DON oD = dt.AHC_DON.Where(x => x.ID == vdonid).FirstOrDefault();
                decimal ToaAnID = 0;
                if (oD != null)
        ...
        protected void lkThemDuongSuKhac_Click(object sender, EventArgs e)
        {
            ...
            string StrMsg = "PopupReport('/QLAN/AHC/TaoHS/Popup/pDuongsu.aspx?hsID=" + DonID.ToString() + "&bID=0','Thêm người tham gia tố tụng',950,450);";
        ...
        protected void lkThemNguoiTGTT_Click(object sender, EventArgs e)
        {
            ...
            string StrMsg = "PopupReport('/QLAN/AHC/TaoHS/Popup/pNguoiThamgiaTT.aspx?hsID=" + DonID.ToString() + "&bID=0','Thêm người tham gia tố tụng',950,450);";
            System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), StrMsg, true);
        }
