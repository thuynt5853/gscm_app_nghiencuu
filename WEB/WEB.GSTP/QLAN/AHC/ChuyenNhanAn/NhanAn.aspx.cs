...
namespace WEB.GSTP.QLAN.AHC.ChuyenNhanAn
{
    public partial class NhanAn : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    #region Quét các vụ việc được chuyển từ Tòa án cấp cao và lưu vào AHC_DON và AHC_CHUYEN_NHAN_AN
                    ...
                    //string sql = "select * from HOSO where TOA_AN_XET_XU='" + ToaAnID.ToString() + "' and LOAI_AN='" + ENUM_LOAIAN.AN_HANHCHINH + "' and TRANG_THAI=1";
                    ...
                    //        #region Update Vụ việc AHC_DON
                    //        AHC_DON vDON = dt.AHC_DON.Where(x => x.MAVUVIEC == MaVuViec && ((x.MAGIAIDOAN == ENUM_GIAIDOANVUAN.SOTHAM && x.TOAANID == ToaAnID) || (x.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM && x.TOAPHUCTHAMID == ToaAnID))).FirstOrDefault();
                    //        if (vDON == null)
                    //        {
                    //            IsNew = true;
                    //            vDON = new AHC_DON();
                    ...
                    //        VuAnID = vDON.ID;
                    //        #endregion
                    //        #region Update Table AHC_CHUYEN_NHAN_AN
                    //        IsNew = false;
                    //        AHC_CHUYEN_NHAN_AN chuyen_nhan_an = dt.AHC_CHUYEN_NHAN_AN.Where(x => x.VUANID == VuAnID && x.TOACHUYENID == Toa_Chuyen_ID && x.TOANHANID == Toa_Nhan_ID).FirstOrDefault();
                    //        if (chuyen_nhan_an == null)
                    //        {
                    //            IsNew = true;
                    //            chuyen_nhan_an = new AHC_CHUYEN_NHAN_AN();
                    //        }
                    ...
                    //        if (IsNew)
                    //        {
                    //            dt.AHC_CHUYEN_NHAN_AN.Add(chuyen_nhan_an);
                    //        }
                    //        dt.SaveChanges();
                    //        #endregion
                    //    }
        ...
        private void LoadGrid()
        {
            ...
            DataTable oDT = oBL.HC_NHANAN(txt_NG_KC.Text.Trim(), txtSoQD.Text.Trim(), txt_NgayQD.Text.Trim(), vDonViID, txtMaVuViec.Text, txtTenVuViec.Text, txtTenToa.Text, Convert.ToDecimal(ddlTHGN.SelectedValue), dFrom, dTo, Convert.ToDecimal(rdbTrangthai.SelectedValue), Convert.ToDecimal(rdbLoai.SelectedValue));
        ...
        protected void cmdLuu_Click(object sender, EventArgs e)
        {
            ...
            foreach (RepeaterItem item in rptCapNhat.Items)
            {
                ...
                AHC_CHUYEN_NHAN_AN oT = dt.AHC_CHUYEN_NHAN_AN.Where(x => x.ID == ID).FirstOrDefault();
                if (oT != null)
                {
                    ...
                    if (oIT.MA == ENUM_TRUONGHOP_GIAONHAN.KHONGTHUOC_THAMQUYEN_XETXU)
                    {
                        ...
                        else
                        {
                            if (rdbLoai.SelectedValue == "0")
                            {
                                ...
                                oDonMoi.MAVUVIEC = ENUM_LOAIVUVIEC.AN_HANHCHINH + oTA.MA + oDonMoi.TT.ToString();
                                ...
                                //update 14082025
                                if (oDonMoi.TOA_GIAIQUYET_ID == null) oDonMoi.TOA_GIAIQUYET_ID = oDon.TOA_GIAIQUYET_ID;

                                dt.AHC_DON.Add(oDonMoi);
                                dt.SaveChanges();

                                GIAI_DOAN_BL GD = new GIAI_DOAN_BL();
                                GD.GAIDOAN_INSERT_UPDATE("6", oDonMoi.ID, 2, oDonMoi.TOAANID.Value, 0, 0, 0, 0);
                                ...
                                IQueryable<DON_CHITIET> lstDON_CHITIET = dt.DON_CHITIET.Where(a => a.DONID == oDon.ID);
                                ...
                                IQueryable<AHC_DON_DUONGSU> lstoDS = dt.AHC_DON_DUONGSU.Where(s => s.DONID == oDon.ID);
                                foreach (var it in lstoDS)
                                {
                                    AHC_DON_DUONGSU oDS = new AHC_DON_DUONGSU();
                                    ...
                                    dt.AHC_DON_DUONGSU.Add(oDS);
                                    dt.SaveChanges();

                                    lstDuongSuTemp.Add(new DuongSuTemp(it.ID, oDS.ID));

                                    //DON_CHITIET dct = dt.DON_CHITIET.Where(s => s.DONID == oDonMoi.ID).OrderByDescending(x => x.ID).FirstOrDefault();
                                ...
                                IQueryable<AHC_DON_THAMGIATOTUNG> lstoTT = dt.AHC_DON_THAMGIATOTUNG.Where(s => s.DONID == oDon.ID);
                                foreach (var it in lstoTT)
                                {
                                    //lưu thông tin người tham gia tố tụng
                                    AHC_DON_THAMGIATOTUNG oTT = new AHC_DON_THAMGIATOTUNG();
                                    ...
                                    dt.AHC_DON_THAMGIATOTUNG.Add(oTT);
                                    dt.SaveChanges();
                                }

                                //
                                IQueryable<AHC_DON_TAILIEU> lstTailieu = dt.AHC_DON_TAILIEU.Where(s => s.DONID == oDon.ID);
                            ...
                            else
                            {
                                ...
                                */
                                string UserName = Session[ENUM_SESSION.SESSION_USERNAME] + "", LoaiVuViec = ENUM_LOAIVUVIEC.AN_HANHCHINH, MaToaAn = Session[ENUM_SESSION.SESSION_MADONVI] + "";
                                ...
                                GIAI_DOAN_BL GD = new GIAI_DOAN_BL();
                                GD.GAIDOAN_INSERT_UPDATE("6", DonID_New, 2, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0, 0);
                            }
                        }
                    }
                    else if (oIT.MA == ENUM_TRUONGHOP_GIAONHAN.XETXULAI_CAPSOTHAM)
                    {
                        ...
                        {
                            AHC_CHUYEN_NHAN_AN_BL _caBL = new AHC_CHUYEN_NHAN_AN_BL();
                            decimal currentToaAnID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                            ...
                            dt.SaveChanges();
                            GD.GAIDOAN_INSERT_UPDATE("6", donIdOld, ENUM_GIAIDOANVUAN.SOTHAM, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0, 0);
                            #region toancau - anhnt update lại kết quả kháng cáo/kháng nghị
                            List<AHC_SOTHAM_KHANGCAO> khangCaos = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.DONID == donIdOld && (x.TINHTRANG_GIAIQUYET == null || x.TINHTRANG_GIAIQUYET == 0) && x.LOAIKHANGCAO == 2).ToList();
                            if (khangCaos != null && khangCaos.Count > 0)
                            {
                                foreach (AHC_SOTHAM_KHANGCAO kc in khangCaos)
                                {
                                    kc.TINHTRANG_GIAIQUYET = 1;
                                    dt.SaveChanges();
                                }
                            }
                            List<AHC_SOTHAM_KHANGNGHI> khangNghis = dt.AHC_SOTHAM_KHANGNGHI.Where(x => x.DONID == donIdOld && (x.TINHTRANG_GIAIQUYET == null || x.TINHTRANG_GIAIQUYET == 0) && x.LOAIKN == 2).ToList();
                            if (khangNghis != null && khangNghis.Count > 0)
                            {
                                foreach (AHC_SOTHAM_KHANGNGHI kn in khangNghis)
                                {
                        ...
                        else
                        {
                            ...
                            //GIAI_DOAN_BL GD = new GIAI_DOAN_BL();
                            //GD.GAIDOAN_INSERT_UPDATE("6", DonID, 2, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0, 0);
                            ...
                            oDON_new.LOAIQDHANHCHINHID = oDon.LOAIQDHANHCHINHID;
                            oDON_new.QDHC_CUA = oDon.QDHC_CUA;
                            oDON_new.NOIDUNGQUYETDINH = oDon.NOIDUNGQUYETDINH;
                            ...
                            //update 14082025
                            if (oDON_new.TOA_GIAIQUYET_ID == null) oDON_new.TOA_GIAIQUYET_ID = oDON_new.TOAANID;
                            if (oDON_new.TOA_PHUCTHAM_GIAIQUYET_ID == null)
                                oDON_new.TOA_PHUCTHAM_GIAIQUYET_ID = oDON_new.TOAPHUCTHAMID;
                            dt.AHC_DON.Add(oDON_new);
                            dt.SaveChanges();

                            GIAI_DOAN_BL GD = new GIAI_DOAN_BL();
                            GD.GAIDOAN_INSERT_UPDATE("6", oDON_new.ID, 2, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0, 0);
                            ...
                            //Câp dương su vụ án
                            List<AHC_DON_DUONGSU> lst = dt.AHC_DON_DUONGSU.Where(x => x.DONID == DonID).ToList<AHC_DON_DUONGSU>();
                            foreach (AHC_DON_DUONGSU vDuongsu_old in lst)
                            {
                                ...
                                //DON_CHITIET dct_new = dt.DON_CHITIET.Where(s => s.DONID == oDonMoi.ID).OrderByDescending(x => x.ID).FirstOrDefault();
                                ...
                                //Ban giao tai lieu
                                List<AHC_DON_TAILIEU> lstTaiLieu = dt.AHC_DON_TAILIEU.Where(x => x.DONID == DonID && x.NGUOIBANGIAO == vDuongsu_old.ID).ToList<AHC_DON_TAILIEU>();
                                foreach (AHC_DON_TAILIEU vdonFile_old in lstTaiLieu)
                                {
                                    ...
                                    donFile_new.TOA_GIAIQUYET_ID = vDuongsu_old.TOA_GIAIQUYET_ID;
                        ...
                        // Phan cong Tham phan
                        List<AHC_DON_THAMPHAN> lstThamPhan = dt.AHC_DON_THAMPHAN.Where(x => x.DONID == DonID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETDON).ToList<AHC_DON_THAMPHAN>();
                        ...
                        //Xu ly don
                        List<AHC_DON_XULY> lstXulyDon = dt.AHC_DON_XULY.Where(x => x.DONID == DonID).ToList<AHC_DON_XULY>();
                        ...
                        //Tam ung an phi
                        List<AHC_ANPHI> lstAP = dt.AHC_ANPHI.Where(x => x.DONID == DonID && x.MAGIAIDOAN == 2).ToList();
                        foreach (AHC_ANPHI vAP_old in lstAP)
                        {
                            ...
                            CNA.INSERT_ANPHI_DUONGSUID(6, DonID, oDON_new.ID);
                        }
                    ...
                    else if (oIT.MA == ENUM_TRUONGHOP_GIAONHAN.TOA_CAPCAO_CHUYEN_VE)
                    {
                        ...
                        if (tblHoSo.Rows.Count > 0)
                        {
                            ...
                            {
                                #region Update Người khởi kiện và người bị kiện
                    ...
                    else
                    {
                        ...
                        //var soThamKhangCaos = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.DONID == oDon.ID && x.LOAIKHANGCAO == 2 && (x.TINHTRANG_GIAIQUYET == null || x.TINHTRANG_GIAIQUYET == 0));
                        //var soThamKhangNghis = dt.AHC_SOTHAM_KHANGNGHI.Where(x => x.DONID == oDon.ID && x.LOAIKN == 2 && (x.TINHTRANG_GIAIQUYET == null || x.TINHTRANG_GIAIQUYET == 0));
                        ...
                        if (_chuyenNhanAnBl.CheckCoKcKnTamDinhChi(DonID))
                        {
                            ...
                            oDON_new.NOIDUNGKHOIKIEN = oDon.NOIDUNGKHOIKIEN;
                            oDON_new.MABAOMAT = oDon.MABAOMAT;
                            oDON_new.TOAPHUCTHAMID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                            oDON_new.QHPLTKID = oDon.QHPLTKID;
                            oDON_new.SOQD = oDon.SOQD;
                            oDON_new.NGAYQD = oDon.NGAYQD;
                            oDON_new.HANHVIHC = oDon.HANHVIHC;
                            ...
                            dt.AHC_DON.Add(oDON_new);
                            dt.SaveChanges();
                            GD.GAIDOAN_INSERT_UPDATE("6", oDON_new.ID, ENUM_GIAIDOANVUAN.PHUCTHAM_QDK, Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]), 0, 0, 0);
                            ...
                            foreach (var dct_data in lstDON_CHITIET)
                            {
                                ...
                                dct_dt.DONID = oDON_new.ID;
                                dct_dt.LOAIANID = dct_data.LOAIANID;
                                dct_dt.TOAANID = dct_data.TOAANID;
                                dct_dt.HINHTHUCNHANDON = dct_data.HINHTHUCNHANDON;
                                dct_dt.NGAYVIETDON = dct_data.NGAYVIETDON;
                                dct_dt.NGAYNHANDON = dct_data.NGAYNHANDON;
                                dct_dt.CANBONHANDONID = dct_data.CANBONHANDONID;
                    ...
                    oT.TOA_GIAIQUYET_ID = oT.TOACHUYENID;
                    dt.SaveChanges();
        ...
        private void UpdateNguyenDonBiDon(List<NGUOI_THAM_GIA_AK> List_NguyeDon_BiDon, decimal DonID)
        {
            if (List_NguyeDon_BiDon.Count > 0)
            {
                ...
                {
                    IsNew = false;
                    AHC_DON_DUONGSU DuongSu = dt.AHC_DON_DUONGSU.Where(x => x.DONID == DonID && x.ID_DUONGSU_TACC == item.Guid).FirstOrDefault();
                    if (DuongSu == null)
                    {
                        IsNew = true;
                        DuongSu = new AHC_DON_DUONGSU();
                    }
                    ...
                    if (IsNew)
                    {
                        dt.AHC_DON_DUONGSU.Add(DuongSu);
                    }
                    dt.SaveChanges();
                }
            }
        ...
        private void UpdateNguoiTGTT(List<NGUOI_THAM_GIA_CHUNG> ListNguoiTGTT, decimal DonID)
        {
            if (ListNguoiTGTT.Count > 0)
            {
                ...
                {
                    AHC_DON_THAMGIATOTUNG NguoiTGTT = dt.AHC_DON_THAMGIATOTUNG.Where(x => x.DONID == DonID && x.ID_DUONGSU_TACC == item.Guid).FirstOrDefault();
                    if (NguoiTGTT != null)
                    {
                        IsNew = true;
                        NguoiTGTT = new AHC_DON_THAMGIATOTUNG();
                    ...
                    if (IsNew)
                    {
                        ...
                        dt.AHC_DON_THAMGIATOTUNG.Add(NguoiTGTT);
                    }
                    dt.SaveChanges();
                }
            }
        ...
        private void UpdateThuLy(THU_LY ThuLy, decimal ToaAnID, decimal DonID, string CapXetXu)
        {
            if (CapXetXu == "SOTHAM")
            {
                ...
                bool IsNew = false;
                AHC_SOTHAM_THULY STThuLy = dt.AHC_SOTHAM_THULY.Where(x => x.DONID == DonID && x.SOTHULY == ThuLy.SOTHULY.ToString()).FirstOrDefault();
                if (STThuLy != null)
                {
                    IsNew = true;
                    STThuLy = new AHC_SOTHAM_THULY();
                ...
                if (IsNew)
                {
                    ...
                    dt.AHC_SOTHAM_THULY.Add(STThuLy);
                }
                dt.SaveChanges();
            }
            else
            {
                ...
                bool IsNew = false;
                AHC_PHUCTHAM_THULY PTThuLy = dt.AHC_PHUCTHAM_THULY.Where(x => x.DONID == DonID && x.SOTHULY == ThuLy.SOTHULY.ToString()).FirstOrDefault();
                if (PTThuLy != null)
                {
                    IsNew = true;
                    PTThuLy = new AHC_PHUCTHAM_THULY();
                ...
                if (IsNew)
                {
                    ...
                    dt.AHC_PHUCTHAM_THULY.Add(PTThuLy);
                }
                dt.SaveChanges();
            }
        }
        private void UpdateNguoiTHTT(List<NGUOI_TIEN_HANH_TO_TUNG> ListNguoiTHTT, decimal DonID, string CapXetXu)
        {
            if (ListNguoiTHTT.Count > 0)
            {
                ...
                foreach (NGUOI_TIEN_HANH_TO_TUNG item in ListNguoiTHTT)
                {
                    ...
                    if (CapXetXu == "SOTHAM")
                    {
                        AHC_SOTHAM_HDXX Hdxx = dt.AHC_SOTHAM_HDXX.Where(x => x.DONID == DonID && x.CANBOID == CanBoID).FirstOrDefault();
                        if (Hdxx == null)
                        {
                            IsNew = true;
                            Hdxx = new AHC_SOTHAM_HDXX();
                    ...
                    {
                        AHC_PHUCTHAM_HDXX Hdxx = dt.AHC_PHUCTHAM_HDXX.Where(x => x.DONID == DonID && x.CANBOID == CanBoID).FirstOrDefault();
                        if (Hdxx == null)
                        {
                            IsNew = true;
                            Hdxx = new AHC_PHUCTHAM_HDXX();
                            Hdxx.NGAYTAO = DateTime.Now;
                        }
                        else
                        {
        ...
        private void UpdateQDVuViec(List<QUYET_DINH> ListQD, decimal ToaAnID, decimal DonID, string CapXetXu)
        {
            if (ListQD.Count > 0)
            {
                ...
                foreach (QUYET_DINH item in ListQD)
                {
                    ...
                    if (CapXetXu == "SOTHAM")
                    {
                        AHC_SOTHAM_QUYETDINH QdVuAn = dt.AHC_SOTHAM_QUYETDINH.Where(x => x.DONID == DonID && x.TOAANID == ToaAnID).FirstOrDefault();
                        if (QdVuAn == null)
                        {
                            IsNew = false;
                            QdVuAn = new AHC_SOTHAM_QUYETDINH()
                            {
                        ...
                        if (IsNew)
                        {
                            ...
                            dt.AHC_SOTHAM_QUYETDINH.Add(QdVuAn);
                        }
                        dt.SaveChanges();
                    }
                    // Phúc thẩm
                    ...
                    {
                        AHC_PHUCTHAM_QUYETDINH QdVuAn = dt.AHC_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DonID && x.TOAANID == ToaAnID).FirstOrDefault();
                        if (QdVuAn == null)
                        {
                            IsNew = false;
                            QdVuAn = new AHC_PHUCTHAM_QUYETDINH()
                            {
                                NGAYTAO = DateTime.Now
                            };
                        }
                        ...
                        if (IsNew)
                        {
                            // update 130825
                            QdVuAn.TOA_GIAIQUYET_ID = Convert.ToDecimal(Session[ENUM_SESSION.SESSION_DONVIID]);
                            dt.AHC_PHUCTHAM_QUYETDINH.Add(QdVuAn);
                        }
                        dt.SaveChanges();
                    }
                }
        ...
        private void UpdateBanAn(BAN_AN bAn, LICH_XET_XU LichXetXu, decimal ToaAnID, decimal DonID, string CapXetXu)
        {
            ...
            if (CapXetXu == "SOTHAM")
            {
                AHC_SOTHAM_BANAN STBanAn = dt.AHC_SOTHAM_BANAN.Where(x => x.DONID == DonID && x.TOAANID == ToaAnID).FirstOrDefault();
                if (STBanAn == null)
                {
                    IsNew = true;
                    STBanAn = new AHC_SOTHAM_BANAN();
                ...
                if (IsNew)
                {
                    ...
                    dt.AHC_SOTHAM_BANAN.Add(STBanAn);
                }
                dt.SaveChanges();
            }
            // Phúc thẩm
            ...
            {
                AHC_PHUCTHAM_BANAN PTBanAn = dt.AHC_PHUCTHAM_BANAN.Where(x => x.DONID == DonID && x.TOAANID == ToaAnID).FirstOrDefault();
                if (PTBanAn == null)
                {
                    IsNew = true;
                    PTBanAn = new AHC_PHUCTHAM_BANAN();
                ...
                DM_KETQUA_PHUCTHAM KQPT = dt.DM_KETQUA_PHUCTHAM.Where(x => x.ISAHC == 1 && x.MA == bAn.KETQUA).FirstOrDefault();
                if (KQPT != null)
                {
                ...
                if (IsNew)
                {
                    ...
                    dt.AHC_PHUCTHAM_BANAN.Add(PTBanAn);
                }
                dt.SaveChanges();
            }
        }
        private void UpdateKhangCao(List<KHANG_CAO> ListKhangCao, decimal ToaAnID, decimal DonID)
        {
            if (ListKhangCao.Count > 0)
            {
                ...
                foreach (KHANG_CAO item in ListKhangCao)
                {
                    ...
                    decimal NguoiKCID = 0;
                    AHC_DON_DUONGSU DuongSu = dt.AHC_DON_DUONGSU.Where(x => x.DONID == DonID && x.ID_DUONGSU_TACC == Guid_NguoiKC).FirstOrDefault();
                    if (DuongSu != null)
                    {
                        NguoiKCID = DuongSu.ID;
                    }
                    AHC_SOTHAM_KHANGCAO kc = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.DONID == DonID && x.DUONGSUID == NguoiKCID && x.TOAANRAQDID == ToaAnID).FirstOrDefault();
                    if (kc != null)
                    {
                        IsNew = true;
                        kc = new AHC_SOTHAM_KHANGCAO();
        ...
        private decimal Action_ChuyenAn_KhongThuoc_ThamQuyen(decimal DonID, string LoaiVuViec, decimal ToaNhanID, string MaToaNhan, string NguoiTao)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("AHC_CVA_KHONG_THAM_QUYEN", parameters);
            decimal Result = 0;
            if (tbl.Rows.Count > 0)
        ...
        {
            AHC_DON_BL Bl = new AHC_DON_BL();
            //for (int i = 0; i < lstDonID.Count; i++)
            //{
            //    var ChuyenNhanID = lstDonID[i];
            //    decimal DonID_New = 0;
            //    AHC_CHUYEN_NHAN_AN ObjChuyenAn = dt.AHC_CHUYEN_NHAN_AN.Where(x => x.ID == ChuyenNhanID).FirstOrDefault();
            //    if (ObjChuyenAn != null)
            //    {
            ...
            for (int i = 0; i < lstDonID.Count; i++)
            {
                var ChuyenNhanID = lstDonID[i];
                decimal DonID_New = 0;
                AHC_CHUYEN_NHAN_AN ObjNhanAn = dt.AHC_CHUYEN_NHAN_AN.Where(x => x.ID == ChuyenNhanID).FirstOrDefault();
                if (ObjNhanAn != null)
                {
                    int LoaiVuViec = Convert.ToInt32(ENUM_LOAIVUVIEC.AN_HANHCHINH);
                    ...
                    if (ObjNhanAn.MAP_VUANID_NEW.GetValueOrDefault(0) > 0)
                    {
                        ...
                        if (rdbLoai.SelectedValue == "0")
                        {
                            AHC_DON_THAMPHAN thamPhan = dt.AHC_DON_THAMPHAN.Where(x => x.DONID == DonID_New && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETDON).FirstOrDefault();
                            if (thamPhan != null)
                            {
                                IsThuLy = true;
                        ...
                        if (!IsThuLy)
                        {
                            ...
                            AHC_DON oDonNew = dt.AHC_DON.Where(x => x.ID == DonID_New).FirstOrDefault();
                            var json = new JavaScriptSerializer().Serialize(oDonNew);
                            ADS_DON_BL oBL = new ADS_DON_BL();
                            if (oBL.HISTORY_ALLDATA_BY_VUANID(DonID_New, Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HANHCHINH), Session[ENUM_SESSION.SESSION_USERID] + "", strUserName, "Huỷ nhận án hành chính", "Xóa", json) == false)
                            {
                                break;
                            }
                            //Ket thuc 
                            ...
                            AHC_DON oVuan = dt.AHC_DON.Where(x => x.ID == ObjNhanAn.VUANID).FirstOrDefault();
                    ...
                    else
                    {
                        ...
                        if (oVuan.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM_QDK)
                        {
                            ...
                            AHC_CHUYEN_NHAN_AN chuyenAnSTlenPTTDC = dt.AHC_CHUYEN_NHAN_AN.Where(x => x.MAP_VUANID_NEW == oVuan.ID).FirstOrDefault();
                            List<AHC_SOTHAM_THULY> oThuLyST = dt.AHC_SOTHAM_THULY.Where(x => x.DONID == oldVuAnId && x.NGAYTAO >= chuyenAnSTlenPTTDC.NGAYTAO).ToList();
                            List<AHC_SOTHAM_HDXX> oSTNguoiTienHanhToTung = dt.AHC_SOTHAM_HDXX.Where(x => x.DONID == oldVuAnId && x.NGAYTAO >= chuyenAnSTlenPTTDC.NGAYTAO).ToList();
                            List<AHC_DON_THAMPHAN> oThamPhanST = dt.AHC_DON_THAMPHAN.Where(x => x.DONID == oldVuAnId && x.NGAYTAO >= chuyenAnSTlenPTTDC.NGAYTAO).ToList();
                            List<AHC_SOTHAM_BANAN> oBanAnST = dt.AHC_SOTHAM_BANAN.Where(x => x.DONID == oldVuAnId && x.NGAYTAO >= chuyenAnSTlenPTTDC.NGAYTAO).ToList();
                            List<AHC_SOTHAM_QUYETDINH> oQDST = dt.AHC_SOTHAM_QUYETDINH.Where(x => x.DONID == oldVuAnId && x.NGAYTAO >= chuyenAnSTlenPTTDC.NGAYTAO).ToList();
                            List<AHC_SOTHAM_KHANGCAO> oKCST = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.DONID == oldVuAnId && x.NGAYTAO >= chuyenAnSTlenPTTDC.NGAYTAO).ToList();
                            List<AHC_SOTHAM_KHANGNGHI> oKNST = dt.AHC_SOTHAM_KHANGNGHI.Where(x => x.DONID == oldVuAnId && x.NGAYTAO >= chuyenAnSTlenPTTDC.NGAYTAO).ToList();
                            ...
                            {
                                AHC_DON oVuAnOld = dt.AHC_DON.Where(x => x.ID == oldVuAnId).FirstOrDefault();
                                AHC_CHUYEN_NHAN_AN ObjNhanAnLanCuoi = dt.AHC_CHUYEN_NHAN_AN.Where(x => x.VUANID == oldVuAnId && x.TOACHUYENID == oVuAnOld.TOAANID).OrderByDescending(x => x.ID).FirstOrDefault();
                                AHC_CHUYEN_NHAN_AN ObjNhanAnLanGanCuoi = dt.AHC_CHUYEN_NHAN_AN.Where(x => x.VUANID == oldVuAnId && x.TOACHUYENID == oVuAnOld.TOAANID && x.ID < ObjNhanAnLanCuoi.ID).OrderByDescending(x => x.ID).FirstOrDefault();
                                if (ObjNhanAnLanGanCuoi == null)
                                {
                                    #region toancau - anhnt update lại kết quả kháng cáo/kháng nghị
                                    List<AHC_SOTHAM_KHANGCAO> khangCaos = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.DONID == oldVuAnId && x.TINHTRANG_GIAIQUYET == 1 && x.LOAIKHANGCAO == 2).ToList();
                                    if (khangCaos != null && khangCaos.Count > 0)
                                    {
                                        foreach (AHC_SOTHAM_KHANGCAO kc in khangCaos)
                                        {
                                    ...
                                    List<AHC_SOTHAM_KHANGNGHI> khangNghis = dt.AHC_SOTHAM_KHANGNGHI.Where(x => x.DONID == oldVuAnId && x.TINHTRANG_GIAIQUYET == 1 && x.LOAIKN == 2).ToList();
                                    if (khangNghis != null && khangNghis.Count > 0)
                                    {
                                        foreach (AHC_SOTHAM_KHANGNGHI kn in khangNghis)
                                        {
                                ...
                                {
                                    #region toancau - anhnt update lại kết quả kháng cáo/kháng nghị
                                    List<AHC_SOTHAM_KHANGCAO> khangCaos = dt.AHC_SOTHAM_KHANGCAO.Where(x => x.DONID == oldVuAnId && x.TINHTRANG_GIAIQUYET == 1 && x.LOAIKHANGCAO == 2 && x.NGAYTAO >= ObjNhanAnLanGanCuoi.NGAYTAO && x.NGAYTAO <= ObjNhanAnLanCuoi.NGAYTAO).ToList();
                                    if (khangCaos != null && khangCaos.Count > 0)
                                    {
                                        foreach (AHC_SOTHAM_KHANGCAO kc in khangCaos)
                                        {
                                    ...
                                    List<AHC_SOTHAM_KHANGNGHI> khangNghis = dt.AHC_SOTHAM_KHANGNGHI.Where(x => x.DONID == oldVuAnId && x.TINHTRANG_GIAIQUYET == 1 && x.LOAIKN == 2 && x.NGAYTAO >= ObjNhanAnLanGanCuoi.NGAYTAO && x.NGAYTAO <= ObjNhanAnLanCuoi.NGAYTAO).ToList();
                                    if (khangNghis != null && khangNghis.Count > 0)
                                    {
                                        foreach (AHC_SOTHAM_KHANGNGHI kn in khangNghis)
                                        {
