<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Quyetdinhphuctham.aspx.cs" Inherits="WEB.GSTP.QLAN.AHC.PhucthamQDK.Quyetdinhphuctham" %>
                ...
                <div class="boder" style="padding: 10px;">
                    <table class="table1">
                        ...
                        <tr>
                            ...
                            <td>
                                <%--<asp:TextBox ID="txtSoQD" runat="server"  Enabled="false" placeholder="Số tự sinh"  CssClass="user" Width="242px" MaxLength="250"></asp:TextBox>--%>
