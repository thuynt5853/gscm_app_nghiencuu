<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="ThuLy.aspx.cs" Inherits="WEB.GSTP.QLAN.AHC.PhucthamQDK.ThuLy" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtSoThuly" CssClass="user" 
                                    runat="server" Width="242px" MaxLength="250" 
                                    AutoPostBack="True" OnTextChanged="txtSoThuly_TextChanged"></asp:TextBox>
                            </td>
                        </tr>
