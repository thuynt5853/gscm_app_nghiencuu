<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Bananphuctham.aspx.cs" Inherits="WEB.GSTP.QLAN.AHC.PhucthamQDK.Bananphuctham" %>
                            ...
                            <div class="boxchung">
                                ...
                                <div class="boder" style="padding: 10px;">
                                    <table class="table1">
                                        ...
                                        <tr>
                                            <td style="width: 135px;">Áp dụng án lệ?</td>
                ...
                <div class="boxchung">
                    ...
                    <div class="boder" style="padding: 10px;">
                        <table class="table1">
                            <tr>
                                <td colspan="4">
                                    <asp:RadioButtonList ID="rdbPanelQD" runat="server" RepeatDirection="Horizontal" Font-Bold="true"  Visible="false"  AutoPostBack="true" OnSelectedIndexChanged="rdbPanelQD_SelectedIndexChanged">
