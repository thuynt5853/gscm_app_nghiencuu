...
namespace WEB.GSTP.QLAN.AHC.Phuctham
{
    public partial class NguoiTienhanhTT : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    if (tucach == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN)
                    {
                        ...
                        oND = dt.AHC_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN && x.TOA_GIAIQUYET_ID == currenttoaid).FirstOrDefault<AHC_PHUCTHAM_HDXX>();
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AHC_PHUCTHAM_HDXX_GETLIST(ID);
