    ...
    public partial class Bananphuctham : System.Web.UI.Page
    {
        ...
        bool CheckCongbo(decimal ID)
        {
            var list = DataExtensions.GetAllWithClause<BAQD_CONGBO>(
                $"VUVIECID = {ID} AND LOAIANID = {ENUM_LOAIVUVIEC_NUMBER.AN_HANHCHINH} AND CAPXETXU = 3 AND TRANGTHAI IN (2,3)"
            );
        ...
        void CheckQuyen()
        {
            ...
            List<AHC_PHUCTHAM_HDXX> lstTPCT = dt.AHC_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.MAVAITRO == ENUM_NGUOITIENHANHTOTUNG.THAMPHAN).ToList();
            if (lstTPCT.Count == 0)
            {
                lstErr.Text = lbthongbaoQD.Text = "Chưa phân công thẩm phán giải quyết !";
                Cls_Comon.SetButton(cmdUpdate, false);
            ...
            AHC_TONGDAT td = dt.AHC_TONGDAT.Where(x => x.DONID == DONID && ( x.BIEUMAUID == 257)).FirstOrDefault(); // vnpt -- xoá check biểu mẫu sơ thẩm đã tống đạt trên phúc thẩm
            if (td != null)
            {
            ...
            bool isExist = ads.IsExistKHOBADQ(0, DONID, 3,ENUM_LOAIVUVIEC_TEXT.AN_HANHCHINH);
            if (isExist)
            {
            ...
            isExist = ads.IsExistKHOBADQ(1, DONID, 3, ENUM_LOAIVUVIEC_TEXT.AN_HANHCHINH);
            if (isExist)
            {
                lstErr.Text = lbthongbaoQD.Text = "Vụ việc đã được đồng bộ. Phải thu hồi đồng bộ trước khi chỉnh sửa/xóa";
                Cls_Comon.SetButton(btnUpdate, false);
        ...
        protected void cmdUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    AHC_TONGDAT oTD1 = dt.AHC_TONGDAT.Where(x => x.DONID == oND.DONID && x.MAPID == oND.ID && x.MAP_TABLE == ENUM_MAP_TABLE.AHC_PHUCTHAM_BANAN).FirstOrDefault();
                    if (oTD1 != null)
                    {
                ...
                var rFileID = UploadFileID(oDon, FileID, "46-HC", STTQD);
                if (rFileID > 0)
                {
                    oND.FILEID = rFileID;
                    dt.SaveChanges();
        ...
        protected void cmdHuyBanAn_Click(object sender, EventArgs e)
        {
            ...
            {
                // khong duoc xoa khi da Tong dat - 29/11/2025 vnpt check
                AHC_TONGDAT oTD2 = dt.AHC_TONGDAT.Where(x => x.DONID == banan.DONID && x.MAPID == banan.ID && x.MAP_TABLE == ENUM_MAP_TABLE.AHC_PHUCTHAM_BANAN).FirstOrDefault();
                if (oTD2 != null)
                {
                ...
                bool isExist = ald.IsExistKHOBADQ(0, DONID, 3,ENUM_LOAIVUVIEC_TEXT.AN_HANHCHINH);
                if (isExist)
                {
            ...
            decimal BieuMauID = 0;
            DM_BIEUMAU bm = dt.DM_BIEUMAU.Where(x => x.MABM == "46-HC").FirstOrDefault();
            if (bm != null)
            {
                BieuMauID = bm.ID;
            }

            AHC_FILE file = dt.AHC_FILE.Where(x => x.DONID == DONID && x.BIEUMAUID == BieuMauID && x.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM).FirstOrDefault();
            if (file != null)
            {
        ...
        private string getQHPL_NAME_THULY()
        {
            ...
            AHC_PHUCTHAM_THULY oT = dt.AHC_PHUCTHAM_THULY.Where(x => x.DONID == ID).FirstOrDefault();
        ...
        private void txtQuanhephapluat_name(AHC_PHUCTHAM_THULY oT)
        {
            if (oT.QUANHEPHAPLUAT_NAME != null)
            {
                txtQuanhephapluat.Text = oT.QUANHEPHAPLUAT_NAME;
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.DGLIST_BAQD_QUYETDINH_KETTHUC_PT(ENUM_LOAIVUVIEC_NUMBER.AN_HANHCHINH, ID);
            if (oDT != null)
            {
        ...
        private void LoadQD()
        {
            ...
            DM_QUYETDINH_VUAN_KETTHUC oBL = new DM_QUYETDINH_VUAN_KETTHUC();
            DataTable oDT = oBL.DM_QUYETDINH_VUAN_PHUCTHAM_KETTHUC(ENUM_LOAIVUVIEC_NUMBER.AN_HANHCHINH);
        ...
        private void LoadNguoiKyInfo()
        {
            ...
            {
                AHC_DON_THAMPHAN oTP = dt.AHC_DON_THAMPHAN.Where(x => x.DONID == DonID && x.MAVAITRO == ENUM_VAITROTHAMPHAN.VTTP_GIAIQUYETPHUCTHAM).FirstOrDefault();
                if (oTP != null)
                {
        ...
        {
            decimal ID = Convert.ToDecimal(hddDonID.Value);
            List<AHC_PHUCTHAM_QUYETDINH> lstQD = dt.AHC_PHUCTHAM_QUYETDINH.Where(x => x.DONID == ID && (x.LOAIQDID == 10 || x.QUYETDINHID == 423 || x.QUYETDINHID == 422 || x.LOAIQDID == 3)).ToList();
            if (lstQD.Count >= 1)
            {
        ...
        public void xoa(decimal id)
        {
            ...
            TK_PHUCTHAM_QUYETDINH TK = DataExtensions.GetAllWithClause<TK_PHUCTHAM_QUYETDINH>($"QUYETDINHID = {id} AND LOAIAN = {Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HANHCHINH)}").FirstOrDefault();
            if (TK != null)
            {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                TK_PHUCTHAM_QUYETDINH TK;

                //GTEL-HUNGQ 22-10-2025 Check neu da chia sẻ dữ liệu không được xóa
                KHOBAQD_BL ads = new KHOBAQD_BL();
                bool isExist = ads.IsExistKHOBADQ(1, DONID, 3, ENUM_LOAIVUVIEC_TEXT.AN_HANHCHINH);
                if (isExist)
                {
                    lstErr.Text = lbthongbaoQD.Text = "Vụ việc đã được đồng bộ. Phải thu hồi đồng bộ trước khi chỉnh sửa/xóa";
                    return;
                ...
                else
                {
                    ...
                    TK = DataExtensions.GetAllWithClause<TK_PHUCTHAM_QUYETDINH>($"QUYETDINHID= {ID} AND LOAIAN =  {Convert.ToDecimal(ENUM_LOAIVUVIEC_NUMBER.AN_HANHCHINH)}").FirstOrDefault();
                ...
                if (ddlQuyetdinh.SelectedItem.Text.Contains("40-HC") || ddlQuyetdinh.SelectedItem.Text.Contains("41-HC") || ddlQuyetdinh.SelectedItem.Text.Contains("42-HC"))
                {
                    TK.DONID = DONID;
                    ...
                    if (ddlQuyetdinh.SelectedItem.Text.Contains("41-HC") || ddlQuyetdinh.SelectedItem.Text.Contains("42-HC"))
                    {
                ...
                if (!ddlQuyetdinh.SelectedItem.Text.Contains("09-HC"))
                {

                    if (!string.IsNullOrEmpty(ddlLydoQuyetdinh.SelectedValue))
                    {
                    ...
                    else
                    {
                        ...
                        oND.LYDOKETQUAID = 0; // Hoặc giá trị mặc định khác
                    }
                }
        ...
        public void loadedit(decimal ID)
        {
            ...
            if (ddlQuyetdinh.SelectedItem.Text.Contains("43-HC"))
            {
        ...
        private void SetEnable_data_QD(AHC_PHUCTHAM_QUYETDINH QD)
        {
            if (QD != null)
            {
                // khong duoc sửa khi da Tong dat nhưng cho phép nhập thêm những trường trống -27 / 11 / 2025 vnpt check
                AHC_TONGDAT oTD = dt.AHC_TONGDAT.Where(x => x.DONID == QD.DONID && x.MAPID == QD.ID && x.MAP_TABLE == ENUM_MAP_TABLE.AHC_PHUCTHAM_BANAN).FirstOrDefault();
                if (oTD != null)
                {
                    if (QD.QHPLTKID != null)
                    {
        ...
        protected void dgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                case "Download":
                    var oND = dt.AHC_PHUCTHAM_QUYETDINH.Where(x => x.DONID == ID).FirstOrDefault();
                    if (oND.TENFILE != "")
                    {
                        var cacheKey = Guid.NewGuid().ToString("N");
                ...
                case "Xoa":
                    ...
                    //GTEL-HUNG 10-10-2025 Dữ liệu Quyết định đã được chia sẻ không được xóa
                    KHOBAQD_BL ahc = new KHOBAQD_BL();
                    bool isExist = ahc.IsExistKHOBADQ(1, ID, 3,ENUM_LOAIVUVIEC_TEXT.AN_HANHCHINH);
                    if (isExist)
                    {
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                decimal DONID = Convert.ToDecimal(hddDonID.Value);
                AHC_PHUCTHAM_QUYETDINH oT = dt.AHC_PHUCTHAM_QUYETDINH.Where(x => x.ID == DONID).FirstOrDefault();
        ...
        protected void ddlQuyetdinh_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (btnUpdate.Enabled == true)
            {
                ...
                {
                    AHC_PHUCTHAM_QUYETDINH oQD = dt.AHC_PHUCTHAM_QUYETDINH.Where(x => x.DONID == IDD && x.LOAIQDID == 5 && x.QUYETDINHID != 147 && x.QUYETDINHID != 148 /*Quyết định chuyển vụ án giải quyết theo thủ tục rút gọn sang giải quyết theo thủ tục thông thường*/).FirstOrDefault();
                    if (oQD == null)
                    {
            ...
            if (ddlQuyetdinh.SelectedItem.Text.Contains("40-HC") || ddlQuyetdinh.SelectedItem.Text.Contains("41-HC") || ddlQuyetdinh.SelectedItem.Text.Contains("42-HC"))
            {
                ...
                if (ddlQuyetdinh.SelectedItem.Text.Contains("42-HC"))
                {
                    pnCongBoQD.Visible = false;
                    pnLyDoKetquaPhuctham.Visible = true;
                    LoadLyDoQuyetdinh();
                }
            }
        ...
        protected void set_valueLydo(AHC_PHUCTHAM_QUYETDINH oND)
        {
        ...
        private void LoadLyDoQuyetdinh()
        {
