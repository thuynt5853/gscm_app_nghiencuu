    ...
    public partial class NguoiThamgiaTT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    AHC_DON oT = dt.AHC_DON.Where(x => x.ID == DONID && x.TOA_GIAIQUYET_ID == Donvi_ID).FirstOrDefault();
                    List<AHC_PHUCTHAM_THULY> lstCount = dt.AHC_PHUCTHAM_THULY.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == Donvi_ID).ToList();
        ...
        protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                AHC_DON oT = dt.AHC_DON.Where(x => x.ID == DONID && x.TOA_GIAIQUYET_ID == DonviID).FirstOrDefault();
        ...
        private void LoadTGTTFromDonKK()
        {
            ...
            chkListTGTT.DataSource = oBL.AHC_DON_TGTT_GETLIST(DONID);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string current_id = Session[ENUM_LOAIAN.AN_HANHCHINH] + "";
                decimal DONID = Convert.ToDecimal(current_id);
                AHC_PHUCTHAM_THAMGIATOTUNG oND;
                if (hddid.Value == "" || hddid.Value == "0")
                    oND = new AHC_PHUCTHAM_THAMGIATOTUNG();
                else
                {
                    decimal ID = Convert.ToDecimal(hddid.Value);
                    oND = dt.AHC_PHUCTHAM_THAMGIATOTUNG.Where(x => x.ID == ID).FirstOrDefault();
                }
                ...
                if (hddid.Value == "" || hddid.Value == "0")
                {
                    ...
                    dt.AHC_PHUCTHAM_THAMGIATOTUNG.Add(oND);
                }
                else
                {
        ...
        public void LoadGrid()
        {
            ...
            DataTable oDT = oBL.AHC_PHUCTHAM_TGTT_GETLIST(ID);
        ...
        {
            AHC_PHUCTHAM_THAMGIATOTUNG oND = dt.AHC_PHUCTHAM_THAMGIATOTUNG.Where(x => x.ID == id).FirstOrDefault();
            if (oND != null)
            {
                //Anhpn 
                ...
                decimal DONID = Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HANHCHINH] + "");
                //hoangndh 140725
                AHC_PHUCTHAM_HDXX AHC_PHUCTHAM_HDXX = dt.AHC_PHUCTHAM_HDXX.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == currenttoaid).FirstOrDefault<AHC_PHUCTHAM_HDXX>();
                ...
                //hoangndh 140725
                AHC_PHUCTHAM_HOAGIAI AHC_PHUCTHAM_HOAGIAI = dt.AHC_PHUCTHAM_HOAGIAI.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == currenttoaid).FirstOrDefault<AHC_PHUCTHAM_HOAGIAI>();
                if (AHC_PHUCTHAM_HOAGIAI != null)
                {
                    lbthongbao.Text = "Xóa không thành công! Do đang tồn tại thông tin hòa giải.";
                    return;
                }
                AHC_PHUCTHAM_QUYETDINH AHC_PHUCTHAM_QUYETDINH = dt.AHC_PHUCTHAM_QUYETDINH.Where(x => x.DONID == DONID && x.TOA_GIAIQUYET_ID == currenttoaid).FirstOrDefault<AHC_PHUCTHAM_QUYETDINH>();
                ...
                dt.AHC_PHUCTHAM_THAMGIATOTUNG.Remove(oND);
                dt.SaveChanges();
                dgList.CurrentPageIndex = 0;
                LoadGrid();
                ResetControls();
        ...
        protected void cmdChonTGTT_Click(object sender, EventArgs e)
        {
            ...
            foreach (ListItem oItem in chkListTGTT.Items)
            {
                if (oItem.Selected)
                {
                    ...
                    if (dt.AHC_PHUCTHAM_THAMGIATOTUNG.Where(x => x.NTGTT_DONKK_ID == NID).ToList().Count == 0)
                    {
                        AHC_DON_THAMGIATOTUNG oD = dt.AHC_DON_THAMGIATOTUNG.Where(x => x.ID == NID).FirstOrDefault();
                        AHC_PHUCTHAM_THAMGIATOTUNG oS = new AHC_PHUCTHAM_THAMGIATOTUNG();
                        oS.DONID = oD.DONID;
                        oS.HOTEN = oD.HOTEN;
                        ...
                        dt.AHC_PHUCTHAM_THAMGIATOTUNG.Add(oS);
                        dt.SaveChanges();
                    }
                }
            }
