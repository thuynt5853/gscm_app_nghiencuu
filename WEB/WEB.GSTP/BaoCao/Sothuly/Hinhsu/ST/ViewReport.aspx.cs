...
namespace WEB.GSTP.BaoCao.Sothuly.Hinhsu.ST
{
    public partial class ViewReport : System.Web.UI.Page
    {
        ...
        private void LoadReport()
        {
            ...
            try
            {
                string sql = "PKG_GSTP_SOTHULY_HINHSU.SO_HINHSU_SOTHAM";
            ...
            rptSoTL_AHS_ST rpt = new rptSoTL_AHS_ST();
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_GSTP_SOTHULY_SOTHAM_PRINT.SO_HINHSU_SOTHAM", parameters);
                //-----------------------------------------
