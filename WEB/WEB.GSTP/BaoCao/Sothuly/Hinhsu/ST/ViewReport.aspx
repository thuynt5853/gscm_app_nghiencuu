<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="ViewReport.aspx.cs" Inherits="WEB.GSTP.BaoCao.Sothuly.Hinhsu.ST.ViewReport" %>
        ...
        <table class="table1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="btnExportExcel" runat="server" CssClass="buttoninput" Text="Xuất Excel" OnClientClick="return ValidateInput();" OnClick="btnExportExcel_Click" />
                </td>
            </tr>
            <tr>
                <td colspan="4">
