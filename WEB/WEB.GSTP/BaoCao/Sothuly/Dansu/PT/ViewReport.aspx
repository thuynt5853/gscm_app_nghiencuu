<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="ViewReport.aspx.cs" Inherits="WEB.GSTP.BaoCao.Sothuly.Dansu.PT.ViewReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="padding: 15px;">
        <table class="table1">
            ...
            <tr>
                <td colspan="4">
                    <asp:Label ID="lblmsg" style="color: red; float: left; padding-top: 10px;" runat="server"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
