<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="tdkt_tkbc_capkhenthuong.aspx.cs" Inherits="WEB.GSTP.BaoCao.TDKT.Thongkebaocao.tdkt_tkbc_capkhenthuong" %>
            ...
            <div class="truong">
                <table class="table1">
                    <tr>
                        <td><b>Đơn vị</b></td>
                        <td colspan="3">
                            <asp:DropDownList ID="DropCapDonVi" Width="318px" runat="server" CssClass="chosen-select">
                                <asp:ListItem Text="--- Tất cả ---" Value=""></asp:ListItem>
                                <asp:ListItem Text="Tối cao" Value="TOICAO"></asp:ListItem>
                                <asp:ListItem Text="Cấp cao" Value="CAPCAO"></asp:ListItem>
                                <asp:ListItem Text="Cấp tỉnh" Value="CAPTINH"></asp:ListItem>
                                <asp:ListItem Text="Cấp huyện" Value="CAPHUYEN"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
