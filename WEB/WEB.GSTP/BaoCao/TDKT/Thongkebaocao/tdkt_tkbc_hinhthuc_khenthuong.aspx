<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="tdkt_tkbc_hinhthuc_khenthuong.aspx.cs" Inherits="WEB.GSTP.BaoCao.TDKT.Thongkebaocao.tdkt_tkbc_hinhthuc_khenthuong" %>
        ...
        <div class="box_nd">
            <div class="truong">
                <table class="table1">
                    ...
                    <tr>
                        <td><b>Hình thức khen thưởng</b></td>
                        <td colspan="3">
                            <asp:DropDownList ID="DropHT_KhenThuong" Width="318px" runat="server" CssClass="chosen-select"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
