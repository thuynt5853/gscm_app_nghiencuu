...
{
    public partial class tdkt_tkbc_hinhthuc_khenthuong : System.Web.UI.Page
    {
        ...
        private void LoadDropHT_KhenThuong()
        {
            string GroupName = ENUM_DANHMUC.DM_HINHTHUC_KHENTHUONG;
            DM_DATAITEM_BL bl = new DM_DATAITEM_BL();
            DataTable tbl = bl.DM_DATAITEM_GETBYGROUPNAME(GroupName);
            if (tbl.Rows.Count > 0)
            {
                DropHT_KhenThuong.DataSource = tbl;
                DropHT_KhenThuong.DataTextField = "TEN";
                DropHT_KhenThuong.DataValueField = "ID";
                DropHT_KhenThuong.DataBind();
            }
            DropHT_KhenThuong.Items.Insert(0, new ListItem("--- Chọn ---", "0"));
        }
        ...
        protected void BtnLamMoi_Click(object sender, EventArgs e)
        {
            ...
            DropHT_KhenThuong.SelectedIndex = 0;
        ...
        private void LoadReport()
        {
            ...
            decimal DonViID = Convert.ToDecimal(DropDonVi.SelectedValue)
                    , HinhThuc_ThiDuaID = 0
                    , HinhThuc_KhenThuongID = Convert.ToDecimal(DropHT_KhenThuong.SelectedValue);
