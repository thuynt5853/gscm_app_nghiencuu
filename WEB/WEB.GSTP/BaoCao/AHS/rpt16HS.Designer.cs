namespace WEB.GSTP.BaoCao.AHS
{
    partial class rpt16HS
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.xrTableCell20.Text = "[v_CHANHAN] [v_TENTOAAN_1_3]";
            ...
            this.xrTableCell27.Text = "      Căn cứ các điều 44, 456 và 457 của Bộ luật Tố tụng hình sự;";
            ...
            this.xrTableCell26.Text = "      Xét thấy vụ án hình sự [v_GIAIDOAN] thụ lý số: [v_SOTHULY] có đủ các điều k" +
    "iện áp dụng thủ tục rút gọn theo quy định tại Điều 456 của    Bộ luật Tố tụng hì" +
    "nh sự,";
            ...
            this.xrTableCell7.Text = "      Áp dụng thủ tục rút gọn đối với vụ án hình sự [v_GIAIDOAN] thụ lý số: [v_SO" +
    "THULY]";
            ...
            this.xrTableCell13.Text = "      Điều 2";
            ...
            this.xrTableCell12.Text = "      Quyết định này có hiệu lực kể từ ngày ra Quyết định cho đến khi kết thúc vi" +
    "ệc xét xử phúc thẩm trừ trường hợp có Quyết định khác hủy bỏ      Quyết định áp " +
    "dụng thủ tục rút gọn.";
            ...
            this.xrTableCell10.Text = "      Quyết định này có thể bị khiếu nại theo quy định tại khoản 5 Điều 457 của B" +
    "ộ luật Tố tụng hình sự.";
            ...
            this.xrTable8,
            this.xrTable9});
            this.ReportHeader.HeightF = 104.1666F;
            ...
            this.xrTableCell11.Text = "Số: [v_SOQD_2]/QĐ-TA";
            ...
            this.xrTable5});
            this.ReportFooter.HeightF = 192.3296F;
            this.ReportFooter.KeepTogether = true;
            this.ReportFooter.Name = "ReportFooter";
            // 
            // xrTable5
            // 
            this.xrTable5.LocationFloat = new DevExpress.Utils.PointFloat(1.000183F, 15.2462F);
            ...
            this.xrTableCell3.Text = "- Viện kiểm sát cùng cấp;\r\n- Bị can (bị cáo), người đại diện của bị can (bị cáo)," +
    " người bào chữa.\r\n- Lưu hồ sơ vụ án.";
            ...
            this.ReportHeader,
            this.ReportFooter});
            this.DisplayName = "16-HS. Quyết định áp dụng thủ tục rút gọn";
