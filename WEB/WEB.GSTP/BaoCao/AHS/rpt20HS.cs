...
{
    public partial class rpt20HS : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt20HS()
        {
            InitializeComponent();
        ...
        private void SubBand_TP_DuKhuyet_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void SubBand_HTND_DuKhuyet_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void SubBand_ThuKy_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void SubBand_TK_DuKhuyet_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void SubBand_KSV_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void SubBand_KSV_DK_BeforePrint(object sender, CancelEventArgs e)
        {
            if (Parameters["prm_KSV_DK"].Value + "" == "")
            {
                SubBand_KSV_DK.Visible = false;
            }
            else
            {
                SubBand_KSV_DK.Visible = true;
            }
        }
    }
}
