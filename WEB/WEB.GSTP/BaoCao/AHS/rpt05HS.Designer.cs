namespace WEB.GSTP.BaoCao.AHS
{
    partial class rpt05HS
    {
        ...
        private void InitializeComponent()
        {
            ...
            // xrTable3
            // 
            this.xrTable3.LocationFloat = new DevExpress.Utils.PointFloat(6.103516E-05F, 98.4166F);
    ...
    "GAYTHULY] tháng [THANGTHULY] năm [NAMTHULY];";
            ...
            this.xrTableCell12.Text = "          Xét thấy cần thiết tiếp tục tạm giam bị cáo để bảo đảm hoàn thành việc " +
    "xét xử sơ thẩm,";
            ...
            this.xrTableCell_BC_HT.Text = "          Tạm giam  bị cáo: [BICAN_HOTEN]; Ngày sinh: [BICAN_NGAYSINH].";
            ...
            this.xrTable11});
            this.SubBand7.HeightF = 136.4583F;
            ...
            this.xrTableCell50.Text = "          Thời hạn tạm giam là: [THOIHANTAMGIAM], kể từ ngày [TUNGAY] cho đến khi" +
    " kết thúc phiên tòa sơ thẩm.";
            ...
            this.DisplayName = "05HS. Quyết định tạm giam (áp dụng biện pháp tạm giam cho đến khi kết thúc phiên " +
    "tòa sơ thẩm đối với bị cáo đang bị tạm giam)";
            ...
            this.Margins = new DevExpress.Drawing.DXMargins(118, 78, 79, 79);
