...
{
    public partial class rpt06HS : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt06HS()
        {
            InitializeComponent();
        ...
        private void xrTableCell_NoiNhanThiHanh_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            {
                xrTableCell_NoiNhanThiHanh.Text = "- Cơ quan công an, "+ GetCurrentColumnValue("ISBICAN") +";";
            }
            else
            {
                xrTableCell_NoiNhanThiHanh.Text = "- Đơn vị Cảnh vệ, " + GetCurrentColumnValue("ISBICAN") + ";";
            }
        }
