<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Soluongthamphan.aspx.cs" Inherits="WEB.GSTP.BaoCao.GSTP.Soluongthamphan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="truong">
                ...
                <table class="table1">
                    <tr>
                        <td><b>Đơn vị</b></td>
                        <td colspan="5">
                            <asp:DropDownList CssClass="chosen-select" ID="ddlToaAn" runat="server" Width="700px"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        <td colspan="5">
                            <asp:CheckBox ID="ChkAllChild" runat="server" Text="Bao gồm đơn vị cấp dưới" /></td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="txtTenTP" CssClass="user" runat="server" Width="382px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td><b>Địa chỉ</b></td>
                    ...
                    <tr>
                        ...
                        <td class="lblEditDMCanBoCol5"><b>Số điện thoại</b></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><b>Ngày bãi nhiệm</b></td>
                        <td>
                            <asp:TextBox ID="txtNgayBaiNhiem" runat="server" CssClass="user" Width="108px" MaxLength="10"></asp:TextBox>
                            <cc1:CalendarExtender ID="CalendarExtender5" runat="server" TargetControlID="txtNgayBaiNhiem" Format="dd/MM/yyyy" Enabled="true" />
                            <cc1:MaskedEditExtender ID="MaskedEditExtender5" runat="server" TargetControlID="txtNgayBaiNhiem" Mask="99/99/9999" MaskType="Date" CultureName="vi-VN" ErrorTooltipEnabled="true" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            <asp:DropDownList ID="ddlTinhtrang" runat="server" CssClass="chosen-select" Width="134px">
                                <asp:ListItem Text="-- Tất cả --" Value="99"></asp:ListItem>
                                ...
                                <asp:ListItem Text="Bãi nhiệm" Value="3"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <td colspan="5">
                            <asp:Button ID="cmdXem" runat="server" Style="margin-bottom: 10px;" CssClass="buttoninput" Text="Xem báo cáo" OnClick="cmdXem_Click" OnClientClick="return kiemtra();" />
                        </td>
                    </tr>
                </table>
    ...
    <script type="text/javascript">
        function kiemtra() {
            ...
            var txtNgayBaiNhiem = document.getElementById('<%=txtNgayBaiNhiem.ClientID%>');
            if (txtNgayBaiNhiem.value.trim().length > 0) {
                var arr = txtNgayBaiNhiem.value.split('/');
                var D = new Date(arr[2] + '-' + arr[1] + '-' + arr[0]);
                if (D.toString() == "NaN" || D.toString() == "Invalid Date") {
                    alert('Bạn phải nhập ngày bãi nhiệm theo định dạng (dd/MM/yyyy).');
                    txtNgayBaiNhiem.focus();
                    return false;
                }
            }
            return true;
