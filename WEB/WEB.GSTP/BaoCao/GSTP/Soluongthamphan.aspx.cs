...
{
    public partial class Soluongthamphan : System.Web.UI.Page
    {
        ...
        private void LoadReport()
        {
            ...
            decimal ToaAn = Convert.ToDecimal(ddlToaAn.SelectedValue), 
                    TinhTrang = Convert.ToDecimal(ddlTinhtrang.SelectedValue),
            ...
            string MaTP = txtMaTP.Text.Trim().ToLower(), 
                   ...
                   NgayBaiNhiem = txtNgayBaiNhiem.Text, 
            ...
            DataTable tbl = bl.REPORT_SOLUONG_TP(ToaAn, MaTP, TenTP, DiaChi, GioiTinh, SoCMND, NgaySinh, SoDienThoai, ChucDanh, ChucVu, NgayNhanCT,
                                                 NgayBoNhiem, NgayKetThuc, NgayBaiNhiem, LoaiAn_HS, LoaiAn_DS, LoaiAn_HC, LoaiAn_HN, LoaiAn_KT, LoaiAn_LD, LoaiAn_PS, LoaiAn_XLHC, TinhTrang, GomDonViCapDuoi);
            if (tbl != null && tbl.Rows.Count > 0)
            {
                string DataSetName = "DataSet1", reportName = "Soluongthamphan.rdlc";
