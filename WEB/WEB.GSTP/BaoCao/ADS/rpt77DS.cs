...
namespace WEB.GSTP.BaoCao.ADS
{
    public partial class rpt77DS : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void Detail_ThamPhanDK_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void Detail_KSVDK_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void xrTable_ND_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void xrTable_ND_Ten_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)DetailReport_NguyenDon.GetCurrentRow();
            if (r == null || r.DataView.Count == 0)
            {
        ...
        private void xrTable_ND_SDT_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)DetailReport_NguyenDon.GetCurrentRow();
            if (r == null || r.DataView.Count == 0)
            {
        ...
        private void xrTable_ND_Email_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)DetailReport_NguyenDon.GetCurrentRow();
            if (r == null || r.DataView.Count == 0)
            {
        ...
        private void xrTable_BD_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void xrTable_BD_Ten_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)DetailReport_BiDon.GetCurrentRow();
            if (r == null || r.DataView.Count == 0)
            {
        ...
        private void xrTable_BD_SDT_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)DetailReport_BiDon.GetCurrentRow();
            if (r == null || r.DataView.Count == 0)
            {
        ...
        private void xrTable_BD_Email_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)DetailReport_BiDon.GetCurrentRow();
            if (r == null || r.DataView.Count == 0)
            {
