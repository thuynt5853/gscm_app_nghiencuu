...
namespace WEB.GSTP.BaoCao.ADS
{
    public partial class rpt30DS : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void SubBand_ND_SDT_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)DetailReport_ND.GetCurrentRow();
        ...
        private void SubBand_ND_Email_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)DetailReport_ND.GetCurrentRow();
            if (r.Row["EMAIL"] + "" == "")
            {
        ...
        private void SubBand_BD_SDT_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)DetailReport_BD.GetCurrentRow();
            if (r.Row["DIENTHOAI"] + "" == "" && r.Row["FAX"] + "" == "")
            {
        ...
        private void SubBand_BD_Email_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)DetailReport_BD.GetCurrentRow();
            if (r.Row["EMAIL"] + "" == "")
            {
        ...
        private void SubBand_NVLQ_SDT_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)DetailReport_NVLQ.GetCurrentRow();
            if (r.Row["DIENTHOAI"] + "" == "" && r.Row["FAX"] + "" == "")
            {
        ...
        private void SubBand_NVLQ_Email_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)DetailReport_NVLQ.GetCurrentRow();
            if (r.Row["EMAIL"] + "" == "")
            {
        ...
        private void Detail_sodienthoai_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void GroupHeader_Email_BeforePrint(object sender, CancelEventArgs e)
        {
