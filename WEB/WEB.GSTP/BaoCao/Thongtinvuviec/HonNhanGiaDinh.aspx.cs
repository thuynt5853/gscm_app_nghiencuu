...
{
    public partial class HonNhanGiaDinh : System.Web.UI.Page
    {
        ...
        private void LoadTreeGiaiDoan()
        {
            ...
            {
                DonID = Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH] + "" == "" ? 0 : Convert.ToDecimal(Session[ENUM_LOAIAN.AN_HONNHAN_GIADINH] + "");
            }
            if (this.hsID != 0)
            {
                DonID = this.hsID;
            ...
            AHN_SOTHAM_THULY st = dt.AHN_SOTHAM_THULY.Where(x => x.DONID == DonID).FirstOrDefault<AHN_SOTHAM_THULY>();
            if (st != null)
            {
                XML = "<menuitem value='st' Text='Sơ thẩm " + ((DateTime)st.NGAYTHULY).ToString("dd/MM/yyyy") + "'></menuitem>";
            }
            AHN_PHUCTHAM_THULY pt = dt.AHN_PHUCTHAM_THULY.Where(x => x.DONID == DonID).FirstOrDefault<AHN_PHUCTHAM_THULY>();
            if (pt != null)
            {
        ...
        private void LoadData()
        {
            ...
            AHN_SOTHAM_BL oBLST = new AHN_SOTHAM_BL();
            AHN_PHUCTHAM_BL oBLPT = new AHN_PHUCTHAM_BL();
            DataTable oDT = null;
            ...
            if (pnThuLy.Visible)
            {
                ...
                {
                    oDT = oBLST.AHN_SOTHAM_THULY_GETLIST(DonID);
                }
                else if (hddGiaiDoan.Value == "pt")
                {
                    oDT = oBLPT.AHN_PHUCTHAM_THULY_GETLIST(DonID);
                }
            ...
            else if (pnHDXX.Visible)
            {
                if (hddGiaiDoan.Value == "st")
                {
                    oDT = oBLST.AHN_SOTHAM_HDXX_GETLIST(DonID);
                }
                else if (hddGiaiDoan.Value == "pt")
                {
                    oDT = oBLPT.AHN_PHUCTHAM_HDXX_GETLIST(DonID);
                }
                if (oDT != null && oDT.Rows.Count > 0)
                {
            ...
            {
                AHN_DON_DUONGSU_BL oBLDS = new AHN_DON_DUONGSU_BL();
                if (hddGiaiDoan.Value == "st")
                {
                    oDT = oBLDS.AHN_DON_DUONGSU_GETBY(DonID);
                }
                else if (hddGiaiDoan.Value == "pt")
                {
                    oDT = oBLDS.AHN_PHUCTHAM_DUONGSU_GETBY(DonID, 0);
                }
                if (oDT != null && oDT.Rows.Count > 0)
                {
            ...
            else if (pnQuyetDinh.Visible)
            {
                if (hddGiaiDoan.Value == "st")
                {
                    oDT = oBLST.AHN_SOTHAM_QUYETDINH_GETLIST(DonID);
                }
                else if (hddGiaiDoan.Value == "pt")
                {
                    oDT = oBLPT.AHN_PHUCTHAM_QUYETDINH_GETLIST(DonID);
                }
                if (oDT != null && oDT.Rows.Count > 0)
                {
            ...
            else if (pnBanAn.Visible)
            {
                if (hddGiaiDoan.Value == "st")
                {
                    oDT = oBLST.AHN_SOTHAM_BANAN_CHITIET(DonID);
                }
                else if (hddGiaiDoan.Value == "pt")
                {
                    oDT = oBLPT.AHN_PHUCTHAM_BANAN_CHITIET(DonID);
                }
                if (oDT != null && oDT.Rows.Count > 0)
                {
            ...
            {
                oDT = oBLST.AHN_SOTHAM_KCaoKNghi_GETLIST(DonID);
