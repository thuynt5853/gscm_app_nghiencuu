<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HonNhanGiaDinh.aspx.cs" Inherits="WEB.GSTP.BaoCao.Thongtinvuviec.HonNhanGiaDinh" %>
                                        ...
                                        <td>
                                            ...
                                            <asp:Panel ID="pnKhangNghi" runat="server" Visible="false">
                                                <asp:DataGrid ID="dgListKhangNghi" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    ItemStyle-CssClass="chan" Width="100%">
                                                    <Columns>
                                                        <asp:TemplateColumn HeaderStyle-Width="40px" ItemStyle-Width="20px" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="header_td" ItemStyle-HorizontalAlign="Center">
                                                            <HeaderTemplate>TT</HeaderTemplate>
                                                            <ItemTemplate><%# Container.DataSetIndex + 1 %></ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        ...
                                                        <asp:BoundColumn DataField="NguoiKCCapKN" HeaderText="Cấp kháng nghị" HeaderStyle-Width="90px" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="header_td"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="LoaiKCKN" HeaderText="Loại kháng nghị" HeaderStyle-Width="92px" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="header_td"></asp:BoundColumn>
