...
{
    public partial class KinhDoanhThuongMai : System.Web.UI.Page
    {
        ...
        private void LoadTreeGiaiDoan()
        {
            ...
            AKT_SOTHAM_THULY st = dt.AKT_SOTHAM_THULY.Where(x => x.DONID == DonID).FirstOrDefault<AKT_SOTHAM_THULY>();
            if (st != null)
            {
                XML = "<menuitem value='st' Text='Sơ thẩm " + ((DateTime)st.NGAYTHULY).ToString("dd/MM/yyyy") + "'></menuitem>";
            }
            AKT_PHUCTHAM_THULY pt = dt.AKT_PHUCTHAM_THULY.Where(x => x.DONID == DonID).FirstOrDefault<AKT_PHUCTHAM_THULY>();
            if (pt != null)
            {
        ...
        private void LoadData()
        {
            ...
            AKT_SOTHAM_BL oBLST = new AKT_SOTHAM_BL();
            AKT_PHUCTHAM_BL oBLPT = new AKT_PHUCTHAM_BL();
            DataTable oDT = null;
            ...
            if (pnThuLy.Visible)
            {
                ...
                {
                    oDT = oBLST.AKT_SOTHAM_THULY_GETLIST(DonID);
                }
                else if (hddGiaiDoan.Value == "pt")
                {
                    oDT = oBLPT.AKT_PHUCTHAM_THULY_GETLIST(DonID);
                }
            ...
            else if (pnHDXX.Visible)
            {
                if (hddGiaiDoan.Value == "st")
                {
                    oDT = oBLST.AKT_SOTHAM_HDXX_GETLIST(DonID);
                }
                else if (hddGiaiDoan.Value == "pt")
                {
                    oDT = oBLPT.AKT_PHUCTHAM_HDXX_GETLIST(DonID);
                }
                if (oDT != null && oDT.Rows.Count > 0)
                {
            ...
            {
                AKT_DON_DUONGSU_BL oBLDS = new AKT_DON_DUONGSU_BL();
                if (hddGiaiDoan.Value == "st")
                {
                    oDT = oBLDS.AKT_DON_DUONGSU_GETBY(DonID);
                }
                else if (hddGiaiDoan.Value == "pt")
                {
                    oDT = oBLDS.AKT_PHUCTHAM_DUONGSU_GETBY(DonID, 0);
                }
                if (oDT != null && oDT.Rows.Count > 0)
                {
            ...
            else if (pnQuyetDinh.Visible)
            {
                if (hddGiaiDoan.Value == "st")
                {
                    oDT = oBLST.AKT_SOTHAM_QUYETDINH_GETLIST(DonID);
                }
                else if (hddGiaiDoan.Value == "pt")
                {
                    oDT = oBLPT.AKT_PHUCTHAM_QUYETDINH_GETLIST(DonID);
                }
                if (oDT != null && oDT.Rows.Count > 0)
                {
            ...
            else if (pnBanAn.Visible)
            {
                if (hddGiaiDoan.Value == "st")
                {
                    oDT = oBLST.AKT_SOTHAM_BANAN_CHITIET(DonID);
                }
                else if (hddGiaiDoan.Value == "pt")
                {
                    oDT = oBLPT.AKT_PHUCTHAM_BANAN_CHITIET(DonID);
                }
                if (oDT != null && oDT.Rows.Count > 0)
                {
            ...
            {
                oDT = oBLST.AKT_SOTHAM_KCaoKNghi_GETLIST(DonID);
