<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PhaSan.aspx.cs" Inherits="WEB.GSTP.BaoCao.Thongtinvuviec.PhaSan" %>
                                            ...
                                            <asp:Panel ID="pnThuLy" runat="server" Visible="false">
                                                <asp:DataGrid ID="dgListThuLy" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="SOTHULY" HeaderText="Số thụ lý" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="header_td" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                        ...
                                                        <asp:BoundColumn DataField="THOIHANTUNGAY" HeaderText="Thời hạn từ" HeaderStyle-Width="75px" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="header_td" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="THOIHANDENNGAY" HeaderText="Thời hạn đến ngày" HeaderStyle-Width="108px" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="header_td" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                        ...
                                                        <asp:BoundColumn DataField="QuanHePLTK" HeaderText="QHPL dùng cho thống kê" HeaderStyle-Width="170px" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="header_td"></asp:BoundColumn>--%>
                                                    </Columns>
                                            ...
                                            <asp:Panel ID="pnDuongSu" runat="server" Visible="false">
                                                <asp:DataGrid ID="dgListDuongSu" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="DAIDIEN" HeaderText="Đại diện" HeaderStyle-Width="47px" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="header_td" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                    </Columns>
                                                    <ItemStyle CssClass="chan"></ItemStyle>
                                                    <PagerStyle Visible="false"></PagerStyle>
                                                </asp:DataGrid>
                                            ...
                                            <asp:Panel ID="pnBanAn" runat="server" Visible="false">
                                                <asp:DataGrid ID="dgListBanAn" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="NGAYTUYENAN" HeaderText="Ngày quyết định" HeaderStyle-Width="65px" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="header_td" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="QuyetDinh" HeaderText="Quyết định" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="header_td"></asp:BoundColumn>
                                                        ...
                                                        <asp:BoundColumn DataField="QUAHAN" HeaderText="Vụ việc quá hạn luật định" HeaderStyle-Width="145px" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="header_td" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                    </Columns>
                                                    <ItemStyle CssClass="chan"></ItemStyle>
                                                    <PagerStyle Visible="false"></PagerStyle>
                                                </asp:DataGrid>
                                            ...
                                            <asp:Panel ID="pnKhangCao" runat="server" Visible="false">
                                                <asp:DataGrid ID="dgListKhangCao" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="NGAYQDBA" HeaderText="Ngày BA/QĐ" HeaderStyle-Width="75px" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="header_td" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundColumn>
                                                    </Columns>
                                                    <ItemStyle CssClass="chan"></ItemStyle>
                                                    <PagerStyle Visible="false"></PagerStyle>
                                                </asp:DataGrid>
                                            ...
                                            <asp:Panel ID="pnKhangNghi" runat="server" Visible="false">
                                                <asp:DataGrid ID="dgListKhangNghi" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="SO_QDBA" HeaderText="Số BA/QĐ" HeaderStyle-Width="75px" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="header_td"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="NGAYQDBA" HeaderText="Ngày BA/QĐ" HeaderStyle-Width="75px" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="header_td" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                    </Columns>
                                                    <ItemStyle CssClass="chan"></ItemStyle>
                                                    <PagerStyle Visible="false"></PagerStyle>
                                                </asp:DataGrid>
