<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GSTP.Master" AutoEventWireup="true" CodeBehind="Danhsach.aspx.cs" Inherits="WEB.GSTP.BaoCao.Baocaotinhhuyen.Danhsach" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <link type="text/css" href="../../UI/css/bc/Manager.css" rel="stylesheet" />
    <link type="text/css" href="../../UI/css/bc/TreeView.css" rel="stylesheet" />
    <link type="text/css" href="../../UI/css/bc/bootstrap.css" rel="stylesheet">
    <link type="text/css" href="../../UI/css/bc/common.css" rel="stylesheet">
    <link type="text/css" href="../../UI/css/bc/WebResource.css" rel="stylesheet">
                ...
                <table class="table1">
                    ...
                    <tr>
                        ...
                        <td class="tk_Col2_W">
                            ...
                            <cc1:calendarextender id="CalendarExtender3" runat="server" targetcontrolid="txt_day_from" format="dd/MM/yyyy" enabled="true" />
                            <cc1:maskededitextender id="MaskedEditExtender3" runat="server" targetcontrolid="txt_day_from" mask="99/99/9999" masktype="Date" culturename="vi-VN" errortooltipenabled="true" />
                        </td>
                        ...
                        <td class="tk_Col4_W">
                            ...
                            <cc1:calendarextender id="CalendarExtender2" runat="server" targetcontrolid="txt_day_to" format="dd/MM/yyyy" enabled="true" />
                            <cc1:maskededitextender id="MaskedEditExtender1" runat="server" targetcontrolid="txt_day_to" mask="99/99/9999" masktype="Date" culturename="vi-VN" errortooltipenabled="true" />
                        </td>
                        <td colspan="2"></td>
                    </tr>
                    <tr>
                    ...
                    <tr runat="server" id="id_chapers_tabales">
                        ...
                        <td>
                            <asp:Button ID="cmd_chapters" runat="server" Text="Chọn" OnClientClick="javascript:document.getElementById('id_window_shows_chapters').style.display = 'block';"
                                Height="26px" Width="130px" CssClass="buttoninput" OnClick="cmd_chapters_Click" />
                        </td>
                        <td></td>
                    </tr>
                    <tr runat="server" id="id_criminal_tabales">
                        ...
                        <td>
                            <asp:Button ID="cmd_crimial_selects" runat="server" Text="Chọn" OnClientClick="javascript:document.getElementById('id_window_shows_criminal').style.display = 'block';"
                                Height="26px" Width="130px" CssClass="buttoninput" OnClick="cmd_crimial_selects_Click" />
                        </td>
                        <td></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <div style="float: right; padding-top: 15px; padding-bottom: 8px;">
                                <asp:Button ID="cmd_BaoCao" runat="server" CssClass="buttoninput" TabIndex="36"
                                    Height="26px" Text="Báo cáo" Width="68px" OnClick="cmd_BaoCao_Click" />
    ...
    <cc1:ModalPopupExtender ID="MP_Window_courts" runat="server" Y="250" X="250" TargetControlID="id_show_ss"
    ...
    <cc1:ModalPopupExtender ID="MP_Window_Criminal" runat="server" Y="250" X="250" TargetControlID="id_show_s"
    ...
    <cc1:ModalPopupExtender ID="MP_Window_Chapters" runat="server" Y="250" X="250" TargetControlID="id_show_ssss"
    ...
    <cc1:ModalPopupExtender ID="MP_Window_Cases" runat="server" Y="250" X="250" TargetControlID="id_show_sss"
