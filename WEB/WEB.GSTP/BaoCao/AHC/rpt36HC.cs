...
namespace WEB.GSTP.BaoCao.AHC
{
    public partial class rpt36HC : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void Detail_NVLQ_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void Detail_ThamPhan_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void xrTable_ThamPhanDK_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void Detail_KSVDuKhuyet_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)GetCurrentRow();
        ...
        private void Detail_KSV_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void Detail_ttlKSV_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)Detail_KSV.GetCurrentRow();
            if (r == null || r.DataView.Count == 0)
            {
        ...
        private void GroupHeader_ThamPhanDK_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)GetCurrentRow();
            if (r == null || r.DataView.Count == 0 || r["THAMPHANDUKHUYET"] + "" == "")
            {
        ...
        private void Detail_NguoiTGTT_BeforePrint(object sender, CancelEventArgs e)
        {
