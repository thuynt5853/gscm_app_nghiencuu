...
{
    public partial class rpt40HC : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt40HC()
        {
            InitializeComponent();
        ...
        private void DetailReport_KCKN_BeforePrint(object sender, CancelEventArgs e)
        {
            System.Data.DataRowView r = (System.Data.DataRowView)DetailReport_KCKN.GetCurrentRow();
            if (r == null || r.DataView.Count == 0)
            {
                Detail_KCKN.Visible = false;
            }
        }
    }
}
