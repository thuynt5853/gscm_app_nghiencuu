<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AN_PHI.Master" AutoEventWireup="true" CodeBehind="Capnhat.aspx.cs"
    Inherits=" WEB.TP.Quantri.User.Capnhat" %>
    ...
    <div class="content_form" style="width: 70%">
        <div class="content_body">
            <div class="content_form_head">
                <div class="content_form_head_title">SỬA THÔNG TIN NGƯỜI DÙNG</div>
                ...
                <table class="table1" style="margin: 0 auto; width: 65%;">
                    <tr>
                        ...
                        <td align="left" colspan="3">
                            <asp:DropDownList CssClass="chosen-select" ID="ddlDonvi" runat="server" Width="520px" AutoPostBack="True" OnTextChanged="ddlDonvi_TextChanged">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" colspan="3">
                            <asp:DropDownList CssClass="chosen-select" ID="ddlNhomquyen" runat="server" Width="520px">
                            </asp:DropDownList>
                        </td>
                    </tr>
