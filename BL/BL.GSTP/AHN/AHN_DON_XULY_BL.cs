...
namespace BL.GSTP
{
    public class AHN_DON_XULY_BL
    {
        ...
        public DataTable CHECK_AHN_DON_DUONGSU_ANPHI(decimal? DONID, decimal? DONCHITIETID, decimal ISDONCHITIET)
        {
            ...
            return Cls_Comon.GetTableByProcedurePaging("PKG_DUONGSU_ANPHI.CHECK_AHN_DON_DUONGSU_ANPHI", prm);
        }

        public DataTable CHECK_AHN_DON_DUONGSU_ANPHI_V2(decimal? DONID, decimal? DONCHITIETID, decimal ISDONCHITIET)
        {
            OracleParameter[] prm = new OracleParameter[]
            {
                new OracleParameter("vDONID", DONID),
            ...
            return Cls_Comon.GetTableByProcedurePaging("PKG_DUONGSU_ANPHI.CHECK_AHN_DON_DUONGSU_ANPHI_V2", prm);
        }
