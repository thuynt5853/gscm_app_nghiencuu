...
namespace BL.GSTP.AHN
{
    public class AHN_PHUCTHAM_BL
    {
        ...
        public DataTable AHN_PHUCTHAM_THULY_GETLIST(decimal vDONID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("AHN_PHUCTHAM_THULY_GETLIST", parameters);
            return tbl;
        }
        public DataTable AHN_KCKNQDK_PHUCTHAM_THULY_GETLIST(decimal vDONID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_AHN_GS.AHN_KCKNQDK_PHUCTHAM_THULY_GETLIST", parameters);
            return tbl;
        }
        public decimal THULYPTQDK_GETNEWTT(decimal donviID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_AHN_GS.AHN_PHUCTHAMQDK_THULY_GETMAXTT", parameters);
        ...
        //                                                                new OracleParameter("curReturn",OracleDbType.RefCursor, ParameterDirection.Output )
        //                                                              };
        //    DataTable tbl = Cls_Comon.GetTableByProcedurePaging("AHN_PHUCTHAM_THULY_GETMAXTT", parameters);
        //    return Convert.ToDecimal(tbl.Rows[0][0]) + 1;
