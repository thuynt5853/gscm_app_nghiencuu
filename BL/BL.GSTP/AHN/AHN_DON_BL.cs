...
namespace BL.GSTP
{
    public class AHN_DON_BL
    {
      ...
      //          DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_AHN_STPT_DS.AHN_DON_SEARCH_TURNING", parameters);
      //          return tbl;
      //      }
      //      else
      //      {
      ...
      //                  new OracleParameter("Page_Size",PageSize),
      //                  new OracleParameter("curReturn",OracleDbType.RefCursor, ParameterDirection.Output ) };
      //          DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_AHN_GS.DON_SEARCH", parameters);
      //          return tbl;
      //      }
      //  }
           ...
           decimal? V_CHECK_HOAGIAI = 0, decimal? V_HOAGIAI_TRANGTHAI = 0, string V_HOAGIAI_TUNGAY = null, string V_HOAGIAI_DENNGAY = null, string V_QHPLTKID = null)
        {
            ...
            if (V_CHECK_PTQDK == 0)
            {
                ...
                DataTable tbl = Cls_Comon.GetTableByProcedurePaging_baocao("PKG_AHN_STPT_DS.AHN_DON_SEARCH_TURNING", parameters);
                return tbl;
            }
            else
            {
                OracleParameter[] parameters = new OracleParameter[] {
                        ...
                        new OracleParameter("Page_Size",PageSize),
                        new OracleParameter("curReturn",OracleDbType.RefCursor, ParameterDirection.Output ) };
                DataTable tbl = Cls_Comon.GetTableByProcedurePaging_baocao("PKG_STPT_AHN_GS.DON_SEARCH", parameters);
                return tbl;
            }
        }
        ...
        public DataTable DON_CON_SEARCH(decimal donIdGoc, string V_CAP_XET_XU_LOGIN, string V_TEN_VU_AN, string V_QHPL, string V_MA_VU_AN, string V_TENDUONGSU, string V_CAPXX, string V_TOAAN_ID, string V_TINHTRANG_THULY, string V_SOTHULY, string V_NGAYTHULY_TU, string V_NGAYTHULY_DEN, string V_THAMPHAN_ID, string V_TINHTRANG_GIAIQUYET, string V_TUNGAY, string V_DENNGAY, string V_KETQUA, string V_SO_QD, string V_NGAY_QD, string V_THUKY_ID, string V_THOIHAN_GQ, string V_LOAIDON, string V_PT_RKINHNGHIEM, string V_GQDON, string V_UTTPDI, decimal vchecktk, decimal trangThaiVuAn, decimal PageIndex, decimal PageSize)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_AHN_STPT_DS.AHN_DON_CON_SEARCH", parameters);
            return tbl;
        }
        public DataTable DON_SEARCH_PCTP(string V_CAP_XET_XU_LOGIN, string V_TEN_VU_AN, string V_QHPL, string V_MA_VU_AN, string V_TENDUONGSU, string V_CAPXX, string V_TOAAN_ID, string V_TINHTRANG_THULY, string V_SOTHULY, string V_NGAYTHULY_TU, string V_NGAYTHULY_DEN, string V_THAMPHAN_ID, string V_TINHTRANG_GIAIQUYET, string V_TUNGAY, string V_DENNGAY, string V_KETQUA, string V_SO_QD, string V_NGAY_QD, string V_THUKY_ID, string V_THOIHAN_GQ, string V_LOAIDON, string V_PT_RKINHNGHIEM, string V_GQDON, decimal PageIndex, decimal PageSize)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_PCTP_HNGD.DON_SEARCH", parameters);
            return tbl;
        }
        public DataTable DON_SEARCH_PCTP_PRINT(string V_CAP_XET_XU_LOGIN, string V_TEN_VU_AN, string V_QHPL, string V_MA_VU_AN, string V_TENDUONGSU, string V_CAPXX, string V_TOAAN_ID, string V_TINHTRANG_THULY, string V_SOTHULY, string V_NGAYTHULY_TU, string V_NGAYTHULY_DEN, string V_THAMPHAN_ID, string V_TINHTRANG_GIAIQUYET, string V_TUNGAY, string V_DENNGAY, string V_KETQUA, string V_SO_QD, string V_NGAY_QD, string V_THUKY_ID, string V_THOIHAN_GQ, string V_LOAIDON, string V_PT_RKINHNGHIEM, string V_GQDON, decimal PageIndex, decimal PageSize)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_PCTP_HNGD.DON_SEARCH_PRINT", parameters);
            return tbl;
        }
        public bool PHANCONGTP_INS_UP(String V_TRANGTHAI, String V_THAMPHANGQ_ID, String V_DONID, String V_NGAYPHANCONGTP, String V_THAM_PHAN_ID, String V_NGAYPHANCONGLD, String V_PHANCONGLD_ID, String V_CAPXX, String V_NGUOITAO, ref Decimal V_COUNTS, ref String V_THONGBAO)
        {
            ...
            OracleCommand comm = new OracleCommand("PKG_PCTP_HNGD.PCTP_INS_UP", conn);
        ...
        public decimal GETNEWTT(decimal donviID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("AHN_DON_GETMAXTT", parameters);
            return Convert.ToDecimal(tbl.Rows[0][0]) + 1;

        }

        public decimal CHECKSTT_AHN(decimal donviID, decimal vMaGiaiDoan, decimal vNam, decimal vLoaiFile, decimal vSTT, string vSTB_Phu, decimal vID)
        {
            OracleParameter[] parameters = new OracleParameter[] {
                                                                        new OracleParameter("vdonviID",donviID),
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_HNGD.AHN_FILE_CHECKSTT_ANPHI", parameters);
            return Convert.ToDecimal(tbl.Rows[0][0]);

        }
        public decimal CHECKSTT_ANPHI_AHN_ANPHI(decimal donviID, decimal vMaGiaiDoan, decimal vNam, decimal vLoaiFile, decimal vSTT)
        {
            OracleParameter[] parameters = new OracleParameter[] {
                                                                        new OracleParameter("vdonviID",donviID),
                                                                        new OracleParameter("vMaGiaiDoan",vMaGiaiDoan),
        ...
        public DataTable AHN_DON_TGTT_GETLIST(decimal vDONID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("AHN_DON_TGTT_GETLIST", parameters);
            return tbl;
        }
        public DataTable AHN_DON_BanGiaoTaiLieu_GETLIST(decimal vDONID)
        {
            OracleParameter[] parameters = new OracleParameter[] {
                new OracleParameter("vDONID",vDONID),
                new OracleParameter("curReturn",OracleDbType.RefCursor, ParameterDirection.Output )
            };
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("AHN_DON_BGTL_GETLIST", parameters);
            return tbl;
        }
        public DataTable AHN_DON_BGTT_GETINFO(decimal vDONID, string NguoiGiao, decimal NguoiNhan, string NgayBanGiao)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("AHN_DON_BGTT_GETINFO", parameters);
            return tbl;
        }
        public DataTable AHN_DON_GETTOAANBYVUVIEC(decimal vDonID)
        {
            ...
            return Cls_Comon.GetTableByProcedurePaging("AHN_DON_GETTOAANBYVUVIEC", prm);
        }
        public DataTable AHN_TONGDAT_DOITUONG_GETBY(decimal vDONID, decimal vTOAANID, decimal vBIEUMAUID, decimal vIsOnlyNKK)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("AHN_TONGDAT_DOITUONG_GETBY", parameters);
            return tbl;
        }
        public DataTable AHN_TONGDAT_GETLIST(decimal vDONID, decimal vToaAnID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("AHN_TONGDAT_GETLIST", parameters);
            return tbl;
        }
        public decimal GETFILENEWTT(decimal donviID, decimal vMaGiaiDoan, decimal vNam, decimal vLoaiFile)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("AHN_FILE_GETMAXTT", parameters);
            return Convert.ToDecimal(tbl.Rows[0][0]) + 1;

        }

        public DataTable AHN_FILE_TONGDAT(decimal vDonID)
        {
            OracleParameter[] parameters = new OracleParameter[] {
                                                                        new OracleParameter("vDonID",vDonID),
                                                                        new OracleParameter("curReturn",OracleDbType.RefCursor, ParameterDirection.Output )
                                                                      };
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("AHN_FILE_TONGDAT", parameters);
            return tbl;
        }
        public bool DELETE_ALLDATA_BY_VUANID(string donID)
        {
            try
            {
                ...
                decimal dbl = Cls_Comon.ExcuteProcResult("PKG_GSTP_DELETE.DELETE_DATA_AHN_BY_VUANID", parameters);
        ...
        {
            AHN_DON _don = dt.AHN_DON.Where(x => x.ID == DonID).FirstOrDefault();
            if (_don != null)
            {
                if (_don.MAGIAIDOAN == ENUM_GIAIDOANVUAN.SOTHAM || _don.MAGIAIDOAN == ENUM_GIAIDOANVUAN.HOSO)
                {
                    AHN_SOTHAM_THULY ObjThuLy = dt.AHN_SOTHAM_THULY.Where(x => x.DONID == DonID).FirstOrDefault();
                    return ObjThuLy != null;
                }
                else if (_don.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM)
                {
                    AHN_PHUCTHAM_THULY ObjThuLy = dt.AHN_PHUCTHAM_THULY.Where(x => x.DONID == DonID).FirstOrDefault();
                    return ObjThuLy != null;
                }
                else if (_don.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM_QDK)
                {
                    AHN_KCKNQDK_PHUCTHAM_THULY ObjThuLy = DataExtensions.GetAllByDonId<AHN_KCKNQDK_PHUCTHAM_THULY>(DonID).FirstOrDefault();
                    return ObjThuLy != null;
                }
            }
            return false;
        }
        public DataTable AHN_ANPHI_GETBYDONID(decimal donID, int tinhTrang, int PageIndex, int PageSize)
        {
            OracleParameter[] parameters = new OracleParameter[] {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("AHN_DON_ANPHI_GETBYDONID", parameters);
            return tbl;
        }

        public DataTable AHN_ANPHI_GETBYDONID_V2(decimal donID, int tinhTrang, int PageIndex, int PageSize)
        {
            OracleParameter[] parameters = new OracleParameter[] {
                                                                        new OracleParameter("CurrDonID",donID),
                                                                        new OracleParameter("V_TINHTRANG",tinhTrang),
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_AHN.AHN_DON_ANPHI_GETBYDONID_V2", parameters);
            return tbl;
        }

        public DataTable AHN_ANPHI_LICHSU_GETBYDONID(decimal donID, decimal anPhiId, int tinhTrang, int PageIndex, int PageSize)
        {
            OracleParameter[] parameters = new OracleParameter[] {
                                                                        new OracleParameter("CurrDonID",donID),
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_AHN.AHN_DON_ANPHI_LICHSU_GETBYDONID", parameters);
            return tbl;
        }
        ...
        public void CAPNHAT_DON_GOC_ID(decimal donGocID, decimal donConID)
        {
            ...
            Cls_Comon.GetTableByProcedurePaging("PKG_STPT_NHAPAN.AHN_UPDATE", parameters);
        }
        ...
        public DataTable DON_QUAHAN(string V_CAP_XET_XU_LOGIN, string V_TOAAN_ID, string V_DS_DONID, decimal PAGE_INDEX, decimal PAGE_SIZE)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_AHN_STPT_DS_TKQUAHAN.AHN_DON_QUAHAN", parameters);
            return tbl;
        }
        ...
        public DataTable DON_QUAHAN_CHITIET(string V_CAP_XET_XU_LOGIN, string V_TOAAN_ID, string V_TK_QUAHAN_ID, string V_DS_DONID, decimal PAGE_INDEX, decimal PAGE_SIZE)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_AHN_STPT_DS_TKQUAHAN.AHN_DON_QUAHAN_CHITIET", parameters);
            return tbl;
        }
    }
}