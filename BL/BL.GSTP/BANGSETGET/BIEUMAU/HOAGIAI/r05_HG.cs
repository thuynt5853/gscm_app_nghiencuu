...
namespace BL.GSTP.BANGSETGET.BIEUMAU.HOAGIAI
{
    ...
    ///(9) Ghi tên và địa chỉ của người khởi kiện/người yêu cầu, người bị kiện nếu là cá nhân thì ghi họ tên, địa chỉ nơi 
    ...
    public partial class r05_HG
    {
        ...
        /// <summary>
        /// (9) Ghi tên và địa chỉ của người khởi kiện/người yêu cầu, người bị kiện nếu là cá nhân thì ghi họ tên, địa chỉ 
        /// nơi cư trú và nơi làm việc; nếu là cơ quan, tổ chức thì ghi tên, địa chỉ của cơ quan, tổ chức. Cần lưu ý đối với 
        /// cá nhân, thì tùy theo độ tuổi mà ghi Ông hoặc Bà, Anh hoặc Chị trước khi ghi họ tên (ví dụ: Kính gửi: Anh Trần Văn B).
        /// </summary>
