...
namespace BL.GSTP.BANGSETGET.BIEUMAU.HOAGIAI
{
    ...
    ///tỉnh thì ghi rõ tên Tòa án nhân dân huyện, quận, thị xã, thành phố thuộc tỉnh, thành phố trực thuộc Trung ương nào
    ///(ví dụ: TÒA ÁN NHÂN DÂN HUYỆN THƯỜNG TÍN); nếu là Tòa án nhân dân tỉnh, thành phố trực thuộc Trung ương thì ghi Tòa
    ...
    ///(5) và(6) Ghi tên và địa chỉ người khởi kiện, người bị kiện, người có quyền lợi, nghĩa vụ liên quan; nếu là cá nhân 
    ///thì ghi họ tên, địa chỉ nơi cư trú và nơi làm việc; nếu là cơ quan, tổ chức thì ghi tên, địa chỉ của cơ quan, tổ chức.
    ///Cần lưu ý đối với cá nhân, thì tùy theo độ tuổi mà ghi Ông hoặc Bà, Anh hoặc Chị trước khi ghi họ tên(ví dụ: “Kính gửi: 
    ///Anh Trần Văn B”).
    ...
    public partial class r07_DT
    {
        ...
        /// <summary>
        /// (5) và (6) Ghi tên và địa chỉ người khởi kiện, người bị kiện, người có quyền lợi, nghĩa vụ liên quan; nếu là cá 
        /// nhân thì ghi họ tên, địa chỉ nơi cư trú và nơi làm việc; nếu là cơ quan, tổ chức thì ghi tên, địa chỉ của cơ quan,
        /// tổ chức. Cần lưu ý đối với cá nhân, thì tùy theo độ tuổi mà ghi Ông hoặc Bà, Anh hoặc Chị trước khi ghi họ tên (ví
        /// dụ: “Kính gửi: Anh Trần Văn B”).
        /// </summary>
        ...
        /// <summary>
        /// (8) Ghi tên người được gửi thông báo. Cần lưu ý đối với cá nhân, thì tùy theo độ tuổi mà ghi Ông hoặc Bà, Anh hoặc
        /// Chị trước khi ghi họ tên (ví dụ: “Kính gửi: Anh Trần Văn B”).
        /// </summary>
        public String NGUOI_NHAN { get; set; }
        public String DIACHI_TOA_HIEN_TAI { get; set; }
