...
namespace BL.GSTP.BANGSETGET.BIEUMAU.HOAGIAI
{
    ...
    ///(6) Ghi tên và địa chỉ người khởi kiện, người bị kiện; nếu là cá nhân thì ghi họ tên, địa chỉ nơi cư trú và nơi làm 
    ...
    ///định Hòa giải viên là “Xét lựa chọn Hòa giải viên của người khởi kiện”, “Xét lựa chọn Hòa giải viên của người khởi 
    ///kiện và sự đồng ý của Hòa giải viên được lựa chọn và Tòa án nơi Hòa giải viên đó làm việc”, “Xét thỏa thuận lựa chọn 
    ///Hòa giải viên của các bên”, “Xét việc người khởi kiện không lựa chọn Hòa giải viên”. Nếu là quyết định thay đổi Hòa 
    ///giải viên theo sự đề nghị của người bị kiện thì ghi “Xét đề nghị thay đổi Hòa giải viên của người bị kiện”.
    ...
    public partial class r06_DT
    {
        ...
        /// giải viên theo sự đề nghị của người bị kiện thì ghi “Xét đề nghị thay đổi Hòa giải viên của người bị kiện”.
        /// </summary>
        public String XET_QUYET_DINH { get; set; }
