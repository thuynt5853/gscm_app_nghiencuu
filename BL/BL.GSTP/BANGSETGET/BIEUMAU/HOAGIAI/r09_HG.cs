...
namespace BL.GSTP.BANGSETGET.BIEUMAU.HOAGIAI
{
    ...
    public partial class r09_HG
    {
        ...
        /// <summary>
        /// (2) và (5) Ghi tên Tòa án nhân dân gửi giấy mời, nếu là Tòa án nhân dân huyện, quận, thị xã, thành phố 
        ...
        /// <summary>
        /// (3) và (4) Nếu là cá nhân thì ghi họ tên, địa chỉ nơi cư trú và nơi làm việc; nếu là cơ quan, tổ chức thì 
        /// ghi tên, địa chỉ của cơ quan, tổ chức. Cần lưu ý đối với cá nhân, thì tùy theo độ tuổi mà ghi Ông hoặc Bà, 
        ...
        public String DIACHI_TOA { get; set; }
