...
{
    public class STPT_KHANGNGHIQUAHAN
    {
        public decimal SOTHULY_GETMAXTT(decimal VTOAANID, decimal VLOAIKHANGNGHI, string VNGAYTHULY)
        {
            try
            {
                OracleParameter[] parameters = new OracleParameter[] {  new OracleParameter("VTOAANID",VTOAANID),
                                                                    new OracleParameter("VLOAIKHANGNGHI",VLOAIKHANGNGHI),
                                                                    new OracleParameter("VNGAYTHULY",VNGAYTHULY),
                                                                    new OracleParameter("curReturn",OracleDbType.RefCursor, ParameterDirection.Output )
                                                                      };
                DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_KHANGNGHIQUAHAN.SOTHULY_GETMAXTT", parameters);
        ...
        public bool SOTHULY_GETMAXTT_CHECK(decimal VTOAANID, decimal VLOAIKHANGNGHI, string VSOTHULY, string VNGAYTHULY)
        {
            try
            {
                OracleParameter[] parameters = new OracleParameter[] {  new OracleParameter("VTOAANID",VTOAANID),
                ...
                DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_KHANGNGHIQUAHAN.SOTHULY_GETMAXTT_CHECK", parameters);
        ...
        public decimal SOQUYETDINH_GETMAXTT(decimal VTOAANID, string VNGAYQUYETDINH)
        {
            try
            {
                ...
                DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_KHANGNGHIQUAHAN.SOQUYETDINH_GETMAXTT", parameters);
                return Convert.ToDecimal(tbl.Rows[0][0]) + 1;
            }
            catch (Exception ex)
            {
        ...
        public bool SOQUYETDINH_GETMAXTT_CHECK(decimal VTOAANID, string VSOQUYETDINH, string VNGAYQUYETDINH)
        {
            try
            {
                ...
                DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_KHANGNGHIQUAHAN.SOQUYETDINH_GETMAXTT_CHECK", parameters);
                return tbl.Rows.Count > 0 ? true : false;
            }
            catch (Exception ex)
            {
        ...
        public DataTable KHANGCAOQUAHAN_HDXX_GETLIST(decimal vDONID, decimal VTHULYID, decimal VLOAIAN)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_KHANGNGHIQUAHAN.KHANGCAOQUAHAN_HDXX_GETLIST", parameters);
            return tbl;
        }
        public DataTable KHANGCAOQUAHAN_HDXX_GETBYID(decimal vDONID, decimal VTHULYID, decimal VLOAIAN, decimal VID_HDXX)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_KHANGNGHIQUAHAN.KHANGCAOQUAHAN_HDXX_GETBYID", parameters);
            return tbl;
        }
        public DataTable KHANGCAOQUAHAN_THULY_GETLAST(decimal vDONID, decimal VLOAIAN, decimal VKHANGCAOID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_KHANGNGHIQUAHAN.KHANGCAOQUAHAN_THULY_GETLAST", parameters);
            return tbl;
        }
        public DataTable KHANGCAOQUAHAN_QUYETDINH_GETLAST(decimal vDONID, decimal VTHULYID, decimal VLOAIAN)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_KHANGNGHIQUAHAN.KHANGCAOQUAHAN_QUYETDINH_GETLAST", parameters);
            return tbl;
        }
        ...
        #region Tìm kiếm
        public DataTable ADS_PT_KCQUAHAN(decimal VLOAIAN, decimal VDONVIID, string VMAVUVIEC, string VTENVUVIEC, string VSOBAQD, string VNGAYBAQD, string VNGUOIKN, string VKCTUNGAY, string VKCDENNGAY,
                                            ...
                                            string VCHECKEDLIST, decimal VPAGEINDEX, decimal VPAGESIZE)
        {
            try
            {
                OracleParameter[] parameters = new OracleParameter[] {  new OracleParameter("VLOAIAN",VLOAIAN),
                                                                    ...
                                                                    new OracleParameter("VNGUOIKN",VNGUOIKN),
                ...
                DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_KHANGNGHIQUAHAN_TIMKIEM.XLHC_PT_KNQUAHAN", parameters);
                return tbl;
            }
            catch (Exception ex)
            {
