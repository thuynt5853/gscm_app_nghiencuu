...
{
    public class AKT_KCKN_PHUCTHAM_BL
    {
        ...
        public DataTable AKT_PHUCTHAM_THULY_GETLIST(decimal vDONID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_AKT_GS.AKT_KCKNQDK_PHUCTHAM_THULY_GETLIST", parameters);
            return tbl;
        }
        public decimal THULY_GETNEWTT(decimal donviID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_AKT_GS.AKT_PHUCTHAMQDK_THULY_GETMAXTT", parameters);
        ...
        public DataTable AKT_KCKNQDK_PHUCTHAM_QUYETDINH_GETLIST(decimal vDONID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_AKT_GS.AKT_KCKNQDK_PHUCTHAM_QUYETDINH_GETLIST", parameters);
            return tbl;
        }
        public DataTable AKT_PHUCTHAMKCKNQDK_BANANQUYETDINH_GETLIST(decimal vDONID)
        {
            OracleParameter[] parameters = new OracleParameter[] {
                                                                        new OracleParameter("vDONID",vDONID),
                                                                        new OracleParameter("curReturn",OracleDbType.RefCursor, ParameterDirection.Output )
                                                                      };
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_AKT_GS.AKT_PHUCTHAMQDK_BANANQUYETDINH_GETLIST", parameters);
            return tbl;
        }
        public DataTable AKT_PHUCTHAM_KCKN_TGTT_GETLIST(decimal vDONID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_AKT_GS.AKT_PHUCTHAM_KCKN_TGTT_GETLIST", parameters);
            return tbl;
        }
        ...
        public DataTable AKT_KCKNQDK_PHUCTHAM_HDXX_GETLIST(decimal vDONID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_AKT_GS.AKT_KCKNQDK_PHUCTHAM_HDXX_GETLIST", parameters);
            return tbl;
        }
        ...
        public DataTable AKT_KCKN_DON_THAMPHAN_GETBY(decimal vDONID, string vMaVaiTro)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_AKT_GS.AKT_KCKN_DON_THAMPHAN_GETBY", parameters);
            return tbl;
        }
