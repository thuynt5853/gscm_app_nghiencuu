...
namespace BL.GSTP.AKT
{
    ...
    public class AKT_TOAAN_C06
    {
        public int CheckC06_TOAAN_KDTM(decimal vLoaiBAQD, decimal vBAQDID, string vCapXX)
        {
            ...
            try
            {
                ...
                using (OracleConnection conn = new OracleConnection())
                {
                    ...
                    string sql = @"Select Count(*)  
                                           From C06_TOAAN_KDTM  
                                           WHERE VUANID = :BAQD_ID AND TRANGTHAIAKDTM = 'HIEU_LUC' AND LOAIBAQD = :LOAI_BAQD
                                             AND CAPXX = :CAPXX";
