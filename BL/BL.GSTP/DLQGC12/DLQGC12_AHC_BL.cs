...
{
    public class DLQGC12_AHC_BL
    {
        public DataTable GetAHCPaging_Search_All_DaDongBo_ThuHoi(
            ...
            , decimal PageIndex, decimal PageSize)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_DVCQG_DLDCQG_HC.SEARCH_PAGING_DADONGBO", parameters);
            return tbl;
        }
            ...
            , decimal PageIndex, decimal PageSize)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_DVCQG_DLDCQG_HC.SEARCH_PAGING_CHUADONGBO", parameters);
            return tbl;
        }
