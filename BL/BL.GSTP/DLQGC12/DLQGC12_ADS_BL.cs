...
{
    public class DLQGC12_ADS_BL
    {
        public DataTable GetADSPaging_Search_DaDongBo_ThuHoi(string v_LOAIBAQD, string v_BAQD_id, string v_KHANGCAOQH
            ...
            , decimal PageIndex, decimal PageSize)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_DVCQG_DLDCQG_ADS.EXT_SEARCH_ALL_DaDongBo_ThuHoi", parameters);
            return tbl;
        }
        
        public DataTable GeADSPaging_Search_All(string v_LOAIBAQD, string v_BAQD_id, string v_KHANGCAOQH
            , string v_toaan_id, string v_Capxx, string v_ten_vu_an, string v_toidanh
            , string v_ma_vu_an, string v_bi_can, string v_cccd
            , string v_so_qd, string V_TUNGAY, string V_DENNGAY
            , string v_thamphan_id, string v_thuky_id
            ...
            , decimal PageIndex, decimal PageSize)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_DVCQG_DLDCQG_ADS.EXT_SEARCH_ALL", parameters);
            return tbl;
        }
    }
}