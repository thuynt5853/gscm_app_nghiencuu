...
{
    public class DLQGC12_AKT_BL
    {
        public DataTable GetAKTPaging_Search_All_DaDongBo_ThuHoi(
            ...
            , decimal PageIndex, decimal PageSize)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_DVCQG_DLDCQG_KDTM.SEARCH_PAGING_DADONGBO", parameters);
            return tbl;
        }
            ...
            , decimal PageIndex, decimal PageSize)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_DVCQG_DLDCQG_KDTM.SEARCH_PAGING_CHUADONGBO", parameters);
            return tbl;
        }
