...
namespace BL.GSTP.AHC
{
    public class AHC_NGUOITHAMGIATOTUNG_BL 
    {
        ...
        public DataTable GET_BC_GIAYXX_NBC(string v_ptst,  String vArrSelectID, String VTOAANID, String VCAPXX)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_TOANCAU_STPT_EXT.GXN_HC_NBC", parameters);
            return tbl;
        }
    }
}
