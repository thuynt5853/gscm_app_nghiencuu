...
namespace BL.GSTP.AHC
{
    ...
    public class AHC_TOAAN_C06
    {
        public int CheckC06_TOAAN_HANHCHINH(decimal vLoaiBAQD, decimal vBAQDID, string vCapXX)
        {
            ...
            try
            {
                ...
                using (OracleConnection conn = new OracleConnection())
                {
                    ...
                    string sql = @"Select Count(*)  
                                           From C06_TOAAN_HANHCHINH  
                                           WHERE VUANID = :BAQD_ID AND TRANGTHAIAHC = 'HIEU_LUC' AND LOAIBAQD = :LOAI_BAQD
                                             AND CAPXX = :CAPXX";
