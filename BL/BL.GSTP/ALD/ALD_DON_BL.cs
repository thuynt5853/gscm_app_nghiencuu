...
namespace BL.GSTP
{
    ...
    //            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_ALD_STPT_DS.ALD_DON_SEARCH_TURNING", parameters);
    //            return tbl;
    //        }
    //        else
    //        {
    ...
    //                    new OracleParameter("Page_Size",PageSize),
    //                    new OracleParameter("curReturn",OracleDbType.RefCursor, ParameterDirection.Output ) };
    //            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_ALD_GS.ALD_DON_SEARCH", parameters);
    //            return tbl;
    //        }
    //    }
            ...
            decimal? V_CHECK_HOAGIAI = 0, decimal? V_HOAGIAI_TRANGTHAI = 0, string V_HOAGIAI_TUNGAY = null, string V_HOAGIAI_DENNGAY = null, string V_QHPLTKID = null)
        {
            ...
            if (V_CHECK_PTQDK == 0)
            {
                ...
                DataTable tbl = Cls_Comon.GetTableByProcedurePaging_baocao("PKG_ALD_STPT_DS.ALD_DON_SEARCH_TURNING", parameters);
                return tbl;
            }
            else
            {
                OracleParameter[] parameters = new OracleParameter[] {
                        ...
                        new OracleParameter("Page_Size",PageSize),
                        new OracleParameter("curReturn",OracleDbType.RefCursor, ParameterDirection.Output ) };
                DataTable tbl = Cls_Comon.GetTableByProcedurePaging_baocao("PKG_STPT_ALD_GS.ALD_DON_SEARCH", parameters);
                return tbl;
            }
        }
        public DataTable DON_CON_SEARCH(decimal donIdGoc, string V_CAP_XET_XU_LOGIN, string V_TEN_VU_AN, string V_QHPL, string V_MA_VU_AN, string V_TENDUONGSU, string V_CAPXX, string V_TOAAN_ID, string V_TINHTRANG_THULY, string V_SOTHULY, string V_NGAYTHULY_TU, string V_NGAYTHULY_DEN, string V_THAMPHAN_ID, string V_TINHTRANG_GIAIQUYET, string V_TUNGAY, string V_DENNGAY, string V_KETQUA, string V_SO_QD, string V_NGAY_QD, string V_THUKY_ID, string V_THOIHAN_GQ, string V_LOAIDON, string V_PT_RKINHNGHIEM, string V_GQDON, string V_UTTPDI, decimal vchecktk, decimal trangThaiVuAn, decimal PageIndex, decimal PageSize)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_ALD_STPT_DS.ALD_DON_CON_SEARCH", parameters);
            return tbl;
        }
        ...
        //---------
        public decimal CHECKSTT_ALD(decimal donviID, decimal vMaGiaiDoan, decimal vNam, decimal vLoaiFile, decimal vSTT, string vSTB_Phu, decimal vID)
        {
            OracleParameter[] parameters = new OracleParameter[] {
                                                                        new OracleParameter("vdonviID",donviID),
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_LAODONG.ALD_FILE_CHECKSTT_ANPHI", parameters);
        ...
        {
            ALD_DON _don = dt.ALD_DON.Where(x => x.ID == DonID).FirstOrDefault();
            if (_don != null)
            {
                ...
                {
                    ALD_PHUCTHAM_THULY ObjThuLy = dt.ALD_PHUCTHAM_THULY.Where(x => x.DONID == DonID).FirstOrDefault();
                    return ObjThuLy != null;
                }
                else if (_don.MAGIAIDOAN == ENUM_GIAIDOANVUAN.PHUCTHAM_QDK)
                {
                    ALD_KCKNQDK_PHUCTHAM_THULY ObjThuLy = DataExtensions.GetAllByDonId<ALD_KCKNQDK_PHUCTHAM_THULY>(DonID).FirstOrDefault();
                    return ObjThuLy != null;
                }
            }
            return false;
        }
        public DataTable ALD_ANPHI_GETBYDONID(decimal donID, int tinhTrang, int PageIndex, int PageSize)
        {
            OracleParameter[] parameters = new OracleParameter[] {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("ALD_DON_ANPHI_GETBYDONID", parameters);
            return tbl;
        }

        public DataTable ALD_ANPHI_GETBYDONID_V2(decimal donID, int tinhTrang, int PageIndex, int PageSize)
        {
            OracleParameter[] parameters = new OracleParameter[] {
                                                                        new OracleParameter("CurrDonID",donID),
                                                                        new OracleParameter("V_TINHTRANG",tinhTrang),
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_ALD.ALD_DON_ANPHI_GETBYDONID_V2", parameters);
            return tbl;
        }
        ...
        public void CAPNHAT_DON_GOC_ID(decimal donGocID, decimal donConID)
        {
            ...
            Cls_Comon.GetTableByProcedurePaging("PKG_STPT_NHAPAN.ALD_UPDATE", parameters);
        }

        public DataTable ALD_ANPHI_LICHSU_GETBYDONID(decimal donID, decimal anPhiId, int tinhTrang, int PageIndex, int PageSize)
        {
            OracleParameter[] parameters = new OracleParameter[] {
                                                                        new OracleParameter("CurrDonID",donID),
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_ALD.ALD_ANPHI_LICHSU_GETBYDONID", parameters);
            return tbl;
        }
        ...
        public DataTable DON_QUAHAN(string V_CAP_XET_XU_LOGIN, string V_TOAAN_ID, string V_DS_DONID, decimal PAGE_INDEX, decimal PAGE_SIZE)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_ALD_STPT_DS_TKQUAHAN.ALD_DON_QUAHAN", parameters);
            return tbl;
        }
        ...
        public DataTable DON_QUAHAN_CHITIET(string V_CAP_XET_XU_LOGIN, string V_TOAAN_ID, string V_TK_QUAHAN_ID, string V_DS_DONID, decimal PAGE_INDEX, decimal PAGE_SIZE)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_ALD_STPT_DS_TKQUAHAN.ALD_DON_QUAHAN_CHITIET", parameters);
            return tbl;
        }
    }
}