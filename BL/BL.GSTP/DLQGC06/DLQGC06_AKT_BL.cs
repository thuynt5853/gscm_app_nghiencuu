...
{
    /* GTEL-HUNGNQ 01-10-2025 Đồng bộ C06 cho án Kinh tế */
    public class DLQGC06_AKT_BL
    {
        public DataTable GetAKTPaging_Search_All_ThuHoi(
            ...
            , decimal PageIndex, decimal PageSize)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("DLQGC06_AKT.C06_AKT_SEARCH_THUHOI", parameters);
            return tbl;
        }

        public DataTable GetAKTPaging_Search_All_DaDongBO(
             string V_LOAIAN_ID, string v_LOAIBAQD, string v_BAQD_id, string v_KHANGCAOQH
            , string v_toaan_id, string v_Capxx, string v_ten_vu_an, string v_toidanh
            , string v_ma_vu_an, string v_bi_can, string v_cccd
            , string v_so_qd, string V_TUNGAY, string V_DENNGAY
            ...
            , decimal PageIndex, decimal PageSize)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("DLQGC06_AKT.C06_AKT_SEARCH_DADONGBO", parameters);
            return tbl;
        }


        public DataTable GeAKTPaging_Search_ChuaDongBo(
            string V_LOAIAN_ID, string v_LOAIBAQD, string v_BAQD_id, string v_KHANGCAOQH
            , string v_toaan_id, string v_Capxx, string v_ten_vu_an, string v_toidanh
            , string v_ma_vu_an, string v_bi_can, string v_cccd
            , string v_so_qd, string V_TUNGAY, string V_DENNGAY
            ...
            , decimal PageIndex, decimal PageSize)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("DLQGC06_AKT.C06_AKT_SEARCH_CHUADONGBO", parameters);
            return tbl;
        }

        public bool C06_TOAAN_KDTM_INSERT(C06_TOAAN_KDTM item)
        {
            ...
            try
            {
                ...
                using (OracleConnection conn = new OracleConnection())
                {
                    ...
                    string sql = @"INSERT INTO C06_TOAAN_KDTM(   
                                            ...
                                            TRANGTHAIAKDTM, TRANGTHAIJOBSHARE, VUANID, DUONGSUID, NGAYGUI, TAIKHOANGUI,
                    ...
                    using (cmd = new OracleCommand(sql, conn))
                    {
                        ...
                        cmd.Parameters.Add(new OracleParameter("TRANGTHAIAKDTM", item.TRANGTHAIAKDTM));
        ...
        public DataTable C06_AKT_SEARCH_BY_ID(string vId)
        {
            OracleParameter[] parameters = new OracleParameter[] {
                        new OracleParameter("V_ID",vId),
                        new OracleParameter("curReturn",OracleDbType.RefCursor, ParameterDirection.Output )
                    };
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("DLQGC06_AKT.C06_AKT_SEARCH_BY_ID", parameters);
            return tbl;
        }

        public DataTable C06_AKT_DUONGSU_GETBYID(decimal vduongsuId, string capxx, string loaiBanAnQd)
        {
            OracleParameter[] parameters = new OracleParameter[] {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("DLQGC06_AKT.C06_AKT_DUONGSU_GETBYID", parameters);
            return tbl;
        }
        ...
        public DataTable GETDULIEUCHON_THUHOIGANNHAT(decimal vduongsuId)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("DLQGC06_AKT.getdulieuchon_thuhoigannhat", parameters);
            return tbl;
        }

        public bool ThuHoi_C06_TOAAN_KDTM(string vDongBoID, string ghiChu, string status)
        {
            OracleCommand cmd = null;
            try
            {
                ...
                using (OracleConnection conn = new OracleConnection())
                {
                    ...
                    {
                        sql = @"UPDATE C06_TOAAN_KDTM  set STATUS = :STATUS, TRANGTHAIAKDTM = 'THU_HOI', GHICHU = :GHICHU
                                            WHERE ID = :DongBoID";
                    }
                    else
                    {
                        sql = @"UPDATE C06_TOAAN_KDTM  set STATUS = :STATUS, TRANGTHAIAKDTM = 'THU_HOI'
                                            WHERE ID = :DongBoID";
                    }
        ...
        public bool C06_KhoiPhucBanGhiThuHoi(string vDongBoID)
        {
            ...
            try
            {
                ...
                using (OracleConnection conn = new OracleConnection())
                {
                    ...
                    string sql = @"UPDATE C06_TOAAN_KDTM  set STATUS = 1
                                            WHERE ID = :DongBoID";
                    //string json = JsonConvert.SerializeObject(CONTENT_JSON);
                    using (cmd = new OracleCommand(sql, conn))
                    {
        ...
        public bool XoaC06_TOAAN_KDTM(string vDongBoID)
        {
            OracleCommand cmd = null;
            try
            {
                ...
                using (OracleConnection conn = new OracleConnection())
                {
                    ...
                    string sql = @"Delete from C06_TOAAN_KDTM WHERE ID = :DongBoID";
                    //string json = JsonConvert.SerializeObject(CONTENT_JSON);
                    using (cmd = new OracleCommand(sql, conn))
                    {
                        cmd.Parameters.Add(new OracleParameter("DongBoID", vDongBoID));
        ...
        public bool C06_AKT_ADD_HISTORY(decimal vAKTID, string vLyDo, string vNoiDung, string vNguoiThuHoi, decimal vuanid, decimal duongsuid, string actionType)
        {
            try
            {
                OracleParameter[] parameters = new OracleParameter[] {
                ...
                Cls_Comon.ExcuteProc("DLQGC06_AKT.c06_toaan_kdtm_history_insert", parameters);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public DataTable GetDulieu_LichSuChuyen(string vId)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("DLQGC06_AKT.C06_AKT_HISTORY_BY_ID", parameters);
            return tbl;
        }

        public DataTable C06_AKT_DUONGSU_CDB_GETBY(decimal vduongsuId, string capxx, string sobananorqd, string loaiBanAnQd)
        {
            OracleParameter[] parameters = new OracleParameter[] {
                        new OracleParameter("v_duongsuId",vduongsuId),
                        new OracleParameter("v_capxx",capxx),
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("DLQGC06_AKT.C06_AKT_DUONGSU_CDB_GETBY", parameters);
            return tbl;
        }

        public DataTable C06_AKT_DUONGSU_GUILAI(string vId)
        {
            OracleParameter[] parameters = new OracleParameter[] {
                        new OracleParameter("V_ID",vId),
                        new OracleParameter("curReturn",OracleDbType.RefCursor, ParameterDirection.Output )
                    };
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("DLQGC06_AKT.C06_AKT_DUONGSU_GUILAI", parameters);
            return tbl;
        }
    }
}