...
{
    /* GTEL-HUNGNQ 01-10-2025 Check C06 cho án dân sự */
    public class ADS_TOAAN_C06
    {
        public int CheckC06_TOAAN_DANSU(decimal vLoaiBAQD, decimal vBAQDID, string vCapXX)
        {
            ...
            try
            {
                ...
                using (OracleConnection conn = new OracleConnection())
                {
                    ...
                    string sql = @"Select Count(*)  
                                           From C06_TOAAN_DANSU  
                                           WHERE VUANID = :BAQD_ID AND TRANGTHAIADS = 'HIEU_LUC' AND LOAIBAQD = :LOAI_BAQD
                                             AND CAPXX = :CAPXX";
