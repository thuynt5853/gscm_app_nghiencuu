...
{
    public class ADS_KCKN_PHUCTHAM_BL
    {
        ...
        public DataTable ADS_PHUCTHAM_THULY_GETLIST(decimal vDONID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_ADS_GS.ADS_KCKN_PHUCTHAM_THULY_GETLIST", parameters);
            return tbl;
        }
        public decimal THULY_GETNEWTT(decimal donviID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_ADS_GS.ADS_KCKN_PHUCTHAM_THULY_GETMAXTT", parameters);
        ...
        public DataTable ADS_PHUCTHAM_KCKN_TGTT_GETLIST(decimal vDONID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_ADS_GS.ADS_PHUCTHAM_KCKN_TGTT_GETLIST", parameters);
            return tbl;
        }
        ...
        public DataTable ADS_KCKN_DON_THAMPHAN_GETBY(decimal vDONID, string vMaVaiTro)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_STPT_ADS_GS.ADS_KCKN_DON_THAMPHAN_GETBY", parameters);
            return tbl;
        }
    }
}