...
{
    public class AHS_SOTHAM_NGUOITHAMGIATOTUNG_BL 
    {
        ...
        public bool AHS_NGUOI_DAIDIEN_INS_UP(Decimal NGUOI_TGTT_ID, String BICAO_ID, ref String V_CHECK)
        {
            ...
            OracleCommand comm = new OracleCommand("PKG_TOANCAU_STPT_EXT.NGUOI_DD_INS", conn);
        ...
        public DataTable GET_NTGTT_BCBC(decimal NGUOITGTT_ID)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_TOANCAU_STPT_EXT.GET_BCBC_NGUOITGTT", parameters);
            return tbl;
        }
        public void SO_DK_RETURN(String V_TUCACHID, ref Decimal V_DK, String VTOAANID)
        {
            OracleConnection conn = Cls_Comon.OpenConnection();
            OracleCommand comm = new OracleCommand("PKG_TOANCAU_STPT_EXT.SO_DK", conn);
            comm.CommandType = CommandType.StoredProcedure;
            comm.CommandTimeout = 60; // timeout 60 giây
            OracleCommandBuilder.DeriveParameters(comm);
            OracleTransaction tran = conn.BeginTransaction();
        ...
        public DataTable GET_BC_GIAYXX_BC(String vArrSelectID, String VTOAANID, String VCAPXX)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_TOANCAU_STPT_EXT.GXN_BICAO", parameters);
            return tbl;
        }
        public DataTable GET_BC_GIAYXX_BH(String vArrSelectID, String VTOAANID, String VCAPXX)
        {
            ...
            DataTable tbl = Cls_Comon.GetTableByProcedurePaging("PKG_TOANCAU_STPT_EXT.GXN_BIHAI", parameters);
            return tbl;
        }
